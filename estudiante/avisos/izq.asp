...
if session("codigo_cpf")=103 then %>
			  ...
			  <tr onMouseOver="Resaltar(1,this,'S','#f8f8f8')" onMouseOut="Resaltar(0,this,'S','#f8f8f8')">
				...
				<!--<img alt="Microsoft" border="0" src="../images/msdn.jpg"> -->
				<b>
				<a href="http://www.usat.edu.pe/campusvirtual/librerianet/academico/votacionalumno.aspx?codigo_alu=<%=session("codigo_usu")%>" target="contenido">
...
<%  'Mostrar Alerta de Pagos
    ...
    <script>
        ...
        AbrirPopUp('escuelamedicinaessalud.asp', '250', '250', 'no', 'no', 'yes')        
	</script>
    <%end if    
    %>
</body>
