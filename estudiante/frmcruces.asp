...
<INPUT style="width:400px" type="button" value="Regresar a pre-matrícula e intente denuevo" onclick="location.href='frmmatricula.asp'" class="usatBoton">
<%else %>
<INPUT style="width:400px" type="button" value="Regresar a la opción agregados/retiros e intente denuevo" onclick="location.href='frmagregadoretiro.asp'" class="usatBoton">
<%end if %>
</p>
</body>
</html>