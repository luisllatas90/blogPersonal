...
if ( ! empty($_SERVER['HTTP_REFERER']) ){
	if( substr($_SERVER['HTTP_REFERER'],0,77)=="https://intranet.usat.edu.pe/campusvirtual/estudiante/frmaccesoAulaVirtual.asp" 
		||
	    substr($_SERVER['HTTP_REFERER'],0,75)=="https://intranet.usat.edu.pe/campusvirtual/personal/frmaccesoAulaVirtual.asp")
		
		||
	    substr($_SERVER['HTTP_REFERER'],0,87)=="http://serverqa/campusvirtual/CampusVirtualEstudiante/CampusVirtualEstudiante/Main.aspx")
		
		{

		//if (decifrado($_POST['avm6'],$_POST['avm4'])== $_POST['avm2'])
		// verifico que los disuasivos se hayan enviado y esten correctos
			//{
				//$codigopso = decifrado($_POST['avm1'],$_POST['avm3']);
				//$claveuser = decifrado($_POST['avm5'],$_POST['avm3']);
				//$codigopso = substr($codigopso,9,strlen($codigopso)-9);
				$codigopso = $_POST['avm7'];
				$claveuser = $_POST['avm8'];

				$_POST['username'] = $codigopso;
				$_POST['password'] = $claveuser;
			//}
	  }
}
/*LOGEO USAT*/
