...
function validar(form){
	...
	else
	{
		...
		if (confirm("¿Está seguro de registrar su inscripción en el evento?\n" + "Recuerde que esto le generará un cargo, el cual deberá ser cancelado según la opción elegida")==true){
				return(true);
			}
			else{
				return(false);
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td width="60%" class="usattitulo"><b class="azul">REGISTRO DE INSCRIPCIÓN:&nbsp; 
