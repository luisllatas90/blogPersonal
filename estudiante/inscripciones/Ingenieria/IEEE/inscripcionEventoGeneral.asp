...
function validarCantidad (){
	...
	else
	{
	    ...
	    if (document.frminscripcion.codigo_sco.value == "638" || document.frminscripcion.codigo_sco.value == "639")
		{
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td width="60%" class="usattitulo"><b>RAMA ESTUDIANTIL IEEE-USAT</b></td>
  </tr>
</table>
    ...
    <td width="75%"><br>
      ...
      <form  name="frminscripcion" method="post" action="grabarInscripcionEventoGeneral.asp" onSubmit="return validar(this)">
        <table cellpadding="3" cellspacing="0" style="border-collapse: collapse; " bordercolor="#111111" width="100%" class="contornotabla">
          ...
          <input type="hidden" name="cboPartes" value="5">
          <tr>
          ...
          <tr>
            ...
            <td width="69%" class="usatTitulousat"><select name="codigo_sco" id="codigo_sco" onChange="validarCantidad()">
                ...
                <option value="638"> PAGO DE MEMBRESIA ANUAL (S/. 90.00 )</option>
...
set rs = obj.consultar("consultarDeudaEvento", "FO", "IEE", "E",codigo_alu, codigo_cac)
obj.CerrarConexion
set obj = nothing
%>
