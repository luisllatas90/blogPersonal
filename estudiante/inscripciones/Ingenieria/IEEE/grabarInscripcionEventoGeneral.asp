...
codigo_cco= 2026  'IEEE

fechaInicio = "01/09/2010" 'empezar a cobrar desde esta fecha (ESTA FECHA SE SUBIO)
codigo_per=null
codigo_ocl=null
...
set rs = obj.consultar("consultarExistenciaDeuda_v2", "FO", "E",codigo_alu, codigo_sco,36, codigo_cco)
obj.CerrarConexion
