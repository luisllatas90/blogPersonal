...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td width="60%" class="usattitulo"><b>RAMA ESTUDIANTIL IEEE-USAT: EPEX: ENCUENTROS PARA EL EXITO</b></td>
  </tr>
</table>
        ...
        <table cellpadding="3" cellspacing="0" style="border-collapse: collapse; " bordercolor="#111111" width="100%" class="contornotabla">
          ...
          <tr>
            ...
            <td width="69%" class="usatTitulousat"><select name="codigo_sco" id="codigo_sco" onChange="validarCantidad()">
                ...
                <option value="630"> EPEX: ENCUENTROS PARA EL EXITO (S/. 5.00 )</option>
...
set rs = obj.consultar("consultarDeudaEvento", "FO", "EEX", "E",codigo_alu, codigo_cac)
obj.CerrarConexion
set obj = nothing
%>
