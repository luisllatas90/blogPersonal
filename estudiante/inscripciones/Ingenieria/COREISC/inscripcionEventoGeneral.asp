...
function validarCantidad (){
	...
	else
	{
		...
		if (document.frminscripcion.codigo_sco.value == "517")
		{
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td width="60%" class="usattitulo"><b>COREISC 2010</b></td>
  </tr>
</table>
        ...
        <table cellpadding="3" cellspacing="0" style="border-collapse: collapse; " bordercolor="#111111" width="100%" class="contornotabla">
          ...
          <tr>
            ...
            <td width="69%" class="usatTitulousat"><select name="codigo_sco" id="codigo_sco" onChange="validarCantidad()">
                ...
                <option value="517"> INSCRIPCION   (S/. 100.00)</option>
                <option value="518"> TALLERES (S/. 15.00) </option>
                <option value="519"> TUTORIAL (S/. 10.00)</option>
              </Select>
                <br />
                        </td>
          </tr>
...
set rs = obj.consultar("consultarDeudaEvento", "FO", "COR", "E",codigo_alu, codigo_cac)
obj.CerrarConexion
set obj = nothing
%>
      <table border="1" cellpadding="0" cellspacing="0" style="border"   bordercolor="#111111" width="100%" align="center">
        ...
        <tr>
          <td width="15%" class="usatAmarillo" align="center" height="20">CODIGO INSCRIP.</td>
        ...
        <% Do while not rs.eof%>
        <tr>
	  <%if rs("codigo_sco")= "517" then  %>
		  <td align="center" height="20"><%=rs("codigo_Deu")%></td>
...
<!--
	...
	- Polo
	- Jornadas Académicas (11 y 12 de noviembre)
...
<tr>
<td class="usatAmarillo" width="100%" colspan 5>Instrucciones:</td>
</tr>
<tr><td><a href=coreisc.doc target="_blank">Descargar instrucciones</a></td></tr>
