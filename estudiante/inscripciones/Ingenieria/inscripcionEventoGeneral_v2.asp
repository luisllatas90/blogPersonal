...
%>
    ...
    <p class="azul">
        Ver Programación: <a href="deportes.htm" style="font-size: 12px; font-weight: bold;">Clic aquí</a></p>
...
<%
        ...
        response.write ("Debe iniciar una sesión desde el campus virtual.")        
    end if
%>