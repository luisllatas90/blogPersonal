...
%>
    ...
    <p class ="azul">¿Dónde recojo las entradas?<br>
        Si ya te registraste, recógelas del unes 15 al viernes 19 de setiembre en tu Dirección de Escuela&nbsp;</p>
...
<% else
    ...
    'response.write ("SI NO COMPRASTE AÚN TU ENTRADA PUEDES HACERLO DESDE EL LUNES 15 AL VIERNES 19 DE SETIEMBRE SÓLO EN CAJA Y PENSIONES YA SEA EN EFECTIVO O CON CARGO A TU PENSIÓN.")
