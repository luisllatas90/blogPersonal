        ...
        <table cellpadding="3" cellspacing="0" style="border-collapse: collapse; " bordercolor="#111111" width="100%" class="contornotabla">
          ...
          <tr>
            ...
            <td width="69%" class="usatTitulousat"><select name="codigo_sco" id="codigo_sco" onChange="validarCantidad()">
                ...
                <option value="540"> INSCRIPCION   (S/. 50.00)</option>
...
set rs = obj.consultar("consultarDeudaEvento", "FO", "ADI", "E",codigo_alu, codigo_cac)
obj.CerrarConexion
set obj = nothing
%>
...
<tr><td><a href=afiche.jpg target="_blank">Descargar afiche publicitario</a></td></tr>
