...
<form  name="frminscripcion" method="post" action="grabarInscripcionJornadaEnfermeria.asp" onSubmit="return validar(this)">
 ...
 <tr>
   	<td width="36%">Precio del servicio:</td>
        ...
        <tr>
      	...
      	<td width="69%">2 partes: 2 partes: (1era cuota vence: OCtubre, 2da cuota vence: Noviembre)<input type=hidden name = cbopartes value="2">
		&nbsp;</td>
    	</tr>
