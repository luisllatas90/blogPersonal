...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td width="60%" class="usattitulo">Cursos de verano</td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="75%"><br>
      ...
      <br>
      <form  name="frminscripcion" method="post" action="grabarInscripcionEventoGeneral.asp?codigo_per=<%=codigo_per%>" onSubmit="return validar(this)">
        <table cellpadding="3" cellspacing="0" style="border-collapse: collapse; " bordercolor="#111111" width="100%" class="contornotabla">
          ...
          <tr>
            <td width="100%" colspan="2" style="text-align: left; color: #FFFFFF;" height="13" 
                  bgcolor="ActiveCaption">Datos de Inscripci&oacute;n</td>
          </tr>
          <tr>
            ...
            <td width="69%" class="usatTitulousat"><select name="codigo_sco" id="codigo_sco" onChange="validarCantidad()">
                ...
                <option value="1">OFFICE 2010         :: S/. 150.00 :: 3 CUOTAS</option>
                <option value="2">SPSS 17.0 BASICO    :: S/. 220.00 :: 2 CUOTAS</option>
                <option value="3">EXCEL AVANZADO      :: S/. 180.00 :: 2 CUOTAS</option>
                <option value="4">GOOGLE APIS CON PHP :: S/. 200.00 :: 2 CUOTAS</option>
                <option value="5">BUSINESS DYNAMICS   :: S/. 200.00 :: 2 CUOTAS</option>
                <option value="6">PHONETICS           :: S/. 200.00 :: 2 CUOTAS</option>
                <option value="7">GESTION DE PROYECTOS CON MS PROYECT :: S/. 200.00 :: 2 CUOTAS</option>                                                                                                
                <option value="8">APLICACIONES WEB    :: S/. 240.00 :: 2 CUOTAS</option>                                                                                                                
              </Select>
                <br />
                        </td>
          </tr>
          <tr>
            <td width="36%" class="azul">&nbsp;</td>
            <td width="69%">
...
set rs = obj.consultar("consultarDeudaEvento", "FO", "CV1", "P",codigo_per, codigo_cac)
obj.CerrarConexion
set obj = nothing
%>
      <table border="1" cellpadding="0" cellspacing="0" style="border"   bordercolor="#111111" width="100%" align="center">
        <tr>
          <td colspan=5 align="center">Detalle de cargo realizado:</td>
        </tr>
        <tr>
          <td width="15%"  align="center" height="20" bgcolor="ActiveCaption" 
                style="color: #FFFFFF">Fecha Registro</td>
          <td width="25%"  align="left" height="20" bgcolor="ActiveCaption" style="color: #FFFFFF">Servicio</td>
          <td width="10%" align="center" height="20" bgcolor="ActiveCaption" style="color: #FFFFFF">Cargo (S/.)</td>
          <td width="10%" align="center" height="20" bgcolor="ActiveCaption"  style="color: #FFFFFF">Abono (S/.)</td>
          <td width="10%" align="center" height="20" bgcolor="ActiveCaption" style="color: #FFFFFF">Saldo (S/.)</td>
        </tr>
        <% Do while not rs.eof%>
        <tr>
          <td align="center" height="20"><%=rs("fecha")%></td>
          <td align="left" height="20"><%=rs("descripcion_Cco")%></td>
...
%>
    ...
    <tr>
      <td><img border="0" src="verano_small.JPG"></td>
    </tr>
    </table></td>
</tr>
