...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" align="center">
  <tr>
    <td width="60%" class="usattitulo"><b>SEMANA DE DERECHO 2009</b></td>
  </tr>
</table>
        ...
        <table cellpadding="3" cellspacing="0" style="border-collapse: collapse; " bordercolor="#111111" width="100%" class="contornotabla">
          ...
          <tr>
            ...
            <td width="69%" class="usatTitulousat"><select name="codigo_sco" id="codigo_sco" >
                ...
                <option value="452"> SEMANA DE DERECHO 2009: BONO INTEGRAL (S/. 60.00)</option>
		<option value="491"> SEMANA DE DERECHO 2009: BONO ALMUERZO Y JORNADA (S/. 45.00)</option>
		<option value="492"> SEMANA DE DERECHO 2009: BONO POLO Y JORNADA  (S/. 45.00)</option>
		<option value="492"> SEMANA DE DERECHO 2009: BONO POLO Y JORNADA  (S/. 45.00)</option>
		<option value="497"> SEMANA DE DERECHO 2009: POLO DERECHO (S/. 15.00)</option>
		<option value="498"> SEMANA DE DERECHO 2009: ALMUERZO DERECHO (S/.15.00)</option>
          ...
          <tr>
            ...
            <td width="69%" class="usatTitulousat"><select name="cboPartes" id="cboPartes" >
                ...
                <option value="1"> 1 parte (Setiembre)</option>
		<option value="2"> 2 partes (Setiembre y octubre)</option>
		<option value="3"> 3 partes (Setiembre,octubre y noviembre)</option>
...
%>
 ...
 <td width="5%">&nbsp;</td>
    <td width="20%" align="center" valign="middle"><table width="98%" border="0" cellpadding="2" cellspacing="2" class="contornotabla_azul">
      <tr>
        <td><p><strong><em>El bono integral Incluye</em></strong> <br><br>
	- Polo <br><br>
	- Jornadas Académicas (11 y 12 de noviembre) <br><br>
	- Almuerzo de Derecho (14 de noviembre) <br><br>
	- N° para sorteo de paquete de libros de Derecho <br><br>
	- Verbena <br><br>
	- Copa Integración <br><br>
	- Noches Culturales <br>
