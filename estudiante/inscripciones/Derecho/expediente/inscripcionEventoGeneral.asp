...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td width="60%" class="usattitulo"><b>I SEM. INTERNACIONAL EXPEDIENTE VIRTUAL Y TIC EN ADMINISTRACION DE JUSTICIA</b></td>
  </tr>
</table>
        ...
        <table cellpadding="3" cellspacing="0" style="border-collapse: collapse; " bordercolor="#111111" width="100%" class="contornotabla">
          ...
          <tr>
            ...
            <td width="69%" class="usatTitulousat"><select name="codigo_sco" id="codigo_sco" onChange="validarCantidad()">
                ...
                <option value="630"> INSCRIPCION   (S/. 80.00) (2 partes: Junio y Julio)</option>
...
set rs = obj.consultar("consultarDeudaEvento", "FO", "EVI", "E",codigo_alu, codigo_cac)
obj.CerrarConexion
set obj = nothing
%>
      <table border="1" cellpadding="0" cellspacing="0" style="border"   bordercolor="#111111" width="100%" align="center">
        ...
        <tr>
          ...
          <td align="center" height="20"><%=cdbl(rs("montoTotal_Deu"))%></td>
