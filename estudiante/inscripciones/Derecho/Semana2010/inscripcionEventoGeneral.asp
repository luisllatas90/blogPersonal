...
function validarCantidad (){
	    if (document.frminscripcion.codigo_sco.value == "1" || document.frminscripcion.codigo_sco.value == 2 || document.frminscripcion.codigo_sco.value == 3)
		{
...
/*
	if (document.frminscripcion.codigo_sco.value == 0 || document.frminscripcion.codigo_sco.value == 1|| document.frminscripcion.codigo_sco.value == 2 )
	{
	...
	else
	{
	    ...
	    if (document.frminscripcion.codigo_sco.value == "1" || document.frminscripcion.codigo_sco.value == 2)
		{
			document.frminscripcion.cantidad.value ="1";
			//document.frminscripcion.cantidad.disabled=true;
			document.frminscripcion.cantidad.readOnly=true;
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td width="60%" class="usattitulo">CE<b>NA DE GALA - SEMANA DE DERECHO 2010</b></td>
  </tr>
</table>
    ...
    <td width="75%"><br>
      ...
      <form  name="frminscripcion" method="post" action="grabarInscripcionEventoGeneral.asp" onSubmit="return validar(this)">
        <table cellpadding="3" cellspacing="0" style="border-collapse: collapse; " bordercolor="#111111" width="100%" class="contornotabla">
          ...
          <tr>
            ...
            <td width="69%" class="usatTitulousat"><select name="codigo_sco" id="codigo_sco" onChange="validarCantidad()">
                ...
                <option value="1"> CENA DE GALA PAREJA (S/. 70.00)</option>
                <option value="2"> CENA DE GALA INDIVIDUAL (S/. 40.00)</option>                
                <option value="3"> SEMANA DE DERECHO (S/. 35.00)</option>                       
              </Select><br />
        ...
        <td width="69%" class="rojo">
			Seleccione el número de partes en las que se descontará. 
        (Meses agrupados con la pensión)<br>
...
set rs = obj.consultar("consultarDeudaEvento", "FO", "SDD", "E",codigo_alu, codigo_cac)
obj.CerrarConexion
set obj = nothing
%>
