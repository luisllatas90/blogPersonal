...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" align="center">
  <tr>
    <td width="60%" class="usattitulo" >
        <b >Semana Naranja 2009</b></td>
  </tr>
</table>
    ...
    <td width="75%"><br>
      ...
      <form  name="frminscripcion" method="post" action="grabarInscripcionEventoGeneral_v2.asp" onSubmit="return validar(this)">
        <table cellpadding="3" cellspacing="0" style="border-collapse: collapse; " bordercolor="#111111" width="100%" class="contornotabla">
          ...
          <tr>
            <td width="100%" colspan="2" class="etabla" 
                  style="text-align: left; background-color: #FF9900; color: #FFFFFF;" 
                  height="13">Datos de Inscripci&oacute;n</td>
          </tr>
          <tr>
            ...
            <td width="69%" class="usatTitulousat"><select name="codigo_sco" id="codigo_sco" >
                ...
                <option value="500"> SEMANA NARANJA 2009: ALMUERZO (S/. 20.00)</option>
		      </Select>
                <br />
              </td>
          </tr>
          ...
          <tr>
            <td width="36%">Nro Partes:</td>
            <td width="69%" class="usatTitulousat"><select name="cboPartes" id="cboPartes" >
                <option value="0">---Indique en cuantas partes lo cancelará--- </option>
                <option value="1"> 1 parte (PENSIÓN NOVIEMBRE)</option>
          ...
          <tr>
            <td width="36%" class="azul">Cantidad de entradas que desesa:</td>
            <td width="69%"><input type=text name="cantidad" value="1" 
                    onKeyPress="validarSoloNumero()" maxlength=2 style="width: 31px">
                (Cantidad de entradas. Esto se multiplicará por el precio)</td>
          </tr>
          <td width="36%">&nbsp;</td>
        <td width="69%" class="rojo"><%=msg%> <br />
            <br />
            <input type="submit" value="Registrar"  name="smtGuardar" class="usatguardar" style="background-color: #FF9900; color: #FFFFFF;">
            <input OnClick="location.href='about:blank'" type="button" value="Cancelar" name="cmdCancelar" class="usatsalir" style="background-color: #FF9900; color: #FFFFFF;">
        </td>
          </tr>
        </table>
      </form>
...
%>
      <table border="1" cellpadding="0" cellspacing="0" style="border"   bordercolor="#111111" width="100%" align="center">
        ...
        <tr style="background-color: #FF9900; color: #FFFFFF;">
          <td width="15%" class="etabla" align="center" height="20" style="background-color: #FF9900; color: #FFFFFF;">Fecha Registro</td>
          <td width="25%" class="etabla" align="center" height="20" style="background-color: #FF9900; color: #FFFFFF;">Servicio</td>
          <td width="10%" class="etabla" align="center" height="20" style="background-color: #FF9900; color: #FFFFFF;">Cantidad</td>
          <td width="10%" class="etabla" align="center" height="20" style="background-color: #FF9900; color: #FFFFFF;">Precio (S/.)</td>
          <td width="10%" class="etabla" align="center" height="20" style="background-color: #FF9900; color: #FFFFFF;">Cargo (S/.)</td>
          <td width="10%" class="etabla" align="center" height="20" style="background-color: #FF9900; color: #FFFFFF;">Abono (S/.)</td>
          <td width="10%" class="etabla" align="center" height="20" style="background-color: #FF9900; color: #FFFFFF;">Saldo (S/.)</td>
        </tr>
        <% Do while not rs.eof%>
        <tr>
...
%>
 ...
 <td width="5%">&nbsp;</td>
    <td width="20%" align="center" valign="middle"><table width="98%" border="0" cellpadding="2" cellspacing="2" class="contornotabla_azul">
      <tr>
        <td style="background-color: #FF9900; color: #FFFFFF;"><p><strong><em>Avisos:</em></strong> <br><br>
	- Puede adquirir más de una entrada, indique la cantidad antes de grabar.<br><br>
	- Las entradas se repartirán el día viernes 30 en la Facultad.<br><br>
	</p>
      </tr>
 </table></td>
  </tr>
