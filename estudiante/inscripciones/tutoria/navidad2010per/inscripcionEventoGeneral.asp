...
function validarCantidad (){
	    if (document.frminscripcion.codigo_sco.value == 10  || document.frminscripcion.codigo_sco.value == 20 || document.frminscripcion.codigo_sco.value == 50 )
		{
...
/*
	if (document.frminscripcion.codigo_sco.value == 0 || document.frminscripcion.codigo_sco.value == 10   || document.frminscripcion.codigo_sco.value == 20 || document.frminscripcion.codigo_sco.value == 50 )
	{
      ...
      <form  name="frminscripcion" method="post" action="grabarInscripcionEventoGeneral.asp?codigo_per=<%=codigo_per%>" onSubmit="return validar(this)">
        <table cellpadding="3" cellspacing="0" style="border-collapse: collapse; " bordercolor="#111111" width="100%" class="contornotabla">
          ...
          <tr>
            ...
            <td width="69%" class="usatTitulousat"><select name="codigo_sco" id="codigo_sco" onChange="validarCantidad()">
                ...
                <option value="50"> COLABORACION S/. 50.00</option>                
        ...
        <td width="69%" class="rojo">
			<select name="cboPartes" id="cboPartes" onChange="validarCantidad()">
              ...
              </Select>&nbsp; (Descuento por planilla)</td>
          </tr>
          <td width="36%">&nbsp;</td>
...
set rs = obj.consultar("consultarDeudaEvento", "FO", "NAE", "P",codigo_per, codigo_cac)
obj.CerrarConexion
set obj = nothing
%>
