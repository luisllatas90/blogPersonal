...
fechaVencimiento_sco =  "05/06/2010"

codigo_cco= 1234'IV Jornada


fechaInicio = "01/05/2010" 'empezar a cobrar desde esta fecha
codigo_per=null
codigo_ocl=null
...
<% 		
    ...
    obj.AbrirConexionTrans
		'Grabar Deuda
		  ...
		  lngCodigo_Deu = obj.Ejecutar("AgregarDeuda_v2", True, fecha,  "", "E", codigo_alu,  codigo_per, codigo_ocl, codigo_sco, codigo_cac, "IV Jornada. Inscripcion Web (" + cstr(partes) + " Partes)", precio_sco, moneda_sco, precio_sco, "P",          generamora_sco,fechaVencimiento_sco , codigo_cco, 1 , Null, Null, 0, 0,partes, fechaInicio, Null)
