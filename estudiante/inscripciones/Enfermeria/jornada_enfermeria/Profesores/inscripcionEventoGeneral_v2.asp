	...
	//Valida
	    ...
	    else 
	    {
	        if (form.cantidad.value=="0" || form.cantidad.value=="" || form.cantidad.value<0 ) { 
		        alert("Por favor, indique el número de partes en que se descontará.");
		        form.cantidad.focus(); 
		        return(false);
	        }
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td width="60%" class="usattitulo"><b>III Jornada Internacional de Investigaci&oacute;n en Ciencias de Enfermer&iacute;a </b></td>
  </tr>
</table>
        ...
        <table cellpadding="3" cellspacing="0" style="border-collapse: collapse; " bordercolor="#111111" width="100%" class="contornotabla">
          ...
          <tr>
            ...
            <td width="69%" class="usatTitulousat"><select name="codigo_sco" id="codigo_sco" >
                ...
                <option value="71"> PREJORNADA INTERNAC. ENFERMERIA 2009 (S/.120.00)</option>
                <option value="70"> III JORNADA INTERNAC. ENFERMERIA 2009 (S/.150.00) </option>-->
              </Select>
                <br />
            </td>
          </tr>
          <tr>
            <td width="36%" class="azul">Partes:</td>
            <td width="69%"><input type=text name="cantidad" value="1" 
                    onKeyPress="validarSoloNumero()" maxlength=1 style="width: 31px"></td>
          </tr>
          <td width="36%">&nbsp;</td>
...
set rs = obj.consultar("consultarDeudaEvento", "FO", "JOR", "P",codigo_per, codigo_cac)
obj.CerrarConexion
set obj = nothing
%>
