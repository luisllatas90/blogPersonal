...
function validar(form){
	...
	else
	{
		...
		if (confirm("¿Está seguro de registrar su inscripción en el evento?\n" + "Recuerde que esto le generará un cargo, el cual deberá ser cancelado en Caja-USAT.")==true){
				return(true);
			}
			else{
				return(false);
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td width="60%" class="usattitulo"><b>Registro de Inscripción</b></td>
  </tr>
</table>
<br>
...
<form  name="frminscripcion" method="post" action="grabarinscripcioneventoSINSYC.asp" onSubmit="return validar(this)">
...
<input type="hidden" name="codigo_cco" value="<%=codigo_cco%>">
 ...
 <tr>
 <td >Evento:</td>
 <td ><b>Semana de Ingeniería de Sistemas y Computación (SINSYC) - 2007<br>(17-22 Septiembre)</b></td>
 </tr>
 <tr>
