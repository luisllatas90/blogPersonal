...
<table style="width: 100%">
	...
	<tr>
		<td class="Menu" onMouseOver="ResaltarMenuElegido(1,this)" onMouseOut="ResaltarMenuElegido(0,this)" align="center" onclick="AbrirPopUp('../../ayuda/manualestudiante.pdf','500','650')">
...
<table bgcolor="white" align="center" class="contornotabla" cellpadding="3" cellspacing="0" style="border-collapse: collapse" width="100%" height="100%">
	...
	<h2 class="rojo">No se encontraron cursos virtuales activados.</h2>
	<h3><br>
	Motivos: - No esta matriculado en los cursos.<br> - El profesor aún no activa el uso del aula virtual para su curso matriculado<br>
	</td>
	</tr>
	<%else%>
	<tr>
