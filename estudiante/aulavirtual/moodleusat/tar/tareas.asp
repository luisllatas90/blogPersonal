...
<body>
<p class="e4">Trabajos por realizar</p>
<%
Set Obj= Server.CreateObject("AulaVirtual.clsAccesoDatos")
obj.AbrirConexion
	Set rsContenido=obj.Consultar("DI_ConsultarTodoTarea","FO",session("idcursovirtual"),session("codigo_tfu"),session("codigo_usu"),0)
obj.CerrarConexion
Set Obj=nothing
...
<table border="1" cellpadding="3" cellspacing="0" style="border-collapse: collapse" width="100%" bordercolor="#808080">
  <tr class="etabla">
    ...
    <td width="20%">Fecha de Presentación</td>
...
<%else
response.write "<h5 class=""sugerencia"">&nbsp;&nbsp;&nbsp;&nbsp;No se han encontrado tareas por realizar</h5>"
end if
