...
function OrdenarMensajes(mis_mensajes)
{
	...
	if ((mis_mensajes=="") || (mis_mensajes==null)) {
  		frames[0].document.body.innerHTML ="Error en el inicio de sesión del chat!";
...
function OrdenarUsuarios(mis_usuarios)
{
	...
	if ((mis_usuarios=="") || (mis_usuarios==null)) {
  		frames[0].document.body.innerHTML ="Error! Los datos no han retornado. Por favor registre denuevo!";
...
<body onload="RecuperarMensajes()" onUnload="location.href='abrirchat.asp?modo=S'" topmargin="0" leftmargin="0" bgcolor="#91A9DB" oncontextmenu="return event.ctrlKey">
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="100%">
  <tr>
    ...
    <table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#808080" width="100%" height="100%">
      ...
      <tr>
        <td width="100%" height="95%" class="contornotabla"><iframe width=100% height="100%" id=mbox name="I1" src="../../chat/lstmensajes.htm" FRAMEBORDER=0></iframe></td>
      </tr>
    </table>
    </td>
    ...
    <table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#808080" width="95%" height="100%">
      ...
      <tr>
        ...
        <iframe width=100% height="100%" id=blist style="border-style: solid; border-width: 0" name="I2" src="../../chat/lstusuarios.htm" FRAMEBORDER=0></iframe></td>
      </tr>
    </table>
    </td>
  </tr>
  <tr>
    ...
    <table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
      ...
      <tr>
        ...
        <input type="button" value="   Salir" name="cmdsalir" onclick="top.location.href='abrirchat.asp?modo=S'" class="boton">
