<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmConsultaPedidoCeco.aspx.vb" Inherits="logistica_frmConsultaPedidoCeco" %>
...
<tr  ><td class="style9">
    <asp:DropDownList ID="cboInstancia" 
    ...
    <tr>
        <td class="style4" colspan="2" visible="False">
            Año Presupuestal:&nbsp;<asp:DropDownList ID="cboAñoPresupuestal" AutoPostBack="true"
                runat="server">
    </asp:DropDownList>
            &nbsp;</td>
    </tr>

<tr  ><td class="style4" colspan="2" visible="False">
    Centro de Costo:
    &nbsp;<asp:DropDownList ID="cboCentroCostos" runat="server" Width ="100%">
    </asp:DropDownList>
    </td>
</tr>
<tr  ><td class="style7" colspan="2">
    &nbsp;Número de Pedido:
            <asp:TextBox ID="txtIdPedido" runat="server" Width="56px"></asp:TextBox>
    &nbsp;&nbsp;
    <asp:TextBox ID="txtTrabajador" runat="server" Width="342px" Visible="False"></asp:TextBox>
    &nbsp;
...
<tr style="height:430px" class="" valign="top"><td class="contornotabla" colspan="2">
    <table width="100%">
    <tr>
