...
Partial Class logistica_frmMonitorPedidoAlmacen
    ...
    Private Sub ConsultarPedidos()
        ...
        If txtDescripcionItem.Text.Trim = "" Then
            item = "%"
        Else
            item = Me.txtDescripcionItem.Text.Trim
        End If
        ...
        'Else
        datos = objcon.ConsultarPedidosPorItem(pedido, Me.cboCentroCostos.SelectedValue, trabajador, item)
        'End If
