<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmFaltaConformidad.aspx.vb" Inherits="logistica_frmFaltaConformidad" %>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
            ...
            <tr>
                <td colspan="2" align="right">                
                    <asp:Button ID="btnConfirma" runat="server" Text="Solicitar confirmación" CssClass="guardar2" Height="22px" Width="140px" />
                </td>
            </tr>
            <tr>
                <td colspan="2">                
