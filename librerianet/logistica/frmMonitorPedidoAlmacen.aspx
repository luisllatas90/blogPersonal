<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmMonitorPedidoAlmacen.aspx.vb" Inherits="logistica_frmMonitorPedidoAlmacen" %>
...
<tr height="430px" class="" valign="top"><td class="contornotabla" colspan="2">
    ...
    <TD style="width:45%">
    <table width="100%">
    <tr><td>Pedido N° <asp:TextBox ID="txtPedido" runat="server" Enabled="False"></asp:TextBox>
    ...
    <tr>
        <td style="color: #0000FF" colspan="2">
            Almacen&nbsp;&nbsp;
          <asp:TextBox ID="txtAlmacen" runat="server" Enabled="False"></asp:TextBox>
        </td>
    </tr>
    </table>
    </TD>
    ...
    <td>
        ...
        <asp:Panel ID="pnlDatos" runat="server" Visible="False">
            ...
            <asp:GridView ID="gvDetallePedido" runat="server" 
                AutoGenerateColumns="False" CellPadding="4" 
                DataKeyNames="codigo_ecc,codigo_dpe,modoDistribucion_Dpe" ForeColor="#333333" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="subtotal" HeaderText="Subtotal" ReadOnly="True" 
                        SortExpression="subtotal" Visible="False">
                        <ItemStyle HorizontalAlign="Right" />
                    </asp:BoundField>
                    ...
                    <asp:CommandField SelectText="Tesorería" ShowSelectButton="True" 
                        Visible="False">
                        <ItemStyle HorizontalAlign="Center" ForeColor="#FF9933" />
                    </asp:CommandField>
                    <asp:CommandField EditText="Compras" ShowEditButton="True" Visible="False">
            ...
            <asp:Label ID="lblTotalDetalle" runat="server" Font-Bold="True" 
                Font-Size="10pt" Font-Underline="True" ForeColor="#0033CC" Text="0.00" 
