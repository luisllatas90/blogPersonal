<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmNuevoPedido_V1_bk.aspx.vb" Inherits="presupuesto_areas_RegistrarPresupuestoDetalle"  EnableEventValidation="false" %>
                                ...
                                <tr bgcolor="#F5F9FC">
                                    ...
                                    <td>
                                        ...
                                        <input ID="Button2" class="cunia" 
                                            ...
                                            style="height: 22px" type="button" /><asp:RequiredFieldValidator 
                                            ID="RequiredFieldValidator11" runat="server" ControlToValidate="TxtFechaEsperada" 
                                            ErrorMessage="Ingrese fecha a Despachar" ValidationGroup="Guardar">*</asp:RequiredFieldValidator>
                                        &nbsp;</td>
                                    </td>    
                                </tr>
                                <tr bgcolor="#F5F9FC">
