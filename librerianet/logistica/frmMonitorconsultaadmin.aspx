<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmMonitorconsultaadmin.aspx.vb" Inherits="librerianet_logistica_frmMonitorconsultaadmin" %>
...
.salir {
	...
	background: #FEFFE1 url('../images/salir.gif') no-repeat 0% 80%;
	width: 100;
	font-family: Tahoma;
	font-size: 8pt;
	font-weight: bold;
...
.Buscar     {border:1px solid #C0C0C0; background:#FEFFE1 url('../images/busca.gif') no-repeat 0% 50%; width:100; font-family:Tahoma; font-size:8pt; font-weight:bold}
.buscar {
	border: 1px solid #C0C0C0;
...
<tr  ><td class="style2" colspan="2">
    <asp:CheckBox ID="chkPorItem" runat="server" AutoPostBack="True" 
        Text="Buscar SÓLO POR ITEM" Visible="False" />
    Ítem Pedido
    <asp:TextBox ID="txtDescripcionItem" runat="server" 
...
<tr height="430px" class="" valign="top"><td class="contornotabla" colspan="2">
    ...
    <TD style="width:60%">
    <table width="100%">
    <tr><td class="style3">Pedido N°
    <asp:TextBox ID="txtPedido" runat="server" Enabled="False" Width="206px"></asp:TextBox>
                                                </td><td class="style8">Ver:         <asp:LinkButton ID="lnkDatos" runat="server" ForeColor="#0000CC">Datos Generales</asp:LinkButton>
        |<asp:LinkButton ID="lnkRevisiones" runat="server" ForeColor="#0000CC">Revisiones</asp:LinkButton>
                                                    <br />
    </td></tr>
    <tr><td class="style4">Proceso&nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="cboPeriodoPresu" runat="server" Enabled="False" 
            Height="22px" Width="209px">
            </asp:DropDownList>
            &nbsp;</td><td class="style5">Estado&nbsp;&nbsp;
            <asp:DropDownList ID="cboEstado" runat="server" Enabled="False">
            </asp:DropDownList>
    </td></tr>
    <tr><td class="style6">Derivar a: <asp:DropDownList ID="cboDerivarCon" 
            runat="server" Height="25px" Width="206px">
            </asp:DropDownList>
        </td><td class="style7">
        <asp:Button ID="cmdDerivar" runat="server" CssClass="guardar" 
            Text="Derivar" Width="95px" Height="23px" ValidationGroup="calificar" />
    </td></tr>
    <tr>
        <td class="style6" style="color: #0000FF" colspan="2">
            Almacen&nbsp;&nbsp;
          <asp:TextBox ID="txtAlmacen" runat="server" Enabled="False" Width="205px" ></asp:TextBox>
        </td>
    </tr>
    </table>
    &nbsp;</TD>
    ...
    <td>
        ...
        <asp:Panel ID="pnlDatos" runat="server" Visible="False">
            ...
            <asp:UpdatePanel runat="server" ID ="up2" >
                ...
                Caption="Lista de ítems pedidos" CaptionAlign="Left" CellPadding="4" 
                DataKeyNames="codigo_ecc,codigo_dpe,modoDistribucion_Dpe,descripcionEstado_Eped" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="descripcion_Ppr" HeaderText="Prog. Presup." />
                                    ...
                                    <table cellspacing="0" cellpadding="2" border="1" style="color:Black;background-color:White;width:90%;border-collapse:collapse;">
                                        ...
                                        <tr >
                                         ...
                                         <tr>
                                            ...
                                            <%--<td> <img src="../images/attachment.png" /><asp:HyperLink  ID ="HyperLink1" runat ="server" NavigateUrl ='<%#Iif( Eval("archivo_especificacion").toString()="","#",Eval("archivo_especificacion","archivos/{0}")) %>' Text ='<%#Iif(Eval("archivo_especificacion").toString() <>"",Eval("archivo_especificacion"),"Ninguno") %>' target="_blank" ></asp:HyperLink></td>--%>
                                            <td> <img src="../images/attachment.png" /><asp:HyperLink  ID ="hlAdjunto" runat ="server" NavigateUrl ='<%#Iif( Eval("archivocompartido").toString()="0",Iif( Eval("archivo_especificacion").toString()="","#",Eval("archivo_especificacion","archivos/{0}")),"DescargarArchivo.aspx?Id="&Eval("archivo_especificacion")) %>' Text ='<%#Iif(Eval("archivocompartido").toString() ="0",Iif(Eval("archivo_especificacion").toString() <>"",Eval("archivo_especificacion"),"Ninguno"),"Archivo") %>' target="_blank" ></asp:HyperLink></td>
                    ...
                    <asp:TemplateField HeaderText ="Estado" >
                            <ItemTemplate>
                                <asp:LinkButton ID="hlnkOrden" runat="server" NavigateUrl="#" Text=<%#Eval("descripcionEstado_Eped").ToString()%> ToolTip ="Ver detalle" OnClick ="hlnkOrden_Click" CommandArgument =<%#Eval("codigo_ecc") %> ></asp:LinkButton>
                            </ItemTemplate>
                    </asp:TemplateField >
                    <asp:BoundField DataField="observacion_ecc" HeaderText="Motivo Eliminado" />
                    <asp:CommandField NewText="" SelectText="Tesorería" ShowSelectButton="True">
                    <ItemStyle ForeColor="#FF9933" HorizontalAlign="Center" />
                    </asp:CommandField>
                    <asp:CommandField EditText="Compras" ShowEditButton="True">
                    <ItemStyle ForeColor="Black" />
                    </asp:CommandField>
                    <asp:CommandField DeleteText="Despachar" ShowDeleteButton="True" />
            ...
            &nbsp;<br />
                     <br />
            <asp:GridView ID="gvCabOrden" runat="server" Caption="Detalle de Orden"  
                CaptionAlign="Left" CellPadding="4" 
                            AutoGenerateColumns="False" 
                            DataKeyNames="codigo_Rco" 
                           ForeColor="#333333" GridLines="None" Width="100%">
                        <RowStyle BackColor="#EFF3FB" />
                            <Columns>
                                ...
                                <asp:BoundField DataField="pago" 
                                    HeaderText="Forma de Pago" SortExpression="pago">
                                <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="usuario" HeaderText="Registrado por" 
                                    SortExpression="usuario" />
                                <asp:BoundField DataField="descripcionEstado_Eped" HeaderText="Estado" 
                                    SortExpression="descripcionEstado_Eped" />
        ...
        <td width="50%" valign="top">
            ...
            <br />
            <asp:GridView ID="gvAtenciones" runat="server" 
                Caption="Datos de ejecución del pedido" CaptionAlign="Left" CellPadding="4" 
                ForeColor="#333333" GridLines="None" Width="97.5%">
                <FooterStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                <RowStyle BackColor="#E3EAEB" />
                <PagerStyle BackColor="#666666" ForeColor="White" HorizontalAlign="Center" />
