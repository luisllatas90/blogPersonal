...
Partial Class logistica_frmConsultaPedidoCeco
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ' Hcano 21-09-17 : Comento Opcion Todos de Ejercicio Presupuestal
            'objfun.CargarListas(cboAñoPresupuestal, datos, "codigo_ejp", "descripcion_ejp", "Todos")
            objfun.CargarListas(cboAñoPresupuestal, datos, "codigo_ejp", "descripcion_ejp")
            ' Fin Hcano 21-09-17 : Comento Opcion Todos de Ejercicio Presupuestal
            If datos.Rows.Count > 0 Then
                objfun.CargarListas(cboPeriodoPresu, datos, "codigo_ejp", "descripcion_ejp")
            End If

            ' Hcano 21-09-17 : Comento y Cambio Carga de Centros de Costos
            'datos = objpre.ObtenerListaCentroCostos("1", 523, Request.QueryString("id"))
            datos = objpre.ObtenerListaCentroCostos_v2("LPR", Request.QueryString("id"), Request.QueryString("ctf"), Me.cboAñoPresupuestal.SelectedValue, "0")
            ...
            objfun.CargarListas(Me.cboCentroCostos, datos, "codigo_Cco", "descripcion_Cco", "TODOS")
            'Fin Hcano 21-09-17 : Comento y Cambio Carga de Centros de Costos
    ...
    Public Sub ConsultaPedido()
        Dim obj As New ClsConectarDatos
        Dim dt As New Data.DataTable
        Try
            Dim pedido As Integer
            Dim idCentroCosto As Integer
            Dim idAñoPresupuestal As Integer
            If Me.txtIdPedido.Text.Trim = "" Then
                pedido = 0
                If Me.cboAñoPresupuestal.SelectedValue = -1 Then
                    idAñoPresupuestal = 0
                Else
                    idAñoPresupuestal = Me.cboAñoPresupuestal.SelectedValue
                End If

                If Me.cboCentroCostos.SelectedValue = -1 Then
                    idCentroCosto = 0
                Else
                    idCentroCosto = Me.cboCentroCostos.SelectedValue
                End If
                obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
                obj.AbrirConexion()
                'Hcano 21-09-17 : Comento y Cambio Procedimiento V1
                'dt = obj.TraerDataTable("LOG_ConsultarPedidosCecoXPeriodoPresupuestalYCco", Request.QueryString("id"), pedido, "", _
                '                            idAñoPresupuestal, idCentroCosto)
                dt = obj.TraerDataTable("LOG_ConsultarPedidosCecoXPeriodoPresupuestalYCco_V1", Request.QueryString("id"), pedido, "", _
                                            idAñoPresupuestal, idCentroCosto, Request.QueryString("ctf"))
                'Fin Hcano 21-09-17 : Comento y Cambio Procedimiento V1
                obj.CerrarConexion()
            ...
            Else
                ...
                obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
                obj.AbrirConexion()
                dt = obj.TraerDataTable("LOG_ConsultarPedidosCeco", Request.QueryString("id"), pedido, "")
                obj.CerrarConexion()
    ...
    Protected Sub cboCentroCostos_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboCentroCostos.SelectedIndexChanged
        'para consultar centros de costos por programa presupuestal y centro de costo
        ConsultarPedidosPorCentroCostos()
    End Sub
    Private Sub ConsultarPedidosPorCentroCostos()
        Dim obj As New ClsConectarDatos
        Dim dt As New Data.DataTable
        Try
            Dim pedido As Integer
            ...
            Else
                idCentroCosto = Me.cboCentroCostos.SelectedValue
            End If
            'Response.Write(idCentroCosto)
            obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
            obj.AbrirConexion()
            dt = obj.TraerDataTable("LOG_ConsultarPedidosCecoXPeriodoPresupuestalYCco", Request.QueryString("id"), pedido, "", _
                                        Me.cboAñoPresupuestal.SelectedValue, idCentroCosto)
            obj.CerrarConexion()
    ...
    Protected Sub cboAñoPresupuestal_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboAñoPresupuestal.SelectedIndexChanged
        Dim objpre As New ClsPresupuesto
        Dim objfun As New ClsFunciones
        Dim datos As New Data.DataTable
        datos = objpre.ObtenerListaCentroCostos_v2("LPR", Request.QueryString("id"), Request.QueryString("ctf"), Me.cboAñoPresupuestal.SelectedValue, "0")
