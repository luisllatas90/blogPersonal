<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmNuevoPedido_V1.aspx.vb" Inherits="presupuesto_areas_RegistrarPresupuestoDetalle"  EnableEventValidation="false" Debug="true" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        */
        ...
        function ModalAdjuntar2(cod_ped) {
            $("#txtpedido").val(cod_ped)
            //$("#txtfile").val("");
            //fnVer(cod_ped)
        ...
        function fnGuardar() {
            if ($("#txtfile").val() == "") {
                ...
                document.getElementById('lblAdjunto').innerHTML = fileInput.files[0].name;
                $('#mdRegistro').modal('hide');
                //fnVer($("#cod_dpe").val())
            }
        }
            ...
            <tr bgcolor="#F5F9FC">
                <td>
                    Centro de costo<asp:RequiredFieldValidator ID="RequiredFieldValidator4" 
                        ...
                        ErrorMessage="Seleccione centro de costos" ValidationGroup="Guardar" Display ="None" EnableClientScript="false" Text ="*" ></asp:RequiredFieldValidator>
                                        <asp:CompareValidator ID="CompareValidator5" runat="server" 
                        ControlToValidate="cboCecos" ErrorMessage="Seleccione centro de costos" 
                        Operator="GreaterThan" ValidationGroup="Guardar" ValueToCompare="0" Text ="*"></asp:CompareValidator>
                ...
                <td colspan="2">
                        ...
                        Visible="False"></asp:TextBox>
                                        <asp:DropDownList ID="cboCecos" runat="server" AutoPostBack ="true" Width="100%" >
                                        </asp:DropDownList>
                                        <asp:TextBox ID="txtBuscaCecos" runat="server" ValidationGroup="BuscarCecos" 
                                            style="width: 128px"></asp:TextBox>
                                            <asp:LinkButton ID="LinkButton2" runat="server" 
                        ForeColor="Blue" ValidationGroup="BuscarCecos" ><img style="height:auto;width:auto;" src="../images/busca.gif"alt="Buscar" /></asp:LinkButton>
                ...
                <td colspan="3">
                        ...
                        ForeColor="#FF3300">
                                ...
                                Centro Costos<asp:CompareValidator ID="CompareValidator7" runat="server" 
                                    ...
                                    Operator="GreaterThan" ValidationGroup="Distribuir" ValueToCompare="0" Text ="*"></asp:CompareValidator>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" 
                                    ...
                                    ErrorMessage="Ingrese la distribución" ValidationGroup="Distribuir" Text ="*"></asp:RequiredFieldValidator>
                                        ...
                                        <asp:Panel ID="pnlPresupuesto" runat="server" ForeColor="Red" 
                                            ...
                                            <asp:Panel ID="pnlListaPresup" runat="server" Height="150px" 
                                                ...
                                                <asp:GridView ID="gvPresupuesto" runat="server" AutoGenerateColumns="False" 
                                                    CellPadding="4" DataKeyNames="codigo_dpr,codigo_Ppr,codigo_Art,IdUni,codigo_dap,fecini_dap" 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="fecini_dap" HeaderText="Fecha Inicio" Visible="false" />
                                                        <%--treyes 04/07/2016--%>
                                                        <asp:TemplateField >
                                                            <ItemTemplate>
                        ...
                        <tr>
                            ...
                            <table width="100%" border="0" cellpadding="2" cellspacing="0">
                                <tr style="height:40px;">
                                    <td  colspan="2">
                                        &nbsp;&nbsp;<asp:CheckBox ID="chkNoPresupuestado" runat="server" AutoPostBack="true" Font-Bold="true" Text="Item No Presupuestado" Visible="false" />
                                    </td>
                                </tr>
                                 <tr bgcolor="#F5F9FC">
                                    <td >Actividad<asp:CompareValidator ID="CompareValidator1" runat="server" 
                                            ControlToValidate="cboDetalleActividadPOA" 
                                            ErrorMessage="Seleccione Una Actividad del Programa/Proyecto" 
                                            Operator="GreaterThan" 
                                            ValidationGroup="Guardar" ValueToCompare="0" EnableClientScript="false" Text ="*"></asp:CompareValidator>
                                    </td>
                                    <td >                                    
...
<%--                                <tr bgcolor="#F5F9FC">
                                    ...
                                    <td>
                                        <asp:Panel ID="Panel4" runat="server">
                                            Item<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                                                ...
                                                ErrorMessage="Busque el item que desea registrar" ValidationGroup="BuscaItem" Text ="*"></asp:RequiredFieldValidator>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                                                ControlToValidate="txtConcepto" ErrorMessage="Selecione item a registrar" 
                                                ValidationGroup="Guardar" EnableClientScript="false" Text ="*"></asp:RequiredFieldValidator>
                        ...
                        ForeColor="Blue" ValidationGroup="BuscaItem" ><img style="height:auto;width:auto;" src="../images/busca.gif"alt="Buscar" /></asp:LinkButton>
                                ...
                                <tr >
                                    ...
                                    <td>
                                        <span style="display:none" id ="AdjuntarModal" ><img id="Adjuntar" src="../images/adjuntar.png" runat="server"
                                            style="width: 20px; height: 20px" alt="Adjuntar" title="Clic aquí para seleccionar"   />Adjuntar archivo</span>
                                    </td>
                                </tr>
                              ...
                              <%--          <img id="AdjuntoProy" name="AdjuntoProy" src="../images/adjuntar.png" runat="server" 
                                                                style="width: 20px; height: 20px" alt="Adjuntar" title="Adjuntar Archivo" class="AdjuntoProy" />
                                         <label id="lblAdjunto" name="lblAdjunto"></label> --%>       
                                            <span id ="AdjuntarUno">
                                            <input type="file" id="txtfile" name="txtfile" class="form-control" runat="server" style=" width:50%; display :inline-block;" onchange ="guardarFile()"  />
                                            
                                            <%--<asp:FileUpload ID="fuCargarArchivo" runat="server" size="50" 
                                                ToolTip="Se admiten archivos .doc,.xls,.docx,.xlsx,.jpg,.png,.pdf,.zip  Tam. máx 4MB" />--%>
                                            <a href="#" onclick="ClearFile();return false;">
                                            <img id="imgEliminar" alt="Link to this page" border="0" src="../images/delete.png" style=" display :inline-block;" ></img></a> &nbsp;<asp:RegularExpressionValidator 
                                                ID="revUpload" runat="server" ControlToValidate="txtfile" 
                                                ErrorMessage="Formato de archivo incorrecto" 
                                                ValidationExpression="^.+(.zip|.ZIP|.doc|.docx|.xls|.xlsx|.jpg|.png|.pdf)$" 
                                    ...
                                    <tr bgcolor="#F5F9FC">
                                        ...
                                        <td>
                                            <asp:TextBox ID="lblUnidad" runat="server" BackColor="#F3F3F3" Visible="False" 
                                    ...
                                    <tr bgcolor="#F5F9FC">
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                                                ...
                                                ValidationGroup="Guardar" Text ="*"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                                                ...
                                                ValidationGroup="Guardar" Text ="*" Display ="None" ></asp:RequiredFieldValidator>
                                            &nbsp; &nbsp;
                        ...
                        <tr>
                                        <td align="left">
                                            <asp:Button ID="cmdGuardar" runat="server" Text="Guardar detalle" 
                                                ...
                                                ValidationGroup="Guardar" Height="26px"  UseSubmitBehavior="false"  />
    ...
    <asp:HiddenField id="HdTipoArt" runat="server" Value="" />
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">
                                    Adjunto:</label>
                                <div class="col-sm-8">
                                    <input type="file" id="txtfile2" name="txtfile" class="form-control" runat="server" />
                                </div>
