<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmMonitorPedidosRevisor.aspx.vb" Inherits="logistica_Default" %>
...
<tr  ><td class="style2"       style="width: 30%;">
    Ver pedidos con mi revisión:&nbsp;&nbsp; <asp:DropDownList ID="cboInstancia" 
        runat="server" AutoPostBack="True" Height="16px" Visible="False">
            ...
            <td>Pedido N°/Trabajador: &nbsp;&nbsp;
                <asp:TextBox runat="server" ID="txtPedidoBuscar" style="width: 30%;" > </asp:TextBox>
                 <asp:Button ID="cmdBuscar" runat="server" Text="  Buscar" 
                                    BorderStyle="Outset" CssClass="Buscar" Width="87px" 
                        Height="26px" />
             </td>
                
            <td align="right" class="style2">
    <asp:Button ID="cmdEnviar" runat="server" Text="  Enviar" 
                                    CssClass="salir" Width="87px" 
...
<tr height="280"><td valign="top" class="contornotabla" colspan="2" >
   <%-- <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="VE" Name="tipo" Type="String" />
            <asp:QueryStringParameter DefaultValue="0" Name="codigo_per" 
                QueryStringField="ID" Type="Int32" />
            <asp:ControlParameter ControlID="cboInstancia" DefaultValue="2" 
                Name="instancia" PropertyName="SelectedValue" Type="Int32" />
            <asp:ControlParameter ControlID="cboVeredicto" DefaultValue="P" 
                Name="veredicto" PropertyName="SelectedValue" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>--%>
    Lista de pedidos:
    <asp:Label ID ="lblHayPedidos" runat ="server" Visible ="False" 
        ForeColor="#CC0000" ></asp:Label>
    <asp:GridView ID="gvPedidos" runat="server" Width="100%" 
        AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" 
        DataKeyNames="Num,codigo_ejp,codigo_per" ForeColor="#333333" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Importe (S/.)" HeaderText="Importe (S/.)" 
                SortExpression="Importe (S/.)" DataFormatString="{0:##.00}" >
...
<tr height="430px" class="" valign="top"><td class="contornotabla" colspan="2">
    ...
    <tr><td>Proceso&nbsp;&nbsp;&nbsp;
        ...
        <td style="color: #0000FF" colspan="2">
            Almacen&nbsp;&nbsp;
          <asp:TextBox ID="txtAlmacen" runat="server" Enabled="False" Width="212px"></asp:TextBox>
        </td>
    </tr>
    </table>
    </TD>
    ...
    <td align="right">
        <asp:Button ID="cmdCalificar" runat="server" CssClass="guardar" 
            Text="Calificar" Width="95px" Height="23px" ValidationGroup="calificar" CausesValidation="true"  
            Enabled="False"/>
        </td>
    </tr>
    <tr>
    <td colspan=3 ><span runat="server" id="lblobs">Obs:</span>
    ...
    <td>
        ...
        <asp:Panel ID="pnlDatos" runat="server" Visible="False">
            ...
            <asp:GridView ID="gvDetallePedido" runat="server" 
                ...
                DataKeyNames="codigo_dpe,modoDistribucion_Dpe,descripcionEstado_Eped" ForeColor="#333333" 
    ...
    <tr>
    <td>
            <asp:Panel ID="pnlCargar" runat="server" BorderWidth="1px" Visible="False">
                Cargar importe no presupuestado a otro centro de costos<table 
                    style="width:100%;">
                    <tr>
                        <td class="style3">
                            Centro Costos</td>
                        <td>
                            :</td>
                        <td>
                            <asp:DropDownList ID="ddlCecoDestino" runat="server" AutoPostBack="True" 
                    ...
                    <tr>
                        ...
                        <td>
                            :</td>
                        <td>
                            <asp:GridView ID="gvPresupuestoTransferir" runat="server" 
                                AutoGenerateColumns="False">
                                <Columns>
                                    <asp:BoundField DataField="codigo_dpr" HeaderText="cod" />
                                    <asp:BoundField DataField="descripcion_Ppr" HeaderText="Prog. Presupuestal" />
                                    <asp:BoundField DataField="DesEstandar" HeaderText="Descripción" />
                                    <asp:BoundField DataField="PreUnitario" DataFormatString="{0:##.00}" 
                                        HeaderText="PreUnitario">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Cantidad" DataFormatString="{0:##.00}" 
                                        HeaderText="Cantidad">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Disponible" DataFormatString="{0:##.00}" 
                    ...
                    <tr>
                        ...
                        <td>
                            :</td>
                        <td>
                            <asp:Label ID="lblNoPresupuestado" runat="server"></asp:Label>
                            <asp:Label ID="lblMensajeNoCubre" runat="server" ForeColor="Red" 
                                Text="*El importe disponible no cubre el importe no presupuestado" 
                                Visible="False"></asp:Label>
                            <asp:Label ID="lblMensajeSeleccione" runat="server" ForeColor="Red" 
                                Text="*Debe seleccionar un ítem del presupuesto" Visible="False"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="style3">
                        ...
                        <td>
                            &nbsp;</td>
                        <td>
                            <asp:Button ID="cmdTransferir" runat="server" CssClass="regresar2" 
                                Text="Guardar" />
                            &nbsp;&nbsp;&nbsp;
                            </td>
                    </tr>
