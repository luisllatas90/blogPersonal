    ...
    <div>
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td class="style3">
                    <img alt="" src="MOD_Calidad.png?x=3" style="width: 150px; height: 150px" />
                </td>
            ...
            <tr>
                ...
                <td class="style3">
                 ...
                 <td class="style3">
                    <asp:Button ID="cmdReglamento38" runat="server" Style="text-align: center" Text="Descargar"
                        OnClientClick="target ='_blank';" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="style3">
                    <img alt="" src="REGL_PREV_HOSTIG_SEXUAL.png?x=3" style="width: 150px; height: 150px" />
                </td>
            ...
            <tr>
                ...
                <td class="style3">
                    <asp:Button ID="Button11" runat="server" Style="text-align: center" Text="Descargar"
                        OnClientClick="target ='_blank';" />
                </td>
            ...
            <tr>
                ...
                <td class="style3">
                    <img alt="" src="DIR_GRU_INV_USA.jpg?x=1" style="height: 150px; width: 150px" />
                </td>
            </tr>
            <tr>
                <td class="style3">
                ...
                <td class="style3">
                    <asp:Button ID="Button15" runat="server" Style="text-align: center"
                        Text="Descargar" OnClientClick="target ='_blank';" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="style3">
                    <img alt="" src="LIN_DOC_TUT_ACA_COM.jpg" style="width: 150px; height: 150px" />
                </td>
            </tr>
            <tr>
                <td class="style3">
                ...
                <td class="style3">
                    <asp:Button ID="cmdReglamento37" runat="server" Style="text-align: center" Text="Descargar"
                        OnClientClick="target ='_blank';" />
                </td>
            </tr>
            <tr>
