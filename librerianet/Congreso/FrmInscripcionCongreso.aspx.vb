...
Partial Class FrmInscripcionCongreso
    ...
    Dim UrlPeticion As String = "http://serverdev/campusvirtual/Congreso/CongresoUsat.asmx"  'DEV
    'Dim UrlPeticion As String = "http://serverqa/campusvirtual/Congreso/CongresoUsat.asmx"  'QA
    'Dim UrlPeticion As String = "http://localhost/campusvirtual/Congreso/CongresoUsat.asmx"  'PROD

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If IsPostBack = False Then
                Me.hdtoken.Value = "XYZ6LT77" 'Request("Evento")
                Me.hdevento.Value = "11" 'Request("Evento")
                InfoCentroCostos()
                ListaUniversidades()
