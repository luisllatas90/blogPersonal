...
Partial Class InscripcionEvento
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Response.Write(Request.Form("token"))
        ...
        Try
            If IsPostBack = False Then
				...
				if Request.Form("token") = "" then
					Me.hdtoken.Value = Request.Form("evento")  '->  desde web usat temporal
				else
					Me.hdtoken.Value = Request.Form("token") '"YCCE4V4D"  -> I CONGRESO INTERNACIONAL DE ENFERMERIA 2019	
				end if
                ...
                'ListaTipoParticipante() 'Se descomenta 06/11/19

                Dim tipoParticipante As String

                If Not Request.Form("p") Is Nothing Then '07/11/19

                    Select Case Desencriptar(Request.Form("p"))

                        Case "E"
                            tipoParticipante = "1"  ' estudiante Usat
                        Case "G"
                            tipoParticipante = "3"  ' egresado Usat
                        Case "P"
                            tipoParticipante = "9"  'posgrado Usat
                        Case ""
                            tipoParticipante = ""
                ...
                Else
                    ListaTipoParticipante() 'TODOS // PROFESIONAL NACIONAL(5), ESTUDIANTE NACIONAL(4) 
                End If
    ...
    Protected Sub btnInscribir_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnInscribir.Click
        ...
        Try
            ...
            Else
                ...
                Page.RegisterStartupScript("redireccionar1", "<script>setTimeout(function(){location.href ='http://www.usat.edu.pe';}, 9000);</script>")
            End If
    ...
    'Protected Sub ListaTipoParticipante3()
    '    Try
    '        Dim list As New Dictionary(Of String, String)
    '        list.Add("token_cco", Me.hdtoken.Value.ToString)
    '        Dim obj As New ClsCongreso
    ...
    '        For i As Integer = 1 To dt.Rows.Count
    '            ' Response.Write(dt.Rows(i - 1).Item("cod").ToString & "--" & tp & "<br>")
    '            If (dt.Rows(i - 1).Item("cod").ToString = 4) Or (dt.Rows(i - 1).Item("cod").ToString = 5) Then
    '                Me.ddltipoparticipante.Items.Add(dt.Rows(i - 1).Item("des").ToString)
    '                Me.ddltipoparticipante.Items(j).Value = dt.Rows(i - 1).Item("cod").ToString
    '                j = j + 1
    '            End If
    ...
    Private Sub enviarEmailInscripcion(ByVal descripcion_cco As String, ByVal apepat As String, ByVal apemat As String, ByVal nombres As String, ByVal nrodoc As String, ByVal universidad As String, ByVal email As String, ByVal fechanacimiento As String, ByVal monto As String, ByVal fechavenc As String)
        ...
        Try
            ...
            'If fechavenc IsNot Nothing Or fechavenc <> "" Then '06/11 se cambia
            '    mensaje = mensaje + "</td></tr></table>"
    ...
    Protected Sub ddltipoparticipante_ServerChange(ByVal sender As Object, ByVal e As EventArgs) Handles ddltipoparticipante.ServerChange
        ...
        Try
            ...
            Else
                Dim tipoParticipante As String   ''--- Se comenta 06/11/19

                If Not Request.Form("p") Is Nothing Then
                ...
                Else
                    ...
                    tipoParticipante = "5" ' PROFESIONAL NACIONAL
