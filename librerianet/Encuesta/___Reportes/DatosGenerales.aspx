                ...
                <td>
                    <asp:GridView ID="GvDatosGenerales" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Ciclo Ing" HeaderText="Ciclo Ing" 
                            ...
                            <asp:BoundField DataField="Lee Ingles" HeaderText="Lee Ingles" 
                                SortExpression="Lee Ingles" />
                            <asp:BoundField DataField="Escribe Ingles" HeaderText="Escribe Ingles" 
                                SortExpression="Escribe Ingles" />
                            <asp:BoundField DataField="Institucion Ingles" HeaderText="Institucion Ingles" 
                                SortExpression="Institucion Ingles" />
                            <asp:BoundField DataField="Certificacion Ingles" 
                                HeaderText="Certificacion Ingles" SortExpression="Certificacion Ingles" />
                            <asp:BoundField DataField="Institución Cert. Ingles" 
                                HeaderText="Institución Cert. Ingles" 
                                SortExpression="Institución Cert. Ingles" />
                            <asp:BoundField DataField="Habla Frances" HeaderText="Habla Frances" 
                                SortExpression="Habla Frances" />
                            <asp:BoundField DataField="Lee Frances" HeaderText="Lee Frances" 
                                SortExpression="Lee Frances" />
                            <asp:BoundField DataField="Escribe Frances" HeaderText="Escribe Frances" 
                                SortExpression="Escribe Frances" />
                            <asp:BoundField DataField="Institución Frances" 
                                HeaderText="Institución Frances" SortExpression="Institución Frances" />
                            <asp:BoundField DataField="Certificación Frances" 
                                HeaderText="Certificación Frances" SortExpression="Certificación Frances" />
                            ...
                            <asp:BoundField DataField="Frec. Reconciliacion" 
                                HeaderText="Frec. Reconciliacion" SortExpression="Frec. Reconciliacion" />
