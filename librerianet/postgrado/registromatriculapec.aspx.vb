Partial Class registromatriculapec
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            obj.AbrirConexion()
            ClsFunciones.LlenarListas(Me.dpPrograma, obj.TraerDataTable("PEC_ConsultarProgramaEC", 8, codigo_usu, codigo_tfu, "PG"), "codigo_pec", "descripcion_pes", "--Seleccione--")
            obj.CerrarConexion()
            obj = Nothing
    ...
    Protected Sub grwParticipantes_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grwParticipantes.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            e.Row.Cells(7).Attributes.Add("onclick", "return confirm('Acción irreversible: ¿Esta seguro que desea eliminar el participante?');")
    ...
    Protected Sub imgGuardar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        Dim obj As New ClsConectarDatos
        Try
            Dim apellidopat_alu As String
            Dim apellidomat_alu As String
            Dim nombres_alu As String
            Dim sexo_alu As String
            Dim codigo_usu As Integer = Request.QueryString("id")
            ...
            obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
            obj.AbrirConexion()
            obj.Ejecutar("PEC_AgregarMatriculaPEC", Me.dpPrograma.SelectedValue, UCase(apellidopat_alu), UCase(apellidomat_alu), UCase(nombres_alu), sexo_alu, Me.GeneraClave(), codigo_usu,0, "").copyto(mensaje, 0)
            obj.CerrarConexion()
            obj = Nothing
            If mensaje(0).ToString <> "" Then
                Me.lblmensaje.Text = mensaje(0)
