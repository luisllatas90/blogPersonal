<%@ Page Language="VB" AutoEventWireup="false" CodeFile="vstconsolidadoresprofesores_rango.aspx.vb" Inherits="academico_vstconsolidadoresprofesores_rango" %>
...
<body>
    ...
    &nbsp;<b>Semestre Acad. Inicial</b>:
    <asp:DropDownList ID="dpCicloIni" runat="server">
    </asp:DropDownList>
    &nbsp;
        <b>Semestre Acad. Final</b>:
    <asp:DropDownList ID="dpCicloFin" runat="server">
    </asp:DropDownList>
    &nbsp;
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
            ...
            HorizontalAlign="Center" BackColor="#e8eef7" Font-Bold="True" ForeColor="#3366CC" />
                    <EmptyDataTemplate>
                        <p class="rojo"><b>No se han encontrado Docentes registrados</b></p>
                    </EmptyDataTemplate>
