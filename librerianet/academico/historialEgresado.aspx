<%@ Page Language="VB" AutoEventWireup="false" CodeFile="historialEgresado.aspx.vb" Inherits="personal_academico_estudiante_historial" %>
                ...
                <tr>
                    <td colspan="2" style="width: 85%" width="15%">
                        ...
                        <asp:Button ID="cmdVer" runat="server" 
                            Text="Ver Historial por ciclo del curso" visible="false" />
                    </td> 
                </tr>
            </table>
        </asp:Panel>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            ...
                            ShowFooter="True">
                            <RowStyle BorderColor="GhostWhite" BorderStyle="Solid" BorderWidth="1px" />
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Observaciones" Visible=false >
                                    <ItemStyle HorizontalAlign="Center" CssClass="rojo" Width="15%" />
                                </asp:BoundField>
                                <asp:HyperLinkField HeaderText="Detalles" Text="Ver" Visible=false >
                                    <ItemStyle HorizontalAlign="Center" Font-Underline="True" ForeColor="#0000CC" 
                                        Width="5%" />
                                </asp:HyperLinkField>
                            </Columns>
                            <FooterStyle 
            HorizontalAlign="Center" BackColor="Snow" Font-Bold="True" ForeColor="Black" />
                            <HeaderStyle BackColor="Snow" ForeColor="Black" BorderColor="#99BAE2" 
