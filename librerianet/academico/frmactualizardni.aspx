<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmactualizardni.aspx.vb" Inherits="frmactualizardni" %>
        ...
        <tr>
            ...
            <td style="width: 75%" colspan="2">
                <asp:TextBox ID="txtClaveActual" runat="server" TextMode="Password" 
                    MaxLength="20"></asp:TextBox>&nbsp;<asp:Label ID="Label1" runat="server" 
                    ForeColor="Red" 
