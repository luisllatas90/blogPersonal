<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmQuitarEgresadoAlumni.aspx.vb"
    Inherits="academico_frmQuitarEgresadoAlumni" %>

<%@ Register Assembly="BusyBoxDotNet" Namespace="BusyBoxDotNet" TagPrefix="busyboxdotnet" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Egresado: Administrar Egresados</title>
...
<body>
    ...
    <p class="usatTitulo">
        Egresado: Revertir el Egreso registrado a un estudiante
    </p>
<%--    <asp:Label ID="lblmensaje" runat="server" Text="ADVERTENCIA: Actualizar esta información permitirá obtener informes y 
    ...
    esta información" CssClass="azul" Visible="False"></asp:Label>
    <br />--%>
    <br />
    ...
    <table cellpadding="3" cellspacing="0" style="width: 100%; border: 1px solid #96ACE7"
        ...
        <tr>
            ...
            <td class="style5">
                <asp:Label ID="Label2" runat="server" Text="Semestre de Egreso:" Font-Bold="True"
                    ForeColor="#E33439"></asp:Label>
            </td>
            <td class="style5">
    ...
    <table cellpadding="3" cellspacing="0" style="width: 100%; border: 1px solid #96ACE7"
        ...
        <tr>
            <td class="style5" style="width:50%;">
                &nbsp;&nbsp;&nbsp;<asp:Button ID="cmdGuardar" runat="server" Text="Restablecer" Visible="False" />
            </td>
            <td class="style5" style="width:50%;">
                <span class="style4">Cronograma: </span>
                <asp:Label ID="lblCronograma" runat="server" Text="Label" Style="font-weight: 700"></asp:Label>
            </td>
        </tr>
<%--        <tr>
            <td>
                <p>
                    La información puede ser verificada en la opción Cursos Faltantes *
                </p>
            </td>
        </tr>--%>
    </table>
    <br />
    <asp:GridView ID="grwEgresados" runat="server" AutoGenerateColumns="False"
        BorderStyle="Solid" CaptionAlign="Top" DataKeyNames="codigo_alu" Width="100%"
        BorderColor="Silver" EnableModelValidation="True" CellPadding="2">
        <RowStyle BorderColor="#C2CFF1" BorderStyle="Solid" BorderWidth="1px" Height="14px" />
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="codigo_alu" DataNavigateUrlFormatString="frmLinkEgresados.aspx?param=1&id={0}"
                DataTextField="alumno" HeaderText="Apellidos y Nombres" Target="_blank">
                <ControlStyle Font-Underline="True" ForeColor="Blue" />
            </asp:HyperLinkField>
            <asp:BoundField DataField="cicloing_alu" HeaderText="Semestre Ingreso"></asp:BoundField>
...
<%--            <asp:BoundField DataField="cCreditosAprobados_alu" HeaderText="Crd. Aprobados">
            ...
            <asp:BoundField DataField="totalCredElecObl_Pes" HeaderText="Cred. Obl. Electivo">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField DataField="totalCreObl_Pes" HeaderText="Cred. Plan Estudio">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>--%>
            <asp:BoundField DataField="Ciclo_Egr" HeaderText="Semestre Egreso" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="descripcion_Cac" HeaderText="Ult. Matricula" ItemStyle-HorizontalAlign="Center" />
    ...
    <busyboxdotnet:BusyBox ID="BusyBox1" runat="server" BackColor="White" Overlay="False"
        Text="Se está procesando su información" Title="Por favor espere" />
    </form>
</body>
</html>
