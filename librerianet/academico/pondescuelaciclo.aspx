<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pondescuelaciclo.aspx.vb"
    Inherits="pondescuelaciclo" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        @keyframes@keyframesspin{0%{transform:rotate(0deg);}100%{transform:rotate(360deg);}</style>
</head>
<body>
    ...
    <p class="usattitulo">
        Cuadro de Méritos Estudiante por Carrera Profesional</p>
    <table cellpadding="3" cellspacing="0" style="width: 100%;" id="tblCriterios">
        ...
        <tr>
            ...
            <td height="5%" width="80%">
                ...
                <asp:DropDownList ID="dpFiltro" runat="server" AutoPostBack="True">
                    ...
                    <asp:ListItem Value="M">Medio Superior (sólo PRONABEC)</asp:ListItem>
        ...
        <tr>
            ...
            <td height="5%" width="80%">
                ...
                <asp:Button ID="cmdExportar" runat="server" CssClass="excel2" Text="  Exportar" Style="width: 100px;
                    height: 24px;" OnClientClick="document.all.tblmensaje.style.display='none'" />
            </td>
        </tr>
        <tr>
            <td height="5%" width="20%" colspan="2" style="width: 100%">
                <asp:Label ID="Label2" runat="server" ForeColor="Red" Text="- Para el cálculo del promedio se consideran los créditos efectivamente cursados, se excluyen: Convalidaciones, exámenes extraordinarios.  (Art. 43)"
                    Visible="False"></asp:Label>
                <br />
                <asp:Label ID="Label1" runat="server" ForeColor="Red" Text="- Se excluye del cuadro de mérito: Estudiantes que no se encuentran dentro del periodo regular de acuerdo al plan de estudios. (Art. 45)"
                    Visible="False"></asp:Label>
                <br />
                <asp:Label ID="Label3" runat="server" ForeColor="Red" Text="- Para la ubicación del cuadro de mérito en el caso que dos estudiantes tengan igual promedio ponderado acumulado se preferirá aquel estudiante que no desaprobó ninguna asignatura. (Art. 45)"
                    Visible="False"></asp:Label>
            </td>
        </tr>
        <tr>
            <td height="5%" width="100%" colspan="2">
                ...
                <div id="modalBody">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ForeColor="#333333" AllowSorting="True" Width="100%" DataKeyNames="codigo_alu"
                        GridLines="None">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="alumno" HeaderText="APELLIDOS Y NOMBRES">
                                <HeaderStyle Font-Underline="False" Font-Names="Arial" Font-Size="X-Small" Height="10px" />
                                <ItemStyle Width="40%" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="numSem" HeaderText="NÚM SEMESTRES">
                                <HeaderStyle Font-Names="Arial" Font-Size="X-Small" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="credMat" HeaderText="CRÉD MATRICULADOS">
                                <HeaderStyle Font-Names="Arial" Font-Size="X-Small" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="credApro" HeaderText="CRÉD APROBADOS">
                                <HeaderStyle Font-Names="Arial" Font-Size="X-Small" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="DifCred" HeaderText="DIFF CRÉDITOS">
                                <HeaderStyle Font-Names="Arial" Font-Size="X-Small" Height="10px" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Ponderado" HeaderText="PPA" DataFormatString="{0:F2}">
                                <HeaderStyle Font-Underline="False" Font-Names="Arial" Font-Size="X-Small" Height="10px" />
                                <ItemStyle Width="10%" HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="Consultas" Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="lblHistorial" runat="server" Font-Underline="True" ForeColor="Blue"
                                        Text="Historial"></asp:Label>
                                    &nbsp;|
                                    <asp:Label ID="lblBeca" runat="server" Font-Underline="True" ForeColor="Blue" Text="Beneficio"></asp:Label>
                                </ItemTemplate>
                        ...
                        <EmptyDataTemplate>
                            <p class="usatsugerencia">
                                &nbsp;&nbsp;&nbsp;&nbsp; No se han encontrado registros con el criterio seleccionado</p>
                        </EmptyDataTemplate>
