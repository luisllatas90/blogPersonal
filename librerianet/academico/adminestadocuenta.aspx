...
<asp:Button ID="cmdExportar" runat="server" CssClass="imprimir2" 
        ...
        <tr>
            <td colspan="2" id="divObs" >             
                <asp:Panel ID="Panel1" runat="server">
                    <!-- * Para la <b>matrícula 2013-II</b> el <b>Monto de matrícula</b> tendrá como fecha 
                de <b>vencimiento 11-08-2013 </b>y <span class="style1">variará gradualmente</span> de acuerdo al cronograma establecido por la oficina de Pensiones. -->
                </asp:Panel>
            </td>
        </tr>
        <tr>
    ...
    <asp:Panel ID="pnlAviso" runat="server">
        <p class="etiqueta">
            <u>Aviso:</u></p>        
        <b><font color="#FF0000">Deberá acudir a cancelar en cualquier agencia del Banco 
        de Crédito o Interbank a nivel nacional, indicando su número de DNI.</font></b> 
    </asp:Panel>
</form>
</body>
</html>
