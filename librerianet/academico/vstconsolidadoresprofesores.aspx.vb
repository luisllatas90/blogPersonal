...
Partial Class personal_academico_tesis_vstconsolidadoresprofesores
    ...
    Protected Sub cmdBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdBuscar.Click
        ...
        Me.GridView2.DataSource = obj.TraerDataTable("ConsultarConsolidadoResponsabilidadesProfesores", 0, Me.dpCiclo.SelectedValue, Me.dpDpto.SelectedValue)
        Me.GridView2.DataBind()

        Me.GridView1.DataSource = obj.TraerDataTable("ConsultarConsolidadoResponsabilidadesProfesores", 1, Me.dpCiclo.SelectedValue, Me.dpDpto.SelectedValue)
