...
Partial Class cartacompromisoEstudiante
    ...
    Protected Sub cmdBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdBuscar.Click
        ...
        Tbl = obj.TraerDataTable("consultaracceso", "E", Me.txtcodigouniversitario.text, 0)
    ...
    Protected Sub cmdGenerar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdGenerar.Click
        ...
        Try
            ...
            lbltenor1.Text = lbltenor1.Text & " identificado con Código de Matrícula " & Me.txtcodigouniversitario.text
            ...
            lbltenor2.Text = lbltenor2.Text & "En ese sentido, el estudiante se <span style='font-weight:bold'><u>compromete a APROBAR</u></span> en el presente semestre " & Me.dpcodigo_cac.SelectedItem.Text
            lbltenor2.Text = lbltenor2.Text & ", las asignaturas señaladas, declarando conocer sobre las consecuencias de su "
            lbltenor2.Text = lbltenor2.Text & "incumplimiento establecido en el artículo nº 48 del reglamento de estudios de Pregrado "
            lbltenor2.Text = lbltenor2.Text & "en el que también dispone el retiro del estudiante en caso de reincidencia.</p>"
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=cargacompromiso-" & Me.txtcodigouniversitario.text & ".doc")
        ...
        Catch ex As Exception
            obj = Nothing
            Me.cmdGenerar.Enabled = True
            Me.lblmensaje.Text = "Ocurrió un Error al actualizar los datos. Contáctese con serviciosti@usat.edu.pe"            
        End Try
    End Sub
