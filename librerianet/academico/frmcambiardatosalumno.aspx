<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmcambiardatosalumno.aspx.vb" Inherits="frmcambiardatosalumno" %>
...
<head id="Head1" runat="server">
    ...
    function ValidarEmail(source, arguments){
      var campo=document.getElementById("email_alu").value
      var ubicacion
      var enter = "\n"
    ...
    function ValidarEmail2(source, arguments){
      var campo=document.getElementById("email2_alu").value
      var ubicacion
      var enter = "\n"
      var caracteres = "abcdefghijklmnñopqrstuvwxyzn1234567890_-." + String.fromCharCode(13) + enter
      var contador = 0
...
<body bgcolor="#f0f0f0">
    ...
    <table style="width:100%" bgcolor="White" cellpadding="3" cellspacing="0">
        ...
        <tr>
            <td colspan="3" style="width: 100%; background-color: #FFFFCC;">
                Bitacora de Cambios:&nbsp;
                <asp:DropDownList ID="dpBitacora" runat="server" AutoPostBack="True">
                </asp:DropDownList>
&nbsp;&nbsp;
            (*) Campos obligatorios.
            </td>
        ...
        <tr>
            ...
            <td style="width: 25%">
                Email Secundario</td>
            <td style="width: 75%">
                <asp:TextBox ID="email2_alu" runat="server" CssClass="cajas" 
                    MaxLength="30"></asp:TextBox>
        ...
        <tr>
            ...
            &nbsp;Distrito:
                <asp:DropDownList ID="Distrito_dal" runat="server">
                </asp:DropDownList>
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="Distrito_dal"
...
&nbsp;<asp:Button ID="cmdCancelar" runat="server" CssClass="noconforme1" 
        Text="       Cancelar" ValidationGroup="cancelar" 
            onclientclick="top.window.close();return(false)" UseSubmitBehavior="False" />
        <asp:HiddenField ID="hdID" runat="server" Value="0" />
        <asp:HiddenField ID="hdOp" runat="server" Value="0" />
    </p>
