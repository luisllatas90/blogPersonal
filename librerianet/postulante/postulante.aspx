<%@ Page Language="VB" AutoEventWireup="false" CodeFile="postulante.aspx.vb" Inherits="librerianet_postulante_postulante" %>
...
<body>
    ...
    <p class="usatTitulo">
        Lista de Postulantes registrados
    </p>    
    <table cellpadding="0" cellspacing="0" style="width: 100%; border:1px solid #96ACE7" border="0">
        <tr bgcolor="#91b4de" style="height:30px">
            <td style="width:80%">
                &nbsp;&nbsp;&nbsp;
                Buscar por: &nbsp;<asp:TextBox ID="txtbuscar" runat="server" CssClass="Cajas" 
                    Width="200px" MaxLength="20"></asp:TextBox>
                &nbsp;<asp:DropDownList ID="dpcampo" runat="server">
                    <asp:ListItem Value="3">Apellidos / Nombres</asp:ListItem>
                    <asp:ListItem Value="4">Grado</asp:ListItem>
                    <asp:ListItem Value="5">Apoderado</asp:ListItem>
                    <asp:ListItem Value="6">Colegio</asp:ListItem>
                    <asp:ListItem Value="7">Escuela Profesional</asp:ListItem>
                    <asp:ListItem Value="8">Radio</asp:ListItem>
                    </asp:DropDownList>
                &nbsp;<asp:Button ID="cmdBuscar" runat="server" Text="Buscar" 
                    CssClass="buscar2" Width="70px" EnableViewState="False" 
                    ValidationGroup="cancelar" />
            &nbsp;&nbsp;
            </td>
            <td style="width:20%" align="right">
    <asp:Button ID="cmdNuevo" runat="server" Text="Nuevo" CssClass="agregar2" 
                    ValidationGroup="cancelar" Width="70px" EnableViewState="False" />
        &nbsp;&nbsp;
        <asp:Button ID="cmdExportar" runat="server" Text="    Exportar" CssClass="excel2" 
                    Width="70px" ValidationGroup="cancelar" />
            </td>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        CellPadding="2" GridLines="Horizontal" BorderStyle="None" DataKeyNames="codigo_pot">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="fechareg_pot" HeaderText="Fecha Reg.">
                <ItemStyle Width="10%" />
            </asp:BoundField>
            <asp:BoundField DataField="postulante" HeaderText="Apellidos y Nombres">
            ...
            <asp:BoundField DataField="telefono_pot" HeaderText="Teléfono" >
                <ItemStyle Width="5%" />
            </asp:BoundField>
            <asp:BoundField DataField="grado_dpo" HeaderText="Grado" >
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:ButtonField ButtonType="Image" CommandName="CargarFichaDatos" 
                HeaderText="Modificar" ImageUrl="../../images/editar.gif" Text="Modificar" 
                ValidationGroup="cancelar">
                <ItemStyle HorizontalAlign="Center" />
            </asp:ButtonField>
            <asp:TemplateField HeaderText="Acción" Visible="False">
                <ItemTemplate>
                    <asp:ImageButton ID="LnkModificar" runat="server" 
                        ImageUrl="../../images/editar.gif" 
                        ValidationGroup="cancelar" />
                    <cc1:ModalPopupExtender ID="mpeFicha" runat="server" 
                        BackgroundCssClass="FondoAplicacion" CancelControlID="cmdCancelar" 
                        PopupControlID="PanelDatos" TargetControlID="LnkModificar" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
        <EmptyDataTemplate>
    ...
    <br />
    <asp:UpdatePanel ID="PanelDatos" runat="server">
        <ContentTemplate>
	<table style="width:90%; background-color:White;" class="contornotabla_azul" cellpadding="3" cellspacing="0">
                ...
                <tr>
                    ...
                    ErrorMessage="Seleccione el Colegio" Operator="NotEqual" 
                    ValueToCompare="-2">*</asp:CompareValidator>
    ...
    <cc1:ModalPopupExtender ID="mpeFicha" runat="server"
        ...
        TargetControlID="cmdNuevo"  BackgroundCssClass="FondoAplicacion" />
