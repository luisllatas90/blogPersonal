...
Public Class clsPlanilla
    ...
    Public Function ConsultarFuncionQuinta(ByVal codigo_per As Int32) As Data.DataTable
        Dim dts As New Data.DataTable
        cnx.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
        cnx.AbrirConexion()
        dts = cnx.TraerDataTable("PRESU_ConsultarFuncionQuintaPorUsuario", codigo_per)
        cnx.CerrarConexion()
        Return dts
    End Function
