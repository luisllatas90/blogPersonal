Partial Class FrmRegistraTitulo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            cargarDatosPagina()
            If Page.Request.QueryString("mod2") IsNot Nothing Then
                btnActualizar_Click(decode(Page.Request.QueryString("mod2")))
            End If
    ...
    Sub cargarDatosPagina()
        ...
        Me.LblFT.Visible = Not Me.CheckBox1.Checked
    ...
    Sub registrar()
        Try
            If validar() Then
                ...
                obj.Ejecutar("ALUMNI_RegistrarFormacionAcademica", Session("codigo_alu"), Me.dpAnioIngreso.SelectedValue.ToString, fechaEgreso, fechagrad, Me.txtGrado.Text, Me.txtUniversidad.Text, "", Me.dpProcedencia.SelectedValue.ToString, estado, "T", "")
                obj.CerrarConexion()
        ...
        If dpdiagrad.SelectedValue() <> "-1" Or dpmesgrad.SelectedValue() <> "-1" Then
            If dpAnioEgreso.SelectedValue <> "AÑO" And DDLAnio.SelectedValue <> "AÑO" Then
                If CInt(DDLAnio.SelectedValue) < CInt(dpAnioEgreso.SelectedValue) Then
                    mensaje &= "<br />La Fecha de Titulación no puede ser menor que Fecha Egreso"
                End If
            End If
        End If

        If Me.txtGrado.Text.Trim = "" Then
            mensaje &= "</br>Debe ingresar el Nombre de Título Profesional Obtenido."
        End If
