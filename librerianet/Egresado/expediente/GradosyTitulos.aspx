<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GradosyTitulos.aspx.vb" Inherits="GradosyTitulos" %>
...
<style type="text/css">
  ...
  <body>	
	...
	<table cellpadding="0" cellspacing="0" class="" style="width: 100%;">
	  <tr><td style="color:White; background:#e33439; font-size:14px;padding:3px;">&nbsp;Grados 
          y Titulos Obtenidos</td></tr>
	</table>&nbsp;
     <div style="padding-bottom:3px;">
        <div style="float:left;color: #e33439;font-weight: bold; font-size:8pt;">GRADOS ACADÉMICOS</div>
        <div style="float:right"><a style="text-decoration:none; color:Black;" runat="server" id='A2' class='ifancybox guardar' href="FormacionAcademicaRegistrar.aspx">Agregar Grado</a></div>   
     </div>
     <br /><br />
  ...
  <br /><br />
     <div style="padding-bottom:3px;">
        <div style="float:left;color: #e33439;font-weight: bold; font-size:8pt;">TITULOS PROFESIONALES</div>
        <div style="float:right"><a style="text-decoration:none; color:Black;" runat="server" id='A1' class='ifancybox guardar' href="FrmRegistraTitulo.aspx">Agregar Título</a></div>   
     </div>
     <br /><br />
