<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FormacionAcademicaRegistrar.aspx.vb" Inherits="FormacionAcademicaRegistrar" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    ...
    <style type="text/css">
        ...
        .guardar {border:1px solid #C0C0C0; background:#FEFFE1 ; width:80; font-family:Tahoma; font-size:8pt; font-weight:bold; height:25}
  ...
  <body>	
      ...
      <table style="width: 100%" class="" id="" cellpadding="2">  
          ...
          &nbsp;Registrar/Actualizar Grado Académico</td></tr>          
              <tr>
...
<asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" Checked="True" 
              ...
              <tr>
                <td class="style18">
                  <asp:Label ID="LblFG" runat="server" Text="Fecha de Graduación" Visible="false"></asp:Label>
                </td>
                <td class="style21">
                    <asp:DropDownList ID="dpdiagrad" runat="server"  
              ToolTip="Dia de Graduación" CssClass="datos_combo" Width="45px" Visible="false">
		    ...
		    <asp:DropDownList ID="dpmesgrad" runat="server" 
              ToolTip="Mes de Graduación" CssClass="datos_combo" Width="90px" Visible="false">
			...
			<asp:DropDownList ID="DDlAnio" runat="server" 
              ToolTip="Año de Graduación" CssClass="datos_combo" Height="16px" Width="63px" Visible="false"></asp:DropDownList>
            <asp:Label ID="Lblopcional" runat="server" CssClass="rojo" Text="&nbsp;&nbsp;&nbsp;* Registro Opcional" Visible="false"></asp:Label>
                </td>
              </tr>
              <tr>
                <td class="style18">Grado</td>
                <td class="style21">
