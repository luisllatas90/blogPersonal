...
Partial Class CVEgresado
    ...
    Function CargarDatosPersonales(Optional ByVal xdown As Boolean = False) As String
        ...
        If tbl.Rows.Count Then
            ...
            datosPersonales_html &= CrearFilasHead((tbl.Rows(0).Item("nombre_pro").ToString.ToUpper & ", " & tbl.Rows(0).Item("nombre_dep").ToString.ToUpper), "format_td3") '& " | " & tbl.Rows(0).Item("areapropuesta_fe")).ToString.ToUpper, "format_td3")
            If Not xdown Then
                datosPersonales_html &= "<tr>"
                datosPersonales_html &= "<td style=""padding-left:10px;"">"
                datosPersonales_html &= btn("cv_link.png", "Enlace Público", "../alumniusat.aspx?xcod=" & encode(Session("codigo_alu")))
                datosPersonales_html &= "</td>"
                datosPersonales_html &= "<td>"
            ...
            If Not xdown Then
                datosPersonales_html &= CrearFilas(btn("cv_edit.png", "Editar", "datospersonales.aspx", ""), "")
            End If
        ...
        Else
            If Not xdown Then
                datosPersonales_html = "Datos Personales: No existe información registrada"
            End If
        End If
        tbl.Dispose()
        obj.CerrarConexion()
    ...
    Function CargarExperienciaLaboral(Optional ByVal xdown As Boolean = False) As String
        ...
        If Not xdown Then
            experienciaLaboral_html &= CrearFilas(btn("cv_edit.png", "Editar", "experiencialaboral.aspx", ""), "")
        End If
        If TablaData.Rows.Count Then
            For i As Integer = 0 To TablaData.Rows.Count - 1
                ...
                experienciaLaboral_html &= CrearFilas("LABORES DESEMPEÑADAS", TablaData.Rows(i).Item("descripción").ToString.ToUpper)
                experienciaLaboral_html &= CrearFilas()
            Next
        Else
            If Not xdown Then
                experienciaLaboral_html &= CrearFilas("", "Aún no has registrado información")
            End If
    ...
    Function CargarGradosAcademicos(Optional ByVal xdown As Boolean = False) As String
        ...
        If Not xdown Then
            gradosAcademicos_html &= CrearFilas(btn("cv_edit.png", "Editar", "GradosyTitulos.aspx", ""), "")
        End If
        If TablaData1.Rows.Count Then
            For i As Integer = 0 To TablaData1.Rows.Count - 1
                ...
                gradosAcademicos_html &= CrearFilas("GRADUACIÓN (DIPLOMA)", TablaData1.Rows(i).Item("FechaActo"))
        ...
        Else
            If Not xdown Then
                gradosAcademicos_html &= CrearFilas("", "Aún no has registrado información")
            End If
        End If
    ...
    Function CargarTitulos(Optional ByVal xdown As Boolean = False) As String
        ...
        If Not xdown Then
            titulos_html &= CrearFilas(btn("cv_edit.png", "Editar", "GradosyTitulos.aspx", ""), "")
        End If
        If TablaData1.Rows.Count Then
        ...
        Else
            If Not xdown Then
                titulos_html &= CrearFilas("", "Aún no has registrado información")
            End If
        End If
    ...
    Function CargarIdiomas(Optional ByVal xdown As Boolean = False) As String
        ...
        If Not xdown Then
            idiomas_html &= CrearFilas(btn("cv_edit.png", "Editar", "IdiomasyOtros.aspx", ""), "")
        End If
        ...
        Else
            If Not xdown Then
                idiomas_html &= CrearFilas("", "Aún no has registrado información")
            End If
    ...
    Function CargarOtrosEstudios(Optional ByVal xdown As Boolean = False) As String
        ...
        obj.AbrirConexion()
        Dim TablaData2 As New Data.DataTable
        TablaData2 = obj.TraerDataTable("ALUMNI_ConsultarAlumni_OtrosEstudios", Session("codigo_alu")) '04/11/2013
        obj.CerrarConexion()
        obj = Nothing
        otros_html = CrearTablaInicial()
        otros_html &= CrearFilasHead("<u>OTROS ESTUDIOS</u>")
        If Not xdown Then
            otros_html &= CrearFilas(btn("cv_edit.png", "Editar", "IdiomasyOtros.aspx", ""), "")
        End If
        ...
        Else
            If Not xdown Then
                otros_html &= CrearFilas("", "Aún no has registrado información")
            End If
        End If
    ...
    Function CargarDatosAdicionales(Optional ByVal xdown As Boolean = False) As String
        ...
        If Not xdown Then
            otros_html &= CrearFilas(btn("cv_edit.png", "Editar", "otros.aspx", ""), "")
        End If
