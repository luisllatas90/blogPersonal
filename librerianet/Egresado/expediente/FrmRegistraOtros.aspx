<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmRegistraOtros.aspx.vb" Inherits="FrmRegistraOtros" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>	
      ...
      <table style="width: 100%" class="" id="" cellpadding="2">  
          ...
          &nbsp;Registrar/Actualizar Otros Estudios</td></tr>          
              <tr>
              ...
              <%--<tr>
                <td class="style18">Fecha de Titulación</td>
          ...
          MaximumValue="31" MinimumValue="1" SetFocusOnError="True" Type="Integer" ErrorMessage="Seleccione dia de Titulación">*</asp:RangeValidator>
            ...
            <asp:RangeValidator ID="RangeValidator3" runat="server" ControlToValidate="DDlAnio"
              ...
              <tr>
                <td class="style18">Estudio Realizado</td>
                <td class="style21">
                  <asp:TextBox ID="txtGrado" runat="server" Width="299px" CssClass="datos_combo"></asp:TextBox><br />Nombre del curso, taller, diplomado, programa...
                </td>
              </tr>
              <tr>
