        ...
        <tr>
            <td>
                <asp:Label ID="lblMensaje" runat="server" Font-Bold="False" Font-Size="Small" 
                    ForeColor="#3366CC" Visible="False"></asp:Label>
...
&nbsp;<asp:Button ID="cmdCancelar" runat="server" Text="Cancelar" CssClass="guardar" 
                ...
                <br />
                <br />
                <asp:Label ID="nro" runat="server" style="color: #800000; font-size: small"></asp:Label>
                <asp:GridView ID="gvRevision" runat="server" Caption="" 
                    CellPadding="4" EmptyDataText="No se cuenta con revisiones" Font-Bold="False" 
                    Font-Size="Medium" ForeColor="#990000" GridLines="None">
