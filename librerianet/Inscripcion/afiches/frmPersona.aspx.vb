...
Partial Class Inscripcion_frmPersona
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If IsPostBack = False Then
                ...
                ' Response.Write("TOKEN>> " & Request.Form("token"))

                If (Request.Form("token") <> Nothing) Then
                    'If (token <> Nothing) Then
                    'strToken = token 
                    strToken = Request.Form("token").ToString
                    ...
                    obj.CerrarConexion()
                End If
                '  Response.Write(Request.Form("Evento"))
                ...
                If (Request.Form("Evento") IsNot Nothing) Then
                    ...
                    Try
                        ...
                        'Me.lblHeader.Text = "Evento: " & "GESTION MATRICULAS/ESCUELA DE COMUNICACION"
                        obj.CerrarConexion()
    ...
    Private Sub MostrarDatosPrivados(ByVal sw As Boolean)
        ...
        'Me.txtFechaNac.Visible = sw
        'Me.dpSexo.Visible = sw
        'Me.dpEstadoCivil.Visible = sw
        'Me.txtcelular.Visible = sw
        'Me.txtMatrimonio.Visible = sw
        'Me.txtConyugue.Visible = sw
        'Me.txtdireccion.Visible = sw
        'Me.txttelefono.Visible = sw
    End Sub
    ...
    Protected Sub dpTipoDoc_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dpTipoDoc.SelectedIndexChanged
        ...
        If Me.dpTipoDoc.SelectedIndex = 1 Then
