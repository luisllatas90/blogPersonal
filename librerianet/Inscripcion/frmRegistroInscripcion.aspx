        ...
        <table>
            ...
            <tr>
                <td class="style2">
                    ...
                    <asp:Label ID="lblEstado" runat="server" Font-Bold="True" Font-Size="X-Large" 
                        ForeColor="Red" Text="La venta de entradas ha finalizado." Visible="False"></asp:Label>
                    <br />
                      ...
                      <tr>
                        ...
                        <td width="69%">
                            <asp:Label ID="txtPrecio" runat="server" Font-Bold="True" Font-Size="Large" 
                                ForeColor="Red">S/. 0.00</asp:Label>
                        </td>
                      </tr>
                      <tr>
                          <td class="style3">Nro. Cuotas</td>
                      ...
                      <tr class="style1">
                        <td>
                            <asp:Button ID="btnRegistrar0" runat="server" 
                                ...
                                Width="214px" CssClass="guardar_prp" ValidationGroup="datos" />
                            <asp:CheckBox ID="chkAcepto" runat="server" Font-Bold="True" ForeColor="Blue" 
                        ...
                        <td width="69%" class="rojo">
                            &nbsp;<asp:Label ID="lblcodigoconfirmacion" runat="server" 
                                ...
                                Visible="False"></asp:TextBox><asp:Button ID="btnRegistrar" runat="server" 
                                Text="Aceptar y Confirmar" Height="30px" 
                                Width="140px" CssClass="guardar_prp" ValidationGroup="datos" 
                                Visible="False" />&nbsp;
                ...
                <td>
                    <table>
                        <tr>
                            <td width="5%">                            
                                <asp:Image ID="ImgEvento" runat="server" /></td>   
                        </tr>       
                    </table>
                </td>
            </tr>
