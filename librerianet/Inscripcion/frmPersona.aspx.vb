...
Partial Class Inscripcion_frmPersona
    ...
    Private Sub CargaDatosEvento(ByVal Envia As String)
        ...
        Try
            ...
            obj.CerrarConexion()
        Catch ex As Exception
            Response.Write("Error al cargar datos del evento: " & ex.Message)
            obj.CerrarConexion()
        End Try
    End Sub
    ...
    Private Sub BuscarPersona(ByVal tipo As String, ByVal valor As String, Optional ByVal mostrardni As Boolean = False)
        ...
        Try
            ...
            tbl = Nothing
        Catch ex As Exception
            Me.lblmensaje.Text = "Error al buscar persona: " & ex.Message
    ...
    Private Sub MostrarDatosPrivados(ByVal sw As Boolean)
        ...
        'Me.fila6.Visible = False        
        'If (Me.HdBusqueda.Value.Trim = "S") Then
        'sw = True
        'Else
        'sw = False
        'End If
        ...
        'Me.dpSexo.Visible = False
        'Me.dpEstadoCivil.Visible = False
        'Me.txtcelular.Visible = False
        'Me.txtMatrimonio.Visible = False
        'Me.txtConyugue.Visible = False
    ...
    Protected Sub lnkComprobar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkComprobarNombres.Click
        ...
        If ValidarNroIdentidad() = True Then
            If lnkComprobarNombres.Text = "Clic aquí para buscar coincidencias" Then
                ...
                obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
                obj.AbrirConexion()
                Me.grwCoincidencias.DataSource = obj.TraerDataTable("PERSON_ConsultarPersona_v2", "APE", Me.txtAPaterno.Text.Trim & " " & Me.txtAMaterno.Text.Trim)
                ...
                If grwCoincidencias.Rows.Count > 0 Then
                    ...
                    Me.HdBusqueda.Value = "N"
                    Me.hdcodigo_pso.Value = 0
                    MostrarDatosPrivados(True)
                Else
                    Me.grwCoincidencias.Visible = False
                    Me.HdBusqueda.Value = "S"
                ...
                'Me.fila1.Visible = True
                'Me.fila3.Visible = True
                'Me.fila4.Visible = True
                'Me.fila5.Visible = True
                'Me.txtFechaNac.Visible = True
                'Me.dpSexo.Visible = True
                'Me.dpEstadoCivil.Visible = True
                'Me.txtcelular.Visible = True
                'Me.txtMatrimonio.Visible = True
                'Me.txtConyugue.Visible = True
                'Me.txtdireccion.Visible = True
                'Me.txttelefono.Visible = True
                'Response.Write("LINK")
            Else
                If (Me.lnkComprobarNombres.Text = "[Clic aquí si está seguro que es una persona nueva]") Then
                    MostrarDatosPrivados(True)
                End If
    ...
    Protected Sub lnkComprobarDNI_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkComprobarDNI.Click
        Try
            ...
            End If
        Catch ex As Exception
            Response.Write("Error al comprobar DNI: " & ex.Message)
        End Try
