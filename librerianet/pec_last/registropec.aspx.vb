Partial Class registropec
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            ClsFunciones.LlenarListas(Me.dpCodigo_Tpec, obj.TraerDataTable("PEC_ConsultarProgramaEC", 0, "FC", 0, 0), "codigo_tpec", "descripcion_tpec")
            ...
            'Cargar Programas
            Me.grwPEC.DataSource = obj.TraerDataTable("PEC_ConsultarProgramaEC", 2, codigo_usu, codigo_tfu, "FC")
            Me.grwPEC.DataBind()
