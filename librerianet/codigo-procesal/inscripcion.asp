<html>
<head>
<title>Programa de Especialiación en Finanzas -  Instituto Mayorga</title>
...
<form name="form1" method="post" action="registra.asp">
  <table border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td align="center" bgcolor="#980011"><img src="Encabezado.jpg" ></td>
    </tr>
    <tr bgcolor="#999999">
      ...
      <td bgcolor="#EFEFEF"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="0" id="AutoNumber1" style="BORDER-COLLAPSE: collapse">
        ...
        <tr>
          ...
          <td  align="left" valign="top"><p>
              <input name="txtnombres" size="20" onKeyPress="validarLetra()">
              <font size="1">Nombres</font> </p></td>
          <td colspan="5" align="left" valign="top"><input name="txtapellidos" size="40" onKeyPress="validarLetra()"  >
              <br>
        ...
        <tr>
          ...
          <td align="left">:</td>
          <td colspan="3" align="left"><input name="txtdireccion" size="35" ></td>
        ...
        <tr>
          ...
          <td align="left">:</td>
          <td align="left"><input name="txttelefono" size="15" onKeyPress="validarnumero()" ></td>
          <td width="83" align="left">Telf. Celular : </td>
          <td align="left"><input name="txtcelular" size="15" onKeyPress="validarnumero()" ></td>
          <td align="left"><span class="Estilo6">*</span> E- mail</td>
          <td align="left">:</td>
          <td align="left"><input name="txtemail" size="35" onlostfocus="validarEmail()" ></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="4%" width="150" align="left">Nombre de la Empresa</td>
          <td align="left">:</td>
        ...
        <tr>
          ...
          <td align="left"><span id="cual_03" >&Aacute;rea</span></td>
          <td align="left">:</td>
          <td align="left"><input name="txtarea" id="txtarea" size="32"  ></td>
        </tr>
        <tr>
          ...
          <td align="left">:</td>
          <td align="left"><input name="txtdistrito" id="txtdistrito" size="32" onKeyPress="validarLetra()"></td>
        </tr>
        <tr>
          <td height="2%" align="left">Tel&eacute;fono</td>
          <td align="left">:</td>
          <td colspan="3" align="left"><input name="txttelefonotrab" id="txttelefonotrab" width="80px" onKeyPress="validarnumero()"></td>
          <td align="left">Fax</td>
          <td align="left">:</td>
          <td align="left"><input name="txtfax" id="txtfax" size="32" onKeyPress="validarnumero()" ></td>
        </tr>
        <tr>
          <td height="2%" align="left">A quien reporta </td>
          <td align="left">:</td>
          <td colspan="3" align="left"><input name="txtreporta" id="txtreporta" size="35" onKeyPress="validarLetra()"  ></td>
        ...
        <tr>
          <td height="1%" colspan="5" align="left"><span class="Estilo1">Facturaci&oacute;n </span></td>
          <td align="left">&nbsp;</td>
          <td align="left">&nbsp;</td>
          <td align="left">&nbsp;</td>
        </tr>
        <tr>
          <td height="2%" colspan="5" align="left"><label><input type="radio" name="optdoc"  
                  id="optboleta" value="B" checked="true"> </label>
            Boleta
              <label>&nbsp;<input type="radio" name="optdoc"  id="optfactura" value="F"></label>Factura</td>
          <td align="left">RUC</td>
          <td align="left">&nbsp;</td>
          <td align="left"><input name="txtruc" id="txtruc" size="20" onKeyPress="validarnumero()"></td>
        </tr>
        <tr>
          <td height="2%" align="left">Facturar a nombre de</td>
          <td align="left">:</td>
          <td colspan="3" align="left"><input name="txtfacturara" id="txtfacturara" size="35" ></td>
          <td align="left">Direcci&oacute;n de la factura </td>
          <td align="left">:</td>
          <td align="left"><input name="txtdireccionfact" id="txtdireccionfact" size="35" ></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="2%" align="left"><span class="Estilo6">*</span> Plan</td>
          <td align="left">:</td>
          <td colspan="6" align="left"><label>
            <input name="optpago" type="radio" id="contado" value="contado" checked>
            Contado
            <input name="optpago" type="radio" id="credito" value="credito">
            Cr&eacute;dito
            --&gt; Nro cuotas
            <input name="txtnrocuotas" type="text" id="txtnrocuotas" size="5">
            <input name="optpago" type="radio" id="corporativo" value="corporativo">
            Dscto Corporativo
            <input name="optpago" type="radio" id="canje" value="canje">
            Canje
            <input name="optpago" type="radio" id="otros" value="otros">
            Otros</label></td>
        </tr>
        <tr>
          <td height="2%" align="left"><span class="Estilo6">*</span> Referencias</td>
          <td align="left">:</td>
          <td colspan="6" align="left"><p>
              <label>
              <input type="radio" name="optreferencias"  id="carta" value="carta">
                Carta </label>
              <label>
              <input type="radio" name="optreferencias" id="diario" value="diario">
                Diario </label>
              <label>
              <input type="radio" name="optreferencias" id="web" value="web">
                Web </label>
              <label>
              <input type="radio" name="optreferencias" id="email" value="email">
                E-mail </label>
              <label>
              <input type="radio" name="optreferencias" id="amigos" value="amigos">
                Amigos </label>
          </p></td>
        </tr>
        <tr>
...
- Universidad Cat&oacute;lica Santo Toribio de Mogrovejo. Facultad de Derecho<br>
Av. Panamericana Norte 855 <br>
- Centro de Conciliaci&oacute;n 
            y Arbitraje de la USAT. Manuel Mar&iacute;a Izaga 766.<br>
e-mail: cca@usat.edu.pe<br>
- Corte de Justicia de Lambayeque y Ministerio P&uacute;blico (Lugares autorizados).<br>
- Tel&eacute;fono: 233477 - Nextel: 827*7657 - RPC 979775919 - RPM #391411. </span></td>
    </tr>
  </table>
  <p>&nbsp;</p>
</form> 
