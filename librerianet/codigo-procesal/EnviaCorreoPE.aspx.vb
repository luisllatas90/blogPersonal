...
Partial Class EnviaCorreoPE_EnviaCorreoPE
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            ...
            Dim mensaje, asunto, A, De, concopia As String
            mensaje = ""
            asunto = "Nuevo inscrito [Diplomado en Negociación Aplicado al Nuevo Código Procesal Penal]"
            De = "campusvirtual@usat.edu.pe"
            A = "cca@usat.edu.pe"
            mensaje = "1 nuevo inscrito a la fecha " & Date.Now.ToShortDateString & "<br><br>"
            concopia = "iperez@usat.edu.pe"
            CrearMensaje(mensaje)
            enviamail.EnviarMail(De, A, asunto, mensaje, True, concopia)
    ...
    Private Sub CrearMensaje(ByRef Mensaje As String)
        ...
        While Tabla.Read
            ...
            With Tabla
                ...
                Mensaje = Mensaje & "<H5>DIPLOMADO EN NEGOCIACIÓN APLICADO AL NUEVO CÓDIGO PROCESAL PENAL</H5>"
