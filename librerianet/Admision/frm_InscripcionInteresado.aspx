<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_InscripcionInteresado.aspx.vb" Inherits="frm_InscripcionInteresado" validaterequest="true" %>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/inscripcionInteresado.css?40">
    ...
    <body>
        <noscript>
            <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PXZB68Q"
        ...
        <form id="frmInscripcionInteresado" runat="server">
            ...
            <input type="hidden" name="fechaHoraLimiteInscripcion" id="hddFechaHoraLimiteInscripcion" runat="server" />
            ...
            <input type="hidden" name="textoBtnInscripcion" id="hddTextoBtnInscripcion" runat="server" />
            ...
            <input type="hidden" name="inscripcionCampus" id="hddInscripcionCampus" runat="server" />
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <asp:TextBox ID="txtNumFijo" runat="server" CssClass="form-control form-control-sm" placeholder="Teléfono Fijo" />
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="form-group row" id="divDatosProfesion" runat="server">
                                            <div class="col-sm-5">
                                        ...
                                        <div class="form-group row" id="divConsultas" runat="server">
                                            <div class="col-sm-12">
                                                <asp:TextBox ID="txtConsultas" runat="server" TextMode="multiline" Rows="3" CssClass="form-control form-control-sm" placeholder="¿Tienes alguna consulta?" />
                                            </div>  
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="contenedor-terminos-condiciones row">
                                                    ...
                                                    <asp:UpdatePanel ID="udpConsideracionesAdmision" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                                                        <ContentTemplate>
                                                            <div id="divRequisitosAdmision" runat="server" class="custom-control custom-checkbox">    
                                                                <input type="checkbox" id="chkConsideracionesAdmision" runat="server" class="custom-control-input ignore">
                                                                <label for="chkConsideracionesAdmision" class="custom-control-label">
                                                                    Consideraciones del proceso de admisión -> <a href="#" id="lnkLeerConsideracionesAdmision">Leer aquí*</a>
                                                                </label>
                                                            </div>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                            ...
                                            <ContentTemplate>
                                                <div class="form-group row">
                                                    <div class="col-sm-12 text-center">
                                                        ...
                                                        <button id="btnFakeInscribirme" runat="server" class="btn btn-sm btn-primary"></button>
        ...
        <!-- Scripts propios -->
        <script src="js/inscripcionInteresado.js?120"></script>
