...
Partial Class librerianet_personal_frmRevisaDirPersonal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If cboSemana.Enabled = False Then cboSemana.SelectedIndex = 0
    ...
    Private Sub consultarVistaHorario()
        Dim obj As New clsPersonal
        Dim dts As New Data.DataTable
        dts = obj.ConsultarVistaHorario(codigo_per, codigo_pel, cboSemana.SelectedValue)
    ...
    Protected Sub btnAceptar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        Dim obj As New clsPersonal
        obj.AgregarHorarioPersonal(ddlDia.SelectedValue, ddlHoraInicio.SelectedValue, ddlHoraFin.SelectedValue, codigo_per, 1, ddlTipo.SelectedValue, codigo_pel, ddlEscuela.SelectedValue, txtEncEscuela.Text, txtResEscuela.Text, ddlFacultad.SelectedValue, cboSemana.SelectedValue)
        consultarVistaHorario()
        consultarListaHorario()
    End Sub
    ...
    Protected Sub CmdReporteHorasTesis_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmdReporteHorasTesis.Click
