...
Partial Class frmHorario
    ...
    Protected Sub btnAceptar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        Dim obj As New clsPersonal
        obj.AgregarHorarioPersonal(ddlDia.SelectedValue, ddlHoraInicio.SelectedValue, ddlHoraFin.SelectedValue, codigo_per, 1, ddlTipo.SelectedValue, codigo_pel, ddlEscuela.SelectedValue, Me.txtEncEscuela.Text, Me.txtResEscuela.Text, ddlFacultad.SelectedValue)
        consultarVistaHorario()
        consultarListaHorario()
    End Sub
...
End Sub
    ...
    Protected Sub cmdHorario3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdHorario3.Click
        ...
        consultarListaHorario()
    End Sub
    Protected Sub cmdHorario4_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdHorario3.Click
        Dim obj As New clsPersonal
        obj.AsignarHorarioAdministrativo(4, codigo_per, codigo_pel)
        consultarVistaHorario()
        consultarListaHorario()
    End Sub
