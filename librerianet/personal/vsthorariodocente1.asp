...
<script type="text/javascript" language="JavaScript" src="../../personal/academico/horarios/private/validarhorarios.js"></script>
<style type="text/css">
td {
	font-size:9px;
	font-family:Tahoma;
...
<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" <%=alto%>>
  ...
  <tr>
    ...
    <%if modo="A" then%>
    <!--<img width="110px" align="FOTO DEL PROFESOR" src="../../personal/images/inscripciones/imgpersonal/<%=codigo_per%>.jpg" height="120px" class="style1">-->
    <img width="110px" align="FOTO DEL PROFESOR" src="../personal/imgpersonal/<%=codigo_per%>.jpg" height="120px" class="style1">
    <%end if%>
    </td>
  </tr>
  <tr>
  ...
  <%if (codigo_cac<>"" and codigo_per<>"-2") then%>
  <tr>
    <td width="70%" style="text-align:right;"  colspan="2"><input onclick="imprimir('N','','')" type="button" value="    Imprimir" name="cmdImprimir" class="../../personal/academico/horarios/usatimprimir"></td>
  </tr>
  <%end if%>
  <tr>
