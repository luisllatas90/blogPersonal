                ...
                <asp:DataList ID="DataList1" runat="server" BackColor="White" 
                        ...
                        <table style="width:100%;" >
                            ...
                            <tr>
                                ...
                                <!-- <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" 
                                        ForeColor="#0000CC" NavigateUrl='<%# "../../archivoscv/" + eval("archivo") %>' 
                    ...
                    <ItemTemplate>
                        <table style="width:100%;" >
                            ...
                            <tr>
                                <td colspan="3" style="width:100%; text-align:right; ">
                                <!-- <asp:HyperLink ID="HyperLink1" rudatasesoriasestudiantes.aspxnat="server" Font-Underline="True" 
                                        ForeColor="#0000CC" 
                                        NavigateUrl='<%# "../../archivoscv/" + eval("archivo") %>' 
                                        Target='<%# "_blank" %>' Text='<%# "Descargar archivo" %>' 
                                        Visible='<%# iif(IsDBNull(eval("archivo"))=true,false,true) %>'></asp:HyperLink>
                                -->
                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" 
