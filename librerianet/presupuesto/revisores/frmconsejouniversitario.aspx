<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmconsejouniversitario.aspx.vb" Inherits="frmconsejouniversitario" %>
...
<head runat="server">
    <title>Revisión de Presupuesto::Consejo Universitario</title>
...
<body style="border-top=0">
    ...
    <p>Aprobación del presupuesto: Consejo Universitario</p>
            </td>
        </tr>
        <tr>
            <td style="width: 10%">
