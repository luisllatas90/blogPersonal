...
Partial Class frmconsejouniversitario
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            ...
            objlista.CargarListas(Me.dpEstadoPresupuesto, objPresup.ObtenerListaEstados(3, 3), "codigo_epr", "descripcion_epr")
    ...
    Protected Sub grwPresupuestos_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grwPresupuestos.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Select Case Me.dpEstado.SelectedValue
                Case 3 'Reformulación, debe volver a "INICIAR REVISION"
                    chk.Visible = True
                    chk.Attributes.Add("OnClick", "HabilitarEnvio(this,document.getElementById('cmdIniciar'))")
                Case 5 'Revisión, debe pasar directo a habilitar botón "REVISAR PRESUPUESTO por Consejo"
                    chk.Visible = True
            ...
            Try
                For Each Fila In Me.grwPresupuestos.Rows
                    ...
                    If chk.Checked = True Then
                        'Envia estado 5: Revisión de Consejo Univ.
                        obj.RevisarPresupuesto(Me.grwPresupuestos.DataKeys.Item(Fila.RowIndex).Value, 5, -1, -1, "", id)
                    End If
                Next
                obj = Nothing
                'Cambiar de estado
