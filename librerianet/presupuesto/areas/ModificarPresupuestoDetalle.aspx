<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ModificarPresupuestoDetalle.aspx.vb" Inherits="presupuesto_areas_ModificarPresupuestoDetalle" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <td colspan="2" width="15%">
                    Unidad presupuestal :
                    <asp:DropDownList ID="cboUnidadPresu" runat="server" AutoPostBack="True">
                    </asp:DropDownList>
                            </td>
                        </tr>
                        <tr bgcolor="#F5F9FC">
                <td colspan="2" width="15%">
                    Área presupuestal&nbsp;&nbsp;&nbsp; :
                    <asp:TextBox ID="txtCecos" runat="server" Width="90px" BackColor="#F3F3F3"></asp:TextBox>
                ...
                <td colspan="2">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        <SelectParameters>
                            ...
                            <asp:ControlParameter ControlID="cboUnidadPresu" Name="codigoUnidad" 
                                PropertyName="SelectedValue" Type="Int32" />
