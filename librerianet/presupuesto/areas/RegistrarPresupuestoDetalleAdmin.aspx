<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RegistrarPresupuestoDetalleAdmin.aspx.vb" Inherits="presupuesto_areas_RegistrarPresupuestoDetalle"  EnableEventValidation="false" %>
...
<body >
    ...
    cellspacing="0">
            ...
            <tr>
                <td>
                    <asp:CheckBox ID="chkTransferir" runat="server" AutoPostBack="True" 
                        Text="Transferir" />
                </td>
                <td>
                    &nbsp;</td>
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td class="style4">
                                    Transferir:</td>
                                <td class="style5">
                                    <asp:TextBox ID="txtImporteTransferir" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="style2">
                                ...
                                <td>
                                    <asp:GridView ID="gvPresupuestoTransferir" runat="server" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Transferido" DataField="transferido_dpr" >
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:BoundField>
                                            <asp:CommandField ShowSelectButton="True" />
                                        </Columns>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="cmdCancelarTransfer" runat="server" CssClass="regresar2" 
                                        Text="Cancelar" />
                                </td>
                            </tr>
                        </table>
