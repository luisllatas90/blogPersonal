...
Partial Class presupuesto_areas_RegistrarPresupuestoDetalle
    ...
    Protected Sub chkTransferir_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkTransferir.CheckedChanged
        If chkTransferir.Checked = True Then
            Dim datos As New Data.DataTable
            Dim objpre As New ClsPresupuesto
            Dim objfun As New ClsFunciones
            datos = objpre.ObtenerListaCentroCostos("1", 523, Request.QueryString("id"))
            'Session("datosCecos") = datos
            objfun.CargarListas(ddlCecoDestino, datos, "codigo_Cco", "descripcion_Cco", ">> Seleccione <<")
    ...
    Protected Sub cmdCancelarTransfer_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdCancelarTransfer.Click
        Dim objcon As ClsLogistica
        objcon = New ClsLogistica
        Dim datosEgr As New Data.DataTable
        Me.txtImporteTransferir.Text = ""
        Me.pnlTransferencia.Visible = False
        Me.chkTransferir.Checked = False

        datosEgr = objcon.ConsultarDetallePresupuesto(Me.cboPeriodoPresu.SelectedValue, -1, "E")
    ...
    Protected Sub cmdTransferir_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdTransferir.Click
        Dim objPre As New ClsPresupuesto
        'Response.Write(Me.gvPresupuestoTransferir.SelectedRow.Cells(0).Text)
        'Response.Write(Request.QueryString("field"))
        'Response.Write(Me.txtImporteTransferir.Text)
        objPre.TransferirPresupuesto(CInt(Request.QueryString("field")), CInt(Me.gvPresupuestoTransferir.SelectedRow.Cells(0).Text), CDbl(Me.txtImporteTransferir.Text))
    End Sub
    ...
    Protected Sub gvPresupuestoTransferir_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvPresupuestoTransferir.SelectedIndexChanged
