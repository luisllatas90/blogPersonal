...
Partial Class presupuesto_areas_RegistrarPresupuestoDetalle_V2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                ...
                If Request.QueryString("tipo") <> "P" Then
                    'Hcano
                    datos = objpre.ObtenerPeriodoPresupuestalxCodigoDpr(Session("codigoDprPto"))
                    If datos.Rows.Count > 0 Then
                        Me.cboPeriodoPresu.SelectedValue = datos.Rows(0).Item("codigo_ejp")
                    End If
                    '
    ...
    Private Sub CargarDatosEditarDetalle()
        ...
        With datos.Rows(0)
            If datos.Rows.Count > 0 Then
                ...
                If Session("ctfPto") = 1 Or Session("ctfPto") = 156 Or Session("ctfPto") = 158 Then
                ...
                If Request.QueryString("tipo") = "E" Then
                    hdmontoaEditar.Value = FormatNumber(.Item("subtotal"), 2)
                End If
    ...
    Protected Sub cboPeriodoPresu_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboPeriodoPresu.SelectedIndexChanged
        ...
        If cboPeriodoPresu.SelectedIndex <> -1 Then
            If Session("ctfPto") = 1 Or Session("ctfPto") = 156 Or Session("ctfPto") = 158 Then
                datos = objpre.ObtenerCecoActividadPOA(-1, cboPeriodoPresu.SelectedValue, "")
            Else
    ...
    Protected Sub cboCecos_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboCecos.SelectedIndexChanged
        ...
        If cboCecos.SelectedIndex <> -1 Then
            ...
            If datos.Rows.Count > 0 Then
                Me.lblnombrepoa.Text = datos.Rows(0).Item("nombre_poa")
    ...
    Protected Sub cmdGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdGuardar.Click
        ...
        If txtCodItem.Text <> "" And cboCecos.Visible = True Then
            ...
            'Hcano 22-12-16
        ElseIf rpta = 2 Then
            ' Nada porque ya mostro el mensaje.
            'Fin Hcano 22-12-16
        Else
    ...
    Private Sub VerificarTechosPresupuestales_V2(ByRef rpta As Byte)
        If rblMovimiento.SelectedValue = "I" Then
            rpta = 1
        Else
            If rblMovimiento.SelectedValue = "E" And Decimal.Parse(txtImporteAnual.Text) <= (Decimal.Parse(lblDisponibleEgr.Text.Replace("S/.", "") + Decimal.Parse(hdmontoaEditar.Value))) Then
                rpta = 1
            Else
    ...
    Protected Sub cmdRegresar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdRegresar.Click
        If Session("RegresaEvaPoa") = 1 Then
            Response.Redirect("ModificarPresupuesto_V3.aspx?op=evaPOA&" & "&id=" & Session("id_eva") & "&ctf=" & Session("ctf_eva") & "&cb1=" & Session("cb1_eva") & "&cb2=" & Session("cb2_eva") & "&cb3=" & Session("cb3_eva") & "&cb4=" & Session("cb4_eva"))
        End If
