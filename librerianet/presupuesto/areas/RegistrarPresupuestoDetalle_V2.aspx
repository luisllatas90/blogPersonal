                                        ...
                                        <table width="100%" border="0" cellpadding="2" cellspacing="0">
                                            <tr>
                                                <td width="20%">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="cboPeriodoPresu"
                                                        ErrorMessage="Seleccione periodo presupuestal" ValidationGroup="Guardar">*</asp:RequiredFieldValidator>
                                                </td>
                                                <td width="80%">
                                            ...
                                            <tr>
                                                <td width="20%">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="cboCecos"
                                                        ErrorMessage="Seleccione Programa / Proyecto" ValidationGroup="Guardar">*</asp:RequiredFieldValidator>
                                                    <asp:CompareValidator ID="CompareValidator5" runat="server" ControlToValidate="cboCecos"
                                                        ErrorMessage="Seleccione Programa / Proyecto" Operator="GreaterThan" ValidationGroup="Guardar"
                                                ...
                                                <td width="80%">
                                                    ...
                                                    <asp:ImageButton ID="ImgBuscarCecos" runat="server" ImageUrl="~/images/busca.gif"
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:Panel ID="Panel3" runat="server" Height="150px" ScrollBars="Vertical" Width="100%">
                                                        <asp:GridView ID="gvCecos" runat="server" AutoGenerateColumns="False" BorderColor="#628BD7"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <%--treyes 28/11/2016 se modifica a solicitud de esaavedra--%>
                                                                <asp:BoundField DataField="resumen_acp" HeaderText="Programa / Proyecto" />
                                                                <%--treyes 28/11/2016 se modifica a solicitud de esaavedra--%>
                                                            ...
                                                            <table width="100%" border="0" cellpadding="4" cellspacing="0">
                                                                <tr>
                                                                    <td width="20%">
                                                                        ...
                                                                        <asp:CompareValidator ID="CompareValidator6" runat="server" ControlToValidate="cboActividad"
                                                                            ErrorMessage="Seleccione Actividad" Operator="GreaterThan" ValidationGroup="Guardar"
                                                                            ValueToCompare="0">*</asp:CompareValidator>
                                                                    </td>
                                                                    <td width="80%">
                                                                    ...
                                                                    <td width="80%">
                                                                        <table cellspacing="2" style="border-collapse: collapse">
                                                                            <tr>
                                                                                ...
                                                                                <th width="120px" class="celdaTitulo">
                                                                                    Meta / Tope
                                                                                </th>
                                                                                <th width="120px" class="celdaTitulo">
                                                                                    Disponible
                                                                                </th>
                                                                                <th width="210px" class="celdaTitulo">
                                                                                    Observación
                                                                                </th>
                                                                            </tr>
                                                                            <tr>
                                                                                ...
                                                                                <td class="celdaDatos" align="right">
                                                                                    <asp:Label ID="lblTopeIng" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                                                                </td>
                                                                                <td class="celdaDatos" align="right">
                                                                                    <asp:Label ID="lblDisponibleIng" runat="server" Font-Bold="True" ForeColor="Green"></asp:Label>
                                                                                </td>
                                                                                <td class="tooltip" align="center" font style="text-transform: uppercase;">
                                                                                    <asp:Label ID="lblObservacionIng" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                                                                    <span class="tooltiptext">Para editar ítems: Revisar la Guía adjunta pag. 16</span>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="celdaTitulo">
                                                                                ...
                                                                                <td class="celdaDatos" align="right">
                                                                                    <asp:Label ID="lblTopeEgr" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                                                                </td>
                                                                                <td class="celdaDatos" align="right">
                                                                                    <asp:Label ID="lblDisponibleEgr" runat="server" Font-Bold="True" ForeColor="Green"></asp:Label>
                                                                                </td>
                                                                                <td class="tooltip" align="center" font style="text-transform: uppercase;">
                                                                                    <asp:Label ID="lblObservacionEgr" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                                                                    <span class="tooltiptext">Para editar ítems: Revisar la Guía adjunta pag. 16</span>
                                                                                </td>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <table width="100%" border="0" cellpadding="2" cellspacing="0">
                                            <tr bgcolor="#F5F9FC">
                                                <td width="20%">
                                                    Movimiento<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                                        ControlToValidate="rblMovimiento" ErrorMessage="Seleccione el movimiento que desea realizar"
                                                        ValidationGroup="BuscaItem">*</asp:RequiredFieldValidator>
                                                </td>
                                                <td width="80%">
                                                    <asp:RadioButtonList ID="rblMovimiento" runat="server" RepeatDirection="Horizontal"
                                                        ValidationGroup="BuscaItem" AutoPostBack="True">
                                            ...
                                            <tr>
                                                <td width="20%">
                                                    Item
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtCodItem"
                                                        ErrorMessage="Busque el item que desea registrar" ValidationGroup="Guardar">*</asp:RequiredFieldValidator>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtConcepto"
                                                        ErrorMessage="Selecione item a registrar" ValidationGroup="Guardar">*</asp:RequiredFieldValidator>
                                                </td>
                                                <td width="80%">
                                                    <asp:TextBox ID="txtConcepto" runat="server" Width="500px" ValidationGroup="BuscaItem"></asp:TextBox>
                                                    <asp:ImageButton ID="ImgBuscarItems" runat="server" ImageUrl="~/images/busca.gif"
                                                        ValidationGroup="BuscaItem" />
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:Panel ID="Panel1" runat="server" Height="150px" ScrollBars="Vertical" Width="100%">
                                                        <asp:GridView ID="gvItems" runat="server" AutoGenerateColumns="False" BorderColor="#628BD7"
                                                            BorderStyle="Solid" BorderWidth="1px" CellPadding="4" DataKeyNames="codigocon,tipo,iduni,especificaCantidad"
                                                            ForeColor="#333333" ShowHeader="False" Width="98%">
                                                            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                                            <RowStyle BackColor="#EFF3FB" />
                                                            <Columns>
                                            ...
                                            <tr>
                                                ...
                                                <td width="80%">
                                                    <asp:TextBox ID="txtComentarioReq" runat="server" MaxLength="100" TextMode="MultiLine"
                                            ...
                                            <tr>
                                                <td width="20%">
                                                    ...
                                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtPrecioUnit"
                                                        ErrorMessage="El precio unitario no puede ser cero" Operator="GreaterThan" ValidationGroup="Guardar"
                                                        ValueToCompare="0">*</asp:CompareValidator>
                                                </td>
                                                <td width="80%">
