<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ConsultarPresupuestoXCecos.aspx.vb" Inherits="presupuesto_consultas_ConsultarPresupuestoXCecos" %>
            ...
            <tr class="titulocel">
                <td>
                                ...
                                <asp:DropDownList ID="cboOpcion" runat="server">
                                    <asp:ListItem Value="6">Resumen general por centro de costos</asp:ListItem>
                                    <asp:ListItem Value="7">Resumen detallado por centro de costos</asp:ListItem>
                                </asp:DropDownList>
				...
				<asp:Button ID="cmdExportar" runat="server" BackColor="#FEFFE1" 
                                    CssClass="ExportarAExcel" Text="    Exportar" Width="80px" 
                        Height="22px" BorderStyle="Outset" />
                                </td>
                <td align="right">
                                &nbsp;</td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="gvDetalle" runat="server" ShowFooter="True">
                        ...
                        <HeaderStyle CssClass="TituloTabla" Height="20px" ForeColor="White" />
                    </asp:GridView>
                </td>
            </tr>
        </table>
