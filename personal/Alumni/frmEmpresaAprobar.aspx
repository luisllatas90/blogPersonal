<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEmpresaAprobar.aspx.vb" Inherits="Alumni_frmEmpresaAprobar" %>
    ...
    <form id="frmEmpresaAprobar" runat="server">
        ...
        <div class="container-fluid">
            <div class="card div-title">                        
                <div class="row title">APROBAR EMPRESAS</div>
            </div> 
                                        ...
                                        <asp:TemplateField HeaderText="OPE." ItemStyle-Width="10%" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnAprobar" runat="server" 
                                                    ...
                                                    OnClientClick="return alertConfirm(this, event, '¿Desea aprobar la empresa seleccionada?', 'warning');">
