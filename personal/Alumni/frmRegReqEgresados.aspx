<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRegReqEgresados.aspx.vb" Inherits="Alumni_frmRegReqEgresados" %>
...
<form id="form1" runat="server">
    ...
    <div class="container-fluid">                     
        <div class="card div-title">                        
            <div class="row title">REGISTRAR REQUISITOS</div>
        </div> 
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">                                                  
                                ...
                                <label class="col-sm-2 col-form-label form-control-sm" for="txtPlanEst">Plan Curricular:</label>                                                                                                            
                                <div class="col-sm-4">
                            ...
                            <div class="row">
                                ...
                                <label class="col-sm-5 col-form-label form-control-sm" for="txtSemestre"></label>
                            </div>
                            <hr/>
                            <div class="row">
                                <asp:LinkButton ID="lbBusca" runat="server" Text="BUSCAR" class="btn btn-accion btn-celeste">   
                            ...
                            <asp:TemplateField HeaderText="REQUISITOS" ItemStyle-CssClass="col-operacion">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnEditar" runat="server" 
                                        ...
                                        CommandName="Editar" CssClass="btn btn-success btn-sm">
        ...
        <ContentTemplate>
            ...
            <div class="modal-body">
                    ...
                    <div class="row">                         
                        ...
                        CODIGO:</label>
                        <div class="col-sm-3">
							<asp:TextBox runat="server" name="txtCodUniAlum" ID="txtCodUniAlum" class="form-control" ReadOnly ="true" ></asp:TextBox>
                        </div>
                        <label class="col-sm-1 col-form-label form-control-sm" for="lblNombres">
                        NOMBRES:</label>
                        <div class="col-sm-7">
							<asp:TextBox runat="server" name="txtNombres" ID="txtNombres" class="form-control" ReadOnly="true"></asp:TextBox>
                        </div>
								...
								<asp:GridView ID="gvRequisitos" runat="server" AutoGenerateColumns="false" DataKeyNames="codigo_req,codigo_pcur,codigo_tip, codigo_are, cumplio" CssClass="table table-striped table-bordered table-hover"> 
									...
									<Columns>									    
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>  
                                                <asp:CheckBox ID="chkCumplir" runat="server" Checked='<%# Eval("cumplio") %>' />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="observacion" HeaderText="OBSERVACION" Visible="False" />                                        
                                        <asp:BoundField DataField="nombre_cat" HeaderText="CATEGORIA" />                                                                                                                   
                                    </Columns>
			...
			<div class="modal-footer">
                  ...
                  <asp:LinkButton ID="btnGuardar" runat="server" Text="Guardar" class="btn btn-accion btn-verde">
