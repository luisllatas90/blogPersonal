...
Imports System.Data
Partial Class DataJson_tutoria_Variable
    ...
    Private Sub RegistrarVariableEvaluacion(ByVal cod As Integer, ByVal nombre As String, ByVal estado As Integer, ByVal tipo As String, ByVal user_reg As Integer)
        Dim obj As New clsTutoria
        Dim Data As New Dictionary(Of String, Object)()
        Dim serializer As System.Web.Script.Serialization.JavaScriptSerializer = New System.Web.Script.Serialization.JavaScriptSerializer()
        Dim JSONresult As String = ""
        ...
        Try
            ...
            dt = obj.ActualizarVariableEvaluacion(cod, nombre, estado, tipo, user_reg)
