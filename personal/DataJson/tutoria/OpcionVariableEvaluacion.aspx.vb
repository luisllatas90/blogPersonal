...
Imports System.Data
Partial Class DataJson_tutoria_OpcionVariableEvaluacion
        ...
        Try
            ...
            Select Case objT.DecrytedString64(Request("action"))
                Case "Listar"
                    ...
                    ListaOpcionVariableEvaluacion("L", 0, k)
                Case "Registrar"
    ...
    Private Sub ListaOpcionVariableEvaluacion(ByVal tipo As String, ByVal codigo As Integer, ByVal codigo_ve As Integer)
        Dim serializer As System.Web.Script.Serialization.JavaScriptSerializer = New System.Web.Script.Serialization.JavaScriptSerializer()
        Dim JSONresult As String = ""
        Dim list As New List(Of Dictionary(Of String, Object))()
        Try
            ...
            tb = obj.ListaOpcionVariableEvaluacion(tipo, codigo, codigo_ve)

            If tb.Rows.Count > 0 Then
                For i As Integer = 0 To tb.Rows.Count - 1
                    Dim data As New Dictionary(Of String, Object)()
                    data.Add("cCod", obj.EncrytedString64(tb.Rows(i).Item("codigo_ov")))
                    data.Add("cVar", obj.EncrytedString64(tb.Rows(i).Item("codigo_ve")))
                    data.Add("cDescripcion", tb.Rows(i).Item("descripcion_ov"))
                    data.Add("cPuntaje", tb.Rows(i).Item("puntaje_ov"))

                    If tipo = "E" Then
                        data.Add("cEstado", tb.Rows(i).Item("estado_ov"))
                    End If
                    list.Add(data)
                Next
            End If
