...
Partial Class DataJson_SolicitudTramite_Movimientos_SolicitudTramite
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            Try
                ...
                Select Case action
                    Case "Upload"
                        codigo_sol = obj.DecrytedString64(Request.Form("cod_sol"))
                        SubirArchivo(codigo_sol)
                    Case "Cerrar"
                        codigo_sol = obj.DecrytedString64(Request.Form("cod_sol"))
                        'CerrarProyecto(codigo_acp)
                    Case "Ver"
                        codigo_sol = obj.DecrytedString64(Request.Form("cod_sol"))
                        ListarProyectosFiles(codigo_sol)
                    Case "Download"
                        'DescargarArchivo()
                End Select
    ...
    Sub SubirArchivo(ByVal codigo_ST As Integer)
        Dim serializer As System.Web.Script.Serialization.JavaScriptSerializer = New System.Web.Script.Serialization.JavaScriptSerializer()
        Dim JSONresult As String = ""
        ' Dim List As New List(Of Dictionary(Of String, Object))()
        Dim Data As New Dictionary(Of String, Object)()
    ...
    Private Sub ListarProyectosFiles(ByVal cod As Integer)
        Try
            ...
            obj.AbrirConexion()
            tb = obj.TraerDataTable("dbo.USP_LISTARARCHIVOSCOMPARTIDOS", 1, 10, cod)
            obj.CerrarConexion()
