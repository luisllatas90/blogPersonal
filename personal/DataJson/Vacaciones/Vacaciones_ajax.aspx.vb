...
Partial Class DataJson_Vacaciones_Vacaciones_ajax
        ...
        Try
            Select Case FPost
                ...
                Case "ListarVacaciones"
                    ListarVacaciones(CInt(codigo_per))
                Case "Generar"
    ...
    Sub ListarVacaciones(ByVal codigo_usu As Integer)
        Dim obj As New ClsConectarDatos
        Dim tb As New Data.DataTable
        Dim cn As New clsaccesodatos
        '  codigo_usu = Request.Form("Param01")
        ...
        obj.AbrirConexion()
        Dim JSONresult As String = ""
        tb = obj.TraerDataTable("dbo.USP_LISTARVACACIONES_PERSONA", "CT", 0, codigo_usu, Session("id_per"))
        obj.CerrarConexion()
        Dim cif As New ClsCRM
    ...
    Sub DatosPersona()
        ...
        tb = obj.TraerDataTable("dbo.USP_LISTAR_PERSONA_VACACIONES", "1", Session("id_per"))
