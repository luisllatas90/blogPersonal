...
Partial Class administrativo_Tesoreria_Rendiciones_AppRendiciones_DataJson_DescargarArchivo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Session("perlogin") Is Nothing Then
            Try
                ...
                obj.AbrirConexion()
                tb = obj.TraerDataTable("dbo.USP_LISTARARCHIVOSCOMPARTIDOS", 2, 1, IdArchivo, "U1XK2A8H92")
                obj.CerrarConexion()
