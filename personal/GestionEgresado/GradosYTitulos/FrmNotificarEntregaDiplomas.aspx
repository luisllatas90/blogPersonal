<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmNotificarEntregaDiplomas.aspx.vb" Inherits="GradosYTitulos_FrmNotificarEntregaDiplomas" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Notificar Entrega de Diplomas</title>
    ...
    <div class="wrapper">
        <div class="content">
            ...
            <div class="page_header">
                <div class="pull-left">
                    <i class="icon ti-comment-alt page_header_icon"></i><span class="main-text">Notificar Entrega de Diplomas</span>
                    <%--<p class="text">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <asp:DropDownList runat="server" class="form-control" ID="cboEstado">
                            ...
                            <asp:ListItem Value="0">Pediente</asp:ListItem>
            ...
            <div class="row">
                ...
                <div class="indeterminate"></div>
                                        ...
                                        <asp:GridView runat="server" ID="gvAlumnos" DataKeyNames="descripcion_tdg,codigo_egr,email_Alu,codigo_dft,codigo_dta,enviado,egresado,codigo_Alu" AutoGenerateColumns="False"
                                            CssClass=" table table-responsive">
                                            <Columns>
                                                <asp:BoundField HeaderText="CODALUM" DataField="codigo_Alu" ItemStyle-Width="10%" ItemStyle-CssClass="hideGridColumn" HeaderStyle-CssClass="hideGridColumn">
                                                </asp:BoundField>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="4%" HeaderStyle-HorizontalAlign="Center">
                                                    ...
                                                    <HeaderTemplate>
                                                        <asp:CheckBox ID="chkall" AutoPostBack="true" OnCheckedChanged="chckchanged" runat="server" />
                                                        </HeaderTemplate>
