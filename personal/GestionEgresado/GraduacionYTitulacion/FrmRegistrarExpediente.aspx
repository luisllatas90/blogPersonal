<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmRegistrarExpediente.aspx.vb"
    Inherits="GraduacionYTitulacion_FrmRegistrarExpediente" %>
...
<head runat="server">
    ...
    <link href="../assets/jqwidgets/jqwidgets/styles/jqx.light.css" rel="stylesheet"
        type="text/css" />--%>
    <link href="../../assets/jqwidgets/jqwidgets/styles/jqx.base.css" rel="stylesheet"
        type="text/css" />
    <link href="../../assets/jqwidgets/jqwidgets/styles/jqx.light.css" rel="stylesheet"
        type="text/css" />

    <script src="../../assets/jqwidgets/scripts/jquery-1.11.1.min.js" type="text/javascript"></script>
    ...
    <script type="text/javascript" src="../../assets/jqwidgets/jqwidgets/jqxgrid.grouping.js"></script>
    ...
    <script src="js/_General.js?a=5" type="text/javascript"></script>

    <script src="js/RegistroEgresado.js?x=99" type="text/javascript"></script>
        ...
        <div class="content">
            ...
            <div class="main-content" style="background-color: White">
                            ...
                            <div id="PanelBusqueda">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="page_header">
                                        <div class="pull-left">
                                            <i class="icon ti-bookmark page_header_icon"></i><span class="main-text">Recepcionar
                                                Expediente</span>
                                        </div>
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 col-md-3">
                            <input type="text" id="txtbusqueda" name="txtbusqueda" class="form-control" placeholder="DNI/Apellidos y Nombres" />
                        </div>
                        <div class="col-sm-1 col-md-2">
                            <button type="button" id="btnBuscar" name="btnBuscar" class="btn btn-sm btn-primary btn-radius">
                                Buscar</button>
                        </div>
                    </div>
                </div>
                <div id="Lista">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-piluku" id="Div3">
                        ...
                        <div class="col-md-3 col-sm-3" style="padding: 0px">
                            ...
                            <div class="panel panel-piluku" id="Div2">
                                ...
                                <div class="panel-body">
                                    ...
                                    <!--Agregado por OLLUEN-->
                                    <div id="DivArchivos">
                                        <div class="panel panel-piluku" id="Div4">
                                            <div class="panel-heading">
                                                <h3 class="panel-title">
                                                    Archivos de trámite:</h3>
                                            </div>
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <button type="button" id="btnVer" name="btnVer" class="btn btn-sm btn-primary btn-radius">
                                                            Ver archivos</button>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-md-9 col-sm-9" style="padding: 0px">
                            <div class="panel panel-piluku">
                                ...
                                <div class="panel-body">
                                    ...
                                    <input type="hidden" id="hddta" name="hddta" value="0" />
                            ...
                            <div class="panel panel-piluku" id="Div1">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea id="txtTituloTesis" name="txtTituloTesis" class="form-control" rows="3"
                    ...
                    <div class="row">
                        <center>
                            <button type="button" id="btnGuardar" name="btnGuardar" class="btn btn-primary">
                                Recepcionar</button>
                            <button type="button" id="btnObservar" name="btnObservar" class="btn btn-warning">
                                Observar</button>
                ...
                <div class="modal fade" id="mdArchivos" role="dialog" aria-labelledby="myModalLabel"
                    style="z-index: 0;" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                ...
                <div class="modal fade" id="mdObservaciones" role="dialog" aria-labelledby="myModalLabel"
                    style="z-index: 100;" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="Form1" name="frmObservaciones" enctype="multipart/form-data" class="form-horizontal"
                                method="post" onsubmit="return false;" action="#">
                                <input type="hidden" id="Hidden1" name="hdCodigoAluME" value="0" />
                                <div class="row">
                                    <div class="form-group">
                                        <label class="col-sm-3 col-md-2 control-label">
                                            Requisitos</label>
                                        <div class="col-sm-9 col-md-10">
                                            <div id="jqxGridRequisitos">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group">
                                        <label class="col-sm-3 col-md-2 control-label">
                                            Ingrese observación:</label>
                                        <div class="col-sm-9 col-md-10">
                                            <textarea name="txtObservacion" id="txtObservacion" class="form-control" rows="4"></textarea>
                                        </div>
                                    </div>
                                </div>
                                </form>
                            ...
                            <div class="modal-footer">
                                <center>
                                    <button type="button" id="btnGuardarObservacion" class="btn btn-primary">
                                        Guardar</button>
                                    <button type="button" class="btn btn-danger" id="btnCancelarObservacion" data-dismiss="modal">
                                        Cancelar</button>
                                </center>
                            </div>
                        </div>
