...
function fnGradoxTipo(cod_cp, tipo) {
    var arr;
    $('body').append('<form id="frmOpe"><input type="hidden" id="action" name="action" value="ConsultarGradoxTipo" /></form>');
    $('#frmOpe').append('<input type="hidden" id="cod" name="cod" value="' + cod_cp + '" />');
    $('#frmOpe').append('<input type="hidden" id="vig" name="vig" value="' + tipo + '" />');
    var form = $("#frmOpe").serializeArray();
    $("#frmOpe").remove();
    //console.log(form);
    $.ajax({
