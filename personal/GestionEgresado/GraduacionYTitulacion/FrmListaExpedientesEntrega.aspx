<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmListaExpedientesEntrega.aspx.vb"
    Inherits="GradosYTitulos_FrmListaExpedientesEntrega" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html lang="en">
<head>
    <title id='Description'>Entrega de Diplomas </title>
    ...
    <script src="js/_General.js?x=35" type="text/javascript"></script>

    <script src="js/Entrega.js?x=14" type="text/javascript"></script>
                            ...
                            <div id="PanelBusqueda">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="page_header">
                                        <div class="pull-left">
                                            <i class="icon ti-folder page_header_icon"></i><span class="main-text">Entrega de Diplomas</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <label class="col-md-5 control-label ">
                                                        Apellidos Nombres / DNI / Cod. Univ.</label>
                                                    <div class="col-md-7">
                                                        <input type="text" id="txtBusqueda" name="txtBusqueda" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
