...
Partial Class GestionEgresado_SustentacionTesis_FrmMantEscala
            ...
            If mt_validaFormulario() = True Then
                ...
                If dtValida.Rows.Count > 0 Then
                    If dtValida.Rows(0).Item("respuesta") = "1" Then
                        dt = mt_ActualizaEscala(Me.hfCodigo_ecs.Value, Me.txtDescripcion_ecs.Text, Me.ddlCondicion.SelectedValue, "0", Me.txtValorMinimo.Text, Me.txtValorMáximo.Text)
...
#Region "procedimiento y funciones"
    ...
    Private Sub mt_consultarEscalaPorCodigo_ecs(ByVal codigo_ecs As Integer)
        ...
        If dt.Rows.Count > 0 Then
            Me.txtDescripcion_ecs.Text = dt.Rows(0).Item("descripcion_ecs").ToString
    ...
    Private Function mt_validaFormulario() As Boolean
        If Me.hfCodigo_ecs.Value = "" Then
            ...
            Me.txtDescripcion_ecs.Focus()
            Return False
        End If
        If Me.ddlCondicion.SelectedValue = "" Then
            Me.lblmensaje.Attributes.Add("class", "alert alert-danger")
            Me.lblmensaje.InnerHtml() = "<p>Seleccione una condición</p>"
            Me.txtDescripcion_ecs.Focus()
            Return False
        End If
        If Me.txtDescripcion_ecs.Text = "" Then
            Me.lblmensaje.Attributes.Add("class", "alert alert-danger")
            Me.lblmensaje.InnerHtml() = "<p>Ingrese descripción de la escala</p>"
            Me.txtDescripcion_ecs.Focus()
            Return False
        End If
    ...
    Private Sub mt_limpiaControles()
        Me.txtDescripcion_ecs.Text = String.Empty
        Me.txtValorMáximo.Text = String.Empty
        Me.txtValorMinimo.Text = String.Empty
