<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmFirmarResolución.aspx.vb"
    Inherits="FrmFirmarResolución" Title="Untitled Page" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Firmar resolución de sustentación de tesis</title>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="background-color: #E33439; color: White; font-weight: bold;
                font-size: 14px;">
                <b>Firmar resolución para sustentación de tesis</b>
            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3 col-md-2">
                                <asp:DropDownList runat="server" ID="ddlEstado" CssClass="form-control">
                                    ...
                                    <asp:ListItem Value="C">FIRMADOS</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:LinkButton ID="btnVer" runat="server" Text='<span class="fa fa-pencil-square-o"></span>'
                                            CssClass="btn btn-warning btn-sm btn-radius" ToolTip="Ver" OnClientClick="MostrarAsesoria();return false;">
                                        </asp:LinkButton>
                                    </td>
                                </tr>
                            </tbody>
                ...
                <div class="modal-body">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <asp:Label ID="Label14" runat="server" CssClass="col-sm-2 col-md-1 control-label">Bachiller</asp:Label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9">
                                <asp:TextBox runat="server" ID="txtCarrera" ReadOnly="true" CssClass="form-control" Text="DERECHO"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9">
                                <asp:TextBox runat="server" ID="txtTitulo" ReadOnly="true" TextMode="MultiLine" Rows="3"
                                    CssClass="form-control" Text="LA POSIBILIDAD DE ABRIR NUEVOS PROCEDIMIENTOS SANCIONADORES CONCLUIDOS POR CADUCIDAD
                                        Y LA POSIBLE LESIÓN AL PRINCIPIO DE INTERDICCIÓN DE LA ARBITRARIEDAD."></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <asp:Label ID="Label7" runat="server" CssClass="col-md-3 col-sm-3 control-label">Resolución firmada</asp:Label>
