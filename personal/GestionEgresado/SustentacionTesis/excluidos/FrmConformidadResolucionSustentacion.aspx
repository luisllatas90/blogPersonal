<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmConformidadResolucionSustentacion.aspx.vb"
    Inherits="FrmConformidadResolucionSustentacion" Title="Untitled Page" %>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="background-color: #E33439; color: White; font-weight: bold;
                font-size: 14px;">
                <b>Conformidad a resolución para sustentación de tesis</b>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3 col-md-2">
                            <asp:DropDownList runat="server" ID="ddlEstado" CssClass="form-control">
                                ...
                                <asp:ListItem Value="C">CON RESOLUCIÓN</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:LinkButton ID="btnVer" runat="server" Text='<span class="fa fa-eye"></span>'
                                        CssClass="btn btn-info btn-sm btn-radius" ToolTip="Ver" OnClientClick="MostrarAsesoria();return false;">
                                    </asp:LinkButton>
