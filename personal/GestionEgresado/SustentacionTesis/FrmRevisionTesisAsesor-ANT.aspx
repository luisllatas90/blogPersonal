                                            ...
                                            <tr>
                                                <td style="width: 15%; padding: 4px;">
                                                    <asp:LinkButton ID="btnDescargar1" runat="server" Text='<span class="fa fa-download"></span>'
                                                        CssClass="btn btn-info btn-sm btn-radius" Font-Size="11px" ToolTip="Descargar" OnClientClick="return false;">
                                                    </asp:LinkButton>
                                                </td>
                                                <td style="width: 85%;">
                                            ...
                                            <tr>
                                                <td style="width: 15%; padding: 4px;">
                                                    <asp:LinkButton ID="btnBloquear1" runat="server" Text='<span class="fa fa-lock"></span>'
                                                        CssClass="btn btn-sm btn-danger btn-radius" Font-Size="11px"  ToolTip="Bloquear" OnClientClick="return false;">
                                                    </asp:LinkButton>
                                                </td>
                                                <td style="width: 85%;">
                                            ...
                                            <tr>
                                                <td style="width: 15%; padding: 4px;">
                                                    <asp:LinkButton ID="LinkButton4" runat="server" Text='<span class="fa fa-unlock"></span>'
                                                        CssClass="btn btn-sm btn-primary btn-radius" Font-Size="11px"  ToolTip="Desbloquear" OnClientClick="return false;">
                                                    </asp:LinkButton>
                                                </td>
                                                <td style="width: 85%;">
                                            ...
                                            <tr>
                                                <td style="width: 15%; padding: 4px;">
                                                    <asp:LinkButton ID="LinkButton5" runat="server" Text='<span class="fa fa-comment"></span>'
                                                        CssClass="btn btn-warning btn-sm btn-radius" Font-Size="11px"  ToolTip="Observaciones" OnClientClick="return false;">
                                                    </asp:LinkButton>
                                                </td>
                                                <td style="width: 85%;">
                                            ...
                                            <tr>
                                                <td style="width: 15%; padding: 4px;">
                                                    <asp:LinkButton ID="LinkButton3" runat="server" Text='<span class="fa fa-check"></span>'
                                                        CssClass="btn btn-success btn-sm btn-radius" Font-Size="11px"  ToolTip="Conformidad" OnClientClick="return false;"> 
                                                    </asp:LinkButton>
                                                </td>
                                                <td style="width: 85%;">
                                            ...
                                            <tr>
                                                <td style="width: 15%; padding: 4px;">
                                                    <asp:LinkButton ID="LinkButton1" runat="server" Text='<span class="fa fa-download"></span>'
                                                        CssClass="btn btn-danger btn-sm btn-radius" Font-Size="11px"  ToolTip="Descargar" OnClientClick="return false;">
                                                    </asp:LinkButton>
                                                </td>
                                                <td style="width: 85%;">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7 col-md-8">
                                                                <asp:TextBox runat="server" ID="txtObservacion" CssClass="form-control" TextMode="MultiLine" MaxLength="1000"
                                                                    Rows="4"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
