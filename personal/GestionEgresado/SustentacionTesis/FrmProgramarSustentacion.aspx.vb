    ...
    Protected Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        Try
            ...
            If ValidarProgramacion() = True Then
                Dim dt As New Data.DataTable
                dt = RegistrarProgramacion(Me.hdpst.Value, Me.hddta.Value, Me.hdtes.Value, "NORMAL", Me.txtFecha.Text, Me.ddlTipoAmbiente.SelectedValue, Me.ddlAmbiente.SelectedValue, Me.txtAmbienteVirtual.Text, Me.txtDetalle.Text, Session("id_per"))
                If dt.Rows.Count > 0 Then
