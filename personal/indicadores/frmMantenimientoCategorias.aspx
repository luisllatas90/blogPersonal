<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmMantenimientoCategorias.aspx.vb" Inherits="Indicadores_Formularios_frmMantenimientoCategorias" %>
...
<body>
    ...
    <div class="usatTituloAzul">Añadir Categorías
    <a href="#" onclick="apprise('Añade una nueva categoría.');">
    ...
    <div class="usatPanel">
        ...
        <div style="width:70%; padding-top:30px">            
            ...
            <asp:TextBox ID="txtDescripcion" runat="server" Width="78%" MaxLength="200"></asp:TextBox>
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" 
             ...
             <asp:CustomValidator   ID="CustomValidator1" 
                                    runat="server" 
                                    ErrorMessage="(*) Se encontraron palabras reservadas en la Descripción de la Categoría." 
                                    ControlToValidate="txtDescripcion" 
                                    Display="Dynamic" 
                                    ValidationGroup="grupo1"
    ...
    <div class="usatPanelConsulta">
        <asp:Label ID="lblConsulta" runat="server" Text="Consulta de Categorías" Width="160px"></asp:Label>
        <div style="height:50px">
            ...
            <div style="width:70%; padding-top:10px">            
                <div style="width:86%; float:left; padding-top:15px">
                ...
                <!-- Para Validar Caja de Busqueda -->
                 <asp:RegularExpressionValidator ID="RegularExpressionValidator2" 
                                            ...
                                            Display="Dynamic" 
                                            ErrorMessage="Ingrese carácteres válidos para buscar la Categoría." 
                                            ValidationExpression="[a-zA-ZñÑáéíóúÁÉÍÓÚ ,.]{3,}" 
                ...
                <asp:CustomValidator   ID="CustomValidator2" 
                                    runat="server" 
                                    ErrorMessage="Se encontraron palabras reservadas en la búsqueda de la Categoría." 
                                    ControlToValidate="txtBuscar" 
                                    Display="Dynamic"                                     
     ...
     <table cellpadding="3" cellspacing="0" style="width: 100%; border:1px solid #96ACE7" border="0">
            <tr>
                <td style="text-align:center">
                    ...
                    <asp:GridView ID="gvCategoria" runat="server" Width="100%" CellPadding="4" 
