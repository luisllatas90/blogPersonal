...
Partial Class indicadores_frmEjePerspectivasObjetivos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                'Response.Write(Request.QueryString("codigo_eje"))
            End If
    ...
    Private Sub CargarSemaforos()
        ...
        For i As Integer = 0 To dts.Rows.Count() - 1
            ...
            If Request.QueryString("codigo_eje") <> 0 Then
                dts_obj = obj.ListarObjetivosSegunPerspectivaEje(Request.QueryString("anio"), Request.QueryString("Codigo_pla"), Request.QueryString("codigo_cco"), codigo_pers, Me.Request.QueryString("codigo_eje"))
            Else
