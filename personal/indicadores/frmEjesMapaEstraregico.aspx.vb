...
Partial Class indicadores_frmEjesMapaEstraregico
    ...
    Protected Sub lnkPers1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkPers1.Click
        Try
            Me.hfEje.Value = Me.lblPers1.Text
            ...
            EnviarAResumenPerspectivas("frmEjePerspectivasObjetivos.aspx")
    ...
    Private Sub EnviarAResumenPerspectivas(ByVal pagina As String)
        Try
            ...
            Me.fradetalle.Attributes("src") = pagina & "?Codigo_pla=" & ddlPlan.SelectedValue & "&anio=" & ddlPeriodo.SelectedValue & "&codigo_cco=" & ddlCentroCostoPlan.SelectedValue & "&codigo_eje=" & Me.hfEje.Value
        Catch ex As Exception
            Response.Write(ex.Message)
        End Try
    End Sub
    ...
    Protected Sub lnkPers2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkPers2.Click
        Try
            ...
            Me.hfEje.Value = Me.lblPers2.Text

            'Response.Write(Me.lblPers2.Text)
            'Esta pagina necesita el codigo_pers y el codigo_plan para cargar sus objetivos - Indicadores
            ...
            'Me.fradetalle.Attributes("src") = "https://intranet.usat.edu.pe/rptusat/?/PRIVADOS/ACADEMICO/IND_CuadroMandoIntegral" & "&codigo_pla=" & ddlPlan.SelectedValue & "&codigo_pers=" & lblPers2.Text & "&anio=" & Me.ddlPeriodo.SelectedValue & "&codigo_cco=" & ddlCentroCostoPlan.SelectedValue
    ...
    Protected Sub lnkPers3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkPers3.Click
        Try
            Me.hfEje.Value = Me.lblPers3.Text
            ...
            'Me.fradetalle.Attributes("src") = "https://intranet.usat.edu.pe/rptusat/?/PRIVADOS/ACADEMICO/IND_CuadroMandoIntegral" & "&codigo_pla=" & ddlPlan.SelectedValue & "&codigo_pers=" & lblPers3.Text & "&anio=" & Me.ddlPeriodo.SelectedValue & "&codigo_cco=" & ddlCentroCostoPlan.SelectedValue
    ...
    Protected Sub lnkPers4_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkPers4.Click
        Try
            Me.hfEje.Value = Me.lblPers4.Text
            ...
            'Me.fradetalle.Attributes("src") = "https://intranet.usat.edu.pe/rptusat/?/PRIVADOS/ACADEMICO/IND_CuadroMandoIntegral" & "&codigo_pla=" & ddlPlan.SelectedValue & "&codigo_pers=" & lblPers4.Text & "&anio=" & Me.ddlPeriodo.SelectedValue & "&codigo_cco=" & ddlCentroCostoPlan.SelectedValue
    ...
    Protected Sub lnkPers5_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkPers5.Click
        Try
            ...
            Me.hfEje.Value = Me.lblPers5.Text
            ...
            'Me.fradetalle.Attributes("src") = "https://intranet.usat.edu.pe/rptusat/?/PRIVADOS/ACADEMICO/IND_CuadroMandoIntegral" & "&codigo_pla=" & ddlPlan.SelectedValue & "&codigo_pers=" & lblPers5.Text & "&anio=" & Me.ddlPeriodo.SelectedValue & "&codigo_cco=" & ddlCentroCostoPlan.SelectedValue
    ...
    Protected Sub lnkPers6_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkPers6.Click
        Try
            ...
            Me.hfEje.Value = Me.lblPers6.Text
            ...
            'Me.fradetalle.Attributes("src") = "https://intranet.usat.edu.pe/rptusat/?/PRIVADOS/ACADEMICO/IND_CuadroMandoIntegral" & "&codigo_pla=" & ddlPlan.SelectedValue & "&codigo_pers=" & lblPers6.Text & "&anio=" & Me.ddlPeriodo.SelectedValue & "&codigo_cco=" & ddlCentroCostoPlan.SelectedValue
