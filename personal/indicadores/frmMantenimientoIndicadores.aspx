   ...
   <!-- Para avisos -->
    ...
    <div class="usatPanel">
        ...
        <div>
            ...
            <div class="usatFormatoCampo" style="width:100px">
                <asp:Label ID="Label9" runat="server" Text="Tipo de Dato [TD]"></asp:Label>
            </div>
            ...
            <div class="usatFormatoCampo" style="width:40px">
                <asp:Label ID="Label14" runat="server" Text="Del año"></asp:Label>
            </div>
            <div class="usatFormatoCampoAncho" style="width:97px; padding-left:12px">
        ...
        <div>
            ...
            <div class="usatFormatoCampoAncho" style="width:110px;">
             ...
             <div class="usatFormatoCampo" style="width:100px">
                <asp:Label ID="Label19" runat="server" Text="Totalizar [T]"></asp:Label>
            </div>
            <div class="usatFormatoCampoAncho" style="width:140px;padding-left:12px">
                <asp:DropDownList ID="ddlTipoOperacion" runat="server" Font-Size="Smaller" 
                    Height="16px" Width="114px">
                </asp:DropDownList>    
                  <asp:CompareValidator ID="CompareValidator8" runat="server" 
                    ErrorMessage="Seleccione un Tipo de Operación" ControlToValidate="ddlTipoOperacion" 
                    Display="Dynamic" Operator="NotEqual" ValidationGroup="grupo1" 
                    ValueToCompare="0">*</asp:CompareValidator>        
            <div style="clear:both; height:0px;"></div>
        </div>    
    ...
    <div class="usatPanel2">
        ...
        <div>
            <div class="usatFormatoCampo">
            <asp:Label ID="Label16" runat="server" Text="Comp.Indicador"></asp:Label>
            </div>
            <div class="usatFormatoCampoAncho">
        ...
        <div>
            ...
            <div> 
               ...
               <div style="float:left; width: 94px; height: 21px;">
    ...
    <div class="usatPanelConsulta">
        ...
        <div style="height:25px;">
        <div class="usatFormatoCampo">
                <asp:Label ID="lblAnioo" runat="server" Text="Año"></asp:Label>
                &nbsp;/ <asp:Label ID="Label18" runat="server" Text="Objetivos"></asp:Label>
            </div>
            <div class="usatFormatoCampoAncho" style="padding-top:0px">   
                
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlAnioBus" runat="server" Width="70px" ValidationGroup="group1" 
                            Font-Size="Smaller" AutoPostBack="True">
                        </asp:DropDownList>       
                        &nbsp;   
                        <asp:DropDownList ID="ddlListaObjetivos" runat="server" Width="84%">
                        </asp:DropDownList>    
                    </ContentTemplate>
                    <Triggers>
         ...
         <table cellpadding="3" cellspacing="0" style="width: 99%; border:1px solid #96ACE7" border="0">
                <tr>                
                    <td style="text-align:center" align="center">
                        <asp:GridView ID="gvIndicadores" runat="server" Width="100%" CellPadding="3" AutoGenerateColumns="False" 
                            
                            
                            
                            DataKeyNames="Codigo,codigo_obj,DesdeOptimo,HastaOptimo,DesdeAmbar,HastaAmbar,DesdeRojo,HastaRojo,CodigoPerspectiva,codigo_pla,año_ind,direccionescala,codigo_top,Codigo_st" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="AbreviaturaObj" HeaderText="Obj." />
                                <asp:BoundField HeaderText="Indicador" DataField="Descripcion" >
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>                                                                
                                <asp:BoundField DataField="basal_ind" HeaderText="Basal" />
                                <asp:BoundField DataField="MetaIndicador" HeaderText="Meta" />
                                
                                <asp:BoundField DataField="Ponderacion" HeaderText="Pond." />
                                <asp:BoundField DataField="TipoDato" HeaderText="TD" />
                                
                                 <asp:BoundField DataField="TipoOperacion" HeaderText="T" />
                                
                                <asp:BoundField HeaderText="Año" DataField="año_ind" />
                                
                                <asp:TemplateField HeaderText="V.Semestral">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="ddlSemestre" AutoPostBack=true Width="120px" runat="server" 
                                         OnSelectedIndexChanged="ddlSemestre_SelectedIndexChanged"
                                         BackColor="#CCFFFF" Font-Size="Smaller">
                                        </asp:DropDownList>
                                        <asp:DropDownList ID="DropDownList1" runat="server">
                                        </asp:DropDownList>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="AvanceAnual" HeaderText="Avance" />
                                ...
                                <asp:BoundField DataField="direccionescala" HeaderText="valDir" 
                                    Visible="False" />
                                <asp:BoundField DataField="codigo_top" HeaderText="codigo_top" 
                                    Visible="False" />
                                <asp:BoundField DataField="Codigo_st" HeaderText="Codigo_st" Visible="False" />
                            </Columns>
