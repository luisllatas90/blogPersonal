<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmListaEvaluarAlineamiento.aspx.vb"
...
<head runat="server">
        ...
        $(document).ready(function() {
            ...
            $("img").click(function() {
                ...
                if ($(this).attr("tipo") == "O") {
                    ...
                    $("#hdcodigo_pla").val($(this).attr("cod_pla"))
                    $("#hdcodigo_poa").val($(this).attr("cod_poa")) //Agregado por fatima.vasquez 08-09-2018
                    $("#mymodal").show();
    ...
    <style type="text/css">
        ...
        /* Centrar Modal de M... en IE */#myModal
        {
...
<body>
    ...
    <div class="titulo_poa">
        <asp:Label ID="Label1" runat="server" Text="Evaluación Alineamiento de Plan Operativo Anual"></asp:Label>
    </div>
    <div class="contorno_poa">
        <table width="100%" id="tabla" runat="server">
            ...
            <tr style="height: 30px">
                ...
                <td colspan="5">
                    ...
                    <%--<img alt="" src="" style="background-color: #87CEEB" width="8px" height="8px" />--%>
                    <div style="float: left">
                        &nbsp;
                        <asp:Label ID="Label2" runat="server"> Pendiente</asp:Label>&nbsp;&nbsp;
                    </div>
                    <%--<img alt="" src="" style="background-color: #F08080" width="8px" height="8px" />--%>
                    <div style="border: solid 1pt; width: 10px; height: 10px; float: left; background-color: #F08080;
                        top: 3pt; vertical-align: middle; display: inline">
                    </div>
                    <div style="float: left">
                        &nbsp;
                        <asp:Label ID="Label4" runat="server"> Observado</asp:Label>&nbsp;&nbsp;
                    </div>
                    <%--<img alt="" src="" style="background-color: #90EE90" width="8px" height="8px" />--%>
                    <div style="border: solid 1pt; width: 10px; height: 10px; float: left; background-color: #90EE90;
                        top: 3pt; vertical-align: middle; display: inline">
                    </div>
                    <div style="float: left">
                        &nbsp;
                        <asp:Label ID="Label5" runat="server"> Aprobado</asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
        ...
        <asp:TreeView ID="treeAlineamiento" runat="server" ExpandDepth="0" Font-Size="XX-Small"
            MaxDataBindDepth="4">
            <Nodes>
            </Nodes>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" style="display: none">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">
                        Observación de Programa / Proyecto</h4>
                </div>
                <div class="modal-body">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:HiddenField runat="server" ID="hdcodigo_acp" />
                                <asp:HiddenField runat="server" ID="hdcodigo_pla" />
                                <asp:HiddenField runat="server" ID="hdcodigo_poa" />
                                <%-- Agregado por fatima.vasquez 09-08-2018 %>---%>
                                <div class="nombre_prog">
                                    <asp:Label ID="lblacp" runat="server"></asp:Label></div>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 130px;">
                            ...
                            <td>
                                <textarea id="txtobservacion" runat="server" cols="50" rows="5" name="txtobservacion"></textarea>
                            </td>
                        </tr>
                    </table>
                    <%--<tr><td>Indicador  </td>
        ...
        <td><textarea id="txtobservacion" runat="server" cols="50" rows="5" name="txtobservacion"></textarea></td>
                ...
                <div class="modal-footer" id="Aprobar" style="display: none">
                    <button type="button" class="btn btn-danger" id="btnObservar">
                        Observar</button>
                    <asp:Button ID="btnAprobacion" runat="server" Text="Aprobar" class="btn btn-primary"
                        OnClientClick="return confirm('¿Está seguro que desea Aprobar el Alineamiento?.')" />
                </div>
                <div class="modal-footer" id="Observar">
                    <button type="button" class="btnCancelar" data-dismiss="modal" id="btncancelar">
                        &nbsp;&nbsp;Cancelar</button>
                    <asp:Button ID="btnObservacion" runat="server" Text="   Guardar" class="btnGuardar"
                        OnClientClick="return confirm('¿Está seguro que desea registrar la Observación?.')" />
                </div>
            </div>
        </div>
    </div>
