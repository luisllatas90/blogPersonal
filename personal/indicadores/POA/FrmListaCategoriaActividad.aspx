<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmListaCategoriaActividad.aspx.vb" Inherits="indicadores_POA_FrmListaCategoriaActividad" %>
...
<body>
    ...
    <div class="titulo_poa">
        <asp:Label ID="Label1" runat="server" Text="Registro de Actividades"></asp:Label>
    </div>
    <div class="contorno_poa">
        <table width="100%">
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="btnBuscar" runat="server" Text="   Buscar" CssClass="style2" />
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            ...
            <tr>
                <td colspan="7">
                    <asp:Button ID="btnNuevo" runat="server" Text="    Nueva Actividad" CssClass="btnNuevo" />
                </td>
            </tr>
            <tr>
                <td colspan="7">
        ...
        <asp:GridView ID="dgv_Categoria" runat="server" Width="100%" AutoGenerateColumns="False"
            DataKeyNames="codigo_cat" CellPadding="3">
            <Columns>
                <asp:BoundField HeaderText="DESCRIPCIÓN" DataField="nombre_cat">
                    <HeaderStyle Width="550px" />
                </asp:BoundField>
                <asp:BoundField HeaderText="estado_cat" DataField="estado_cat" Visible="False">
