...
Partial Class indicadores_POA_FrmListaEvaluarPresupuesto
    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        Try
            ...
            If IsPostBack = False Then
                ...
                Else
                    If Request.QueryString("back") = "Estado" Then
                        If Request.QueryString("ok") = "1" Then
                            Me.aviso.Attributes.Add("class", "mensajeExito")
                            Me.lblrpta.Text = "Programa/Proyecto Fue Enviado Correctamente"
                        Else
                            Me.aviso.Attributes.Add("class", "mensajeError")
                            Me.lblrpta.Text = "Programa/Proyecto No se Pudo Enviar"
                        End If
                    End If
    ...
    Function CargaActividadesPto(ByVal codigo_pladdl As Integer, ByVal codigo_poaddl As Integer, ByVal codigo_ejp As Integer, ByVal estado As String, ByVal id As Integer, ByVal ctf As Integer) As String
        ...
        If dt.Rows.Count > 0 Then
            ...
            strTabla = strTabla & "<th rowspan='3' width='30px' align='center' >VER DETALLE</th>"
            strTabla = strTabla & "<th rowspan='3' width='30px' align='center' >VER GRAFICO</th>"
            If ctf = 156 Or ctf = 158 Or ctf = 1 Then ' SOLO PARA ADMINISTRADOR Y  DIRECTOR DE FINANZAS
                strTabla = strTabla & "<th rowspan='3' width='65px' align='center' >RETORNA A REGISTRO PRESUPUESTO</th>"
            End If
            strTabla = strTabla & "</tr>"
            strTabla = strTabla & "<tr>"
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                If i + 1 <= dt.Rows.Count - 1 Then
                    ...
                    If codigo_poa = dt.Rows(i + 1).Item("codigo_poa") Then
                        ...
                        StrCeldas = StrCeldas & "<td align='center' class='celda_combinada'>"
                        ...
                        StrCeldas = StrCeldas & "&cb2=" & Me.ddlEjercicio.SelectedValue & "&cb3=" & Me.ddlPoa.SelectedValue & "&cb4=" & Me.ddlestado.SelectedValue & "&despoa=" & dt.Rows(i).Item("nombre_poa") & "&acp=" & dt.Rows(i).Item("codigo_acp") & "' title='Ver Detalle' ><img src='../../Images/verDetallePOA.png' height='18' wdth='18' border='0' /></a>"
                        'End If
                        StrCeldas = StrCeldas & "</td><td align='center'><b><a href='../../../../rptusat/?/PRIVADOS/POA/POA_GraficoDetalleEjecucion&codigo_acp=" & dt.Rows(i).Item("codigo_acp") & "' title='Ver Grafico'"
                        StrCeldas = StrCeldas & " ><img src='../../Images/vergraficoPOA.png' height='18' wdth='18' border='0' /></a></b></td>"
                        If ctf = 156 Or ctf = 158 Or ctf = 1 Then ' SOLO PARA ADMINISTRADOR Y  DIRECTOR DE FINANZAS
                            StrCeldas = StrCeldas & "<td align='center'><a onclick='confirma(" & dt.Rows(i).Item("codigo_acp") & "," & id & "," & ctf & ");' title='Enviar a Registro de Presupuesto' ><img src='../../Images/back.gif' height='18' wdth='18' border='0' /></a></td>"
                        End If
                    ...
                    Else
                        ...
                        'StrCab = "<tr><td class='celda_combinada' rowspan=" & rowspanCab & "><a href='../../../../reportServer/?/PRIVADOS/POA/POA_GraficoDetalleEjecucionxPOA&cp=" & dt.Rows(i).Item("codigo_poa") & "&cod_iep=" & Me.ddlestado.SelectedValue & "' title='Ver Grafico'>" & dt.Rows(i).Item("nombre_poa") & "</a></td>"
                        StrCab = "<tr><td class='celda_combinada' rowspan=" & rowspanCab & "><a href='../../../../rptusat/?/PRIVADOS/POA/POA_GraficoDetalleEjecucionxPOA&cp=" & dt.Rows(i).Item("codigo_poa") & "&cod_iep=" & Me.ddlestado.SelectedValue & "' title='Ver Grafico'>" & dt.Rows(i).Item("nombre_poa") & "</a></td>"
                        StrCeldas = StrCeldas & "<td class='celda_combinada'>" & dt.Rows(i).Item("descripcion_tac") & "</td>"
                        StrCeldas = StrCeldas & "<td class='celda_combinada'>" & dt.Rows(i).Item("resumen_acp") & "</td>"
                        StrCeldas = StrCeldas & "<td align='right' class='celda_combinada'>" & FormatNumber(dt.Rows(i).Item("ingresos_acp"), 2) & "</td>"
                        StrCeldas = StrCeldas & "<td align='right' class='celda_combinada'>" & FormatNumber(dt.Rows(i).Item("ingresos_pto"), 2) & "</td>"
