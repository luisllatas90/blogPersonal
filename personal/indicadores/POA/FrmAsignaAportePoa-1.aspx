<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmAsignaAportePoa-1.aspx.vb" Inherits="indicadores_POA_FrmAsignaAportePoa" %>
...
<body>
    ...
    <div class="contorno_poa">
        ...
        <td><input type="button" value="Alerta" id="boton" name="boton" onclick="return boton_onclick()" /></td>
        </tr>
        <tr>
        <td colspan="6">
        ...
        <p>
        Inbox : <span class="badge">46</span>
        </p>
        <div id="ResultJson" name="ResultJson"></div>
    </div>
    </form>
</body>
</html>
