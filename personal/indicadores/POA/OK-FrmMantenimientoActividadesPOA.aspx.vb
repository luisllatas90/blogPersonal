...
#Region "PANEL N°1"
    ...
    Protected Sub btnguardar_cco_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnguardar_cco.Click
        Try
            ...
            dt.Clear()
            dt = obj.CrearCostoTemporalPOA(Me.txtdescripcion_cco.Text, codigo_poa, 2, codigo_raiz, Me.ddlprogpresupuestal_cco.SelectedValue, Me.ddlresponsable_cco.SelectedValue, Request.QueryString("id"))
            Me.ddlTipoActividad.SelectedValue = 2
        ...
        Try
            ...
            If Me.btnguardar_cco.Visible = False Then
                ...
                If Me.hdcodigoacp.Value = 0 Then
                    ...
                    codigo_acp = obj.AtualizarActividadPoa(abreviatura, descripcion_acp, Me.txtEgresos.Text, Me.txtIngresos.Text, Me.txtUtilidad.Text, Request.QueryString("id"), Me.ddlTipoActividad.SelectedValue, Me.ddlResponsable.SelectedValue, Me.ddlApoyo.SelectedValue, Me.ddlCeco.SelectedValue, Me.ddlProgPresupuestal.SelectedValue, Request.QueryString("codigo_poa"), fecha_inicio, fecha_fin, Me.hdcodigo_ejp.Value, Me.hdcodigoacp.Value)
                    If codigo_acp > 0 Then
...
#Region "PANEL N°3"
    ...
    Protected Sub btnNuevoIndicador_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNuevoIndicador.Click
        ...
        'Response.Write("<script>alert('OBJETIVO: " & hd_codigo_pobj.Value & "')</script>")
    End Sub
...
#End Region
    ...
    Protected Sub btnGuardarObs_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardarObs.Click
        Try
            ...
            If mensaje = 0 Then
                ...
                Dim dt As New Data.DataTable
                dt = obj.POA_EnvioMails(Me.hdcodigoacp.Value, Request.QueryString("id"))
                ...
                Dim MensajeCorreo As String = txtobservacion.Text.Trim.ToUpper
                Dim copia As String = ""
                ...
                If EnviarMensaje(de, de_nombre, para, Asunto, MensajeCorreo, copia, strRuta, nombrearchivo, replyto) Then
                    ...
                    Response.Write("<script>alert('El Mensaje se envio Satisfactoriamente')</script>")
                Else
    ...
    Protected Sub dgv_p4_detalle_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_p4_detalle.SelectedIndexChanged
