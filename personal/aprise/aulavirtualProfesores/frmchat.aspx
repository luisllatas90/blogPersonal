<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmchat.aspx.vb" Inherits="aulavirtual_frmchat" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Registro de sesiones de chat</title>
                    ...
                    <table style="width: 100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="width: 23%">
                                &nbsp;Título</td>
                            <td colspan="2">
                                &nbsp;<asp:TextBox ID="TxtNombre" runat="server" Font-Size="9pt" Width="435px" MaxLength="50"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtNombre"
                                    ErrorMessage="Especifique Titulo de la chat.">*</asp:RequiredFieldValidator></td>
                        </tr>
                        <tr>
                            <td>
                                &nbsp;Fecha de inicio</td>
                        ...
                        <tr>
                            <td colspan="3" align="right" class="azul">
                                <asp:Label id="LblPublicacion" runat="server" Text="¿Quién visualizará esta sesión de chat ?"></asp:Label>&nbsp;
