<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmdocumento2.aspx.vb" Inherits="aulavirtual_frmdocumento2" %>
...
<tr>
    ...
    <td>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtNombre"
            ErrorMessage="Especifique nombre de documento.">*</asp:RequiredFieldValidator>
    </td>
  </tr>
<tr>
    <td>
        &nbsp;<asp:Label ID="LblUbicacion" runat="server" Text="Ubicacion de Archivo (5 megas máx.)" Width="128px"></asp:Label></td>
    <td>
...
<tr>
    ...
    <td>
        &nbsp;<asp:TextBox ID="TxtComentario" runat="server" Height="75px" TextMode="MultiLine"
            Width="95%" Font-Size="9pt" MaxLength="255"></asp:TextBox></td>
</tr>
<tr>
    <td colspan="2" align="right" class="azul">
        <asp:Label id="LblPublicacion" runat="server" Text="¿Quién visualizará este archivo?"></asp:Label>&nbsp;
