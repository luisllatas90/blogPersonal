...
Partial Class aulavirtual_frmdocumento
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            Me.trfechainicio.visible = False
            Me.trfechafin.visible = False
    ...
    Protected Sub CmdGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmdGuardar.Click
		...
		Dim carpetaDestino As New System.IO.DirectoryInfo(ruta)
                ...
                '##########################################################################
                If fileExtension = ".zip" Or fileExtension = ".rar" Or fileExtension = ".pdf" Then
                    fileOk = True
                Else
                    Me.LblMensaje.Text = "El tipo de Archivo no está permitido permitido. Solamente debe subir archivos ZIP, RAR y PDF"
                    Exit Sub
                End If
                ...
                If fileOk = True Then
                    ...
                    Try
                        ...
                        If valordevuelto > 0 Then
                            ...
                            Else
                                Response.Write("<script>window.opener.location='../../personal/aulavirtual/documentos/index.asp?veces=1'; window.close();</script>")
                            End If
                        End If
        ...
        Else
            Try
                ...
                ObjCMDUSAT.TerminarTransaccion()
                Response.Write("<script>window.opener.location='../../personal/aulavirtual/documentos/detalledocumento.asp?" & Replace(Page.ClientQueryString, "&accion=modificardocumento", "", , , CompareMethod.Text) & "'; window.close()</script>")
            Catch ex As Exception
                ObjCMDUSAT.AbortarTransaccion()
