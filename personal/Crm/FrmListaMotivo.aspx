<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmListaMotivo.aspx.vb"
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/crm.js?x=5"></script>

    <script type="text/javascript" src="js/JsMotivo.js?x=5"></script>
                            ...
                            <div id="PanelBusqueda">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="page_header">
                                        <div class="pull-left">
                                            <i class="icon ti-volume page_header_icon"></i><span class="main-text">Motivo de Comunicación</span>
                                        </div>
                                        ...
                                        <form class="form form-horizontal" id="frmBuscarMotivo" name="frmBuscarMotivo" onsubmit="return false;"
                                        action="#" method="post">
                                        <div class="row">
                                            <div class="col-md-12">
                                            </div>
                    ...
                    <div class="panel panel-piluku" id="PanelLista">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                Listado de Motivos de Comunicación <span class="panel-options"><a class="panel-refresh"
                                    href="#"><i class="icon ti-reload" onclick="fnBuscarMotivo(false)"></i></a><a class="panel-minimize"
                                        href="#"><i class="icon ti-angle-up"></i></a></span>
                            </h3>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <div id="ttMotivo_wrapper" class="dataTables_wrapper" role="grid">
                                    <table id="tMotivo" name="tMotivo" class="display dataTable" width="100%">
                                        <thead>
                                            <tr role="row">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header" style="background-color: #E33439; color: White; font-weight: bold;">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel3">
                                            Mantenimiento de Motivos de Comunicación</h4>
                                    </div>
