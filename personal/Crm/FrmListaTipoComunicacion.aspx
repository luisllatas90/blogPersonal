<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmListaTipoComunicacion.aspx.vb"
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/crm.js?x=3"></script>

    <script type="text/javascript" src="js/JsTipoComunicacion.js?x=10"></script>
                            ...
                            <div id="PanelBusqueda">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="page_header">
                                        <div class="pull-left">
                                            <i class="icon ti-volume page_header_icon"></i><span class="main-text">Tipo de Comunicación</span>
                                        </div>
                                        ...
                                        <form class="form form-horizontal" id="frmBuscarTipoComunicacion" name="frmBuscarTipoComunicacion"
                    ...
                    <div class="panel panel-piluku" id="PanelLista">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                Listado de Tipo de Comunicación <span class="panel-options"><a class="panel-refresh"
                                    href="#"><i class="icon ti-reload" onclick="fnBuscarTipoComunicacion(false)"></i>
                                </a><a class="panel-minimize" href="#"><i class="icon ti-angle-up"></i></a></span>
                            </h3>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <div id="tTipoComunicacion_wrapper" class="dataTables_wrapper" role="grid">
                                    <table id="tTipoComunicacion" name="tTipoComunicacion" class="display dataTable"
                                        width="100%">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <td width="45%" style="font-weight: bold; width: 89px; text-align: center" class="sorting"
                                                ...
                                                <td width="20%" style="font-weight: bold; width: 89px; text-align: center" class="sorting"
                                                    tabindex="0" rowspan="1" colspan="1" aria-label="Categoria: activate to sort column ascending">
                                                    Categoría
                                                </td>
                                                <td width="20%" style="font-weight: bold; width: 89px; text-align: center" class="sorting"
                                                    tabindex="0" rowspan="1" colspan="1" aria-label="Procedencia: activate to sort column ascending">
                                                    Procedencia
                                                </td>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header" style="background-color: #E33439; color: White; font-weight: bold;">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel3">
                                            Mantenimiento de Tipo de Comunicación</h4>
                                    </div>
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="cboCategoria" id="cboCategoria" class="form-control">
                                                        ...
                                                        <option value="ADMISION OTROS">ADMISIÓN - OTROS</option>
                                                        <option value="MARKETING MASIVO">MASIVO MARKETING</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="cboProcedencia" id="cboProcedencia" class="form-control">
                                                        <option value="">-- Seleccione --</option>
                                                        <option value="S" selected="true">SALIENTE</option>
