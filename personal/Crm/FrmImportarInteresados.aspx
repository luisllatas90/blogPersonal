<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmImportarInteresados.aspx.vb"
    Inherits="Crm_FrmImportarInteresados" %>
...
<head runat="server">
    ...
    <title>CRM - Importar Interesados</title>
    ...
    <div class="wrapper">
        <div class="content">
            <div class="page_header">
                <div class="pull-left">
                    <i class="icon ti-import page_header_icon"></i><span class="main-text">Importar Interesados</span>
                    <p class="text">
                        Importar Interesados desde Excel.
                    </p>
                </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel" runat="server">
                        <ContentTemplate>
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-md-2 control-label ">
                                        Convocatoria CRM</label>
                                    <div class="col col-md-6">
                                        <asp:DropDownList runat="server" ID="ddlConvocatoria" CssClass="form-control" AutoPostBack="true">
                                            <asp:ListItem Value="">--Seleccione--</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-md-2 control-label ">
                                        Evento</label>
                                    <div class="col col-md-6">
                                        <asp:DropDownList runat="server" ID="ddlEvento" CssClass="form-control">
                                            <asp:ListItem Value="">--Seleccione--</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
