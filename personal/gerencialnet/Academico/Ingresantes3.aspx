<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ingresantes3.aspx.cs" Inherits="Ingresantes3"  %>
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <DOCWC:OlapGrid ID="OlapGrid1" runat="server" Height="480px" Width="730px" OlapManagerID="OlapManager1"
                                    ...
                                    TitleBackColor="WhiteSmoke" TitleColor="Black" TitleText="Ingresantes por Semestre Academico y Escuela Profesional segun Modalidad de Ingreso" TitleVisible="False" CellBorderWidth="1px" BorderWidth="0px" SubTotalsVisible="False" AddContextMenu="False" >
