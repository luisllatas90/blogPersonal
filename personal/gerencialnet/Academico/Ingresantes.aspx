<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ingresantes.aspx.cs" Inherits="Ingresantes"%>
...
<body>
    <form id="form1" runat="server">
            <DOCWC:OlapToolbar ID="OlapToolbar1" runat="server" Width="100%"
                OnClick="OlapToolbar1_Click" OlapManagerID="OlapManager1">
            </DOCWC:OlapToolbar>
            
            <asp:Panel ID="PanelChartGrid" runat="server" Width="100%" Style="margin-top: 4px;
                text-align: left; font-family: Tahoma;" Height="100%">

                <asp:Panel ID="Panel1" runat="server" Height="25px" Width="100%" Style="white-space: nowrap;
                ...
                <asp:Panel ID="PanelChartGridFrame" runat="server" Width="100%" BorderColor="gainsboro"
                    BorderStyle="Solid" BorderWidth="1px" Style="padding: 4px;" Height="560px">
               
                    <table cellpadding="0" cellspacing="0" style="height: 100%" width="100%">
                        <tr>
                            <td valign="top">
                                <DOCWC:OlapChart ID="OlapChart1" runat="server" Style="display: block;" OnInit="OlapChart1_Init"
                                    OlapManagerID="OlapManager1" Height="560px">
                                    <Legends>
                                    ...
                                    <ToolbarSettings>
                                        ...
                                        <SelectChartType Description="Select Chart Type" Visible="False" />
                            ...
                            <td valign="top">
                                <DOCWC:OlapGrid ID="OlapGrid1" runat="server" Height="580px" Width="100%" OlapManagerID="OlapManager1"
                                    TitleFont="Tahoma, 12pt"
                                    TitleBackColor="WhiteSmoke" TitleColor="Black" TitleText="Ingresantes por Semestre de Ingreso y Escuela Profesional" TitleVisible="False" CellBorderWidth="1px" BorderWidth="0px" AddContextMenu="False" SubTotalsVisible="False" >
            ...
            <asp:Panel ID="PanelAxes" runat="server" Width="100%" Style="margin-top: 4px; position: relative;
                text-align: left; font-family: Tahoma;">
                <asp:Panel ID="PanelAxesBuilderTabs" runat="server" Height="25px" Width="196px" Style="white-space: nowrap;
                    position: relative; left: 3px;">
                    <asp:Panel ID="PanelTabCategories" runat="server" Width="70px" CssClass="ppbtn_selected"
                        Style="left: 0px; padding-top: 4px; position: absolute; top: 0px;" onmouseover="tabControlOver(this);"
                        onmouseout="tabControlOut(this);">
                        &nbsp;&nbsp;Escuela</asp:Panel>
                    <asp:Panel ID="PanelTabSeries" runat="server" Width="70px" CssClass="ppbtn_normal"
                    ...
                    <asp:Panel ID="PanelTabSlicer" runat="server" Width="70px" CssClass="ppbtn_normal"
                        Style="left: 142px; padding-top: 4px; position: absolute; top: 0px;" onmouseover="tabControlOver(this);"
                        onmouseout="tabControlOut(this);" Visible="False">
                        &nbsp;&nbsp;Slicer</asp:Panel>
                </asp:Panel>
                
                <asp:Panel ID="PanelAxesBuilders" runat="server" Width="100%" Height="32px" BorderColor="gainsboro"
                    ...
                    <DOCWC:AxisBuilder ID="AxisBuilderCategorical" runat="server" AxisType="Categorical"
                        Height="32px" OlapManagerID="OlapManager1" Width="100%" BackColor="GhostWhite"
                    ...
                    <DOCWC:AxisBuilder ID="AxisBuilderSeries" runat="server" AxisType="Series" Height="32px"
                        OlapManagerID="OlapManager1" Width="100%" BackColor="GhostWhite" DialogDirection="UpRight"
