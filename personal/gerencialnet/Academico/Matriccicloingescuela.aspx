<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Matriccicloingescuela.aspx.cs" Inherits="Matriccicloingescuela"  %>
    ...
    <center>
        <div style="font-family: Tahoma;">
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <DOCWC:OlapGrid ID="OlapGrid1" runat="server" Height="480px" Width="730px" OlapManagerID="OlapManager1"
                                    ...
                                    TitleBackColor="WhiteSmoke" TitleColor="Black" TitleText="Matriculados 2008-I por Semestre de Ingreso y Escuela Profesional" TitleVisible="False" CellBorderWidth="1px" BorderWidth="0px" AddContextMenu="False" TotalsVisible="False" >
            ...
            <asp:Panel ID="PanelAxes" runat="server" Width="740px" Style="margin-top: 4px; position: relative;
                ...
                <asp:Panel ID="PanelAxesBuilderTabs" runat="server" Height="21px" Width="274px" Style="white-space: nowrap;
                    position: relative; left: 3px; top: 0px;">
                    <asp:Panel ID="PanelTabCategories" runat="server" Width="66px" CssClass="ppbtn_selected"
                        Style="left: 0px; padding-top: 4px; position: absolute; top: 0px;" onmouseover="tabControlOver(this);"
                        onmouseout="tabControlOut(this);">
                        &nbsp;Escuelas</asp:Panel>
                    <asp:Panel ID="PanelTabSeries" runat="server" Width="117px" CssClass="ppbtn_normal"
                        Style="left: 67px; padding-top: 4px; position: absolute; top: 0px;" onmouseover="tabControlOver(this);"
                    ...
                    <asp:Panel ID="PanelTabSlicer" runat="server" Width="70px" CssClass="ppbtn_normal"
                        Style="left: 225px; padding-top: 4px; position: absolute; top: 0px;" onmouseover="tabControlOver(this);"
                        onmouseout="tabControlOut(this);" Visible="False">
