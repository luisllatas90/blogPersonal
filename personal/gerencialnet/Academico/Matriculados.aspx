<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Matriculados.aspx.cs" Inherits="Matriculados"  %>
    ...
    <form id="form1" runat="server">
            ...
            <asp:Panel ID="PanelChartGrid" runat="server" Width="100%" Style="margin-top: 4px;
                ...
                <asp:Panel ID="PanelChartGridFrame" runat="server" Width="100%" BorderColor="gainsboro"
                    BorderStyle="Solid" BorderWidth="1px" Style="padding: 4px;" Height="580px">
                    <table cellpadding="0" cellspacing="0" style="height: 580px">
                        <tr>
                            <td valign="top">
                                <DOCWC:OlapChart ID="OlapChart1" runat="server" Style="display: block;" OnInit="OlapChart1_Init"
                                    OlapManagerID="OlapManager1" Height="580px">
                                    <Legends>
                            ...
                            <td valign="top">
                                <DOCWC:OlapGrid ID="OlapGrid1" runat="server" Height="580px" Width="100%" OlapManagerID="OlapManager1"
                                    ...
                                    TitleBackColor="WhiteSmoke" TitleColor="Black" TitleText="Matriculados por Ciclo Academico y Escuela Profesional" TitleVisible="False" CellBorderWidth="1px" BorderWidth="0px" AddContextMenu="False" SubTotalsVisible="False" >
            ...
            <asp:Panel ID="PanelAxes" runat="server" Width="100%" Style="margin-top: 4px; position: relative;
                ...
                <asp:Panel ID="PanelAxesBuilderTabs" runat="server" Height="25px" Width="100%" Style="white-space: nowrap;
