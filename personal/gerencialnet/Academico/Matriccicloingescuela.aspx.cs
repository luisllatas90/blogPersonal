...
public partial class Matriccicloingescuela : System.Web.UI.Page
{
    ...
    private void UpdateChartGridVisibility()
    {
        ...
        switch (this.ActiveChartGridView)
        {
            ...
            case ChartGridViewState.Both:
                this.OlapChart1.Visible = true;
                this.OlapGrid1.Visible = true;
                this.OlapChart1.Width = 430;
                this.OlapGrid1.Width = 300;
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (!this.IsPostBack)
        {
           ...
           this.OlapManager1.LoadReports(this.Server.MapPath("matriccicloingescuela.xml"));
