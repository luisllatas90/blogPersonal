<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Matriccicloing.aspx.cs" Inherits="Matriccicloing"  %>
        ...
        <div style="font-family: Tahoma;">
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <DOCWC:OlapGrid ID="OlapGrid1" runat="server" Height="480px" Width="730px" OlapManagerID="OlapManager1"
                                    ...
                                    TitleBackColor="WhiteSmoke" TitleColor="Black" TitleText="Matriculados por Semestre de Ingreso y Ciclo Academico" TitleVisible="False" CellBorderWidth="1px" BorderWidth="0px" AddContextMenu="False" SubTotalsVisible="False" >
            ...
            <asp:Panel ID="PanelAxes" runat="server" Width="740px" Style="margin-top: 4px; position: relative;
                ...
                <asp:Panel ID="PanelAxesBuilderTabs" runat="server" Height="21px" Width="274px" Style="white-space: nowrap;
                    ...
                    <asp:Panel ID="PanelTabCategories" runat="server" Width="112px" CssClass="ppbtn_selected"
                        Style="left: 0px; padding-top: 4px; position: absolute; top: 0px;" onmouseover="tabControlOver(this);"
                        onmouseout="tabControlOut(this);">
                        &nbsp;Semestre Ingreso</asp:Panel>
                    <asp:Panel ID="PanelTabSeries" runat="server" Width="110px" CssClass="ppbtn_normal"
                        Style="left: 113px; padding-top: 4px; position: absolute; top: 0px;" onmouseover="tabControlOver(this);"
