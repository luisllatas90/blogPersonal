...
Imports System.Web
Partial Class matriculaciclo
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            Session("Titulo") = "Total Recaudado por Matricula segun Escuela Profesional y Ciclo Académico"
    ...
    Protected Function LeeAño() As String
        Dim StrValor As String
        If Me.DDLModalidad.SelectedValue = "0" Then
            StrValor = "where estado.ingreso"
        Else
            StrValor = "where (estado.ingreso, [tiempo].[" & Me.DDLModalidad.SelectedValue & "])"
        End If
        Return StrValor
    End Function
    ...
    Public Function ObtenerConsulta(ByVal arbol1 As TreeView, ByVal arbol3 As TreeView, ByVal pos1 As Integer, ByVal pos3 As Integer) As String
        ...
        StrSQL = StrSQL & ", NON EMPTY {servicio.[matricula].[matricula] } on axis(2) "
    ...
    Protected Sub LlenaMOdalidad()
        ...
        Try
            ...
            cnx.Open()
            cmd = New SqlCommand("pa_tiempo_año", cnx)
    ...
    Protected Sub ConsultaLoad()
        ...
        MDX = MDX & ", [Carreraprofesional].[INGENIERÍA].children,[Carreraprofesional].[MEDICINA].children,[Carreraprofesional].[HUMANIDADES].children, carreraprofesional.[--- no definida ---].children} on axis(1)"
        MDX = MDX & ", NON EMPTY {servicio.[matricula].[matricula]} on axis(2)"
