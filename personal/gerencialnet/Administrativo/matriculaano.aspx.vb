...
Imports System.Web
Partial Class MatriculaAno
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            Session("Titulo") = "Total Recaudado por Matricula segun Escuela Profesional y Año de Recaudo"
    ...
    Public Function ObtenerConsulta(ByVal arbol1 As TreeView, ByVal arbol3 As TreeView, ByVal pos1 As Integer, ByVal pos3 As Integer) As String
        ...
        StrSQL = StrSQL & ", NON EMPTY {servicio.[matricula] } on axis(2) "
