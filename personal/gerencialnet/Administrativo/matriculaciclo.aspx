<%@ Page Language="VB" AutoEventWireup="false" CodeFile="matriculaciclo.aspx.vb" Inherits=" matriculaciclo" %>
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="3" rowspan="1" style="font-size: 8pt; color: navy; font-family: verdana"
                    valign="top">
                    Año de Recaudo : &nbsp;<asp:DropDownList ID="DDLModalidad" runat="server" Style="font-size: 8pt; color: navy;
