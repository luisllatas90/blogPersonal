...
Partial Class Grafico
    ...
    Protected Sub MostrarReporte()
        ...
        Try
            ...
            strScript = objcubo.MostrarGrafAdm(120, Me.PanelLeyenda)
        ...
        Catch ex As Exception
            Me.PanelLeyenda.Visible = False
            Response.Write("<br><br><br><br><center><font size='3' face='Arial'>¡¡¡Ocurrio un error al elaborar el gráfico!!!<br>Posiblemente no ha seleccionado ningun tipo de informacion o tenga <br> que cambiar los ejes de presentacion.</center>")
        End Try
    ...
    Protected Sub MostrarReporte2()
        Try
            ...
            objcubo.Cubo = Session("cubo")
            objcubo._strConsulta = Session("consulta")
            If objcubo.MostrarGrafAdm(100, Me.PanelLeyenda) IsNot Nothing Then
                Response.Write("&nbsp;&nbsp;&nbsp;&nbsp;<font face='arial' color='blue' size='1'>Actualizado al : " & objcubo.MuestraFecha() & "</font>")
                Response.Write(objcubo.MostrarGrafAdm(100, Me.PanelLeyenda))
                Me.PanelLeyenda.Visible = True
            Else
                Response.Write("<br><br><br><br><center><font size='3' face='Arial'>¡¡¡No se encontraron coincidencias de las opciones seleccionadas!!!<br>Intentelo Nuevamente</center>")
            End If
