...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tabs').smartTab({ selected: 0, saveState: true, autoProgress: false, stopOnFocus: true, transitionEffect: 'slide', keyNavigation: false });
        ...
        <div class="panel panel-default" id="pnlLista" runat="server">
            ...
            <div class="panel panel-body">
                ...
                <div id="tabs" runat="server">
                    <ul>
                        <li id="liPerfilIngreso" runat="server"><a href="#tabs-1"><small><b>PERFIL DE INGRESO</b></small>
                        </a></li>
                        <li id="liPerfilEgreso" runat="server"><a href="#tabs-2"><small><b>PERFIL DE EGRESO</b></small>
                        </a></li>
                    </ul>
                    <div id="tabs-1">
                        <div class="row">
