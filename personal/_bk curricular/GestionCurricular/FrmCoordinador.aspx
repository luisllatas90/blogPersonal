            ...
            <div class="panel panel-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-md-4">
                                Tipo Asignatura:</label>
                            <div class="col-md-8">
                                <asp:DropDownList ID="cboTipoCur" runat="server" CssClass="form-control input-sm"
                                    AutoPostBack="true">
                                    <asp:ListItem Value="1"> Genéricas - Transversales </asp:ListItem>
                                    <asp:ListItem Value="2"> Genéricas - No Transversales </asp:ListItem>
                                    <asp:ListItem Value="3"> Específicas </asp:ListItem>
                                    <asp:ListItem Value="4"> Especialidad </asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvCoordinador" runat="server" AutoGenerateColumns="false" ShowHeader="true"
                            AllowPaging="True" PageSize="10" DataKeyNames="codigo_coo, codigo_cur, codigo_per, codigo_pes, nombre_Cur, indicador_coo"
                        ...
                        <ContentTemplate>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            <asp:CheckBox ID="chkDocente" runat="server" Text=" Listar Docentes del Departamento Académico"
