                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <asp:GridView ID="gvAsignatura" runat="server" Width="99%" AutoGenerateColumns="false"
                                ShowHeader="true" AllowPaging="True" PageSize="10" DataKeyNames="codigo_sum, codigo_pes, codigo_Cur, descripcion_sum,competencia_sum"
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Acción" HeaderStyle-Width="4%">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnEditar" runat="server" OnClick="btnEditar_Click" CommandName="Editar"
                                                CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>" CssClass='<%# IIF(Eval("codigo_sum")=-1,"btn btn-success btn-sm","btn btn-primary btn-sm") %>'
