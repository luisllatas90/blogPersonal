...
#Region "Eventos"
    ...
    Protected Sub cboCarProf_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboCarProf.SelectedIndexChanged
        Try
            ...
            If Me.gvAsignatura.Rows.Count > 0 Then mt_CargarDatos(0)
    ...
    Protected Sub btnGrabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        ...
        Try
            ...
            Else
                obj.AbrirConexion()
                obj.Ejecutar("PlanCursoSumilla_insertar", Session("gc_codigo_pes"), Session("gc_codigo_cur"), Me.txtSumilla.Text, Me.txtCompetencia.Text.Trim, cod_user)
                obj.CerrarConexion()
    ...
    Protected Sub cboPlanEst_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboPlanEst.SelectedIndexChanged
        Try
            mt_CargarDatos(IIf(Me.cboPlanEst.SelectedValue = -1, 0, Me.cboPlanEst.SelectedValue))
        Catch ex As Exception
            mt_ShowMessage(ex.Message.Replace("'", " "), MessageType.Error)
        End Try
    End Sub
...
#Region "Metodos"
    ...
    Private Sub mt_CargarDatos(ByVal codigo_pes As Integer)
        Dim obj As New ClsConectarDatos
        Dim dt As New Data.DataTable
        obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ToString
        Try
            obj.AbrirConexion()
            dt = obj.TraerDataTable("PlanCursoSumilla_Listar", "PC", -1, codigo_pes, -1)
            obj.CerrarConexion()
