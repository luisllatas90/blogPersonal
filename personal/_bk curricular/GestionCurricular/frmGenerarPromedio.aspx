<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmGenerarPromedio.aspx.vb"
    Inherits="GestionCurricular_frmGenerarPromedio" EnableEventValidation="false" %>
            ...
            <div class="panel panel-body">
                ...
                <div class="row">
                    <div class="col-md-1" style="text-align: left">
                        <asp:LinkButton ID="btnPublicar" runat="server" CssClass="btn btn-primary" Text='<i class="fa fa-save"></i> Publicar'
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <asp:GridView ID="gvNotas" runat="server" AutoGenerateColumns="false" ShowHeader="true"
                                DataKeyNames="codigo_Dma, codigoUniver_Alu, codigo_mat, nombre_alu" OnRowDataBound="gvNotas_OnRowDataBound"
                                OnRowCreated="gvNotas_OnRowCreated" CssClass="table table-bordered table-hover">
                                <Columns>
                                    <asp:TemplateField HeaderText="Código" HeaderStyle-Width="8%" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="nombre_alu" HeaderText="Apellidos y Nombres" HeaderStyle-Width="32%" />
                                </Columns>
                                <EmptyDataTemplate>
