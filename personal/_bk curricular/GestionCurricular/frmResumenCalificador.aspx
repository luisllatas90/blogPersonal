...
<head runat="server">
    ...
    <title>Resumen Calificador</title>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <asp:GridView ID="gvAsignatura" runat="server" AutoGenerateColumns="false" ShowHeader="true"
                                AllowPaging="True" PageSize="10" DataKeyNames="codigo_cup, codigo_cur, codigo_pes, nombre_Cur, codigo_dis"
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <asp:GridView ID="gvContenido" runat="server" AutoGenerateColumns="false" GridLines="None"
                                        ShowHeadersWhenNoRecords="True" DataKeyNames="codigo_con, codigo_cdes" CssClass="table table-sm table-bordered table-hover"
                                        ShowFooter="False" ShowHeader="True">
                                        <Columns>
                                            <asp:BoundField DataField="numero_uni" HeaderText="Unidad" HeaderStyle-Width="5%"
                                                ItemStyle-Width="5%" FooterStyle-Width="5%" ReadOnly="true" />
                                            <asp:BoundField DataField="sesion" HeaderText="Sesión" HeaderStyle-Width="5%" ItemStyle-Width="5%"
                                                FooterStyle-Width="5%" ReadOnly="true" HtmlEncode="false" />
