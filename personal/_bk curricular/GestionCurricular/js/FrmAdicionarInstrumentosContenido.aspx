<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmAdicionarInstrumentosContenido.aspx.vb"
    Inherits="GestionCurricular_FrmAdicionarInstrumentosContenido" EnableEventValidation="false" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvResultados" runat="server" AutoGenerateColumns="false" ShowHeader="true"
                            DataKeyNames="codigo_dis, codigo_uni, unidad, codigo_gru, total_ses" CssClass="table table-bordered">
                            <Columns>
                                <asp:BoundField DataField="numero_uni" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center"
                                    HeaderText="UNIDAD" ItemStyle-Width="3%" />
                                <asp:BoundField HtmlEncode="false" DataField="sesion" HeaderText="SESIÓN" ItemStyle-VerticalAlign="Middle"
                                    ItemStyle-HorizontalAlign="Center" ItemStyle-Width="3%" />
                                <asp:BoundField HtmlEncode="false" DataField="contenido" HeaderText="CONTENIDO" ItemStyle-Width="30%" />
                                ...
                                <asp:BoundField HtmlEncode="false" DataField="instrumento" HeaderText="INSTRUMENTOS"
                                    ItemStyle-Width="29%" />
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="ACCIÓN" ItemStyle-Width="5%">
                                    <ItemTemplate>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Instrumento">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblInstrumento" runat="server" Text='<%# Eval("descripcion_ins") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
