                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <asp:GridView ID="gvAsignatura" runat="server" AutoGenerateColumns="false" ShowHeader="true"
                                AllowPaging="True" PageSize="10" DataKeyNames="codigo_cup, codigo_cur, codigo_pes, nombre_Cur"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <asp:GridView ID="gvEstudiantes" runat="server" AutoGenerateColumns="false" ShowHeader="true"
                                        DataKeyNames="codigo_Dma, nombre_alu, codigo_nop, codigo_eva" CssClass="table table-bordered table-hover">
                                        <Columns>
