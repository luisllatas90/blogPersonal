...
#Region "eventos"
    ...
    Protected Sub btnAgregar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        Try
            If Me.ddlConsejo.SelectedValue <> "" Then
                If Me.ddlConsejo.SelectedValue = 8 And Me.ddlFacultad.SelectedValue = "" Then
    ...
    Protected Sub ddlConsejo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlConsejo.SelectedIndexChanged
        Try
            ...
            ElseIf ddlConsejo.SelectedValue = "7" Or ddlConsejo.SelectedValue = "9" Then ' consejo adminitrativo / consejo universitario
    ...
    Protected Sub lbActualizarMiembro_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbActualizarMiembro.Click
        Try
            ...
            With me_consejo
                ...
                ElseIf Me.ddlConsejo.SelectedValue = "7" Or Me.ddlConsejo.SelectedValue = "9" Then ' consejo administrativo / cons. universitario
                    .codigo_fac = 0
                End If
                .usuario = codigo_usu
            End With
            If mt_validarModalMiembro() Then
                ...
                If dt.Rows.Count > 0 Then
                    If dt.Rows(0).Item("Respuesta") = "1" Then
                        ...
                        If Me.ddlConsejo.SelectedValue = "8" Then '' consejo facultad
                            Call mt_listarPersonalConsejo("CFC")
                        ElseIf Me.ddlConsejo.SelectedValue = "7" Or Me.ddlConsejo.SelectedValue = "9" Then  '' consejo administrativo / consejo universitario
                            Call mt_listarPersonalConsejo("CAD")
                        End If
...
#Region "procedimientos y funciones"
        ...
        Try
            ...
            With me_consejo
                If Me.ddlConsejo.SelectedValue = "8" Then '' consejo de facultad - consejo nuevo
                    If Me.ddlFacultad.SelectedValue = "21" Then  '--- Ese grid se agrerga para la facultad postgrado , no aparecia el personal requerido 
                        .operacion = "T"
                        .codigo_fac = 0
                        .codigo_con = "7"
                    Else
                ...
                ElseIf Me.ddlConsejo.SelectedValue = "7" Then 'consejoa administrativo y ademas 6 rectorado
                    ...
                    .codigo_fac = 0
                    .codigo_con = Me.ddlConsejo.SelectedValue
                ElseIf Me.ddlConsejo.SelectedValue = "9" Then 'consejo universitario
                    .operacion = "T"
                    .codigo_fac = 0
                    .codigo_con = Me.ddlConsejo.SelectedValue
                End If
    ...
    Private Sub mt_CargaComboCargoConsejoFacultad()
        If Me.ddlConsejo.SelectedValue = "9" Then
            Me.ddlCargoCF.Items.Clear()
            Me.ddlCargoCF.Items.Add(New ListItem("MIEMBRO DEL CONSEJO UNIVERSITARIO", "U"))
        Else
            Me.ddlCargoCF.Items.Clear()
