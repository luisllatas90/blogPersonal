...
Public Class ClsFunciones
    ...
    Public Sub CargarListasGrupo(ByVal Combo As System.Object, ByVal Datos As System.Data.DataTable, _
 ByVal ColValor As String, ByVal ColDescripcion As String, ByVal ColGrupo As String)
        'Combo.Items.Clear()
        'Combo.DataSource = Datos
        'Combo.DataValueField = Datos.Columns(ColValor).ToString
        'Combo.DataTextField = Datos.Columns(ColDescripcion).ToString
        ...
        For Each row As Data.DataRow In Datos.Rows
            Dim item As ListItem = New ListItem()
            item.Text = row(ColDescripcion).ToString()
            item.Value = row(ColValor).ToString()
            item.Attributes("data-group") = row(ColGrupo).ToString()
