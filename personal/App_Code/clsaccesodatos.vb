...
Public Class clsaccesodatos
    ...
    Public Sub abrirconexion()
        ...
        cn.ConnectionString = configurationmanager.connectionstrings("cnxbdusat").connectionstring '"Data Source=.;Initial Catalog=BDUSAT;User ID=usuariogeneral;password=#t*a+?su)@"
    ...
    End Sub
    Public Sub abrirconexiontrans_distribuida()
        cn.ConnectionString = configurationmanager.connectionstrings("cnxbdusat").connectionstring
        '"Data Source=srvbd;Initial Catalog=BDUSAT;User ID=usuariogeneral;password=#t*a+?su)@"
        'cn.ConnectionString = "Data Source=SRVBD;Initial Catalog=BDUSAT;Integrated Security=True"
        'cn.ConnectionString = "Data Source=.;Initial Catalog=bdusat21122007;Integrated Security=true"
        'cn.ConnectionString = "Data Source=.;Initial Catalog=BDUSAT1;Integrated Security=true"
        cn.Open()
    ...
    Public Sub abrirconexiontrans()
        ...
        cn.ConnectionString = configurationmanager.connectionstrings("cnxbdusat").connectionstring
        '"Data Source=srvbd;Initial Catalog=BDUSAT;User ID=usuariogeneral;password=#t*a+?su)@"
        'cn.ConnectionString = "Data Source=desarrollo-ii;Initial Catalog=bdusat03122007;Integrated Security=true"
        'cn.ConnectionString = "Data Source=.;Initial Catalog=bdusat21122007;Integrated Security=true"
        'cn.ConnectionString = "Data Source=SRVBD;Initial Catalog=BDUSAT;Integrated Security=True"
        'cn.ConnectionString = "Data Source=.;Initial Catalog=BDUSAT1;Integrated Security=true"
        cn.Open()
    ...
    Public Function ejecutar(ByVal procedimiento As String, ByVal devuelve_valor As Boolean, ByRef rpta As Integer, ByRef mensaje As String, ByVal ParamArray x() As Object) As Object
        ...
        Next
        'ejecutar = 0
        ' hacemos que devuelva el ultimo parametro en la funci�n para darle soporte a los procedimientos antiguos
...
Public Function TraerDataTable(ByVal procedimiento As String, ByVal ParamArray x() As Object) As Data.DataTable
        ...
        Dim cmd_consulta As New SqlClient.SqlCommand
        Dim adap_consulta As New SqlClient.SqlDataAdapter
        Dim dts_consulta As New Data.DataTable
        ...
        Next
        adap_consulta.SelectCommand = cmd_consulta
        adap_consulta.Fill(dts_consulta)
