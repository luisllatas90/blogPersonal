...
Public Class Combos
    ...
    '--/ Inicio 02/08/2012 xDguevara
    Public Sub LlenaTipoVia(ByVal combo As DropDownList)
        Dim Cnx As SqlConnection
        Dim Cmd As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Integer = 0
        ...
        Try
            Cnx = New SqlConnection(_strConecctionString)
            Cnx.Open()
            Cmd = New SqlCommand("spPla_ConsultarTipoVia", Cnx)
            Cmd.CommandType = CommandType.StoredProcedure
            Cmd.Parameters.Add("@tipo", SqlDbType.Char, 2).Value = "TO"
            Cmd.Parameters.Add("@param", SqlDbType.VarChar, 25).Value = ""
            Reader = Cmd.ExecuteReader
            combo.Items.Clear()
            combo.Items.Add("--Seleccione Tipo Via--")
            combo.Items(0).Value = 0
    ...
    Public Sub LlenaTipoDocumento(ByVal combo As DropDownList)
        Dim Cnx As SqlConnection
        Dim Cmd As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Integer = 0
        ...
        Try
            Cnx = New SqlConnection(_strConecctionString)
            Cnx.Open()
            Cmd = New SqlCommand("spPla_ConsultarTipoDocumentoIdentidad", Cnx)
            Cmd.CommandType = CommandType.StoredProcedure
            Cmd.Parameters.Add("@tipo", SqlDbType.Char, 2).Value = "TO"
            Cmd.Parameters.Add("@param", SqlDbType.VarChar, 25).Value = ""
            Reader = Cmd.ExecuteReader
            combo.Items.Clear()
            combo.Items.Add("--Seleccione Tipo Documento--")
            combo.Items(0).Value = 0
    ...
    Public Sub LlenaPaisEmisor(ByVal combo As DropDownList)
        Dim Cnx As SqlConnection
        Dim Cmd As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Integer = 0
        ...
        Try
            Cnx = New SqlConnection(_strConecctionString)
            Cnx.Open()
            Cmd = New SqlCommand("spPla_ConsultarPaisEmisor", Cnx)
            Cmd.CommandType = CommandType.StoredProcedure
            Cmd.Parameters.Add("@tipo", SqlDbType.Char, 2).Value = "TO"
            Cmd.Parameters.Add("@param", SqlDbType.VarChar, 25).Value = ""
            Reader = Cmd.ExecuteReader
            combo.Items.Clear()
            combo.Items.Add("--Seleccione País Emisor--")
            combo.Items(0).Value = "0"
    ...
    Public Sub LlenaVinculoFamiliar(ByVal combo As DropDownList)
        Dim Cnx As SqlConnection
        Dim Cmd As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Integer = 0
        ...
        Try
            Cnx = New SqlConnection(_strConecctionString)
            Cnx.Open()
            Cmd = New SqlCommand("spPla_ConsultarVinculoFamiliar", Cnx)
            Cmd.CommandType = CommandType.StoredProcedure
            Cmd.Parameters.Add("@tipo", SqlDbType.Char, 2).Value = "TO"
            Cmd.Parameters.Add("@param", SqlDbType.VarChar, 25).Value = ""
            Reader = Cmd.ExecuteReader
            combo.Items.Clear()
            combo.Items.Add("--Seleccione Vínculo Familiar--")
            combo.Items(0).Value = 0
    ...
    Public Sub LlenaMotivoBahaDH(ByVal combo As DropDownList)
        Dim Cnx As SqlConnection
        Dim Cmd As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Integer = 0
        ...
        Try
            Cnx = New SqlConnection(_strConecctionString)
            Cnx.Open()
            Cmd = New SqlCommand("spPla_ConsultarTipodeBajaDH", Cnx)
            Cmd.CommandType = CommandType.StoredProcedure
            Cmd.Parameters.Add("@tipo", SqlDbType.Char, 2).Value = "TO"
            Cmd.Parameters.Add("@param", SqlDbType.VarChar, 25).Value = ""
            Reader = Cmd.ExecuteReader
    ...
    Public Sub LlenaCodigoLargaDistancia(ByVal combo As DropDownList)
        Dim Cnx As SqlConnection
        Dim Cmd As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Integer = 0
        ...
        Try
            Cnx = New SqlConnection(_strConecctionString)
            Cnx.Open()
            Cmd = New SqlCommand("spPla_ConsultarLargaDistanciaNacional", Cnx)
            Cmd.CommandType = CommandType.StoredProcedure
            Reader = Cmd.ExecuteReader
            combo.Items.Clear()
            combo.Items.Add("--Seleccione Código Teléfonico--")
            combo.Items(0).Value = 0

            While Reader.Read
                i = i + 1
                combo.Items.Add(Reader.Item(0).ToString + "-" + Reader.Item(1).ToString)
                combo.Items(i).Value = Reader.Item(0)
            End While
    ...
    Public Sub LlenaDocumentoSustentaVinculoFamiliar(ByVal combo As DropDownList)
        Dim Cnx As SqlConnection
        Dim Cmd As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Integer = 0
        ...
        Try
            Cnx = New SqlConnection(_strConecctionString)
            Cnx.Open()
            Cmd = New SqlCommand("spPla_ConsultarDocumentoVinculoFamiliar", Cnx)
            Cmd.CommandType = CommandType.StoredProcedure
            Reader = Cmd.ExecuteReader
            combo.Items.Clear()
            combo.Items.Add("--Seleccione Tipo Documento Sustenta Vinculo Familiar--")
            combo.Items(0).Value = 0
    ...
    Public Sub LLenaTipoZona(ByVal combo As DropDownList)
        Dim Cnx As SqlConnection
        Dim Cmd As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Integer = 0
        ...
        Try
            Cnx = New SqlConnection(_strConecctionString)
            Cnx.Open()
            Cmd = New SqlCommand("spPla_ConsultarTipoZona", Cnx)
            Cmd.CommandType = CommandType.StoredProcedure
            Cmd.Parameters.Add("@tipo", SqlDbType.Char, 2).Value = "TO"
            Cmd.Parameters.Add("@param", SqlDbType.VarChar, 25).Value = ""
            ...
            Reader = Cmd.ExecuteReader
            combo.Items.Clear()
            combo.Items.Add("--Seleccione Tipo Zona--")
            combo.Items(0).Value = 0
    ...
    Public Sub LLenaNivelEducativo(ByVal combo As DropDownList)
        Dim Cnx As SqlConnection
        Dim Cmd As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Integer = 0
        ...
        Try
            Cnx = New SqlConnection(_strConecctionString)
            Cnx.Open()
            Cmd = New SqlCommand("spPla_ConsultarNivelEducativo", Cnx)
            Cmd.CommandType = CommandType.StoredProcedure
            Cmd.Parameters.Add("@tipo", SqlDbType.Char, 2).Value = "TO"
            Cmd.Parameters.Add("@param", SqlDbType.VarChar, 25).Value = ""
            ...
            Reader = Cmd.ExecuteReader
            combo.Items.Clear()
            combo.Items.Add("--Seleccione Nivel Educativo--")
            combo.Items(0).Value = 0
    ...
    Public Sub LlenaEntidadFinanciera(ByVal combo As DropDownList)
        Dim Cnx As SqlConnection
        Dim Cmd As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Integer = 0
        ...
        Try
            Cnx = New SqlConnection(_strConecctionString)
            Cnx.Open()
            Cmd = New SqlCommand("spPla_ConsultarEntidadFinanciera", Cnx)
            Cmd.CommandType = CommandType.StoredProcedure
            Cmd.Parameters.Add("@tipo", SqlDbType.Char, 2).Value = "TO"
            Cmd.Parameters.Add("@param", SqlDbType.VarChar, 25).Value = ""
            ...
            Reader = Cmd.ExecuteReader
            combo.Items.Clear()
            combo.Items.Add("--Seleccione Entidad Financiera--")
            combo.Items(0).Value = 0
    ...
    Public Sub LlenaRegimenSalud(ByVal combo As DropDownList)
        Dim Cnx As SqlConnection
        Dim Cmd As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Integer = 0
        ...
        Try
            Cnx = New SqlConnection(_strConecctionString)
            Cnx.Open()
            Cmd = New SqlCommand("spPla_ConsultarRegimenSalud", Cnx)
            Cmd.CommandType = CommandType.StoredProcedure

            Reader = Cmd.ExecuteReader
            combo.Items.Clear()
            combo.Items.Add("--Seleccione Reg.Essalud--")
    ...
    Public Sub LlenaRegimenPensionario(ByVal combo As DropDownList)
        Dim Cnx As SqlConnection
        Dim Cmd As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Integer = 0
        ...
        Try
            Cnx = New SqlConnection(_strConecctionString)
            Cnx.Open()
            Cmd = New SqlCommand("spPla_ConsultarRegimenPension", Cnx)
            Cmd.CommandType = CommandType.StoredProcedure
            Cmd.Parameters.Add("@tipo", SqlDbType.Char, 2).Value = "PR"
            Cmd.Parameters.Add("@param", SqlDbType.VarChar, 25).Value = ""

            Reader = Cmd.ExecuteReader
            combo.Items.Clear()
            combo.Items.Add("--Seleccione Reg.Pensionario--")
            combo.Items(0).Value = 0
    ...
    Public Sub LlenaEPS(ByVal combo As DropDownList)
        Dim Cnx As SqlConnection
        Dim Cmd As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Integer = 0
        ...
        Try
            Cnx = New SqlConnection(_strConecctionString)
            Cnx.Open()
            Cmd = New SqlCommand("spPla_ConsultarEPS", Cnx)
            Cmd.CommandType = CommandType.StoredProcedure
            ...
            While Reader.Read
                i = i + 1
                combo.Items.Add(Reader.Item(2).ToString)
                combo.Items(i).Value = Reader.Item(0)
            End While
        Catch ex As Exception
        End Try
    ...
    Public Sub LlenaSituacionEPS(ByVal combo As DropDownList)
        Dim Cnx As SqlConnection
        Dim Cmd As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Integer = 0
        ...
        Try
            Cnx = New SqlConnection(_strConecctionString)
            Cnx.Open()
            Cmd = New SqlCommand("spPla_ConsultarSituacionEPS", Cnx)
            Cmd.CommandType = CommandType.StoredProcedure
    ...
    Public Sub LlenaAfp(ByVal combo As DropDownList)
        Dim Cnx As SqlConnection
        Dim Cmd As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Integer = 0
        ...
        Try
            Cnx = New SqlConnection(_strConecctionString)
            Cnx.Open()
            'Cmd = New SqlCommand("spPla_ConsultarAfp", Cnx)
            Cmd = New SqlCommand("spPla_ConsultarAfp_v2", Cnx)
            Cmd.CommandType = CommandType.StoredProcedure
    ...
    'Add 03.10.2013 solicitado por esaavedra, implementado xDguevara
    Public Sub llenaModalidad(ByVal Combo As DropDownList)
        Dim cnx As SqlConnection = Nothing
        Dim Comand As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Int16
        ...
        Try
            ...
            Comand = New SqlCommand("HV_ConsultarModalidades", cnx)
            Comand.CommandType = CommandType.StoredProcedure
            Comand.Parameters.Add("@tipo", SqlDbType.Char, 2).Value = "TO"
            Reader = Comand.ExecuteReader

            Combo.Items.Clear()
            Combo.Items.Add("-- Seleccione la Modalidad --")
            Combo.Items(0).Value = 0
            While Reader.Read
                Combo.Items.Add(Reader.Item(1))
                Combo.Items(i).Value = Reader.Item(0)
    ...
    Public Sub LlenaCargosUnv(ByVal Combo As DropDownList)
        Dim cnx As SqlConnection
        Dim Comand As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Int16
        ...
        Try
            ...
            Comand.CommandType = CommandType.StoredProcedure
            Comand.Parameters.Add("@tipo", SqlDbType.Char, 2).Value = "EA"
            Comand.Parameters.Add("@param1", SqlDbType.VarChar, 25).Value = ""
            Reader = Comand.ExecuteReader
    ...
    Public Sub LlenaDepartamentoAcademico(ByVal combo As DropDownList)
        ...
        Try
            ...
            Comand.CommandType = CommandType.StoredProcedure
            Comand.Parameters.Add("@tipo", SqlDbType.Char, 2).Value = "SG" 'Se cambió el tipo: TO por SG
            Comand.Parameters.Add("@param1", SqlDbType.VarChar, 25).Value = ""
            Reader = Comand.ExecuteReader
            combo.Items.Clear()
            While Reader.Read
    ...
    Public Sub LlenaEventos(ByVal Lista As ListBox, _
    ...
    'Agregado xDguevara 10.06.2013
    Public Sub LlenaTipoPersonal(ByVal combo As DropDownList)
        Dim cnx As SqlConnection
        Dim Comand As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Int16
        ...
        Try
            ...
            Comand = New SqlCommand("ListaTipoPersonal", cnx)
            Comand.CommandType = CommandType.StoredProcedure
    ...
    Public Sub LlenaEstadoPlla(ByVal combo As DropDownList)
        Dim cnx As SqlConnection
        Dim Comand As SqlCommand
        Dim Reader As SqlDataReader
        Dim i As Int16
        ...
        Try
            ...
            Comand = New SqlCommand("EstadoPlanilla", cnx)
            Comand.CommandType = CommandType.StoredProcedure
            'Comand.Parameters.Add("@tipo", SqlDbType.Char, 2).Value = "TD"
            'Comand.Parameters.Add("@param1", SqlDbType.VarChar, 25).Value = ""
            Reader = Comand.ExecuteReader
    ...
    Public Sub LlenaCentroCostos(ByVal combo As DropDownList, ByVal codigo_per As String, ByVal tipo As String)
        ...
        Try
            ...
            Select Case tipo
                ...
                Case "HV"
                    'Entra aqui cuando filtra la Hoja de Vida.
            ...
            '--->> Este bloque estaba antes, lo comente para atender una solicitid de Timana
            '>> xDguevara 10.06.2013
            'If tipo = "CP" Then
            '    combo.Items.Add("-- Seleccione Area --")
            '    combo.Items(0).Value = 0
            '    While Reader.Read
