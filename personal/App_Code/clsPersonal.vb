   ...
   Public Sub AbrirTransaccionCnx()
    ...
    Public Function HabilitarModificarHorarioPersonal(ByVal codigo_per As Integer, _
        ...
        If Trim(LCase(correo)) <> "@usat.edu.pe" Then
            mensaje = "<br><br>Su registro de horario ha sido activado.<br><br> Ante una consulta sírvase comunicar con el Sr. Rolando Timana en Dirección de Personal. e-mail: rtimana@usat.edu.pe, Anexo: 1030.<br><br>Atte.<br><br>Campus Virtual - USAT."
    ...
    Public Sub EnviarEmailComunicado(ByVal codigo_per As Integer, _
        ...
        'enviar el correo
        If Trim(LCase(correo)) <> "@usat.edu.pe" Then
            If idusuario = 1437 Then  'VERIFICA QUE EL USUARIO SEA: [TIMANA VASQUEZ ROLANDO GILBERTO]
                mensaje = "Estimado(a): " & nombre & "<br><br>Se le comunica que: <B>" & obs & "</B>.<br><br> Ante una consulta sírvase comunicar con el Sr. Rolando Timaná en Dirección de Personal. e-mail: rtimana@usat.edu.pe, Anexo: 1030.<br><br>Atte.<br><br>Campus Virtual - USAT."
            Else
                ...
                'Enviar correo a Timana Informando que el jefe de area a modificado el horario.
                mensaje2 = "Estimado Sr. Timaná: <br><br>El Director (a) " & usuariorevisa & " ha enviado un aviso sobre el horario del trabajador " & nombre & ".<br><br>Atte.<br><br>Campus Virtual - USAT."
                objMail.EnviarMail("campusvirtual@usat.edu.pe", "Dirección de Personal", "rtimana@usat.edu.pe", "Modificacion de Horario: " & nombre, mensaje2, True)
            End If
    ...
    Public Sub EnviarEmailTesis(ByVal codigo_per As Integer, _
        ...
        If Trim(LCase(correo)) <> "@usat.edu.pe" Then
            If idusuario = 1437 Then  'VERIFICA QUE EL USUARIO SEA: [TIMANA VASQUEZ ROLANDO GILBERTO]
                mensaje = "Estimado(a): " & nombre & "<br><br>Su registro de horario ha sido observado: <B>" & obs & "</B>.<br><br> Ante una consulta sírvase comunicar con el Sr. Rolando Timaná en Dirección de Personal. e-mail: rtimana@usat.edu.pe, Anexo: 1030.<br><br>Atte.<br><br>Campus Virtual - USAT."
            Else
                'Enviar correo a trabajador
                ...
                'Enviar correo a Timana Informando que el jefe de area a modificado el horario.
                mensaje2 = "Estimado Sr. Timaná: <br><br>El Director (a) " & usuariorevisa & " ha modificado el horario del trabajador " & nombre & ".<br><br>Atte.<br><br>Campus Virtual - USAT."
                objMail.EnviarMail("campusvirtual@usat.edu.pe", "Dirección de Personal", "rtimana@usat.edu.pe", "Modificacion de Horario: " & nombre, mensaje2, True)
            End If
    ...
    Public Function ConsultarPersonalDirectorDepartamento_v2(ByVal codigo_per As Integer, ByVal estado_hop As String) As Data.DataTable
        ...
        cnx.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
        cnx.AbrirConexion()
        dts = cnx.TraerDataTable("PER_ConsultarPersonalDirectorDepartamento_v2", codigo_per, estado_hop)
        cnx.CerrarConexion()
        Return dts
    End Function
    ...
    Public Sub EnviarAlertaHorarios(ByVal codigo_per As Integer, ByVal nombre As String, ByVal idusuario As Integer)
        ...
        'enviar el correo
        If Trim(LCase(correo)) <> "@usat.edu.pe" Then
            para = "</br><font face='Courier'>" & "Estimado : <b>" & "TIMANA	VASQUEZ	ROLANDO GILBERTO" & "</b>"
            ...
            ObjMailNet.EnviarMail("campusvirtual@usat.edu.pe", "Investigaciones", "rtimana@usat.edu.pe", "Notificación Registro Horarios - Horas no coinciden con la distribución", para & mensaje, True)
    ...
    Public Sub AprobarHorario(ByVal codigo_per As Integer, ByVal nombre As String, ByVal idusuario As Integer)
        ...
        '############### Modelo de Envio de Correo Anteriot
        'If Trim(LCase(correo)) <> "@usat.edu.pe" Then
        '    If idusuario = 1437 Then  'VERIFICA QUE EL USUARIO SEA: [TIMANA VASQUEZ ROLANDO GILBERTO]
        '        mensaje = "Estimado(a): " & nombre & "<br><br>Su registro de horario ha sido aprobado. <B>" & "</B><br><br> Ante una consulta sírvase comunicar con el Sr. Rolando Timana en Dirección de Personal. e-mail: rtimana@usat.edu.pe, Anexo: 1030.<br><br>Atte.<br><br>Campus Virtual - USAT."
        '    Else
        '        'Enviar correo a trabajador
        '        mensaje = "Estimado(a): " & nombre & "<br><br>Su registro de horario ha sido aprobado. <B>" & "</B><br><br> Ante una consulta sírvase comunicar con el Sr(a). " & usuariorevisa & ". e-mail: " & correorevisa & ".<br><br>Atte.<br><br>Campus Virtual - USAT."                
        '        'Enviar correo a Timana Informando que el jefe de area a modificado el horario.
        ...
        If Trim(LCase(correo)) <> "@usat.edu.pe" Then
            If idusuario = 1437 Then  'VERIFICA QUE EL USUARIO SEA: [TIMANA VASQUEZ ROLANDO GILBERTO]
                mensaje = "Estimado(a): " & nombre & "<br><br>Su registro de horario ha sido generado. <B>" & "</B><br><br> Ante una consulta sírvase comunicar con el Sr. Rolando Timana en Dirección de Personal. e-mail: rtimana@usat.edu.pe, Anexo: 1030.<br><br>Atte.<br><br>Campus Virtual - USAT."
            Else
                'Enviar correo a trabajador
