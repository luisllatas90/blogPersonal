...
Public Class ClsCongreso
    Public Function SoapEnvelope(ByVal Data As Dictionary(Of String, String)) As String
        ...
        With envelope
            ...
            .AppendLine("<codigo_cco>" & CType(Data("codigo_cco").ToString(), Integer) & "</codigo_cco>")
    ...
    End Function
    '''</Agregado Osmar Lluen>
    '''</26/11/2019 >
    '''</Para la inscripción ALUMNI>
    ...
    End Function
    '/** 27/11/2016 
    '/*** Osmar Lluen agregado para traer datos del alumno
    Public Function SoapEnvelopeTokenDatosAlumno(ByVal Data As Dictionary(Of String, String)) As String
        Dim envelope As New StringBuilder
        With envelope
            .AppendLine("<?xml version=""1.0"" encoding=""utf-8""?>")
            .AppendLine("<soap:Envelope xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:soap='http://schemas.xmlsoap.org/soap/envelope/'>")
            .AppendLine("<soap:Body>")
            .AppendLine("<VerDatosParticipante xmlns=""http://tempuri.org/"">")
            .AppendLine("<token_cco>" & Data("token_cco").ToString & "</token_cco>")
            .AppendLine("</VerDatosParticipante>")
            .AppendLine("</soap:Body>")
            .AppendLine("</soap:Envelope>")
        End With
        Return envelope.ToString()
