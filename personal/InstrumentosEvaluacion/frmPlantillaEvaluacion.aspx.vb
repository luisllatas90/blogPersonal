...
Partial Class InstrumentosEvaluacion_frmPlantillaEvaluacion
...
#Region "Metodos"
    ...
    Private Sub mt_CargarDatos()
        Try
            ...
            dt.Columns.Add("codigo_ple")
            dt.Columns.Add("titulo_ple")
            dt.Columns.Add("tipo_ple")
            dt.Columns.Add("estado_ple")

            fila = dt.NewRow()
            fila("codigo_ple") = "1"
            fila("titulo_ple") = "VISIÓN DEL ESTUDIANTE"
            fila("tipo_ple") = "EVALUACIÓN DOCENTE - ESTUDIANTES"
            fila("estado_ple") = "ACTIVO"

            dt.Rows.Add(fila)

            fila = dt.NewRow()
            fila("codigo_ple") = "2"
            fila("titulo_ple") = "VISIÓN DEL DEPARTAMENTO"
            fila("tipo_ple") = "EVALUACIÓN DOCENTE - OBSERVADOR"
            fila("estado_ple") = "ACTIVO"
