...
Partial Class InstrumentosEvaluacion_frmEscalasEvaluacion
...
#Region "Metodos"
    ...
    Private Sub mt_CargarDatos()
        Try
            ...
            fila = dt.NewRow()
            fila("codigo_esc") = "1"
            fila("nombre_esc") = "ESCALA DE LIKERT (1 - 5)"
            fila("descripcion_esc") = "Las respuestas pueden ser ofrecidas en los niveles de medición del 1 al 5."
            dt.Rows.Add(fila)
