<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmGestionEvaluacion.aspx.vb" Inherits="InstrumentosEvaluacion_frmGestionEvaluacion" %>
...
<body>
    ...
    <form id="frmGestionEvaluacion" runat="server">
        ...
        <div class="container-fluid">
            <div class="card div-title">                        
                <div class="row title">GESTIÓN DE EVALUACIONES</div>
            </div>
                ...
                <div class="tab-pane show active" id="listado" role="tabpanel" aria-labelledby="listado-tab">
                    ...
                    <div class="table-responsive">
                        <asp:UpdatePanel ID="udpLista" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                            <ContentTemplate>
                                <asp:GridView ID="grwLista" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="codigo_cev"
                                    CssClass="display table table-sm" GridLines="None">
                                    <Columns>
                                        <asp:BoundField DataField="codigo_cev" HeaderText="CÓDIGO" ItemStyle-Width="10%" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="descripcion_cev" HeaderText="TÍTULO" ItemStyle-Width="30%" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="tipo_cev" HeaderText="TIPO" ItemStyle-Width="20%" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="ciclo_cev" HeaderText="PERÍODO" ItemStyle-Width="10%" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="fecha_ini" HeaderText="F.INICIO" ItemStyle-Width="10%" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="fecha_fin" HeaderText="F.FIN" ItemStyle-Width="10%" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="estado_cev" HeaderText="ESTADO" ItemStyle-Width="10%" ItemStyle-Wrap="false" />
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-2" style="text-align: right; padding-right: 0px;">                                                
                                                <asp:CheckBox ID="chkPlantilla" AutoPostBack="True" runat="server"/>
                                                <label for="chkPlantilla" class="form-control-sm">Usar Plantilla</label>
                                            </div> 
                                            <label for="cmbPlantilla" class="col-sm-1 col-form-label form-control-sm">Plantilla:</label>
                                            <div class="col-sm-5">
                                                <asp:DropDownList ID="cmbPlantilla" runat="server" AutoPostBack="true" CssClass="form-control form-control-sm combo_filtro" data-live-search="true" AutoComplete="off">
                                                    <asp:ListItem Value="">[-- SELECCIONE --]</asp:ListItem>
                                                    <asp:ListItem Value="1">VISIÓN DEL DEPARTAMENTO</asp:ListItem>
                                                    <asp:ListItem Value="2">VISIÓN DEL ESTUDIANTE</asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <label for="cmbPeriodo" class="col-sm-1 form-control-sm">Período:</label>
                                            <div class="col-sm-2">
                                                <asp:DropDownList ID="cmbPeriodo" runat="server" AutoPostBack="true" CssClass="form-control form-control-sm combo_filtro" data-live-search="true" AutoComplete="off">
                                                    <asp:ListItem Value="">[-- SELECCIONE --]</asp:ListItem>
                                                    <asp:ListItem Value="1">2021-I</asp:ListItem>
                                                    <asp:ListItem Value="2">2021-0</asp:ListItem>
                                                    <asp:ListItem Value="3">2020-II</asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="card-footer" style="text-align: center;">
                                        <asp:LinkButton ID="btnGuardar" runat="server" CssClass="btn btn-accion btn-verde"
                                            OnClientClick="return alertConfirm(this, event, '¿Desea registrar la evaluación?', 'warning');">
