<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEscalasEvaluacion.aspx.vb" Inherits="InstrumentosEvaluacion_frmEscalasEvaluacion" %>
...
<head>
    ...
    <title>Escalas de Evaluación</title>
...
<body>
    ...
    <form id="frmEscalasEvaluacion" runat="server">
        ...
        <div class="container-fluid">
            <div class="card div-title">                        
                <div class="row title">ESCALAS DE EVALUACIÓN</div>
            </div>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="grwListaEscalas" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="codigo_esd"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="valor_esd" HeaderText="VALOR" ItemStyle-Width="10%" ItemStyle-Wrap="false" />                                                        
                            ...
                            <ContentTemplate>
                                <div class="card">                                    
                                    <div class="card-body">    
                                        ...
                                        <div class="row">
                                            <label for="txtOrden" class="col-sm-3 form-control-sm">Orden:</label>
                                            <div class="col-sm-2">                                                                                
                                                <asp:TextBox ID="txtOrden" runat="server" CssClass="form-control form-control-sm uppercase" AutoComplete="off"/>
                                            </div> 
                                            <label for="txtValor" class="col-sm-1 form-control-sm">Valor:</label>
                                            <div class="col-sm-2">                                                                                
                                                <asp:TextBox ID="txtValor" runat="server" CssClass="form-control form-control-sm uppercase" AutoComplete="off"/>
                                            </div> 
                                        </div>
                                        <hr/>
                                        <div class="row">
