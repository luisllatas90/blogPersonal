<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmTipoSesion.aspx.vb" Inherits="tutoria_frmTipoSesion" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/JsTipoSesion.js?x=2"></script>
                            ...
                            <div id="PanelBusqueda">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="page_header">
                                        <div class="pull-left">
                                            <i class="ion-android-clipboard page_header_icon"></i><span class="main-text">Tipo de Sesión</span>
                                        </div>
                                        ...
                                        <form class="form form-horizontal" id="frmBuscarTipoSesion" name="frmBuscarTipoSesion"
                    ...
                    <div class="panel panel-piluku" id="PanelLista">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                Listado de Tipos de Sesión<span class="panel-options"><a class="panel-refresh"
                                    href="#"><i class="icon ti-reload" onclick="fnBuscarTipoSesion(false)"></i>
                                </a><a class="panel-minimize" href="#"><i class="icon ti-angle-up"></i></a></span>
                            </h3>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <div id="tTipoSesion_wrapper" class="dataTables_wrapper" role="grid">
                                    <table id="tTipoSesion" name="tTipoSesion" class="display dataTable"
                                        width="100%">
                                        <thead>
                                            <tr role="row">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header" style="background-color: #E33439; color: White; font-weight: bold;">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel3">
                                            Mantenimiento de Tipo de Sesion</h4>
                                    </div>
