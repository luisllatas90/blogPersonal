<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmVariable.aspx.vb"
    Inherits="tutoria_frmVariable" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/JsVariable.js?s=2"></script>
                            ...
                            <div id="PanelBusqueda">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="page_header">
                                        ...
                                        <form class="form form-horizontal" id="frmBuscarVariable" name="frmBuscarVariable"
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                Listado de Tipos de Evaluación<span class="panel-options"><a class="panel-refresh"
                                    href="#"><i class="icon ti-reload" onclick="fnBuscarVariable(false)"></i>
