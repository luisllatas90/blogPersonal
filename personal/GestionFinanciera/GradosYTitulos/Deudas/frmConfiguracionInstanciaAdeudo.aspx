<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmConfiguracionInstanciaAdeudo.aspx.vb" Inherits="GraduacionTitulacion_Deudas_frmConfiguracionInstanciaAdeudo" %>
...
<head>
    ...
    <title>Configuración de Instancias de Control de Adeudos</title>
...
<body>
    ...
    <form id="frmConfiguracionInstanciaAdeudo" runat="server">
        ...
        <div class="container-fluid">
            <div class="card div-title">                        
                <div class="row title">CONFIGURACIÓN DE INSTANCIAS DE CONTROL DE ADEUDOS</div>
            </div>
                ...
                <div class="tab-pane show active" id="listado" role="tabpanel" aria-labelledby="listado-tab">
                            ...
                            <ContentTemplate>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <label for="cmbCargoFiltro" class="col-sm-2 col-form-label form-control-sm">Cargo:</label>
                                            <div class="col-sm-4">
                                                <asp:DropDownList ID="cmbCargoFiltro" runat="server" AutoPostBack="true" CssClass="form-control form-control-sm combo_filtro" data-live-search="true" AutoComplete="off"></asp:DropDownList>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <asp:LinkButton ID="btnNuevo" runat="server" CssClass="btn btn-accion btn-azul"                                                    
                                                    OnClientClick="return alertConfirm(this, event, '¿Desea registrar una nueva configuración?', 'warning');">
                    ...
                    <div class="table-responsive">
                        <asp:UpdatePanel ID="udpLista" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                            <ContentTemplate>
                                <asp:GridView ID="grwLista" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="codigo_cia"
                                    CssClass="display table table-sm" GridLines="None">
                                    <Columns>
                                        <asp:BoundField DataField="descripcionArea_cco" HeaderText="ÁREA" ItemStyle-Width="20%" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="descripcion_tfu" HeaderText="CARGO" ItemStyle-Width="25%" ItemStyle-Wrap="false" />                                        
                                        <asp:BoundField DataField="estado_configuracion" HeaderText="ESTADO" ItemStyle-Width="10%" ItemStyle-Wrap="false" />                                                                               
                ...
                <div class="tab-pane" id="registro" role="tabpanel" aria-labelledby="registro-tab">
                    <div class="panel-cabecera">
                        <asp:UpdatePanel ID="udpRegistro" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                            <ContentTemplate>
                                <div class="card">
                                    <div class="card-header">Datos de la Instancia</div>
                                    <div class="card-body">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <label for="cmbCargo" class="col-sm-2 col-form-label form-control-sm">Cargo:</label>
                                            <div class="col-sm-4">
                                                <asp:DropDownList ID="cmbCargo" runat="server" AutoPostBack="true" CssClass="form-control form-control-sm combo_filtro" data-live-search="true" AutoComplete="off"></asp:DropDownList>
                                            </div> 
                                            <label for="cmbEstado" class="col-sm-1 col-form-label form-control-sm">Estado:</label>
                                            <div class="col-sm-2">
                                                <asp:DropDownList ID="cmbEstado" runat="server" AutoPostBack="true" CssClass="form-control form-control-sm combo_filtro" data-live-search="true" AutoComplete="off"></asp:DropDownList>
                                            </div>                                            
                                        </div>                                                                                                                                                                             
                                    </div>    
                                </div>     
                                <br/>     
                                <div class="card">
                                    <div class="card-header">Datos de la Deuda</div>
                                    <div class="card-body">
                                        <div class="row">
                                            <label for="cmbConcepto" class="col-sm-2 col-form-label form-control-sm">Concepto:</label>
                                            <div class="col-sm-7">
                                                <asp:DropDownList ID="cmbConcepto" runat="server" AutoPostBack="true" CssClass="form-control form-control-sm combo_filtro" data-live-search="true" AutoComplete="off"></asp:DropDownList>
                                            </div>  
                                        </div>     
                                        <div class="row">
                                            <label for="cmbCentroCosto" class="col-sm-2 col-form-label form-control-sm">Centro Costo:</label>
                                            <div class="col-sm-7">
                                                <asp:DropDownList ID="cmbCentroCosto" runat="server" AutoPostBack="true" CssClass="form-control form-control-sm combo_filtro" data-live-search="true" AutoComplete="off"></asp:DropDownList>
                                            </div>  
                                        </div>                                                                             
                                    </div>
                                    <div class="card-footer" style="text-align: center;">
                                        <asp:LinkButton ID="btnGuardar" runat="server" CssClass="btn btn-accion btn-verde"
                                            OnClientClick="return alertConfirm(this, event, '¿Desea registrar la configuración?', 'warning');">
