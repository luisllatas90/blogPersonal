<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmTestHorario.aspx.vb" Inherits="frmTestHorario" %>
                ...
                <td>
                    <table style="width: 100%;">
                        <tr>
                                            ...
                                            <table style="border: 1px solid #000000; width:100%; background-color: #FFFFCC;" >
                                                ...
                                                <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:Label ID="lblEnviado" runat="server" ForeColor="Blue" 
                                                            Text="Enviado correctamente" Visible="False"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="background-color:Yellow" colspan="3" align="justify">
                                                        <asp:Label  ID="lblAlertaContrato" 
                                                                    Visible="False" 
                                                                    runat="server" 
                                                                    
                                                            Text="Posiblemente no ha suscrito su contrato de trabajo, para el presente ciclo. Favor de acercarse a Dirección de Personal. (Si ya suscribió el mismo, no considere este mensaje, ya que dentro de las siguiente 24 horas debe estar disponible su campus virtual, para el registro del mismo." 
                            ...
                            <td class="style7" rowspan="3" valign="top" align="right">                                                        
                                            ...
                                            <table style="width:250px;">
                                                ...
                                                <tr>
                                                    <td align="left" style="font-size: small" valign="top">
                                                        ...
                                                        <asp:Label ID="lblsx" runat="server" ForeColor="Fuchsia" Text="Label" 
                                                    ...
                                                    <td style="border: 1px solid #000000; font-size: x-small" valign="top">
                                                        <table align="center" bgcolor="White" style="width: 200px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="style4" align = "center" valign="middle">
                                                                <asp:Label ID="lblPE" runat="server" Text="Label" Height="35px" Width="100px" 
                                                                        ></asp:Label>                                                                
                                                                </td>
                                                            </tr>
                                                            <tr>
                        ...
                        <tr>
                            <td style="font-weight: bold" class="style45">
                            ...
                            <td>
                                                        ...
                                                        <table style="width: 100%; font-weight: normal;">                                                            
                                                            <tr>
                                                                <td class="style20" style="font-weight: bold; background-color: #DDEEFF;">
                                                                    ...
                                                                    <asp:Label ID="Label28" runat="server" Font-Bold="False" ForeColor="Red" 
                                                                        Text="[Haga Clic sobre el botón asignar horario si desea registrar un horario administrativo. De lo contrario, continúe con el Paso Nº 2.]" 
                                    ...
                                    <tr>
                                        <td style="font-weight: bold; background-color:  #DDEEFF;">
                                            ...
                                            <asp:Label ID="Label16" runat="server" Font-Bold="False" ForeColor="Red" 
                                                ...
                                                Text="[Si le corresponde refrigerio, elija un refrigerio predefinido o registre uno personalizado. Sino, continúe con el Paso Nº 3.]"></asp:Label>
                                            <br />
                                    ...
                                    <td colspan="2" style="font-weight: bold; background-color: #DDEEFF;">
                                        <asp:Label ID="Label5" runat="server" Text="Paso Nº 3. Importar Hrs. Lectivas" 
                                            ...
                                            <br />
                                                <asp:Label ID="Label10" runat="server" Font-Bold="False" ForeColor="Red" 
