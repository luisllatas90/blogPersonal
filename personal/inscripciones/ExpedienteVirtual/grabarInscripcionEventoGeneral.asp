...
codigo_cco= 2023 'rs("codigo_cco") '1558 Entendiendo las adicciones

fechaInicio = "01/06/2010" 'empezar a cobrar desde esta fecha
codigo_alu=null
codigo_ocl=null
...
set rs = obj.consultar("consultarExistenciaDeuda", "FO", "P",codigo_per, codigo_sco,36)
obj.CerrarConexion
