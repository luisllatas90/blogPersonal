...
function validarCantidad (){
	...
	else
	{
		...
		if (document.frminscripcion.codigo_sco.value == "605")
		{
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td width="60%" class="usattitulo"><b>Entendiendo las adicciones</b></td>
  </tr>
</table>
        ...
        <table cellpadding="3" cellspacing="0" style="border-collapse: collapse; " bordercolor="#111111" width="100%" class="contornotabla">
          ...
          <tr>
            ...
            <td width="69%" class="usatTitulousat"><select name="codigo_sco" id="codigo_sco" onChange="validarCantidad()">
                ...
                <option value="605"> INSCRIPCION   (S/. 50.00)</option>
...
set rs = obj.consultar("consultarDeudaEvento", "FO", "ADI", "P",codigo_per, codigo_cac)
obj.CerrarConexion
set obj = nothing
...
<tr>
<td class="usatAmarillo" width="100%" colspan 5>Publicidad:</td>
</tr>
<tr><td><a href=afiche.jpg target="_blank">Clic para ver afiche </a></td></tr>
