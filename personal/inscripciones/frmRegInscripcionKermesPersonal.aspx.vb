...
Partial Class Inscripcion_frmRegInscripcionPersonal
	...
	'response.write (session("codigo_Usu"))
		...
		Dim Obj As New ClsConectarDatos
            ...
            Try
                ...
                Me.Hdcodigo_per.Value = session("codigo_Usu") 'request.QueryString("cco").Substring(12, Request.QueryString("cco").Length - 12)
                Obj.AbrirConexion()
                ...
                If Tbl.Rows.Count > 0 Then
                    ...
                    ruta = "//intranet.usat.edu.pe/campusvirtual/personal/imgpersonal/" & Me.Hdcodigo_per.Value & ".jpg"
    ...
    Public Sub cargarData()
        ...
        dt2 = consultarCompra(Me.Hdcodigo_per.Value, 1570, Me.Hdcodigo_cac.Value, Me.Hdcodigo_cco.Value)
        ...
        dt3 = consultarCompra(Me.Hdcodigo_per.Value, 1571, Me.Hdcodigo_cac.Value, Me.Hdcodigo_cco.Value)
        ...
        Me.lblSubtotal4.Text = FormatNumber(CInt(Me.lblSubtotal1.Text) + CInt(Me.lblSubtotal2.Text) + CInt(Me.lblSubtotal3.Text), 2)
        dt3.Dispose()
    End Sub
