        ...
        Try
            ...
            If tbl.Rows.Count > 0 Then
                ...
                If Request.QueryString("accion") <> "M" Then
                    ...
                    Response.Write("EVE_ConsultarDeudasPersona " & tbl.Rows(0).Item("codigo_pso") & ", " & Me.hdcodigo_cco.Value)
                    ...
                    If (dtDeudas.Rows.Count = 0) Then                        
                        dtDeudas = obj.TraerDataTable("EVE_ConsultarDeudasPersona", tbl.Rows(0).Item("codigo_pso"), Me.hdcodigo_cco.Value)
