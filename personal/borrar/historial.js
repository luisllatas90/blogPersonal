        ...
        success: function(data) {
            ...
            if (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    if (!data[i].formcomp) { //20200818-ENevado
                        if (data[i].swprom) {
                            ...
                            if (data[i].inhabilitado) {
                                /*tb += '<td>' + data[i].curso + ' <font style="color: red;"> Inhabilitado</font></td>';*/
                                tb += '<td>' + data[i].curso + '</td>';
                                data[i].nota = '-';
                                data[i].condicion = 'INHABILITADO';
                            } else {
                                tb += '<td>' + data[i].curso + '</td>';
                            }
                ...
                for (var i = 0; i < data.length; i++) {
                    if (data[i].formcomp) {
                        if (data[i].swprom) {
                            if (data[i].formcomp) {
                                tb2 += '<tr role="row" style="font-size:12px;font-weight:bold">';
                                tb2 += '<td></td>';
                                tb2 += '<td></td>';
                                tb2 += '<td></td>';
                                tb2 += '<td style="text-align:right;">Total</td>';
                                tb2 += '<td style="text-align:right;">' + data[i].sumcred + '&nbsp;&nbsp;&nbsp;</td>';
                                tb2 += '<td style="text-align:right;" colspan="2">&nbsp;</td>';
                                tb2 += '<td></td>';
                                tb2 += '<td></td>';
                                tb2 += '</tr>';
                                cnv = 0;
                            ...
                            det++;
                            tb2 += '<tr role="row" style="font-size:11px; color:' + data[i].color + '">';
                            tb2 += '<td>' + data[i].ciclo + '</td>';
                            tb2 += '<td>' + data[i].desc_cac + '</td>';
                            tb2 += '<td>' + data[i].tcurdma + '</td>';
                            if (data[i].inhabilitado) {
                            ...
                            tb2 += '<td style="text-align:right;">' + data[i].cred + '&nbsp;&nbsp;&nbsp;</td>';
                            tb2 += '<td>' + data[i].grupo + '</td>';
                            tb2 += '<td style="text-align:right;">' + data[i].vcsdma + '&nbsp;&nbsp;&nbsp;</td>';
                            tb2 += '<td>' + data[i].condicion + '</td>';
                            tb2 += '<td>' + data[i].escuela + '</td>';
                            tb2 += '</tr>';
                            if (data[i].condicion == "ACREDITA") {
                                FCCA += parseInt(data[i].cred);
                                FCAA++;
                            }
                        }
