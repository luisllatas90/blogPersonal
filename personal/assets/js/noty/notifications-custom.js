function fnMensajeConfirmarEliminar(layout, mensaje, funcion, param1, param2, param3, param4) {
...
function fnMensajeConfirmarEliminarAtencion(layout, mensaje, funcion,funcioncancelar, param1, param2, param3, param4) {
    ...
    var n = noty({
        ...
        { addClass: 'btn btn-danger', text: 'No', onClick: function($noty) {
            var myFunc = window[funcioncancelar];
            myFunc( param2);
...
//Chrome Desktop notifications
 ...
 $(function() {
        $('button#noti').click(function(){
            $.desknoty({
                icon: "assets/images/profiles/eleven.png",
