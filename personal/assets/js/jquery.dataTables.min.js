...
-1 !== r.indexOf("&") && (i.innerHTML = r, r = i.textContent ? i.textContent : i.innerText, r = r.replace(/\n/g, " ").replace(/\r/g, ""));
         ...
         function Ka(e) {
             //i.browser.msie=navigator.userAgent.match(/msie [6]/i)
             var t = e.nScrollHead.getElementsByTagName("div")[0], n = t.getElementsByTagName("table")[0], r = e.nTable.parentNode, s, o, u, a, f, l, c, h, p = [], d = null !== e.nTFoot ? e.nScrollFoot.getElementsByTagName("div")[0] : null, v = null !== e.nTFoot ? d.getElementsByTagName("table")[0] : null, m = navigator.userAgent.match(/msie [6]/i) && 7 >= i.browser.version;
...
-1 != i.inArray(e, t) && i(s).insertAfter(e);
     ...
     j.defaults = {
         ...
         oLanguage: {
             ...
             sSearch: "Buscar:",
             sUrl: "",
             sZeroRecords: "No se ha encontrado informaci&oacuten"
         },
