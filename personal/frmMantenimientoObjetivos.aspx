    ...
    <div class="usatPanel">
        ...
        <div style="margin-top:10px;">
            ...
            <div class="usatFormatoCampoAncho">
                <asp:TextBox ID="txtAbreviatura" runat="server" Width="70px" Font-Size="Small" 
        ...
        <div style="margin-top:1px;">
            ...
            <div class="usatFormatoCampoAncho">
                <asp:TextBox ID="txtDescripcion" runat="server" Width="500px" Font-Size="Small" 
        ...
        <div>
            <div class="usatFormatoCampo">
                <asp:Label ID="Label1" runat="server" Text="Filtrar Plan"></asp:Label>
            </div>
            <div class="usatFormatoCampoAncho">
                    
                <asp:RadioButton ID="rbtTodos" text="Todos Planes Configurados" runat="server" 
                    AutoPostBack="True" GroupName="Opciones" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:RadioButton ID="rbtActivo" Text="Plan Activo" runat="server" 
                    AutoPostBack="True" GroupName="Opciones" Checked="True" />
         ...
         <table cellpadding="3" cellspacing="0" style="width: 100%; border:1px solid #96ACE7" border="0">
                <tr>                
                    <td style="text-align:center" align="center">
                        <asp:GridView ID="gvObjetivos" runat="server" Width="100%" CellPadding="4" 
                            ForeColor="#333333" AutoGenerateColumns="False" 
                            DataKeyNames="Codigo,codigo_ppla, DesdeOptimo,HastaOptimo,DesdeAmbar,HastaAmbar,DesdeRojo,HastaRojo" 
