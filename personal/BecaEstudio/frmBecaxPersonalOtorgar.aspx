<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBecaxPersonalOtorgar.aspx.vb" Inherits="BecaEstudio_frmBecaxConvenio" %>
...
<body>
    ...
    <div id="">
        <asp:Panel ID="pnlPrincipal" runat="server" Visible="true">
            ...
            <tr>
                <td bgcolor="#EFF3FB" height="35px">
                    ...
                    <asp:Label ID="Label11" runat="server" 
                        Text="Asignar Becas por Personal USAT"></asp:Label></b>
                </td>
            </tr>
            <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlDedicacion" runat="server" AutoPostBack="True">
                                    ...
                                    <asp:ListItem Value="1">TIEMPO COMPLETO</asp:ListItem>
                                    <asp:ListItem Value="2">MEDIO TIEMPO</asp:ListItem>
                                    <asp:ListItem Value="-1">TIEMPO PARCIAL &gt;= 30 hrs</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                             <td>
                                 &nbsp;</td>
            ...
            <tr>
                <td align="left">
                    <asp:Button ID="btnAgregar" CssClass="asignarbecas" runat="server" Height="40" 
                        Text="      Asignar Beca" />
                </td>
            </tr>
            <tr>
             ...
             <asp:TemplateField HeaderText="" >
                ...
                <ItemTemplate>                
                    <asp:CheckBox ID="chkElegir" runat="server"/>
                             ...
                             <asp:BoundField DataField="PersonalUSAT" HeaderText="Personal USAT" />
