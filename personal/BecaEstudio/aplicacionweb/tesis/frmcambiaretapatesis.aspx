<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmcambiaretapatesis.aspx.vb" Inherits="personal_academico_tesis_frmcambiaretapatesis" %>
...
<body>
    ...
    <table width="100%" cellpadding="4" cellspacing="0" 
        ...
        <tr>
            <td class="usatTitulo">Lista de tesis por etapa</td>
            <td align="right">
                Acciones:
                <asp:DropDownList ID="dpAcciones" runat="server" Enabled="False" 
                    Font-Size="7pt" EnableViewState="False">
                    <asp:ListItem Value="-2">--Seleccione una acción--</asp:ListItem>
                    <asp:ListItem Value="0">Habilitar asesoria de tesis</asp:ListItem>
                    <asp:ListItem Value="1">Deshabilitar asesoría de tesis</asp:ListItem>
                    <asp:ListItem Value="2">Cambiar etapa de tesis</asp:ListItem>
                </asp:DropDownList>
                <asp:ImageButton ID="imgGuardar" runat="server" 
                    ImageAlign="AbsMiddle" ImageUrl="../../../images/guardar.gif"
                    OnClientClick="OcultarTabla()" EnableViewState="False" />
            </td>
        </tr>
    </table>
    <br />
    ...
    <table width="100%" cellpadding="3" cellspacing="0" id="tblLista">
        <tr>
            <td width="20%">Carrera Profesional:</td>
            <td width="80%">
            ...
            &nbsp;Etapa: 
                <asp:DropDownList ID="dpFase" runat="server" Font-Size="9px" 
                    Width="180px" TabIndex="1" AutoPostBack="True"></asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="descripcion_cac" HeaderText="Semestre Matricula" />
