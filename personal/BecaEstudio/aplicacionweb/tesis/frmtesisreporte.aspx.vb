...
Partial Class personal_academico_tesis_frmcambiaretapatesis
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            Else
                ClsFunciones.LlenarListas(Me.dpEscuela, obj.TraerDataTable("consultaracceso", "ESC", "", Request.QueryString("id")), "codigo_cpf", "nombre_cpf", "-Seleccione la Carrera Profesional-")
            End If
