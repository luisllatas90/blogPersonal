...
//	Modificado por Ricaute Jiménez S.
...
function PoPCalCreateCalendarInstance()
{
	...
	if (!PopCalInstanceCreated())
	{
		...
		this.imgDir = "/iconos/" // directory for images ...  e.g. var imgDir="/img/"
...
function PopCalInitCalendar()
{
	...
	if (PopCal)
	{
		if (PopCal.initialized==0)
		{
			...
			document.write ("<div id='popupSuperCalendar' onclick='PopCalDownMonth();PopCalDownYear();objPopCalendar.bShow=true;' style='z-index:+999;position:absolute;top:0;left:0;visibility:hidden;background-color:#ffffff'><table id='popupSuperHighLight' width="+((objPopCalendar.showWeekNumber==1)?250:220)+" style='font-family:arial;font-size:11px;border-width:1;border-style:solid;border-color:#a0a0a0;font-family:arial; font-size:11px}' bgcolor='#ffffff'><tr height='10' bgcolor='#267DDD'><td height='10' Style='cursor:default'><table width='"+((objPopCalendar.showWeekNumber==1)?248:218)+"'><tr height='10'><td height='10' style='padding:2px;font-family:arial; font-size:11px;cursor:default'><font color='#ffffff'><B><span id='popupSuperCaption'></span></B></font></td><td id='popupSuperMoveCalendar' width='1px'></td><td align=right Style='cursor:default'><a onClick='PopCalHideCalendar()'><font face='verdana' size='1' color='#FFFFFF'><b>x</b></font></a></td></tr></table></td></tr><tr height='10'><td height='10' style='padding:5px;cursor:default' bgcolor=#ffffff><span id='popupSuperContent'></span></td></tr>")

			if (objPopCalendar.showToday==1)
			{
				document.write ("<tr height='10' bgcolor=#f0f0f0><td height='10' style='padding:5px;cursor:default' align=center><span id='popupSuperToday'></span></td></tr>")
			}
			...
			var sHTML1="<span id='popupSuperSpanLeft' style='border-style:solid;border-width:1;border-color:#3366FF;cursor:default;' onmouseover='PopCalSwapImage(\"popupSuperChangeLeft\",\"left2.gif\");this.style.borderColor=\"#88AAFF\";window.status=\""+objPopCalendar.scrollLeftMessage+"\"' onclick='PopCalDecMonth()' onmouseout='clearInterval(objPopCalendar.intervalID1);PopCalSwapImage(\"popupSuperChangeLeft\",\"left1.gif\");this.style.borderColor=\"#3366FF\";window.status=\"\"' onmousedown='clearTimeout(objPopCalendar.timeoutID1);objPopCalendar.timeoutID1=setTimeout(\"PopCalStartDecMonth()\",100)' onmouseup='clearTimeout(objPopCalendar.timeoutID1);clearInterval(objPopCalendar.intervalID1)'>&nbsp<font size='1' face='verdana' color='#FFFFFF'>&laquo;</font>&nbsp</span>&nbsp;"
			sHTML1+="<span id='popupSuperSpanRight' style='border-style:solid;border-width:1;border-color:#3366FF;cursor:default;' onmouseover='PopCalSwapImage(\"popupSuperChangeRight\",\"right2.gif\");this.style.borderColor=\"#88AAFF\";window.status=\""+objPopCalendar.scrollRightMessage+"\"' onmouseout='clearInterval(objPopCalendar.intervalID1);PopCalSwapImage(\"popupSuperChangeRight\",\"right1.gif\");this.style.borderColor=\"#3366FF\";window.status=\"\"' onclick='PopCalIncMonth()' onmousedown='clearTimeout(objPopCalendar.timeoutID1);objPopCalendar.timeoutID1=setTimeout(\"PopCalStartIncMonth()\",100)'	onmouseup='clearTimeout(objPopCalendar.timeoutID1);clearInterval(objPopCalendar.intervalID1)'>&nbsp<font size='1' face='verdana' color='#FFFFFF'>&raquo;</font>&nbsp</span>&nbsp"
			sHTML1+="<span id='popupSuperSpanMonth' style='border-style:solid;border-width:1;border-color:#3366FF;cursor:default;' onmouseover='PopCalSwapImage(\"popupSuperChangeMonth\",\"drop2.gif\");this.style.borderColor=\"#88AAFF\";window.status=\""+objPopCalendar.selectMonthMessage+"\"' onmouseout='PopCalSwapImage(\"popupSuperChangeMonth\",\"drop1.gif\");this.style.borderColor=\"#3366FF\";window.status=\"\"' onclick='objPopCalendar.keepMonth=!PopCalIsVisible(objPopCalendar.crossMonthObj);PopCalUpMonth()'></span>&nbsp;"
			sHTML1+="<span id='popupSuperSpanYear' style='border-style:solid;border-width:1;border-color:#3366FF;cursor:default;' onmouseover='PopCalSwapImage(\"popupSuperChangeYear\",\"drop2.gif\");this.style.borderColor=\"#88AAFF\";window.status=\""+objPopCalendar.selectYearMessage+"\"'	onmouseout='PopCalSwapImage(\"popupSuperChangeYear\",\"drop1.gif\");this.style.borderColor=\"#3366FF\";window.status=\"\"' onclick='objPopCalendar.keepYear=!PopCalIsVisible(objPopCalendar.crossYearObj);PopCalUpYear()' onMouseWheel='PopCalWheelYear()'></span>&nbsp;"
...
function PopCalConstructMonth() 
{
	...
	if (!objPopCalendar.monthConstructed) 
	{
		...
		for (var i=beginMonth; i<=endMonth; i++) 
		{
			...
			sHTML += "<tr height='10'><td height='10' id='popupSuperMonth" + i + "' onmouseover='objPopCalendar.bShow=true;this.style.backgroundColor=\"#FFCC99\"' onmouseout='objPopCalendar.bShow=false;this.style.backgroundColor=\"\"' style='cursor:default' onclick='objPopCalendar.bShow=false;objPopCalendar.monthConstructed=false;objPopCalendar.monthSelected=" + i + ";PopCalConstructCalendar();PopCalDownMonth();event.cancelBubble=true'>&nbsp;" + sName + "&nbsp;</td></tr>"
		}
...
function PopCalConstructYear() 
{
	...
	if (!objPopCalendar.yearConstructed)
	{
		...
		if (longList)
		{
			sHTML += "<tr height='10'><td height='10' align='center' onmouseover='objPopCalendar.bShow=true;this.style.backgroundColor=\"#FFCC99\"' onmouseout='objPopCalendar.bShow=false;clearInterval(objPopCalendar.intervalID1);this.style.backgroundColor=\"\"' style='cursor:default;border-bottom:1px #a0a0a0 solid' onmousedown='clearInterval(objPopCalendar.intervalID1);objPopCalendar.intervalID1=setInterval(\"PopCalDecYear()\",15)' onmouseup='clearInterval(objPopCalendar.intervalID1)'><font face='verdana' size='1' color='#000000'><b>^</b></font></td></tr>"
		}
		...
		for (var i=(beginYear); i<=(endYear); i++)
		{
			...
			sHTML += "<tr height='10'><td height='10' id='popupSuperYear" + j + "' align='center' onmouseover='objPopCalendar.bShow=true;this.style.backgroundColor=\"#FFCC99\"' onmouseout='objPopCalendar.bShow=false;this.style.backgroundColor=\"\"' style='cursor:default' onclick='objPopCalendar.bShow=false;PopCalSelectYear("+j+");event.cancelBubble=true'>&nbsp;" + sName + "&nbsp;</td></tr>"
			j ++
		}

		if (longList)
		{
			sHTML += "<tr height='10'><td height='10' align='center' onmouseover='objPopCalendar.bShow=true;this.style.backgroundColor=\"#FFCC99\"' onmouseout='objPopCalendar.bShow=false;clearInterval(objPopCalendar.intervalID2);this.style.backgroundColor=\"\"' style='cursor:default;border-top:1px #a0a0a0 solid' onmousedown='clearInterval(objPopCalendar.intervalID2);objPopCalendar.intervalID2=setInterval(\"PopCalIncYear()\",15)' onmouseup='clearInterval(objPopCalendar.intervalID2)'><font face='arial' size='1' color='#000000'><b>v</b></font></td></tr>"
		}

		document.getElementById("popupSuperYear").innerHTML	= "<table width=44 style='font-family:arial; font-size:11px; border-width:1; border-style:solid; border-color:#a0a0a0;'	bgcolor='#FFFFDD' onmouseover='clearTimeout(objPopCalendar.timeoutID2)' onmouseout='clearTimeout(objPopCalendar.timeoutID2);' cellspacing=0>"	+ sHTML	+ "</table>"
...
function PopCalConstructCalendar ()
{
	...
	var sHTML = "<table border=0 style='font-family:verdana;font-size:10px;'><tr height='10'>"

	if (PopCal.showWeekNumber==1)
	{
		sHTML += "<td height='10' width=27 Style='cursor:default'><b>" + objPopCalendar.weekString + "</b></td><td width=1 rowspan=7 bgcolor='#d0d0d0' style='padding:0px'></td>"
	}
	...
	sHTML +="</tr><tr height='10'>"
	
	if (PopCal.showWeekNumber==1)
	{
		sHTML += "<td height='10' align=right Style='cursor:default'>" + PopCalWeekNbr(startDate) + "&nbsp;</td>"
	}
	...
	for (var datePointer=1; datePointer<=numDaysInMonth; datePointer++ )
	{
		...
		if (notSelect)
		{
			...
			{
				sHTML += "<b><Span title=\"" + sHint + "\" Style='" + sStyle + "text-decoration:line-through;color=#ff0000'>&nbsp;" + datePointer + "&nbsp;</Span></b>"
			}
		...
		{
			sHTML += "<b><a "+dateMessage+" title=\"" + sHint + "\" style='"+sStyle+"' onClick='objPopCalendar.dateSelected="+datePointer+";PopCalCloseCalendar();'>&nbsp;<font color=#ff0000>" + datePointer + "</font>&nbsp;</a></b>"
		}
		else if (((dayPointer % 7 == (PopCal.startAt * -1)+1) || (dayPointer % 7 == (PopCal.startAt * -1)+7) || (dayPointer % 7 == (PopCal.startAt * -1))) && (PopCal.showWeekend==1))
		{
		...
		if ((dayPointer+PopCal.startAt) % 7 == PopCal.startAt) { 
			...
			{
				sHTML += "<td height='10' align=right Style='cursor:default'>" + (PopCalWeekNbr(new Date(objPopCalendar.yearSelected,objPopCalendar.monthSelected,datePointer+1))) + "&nbsp;</td>"
			}
		}
	...
	document.getElementById("popupSuperSpanMonth").innerHTML = "&nbsp;" + objPopCalendar.monthName[objPopCalendar.monthSelected] + "&nbsp;<font size='1' face='verdana' color='#FFFFFF'>v</font>"
	document.getElementById("popupSuperSpanYear").innerHTML = "&nbsp;" + objPopCalendar.yearSelected + "&nbsp;<font size='1' face='verdana' color='#FFFFFF'>v</font>"
...
function PopCalAddRegularHolidays()
{
	...
	PopCalAddHoliday(29,6,0,"D" + c_iTilde + "a del Papa", "Dia del Papa")
	PopCalAddHoliday(28,7,0,"D" + c_iTilde + "a de la Independencia", "Independence Day")
	PopCalAddHoliday(29,7,0,"D" + c_iTilde + "a de la Independencia", "Independence Day")
	PopCalAddHoliday(30,8,0,"D" + c_iTilde + "a de Santa Rosa de Lima", "Santa Rosa de Lima")
	PopCalAddHoliday(8,10,0,"D" + c_iTilde + "a del Combate de Angamos ", "Dia del COmbate de Angamos")
	PopCalAddHoliday(8,12,0,"D" + c_iTilde + "a de La Inmaculada Concepcion", "Dia de La Inmaculada Concepcion")
