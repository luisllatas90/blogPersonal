<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmClasificacion.aspx.vb"
    Inherits="OrientacionCliente_FrmClasificacion" %>
...
<head runat="server">
    ...
    <title>Clasificación de tickets</title>
    ...
    <script type="text/javascript">
        ...
        function Validar(ctrl, texto, adicional) {
            if ($("#txtDescripcion").val().trim() == "") {
                fnMensaje('error', 'Debe ingresar la descripción de la clasificación')
                return false
            } else if ($("#txtDetalle").val().trim() == "") {
                    ...
                    <ContentTemplate>
                        <div runat="server" id="Lista">
                            ...
                            <div class="form-group">
                                <asp:GridView runat="server" ID="gvLista" CssClass="table table-condensed" DataKeyNames="codigo_tio,nombre_tio,descripcion_tio"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="nombre_tio" HeaderText="CLASIFICACIÓN" HeaderStyle-Width="30%" />
                                        <asp:BoundField DataField="descripcion_tio" HeaderText="DESCRIPCIÓN" HeaderStyle-Width="60%" />
                                        ...
                                        <asp:TemplateField HeaderText="" HeaderStyle-Width="3%" ShowHeader="false">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnEliminar" runat="server" Text='<span class="fa fa-close"></span>'
                                                    ...
                                                    OnClientClick="fnConfirmacion(this,'¿Está seguro que desea eliminar la clasificación?','Luego no podrá visualizar la clasificación'); return false;"
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <asp:Label ID="Label2" runat="server" CssClass="col-sm-2 col-md-1 control-label"
                                        For="txtDescripcion">Clasificación</asp:Label>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <asp:Label ID="Label1" runat="server" CssClass="col-sm-2 col-md-1 control-label"
                                        For="txtDetalle">Descripción</asp:Label>
                                    <div class="col-sm-6 col-md-6">
                                        <asp:TextBox runat="server" ID="txtDetalle" CssClass="form-control" Text="" TextMode="MultiLine"
                                            Rows="4"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
