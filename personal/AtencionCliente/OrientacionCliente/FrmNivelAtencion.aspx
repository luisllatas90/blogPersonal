<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmNivelAtencion.aspx.vb"
    Inherits="OrientacionCliente_FrmNivelAtencion" %>
...
<head runat="server">
    ...
    <title>Niveles de atención</title>
    ...
    <script type="text/javascript">
        ...
        function Validar(ctrl, texto, adicional) {
            if ($("#txtDescripcion").val().trim() == "") {
                fnMensaje('error', 'Debe ingresar la descripción del nivel de atención')
                return false
            }
            else {
                    ...
                    <ContentTemplate>
                        <div runat="server" id="Lista">
                            ...
                            <div class="form-group">
                                <asp:GridView runat="server" ID="gvLista" CssClass="table table-condensed" DataKeyNames="codigo_ioc,nombre_ioc"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="nombre_ioc" HeaderText="NIVEL DE ATENCIÓN" HeaderStyle-Width="70%" />
                                        ...
                                        <asp:TemplateField HeaderText="" HeaderStyle-Width="3%" ShowHeader="false">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnEliminar" runat="server" Text='<span class="fa fa-close"></span>'
                                                    ...
                                                    OnClientClick="fnConfirmacion(this,'¿Está seguro que desea eliminar el nivel de atención?','Luego no podrá visualizar el registro'); return false;"
