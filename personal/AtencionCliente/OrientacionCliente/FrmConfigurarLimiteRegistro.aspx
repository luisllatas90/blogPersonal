<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmConfigurarLimiteRegistro.aspx.vb"
    Inherits="OrientacionCliente_FrmConfigurarLimiteRegistro" %>
    ...
    <script type="text/javascript">
        ...
        function Validar(ctrl, texto, adicional) {
            if ($("#txtDescripcion").val() == "") {
                ...
                return false
            } else if ($("#txtCantidad").val().trim() == "") {
                fnMensaje('error', 'Debe ingresar la cantidad de días')
                return false
            }
            else {
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="background-color: #E33439; color: White; font-weight: bold;
                font-size: 16px;">
                <b>Configurar limites de tickets</b>
            </div>
                    ...
                    <ContentTemplate>
                        <div runat="server" id="Lista">
                            ...
                            <div class="form-group">
                                <asp:GridView runat="server" ID="gvLista" CssClass="table table-condensed" DataKeyNames="codigo_cla,nombre_cla,limite_cla"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="nombre_cla" HeaderText="DESCRIPCIÓN DE LIMITE" HeaderStyle-Width="60%" />
                                        <asp:BoundField DataField="limite_cla" HeaderText="CANTIDAD" HeaderStyle-Width="10%" />
                                        ...
                                        <%--  <asp:TemplateField HeaderText="" HeaderStyle-Width="3%" ShowHeader="false">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnEliminar" runat="server" Text='<span class="fa fa-close"></span>'
                                                    ...
                                                    OnClientClick="fnConfirmacion(this,'¿Está seguro que desea eliminar el tipo de orientación?','Luego no podrá visualizar el tipo'); return false;"
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <asp:TextBox runat="server" ID="txtDescripcion" CssClass="form-control" Text="" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <asp:Label ID="Label1" runat="server" CssClass="col-sm-2 col-md-1 control-label"
                                        For="txtDescripcion">Cantidad</asp:Label>
                                    <div class="col-xs-12 col-sm-1 col-md-1">
                                        <div class="input-group demo-group">
                                            <asp:TextBox runat="server" ID="txtCantidad" CssClass="form-control" Text="" MaxLength="5"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
