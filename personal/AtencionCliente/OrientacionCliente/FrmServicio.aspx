<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmServicio.aspx.vb" Inherits="OrientacionCliente_FrmServicio" %>
    ...
    <script type="text/javascript">
        ...
        function Validar(ctrl, texto, adicional) {
            if ($("#txtNombre").val().trim() == "") {
                fnMensaje('error', 'Debe ingresar el nombre del servicio')
                return false
            }
            else {
        ...
        function fnValidarAgregar() {
            if ($("#ddlInstancia").val() == "0") {
                fnMensaje('error', 'Debe seleccionar el nivel de atención')
                return false
            }
            if ($("#txtDias").val().trim() == "") {
                fnMensaje('error', 'Debe ingresar el número de dias para la atención del nivel')
                return false
            }
            if (EsEntero($("#txtDias").val().trim()) == false) {
                fnMensaje('error', 'Debe ingresar un número entero de dias para la atención del nivel')
                return false
            }
            if ($("#ddlResponsable").val() == "0") {
                fnMensaje('error', 'Debe seleccionar el perfil responsable')
                return false
            }
            if ($("#txtOrden").val().trim() == "") {
                fnMensaje('error', 'Debe ingresar el orden del nivel de atención')
                return false
            }
            if (EsEntero($("#txtOrden").val().trim()) == false) {
                fnMensaje('error', 'Debe ingresar un número entero de orden para la atención del nivel')
                return false
            }
            return true
                    ...
                    <ContentTemplate>
                        <div runat="server" id="Lista">
                            ...
                            <div class="form-group">
                                <asp:GridView runat="server" ID="gvLista" CssClass="table table-condensed" DataKeyNames="codigo_soc,nombre_soc,descripcion_soc"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="nombre_soc" HeaderText="SERVICIO" HeaderStyle-Width="50%" />
                                        <asp:BoundField DataField="descripcion_soc" HeaderText="DESCRIPCIÓN" HeaderStyle-Width="30%" />
                                        ...
                                        <asp:TemplateField HeaderText="" HeaderStyle-Width="3%" ShowHeader="false">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnEliminar" runat="server" Text='<span class="fa fa-close"></span>'
                                                    ...
                                                    OnClientClick="fnConfirmacion(this,'¿Está seguro que desea eliminar el servicio?','Luego no podrá visualizar el registro'); return false;"
                        ...
                        <div class="form-group" id="DivMantenimiento" runat="server" visible="false">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <asp:Label ID="Label2" runat="server" CssClass="col-sm-2 col-md-2 control-label"
                                        For="txtNombre">Nombre</asp:Label>
                                    <div class="col-sm-6 col-md-6">
                                        <asp:TextBox runat="server" ID="txtNombre" CssClass="form-control" Text=""></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <asp:Label ID="Label4" runat="server" CssClass="col-sm-12 col-md-12 badge bg-danger"
                                        Font-Size="16px">Configurar Niveles de atención</asp:Label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    <asp:Label ID="Label5" runat="server" CssClass="col-sm-2 col-md-2 control-label"
                                        For="txtDescripcion">Nivel de atención</asp:Label>
                                    ...
                                    <asp:Label ID="Label3" runat="server" CssClass="col-sm-2 col-md-2 control-label"
                                        For="txtDescripcion">Dias para resolver</asp:Label>
                                    <div class="col-sm-1 col-md-1">
                                        <asp:TextBox runat="server" ID="txtDias" CssClass="form-control" Text=""></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    <asp:Label ID="Label6" runat="server" CssClass="col-sm-2 col-md-2 control-label"
                                        For="txtDescripcion">Rol Responsable</asp:Label>
                                    <div class="col-sm-5 col-md-5">
                                        <asp:DropDownList runat="server" ID="ddlResponsable" CssClass="form-control">
                                        </asp:DropDownList>
                                    </div>
                                    <asp:Label ID="Label7" runat="server" CssClass="col-sm-1 col-md-1 control-label"
                                        For="txtDescripcion">Orden</asp:Label>
                                    <div class="col-sm-1 col-md-1">
                                        <asp:TextBox runat="server" ID="txtOrden" CssClass="form-control" Text=""></asp:TextBox>
                                    </div>
                                    <div class="col-sm-2 col-md-2">
                                        <asp:Button runat="server" ID="btnAgregar" CssClass="btn btn-sm btn-primary btn-radius"
                                            OnClientClick="return fnValidarAgregar();" Text="Agregar" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <asp:UpdatePanel runat="server" ID="UpdatePanel2" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:GridView runat="server" ID="gvConfiguracion" CssClass="table table-condensed"
                                                DataKeyNames="codigo_cso,codigo_soc,codigo_ioc,codigo_tfu" AutoGenerateColumns="false">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="#" HeaderStyle-Width="3%">
                                                        <ItemTemplate>
                                                            <%#Container.DataItemIndex + 1%>
                                                    ...
                                                    <asp:BoundField DataField="nombre_ioc" HeaderText="NIVEL DE ATENCIÓN" HeaderStyle-Width="30%" />
                                                    <asp:BoundField DataField="descripcion_tfu" HeaderText="ROL DE RESPONSABLE" HeaderStyle-Width="40%" />
                                                    <asp:BoundField DataField="diasatencion_cso" HeaderText="DIAS PARA RESOLVER" HeaderStyle-Width="10%"
                                                        ItemStyle-HorizontalAlign="Center" />
                                                    <asp:BoundField DataField="orden_cso" HeaderText="ORDEN" HeaderStyle-Width="10%"
                                                        ItemStyle-HorizontalAlign="Center" />
                                                    <asp:TemplateField HeaderText="" HeaderStyle-Width="3%" ShowHeader="false">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnEliminar" runat="server" Text='<span class="fa fa-close"></span>'
                                                                CssClass="btn btn-danger btn-sm btn-radius" ToolTip="Eliminar" CommandName="Eliminar"
                                                                OnClientClick="fnConfirmacion(this,'¿Está seguro que desea eliminar la configuración?','Luego no podrá visualizar el registro'); return false;"
                                                                CommandArgument='<%#Convert.ToString(Container.DataItemIndex)%>'> 
                                                            </asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                ...
                                                <RowStyle Font-Size="12px" />
                                                <EmptyDataTemplate>
                                                    <b>No cuenta con configuración de niveles de atención</b>
                                                </EmptyDataTemplate>
                                            </asp:GridView>
                                        </ContentTemplate>
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="btnAgregar" />
                                            <asp:AsyncPostBackTrigger ControlID="gvConfiguracion" EventName="RowCommand" />
                                        </Triggers>
                                    </asp:UpdatePanel>
                                </div>
                            </div>
