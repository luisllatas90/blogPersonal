    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Session("perlogin") Is Nothing Then
            Try
                ...
                list.Add("Usuario", perlogin)
                list.Add("Token", token)
                Dim envelope As String = wsCloud.SoapEnvelopeDescarga(list)

                Dim result As String = wsCloud.PeticionRequestSoap(ruta, envelope, "http://usat.edu.pe/DownloadFile", perlogin)
                ...
                If tb.Rows.Count > 0 Then
                    ...
                    Response.AppendHeader("Content-Length", bytes.Length)
