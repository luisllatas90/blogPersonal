<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmEvaluacionEvaluadorExterno.aspx.vb" Inherits="GestionInvestigacion_FrmEvaluacionEvaluadorExterno" %>
                                ...
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="page_header">
                                        <div class="pull-left">
                                            ...
                                            <span class="main-text">GESTIÓN DE INVESTIGACIÓN </span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input name="txtEvaluadorExterno" type="text" id="txtEvaluadorExterno" value="" class="form-control" readonly="true" runat="server"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <label class="col-md-2 control-label ">
                                            Concurso</label>
                                        <div class="col-md-8">
                                            <input name="txtConcurso" type="text" id="txtConcurso" value="" class="form-control" readonly="true" runat="server"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <label class="col-md-2 control-label ">
                                            Rúbrica</label>
                                        <div class="col-md-8">
                                            <div id=txtRubrica runat="server"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel-piluku">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div id="tBonos_wrapper" class="dataTables_wrapper" role="grid">
                                                <table id="tPostulacionesEvaluar" name="tPostulacionesEvaluar" class="display dataTable" width="100%">
                                                    <thead>
                                                        <tr role="row">
