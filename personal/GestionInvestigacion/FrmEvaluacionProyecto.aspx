<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmEvaluacionProyecto.aspx.vb"
...
<head>
    ...
    <script src="js/EvaluacionProyecto.js?x=4" type="text/javascript"></script>
            ...
            <div class="main-content">
                            ...
                            <div id="PanelBusqueda">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="page_header">
                                        <div class="pull-left">
                                            <i class="icon ti-bookmark-alt page_header_icon"></i><span class="main-text" id="titulo">
                                                Evaluación de Proyectos de Investigación</span>
                                        </div>
                                    ...
                                    <table id="tProyectos" name="tProyectos" class="display dataTable" width="100%">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <td width="22%" style="font-weight: bold; width: 89px; text-align: center" class="sorting"
                                                    tabindex="0" rowspan="1" colspan="1" aria-label="Nombre: activate to sort column ascending">
                                                    Responsable
                                                </td>
                    ...
                    <div class="modal fade" id="mdEquipo" role="dialog" aria-labelledby="myModalLabel"
                        ...
                        <div class="modal-dialog modal-lg" id="Div3">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <center>
                                        <button type="button" class="btn btn-danger" id="Button6" data-dismiss="modal">
                                            Cancelar</button>
                                    </center>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="modal fade" id="mdObservar" role="dialog" aria-labelledby="myModalLabel"
                        style="z-index: 0;" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                        <div class="modal-dialog modal-lg" id="Div1">
                            <div class="modal-content">
                                <div class="modal-header" style="background-color: #E33439; color: White; font-weight: bold;">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="float: right;">
                                        <span aria-hidden="true" class="ti-close" style="color: White;"></span>
