<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmEvaluacionPostulacion.aspx.vb"
    Inherits="GestionInvestigacion_FrmEvaluacionProyecto" %>

<!DOCTYPE html>
<html>
<head>
    <title>Evaluar Postulación</title>
    ...
    <script src="js/EvaluarPostulacion.js?x=3" type="text/javascript"></script>
                                        ...
                                        <table id="tPostulacion" name="tPostulacion" class="display dataTable" width="100%">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <td style="font-weight: bold; width: 30%; text-align: center" class="sorting"
                                                        tabindex="0" rowspan="1" colspan="1" aria-label="Nombre: activate to sort column ascending">
                                                        Coordinador
                                                    </td>
                                                    <td style="font-weight: bold; width: 35%; text-align: center" class="sorting"
                                                        tabindex="0" rowspan="1" colspan="1" aria-label="Nombre: activate to sort column ascending">
                                                        Titulo
                                                    </td>
                                                    <td style="font-weight: bold; width: 10%; text-align: center" class="sorting"
                                                        tabindex="0" rowspan="1" colspan="1" aria-label="Etapa: activate to sort column ascending">
                                                        Fecha Postulación
                                                    </td>
                                                    <td style="font-weight: bold; width: 15%; text-align: center" class="sorting"
                                                        tabindex="0" rowspan="1" colspan="1" aria-label="Etapa: activate to sort column ascending">
                                                        Etapa
                                                    </td>
                                                    <td style="font-weight: bold; width: 5%; text-align: center" class="sorting"
                                                        tabindex="0" rowspan="1" colspan="1" aria-label="Opciones: activate to sort column ascending">
                                                        Opciones
                                                    </td>
                                                </tr>
                        ...
                        <div class="modal-dialog modal-lg" id="modalReg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row" id="Evaluacion" style="text-align: right;">
                                        <button type="button" id="btnObservar" class="btn btn-danger" onclick="fnEvaluar(5,'R')">
                                            Rechazar</button>
                                        <button type="button" class="btn btn-success" id="btnAprobar" onclick="fnEvaluar(2,'A')">
                                            Aprobar</button>
                                    </div>
                                    <div role="tabpanel">
                                        <!-- Nav tabs -->
                                        <ul class="nav nav-tabs nav-justified piluku-tabs piluku-noborder" role="tablist">
                                            <li role="presentation" class="active" id="tabLI1"><a href="#hometabnb" aria-controls="home"
                                                role="tab" data-toggle="tab" aria-expanded="true" id="tab1">Información General</a></li>
                                            <li role="presentation" class="" id="tabEstudiante"><a href="#tabalumno" aria-controls="home"
                                                role="tab" data-toggle="tab" aria-expanded="true" id="A1">Información General</a></li>
                                            <li role="presentation" class="" id="tabLI2"><a href="#profiletabnb" aria-controls="profile"
                                        ...
                                        <div class="tab-content piluku-tab-content">
                                            <div role="tabpanel" class="tab-pane active" id="hometabnb">
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            ...
                                                            <input type="text" id="txttituloPos" name="txttituloPos" class="form-control" maxlength="500"
                                                                disabled="disabled" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select id="cboLinea" name="cboLinea" class="form-control" disabled="disabled">
                                            ...
                                            <div role="tabpanel" class="tab-pane" id="tabalumno">
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label" for="txttituloPos">
                                                            Título:</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" id="txttituloPosA" name="txttituloPosA" class="form-control" readonly="true" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label" for="txttituloPos">
                                                            Asesor:</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" id="txtAsesor" name="txtAsesor" class="form-control" readonly="true" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label" for="txtFacultad">
                                                            Facultad:</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" id="txtFacultad" name="txtFacultad" class="form-control" readonly="true" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label" for="txtEscuela">
                                                            Escuela:</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" id="txtEscuela" name="txtEscuela" class="form-control" readonly="true" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label" for="txtFechaNac">
                                                            Fecha Nac.:</label>
                                                        <div class="col-sm-9">
                                                            <input type="txtFechaNac" id="txtFechaNac" name="txtFechaNac" class="form-control"
                                                                readonly="true" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label" for="txtEmail">
                                                            Email:</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" id="txtEmail" name="txtEmail" class="form-control" readonly="true" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label" for="txtFijo">
                                                            Telef. Fijo:</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" id="txtFijo" name="txtFijo" class="form-control" readonly="true" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="table-responsive" style="font-size: 12px; font-weight: 300; line-height: 18px;">
                                                        <div id="Div1" class="dataTables_wrapper" role="grid">
                                                            <table id="tGrupo" name="tGrupo" class="display dataTable" width="100%">
                                                                <thead>
                                                                    <tr role="row">
                                                                        <td style="font-weight: bold; width: 3%; text-align: center" class="sorting_asc"
                                                                            tabindex="0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="N°: activate to sort column descending">
                                                                            N°
                                                                        </td>
                                                                        <td style="font-weight: bold; width: 37%; text-align: center" class="sorting" tabindex="0"
                                                                            rowspan="1" colspan="1" aria-label="Nombre: activate to sort column ascending">
                                                                            Nombre
                                                                        </td>
                                                                        <td style="font-weight: bold; width: 28%; text-align: center" class="sorting" tabindex="0"
                                                                            rowspan="1" colspan="1" aria-label="Fecha Inicio: activate to sort column ascending">
                                                                            Url DINA
                                                                        </td>
                                                                        <td width="30%" style="font-weight: bold; width: 28%; text-align: center" class="sorting"
                                                                            tabindex="0" rowspan="1" colspan="1" aria-label="Tipo de Estudio: activate to sort column ascending">
                                                                            Rol
                                                                        </td>
                                                                        <td style="font-weight: bold; width: 4%; text-align: center" class="sorting" tabindex="0"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <textarea id="txtresumen" name="txtresumen" class="form-control" cols="100%" rows="3"
                                                                maxlength="8000" disabled="disabled"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <textarea id="txtjustificacion" name="txtjustificacion" class="form-control" cols="100%"
                                                                rows="3" maxlength="8000" disabled="disabled"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="table-responsive" style="font-size: 12px; font-weight: 300; line-height: 18px;">
                                                    <div id="Div6" class="dataTables_wrapper" role="grid">
                                                        <table id="tObjetivos" name="tObjetivos" class="display dataTable" width="100%">
                                                            <thead>
                                                                <tr role="row">
                                                                    <td style="font-weight: bold; width: 70%; text-align: center" class="sorting" tabindex="0"
                                                                        rowspan="1" colspan="1" aria-label="Nombre: activate to sort column ascending">
                                                                        Objetivo
                                                                    </td>
