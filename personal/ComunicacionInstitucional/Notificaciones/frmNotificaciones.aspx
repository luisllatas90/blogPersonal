<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmNotificaciones.aspx.vb" Inherits="sistema_Notificaciones_frmNotificaciones" %>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <label for="cmbClasificacionFiltro" class="col-sm-2 col-form-label form-control-sm">Clasificación:</label>
                                            <div class="col-sm-4">
                                                <asp:DropDownList ID="cmbClasificacionFiltro" runat="server" AutoPostBack="true" CssClass="form-control form-control-sm combo_filtro" data-live-search="true" AutoComplete="off"></asp:DropDownList>
                                            </div> 
                                        </div>                                        
                                        <hr/>
                                        <div class="row">
                        ...
                        <asp:UpdatePanel ID="udpLista" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                            <ContentTemplate>
                                <asp:GridView ID="grwLista" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="codigo_not"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="nombre_not" HeaderText="NOMBRE" ItemStyle-Width="30%" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="abreviatura_not" HeaderText="ABREVIATURA" ItemStyle-Width="10%" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="tipo" HeaderText="TIPO" ItemStyle-Width="10%" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="clasificacion" HeaderText="CLASIFICACIÓN" ItemStyle-Width="30%" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="version_not" HeaderText="VERSIÓN" ItemStyle-Width="10%" ItemStyle-Wrap="false" />
                        ...
                        <asp:UpdatePanel ID="udpRegistro" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                            <ContentTemplate>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <label for="cmbTipo" class="col-sm-1 col-form-label form-control-sm">Tipo:</label>
                                            <div class="col-sm-3">
                                            ...
                                            <label for="cmbClasificacion" class="col-sm-2 col-form-label form-control-sm">Clasificación:</label>
                                            <div class="col-sm-5">
                                                <asp:DropDownList ID="cmbClasificacion" runat="server" AutoPostBack="true" CssClass="form-control form-control-sm combo_filtro" data-live-search="true" AutoComplete="off"></asp:DropDownList>
                                            </div> 
                                        </div>
                                        <div class="row">
