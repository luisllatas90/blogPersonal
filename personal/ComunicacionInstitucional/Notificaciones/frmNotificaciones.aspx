<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmNotificaciones.aspx.vb"
    Inherits="sistema_Notificaciones_frmNotificaciones" %>
    ...
    <body>
        ...
        <form id="frmNotificaciones" runat="server">
            ...
            <div class="container-fluid">
                <div class="card div-title">
                    <div class="row title">CONFIGURACIÓN DE NOTIFICACIONES</div>
                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <label for="cmbTipoFiltro"
                                                    class="col-sm-2 col-form-label form-control-sm">Tipo:</label>
                                                <div class="col-sm-3">
                                                    <asp:DropDownList ID="cmbTipoFiltro" runat="server"
                                                        ...
                                                        <asp:ListItem Value="SMS">MENSAJE DE TEXTO</asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                                <label for="cmbClasificacionFiltro"
                                                    class="col-sm-2 col-form-label form-control-sm">Clasificación:</label>
                                                <div class="col-sm-4">
                                                    <asp:DropDownList ID="cmbClasificacionFiltro" runat="server"
                                                        AutoPostBack="true"
                                                        CssClass="form-control form-control-sm combo_filtro"
                                                        data-live-search="true" AutoComplete="off"></asp:DropDownList>
                                                </div>
                                            </div>
                                            <hr />
                                            <div class="row">
                            ...
                            <asp:UpdatePanel ID="udpLista" runat="server" UpdateMode="Conditional"
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="grwLista" runat="server" AutoGenerateColumns="false"
                                        ShowHeader="true" DataKeyNames="codigo_not" CssClass="display table table-sm"
                                        GridLines="None">
                                        <Columns>
                                            <asp:BoundField DataField="nombre_not" HeaderText="NOMBRE"
                                                ItemStyle-Width="30%" ItemStyle-Wrap="false" />
                                            <asp:BoundField DataField="abreviatura_not" HeaderText="ABREVIATURA"
                                            ...
                                            <asp:BoundField DataField="clasificacion" HeaderText="CLASIFICACIÓN"
                                                ItemStyle-Width="30%" ItemStyle-Wrap="false" />
                                            <asp:BoundField DataField="version_not" HeaderText="VERSIÓN"
                                                ItemStyle-Width="10%" ItemStyle-Wrap="false" />
                                            <asp:TemplateField HeaderText="OPE." ItemStyle-Width="10%"
                                                ItemStyle-Wrap="false">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="btnEliminar" runat="server"
                                                        CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>"
                                                        CommandName="Eliminar" CssClass="btn btn-danger btn-sm"
                    ...
                    <div class="tab-pane" id="registro" role="tabpanel" aria-labelledby="registro-tab">
                        <div class="panel-cabecera">
                            <asp:UpdatePanel ID="udpRegistro" runat="server" UpdateMode="Conditional"
                                ...
                                <ContentTemplate>
                                    <div class="card">
                                        <div class="card-header">Datos de la Notificación</div>
                                        <div class="card-body">
                                            <div class="row">
                                                <label for="cmbTipo"
                                                    class="col-sm-1 col-form-label form-control-sm">Tipo:</label>
                                                <div class="col-sm-3">
                                            ...
                                            <div class="row">
                                                <label for="txtNombre"
                                                    class="col-sm-1 col-form-label form-control-sm">Nombre:</label>
                                                <div class="col-sm-5">
                                                    <asp:TextBox ID="txtNombre" runat="server" MaxLength="300"
                                                        CssClass="form-control form-control-sm uppercase"
                                                        AutoComplete="off" />
                                                </div>
                                                <label for="txtAbreviatura"
                                                    class="col-sm-2 col-form-label form-control-sm">Abreviatura:</label>
                                                <div class="col-sm-3">
                                                    <asp:TextBox ID="txtAbreviatura" runat="server" MaxLength="300"
                                                        CssClass="form-control form-control-sm uppercase"
                                                        AutoComplete="off" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <label for="txtVersion"
                                                    class="col-sm-1 col-form-label form-control-sm">Versión:</label>
                                                <div class="col-sm-2">
                                                    <asp:TextBox ID="txtVersion" runat="server" MaxLength="100"
                                                        CssClass="form-control form-control-sm uppercase"
                                                        AutoComplete="off" />
                                                </div>
                                                <label for="cmbProfile"
                                                    class="col-sm-1 col-form-label form-control-sm">Profile:</label>
                                                <div class="col-sm-2">
                                                    <asp:DropDownList ID="cmbProfile" runat="server" AutoPostBack="true"
                                                        CssClass="form-control form-control-sm combo_filtro"
                                                        data-live-search="true" AutoComplete="off" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <label for="txtAsunto"
                                                    class="col-sm-1 col-form-label form-control-sm">Asunto:</label>
                                                <div class="col-sm-10">
                                                    <asp:TextBox ID="txtAsunto" runat="server" MaxLength="500"
                                                        CssClass="form-control form-control-sm uppercase"
                                                        AutoComplete="off" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <label for="divPlantilla"
                                                    class="col-sm-1 col-form-label form-control-sm">Cuerpo:</label>
                                                <div class="col-sm-10">
