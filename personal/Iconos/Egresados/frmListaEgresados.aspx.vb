...
Partial Class Egresado_frmListaEgresados
    ...
    Sub OcultarDatosActualizar(ByVal sw As Boolean)
        ...
        Me.lblCorreo.Visible = sw
        Me.txtCorreo.Visible = sw
        Me.txtTelefono.Visible = sw
        'Me.lblTelefono.Visible = sw
    ...
    Function CargarGrid() As Data.DataTable
        ...
        Me.lblMensajeFormulario.Text = "Nivel:" & Me.ddlNivel.SelectedItem.Text & " Escuela: " & Me.ddlEscuela.SelectedItem.Text
            ...
            For i As Integer = 0 To Me.gvwEgresados.Rows.Count - 1
                ...
                If (valor = True) Then
                    If Me.gvwEgresados.DataKeys(i).Values(4).ToString = "SI" Then
                        ...
                        Me.lblMensajeFormulario.Text = cls.EnviarMailAd("alumni@usat.edu.pe", "", "esaavedra@usat.edu.pe", Me.txtAsunto.Text.Trim, Mensaje, True, "", "alumni@usat.edu.pe", strRuta, Me.FileUpload1.FileName)
                    Else
        ...
        If (validaCheckActivo() = True) Then
            ...
            For i As Integer = 0 To Me.gvwEgresados.Rows.Count - 1
                ...
                If (valor = True) Then
                    ...
                    Me.txtCorreo.Text = Me.gvwEgresados.DataKeys(i).Values("EMAIL")
                    Me.txtTelefono.Text = Me.gvwEgresados.DataKeys(i).Values("TELEFONO")
    ...
    Protected Sub btnActualizarDatos_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnActualizarDatos.Click
        ...
        If psotoupdate.Value > 0 Then
            ...
            obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
            obj.AbrirConexion()
            obj.Ejecutar("alumni_actualizaremailtelefono", psotoupdate.Value, Me.txtCorreo.Text.Trim, Me.txtTelefono.Text.Trim)
            obj.CerrarConexion()
            obj = Nothing
            Me.txtEgresado.Text = ""
            Me.txtCorreo.Text = ""
    ...
    Protected Sub ddlNivel_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlNivel.SelectedIndexChanged
        If Me.ddlNivel.SelectedIndex > -1 Then
            ...
            obj.CerrarConexion()
            obj = Nothing
            Me.lblMensajeFormulario.Text = Me.ddlNivel.SelectedItem.Text
        End If        
    End Sub
End Class