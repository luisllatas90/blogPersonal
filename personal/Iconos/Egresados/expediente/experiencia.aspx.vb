...
Partial Class experiencia
    ...
    Private Sub GuardarExperiencia()
        ...
        Try
            ...
            Else
                valor = ObjPersonal.Modificarexperiencia(intcargo, strFuncion, FechaIni, FechaFin, strDescripcion, intContrato, strCese, strCiudad, strEmpresa, Me.HddExperiencia.Value)
            End If
    ...
    Private Sub GuardarEvento()
        ...
        Try
            ...
            If valor = -1 Then
                ...
                scriptMsg = "<script>alert('Ocurio un error al insertar los datos, intentelo nuevamente')</script>"
