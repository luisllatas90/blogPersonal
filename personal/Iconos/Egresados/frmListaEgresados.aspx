<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmListaEgresados.aspx.vb" Inherits="Egresado_frmListaEgresados" %>
...
<body>
    ...
    <table width="100%">
     ...
     <br />   <br />   
            ...
            PageSize="15" CellPadding="4" ForeColor="#333333" Font-Size="Smaller">
        <Columns>
    ...
    <table cellspacing="0" width="85%"  style="width: 85%; border-color: #0099FF; border-bottom-width: 1px; 
        ...
        <tr>
            <td class="style8">                           
                <asp:Label ID="lblCorreo" runat="server" Text="Correo Personal:"></asp:Label></td>
            <td class="style9">
                <asp:TextBox ID="txtCorreo" runat="server" Width="80%"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style8">                           
                <asp:Label ID="lblCorreoProfesional" runat="server" Text="Correo Profesional:"></asp:Label></td>
            <td class="style9">
                <asp:TextBox ID="txtCorreo0" runat="server" Width="80%"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style10">                           
            ...
            <td >
                <asp:TextBox ID="txtTelefono" runat="server" Width="20%"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style10">                           
            ...
            <td >
                <asp:TextBox ID="txtTelefono0" runat="server" Width="20%"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style10">                           
            ...
            <td >
                <asp:TextBox ID="txtTelefono1" runat="server" Width="20%"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td colspan="2" align="right">
    ...
    <asp:GridView ID="gvExporta" runat="server" CellPadding="4" ForeColor="#333333" 
        AutoGenerateColumns="False" GridLines="both"  Font-Size="Smaller">
           ...
           <Columns>
            ...
            <asp:BoundField DataField="CORREO" HeaderText="CORREO PROFESIONAL" >
                    <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>            
            <asp:BoundField DataField="APELLIDOS" HeaderText="APELLIDOS" />
            <asp:BoundField DataField="NOMBRES" HeaderText="NOMBRES" />           
