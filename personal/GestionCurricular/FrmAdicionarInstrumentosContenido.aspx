                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <asp:GridView ID="gvResultados" runat="server" AutoGenerateColumns="false" ShowHeader="true"
                            DataKeyNames="codigo_dis, codigo_uni, unidad, codigo_gru, total_ses, numero_uni"
                            CssClass="table table-sm table-striped table-bordered table-condensed">
                            <Columns>
                                <asp:BoundField HtmlEncode="false" DataField="contenido" HeaderText="Contenido" HeaderStyle-Width="30%"
                                    ItemStyle-Width="30%" FooterStyle-Width="30%" />
                                <asp:BoundField HtmlEncode="false" DataField="actividad" HeaderText="Actividad" HeaderStyle-Width="30%"
                                    ItemStyle-Width="30%" FooterStyle-Width="30%" />
                                ...
                                <asp:BoundField HtmlEncode="false" DataField="instrumento" HeaderText="Instrumentos"
                                    HeaderStyle-Width="29%" ItemStyle-Width="29%" FooterStyle-Width="29%" />
