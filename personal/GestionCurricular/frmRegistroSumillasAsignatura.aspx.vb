...
Partial Class GestionCurricular_frmRegistroSumillasAsignatura
...
#Region "Eventos"
    ...
    Protected Sub btnGrabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        ...
        Try
            ...
            If Not String.IsNullOrEmpty(Session("gc_codigo_sum")) And Session("gc_codigo_sum") <> "-1" Then
    ...
    '            Dim _codigo_pes As Integer = Me.gvAsignatura.DataKeys(e.Row.RowIndex).Values.Item("codigo_pes")
    '            Dim _trasversal As Boolean = Me.gvAsignatura.DataKeys(e.Row.RowIndex).Values.Item("transversal")
    '            Dim _btnAdm As LinkButton = CType(e.Row.Cells(e.Row.RowIndex).FindControl("btnEditar"), LinkButton)

    '            If _trasversal Then

    '                If _codigo_pes <> -2 Then
    '                    _btnAdm.Enabled = False
    '                    _btnAdm.OnClientClick = ""
    '                End If
...
#Region "Metodos"
    ...
    '            gvAsignatura_RowDataBound(Me.gvAsignatura, New GridViewRowEventArgs(_Row))
    '        Next
    '    Catch ex As Exception
    '        Throw ex
    '    End Try
