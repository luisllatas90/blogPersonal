...
#Region "Eventos"
    ...
    Protected Sub cboCarProf_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboCarProf.SelectedIndexChanged
        Try
            ...
            If Not (Me.cboCarProf.SelectedValue = -1 Or Me.cboCarProf.SelectedValue = -2) Then cboPlanCurr_SelectedIndexChanged(Nothing, Nothing)
            If Me.cboCarProf.SelectedValue = -1 Or Me.cboCarProf.SelectedValue = -2 Then
...
#Region "Metodos"
    ...
    Private Sub mt_CargarCarreraProfesional()
        ...
        Try
            ...
            For i As Integer = 0 To cboCarProf.Items.Count - 1
                If cboCarProf.Items(i).Value.ToString.Equals("-2") Then cboCarProf.Items.RemoveAt(i)
            Next
        Catch ex As Exception
            Throw ex
        End Try
