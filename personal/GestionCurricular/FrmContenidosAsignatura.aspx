...
<head id="Head1" runat="server">
    ...
    <title>Diseñar sesiones (contenidos y actividades)</title>
                    ...
                    <div class="col-md-10">
                        <h4>
                            <label id="lblCurso" runat="server">
                                Diseñar sesiones (contenidos y actividades)</label></h4>
                    </div>
                    <div class="col-md-1">
            ...
            <div class="panel panel-body">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="row" style="margin-top: 5px">
                            <div class="form-group">
                                <label id="lblAsignatura" runat="server" class="col-md-3">
                                    Diseño:</label>
                                <div class="col-md-9">
                        ...
                        <div class="row" style="margin-top: 5px; margin-bottom: 5px">
                            ...
                            <div class="col-xs-9">
                                <asp:LinkButton ID="btnAgregarGrupo" runat="server" Text='<i class="fa fa-plus"></i> Agregar Sesión'
                                    CssClass="btn btn-success"></asp:LinkButton>
                                <asp:LinkButton ID="btnCombinar" runat="server" Text='<i class="fa fa-compress"></i> Unir Grupos'
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <table class="col-xs-11" style="margin-left: 10px; border: 1px solid #ffe4e4;">
                                <tbody>
                                    <tr style="border: 1px solid #ffe4e4;">
                                        <td style="border: 1px solid #ffe4e4;">
                                            Número de grupos horarios
                                        </td>
                                        <td>
                                            <label id="lblTotalGrupos" runat="server" class="col-md-6" style="font-size: smaller;
                                                width: 100%;">
                                                0</label>
                                        </td>
                                    </tr>
                                    <tr style="border: 1px solid #ffe4e4;">
                                        <td style="border: 1px solid #ffe4e4;">
                                            Grupo horario con menor n° fechas de clase
                                        </td>
                                        <td>
                                            <label id="lblGrupoMenor" runat="server" class="col-md-6" style="font-size: smaller;
                                                width: 100%;">
                                            </label>
                                        </td>
                                    </tr>
                                    <tr style="border: 1px solid #ffe4e4;">
                                        <td style="border: 1px solid #ffe4e4;">
                                            N° mínimo de fechas de clase
                                        </td>
                                        <td>
                                            <label id="lblMinimoClases" runat="server" class="col-md-6" style="font-size: smaller;
                                                width: 100%;">
                                                0</label>
                                        </td>
                                    </tr>
                                    <tr style="border: 1px solid #ffe4e4;">
                                        <td style="border: 1px solid #ffe4e4;">
                                            Grupo horario con mayor n° fechas de clase
                                        </td>
                                        <td>
                                            <label id="lblGrupoMayor" runat="server" class="col-md-6" style="font-size: smaller;
                                                width: 100%;">
                                            </label>
                                        </td>
                                    </tr>
                                    <tr style="border: 1px solid #ffe4e4;">
                                        <td style="border: 1px solid #ffe4e4;">
                                            N° mayor de fechas de clases
                                        </td>
                                        <td>
                                            <label id="lblMaximoClases" runat="server" class="col-md-6" style="font-size: smaller;
                                                width: 100%;">
                                                0</label>
                                        </td>
                                    </tr>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvResultados" runat="server" Width="99%" AutoGenerateColumns="false"
                            ShowHeader="true" DataKeyNames="codigo_dis, codigo_uni, unidad, codigo_gru, total_ses, codigo_ses, sesion"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center"
                                    HeaderText="Agr." HeaderStyle-Width="3%">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkCombinar" runat="server" Text='<%# Eval("grupo") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Left"
                                    HeaderText="Sesión" HeaderStyle-Width="8%">
                                    <ItemTemplate>
                                        <!-- <asp:Label ID="lblSesion" runat="server" Text='<%# Eval("sesion") %>' ></asp:Label> -->
                                        <asp:CheckBox ID="chkSesion" runat="server" Text='<%# Eval("sesion") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField HtmlEncode="false" DataField="contenido" HeaderText="Contenido" HeaderStyle-Width="37%"
                                    ItemStyle-VerticalAlign="Middle" />
                                <asp:BoundField HtmlEncode="false" DataField="actividad" HeaderText="Actividades"
                                    HeaderStyle-Width="37%" ItemStyle-VerticalAlign="Middle" />
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Editar" HeaderStyle-Width="5%">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnEditarGrupo" runat="server" ToolTip="Editar" Text='<i class="fa fa-edit"></i><span>'
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Acción" HeaderStyle-Width="5%">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnUnir" runat="server" ToolTip="Unir Sesiones" Text='<i class="fa fa-compress"></i>'
                                            CommandName="Combinar" CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>"
                                            CssClass="btn btn-info btn-sm" OnClientClick="return confirm('¿Seguro de combinar las sesiones?');"
                                            Visible='<%# IIF(Eval("total_ses")>1,"true","false") %>'></asp:LinkButton>
                                        <br />
                                        <asp:LinkButton ID="btnDesunir" runat="server" ToolTip="Desunir Sesiones" Text='<i class="fa fa-expand"></i>'
                                            CommandName="Descombinar" CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>"
                                            CssClass="btn btn-warning btn-sm" OnClientClick="return confirm('¿Seguro de descombinar las sesiones?');"
                                            Visible='<%# IIF(Eval("total_com")>0,"true","false") %>'></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
                                        ...
                                        <asp:UpdatePanel ID="udpSesion" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                                            <ContentTemplate>
                                                <asp:GridView ID="gvSesion" runat="server" AutoGenerateColumns="False" CssClass="table table-sm table-bordered table-hover"
                                                    ...
                                                    DataKeyNames="codigo,sesion,codigo_ses,descripcion" ShowFooter="False" ShowHeader="True">
                                                    <Columns>
                                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="#" HeaderStyle-Width="5%">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:BoundField DataField="codigo" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center"
                                                            HeaderText="Sesión" HeaderStyle-Width="0%" ItemStyle-Width="0%" FooterStyle-Width="0%"
                                                            ReadOnly="true" Visible="false" />
                                                        <asp:TemplateField HeaderText="Descripción de la Sesión" HeaderStyle-Width="82%"
                                                            ItemStyle-Width="82%" FooterStyle-Width="82%">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:BoundField DataField="unidad" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center"
                                                            HeaderText="Unidad" HeaderStyle-Width="0%" ItemStyle-Width="0%" FooterStyle-Width="0%"
                                                            ReadOnly="true" Visible="false" />
                                                        <asp:TemplateField HeaderText="Acción" HeaderStyle-Width="13%" ItemStyle-Width="13%"
    ...
    <script type="text/javascript">
        ...
        Sys.WebForms.PageRequestManager.getInstance().add_endRequest(function(sender, args) {
            ...
            if (controlId == 'btnValidar') {
                ...
                // 2019-07-25: Auto ajustar al alto del contenedor
                if (controlId.indexOf("LinkButton2") > -1 || controlId.indexOf("LinkButton5") > -1) {
                    $('#tabs').smartTab('adjustHeight', $("#tabs a.sel").attr("href"));
                }
            }
        });
    </script>
