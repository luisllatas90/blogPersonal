...
<head runat="server">
    ...
    <title>Diseño de Asignatura</title>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#btnGuardar2').click(function() {
                var rb1l = document.getElementById('<%= rb1.ClientID %>').checked
                var rb12 = document.getElementById('<%= rb2.ClientID %>').checked
                if (rb1l) {
                    var cbo1 = document.getElementById('<%=cboDiseño.ClientID%>');
                    if (cbo1.selectedIndex < 1) {
                        alert('¡ Seleccione Diseño !');
                        cbo1.focus();
                        return false;
                    }
                }
                if (rb12) {
                    var cbo2 = document.getElementById('<%=cboDiseño2.ClientID%>');
        ...
        function openModal(modal_ord, title) {
            if (modal_ord == '1') {
                $('#myModal').modal('show');
            }
            else {
        ...
        function FileSelected(fu) {
            ...
            if (fn !== "") {
                ...
                $("#hf").val("1");
                $("#spnFile").text(fn);
                $("#btnQuitarAnexo").css('visibility', 'hidden');
            } else {
                $("#hf").val("0");
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <asp:GridView ID="gvAsignatura" runat="server" AutoGenerateColumns="false" ShowHeader="true"
                                AllowPaging="True" PageSize="20" DataKeyNames="codigo_cur, codigo_pes, nombre_Cur, codigo_dis, estado_dis, codigo_cup, IdArchivo_Anexo, observacion, control_dis, modular_pcu"
                                OnRowCreated="gvAsignatura_OnRowCreated" OnRowDataBound="gvAsignatura_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Acción">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnAgregarDA" runat="server" CommandName="FrmResultadoAprendizaje"
                                                ...
                                                Visible='<%# IIF(Eval("tieneCronograma") = 0, IIF(Request.QueryString("ctf") = "1", True, False), IIF(Eval("estado_dis") = "P", True, IIF(Eval("control_dis") = 1, True, False)))  %>'
                                                OnClientClick="return confirm('¿Desea ir a Registro de Unidades de Asignatura?');">
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Acción">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnAgregarCE" runat="server" CommandName="frmCriteriosEvaluacion"
                                                ...
                                                Visible='<%# IIF(Eval("tieneCronograma") = 0, False, IIf(Eval("unidad") > 0 AND Eval("estado_dis") = "P", True, False)) %>'
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Anexos">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnSubir" runat="server" CommandName="Subir" CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>"
                                                CssClass="btn btn-primary btn-sm" Visible='<%# IIF(Eval("tieneCronograma") = 0, False, IIF(Eval("codigo_dis")<>-1 and (Eval("estado_dis")="P" or Eval("estado_dis")="O" or Eval("control_dis")=1), True, False)) %>'
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Importar">
                                        <ItemTemplate>
                        ...
                        <ContentTemplate>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="col-md-1">
                                            <asp:RadioButton ID="rb1" runat="server" OnCheckedChanged="rb1_CheckedChanged" AutoPostBack="true" />
                                        </div>
                                        <label class="col-md-4" for="rb1">
                                            Diseño de Semestres Anteriores:</label>
                                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="col-md-1">
                                            <asp:RadioButton ID="rb2" runat="server" OnCheckedChanged="rb2_CheckedChanged" AutoPostBack="true" />
                                        </div>
                                        <label class="col-md-4" for="rb2">
                                            Diseño Aprobado en la Facultad:</label>
                                        <div class="col-md-6">
                                            <asp:DropDownList ID="cboDiseño2" runat="server" CssClass="form-control input-sm"
                                                AutoPostBack="true">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content" id="Div3">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">
                        &times;</button>
                    <h4 class="modal-title" id="lblTituloAnexo">
                        Subir Anexos</h4>
                </div>
                <div class="modal-body">
                    <asp:UpdatePanel ID="updFileUpload" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                        <ContentTemplate>
                            <div class="row">
                                ...
                                <div class="col-md-9 col-xs-10 form-group">
                                ...
                                <div class="col-md-1">
                                    <asp:LinkButton ID="btnQuitarAnexo" runat="server" CssClass="btn btn-danger btn-sm"
                                        Text="<i class='fa fa-trash'></i>" ToolTip="Quitar Anexo adjunto"></asp:LinkButton>
                                </div>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
