...
#Region "Declaracion de Variables"
    ...
    Private codigo_dis As Integer = 0
...
#Region "Eventos"
    ...
    Protected Sub OnEditUnidad(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            Dim orden_uni As String = gvResultado.DataKeys(row.RowIndex).Item("orden_uni").ToString
            ...
            Else
                ...
                Me.ddlUnidad.SelectedValue = orden_uni
            ...
            If Not (IsDBNull(Session("perlogin"))) And Session("perlogin").ToString <> "" Then
                ...
                If flag Then
                    ...
                    For i As Integer = 0 To dtElim.Rows.Count - 1
                        ...
                        dt = obj.TraerDataTable("COM_EliminarResultados", codigo_res, cod_user)
                    Next
...
#Region "Metodos"
    ...
    Private Sub mt_CargarCarreraProf()
        ...
        Try
            obj.AbrirConexion()
            'Comentar deben listar todas las carreras, hace falta cambio para no mostrar el combobox en cada form del diseño. Por Luis Q.T | 19DIC2019
    ...
    Private Sub mt_CargarDatos(ByVal codigo_cac As Integer, ByVal codigo_pes As Integer, ByVal codigo_cur As Integer)
        ...
        Try
            obj.AbrirConexion()
            'mt_ShowMessage(codigo_cac & " - " & codigo_pes & " - " & codigo_cur, MessageType.Warning)
            ...
            'mt_ShowMessage(Session("gc_codigo_cac") & " - " & Session("gc_codigo_pes") & " - " & Session("gc_codigo_cur"), MessageType.Warning)
            'mt_ShowMessage(Me.gvResultado.Rows.Count, MessageType.Warning)
