            ...
            <div class="panel panel-body">
                ...
                <div id="tabs" runat="server">
                    <ul>
                        ...
                        <li id="liNormas" runat="server"><a href="#tabs-4"><small><b>NORMAS</b></small> </a>
                        </li>
                    </ul>
                                        ...
                                        <div class="messagealert" id="divAlertModal" runat="server" visible="false">
                                            <div id="alert_div_modal" style="margin: 0 0.5%; -webkit-box-shadow: 3px 4px 6px #999;"
                                                ...
                                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> <span
                                                    id="lblMensaje" runat="server"><i style="color: #c75c5c"><span class="fa fa-exclamation-triangle">
                                                    </span></i>&nbsp;Se recomienda que la última semana de clases también sea seleccionada.</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <asp:GridView ID="gvNivelLogro" runat="server" AutoGenerateColumns="false" GridLines="None"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Nombre del Rango" HeaderStyle-Width="16%" ItemStyle-Width="16%"
                                            ...
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtNewNombre" runat="server" CssClass="form-control input-sm" Style="text-transform: uppercase"></asp:TextBox>
                                            </FooterTemplate>
                                            <ItemStyle Wrap="True" />
                                        </asp:TemplateField>
                    ...
                    <asp:UpdatePanel ID="updNorma" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                        <ContentTemplate>
                            <div id="tabs-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-md-3">
                                                Semestre:</label>
                                            <div class="col-md-4">
                                                <asp:DropDownList ID="cboSemestre2" runat="server" CssClass="form-control input-sm"
                                                    AutoPostBack="true">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <asp:GridView ID="gvNorma" runat="server" AutoGenerateColumns="false" GridLines="None"
                                            OnRowEditing="gvNorma_RowEditing" ShowHeadersWhenNoRecords="True" DataKeyNames="codigo_nor, descripcion_nor"
                                            CssClass="table table-sm table-bordered table-hover" ShowFooter="True" ShowHeader="True">
                                            <Columns>
                                                <asp:TemplateField HeaderText="Descripción de la Norma" HeaderStyle-Width="88%" ItemStyle-Width="88%"
                                                    FooterStyle-Width="88%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDescripcion2" runat="server" Text='<%#Eval("descripcion_nor")%>'></asp:Label>
                                                    </ItemTemplate>
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="txtDescripcion2" runat="server" CssClass="form-control input-sm"
                                                            Text='<%#Eval("descripcion_nor")%>' Rows="3" TextMode="MultiLine"></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <FooterTemplate>
                                                        <asp:TextBox ID="txtNewDescripcion2" runat="server" CssClass="form-control input-sm"
                                                            Rows="3" TextMode="MultiLine"></asp:TextBox>
                                                    </FooterTemplate>
                                                    <ItemStyle Wrap="True" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Acción" HeaderStyle-Width="12%" ItemStyle-Width="12%"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="LinkButton1" Text='<i class="fa fa-pen"></i>' ToolTip="Editar"
                                                            runat="server" CommandName="Edit" CssClass="btn btn-primary btn-sm" />
                                                        <span onclick="return confirm('¿Está seguro de eliminar esta Norma?')">
                                                            <asp:LinkButton ID="LinkButton2" Text='<i class="fa fa-trash"></i>' ToolTip="Eliminar"
                                                                runat="server" OnClick="OnDeleteNorma" CssClass="btn btn-danger btn-sm" />
                                                        </span>
                                                    </ItemTemplate>
                                                    <EditItemTemplate>
                                                        <asp:LinkButton ID="LinkButton3" Text='<i class="fa fa-save"></i>' ToolTip="Actualizar"
                                                            runat="server" OnClick="OnUpdateNorma" CssClass="btn btn-success btn-sm" />
                                                        <asp:LinkButton ID="LinkButton4" Text='<i class="fa fa-times"></i>' ToolTip="Cancelar"
                                                            runat="server" OnClick="OnCancelNorma" CssClass="btn btn-info btn-sm" />
                                                    </EditItemTemplate>
                                                    <FooterTemplate>
                                                        <asp:LinkButton ID="LinkButton5" Text='<i class="fa fa-plus"></i>' ToolTip="Agregar"
                                                            runat="server" CommandName="New" OnClick="OnNewNorma" CssClass="btn btn-success btn-sm" />
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                            <EmptyDataTemplate>
