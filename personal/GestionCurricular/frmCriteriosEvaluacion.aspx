                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="gvResultados" runat="server" Width="99%" AutoGenerateColumns="false"
                                ShowHeader="true" OnRowCreated="gvResultados_OnRowCreated" 
                                DataKeyNames="codigo_dis,codigo_uni,codigo_res,descripcion_res,peso_res,codigo_ind,descripcion_ind,peso_ind,codigo_indEvi,codigo_evi,descripcion_evi,codigo_eviIns,codigo_ins,descripcion_ins,peso_ins,tipo_prom,tipo_prom2,orden_ind,orden_res"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Acción" HeaderStyle-Width="8%">
                                        <ItemTemplate>
                                            ...
                                            <br />
                                            <asp:LinkButton ID="btnSubirInd" runat="server" CommandName="UpIndicador"
                                                CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>" CssClass="btn btn-info btn-sm"
                                                Visible='<%# IIf(Eval("codigo_ind")>-1,True,False) %>' OnClientClick="return confirm('¿Desea subir el indicador?');">
                                                <span><i class="fa fa-chevron-circle-up"></i></span>
                                            </asp:LinkButton>
                                            <asp:LinkButton ID="btnBajarInd" runat="server" CommandName="DownIndicador"
                                                CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>" CssClass="btn btn-info btn-sm"
                                                Visible='<%# IIf(Eval("codigo_ind")>-1,True,False) %>' OnClientClick="return confirm('¿Desea bajar el indicador?');">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <asp:TextBox ID="txtPorcentaje" runat="server" CssClass="form-control input-sm" placeholder="00"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="col-md-8">
                                    <asp:CheckBox id="chkVarios" runat="server" Text=" Registrar en todos los indicadores"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <asp:TextBox ID="txtPorcenIns" runat="server" CssClass="form-control input-sm" placeholder="00"
                                        onkeypress="return soloNumeros(event)"></asp:TextBox>
                                </div>
                            </div>
                        </div>
