<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEstrategiasDidactica.aspx.vb"
    Inherits="GestionCurricular_frmEstrategiasDidactica" EnableEventValidation="false" %>
...
<body>
                    ...
                    <div class="col-md-10">
                        <h4>
                            <label id="lblCurso" runat="server">
                                Registrar Estrategias Didácticas</label></h4>
                    </div>
                    <div class="col-md-1">
            ...
            <div class="panel panel-body">
                ...
                <div class="row">
                    <div class="col-xs-2">
                        ...
                        <asp:LinkButton ID="btnAgregar" runat="server" Text="Agregar" CssClass="btn btn-success">
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gvEstrategia" runat="server" Width="99%" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="descripcion_dis" HeaderText="Estrategia Didáctica" />
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Acciones" HeaderStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnEditar" runat="server" OnClick="btnEditar_Click" CommandName="Editar"
                                                ...
                                                OnClientClick="return confirm('¿Desea editar esta Estrategia Didáctica?');">
                                            ...
                                            <asp:LinkButton ID="btnEliminar" runat="server" CommandName="Eliminar" CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>"
                                                CssClass="btn btn-danger btn-sm" OnClientClick="return confirm('¿Desea eliminar esta Estrategia Didáctica?');">
    ...
    <!-- Modal Registro de Estrategias Didactica -->
            ...
            <div class="modal-content" id="modalFinalizaBody">
                <div class="modal-header" style="background-color: #E33439; color: White; font-weight: bold;">
                    ...
                    <h4 class="modal-title">
                        Registro de Estrategias Didácticas</h4>
                </div>
