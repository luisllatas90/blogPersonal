...
#Region "Eventos"
                    ...
                    For i As Integer = 0 To dt.Rows.Count - 1
                        ...
                        If _codigo_dma <> -1 Then
                            ...
                            If _codigo_emd = -1 Then
                                lbl.Text = fc_getNota(_codigo_dma, _codigo_ins, _codigo_cup)
                            Else
                                Dim aux As String = "0"
                            ...
                            '    _nota = fc_getNota(_codigo_dma, _codigo_ins)
    ...
    Protected Sub gvNotas_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvNotas.RowDataBound
        Try
            ...
            _inhabilitado = Me.gvNotas.DataKeys(e.Row.RowIndex).Values("inhabilitado_dma")
...
#Region "Metodos"
    ...
    Private Sub mt_CargarNotas(ByVal codigo_cup As Integer)
        ...
        Try
            obj.AbrirConexion()
            dt = obj.TraerDataTable("DEA_NotasParciales_listar", "", -1, -1, "P", codigo_cup) 'Por Luis QT|04DIC2019: Uso 99 para obtener notas del último corte
