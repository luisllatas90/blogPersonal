<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmTipoRequisitoEgreso.aspx.vb"
    Inherits="GestionCurricular_frmTipoRequisitoEgreso" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <title>Registrar Tipo de Requisito de Egreso</title>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default" id="pnlLista" runat="server">
            <div class="panel panel-heading">
                <h4>
                    Registrar Tipo de Requisito de Egreso</h4>
            </div>
            <div class="panel panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvTipoRequisitoEgreso" runat="server" Width="99%" AutoGenerateColumns="false"
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Operaciones">
                                    <ItemTemplate>
                                        <asp:Button ID="btnEditar" runat="server" Text="Editar" OnClick="btnEditar_Click"
                                            ...
                                            CssClass="btn btn-warning btn-sm" OnClientClick="return confirm('¿Desea editar este Tipo Requisito de Egreso?');" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
                                No se encontraron tipo de requisitos de egreso
                            </EmptyDataTemplate>
