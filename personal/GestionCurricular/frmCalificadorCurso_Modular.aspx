<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCalificadorCurso_Modular.aspx.vb"
    Inherits="GestionCurricular_frmCalificadorCurso_Modular" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <title>Calificador Asignatura - Modular</title>
        ...
        <div class="panel panel-default" id="pnlLista" runat="server">
            <div class="panel panel-heading">
                <div class="row">
                    ...
                    <div class="col-md-11">
                        <div class="row">
                            <div class="col-md-7" style="border-right: 1px solid #d6d2d2;">
            ...
            <div class="panel panel-body">
                <div class="row">
                    <div class="col-md-3" style="text-align: left;">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label id="lblGrupo" runat="server" class="col-md-4">
                                        Grupo:</label>
                                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <asp:LinkButton ID="btnEnviar" runat="server" CssClass="btn btn-success" Text='<i class="fa fa-lock"></i>Confirmar Calificaciones' />
                    ...
                    <div class="col-md-3" id="divEnviar" runat="server" style="display: none">
                        <div class="row">
