                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gvAsignatura" runat="server" AutoGenerateColumns="false" ShowHeader="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="identificador_Cur" HeaderText="Código" ItemStyle-Width="13%"
                                        HeaderStyle-Width="13%" />
                                    <asp:BoundField DataField="nombre_Cur" HeaderText="Asignatura" ItemStyle-Width="50%"
                                        HeaderStyle-Width="50%" />
                                    <asp:BoundField DataField="grupoHor_Cup" HeaderText="Grupo" ItemStyle-Width="5%"
                                        HeaderStyle-Width="5%" />
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="¿Promedio final publicado?"
                                        ItemStyle-Width="20%" HeaderStyle-Width="20%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPublicado" runat="server" Text='<%# IIF(Eval("estadoNota_Cup") = "P", "", "Sí") %>'>
                                            </asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Autorizar" ItemStyle-Width="7%"
                                        HeaderStyle-Width="7%">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnSolicitar" runat="server" CommandName="Solicitar" CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>"
                                                ...
                                                Visible='<%# IIF(Eval("estadoNota_Cup") = "P", "true", "false") %>'>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <asp:GridView ID="gvEstudiantes" runat="server" AutoGenerateColumns="false" ShowHeader="true"
                                        DataKeyNames="codigo_Dma, nombre_Alu, codigo_nop, codigo_eva, codigo_cup, codigo_ins"
                                        CssClass="table table-bordered table-hover">
                                        <Columns>
