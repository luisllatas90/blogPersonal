<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmConformidadAccesos.aspx.vb" Inherits="DisenioPuestos_frmConformidadAccesos" %>
...
<body>
    ...
    <form id="frmConformidadAccesos" runat="server">
        ...
        <div class="container-fluid">
            <div class="card div-title">                        
                <div class="row title">CONFIRMACIÓN A ACCESO A MÓDULOS</div>
            </div>
