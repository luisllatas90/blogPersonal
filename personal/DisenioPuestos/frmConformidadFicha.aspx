<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmConformidadFicha.aspx.vb" Inherits="DisenioPuestos_frmConformidadFicha" %>
...
<body>
    ...
    <form id="frmConformidadFicha" runat="server">
        ...
        <div class="container-fluid">
            <div class="card div-title">                        
                <div class="row title">CONFIRMACIÓN A LA FICHA DE ANÁLISIS DE PUESTO</div>
            </div>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="grwLista" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="codigo_pue"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="DERIVAR" ItemStyle-Width="10%" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnDerivar" runat="server" 
                                                    CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>"
                                                    CommandName="Derivar" 
                                                    CssClass="btn btn-success btn-sm" 
                                                    ToolTip="Derivar Ficha De Análisis De Puesto"
                                                    OnClientClick="return alertConfirm(this, event, '¿Desea derivar la ficha de análisis de puesto seleccionado?', 'warning');">
                                                    <span><i class="fas fa-arrow-circle-right"></i></span>
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>                                    
