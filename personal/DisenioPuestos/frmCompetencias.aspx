<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCompetencias.aspx.vb" Inherits="DisenioPuestos_frmCompetencias" %>
...
<body>
    ...
    <form id="frmCompetencias" runat="server">
        ...
        <div class="container-fluid">
            <div class="card div-title">                        
                <div class="row title">MANTENIMIENTO DE COMPETENCIAS</div>
            </div>
                ...
                <div class="tab-pane show active" id="listado" role="tabpanel" aria-labelledby="listado-tab">
                        ...
                        <asp:UpdatePanel ID="udpFiltros" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                            <ContentTemplate>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <label for="cmbTipoFiltro" class="col-sm-2 col-form-label form-control-sm">Tipo de Competencia:</label>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <asp:LinkButton ID="btnNuevo" runat="server" CssClass="btn btn-accion btn-azul"                                                    
                                                    OnClientClick="return alertConfirm(this, event, '¿Desea registrar una nueva competencia?', 'warning');">
                    ...
                    <div class="table-responsive">
                        <asp:UpdatePanel ID="udpLista" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                            <ContentTemplate>
                                <asp:GridView ID="grwLista" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="codigo_com"
                ...
                <div class="tab-pane" id="registro" role="tabpanel" aria-labelledby="registro-tab">
                    <div class="panel-cabecera">
                        <asp:UpdatePanel ID="udpRegistro" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                            <ContentTemplate>
                                <div class="card">
                                    <div class="card-header">Datos de la Competencia</div>
                                    <div class="card-body">
                                        <div class="row">
                                            <label for="txtCompetencia" class="col-sm-2 col-form-label form-control-sm">Competencia:</label>
                                            <div class="col-sm-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <asp:TextBox ID="txtNombre" runat="server" MaxLength="300" CssClass="form-control form-control-sm uppercase" AutoComplete="off" TextMode="MultiLine" Rows="3"/>
                                            </div>                                         
                                        </div> 
                                        <div class="row">
                                            <label for="cmbClasificacion" class="col-sm-2 col-form-label form-control-sm">Grado de Competencia:</label>
                                            <div class="col-sm-3">
                                                <asp:DropDownList ID="cmbGra" runat="server" AutoPostBack="true" CssClass="form-control form-control-sm combo_filtro" data-live-search="true" AutoComplete="off">
                                                    <asp:ListItem Value="">[-- SELECCIONE --]</asp:ListItem>
                                                    <asp:ListItem Value="A">Grado A</asp:ListItem>
                                                    <asp:ListItem Value="B">Grado B</asp:ListItem>     
                                                    <asp:ListItem Value="C">Grado C</asp:ListItem>    
                                                    <asp:ListItem Value="D">Grado D</asp:ListItem>
                                                    <asp:ListItem Value="E">Grado E</asp:ListItem>                                           
                                                </asp:DropDownList>
                                            </div>
                                        </div>                                                                                
                                    </div>
