...
Partial Class DisenioPuestos_frmPerfilDocente
...
#Region "Eventos"
    ...
    Protected Sub btnNuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        Try
            Session("frmPerfilDocente-codigo_asig") = 0
    ...
    Protected Sub grwLista_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grwLista.RowCommand
        Try
            ...
            Session("frmPerfilDocente-codigo_asig") = Me.grwLista.DataKeys(index).Values("codigo_asig").ToString

            Select Case e.CommandName
                Case "Editar"
                    'If Not fu_ValidarCargarFormularioRegistro() Then Exit Sub

                    'If Not mt_CargarFormularioRegistro(CInt(Session("frmPerfilDocente-codigo_asig"))) Then Exit Sub
                ...
                Case "Eliminar"
                    ...
                    If Not mt_EliminarNotificacion(CInt(Session("frmPerfilDocente-codigo_asig"))) Then Exit Sub
    ...
    Protected Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        Try
            If mt_RegistrarNotificacion(CInt(Session("frmPerfilDocente-codigo_asig"))) Then
                Call btnListar_Click(Nothing, Nothing)
                Call mt_FlujoTabs("Listado")
                Exit Sub
            End If
...
#Region "Metodos"
    ...
    Private Sub mt_LimpiarVariablesSession()
        Try
            'Session("frmPerfilDocente-codigo_asig") = Nothing
        Catch ex As Exception
            Call mt_ShowMessage(ex.Message.Replace("'", " "), MessageType.error)
        End Try
    End Sub
    ...
    Private Sub mt_CargarDatos()
        Try
            ...
            dt.Columns.Add("codigo_asig")
            dt.Columns.Add("nombre_asig")
            dt.Columns.Add("codigo")
            dt.Columns.Add("ciclo_asig")

            Dim fila As Data.DataRow

            fila = dt.NewRow()
            fila("codigo_asig") = 1
            fila("nombre_asig") = "Cálculo Diferencial"
            fila("codigo") = "A0001"
            fila("ciclo_asig") = "I"
            dt.Rows.Add(fila)
            ...
            fila = dt.NewRow()
            fila("codigo_asig") = 3
            fila("nombre_asig") = "Cálculo Integral"
            fila("codigo") = "C0001"
            fila("ciclo_asig") = "III"
            dt.Rows.Add(fila)
    ...
    Private Function mt_CargarFormularioRegistro(ByVal codigo_asig As Integer) As Boolean
        Try
            'me_Notificacion = md_Notificacion.GetNotificacion(codigo_asig)

            'If me_Notificacion.codigo_asig = 0 Then mt_ShowMessage("El registro seleccionado no ha sido encontrado.", MessageType.warning) : Return False
    ...
    Private Function fu_ValidarCargarFormularioRegistro() As Boolean
        Try
            'If Session("frmPerfilDocente-codigo_asig") Is Nothing OrElse String.IsNullOrEmpty(Session("frmPerfilDocente-codigo_asig")) Then mt_ShowMessage("El código de notificación no ha sido encontrado.", MessageType.warning) : Return False
    ...
    Private Function mt_RegistrarNotificacion(ByVal codigo_asig As Integer) As Boolean
        Try
    ...
    Private Function fu_ValidarRegistrarNotificacion() As Boolean
        Try
            ...
            'If dt.Rows.Count > 0 AndAlso CInt(Session("frmPerfilDocente-codigo_asig")) = 0 Then mt_ShowMessage("Existe un registro con este tipo, clasificación, abreviatura y versión.", MessageType.warning) : Return False

            'For Each fila As DataRow In dt.Rows
            '    If CInt(Session("frmPerfilDocente-codigo_asig")) <> CInt(fila("codigo_asig")) Then mt_ShowMessage("Existe un registro con este tipo, clasificación, abreviatura y versión.", MessageType.warning) : Return False
            'Next
    ...
    Private Function mt_EliminarNotificacion(ByVal codigo_asig As Integer) As Boolean
        Try
            'me_Notificacion = md_Notificacion.GetNotificacion(codigo_asig)
