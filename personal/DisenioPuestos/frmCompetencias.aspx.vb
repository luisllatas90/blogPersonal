...
Partial Class DisenioPuestos_frmCompetencias
...
#Region "Eventos"
    ...
    Protected Sub btnNuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        Try
            Session("frmCompetencias-codigo_com") = 0
    ...
    Protected Sub grwLista_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grwLista.RowCommand
        Try
            ...
            Session("frmCompetencias-codigo_com") = Me.grwLista.DataKeys(index).Values("codigo_com").ToString

            Select Case e.CommandName
                Case "Editar"
                    'If Not fu_ValidarCargarFormularioRegistro() Then Exit Sub

                    'If Not mt_CargarFormularioRegistro(CInt(Session("frmCompetencias-codigo_com"))) Then Exit Sub
                ...
                Case "Eliminar"
                    ...
                    If Not mt_EliminarNotificacion(CInt(Session("frmCompetencias-codigo_com"))) Then Exit Sub
    ...
    Protected Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        Try
            If mt_RegistrarNotificacion(CInt(Session("frmCompetencias-codigo_com"))) Then
                Call btnListar_Click(Nothing, Nothing)
                Call mt_FlujoTabs("Listado")
                Exit Sub
            End If
...
#Region "Metodos"
    ...
    Private Sub mt_LimpiarVariablesSession()
        Try
            'Session("frmCompetencias-codigo_com") = Nothing
        Catch ex As Exception
            Call mt_ShowMessage(ex.Message.Replace("'", " "), MessageType.error)
        End Try
    End Sub
    ...
    Private Function mt_CargarFormularioRegistro(ByVal codigo_com As Integer) As Boolean
        Try
            'me_Notificacion = md_Notificacion.GetNotificacion(codigo_com)

            'If me_Notificacion.codigo_com = 0 Then mt_ShowMessage("El registro seleccionado no ha sido encontrado.", MessageType.warning) : Return False
    ...
    Private Function fu_ValidarCargarFormularioRegistro() As Boolean
        Try
            'If Session("frmCompetencias-codigo_com") Is Nothing OrElse String.IsNullOrEmpty(Session("frmCompetencias-codigo_com")) Then mt_ShowMessage("El código de notificación no ha sido encontrado.", MessageType.warning) : Return False
    ...
    Private Function mt_RegistrarNotificacion(ByVal codigo_com As Integer) As Boolean
        Try
    ...
    Private Function fu_ValidarRegistrarNotificacion() As Boolean
        Try
            ...
            'If dt.Rows.Count > 0 AndAlso CInt(Session("frmCompetencias-codigo_com")) = 0 Then mt_ShowMessage("Existe un registro con este tipo, clasificación, abreviatura y versión.", MessageType.warning) : Return False

            'For Each fila As DataRow In dt.Rows
            '    If CInt(Session("frmCompetencias-codigo_com")) <> CInt(fila("codigo_com")) Then mt_ShowMessage("Existe un registro con este tipo, clasificación, abreviatura y versión.", MessageType.warning) : Return False
            'Next
    ...
    Private Function mt_EliminarNotificacion(ByVal codigo_com As Integer) As Boolean
        Try
            'me_Notificacion = md_Notificacion.GetNotificacion(codigo_com)
