...
<table width="100%" height="98%" border="0" style="border-collapse: collapse" bordercolor="#111111" cellspacing="0" cellpadding="2">
   <tr><td colspan="2" width="100%" height="3%">
   		...
   		<td width="80%" height="3%" class="usattitulo">Consulta de Matrículas 
        por Escuela Profesional</td>
      	<td width="20%" height="3%" align="right">&nbsp;<%call botonExportar("../../../../","xls","rptematriculadosescuela","S","B")%></td>
      	</tr></table></td>
    </tr>
      <tr>
        <td width="20%" height="3%" class="etiqueta">Estado de Matrícula</td>
      	<td width="60%" height="3%">
        <select name="cboestado_mat" id="cboestado_mat" onChange="actualizarlista('consultartotalalumatrixcarrera.asp?codigo_cac=' + cbocodigo_cac.value + '&estado_mat=' + this.value + '&descripcion_cac=' + this.options[this.selectedIndex].text)" style="width: 100%">
      ...
      <tr>
        <td width="20%" height="3%" class="etiqueta">Ciclo Académico</td>
      	<td width="60%" height="3%"><%call ciclosAcademicos("actualizarlista('consultartotalalumatrixcarrera.asp?codigo_cac=' + this.value + '&estado_mat=' + cboestado_mat.value + '&descripcion_cac=' + this.options[this.selectedIndex].text)",codigo_cac,"S","")%></td>
    </tr>
    <%if codigo_cac<>"-2" then%>
    <tr><td width="40%" height="40%" colspan="2" valign="top">
        <%
        	Set obj=Server.CreateObject("PryUSAT.clsDatMatricula")
				Set rsMatriculados=obj.consultarNroAlumnosMatriculados("RS","CP",codigo_cac,estado_mat)
			Set Obj=nothing
		...
		ArrEncabezados=Array("Escuela Profesional",titulo & "(" & total & ")")
		ArrCampos=Array("nombre_cpf","matriculas")
		ArrCeldas=Array("70%","30%")
		ArrCamposEnvio=Array("codigo_cpf")
		pagina="lstalumnosmatriculados.asp?rpte=mat-esc&codigo_cac=" & codigo_cac & "&estado_mat=" & estado_mat
    ...
    <tr><td width="100%" height="48%" colspan="2" valign="top">
	    <span id="mensajedetalle" class="usatsugerencia">&nbsp; &nbsp;&nbsp;&nbsp;Elija la Escuela Profesional para visualizar los alumnos matriculados</span>
