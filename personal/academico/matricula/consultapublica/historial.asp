...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    ...
    <%if quitar="B" then%>
    <td width="43%" height="30" class="usattitulo" class="NoImprimir">
     <%call buscaralumno("matricula/consultapublica/historial.asp","../../")%>
    </td>
    <%end if
...
if modo="resultado" then
	...
	Set Obj=nothing
		...
		ElseIf (session("estadodeuda_alu")=1 and session("codigo_tfu")<>1 and session("codigo_tfu")<>25 and session("codigo_tfu")<>9 and session("codigo_tfu")<>26 and session("codigo_tfu")<>30 and session("codigo_tfu")<>35 and session("codigo_tfu")<>16 and session("codigo_tfu")<>27) then%>
				<script>
