...
Set objEscuela=Server.CreateObject("PryUSAT.clsAccesoDatos")
	objEscuela.AbrirConexion
		Set rsCursoProg= objEscuela.Consultar("ConsultarAlumnosMatriculados","FO",13,0,codigo_cac,0)
...
<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" <%=alto%>>
  <tbody class="style1">
  <tr class="usattitulo">
    <td width="100%" colspan="2" height="5%">Matriculados en cursos 
	complementarios</td>
  </tr>
  <tr>
    <td width="27%" height="3%">Ciclo Académico</td>
    <td width="73%" height="3%"><%call ciclosAcademicos("actualizarlista('totmatriculadoscurso.asp?codigo_cac='+this.value);mensaje.innerHTML='Espere un momento...'",codigo_cac,"","")%></td>
 </tr>
  <%if activo=true then%>
  <tr>
