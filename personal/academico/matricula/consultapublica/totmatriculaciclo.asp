...
if cicloing_alu="" then cicloing_alu=-1

Set obj = Server.CreateObject("PryUSAT.clsAccesoDatos")
	obj.AbrirConexion
	Set rsCiclo=Obj.Consultar("ConsultarCicloAcademico","FO","TO",0)
	Set rsIngresos=Obj.Consultar("ConsultarResumenMatriculados","FO",0,codigo_cac,0,0,0)
	set rsResumen=Obj.Consultar("ConsultarResumenMatriculados","FO",1,codigo_cac,cicloing_alu,0,0)
	obj.CerrarConexion
Set obj=nothing
%>
<html>
<head>
	...
	function AbrirEscuela(tipo,codigo_cpf,valor)
	{
			if (valor>0){
				...
				if (fila.tagName == "TR"){
					...
					var cicloing_alu=cbocicloing_alu.value
					
					var pagina="../academico/matricula/consultapublica/lstestudiantesresumen.asp??nombre_cpf=" + nombre_cpf + "&codigo_cpf=" + codigo_cpf + "&tipo=" + tipo + "&codigo_cac=" + codigo_cac + "&cicloing_alu=" + cicloing_alu
				}
			}
	...
	{
		window.location.href="../../../aplicacionweb2/cargando.asp?rutapagina=../academico/matricula/consultapublica/totmatriculaciclo.asp?codigo_cac="+ cbocodigo_cac.value + "&cicloing_alu=" + cbocicloing_alu.value
	}
...
<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    ...
    <td width="20%" align="right">Ciclos de Ingreso</td>
    <td width="15%" align="right">
    <%call llenarlista("cbocicloing_alu","",rsIngresos,"cicloIng_alu","cicloIng_alu",cicloing_alu,"","S","")%>
    </td>
    <td width="45%" align="right" class="NoImprimir">
