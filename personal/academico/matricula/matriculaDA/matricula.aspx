				...
				<div class='panel panel-piluku'>
					...
					<div class="row">
					        <div class="form-group">
						        <div class="col-sm-12">
							        <center>
							         <img src="assets/images/reglamento2020-0.png?yA=3" style="width:379px;height:101px;" />
							         </center>
                                   <br /><br />
					  ...
					  <div class="row">
                            ...
                            <div class="form-group">
							         <div class="col-sm-12" >		
                                        ...
                                        <label for='toggle-switcha'><span></span></label>]<font style="font-weight:bold;color:Black;">He leído la <a href="pdf/CartillaPensiones2020-I.pdf" target="_blank">Cartilla Informativa 2020</a></font>
														</center>	</p>
								                    </div>
						...
						<div class="row">
							<div class="col-md-12">
							    ...
							    <div id="divIdioma" runat="server"></div>
							      ...
							      <%--    <asp:HiddenField ID="tAlver" runat="server" />--%>
							          ...
							          <form class="form form-horizontal"  id="frmGrupos" method="post" enctype="multipart/form-data">
								           ...
								           <table class="display dataTable" id="tablagruposdisponibles" >
									        ...
									        <td colspan="5">
									        <b>Leyenda:</b> <br />
									        <ul  style="text-align:justify; font-size:xx-small" id="ulpeo" runat="server">
									        ...
									        <ul  style="text-align:justify; font-size:xx-small">
									         ...
									         <li><span style="text-decoration: underline;">Promedio ponderado</span> : Obtenido en el &uacute;ltimo semestre acad&eacute;mico regular.</li>
									        <li>Puedes realizar retiro de asignatura según cronograma.</li>
									         </ul>
											 <b>Reglamento:</b> <br />
									        <ul  style="text-align:justify; font-size:xx-small">
									         <li>Art.79(c)Se considera estudiante regular a aquel que se encuentra matriculado en un mínimo de 12 créditos por semestre.</li>
									         <li>Art.41 El estudiante que haya desaprobado dos veces una misma asignatura , solo podrá matricularse hasta en 15 créditos, incluyendo la o las asignaturas desaprobadas.</li>
											 <li>Art.11 Los estudiantes deberán acreditar el nivel A1 al iniciar el VII semestre de estudios, el nivel A2 al iniciar el
VIII semestre, y el nivel B1 al iniciar el IX semestre. Los niveles mencionados corresponden al Marco común
Europeo de Referencia para las Lenguas (MCERL).</li>
									         <li>Art.17 Para que una asignatura sea dictada se necesita un número no menor a  quince (15) estudiantes matriculados.</li>
									         </ul>
									         ...
									         <u><b>Ciclo de Referencia:</b></u> <b>Es el ciclo en la cual el estudiante debería encontrarse de acuerdo a su plan de estudios </b>y se calcula contando el número de semestres transcurridos desde la primera matrícula regular del estudiante en la escuela actual hasta la última matrícula regular.
									            ...
									            <p style="text-align:justify">
									            <ul>
									            <u><b>No Nivelados:</b></u>
									            <li></li>
									            <li></li>
									            <li></li>									            
									            </ul>
									            
                                                  <%--  <span style="font-size:11.0pt;font-family:&quot;Calibri&quot;,sans-serif;mso-fareast-font-family:Calibri;mso-fareast-theme-font:minor-latin;mso-bidi-font-family:&quot;Times New Roman&quot;;mso-ansi-language:ES-PE;mso-fareast-language:EN-US;mso-bidi-language:AR-SA">
                                                    Aquellos alumnos invictos en todos los semestres matriculados. &nbsp;(SÓLO 1 asignatura)</span>--%>
