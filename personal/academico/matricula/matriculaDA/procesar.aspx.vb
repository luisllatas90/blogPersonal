                ...
                Case 1  'Recuperar contraseña
                    ...
                    Try
                        ...
                        If (dt.Rows.Count > 0) Then
                            Email = dt.Rows(0).Item("eMail_Alu").ToString

                            If Email Is Nothing OrElse Email = "" Then
                                Email = dt.Rows(0).Item("email2_Alu").ToString
                            End If
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
                ...
                Try
                    ...
                    If Not dt Is Nothing AndAlso (dt.Rows.Count > 0) Then
                        ...
                        Else
                            ...
                            blnResultado = ObjMail.fnEnviarMailVariosCad("alumni@usat.edu.pe", "Alumni USAT", destino, Asunto, mensaje, True, "AlumniUSAT", "alumni@usat.edu.pe")
                            If (blnResultado = "OK") Then
                            ...
                            Else
                                dict.Add("email", "")
                                dict.Add("aviso", "")
                                'dict.Add("error", blnResultado.ToString)  ' Para ver error en console.log
                                dict.Add("respuesta", "ERROR")
                            End If
        ...
        Else
            ...
            ElseIf Request("param0") = "lsCMINV" Then  ' lista de cursos invitados PROFESIONALIZACION
                ...
                JSONresult = serializer.Serialize(list)
            ElseIf Request("param0") = "lsCurTut" Then  ' lista de cursos tutorial invitados 
                Dim list As New List(Of Dictionary(Of String, Object))()
                Dim serializer As System.Web.Script.Serialization.JavaScriptSerializer = New System.Web.Script.Serialization.JavaScriptSerializer()
                list = Session("lstCurTut")
                Session.Remove("lstCurTut")
                JSONresult = serializer.Serialize(list)
            ElseIf Request("param0") = "lsCurPen" Then  ' lista de cursos pendiente invitados 
                Dim list As New List(Of Dictionary(Of String, Object))()
                Dim serializer As System.Web.Script.Serialization.JavaScriptSerializer = New System.Web.Script.Serialization.JavaScriptSerializer()
                list = Session("lstCurPen")
                Session.Remove("lstCurPen")
                JSONresult = serializer.Serialize(list)
            ...
            ElseIf Request("param0") = "regCurRec" Then
                ...
                JSONresult = serializer.Serialize(list)
            ElseIf Request("param0") = "regCurTut" Then   ' Registrar si acepta o no el curso tutorial
                Dim olMat As New lMatricula
                Dim oeMat As New eMatricula
                Dim f As New lFunciones
                Dim values As ArrayList = f.ParamsValues(Request.Params, "param1")
                ...
                If Request("param2") = "1" Then
                    ...
                    dt = olMat.EjecutaProcesoCursoTutorial(oeMat)

                    If Not dt Is Nothing Then
                        dict.Add("R", "OK")
                        dict.Add("Mensaje", "ha confirmado su matricula para el curso tutorial " & curso.ToString.ToUpper)
                    Else
                        dict.Add("R", "CANCEL")
                        dict.Add("Mensaje", "Ocurrio un problema al confirmar la matricula, favor de volver intentar")
                    End If
                ...
                Else
                    dt = olMat.RechazaProcesoCursoTutorial(oeMat)

                    If Not dt Is Nothing Then
                        dict.Add("R", "OK")
                        dict.Add("Mensaje", "ha rechazado su matricula para el curso tutorial")
                    Else
                        dict.Add("R", "CANCEL")
                        dict.Add("Mensaje", "Ocurrio un problema al rechazar la matricula, favor de volver intentar")
                    End If
                ...
                JSONresult = serializer.Serialize(list)
            ElseIf Request("param0") = "regCurPen" Then   ' Registrar si acepta o no el curso pendiente
                Dim olMat As New lMatricula
                Dim oeMat As New eMatricula
                Dim f As New lFunciones
                Dim values As ArrayList = f.ParamsValues(Request.Params, "param1")
                ...
                If Request("param2") = "1" Then
                    ...
                    dt = olMat.EjecutaProcesoCursoPendiente(oeMat)

                    If Not dt Is Nothing Then
                        dict.Add("R", "OK")
                        dict.Add("Mensaje", "ha confirmado su matricula para el curso pendiente " & curso.ToString.ToUpper)
                    Else
                        dict.Add("R", "CANCEL")
                        dict.Add("Mensaje", "Ocurrio un problema al confirmar la matricula, favor de volver intentar")
                    End If
                ...
                Else
                    dt = olMat.RechazaProcesoCursoPendiente(oeMat)

                    If Not dt Is Nothing Then
                        dict.Add("R", "OK")
                        dict.Add("Mensaje", "ha rechazado su matricula para el curso pendiente")
                    Else
                        dict.Add("R", "CANCEL")
                        dict.Add("Mensaje", "Ocurrio un problema al rechazar la matricula, favor de volver intentar")
                    End If
            ...
            ElseIf Request("param0") = "lsHis" Then
                ...
                If Not dtCursos Is Nothing AndAlso dtCursos.Rows.Count > 0 Then
                    ...
                    For i = 0 To dtCursos.Rows.Count - 1
                        ...
                        dict.Add("inhabilitado", dtCursos.Rows(i).Item("inhabilitado_dma"))

                        'If dtCursos.Rows(i).Item("inhabilitado_dma") = 1 Then
                        '    dict.Add("inhabilitado", True)
                        'Else
                        '    dict.Add("inhabilitado", false)
                        'End If
                        ...
                        ElseIf dtCursos.Rows(i).Item("inhabilitado_dma") = True Then
                            dict.Add("color", "#3c3c3c")
            ...
            ElseIf Request("param0") = "CnfSE" Then
                ...
                Dim serializer As System.Web.Script.Serialization.JavaScriptSerializer = New System.Web.Script.Serialization.JavaScriptSerializer()
                JSONresult = serializer.Serialize(dict)
            ElseIf Request("param0") = "enviarToken" Then
                Dim dtToken As New DataTable
                Dim oeDalCelularToken As New eDalCelularToken
                With oeDalCelularToken
                    .param1 = Session("codigo_Alu")
                    .param2 = Request("param1")
                    .operacion_cet = "ACT. DE DATOS ESTUDIANTE"
                    .tipo_cet = "A"
                End With
                Dim olDalCelularToken As New lDalCelularToken
                dtToken = olDalCelularToken.GenerarCelularToken(oeDalCelularToken)

                Dim dict As New Dictionary(Of String, Object)()
                dict.Item("rpta") = "warning"
                dict.Item("msg") = "Se ha producido un error"
                If dtToken.Rows.Count > 0 Then
                    If dtToken.Rows(0).Item("rpta") = "1" Then
                        dict.Item("rpta") = "success"
                    End If
                    dict.Item("msg") = dtToken.Rows(0).Item("msg").ToString
                End If
                Dim serializer As System.Web.Script.Serialization.JavaScriptSerializer = New System.Web.Script.Serialization.JavaScriptSerializer()
                JSONresult = serializer.Serialize(dict)
            ...
            ElseIf Request("param0") = "lstDAl" Then
                ...
                If Not dt Is Nothing AndAlso dt.Rows.Count > 0 Then
                    ...
                    If dt.Rows(0).Item("confirmaDatos") = 0 Then
                        ...
                        dict.Add("estudiante", dt.Rows(0).Item("ApellidosNombres").ToString)
                        dict.Add("codUniversitario", dt.Rows(0).Item("codigoUniver_Alu").ToString)
                        dict.Add("escuela", dt.Rows(0).Item("EscuelaProfesional").ToString)
                        dict.Add("nrodoc", dt.Rows(0).Item("nroDocIdent_Alu").ToString)
                        dict.Add("dia", Date.Today.Day.ToString)
                        dict.Add("mes", lfun.NombreMes(Date.Today.Month.ToString))
                        dict.Add("anio", Date.Today.Year.ToString)
                    Else
            ...
            ElseIf Request("param0") = "gTlf" Then
                ...
                Try
                    ...
                    If Not dt Is Nothing AndAlso dt.Rows(0).Item("rpta").ToString = "OK" Then
                        dict.Add("r", True)
                        dict.Add("msje", "<i class='ion-flag'></i> Se ha confirmado teléfono en sus datos correctamente")
                        ...
                        If Request("param2") = 1 Then
                            ...
                            Dim dictConfirma As New Dictionary(Of String, Object)()

                            dictConfirma.Add("confirma", 1)
                            listConfirma.Add(dictConfirma)
                ...
                Catch ex As Exception
                    ...
                    ' dict.Add("param2", Request("param2"))
                    Dim serializer As System.Web.Script.Serialization.JavaScriptSerializer = New System.Web.Script.Serialization.JavaScriptSerializer()

                    JSONresult = serializer.Serialize(dict)
                End Try
            ElseIf Request("param0") = "gEmailP" Then
                Try
                    Dim f As New lFunciones
                    Dim values As ArrayList = f.ParamsValues(Request.Params, "param2")
                    Dim list As New List(Of Dictionary(Of String, Object))()
                    ...
                    Dim email As String = Request("param1")
                    ...
                    If Not dt Is Nothing AndAlso dt.Rows(0).Item("rpta").ToString = "OK" Then
                        dict.Add("r", True)
                        dict.Add("msje", "<i class='ion-flag'></i> Se ha confirmado email personal en sus datos correctamente")
                        dict.Add("alert", "success")
                        dict.Add("user", f.EncrytedString64(Request("param1").tostring()))
            ...
            ElseIf Request("param0") = "modDAl" Then  ' modificar datos del alumno
                ...
                ' MsgBox(serializer.Serialize(list))
                JSONresult = serializer.Serialize(list)
            ElseIf Request("param0") = "modDAlTok" Then  ' modificar datos del alumno
                Dim f As New lFunciones
                Dim values As ArrayList = f.ParamsValues(Request.Params, "param2")
                Dim list As New List(Of Dictionary(Of String, Object))()
                Dim dict As New Dictionary(Of String, Object)()
                ...
                If Request("ace") = 1 Then
                    With oeAlumno
                        .tipoOperacion = "A"
                        .codigo_Alu = Session("codigo_Alu")
                        .email_Alu = Request("email1")
                        .email_Alu2 = Request("email2")
                        .direccion = Request("dir")
                        .telefonocasa = Request("fono")
                        .telefonomovil = Request("cel")
                        .dalToken = Request("tkn")
                        'If CBool(Request(values(5))) Then
                        '    .confirmaDatos = 1
                        'Else
                        '    .confirmaDatos = 0
                        'End If
                        .confirmaDatos = Request("ace")
                    End With

                    dtToken = olAlumno.DAL_ComparaToken(oeAlumno)


                    If Not dtToken Is Nothing > 0 AndAlso dtToken.Rows(0).Item("rpta").ToString = "OK" Then
                        dt = olAlumno.ModificaDatosAlumno(oeAlumno)
                    ...
                    Else
                        dict.Add("r", False)
                        dict.Add("alert", "warning")
                        dict.Add("msje", "CODIGO DE CONFIRMACION INCORRECTO")
                    End If
                Else
                    dict.Add("r", False)
                    dict.Add("msje", "No ha aceptado los t&eacute;rminos y condiciones")
            ...
            ElseIf Request("param0") = "lstAdeudo" Then  'LISTA DE NO ADEUDOS
                Dim list As New List(Of Dictionary(Of String, Object))()
                Dim serializer As System.Web.Script.Serialization.JavaScriptSerializer = New System.Web.Script.Serialization.JavaScriptSerializer()
                Try


                    Dim oe As New eAdeudo
                    Dim ol As New lAdeudo
                    ...
                    If Not dt Is Nothing AndAlso dt.Rows.Count > 0 Then
                        ...
                        For i As Integer = 0 To dt.Rows.Count - 1
                            ...
                            dict.Add("c", olf.EncrytedString64(dt.Rows(i).Item("Nro").ToString))
                            dict.Add("fecha", CDate(dt.Rows(i).Item("Fecha")).ToShortDateString)
                            dict.Add("alumno", dt.Rows(i).Item("Alumno").ToString.ToUpper)
                            dict.Add("escuela", dt.Rows(i).Item("Escuela").ToString)
                            dict.Add("correo", dt.Rows(i).Item("correo").ToString)
                            dict.Add("revisiones", dt.Rows(i).Item("revisiones").ToString)
                            dict.Add("reg", dt.Rows(i).Item("registrado").ToString)
                            list.Add(dict)
                        Next
                ...
                JSONresult = serializer.Serialize(list)
            ElseIf Request("param0") = "lstAdeudoRev" Then  'LISTA DE NO ADEUDOS Revisores
                Dim list As New List(Of Dictionary(Of String, Object))()
                Dim serializer As System.Web.Script.Serialization.JavaScriptSerializer = New System.Web.Script.Serialization.JavaScriptSerializer()
                Try
                    ...
                    oe.tipooperacion = "D"
                    oe.codigo_Cade = CInt(olf.DecrytedString64(Request("param1").ToString))
                    oe.estado = ""
                    dt = ol.ConsultarNoAdeudo(oe)
                    ...
                    If Not dt Is Nothing AndAlso dt.Rows.Count > 0 Then
                        For i As Integer = 0 To dt.Rows.Count - 1
                            Dim dict As New Dictionary(Of String, Object)()
                            dict.Add("fecha", CDate(dt.Rows(i).Item("FechaRevision")).ToShortDateString)
                            dict.Add("estado", dt.Rows(i).Item("Estado").ToString.ToUpper)
                            'dict.Add("obs", dt.Rows(i).Item("Observación").ToString)
                            dict.Add("rev", dt.Rows(i).Item("Revisor").ToString)
                            list.Add(dict)
                        Next
                    End If
                Catch ex As Exception
            ...
            ElseIf Request("param0") = "lstCurInhabil" Then  'LISTA DE CURSOS INHABILITADOS
                Dim list As New List(Of Dictionary(Of String, Object))()
                Dim serializer As System.Web.Script.Serialization.JavaScriptSerializer = New System.Web.Script.Serialization.JavaScriptSerializer()
                Try


                    Dim cInhabil As Integer = 0
                    Dim strTbody As New StringBuilder
                    Dim codigo_cup As Integer = 0

                    Dim i As Integer = 0
                    Dim dt As New DataTable
                    Dim cod_cac As Integer = 0

                    If Session("codigo_test").ToString = "2" Then
                        Dim oeCA As New eCicloAcademico
                        Dim olCA As New lCicloAcademico
                        oeCA.vigencia_Cac = 1
                        oeCA.tipoOperacion = "AU2"
                        oeCA = olCA.consultar(oeCA)
                        cod_cac = oeCA.codigo_Cac

                        'Response.Write(oeCA.descripcion_Cac)
                        'Response.Write("sds")
                    Else
                        cod_cac = Session("Codigo_Cac")
                    End If

                    Dim oeCursoProgramado As New eCursoProgramado
                    Dim olCursoProgramado As New lCursoProgramado
                    oeCursoProgramado.tipooperacion = "0"
                    oeCursoProgramado.codigo_cac = cod_cac

                    oeCursoProgramado.codigo_Alu = Session("Codigo_Alu")
                    If Session("codigo_test") = 2 Then

                        dt = olCursoProgramado.consultarCursosMatriculados(oeCursoProgramado)
                    Else

                        dt = olCursoProgramado.consultarCursosMatriculadosOtros(oeCursoProgramado)
                    End If
                    ...
                    If Not dt Is Nothing AndAlso dt.Rows.Count > 0 Then
                        For i = 0 To dt.Rows.Count - 1
                            If i < (dt.Rows.Count - 1) Then
                                If dt.Rows(i).Item("codigo_cup") <> dt.Rows(i + 1).Item("codigo_cup") Then
                                    If dt.Rows(i).Item("inhabilitado_dma") <> 0 Then

                                        Dim dict As New Dictionary(Of String, Object)()

                                        dict.Add("cup", dt.Rows(i).Item("codigo_cup").ToString.ToUpper)
                                        dict.Add("cur", dt.Rows(i).Item("nombre_Cur").ToString)
                                        dict.Add("cac", dt.Rows(i).Item("descripcion_Cac").ToString)
                                        dict.Add("doc", dt.Rows(i).Item("docente").ToString)
                                        dict.Add("ciclo", dt.Rows(i).Item("ciclo_Cur").ToString)
                                        dict.Add("cred", dt.Rows(i).Item("creditoCur_Dma").ToString)
                                        dict.Add("th", dt.Rows(i).Item("totalhoras_cur").ToString)
                                        dict.Add("vcs", dt.Rows(i).Item("vecesCurso_Dma").ToString)
                                        dict.Add("est", dt.Rows(i).Item("estado_dma").ToString)
                                        list.Add(dict)
                                    End If
                                End If
                            End If
                        ...
                        If dt.Rows(dt.Rows.Count - 1).Item("inhabilitado_dma") <> 0 Then

                            Dim dict2 As New Dictionary(Of String, Object)()

                            dict2.Add("cup", dt.Rows(dt.Rows.Count - 1).Item("codigo_cup").ToString.ToUpper)
                            dict2.Add("cur", dt.Rows(dt.Rows.Count - 1).Item("nombre_Cur").ToString)
                            dict2.Add("cac", dt.Rows(dt.Rows.Count - 1).Item("descripcion_Cac").ToString)
                            dict2.Add("doc", dt.Rows(dt.Rows.Count - 1).Item("docente").ToString)
                            dict2.Add("ciclo", dt.Rows(dt.Rows.Count - 1).Item("ciclo_Cur").ToString)
                            dict2.Add("cred", dt.Rows(dt.Rows.Count - 1).Item("creditoCur_Dma").ToString)
                            dict2.Add("th", dt.Rows(dt.Rows.Count - 1).Item("totalhoras_cur").ToString)
                            dict2.Add("vcs", dt.Rows(dt.Rows.Count - 1).Item("vecesCurso_Dma").ToString)
                            dict2.Add("est", dt.Rows(dt.Rows.Count - 1).Item("estado_dma").ToString)
                            list.Add(dict2)
            ...
            ElseIf Request("param0") = "lstCurSil" Then
                Dim olF As New lFunciones
                Dim list As New List(Of Dictionary(Of String, Object))()
                ...
                Dim ol As New lMatricula
                oe.codigo_Alu = Session("codigo_Alu")
                oe.codigo_test = Session("codigo_test")
                oe.codigo_Cac = Session("codigo_cac")
                dt = ol.ListarCursosSilabo(oe)

                If Not dt Is Nothing AndAlso dt.Rows.Count > 0 Then
                    Dim ls As String = ""
                    For i As Integer = 0 To dt.Rows.Count - 1
                        Dim dict As New Dictionary(Of String, Object)()
                        dict.Add("cod", olF.EncrytedString64(dt.Rows(i).Item("codigo_dis").ToString))
                        dict.Add("curso", dt.Rows(i).Item("nombre_Cur").ToString)
                        dict.Add("refcup", (New lFunciones).EncrytedString64(dt.Rows(i).Item("Refcodigo_Cup").ToString))
                        ls = ls & dt.Rows(i).Item("codigo_dis").ToString & ","

                        If i = dt.Rows.Count - 1 Then
                            dict.Add("confdis", (New lFunciones).EncrytedString64(ls))
                        Else
                            dict.Add("confdis", "")
                        End If
            ...
            ElseIf Request("param0") = "regCurSil" Then
                Dim serializer As System.Web.Script.Serialization.JavaScriptSerializer = New System.Web.Script.Serialization.JavaScriptSerializer()
                Dim olF As New lFunciones
                ...
                Try
                    ...
                    oe.codigo_Alu = Session("codigo_Alu")
                    oe.arrCP = olF.DecrytedString64(Request("param1"))
                    oe.usuario_Bit = clientMachineName
                    dt = ol.ConfirmarCursosSilabo(oe)

                    If Not dt Is Nothing AndAlso dt.Rows.Count > 0 Then
                        If dt.Rows(0).Item("rpta").ToString = 1 Then
                            dict.Add("r", True)
                            dict.Add("msje", "Haz confirmado silabo")
                        Else
                            dict.Add("r", False)
                            dict.Add("ErrorNumber", dt.Rows(0).Item("ErrorNumber").ToString)
                            dict.Add("ErrorSeverity", dt.Rows(0).Item("ErrorSeverity").ToString)
                            dict.Add("ErrorState", dt.Rows(0).Item("ErrorState").ToString)
                            dict.Add("ErrorProcedure", dt.Rows(0).Item("ErrorProcedure").ToString)
                            dict.Add("ErrorLine", dt.Rows(0).Item("ErrorLine").ToString)
                            dict.Add("ErrorMessage", dt.Rows(0).Item("ErrorMessage").ToString)
                        End If
                    Else
                        dict.Add("r", False)
                        dict.Add("msje", "Problemas al registrar confirmacion silabo")
                    End If
