	            ...
	            */
	            ...
	            if (tipo_cac == "E") {
	                if ($(this).is(':checked') == true) {
	                    ...
	                    if (parseInt(cursoAdelantar) > parseInt(MaxAdelantar)) {
...
function modificarmatricula(modo,ID)
{
	...
	if (modo=='N'){ //Para nueva matrícula
	    pagina = "../academico/matricula/administrarGO/frmagregarcurso2015.asp?accion=matriculasegura&codigo_pes=" + ID
		window.location.href="../../../aplicacionweb2/cargando.asp?rutapagina=" + pagina
	}
		
	if (modo=='A'){ //Para agregado de matrícula
		pagina="../academico/matricula/administrarGO/frmagregarcurso2015.asp?accion=agregarcursomatricula&codigo_pes=" + ID
...
{
	pagina="../academico/matricula/administrarGO/frmagregarcursoGO.asp?accion=agregarcursomatricula&codigo_pes=" + codigo_pes
	window.location.href="../../../aplicacionweb2/cargando.asp?rutapagina=" + pagina
}
function ActualizaPreRequisito(param1, param2, param3, param4) {
	//alert(param1+' '+ param2+' '+ param3+' '+ param4);

	pagina = "../administrarGO/calculaPreRequisito2015.aspx?param1=" + param1 + "&param2=" + param2 + "&param3=" + param3 + "&param4=" + param4
    //alert(pagina);
