...
function modificarmatricula(modo,ID)
{
	...
	if (modo=='N'){ //Para nueva matrícula
	    pagina = "../mantenimiento/frmagregarcurso2015.asp?accion=matriculasegura&codigo_pes=" + ID
		//window.location.href="../../../aplicacionweb2/cargando.asp?rutapagina=" + pagina
		window.location.href=pagina
	}
		
	if (modo=='A'){ //Para agregado de matrícula
		pagina="../mantenimiento/frmagregarcurso2015.asp?accion=agregarcursomatricula&codigo_pes=" + ID
