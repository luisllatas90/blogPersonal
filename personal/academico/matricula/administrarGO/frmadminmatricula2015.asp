...
paginaorigen="matricula/administrarGO/frmadminmatricula2015.asp"
...
if codigo_alu<>"" and modo="resultado" then
	...
	'end if
    response.redirect("../verificaraccesomatriculaGO.asp?rutaActual=../academico/matricula/administrarGO")
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="tabla_buscar">
  <tr>
    <td width="60%" class="usattitulo">Asesorar matr&iacute;cula del estudiante (<%=descripcion_cac%>)</td>
	<%if codigo_alu="" then	%>
    <td width="40%"><%       
	...
	<table align="center" bgcolor="#EEEEEE" style="width: 80%;height:30%" cellpadding="3" class="contornotabla_azul">
		<tr>
			...
			<td class="usatTitulousat">
				No se han encontrado asignaturas matriculadas para el ciclo acad&eacute;mico <%=descripcion_cac%>
			</td>
		</tr>
		<tr class="usatTitulo">
			<td>¿Desea realizar una nueva matr&iacute;cula?</td>
		</tr>		
		<tr>
			<td align="center">&nbsp;</td>
			<td align="center">
