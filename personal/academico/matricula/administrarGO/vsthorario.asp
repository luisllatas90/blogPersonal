...
Set Obj= Server.CreateObject("PryUSAT.clsAccesoDatos")
	obj.AbrirConexion
		Set rsCursos=Obj.Consultar("ConsultarCursoProgramadoPorAsesor","FO","2",codigo_alu,codigo_cac,codigo_alu,0)
	obj.CerrarConexion
Set Obj=nothing
%>
<HTML>
	...
	<%  Set obj=Server.CreateObject("PryUSAT.clsAccesoDatos")	
        ...
        set obj = nothing        
        %>                     
        <font color="red">AMBIENTES POR DEFINIR: Los Ambientes seran mostrados a partir del <% response.write(FechaInicioCrog) %> <br /><br />        </font> 
        <%        
    %>  
	...
	<%else%>
		<h5 class="usatsugerencia">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No se han encontrado Horarios registradas</h5>
	<%end if%>
	</body>
</HTML>
