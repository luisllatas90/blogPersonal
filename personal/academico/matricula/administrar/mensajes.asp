...
&nbsp;<li><i><b>¿Qué hago si ya pagué en la Oficina de Caja de la Universidad?</b></i><br>
    ...
    <%else%>
        <p>Se restableció la inscripcion de verano del estudiante <b><font color="#0000FF" size="3">Regresar al menú principal</font></b>.<br>
        <br/>
...
<%case "AV"%>
    ...
    haya cancelado su 
		...
		<span style="font-weight: 400"><br/>, en caso no tenga la deuda,  debe generarlo ingresando a su campus virtual estudiante en la opción Procesos en línea>>Inscripción de Cursos de Verano. Además indicarle que para poder generarlo no debe tener deudas vencidas.
    ...
    haya cancelado su 
		...
		</span><span style="font-weight: 800"><i><font color="#FF0000">PAGO DE INSCRIPCIÓN DE VERANO</font></i></span>
		<span style="font-weight: 400"><br/>, en caso no tenga la deuda,  debe generarlo ingresando a su campus virtual estudiante en la opción Procesos en línea>>Inscripción de Cursos de Verano. Además indicarle que para poder generarlo no debe tener deudas vencidas.
