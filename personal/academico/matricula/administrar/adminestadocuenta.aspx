...
<body>
    ...
    <p class="usatTitulo">Cargos Suspendidos</p>
        ...
        <tr>
            <td style="width: 40%">
                ...
                <asp:LinkButton ID="lnkBanco" runat="server" ForeColor="Red" Font-Bold="True" 
                    Font-Size="X-Small" Visible="False">Deudas en el Banco</asp:LinkButton>
        ...
        <tr>
            <td colspan="2" id="divObs" >
                ...
                <asp:Panel ID="Panel1" runat="server">
                    * Para la <b>matrícula 2011-I</b> el <b>Monto de matrícula</b> tendrá como fecha 
                de <b>vencimiento 13-03-2011 </b>y <span class="style1">variará gradualmente</span> de acuerdo al cronograma establecido por la oficina de Pensiones.
                </asp:Panel>
            </td>
        </tr>
        <tr>
    ...
    <asp:Panel ID="pnlDeudas" runat="server">
        <asp:GridView ID="grwPagos" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField>
                <ItemStyle Font-Underline="True" ForeColor="#0066FF" HorizontalAlign="Center" />
                </asp:BoundField>
            </Columns>
