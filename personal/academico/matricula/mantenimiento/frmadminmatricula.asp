...
<script type="text/javascript" language="JavaScript" src="private/validarfichamatricula2015.js"></script>
...
<table border="0" cellpadding="2" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="<%=alto%>">
    ...
    <tr>
      ...
      <td width="50%" style="height: 4%">
     	<%call buscaralumno("matricula/mantenimiento/frmadminmatricula.asp","../../",-1)%>
      </td>
    </tr>
    <%else   %>
    <tr>
