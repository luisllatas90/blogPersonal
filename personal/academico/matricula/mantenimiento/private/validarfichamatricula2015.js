...
/*}ID:38643*/
    ...
    fnCrdSituacion(parseInt(creditos) - parseInt(credMat));
    var codigo_cac = 0
...
function modificarmatricula(modo,ID,dc,cp,accion)
{
	...
	if (modo=='A'){ //Para agregado de matrícula
		pagina="../academico/matricula/mantenimiento/frmagregarcurso2015.asp?accion=" + accion + "&codigo_cac=" + ID + "&descripcion_cac=" + dc + "&codigo_pes=" + cp
...
{
	pagina="../academico/matricula/mantenimiento/frmagregarcurso2015.asp?accion=agregarcursomatricula&codigo_pes=" + document.all.cbocodigo_pes.value + "&codigo_cac=" + ca + "&descripcion_cac=" + dc
