	...
	switch (eval(frmFicha.txtcodigo_cpf.value)) {
	    case 24:
	        if (creditos <= 13) // medicina
	            ...
	            document.all.lblPrecioCiclo.innerHTML = 1300 * 5
	        break
	    case 31:
...
function modificarmotivo(codigo_dma,tipo,  motivoactual , obsactual)
{
	...
	pagina	=	"../matricula/mantenimiento";
...
function modificarmatricula(modo,ID,dc,cp,accion)
{
	...
	if (modo=='N'){ //Para nueva matrícula
		pagina="../academico/matricula/mantenimiento/frmagregarcurso.asp?esnuevamatricula=S&accion=agregarcursomatricula&codigo_pes=" + ID
		window.location.href="../../../aplicacionweb2/cargando.asp?rutapagina=" + pagina
	}
		
	if (modo=='A'){ //Para agregado de matrícula
		pagina="../academico/matricula/mantenimiento/frmagregarcurso.asp?accion=" + accion + "&codigo_cac=" + ID + "&descripcion_cac=" + dc + "&codigo_pes=" + cp
...
{
	pagina="../academico/matricula/mantenimiento/frmagregarcurso.asp?accion=agregarcursomatricula&codigo_pes=" + document.all.cbocodigo_pes.value + "&codigo_cac=" + ca + "&descripcion_cac=" + dc
	window.location.href="../../../aplicacionweb2/cargando.asp?rutapagina=" + pagina
}
function ActualizaPreRequisito(param1, param2, param3, param4) {
    pagina = "../mantenimiento/calculaPreRequisito.aspx?param1=" + param1 + "&param2=" + param2 + "&param3=" + param3 + "&param4=" + param4
...
function CalcularCuota(valor, precioCredito) {
    ...
    lblCuota.innerHTML = redondear(parseFloat(precioCredito / valor), 2)
