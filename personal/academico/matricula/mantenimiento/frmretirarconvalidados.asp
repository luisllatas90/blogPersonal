...
'determinar si el alumno tiene alguna categorizacion
	...
	Obj.AbrirConexion
	'Set rsMatricula=Obj.Consultar("ConsultarAccesoMatriculaPorAsesor_2015","FO",codigo_alu,session("codigo_cac"),0,"administrar/mantenimiento/retirarconvalidados",session("codigo_tfu"))
	Set rsMatricula=Obj.Consultar("ConsultarAccesoRetiroConvalidado","FO",codigo_alu,session("codigo_cac"),0,"administrar/mantenimiento/retirarconvalidados",session("codigo_tfu"))
...
<script language="JavaScript" src="../../matricula/administrar/private/jquery.js"></script>
<link rel="stylesheet" type="text/css" href="../../../../private/estilo.css">
<script language="JavaScript" src="../../../../private/funciones.js"></script>
<script type="text/javascript" language="JavaScript" src="private/validarfichamatricula2015.js?x=1"></script>
...
<body onload="document.all.txtcodigouniver_alu.focus();<%if HayReg=true and tieneSeparacion = 0 then%>AbrirMatricula('0','detalleretiros2015.asp')<%end if%>">
...
<table border="0" cellpadding="2" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="<%=alto%>">
    ...
    <tr>
      ...
      <td width="50%" style="height: 4%">
     	<%call buscaralumno("matricula/mantenimiento/frmretirarconvalidados.asp","../../",-1)%>
      </td>
    </tr>
    <%else   %>
    <tr>
    ...
    <!--< % if tieneSeparacion = 1 then % >  comentado 31.12.18 GLPI 23020-->
    ...
    </tr> comentado 31.12.18 GLPI 23020
   -->   
    
	<% 'else  comentado 31.12.18 GLPI 23020%>	   
    <tr>
      <td width="100%" valign="top" height="3%" colspan="2" class="contornotabla">
			<table border="0" width="100%" style="border-collapse: collapse;">
				...
				<tr bgcolor="#FFFFCC">
					...
					Call llenarlista("cbocodigo_mat","ResaltarPestana2('0','','');AbrirMatricula(this.selectedIndex,'detalleretiros2015.asp')",rsMatricula,"codigo_mat","descripcion_cac",0,"","","")
					%>	
					</td>
    ...
    <tr>
      <td valign="top" height="70%" colspan="2">
		<table cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="100%">
				<tr height="8%">
					<td class="pestanaresaltada" id="tab" align="center" width="22%" onclick="ResaltarPestana2('0','','');AbrirMatricula(cbocodigo_mat.selectedIndex,'detalleretiros2015.asp')">
                    ...
                    <td width="100%" valign="top" colspan="10" style ="padding:10px;border-left:1px solid gray;border-right:1px solid gray;"  >
                        <b>AVISO </b></br>El estudiante tiene <%=motivoSeparacion%> 
                        Cualquier duda consulte con el Director de Escuela.
                    </td>
                    </tr>
 ...
 'end if  comentado 31.12.18 GLPI 23020 %>
</table>
</body>
</html>