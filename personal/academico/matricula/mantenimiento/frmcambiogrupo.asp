...
Set Obj=Server.CreateObject("PryUSAT.clsAccesoDatos")
	...
	if codigo_tfu=1 or codigo_tfu=7 or codigo_tfu=16 then
		...
		Set rsEscuela= obj.Consultar("consultaracceso","FO","ESC",0,usuario)
...
<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" <%=alto%>>
  <tr class="usattitulo">
    ...
    por Carrera Profesional</td>
  </tr>
  <tr>
    <td width="15%" height="5%">Semestre Academico</td>
    <td width="15%" height="5%"><%call ciclosAcademicos("actualizarlista('frmcambiogrupo.asp?codigo_cac='+ this.value)",codigo_cac,"","")%></td>
    <td width="20%" height="5%" align="right">Carrera Profesional:</td>
    <td width="40%" height="5%" colspan="2">
    <%call planescuela2("actualizarlista('frmcambiogrupo.asp?codigo_cac='+ document.all.cbocodigo_cac.value + '&codigo_pes='+ this.value)",codigo_pes,rsEscuela)%>
    </td>
 </tr>
  <%if activo=true then%>
  <tr>
    ...
    <input type="button" value="Buscar" name="cmdBuscar" onClick="location.href='frmcambiogrupo.asp?codigo_cac=<%=codigo_cac%>&codigo_pes=<%=codigo_pes%>&codigo_cup='+document.all.cbocursoorigen.value" class="buscar2" id="cmdBuscar"></td>
  </tr>
  <%=mensaje%>
  ...
  <tr>
    ...
    <table border="1" cellpadding="2" cellspacing="0" style="border-collapse: collapse" bordercolor="#808080" width="100%"  <%=alto%> id="tblcursoprogramado">
      <tr class="etabla">
        ...
        <td width="25%" height="3%">Carrera Profesional</td>
