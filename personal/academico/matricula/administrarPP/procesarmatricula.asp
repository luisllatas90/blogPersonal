	...
	if accion="matriculasegura" then
		...
		<%'else
		    ...
		    if(numDeudas > 2 or TieneConvenio = 0) then 
		        mensaje = "location.href='frmadminmatricula.asp'|Su matricula no fue registrada.<br/>Ud. no tiene convenio o tiene más de 2 deudas vencidas."
...
'*************************************************************************************
	if accion="agregarcursomatricula" then
		...
		if(numDeudas > 2 or TieneConvenio = 0) then 
	        mensaje = "location.href='frmadminmatricula.asp'|Su matricula no fue registrada.<br/>Ud. no tiene convenio "& TieneConvenio & " o tiene más de 2 deudas vencidas." 
		    tituloboton = "Regresar"
	    else
	        'Cambiado por hreyes
