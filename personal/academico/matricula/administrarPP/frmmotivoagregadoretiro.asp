...
obsv       =	request.querystring("txtobs")
...
<body bgcolor="#EEEEEE">
<form name="frmmotivo" method="POST" action="<%=ruta%>/procesarmatricula.asp?accion=<%=accion%>&codigo_dma=<%=codigo_dma%>&txtobs=<%=obsv%>&tipo_mar=<%=tipo_mar%>"  >
