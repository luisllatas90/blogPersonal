...
Set Obj= Server.CreateObject("PryUSAT.clsAccesoDatos")
	Obj.AbrirConexion
		Set rsMatricula=Obj.Consultar("ConsultarCursosMatriculadosPorAsesorPP","FO",codigo_alu,codigo_pes,codigo_cac,codigo_tfu,22)
		'set rsAgregados = Obj.Consultar("ACAD_RetornaAgregadosRetirosPP","FO",codigo_alu,session("codigo_cac"),0,"administrar/mantenimiento",session("codigo_tfu"))
	Obj.CerrarConexion
...
<table border="1" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="gray" width="100%" bgcolor="white">
  <tr class="etabla">
    ...
    <p style="text-align: left">Cursos Matriculados</td>
  </tr>
  <tr class="etabla">
    <td width="5%">Tipo</td>
    <td width="10%">GH</td>
  ...
  <tr onMouseOver="Resaltar(1,this,'S')" onMouseOut="Resaltar(0,this,'S')">
    ...
    <% if isnull(rsmatricula.fields("codigoretiro_mar"))=false then	%>
