...
function modificarmatricula(modo,ID,dc,cp,accion)
{
	...
	if (modo=='N'){ //Para nueva matrícula
	    pagina = "../academico/matricula/administrarPP/frmagregarcurso.asp?esnuevamatricula=S&accion=agregarcursomatricula&codigo_pes=" + ID + "&codigo_cac=" + dc + "&descripcion_cac=" + cp
