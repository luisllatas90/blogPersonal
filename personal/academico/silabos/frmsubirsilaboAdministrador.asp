...
<html>
	...
	<body>
        ...
        <input type="hidden" name="hdcodigo_cup" value="<%=codigo_cup%>">
	<input type="hidden" name="hddescripcion_cac" value="<%=descripcion_cac%>">
        ...
        <table border="0" cellpadding="5" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" class="contornotabla">
          ...
          <tr>
            <td width="100%">
			<input type="file" name="File1" size="40" class="cajas2"></td>
          </tr>
          <tr>
