...
function AccionSilabos(modo, ca, esc, cu, cup, tbl, fila) {
    ...
    switch (modo) {
        case "E":
            ...
            if (Confirmar == true) {
                pagina = "procesar.asp?accion=eliminarsilabos3&codigo_cup=" + cu + "&codigo_cac=" + ca + "&codigo_cpf=" + esc + "&descripcion_cac=" + cup
                //AbrirPopUp(pagina,"10","10")
                location.href = pagina
                //location.href = "frmadminsilabos.asp?codigo_cac=" + ca
            }
            else
            { return false }
            break
        ...
        case "A":
            ...
            window.open("frmsubirsilabo.asp?descripcion_cac=" + ca + "&codigo_cup=" + cu, "ventana1")
            //popitup("frmsubirsilabo.asp")
            break
        ...
        case "C":
            if (cbocodigo_cpf.value == -2) {
                ...
                pagina = "../academico/silabos/frmadminsilabos.asp?codigo_cac=" + cbocodigo_cac.value + "&codigo_cpf=" + cbocodigo_cpf.value + "&descripcion_cac=" + cbocodigo_cac.options[cbocodigo_cac.selectedIndex].text + "&mod=" + ca
            }
