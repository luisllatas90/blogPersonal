<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmAdminSilabos.aspx.vb" Inherits="academico_silabos_FrmAdminSilabos" %>
                            ...
                            <div class="col-xs-12 col-sm-12">
                                <div class="form-group row">
                                    <label class="col-sm-4" for="FileUploadControl">
                                        Nota:</label>
                                        <div class="col-sm-8">
                                            <label style="text-align:justify">Debe tomar en cuenta que el tamaño del archivo, no sobrepase los 300 Kb y debe ser empaquetado (.ZIP) caso contrario el sistema no le admitirá subir el archivo. Recuerde tomar en cuenta estas indicaciones para que estudiante pueda descargar con facilidad el archivo</label>
                                        </div>
                                </div>
                            </div>
                        </div>
