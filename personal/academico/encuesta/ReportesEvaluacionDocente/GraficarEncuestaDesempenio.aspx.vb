...
Partial Class Encuesta_ReportesEvaluacionDocente_GraficarEncuestaDesempenio
    Inherits System.Web.UI.Page

    Protected Sub cmdDetallado_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdDetallado.Click
        Response.Redirect("GraficarEncuestaDesempenioDetallado.aspx?id=" & Request.QueryString("id") & "&per=" & Request.QueryString("per") & "&cup=" & Request.QueryString("cup") & _
