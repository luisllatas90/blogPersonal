<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ConsultarEncuestaCC2.aspx.vb" Inherits="Encuesta_CursosComplementarios_ConsultarEncuestaCC2" %>
...
<body>
    ...
    <table style="width:100%;">
        <tr>
            <td colspan="2">
                <b>Consulta de cursos complementarios: CURSO BÁSICO DE FONÉTICA </b><br />
            </td>
        </tr>
        <tr>
            <td>
