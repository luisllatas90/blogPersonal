                 ...
                 <div class="row">
                      <div class="col-md-12">
                          <div class="table-responsive">
                                ...
                                <asp:TemplateField HeaderText="NO (0)"> 
                                
                                <ItemTemplate>                                 
                                <center>
                                    <label for="rbNo">No</label><br />
                                    <asp:RadioButton ID="rbNo" GroupName="opciones" runat="server" CssClass="radiorespuesta"/>
                                </center>                                     
                               </ItemTemplate>
                                </asp:TemplateField>
                                
                                <asp:TemplateField HeaderText="SI (1)">
                                <ItemTemplate>
                                    <center>
                                        <label for="rbSi">Sí</label><br />
                                        <asp:RadioButton ID="rbSi" GroupName="opciones" runat="server" CssClass="radiorespuesta" />
                                    </center>
                                </ItemTemplate>
                                </asp:TemplateField>
                  ...
                  <div class="row">
                                    <div class="col-md-8">   
                                        <asp:Label ID="lblPreguntaAbierta" runat="server" Text="Label" Font-Bold="true"></asp:Label> 
                                        <asp:TextBox ID="txtPreguntaAbierta" runat="server" MaxLength="800" 
                                            TextMode="MultiLine" Width="500"></asp:TextBox>
                                    </div>
