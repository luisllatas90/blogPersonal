...
Partial Class academico_encuesta_EncuestaEvaluacionDocente_ResponderEncuestaAuto
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Else
                If Not String.IsNullOrEmpty(Request.QueryString("tipoEval")) Then
                    Session("eva_Tipo") = Request.QueryString("tipoEval").ToString
                Else
                    Session("eva_Tipo") = "D" 'Cuando respondio SI a la notificación del campus
                End If
    ...
    Sub Cargarfoto()
        ...
        If strFoto = True Then
            Me.imagePer.ImageUrl = "../../../imgpersonal/" & CInt(Session("id_per")) & ".jpg" ' "https://intranet.usat.edu.pe/campusvirtual/personal/imgpersonal/" & CInt(Session("id_per")) & ".jpg"
        Else
            Me.imagePer.ImageUrl = "../../../imgpersonal/fotovacia3.png"  '"https://intranet.usat.edu.pe/campusvirtual/personal/imgpersonal/fotovacia3.png"
        End If
    End Sub
    Sub CargarPreguntas()
        Try
        ...
        If validar() Then
            ...
            If cod_per > 0 Then
                ...
                Try
                    ...
                    Dim respuesta_eva As Decimal = 0
