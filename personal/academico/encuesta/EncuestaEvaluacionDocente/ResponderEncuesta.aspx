<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ResponderEncuesta.aspx.vb"
    Inherits="academico_encuesta_EncuestaEvaluacionDocente_ResponderEncuesta" %>
        ...
        <div class="panel panel-default" id="pnlLista" runat="server">
                                    ...
                                    <div class="col-md-12">
                                        <center>
                                            <div class="table-responsive">
                                                <br />
                                                <br />
                                                <asp:GridView GridLines="Horizontal" ID="GridView1" runat="server" AutoGenerateColumns="False"
                                                    CssClass="table table-bordered" Width="30%">
                                                    <Columns>
                                                        <asp:BoundField DataField="1" HeaderText="NO" HeaderStyle-HorizontalAlign="Center">
                                                            <HeaderStyle BackColor="#FF6666" HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="2" HeaderText="SÍ" HeaderStyle-HorizontalAlign="Center">
                                                            <HeaderStyle BackColor="#FFFF66" HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:BoundField>
                                                    </Columns>
                                                    <HeaderStyle BackColor="#C3C3C3" ForeColor="Black" VerticalAlign="Middle" HorizontalAlign="Center"
                                                        Font-Size="11px" />
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <asp:GridView ID="gvPreguntas" runat="server" AutoGenerateColumns="False" DataKeyNames="codigo_eva,conrespuesta_eva,orden_eva,codigo_crit,codigo_comp"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sí" HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <center>
                ...
                <div class="row">
                    <div class="col-md-12" align="left">
                        <asp:Label ID="lblpreg" runat="server" Text="*Si existiera algún comentario en particular, como producto de la observación de
                            la sesión de aprendizaje, anótela a continuación:"></asp:Label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12" align="left">
                        <asp:TextBox ID="Txtpreguntafinal" runat="server" Width="800px"></asp:TextBox>
                    </div>
                </div>
                <br />
                <div class="row">
