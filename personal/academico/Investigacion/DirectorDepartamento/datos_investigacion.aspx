<%@ Page Language="VB" AutoEventWireup="false" CodeFile="datos_investigacion.aspx.vb" Inherits="DirectorDepartamento_datos_investigacion" %>
                            ...
                            <ItemTemplate>
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 8pt; width: 10%; font-family: verdana" align="center">
                                            <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl='<%# iif (Right(Eval("rutaPerfil_Inv"),3)="pdf","../../../../images/ext/pdf.gif",iif (Right(Eval("rutaPerfil_Inv"),3)="doc","../../../../images/ext/doc.gif",iif (Right(Eval("rutaPerfil_Inv"),3)="zip","../../../../images/ext/zip.gif","../../../../images/ext/rar.gif"))) %>'
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 8pt; width: 10%; font-family: verdana" align="center">
                                            <asp:HyperLink ID="HyperLink2" runat="server" ImageUrl='<%# iif (Right(Eval("rutaProyecto_Inv"),3)="pdf","../../../../images/ext/pdf.gif",iif (Right(Eval("rutaProyecto_Inv"),3)="doc","../../../../images/ext/doc.gif",iif (Right(Eval("rutaProyecto_Inv"),3)="zip","../../../../images/ext/zip.gif","../../../../images/ext/rar.gif")))%>'
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" style="width: 100%">
                                                        <tr>
                                                            ...
                                                            <td style="font-size: 8pt; color: black; font-family: verdana; width: 10%;" align="left">
                                                                <asp:HyperLink ID="HyperLink3" runat="server" ImageUrl="../../../../images/zip.gif"
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 8pt; width: 10%; font-family: verdana; height: 18px;" align="center">
                                            <asp:HyperLink ID="HyperLink3" runat="server" ImageUrl="../../../../images/zip.gif"
                                                ...
                                                Target="_blank" Visible='<%# iif(Eval("rutaInforme_Inv") = "-",false,true) %>'></asp:HyperLink></td>
                                    </tr>
                                    <tr>
                                        <td style="font-weight: bold; font-size: 8pt; width: 10%; font-family: verdana; height: 18px;">
                                        ...
                                        <td style="font-size: 8pt; width: 10%; font-family: verdana; height: 18px;" align="center">
                                            <asp:HyperLink ID="HyperLink4" runat="server" ImageUrl="../../../../images/zip.gif"
                                                NavigateUrl='<%# "../../../../filesInvestigacion/" & Eval("codigo_Inv") &"/" & Eval("rutaResumen_Inv") %>'
                                                Target="_blank" Visible='<%# iif(Eval("rutaResumen_Inv") = "-",false,true) %>'></asp:HyperLink></td>
                                    </tr>
                                </table>
