                        ...
                        <tr>
                            <td align="left" colspan="4" style="height: 13px">
                                &nbsp;&nbsp;<asp:Button ID="CmdActualizar" runat="server" CssClass="enviaryrecibir1"
                                    ...
                                    Width="95px" />&nbsp;
                                <asp:Button ID="CmdAprobar" runat="server" Text="          Aprobar" Width="86px" CssClass="conforme1" ToolTip="Aprobar una investigacion" OnClientClick="return confirm('¿Realmente desea aprobar la Inevstigación?')" />
                        ...
                        <td colspan="6" 
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="fechaInicio_Inv" DataFormatString="{0:dd-MM-yyyy}" HeaderText="Fecha Ingreso"
