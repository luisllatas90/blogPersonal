<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmlinea.aspx.vb" Inherits="DirectorDepartamento_frmlinea" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Investigaciones :: Agregar Linea</title>
...
<body style="margin-top: 0px; padding-top: 0px">
    <form id="form1" runat="server">
        ...
        <table style="width: 100%" class="contornotabla">
            ...
            <tr>
                <td>
                    &nbsp;Nombre de Línea</td>
                <td>
                    &nbsp;<asp:TextBox ID="Txtlinea" runat="server" Style="border-right: black 1px solid;
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Txtlinea"
                        ErrorMessage="Ingrese titulo de linea" SetFocusOnError="True" ValidationGroup="guardar">*</asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td>
                    &nbsp;Propósito de la Linea</td>
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TxtProposito"
                        ErrorMessage="Ingrese proposito de la linea" SetFocusOnError="True" ValidationGroup="guardar">*</asp:RequiredFieldValidator><br />
                </td>
            </tr>
            <tr>
        ...
        <asp:HiddenField ID="HddCodigo_cco" runat="server" />
        <asp:HiddenField ID="HDDCodigo_are" runat="server" />
        <asp:HiddenField ID="HddNivel_are" runat="server" />
    </form>
</body>
</html>
