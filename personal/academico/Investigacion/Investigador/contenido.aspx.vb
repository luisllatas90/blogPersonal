...
Partial Class _COntenido
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If tipo = 1 Then
            Me.CmdNuevo_v1.Visible = False
            Me.CmdNuevo_v2.Visible = False
            Select Case estado
                Case 1
                    Me.LblTitulo.Text = "Perfil Por Revisar por Director de Departamento"
                Case 2
                    Me.CmdNuevo.Visible = False 'Agregada el 17-05-10 - CLLUEN
        ...
        If IsPostBack = False Then
            ...
            Me.CmdNuevo_v1.Attributes.Add("Onclick", "AbrirPopUp('frmInvestigacion2.aspx?id=" & Request.QueryString("id") & "','500','670'); return false;") '25/06/10
            Me.CmdNuevo_v2.Attributes.Add("Onclick", "AbrirPopUp('frmInvestigacion3.aspx?id=" & Request.QueryString("id") & "','480','650'); return false;")
            Me.CmdNuevo.Attributes.Add("Onclick", "AbrirPopUp('frmInvestigacion1.aspx?id=" & Request.QueryString("id") & "','480','650'); return false;")
