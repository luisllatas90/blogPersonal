<%@ Page Language="VB" AutoEventWireup="false" CodeFile="agregacomentario.aspx.vb" Inherits="Investigador_agregacomentario" %>
                    ...
                    <table class="contornotabla">
                        ...
                        <tr>
                            <td>
                                &nbsp;Observación</td>
                            <td colspan="2">
                                <asp:TextBox ID="TxtObservacion" runat="server" Rows="6" TextMode="MultiLine" Width="400px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Font-Size="8pt" ForeColor="Navy" Height="94px" MaxLength="2000" Font-Names="Arial"></asp:TextBox>
