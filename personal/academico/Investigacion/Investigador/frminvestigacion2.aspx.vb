Partial Class Investigador_frminvestigacion2
    ...
    Protected Sub CmdGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmdGuardar.Click
        ...
        codigo_inv = Request.QueryString("codigo_inv")
        If codigo_inv = "" Then
            codigo_inv = objNuevoInv.NuevoProyecto("1", Me.TxtTitulo.Text, 2, Me.DDLTematica.SelectedValue, 3, Me.FileProyecto, Me.TxtDuracion.Text, Me.DDLDuracion.SelectedValue, Me.DDLAmbito.SelectedValue, Me.DDLPoblacion.SelectedValue, Me.TxtDetalle.Text.Trim, Me.TxtCosto.Text, Me.DDLFinanciamiento.SelectedValue, strruta, Request.QueryString("id")).ToString

        Else
            codigo_inv = objNuevoInv.ModificarInvestigacion(codigo_inv, Me.TxtTitulo.Text.Trim, 1, 1, Me.FileProyecto, strruta, "N", 0, _
