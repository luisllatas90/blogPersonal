...
Public Class Investigacion_18-05-10
    ...
    ByVal ambito As String, ByVal poblacion As String, ByVal detallezona As String, ByVal ruta As String, ByVal codigo_per As String) As String
        ...
        Try
            ...
            nombreArchivo = retorno & "perfil" & System.IO.Path.GetExtension(archivo.FileName).ToLower()
            ...
            If Datos.Rows.Count > 0 Then
                If CInt(Datos.Rows(0).Item("codigo_per")) = codigo_per Then
                    ...
                    objMail.EnviarMail("investigaciones@usat.edu.pe", "SISTEMA DE INVESTIGACIONES", _strMailDirInv, "REVISION DE PERFIL", objMail.MensajeInvestigacion(5, Me._strNombreDIrInv, nombreautor, titulo_inv), True)
                Else
                    nombredirector = Datos.Rows(0).Item("director")
                    maildirector = Datos.Rows(0).Item("usuario_per").ToString.Trim & "@usat.edu.pe"
                    objMail.EnviarMail("investigaciones@usat.edu.pe", "SISTEMA DE INVESTIGACIONES", maildirector, "NUEVA INVESTIGACION", objMail.MensajeInvestigacion(1, nombredirector, nombreautor, titulo_inv), True)
                End If
            End If
     ...
     ByVal poblacion_inv As String, ByVal detallezona_inv As String, Optional ByVal DescripcionFinan As String = "") As Integer
        ...
        Try
            ...
            If codigo_eti = 1 Then
                ...
                If Datos.Rows.Count > 0 Then
                    If CInt(Datos.Rows(0).Item("codigo_per")) = codigo_per Then
                        ...
                        objMail.EnviarMail("investigaciones@usat.edu.pe", "SISTEMA DE INVESTIGACIONES", _strMailDirInv, "INVESTIGACION MODIFICADA", objMail.MensajeInvestigacion(5, Me._strNombreDIrInv, nombreautor, titulo_inv), True)
                    Else
                        nombredirector = Datos.Rows(0).Item("director")
                        maildirector = Datos.Rows(0).Item("usuario_per").ToString.Trim & "@usat.edu.pe"
                        objMail.EnviarMail("investigaciones@usat.edu.pe", "SISTEMA DE INVESTIGACIONES", maildirector, "NUEVA INVESTIGACION", objMail.MensajeInvestigacion(2, nombredirector, nombreautor, titulo_inv), True)
                    End If
                End If
            ...
            ElseIf codigo_eti = 2 Then
                ...
                'nombredirector = Datos.Rows(0).Item("director")
                'maildirector = Datos.Rows(0).Item("usuario_per").ToString.Trim & "@usat.edu.pe"
                objMail.EnviarMail("investigaciones@usat.edu.pe", "SISTEMA DE INVESTIGACIONES ", _strMailDirInv, "REVISION DE INVESTIGACION", objMail.MensajeInvestigacion(3, _strNombreDIrInv, nombreautor, titulo_inv), True)
            End If
    ...
    Public Function RegistrarAvances(ByVal codigo_inv As Integer, ByVal archivo As FileUpload, ByVal strruta As String, ByVal codigo_per As Integer) As Int16
        ...
        Try
            ...
            'nombredirector = Datos.Rows(0).Item("director")
            'maildirector = Datos.Rows(0).Item("usuario_per").ToString.Trim & "@usat.edu.pe"
            objMail.EnviarMail("investigaciones@usat.edu.pe", "SISTEMA DE INVESTIGACIONES ", _strMailDirInv, "REVISION DE INVESTIGACION", objMail.MensajeInvestigacion(7, _strNombreDIrInv, nombreautor, titulo_inv), True)
    ...
    Public Function RegistrarInformes(ByVal codigo_inv As Integer, ByVal archivo As FileUpload, ByVal strRuta As String, ByVal codigo_per As Integer) As Integer
        ...
        Try
            ...
            'nombredirector = Datos.Rows(0).Item("director")
            'maildirector = Datos.Rows(0).Item("usuario_per").ToString.Trim & "@usat.edu.pe"
            objMail.EnviarMail("investigaciones@usat.edu.pe", "SISTEMA DE INVESTIGACIONES ", _strMailDirInv, "REVISION DE INVESTIGACION", objMail.MensajeInvestigacion(8, _strNombreDIrInv, nombreautor, titulo_inv), True)
        ...
        Try
            ...
            Select Case Estado
                Case 7
                    ...
                    Datos.Dispose()
                    If tipo = 1 Then
                        objMail.EnviarMail("investigaciones@usat.edu.pe", "SISTEMA DE INVESTIGACIONES", mailautor, "REVISION DE INVESTIGACION", objMail.MensajeInvestigacion(4, nombreautor, "", ""), True)
                    ElseIf tipo = 3 Then
                        objMail.EnviarMail("investigaciones@usat.edu.pe", "SISTEMA DE INVESTIGACIONES", mailautor, "REVISION DE INVESTIGACION", objMail.MensajeInvestigacion(9, nombreautor, "", ""), True)
                    End If
                ...
                Case 8
                    ...
                    mailautor = Datos.Rows(0).Item("usuario_per").ToString.Trim & "@usat.edu.pe"
                    Datos.Dispose()
                    objMail.EnviarMail("investigaciones@usat.edu.pe", "SISTEMA DE INVESTIGACIONES", mailautor, "REVISION DE INVESTIGACION", objMail.MensajeInvestigacion(11, nombreautor, "", ""), True)
                ...
                Case 4
                    ...
                    mailautor = Datos.Rows(0).Item("usuario_per").ToString.Trim & "@usat.edu.pe"
                    Datos.Dispose()
                    objMail.EnviarMail("investigaciones@usat.edu.pe", "SISTEMA DE INVESTIGACIONES", mailautor, "REVISION DE INVESTIGACION", objMail.MensajeInvestigacion(12, nombreautor, "", ""), True)
                ...
                Case 2
                    ...
                    mailautor = Datos.Rows(0).Item("usuario_per").ToString.Trim & "@usat.edu.pe"
                    Datos.Dispose()
                    objMail.EnviarMail("investigaciones@usat.edu.pe", "SISTEMA DE INVESTIGACIONES", mailautor, "REVISION DE INVESTIGACION", objMail.MensajeInvestigacion(13, nombreautor, "", ""), True)
    ...
    Public Function ActualizarDecreto(ByVal Codigo_inv As Integer, ByVal Decreto As String, ByVal archivo As FileUpload, ByVal strRuta As String) As Integer
        ...
        Try
            ...
            mailautor = Datos.Rows(0).Item("usuario_per").ToString.Trim & "@usat.edu.pe"
            Datos.Dispose()
            objMail.EnviarMail("investigaciones@usat.edu.pe", "SISTEMA DE INVESTIGACIONES", mailautor, "REVISION DE INVESTIGACION", objMail.MensajeInvestigacion(6, nombreautor, "", ""), True)
