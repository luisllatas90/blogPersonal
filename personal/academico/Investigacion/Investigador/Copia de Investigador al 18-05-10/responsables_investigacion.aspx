<%@ Page Language="VB" AutoEventWireup="false" CodeFile="responsables_investigacion.aspx.vb" Inherits="Investigador_responsables_investigacion" %>
...
<body>
    ...
    <div>
        <table cellpadding="0" cellspacing="1" style="width: 100%">
            <tr>
                <td align="right" colspan="3" style="height: 27px" valign="top">
                    <asp:Button ID="CmdAgregar" runat="server" Text="     Agregar" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" CssClass="attach_prp" Height="24px" Width="79px" ToolTip="Agregue un responsable a esta investigación" /></td>
            </tr>
            <tr>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="codigo_Res"
            ...
            <Columns>
                ...
                <asp:CommandField ShowDeleteButton="True" ButtonType="Image" DeleteImageUrl="../../../../images/menus/noconforme_small.gif" HeaderText="Eliminar" >
                    <HeaderStyle BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" />
                    <ItemStyle HorizontalAlign="Center" />
                </asp:CommandField>
            </Columns>
