...
<head runat="server">
    <title>Investigaciones :: Agregar Responsables.</title>
...
<body style="margin-top:0px">
    ...
    <div>
        <table cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                <td align="left" colspan="3" rowspan="1" style="height: 31px; background-color: #f0f0f0">
                    &nbsp;
                    <asp:Button ID="CmdFinalizar" runat="server" CssClass="cerrar_prp" Height="14px"
            ...
            <tr>
                <td colspan="3" align="center">
                    <table style="width: 630px; height: 27px;" cellpadding="0" cellspacing="0" class="contornotabla">
                        <tr>
                                    ...
                                    <table style="width: 630px" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td colspan="2" align="center">
                                                &nbsp;<asp:ListBox ID="LstPersonal" runat="server" Width="601px" Rows="6" style="font-size: 8pt; color: navy; font-family: verdana" ToolTip="Seleccione un personal de la lista"></asp:ListBox></td>
                                        </tr>
                                    </table>
                                </asp:Panel>
            ...
            <tr>
                <td align="center" colspan="3" rowspan="1">
                    <asp:Panel ID="PanResponsables" runat="server" Height="150px" ScrollBars="Auto" Width="630px">
                        <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False" BorderColor="Transparent"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Situacion" Visible="False">
                                    <HeaderStyle BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" />
                                </asp:TemplateField>
