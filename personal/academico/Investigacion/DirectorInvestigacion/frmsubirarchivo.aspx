        ...
        <table id="tblDatos" cellpadding="0" cellspacing="0" style="width: 100%">
            ...
            <tr>
                <td align="center" colspan="3" rowspan="2">
                    <table class="contornotabla" style="width: 100%; height: 154px">
                        <tr>
                            <td colspan="3" style="font-weight: bold; font-size: 11pt; color: navy; font-family: verdana;
                                height: 28px; text-align: center">
                                <asp:Label ID="LblTituloFrm" runat="server">Registrar Decreto de Investigacion</asp:Label></td>
                        </tr>
                        <tr>
                            <td align="left" style="width: 202px; height: 27px">
                                &nbsp;Titulo</td>
                            <td align="left" style="height: 27px">
                                <asp:Label ID="LblTitulo" runat="server" ForeColor="Black"></asp:Label></td>
                        </tr>
                        <tr>
                            <td align="left" style="width: 202px; height: 6px">
                                &nbsp;Fechas</td>
                        ...
                        <tr>
                            ...
                            <td align="left" style="height: 13px">
                                <asp:TextBox ID="TxtDecreto" runat="server" BorderColor="Black" BorderStyle="Solid"
                                    BorderWidth="1px" Font-Names="verdana" Font-Size="XX-Small" ForeColor="Navy"
                                    Width="150px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtDecreto"
                                    ErrorMessage="Ingrese numero de Decreto" SetFocusOnError="True">*</asp:RequiredFieldValidator>Ej.
                                01-2007-II-PR-DI-USAT</td>
                        </tr>
                        <tr>
                            <td align="left" style="width: 202px; height: 13px">
                                &nbsp;Decreto</td>
                            <td align="left" style="height: 13px">
                                <asp:FileUpload ID="FileArchivo" runat="server" BorderStyle="Solid" BorderWidth="1px"
                                    Height="18px" Width="423px" /><asp:RegularExpressionValidator ID="RegularExpressionValidator1"
                                        runat="server" ControlToValidate="FileArchivo" ErrorMessage="Solo puede subir archivos con extension *.pdf"
                                        SetFocusOnError="True" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))+(.pdf|.PDF)$">*</asp:RegularExpressionValidator><asp:RequiredFieldValidator
                                            ID="RequiredFieldValidator4" runat="server" ControlToValidate="FileArchivo" ErrorMessage="Debe seleccionar un archivo para subir como decreto"
