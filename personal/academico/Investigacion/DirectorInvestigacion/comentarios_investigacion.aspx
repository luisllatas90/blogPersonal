<%@ Page Language="VB" AutoEventWireup="false" CodeFile="comentarios_investigacion.aspx.vb" Inherits="DirectorInvestigacion_comentarios_investigacion" %>
                        ...
                        <ItemTemplate>
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td style="font-weight: bold; font-size: 9pt; color: black; font-family: Verdana; width: 40px;">
                                        Fecha</td>
                                    <td style="font-size: 8pt; color: black; font-family: Verdana; width: 180px;">
                                        :<asp:Label ID="fecha_ComLabel" runat="server" Text='<%# Eval("fecha_Com") %>'></asp:Label></td>
                                </tr>
                                <tr>
                                    <td style="font-weight: bold; font-size: 9pt; color: black; font-family: Verdana; width: 90px;">
                                        Asunto</td>
                                    <td colspan="3" style="font-size: 8pt; color: black; font-family: Verdana">
                                ...
                                <tr>
                                    <td colspan="4" style="font-weight: bold; font-size: 9pt; color: black; font-family: Verdana">
                                        <hr />
                                    </td>
                                </tr>
                            </table>
