...
function ConsultarCursos()
{
	if (document.all.listadiv!=undefined){
		listadiv.innerHTML="<h5 align=center class=rojo>Procesando búsqueda, espere un momento...</h5>"
}
...
<table style="border-collapse: collapse" width="100%" <%=alto%>>
	<tr>
		...
		<img src="../../../../images/menus/buscar_small12.gif" alt="Abrir formulario de búsqueda" onclick="ConsultarCursos()" class="imagen">
		</td>
	</tr>
	<%if HayReg=true then%>
