...
<script type="text/javascript" language="javascript">
    function ConfirmarCurso() {
        var mensaje = ""
        mensaje = "¿Está completamente seguro que desea crear Habilitar el aula virtual para las asignaturas seleccionadas?"
...
<% '#if (rsCarga.BOF and rsCarga.EOF) then
  	'#	response.write "<h5 class=""usatsugerencia"">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No se han encontrado carga académica registrada para el ciclo académico actual</h5>"
  	'#else
  	
   if (rsCac.BOF and rsCac.EOF) then
      response.write "<h5 class=""usatsugerencia"">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No se han encontrado ciclos académicos activos</h5>"
   else
...
<table cellpadding="3" width="100%" class="contornotabla">
	<tr>
		<td class="etiqueta">Seleccionar Ciclo Académico </td>
...
<!--<input type="button" class="enviaryrecibir1"  value="        Habilitar"  
    disabled=true onClick="alert('Las aulas serán activadas esta semana.')" 
...
<table border="1" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#808080" width="100%">
  <tr class="etabla">
    ...
    <td width="5%" height="26">Sílabo</td>
  ...
  <%
 	...
 	if (request.querystring("codigo_cac")= "")  then
        response.write "<h5 class=""usatsugerencia"">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Debe seleccionar un ciclo académico para listar la carga académica</h5>"
    else
        if (rsCarga.BOF and rsCarga.EOF) then
          response.write "<h5 class=""usatsugerencia"">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No existe carga académica para el ciclo seleccionado </h5>"
        else
  	       do while not rsCarga.EOF 	
 	        i=i+1
...
<!--<input type="checkbox" onClick="VerificaCheckMarcados(chkcursoshabiles,cmdGuardar)" name="chkcursoshabiles" value="<%=rsCarga("codigo_cup")%>">-->
    ...
    <td width="10%" align="center" bgcolor="#FFFFFF" height="20"><%
            ...
            if Isnull(rsCarga("fechasilabo_cup"))=true then
                silabo = "<img src='../../../../images/bloquear.gif' border='0' alt='Sílabo no disponible'>"
            else
...
<!-- <br /><br />AVISO</p>
<p>Estimado Docente, el aula virtual será habilitada a partir del <b>25/07/2012</b><br /></p>-->
...
<p class="usatEtiqOblig">1. ¿Cómo activar un curso en el aula virtual?</p>
<p> Si tiene carga acádemica registrada, verá un listado de los cursos. Para activar deberá marcar el check del curso y luego hacer clic
en el botón <b>Habilitar Aula Virtual</b></p>

<p class="usatEtiqOblig">2. ¿Cómo acceder a mis cursos virtuales?</p>
<p>Para acceder a los cursos virtuales activados, deberá dirigirse al enlace <b>"Ingresar a Aula Virtual"</b> y luego dar clic en <b>"Clic para Ingresar"</b></p>

<!--<p class="usatEtiqOblig">1. ¿Qué debo hacer para agrupar asignaturas en el aula virtual?</p>
<p>Solicitar por email a evaluación y registros, el agrupamiento de asignaturas indicando las asignaturas que se agruparán y el motivo.</p>
-->

<!--<p class="usatEtiqOblig">2. ¿Cómo copio documentos de asignaturas anteriores a una asignatura en el ciclo actual? </p>
<p>Primero, debe <strong>habilitar el aula virtual</strong> para la asignatura correspondiente, luego debe hacer clic en el ícono
<img src="../../../../images/menus/attachfiles_small.gif" width="25" height="25"> para indicar de qué asignatura se copiarán los documentos..</p>
-->

<p class="usatEtiqOblig">3. ¿Qué debo hacer si no tengo asignada mi carga académica para el ciclo actual?</p>
<p>Solicitar por email a <strong>Evaluación y Registros</strong>, el registro de la carga académica en el Sistema.</p>
