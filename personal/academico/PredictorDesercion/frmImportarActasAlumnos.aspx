<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmImportarActasAlumnos.aspx.vb" Inherits="academico_PredictorDesercion_frmImportarActasAlumnos" %>
            ...
            return results[1];
              ...
              function Grabar() {
                  if (validar() == true) {
                      ...
                      var RowError=0
                      var result = 0;
                      var tam = data.Actas.length;
                      var regs = 0;
                      jQuery.each(data.Actas, function(i, val) {
                          regs = regs + 1;
                          $.ajax({
                              type: "POST",
                              //contentType: "application/json; charset=utf-8",
                              url: "../../DataJson/PredictorDesercion/ImportarActasAlumnos.aspx",
                              data: { "Funcion": "Post",
                              CODIGO: val.CODIGO,
                              MAT3: val.MAT3,
                              MAT4: val.MAT4,
                            ...
                            <div id="PanelBusqueda">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="page_header">
                                        <div class="pull-left">
                                            <i class="icon ti-volume page_header_icon"></i><span class="main-text">Cargar actas de Alumnos</span>
                                        </div>
           ...
           <div class="panel panel-piluku" id="PanelLista">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                Listado de Actas de Alumnos <span class="panel-options"><a class="panel-refresh" href="#">
                            ...
                            <div class="table-responsive">
                                <div id="tConvocatoria_wrapper" class="dataTables_wrapper" role="grid">
                                    <table id="tConvocatoria" name="tConvocatoria" class="display dataTable" width="100%">
                                        <thead>
                                            <tr role="row">
                                                <td width="5%" style="font-weight: bold; width: 30px; text-align: center" class="sorting_asc"
                                                ...
                                                <td width="40%" style="font-weight: bold; width: 250px; text-align: center" class="sorting"
                                                    tabindex="0" rowspan="1" colspan="1" aria-label="Tipo de Estudio: activate to sort column ascending">
                                                   ALUMNO
                                                </td>
                                                <td width="10%" style="font-weight: bold; width: 50px; text-align: center" class="sorting"
                                                ...
                                                <td width="7%" style="font-weight: bold; width: 50px; text-align: center" class="sorting"
                                                    tabindex="0" rowspan="1" colspan="1" aria-label="Estado: activate to sort column ascending">
                                                    5MAT
                                                </td>
                                                <td width="5%" style="font-weight: bold; width: 50px; text-align: center" class="sorting"
                                                    tabindex="0" rowspan="1" colspan="1" aria-label="Estado: activate to sort column ascending">
                                                    3COM
                                                </td>
                                                <td width="10%" style="font-weight: bold; width: 50px; text-align: center" class="sorting"
