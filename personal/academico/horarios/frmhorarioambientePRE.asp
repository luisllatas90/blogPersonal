...
Set Obj= Server.CreateObject("PryUSAT.clsAccesoDatos")
	obj.AbrirConexion
		...
		'if codigo_tfu=1 OR codigo_tfu=7 OR codigo_tfu=16 or codigo_tfu=18 or codigo_tfu=90 then
			'tipo="S"
		    'if(tipoestudio <> 2) then		    
		        Set rsEscuela=obj.Consultar("ConsultarCarreraProfesional","FO","PR",0)
		    'else		        
		...
		if codigo_cpf<>"-2" and codigo_cpf<>"" then
			...
			Set rsCursos=Obj.Consultar("ConsultarHorarios_pre","FO",codigo_cac,codigo_cpf,curso)
...
{
	location.href="frmhorarioambientePRE.asp?codigo_cac=" + cbocodigo_cac.value + "&codigo_cpf=" + cbocodigo_cpf.value + "&curso=" + termino
}
	...
	<tr height="40%" valign="top">
		<td width="100%" class="contornotabla" colspan="5">
			...
			<tr class="etabla">
				...
				<td width="20%" height="10%">Profesor</td>
