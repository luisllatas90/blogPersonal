...
<%
	...
	if Not(rsCursos.BOF and rsCursos.EOF) then
		if ((cint(codigo_cac) <= cint(session("codigo_cac"))) or (session("codigo_tfu")="1" or session("codigo_tfu")="15" or session("codigo_tfu")="41" or session("codigo_tfu")="9" or session("codigo_tfu")= 109 or session("codigo_tfu")= 11   or session("codigo_tfu")= 25   or session("codigo_tfu")= 103 )) then
