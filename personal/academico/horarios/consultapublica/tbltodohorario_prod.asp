...
<link href="../private/demo_table.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" language="JavaScript" src="../../../../private/funciones.js"></script>
<script type="text/javascript" language="JavaScript" src="../../../../private/tooltip.js"></script>
<script src="../private/jquery.dataTables.js" type="text/javascript"></script>
<script src="../private/jquery.js" type="text/javascript"></script>
<script src="../private/jquery.dataTables.min.js" type="text/javascript"></script>
<script src="../private/FixedHeader.js" type="text/javascript"></script>
<style type="text/css">
td {
	font-size: xx-small;
	text-align: center;
...
if (rsAmbiente.recordcount > 0) then
	Do while not rsAmbiente.EOF
		for c=0 to 90	
		    if c=0 then
			    response.write vbtab & "<td width='300px' class='etiquetaTabla' style='text-align:left'>" & "[" & rsAmbiente("ambiente_real") & "]</td>" & vbcrlf
            else
				if c=1 then dia="LU"
				if c=16 then dia="MA"
				if c=31 then dia="MI"
