...
Partial Class academico_horarios_administrar_frmSolicitudConfirmarAdmin
    ...
    Protected Sub gridHorario_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gridHorario.RowCommand
        ...
        If (e.CommandName = "EnviarNotificacion") Then
            Dim obj As New ClsConectarDatos
            obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
            obj.AbrirConexion()
            obj.Ejecutar("HorarioPE_ActualizarEstado2", gridHorario.DataKeys(index).Values("codigo_lho"), "N")
            EnviarCorreo(gridHorario.DataKeys(index).Values("codigo_lho"))
            consultarHorarios()
            obj.CerrarConexion()
            obj = Nothing
        End If
    ...
    Sub consultarHorarios()
        ...
        If Me.ddlRango.SelectedIndex = 0 Then
            dias_desde = 0
            dias_hasta = 3
        Else
            dias_desde = 4
        ...
        End If
        obj.AbrirConexion()
        Me.gridHorario.DataSource = obj.TraerDataTable("[HorarioPE_ConsultarSolConfirmar]", 0, dias_desde, dias_hasta)
        obj.CerrarConexion()
    ...
    Protected Sub gridHorario_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gridHorario.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.Cells(13).Text = "Confirmada" Then
                e.Row.Cells(13).ForeColor = Drawing.Color.Blue
                e.Row.Cells(10).Text = ""

            ElseIf e.Row.Cells(13).Text = "Cancelada" Then
                e.Row.Cells(13).ForeColor = Drawing.Color.Red
                e.Row.Cells(11).Text = ""

            Else
                e.Row.Cells(13).ForeColor = Drawing.Color.Green
            End If
    ...
    Protected Sub ddlRango_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlRango.SelectedIndexChanged
        consultarHorarios()
    End Sub
