<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSolicitudAmbienteV2.aspx.vb" Inherits="academico_horarios_frmSolicitudAmbienteV2" %>
    ...
    <tr>
     ...
     <tr>
        ...
        <asp:DropDownList ID="ddlFecha" runat="server" AutoPostBack="True">
          ...
          <asp:ListItem Value="31" Selected="True">Próximos 30 días</asp:ListItem>
