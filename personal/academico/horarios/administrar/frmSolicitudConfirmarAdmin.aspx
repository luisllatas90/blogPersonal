<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSolicitudConfirmarAdmin.aspx.vb" Inherits="academico_horarios_administrar_frmSolicitudConfirmarAdmin" %>
    ...
    <div>
      <table  cellpadding="3" cellspacing="0" style="border: 1px solid #C2CFF1; width:95%" >
        <tr style="background-color: #E8EEF7; font-weight: bold; height: 30px">
            <td colspan="7">Administrar Notificaciones de Solicitud de Ambientes</td>
        </tr>
        ...
        <asp:DropDownList ID="ddlRango" runat="server" AutoPostBack="True" 
            CssClass="style1">
            <asp:ListItem Value="3">0-3 días</asp:ListItem>
            <asp:ListItem Value="4">4-15 días</asp:ListItem>
        </asp:DropDownList>
        <br />
...
&nbsp;<asp:GridView ID="gridHorario" runat="server" AutoGenerateColumns="False"
             ...
             <Columns>
                 ...
                 <asp:TemplateField HeaderText="Cancelar Solicitud"
                     ...
                     ItemStyle-HorizontalAlign="Center" ItemStyle-Width="25px">
                     <ItemTemplate>
                         <asp:ImageButton ID="btnEnviarNotificacion" runat="server" 
                             CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>" 
                             CommandName="EnviarNotificacion" ImageUrl="~/administrativo/pec/image/sendmail.png" 
                             ToolTip="Enviar Notificacion" />
                     </ItemTemplate>
                     <ItemStyle HorizontalAlign="Center" />
                 </asp:TemplateField>
