<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRptAmbientesxFechaPostGrado.aspx.vb" Inherits="academico_horarios_administrar_frmRptAmbientesxFechaPostGrado" %>
    ...
    <form id="form1" runat="server">
     ...
     <table  cellpadding="3" cellspacing="0" style="border: 1px solid #C2CFF1; width:95%" >
        <tr style="background-color: #E8EEF7; font-weight: bold; height: 30px">
            <td colspan="7"><b>Consulta de Ambientes Asignados - POSTGRADO</b></td>            
        </tr>
        </table>
        <br />
        <table>
