...
<script language="JavaScript" src="../../../private/funciones.js?x=1"></script>
...
<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" <%=alto%>>
  ...
  <tr>
    ...
    <td width="73%" height="5%">
        <%call llenarlista("cbocodigo_cac","actualizarlista('vsthorarioambienteAsignadoNoConfirmado.asp?codigo_cac=' + this.value + '&codigo_amb=' + cbocodigo_amb.value)",rsCiclo,"codigo_cac","descripcion_cac",codigo_cac,"","","")%>
    </td>
  </tr>
  <tr>
