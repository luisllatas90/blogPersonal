...
Set Obj= Server.CreateObject("PryUSAT.clsAccesoDatos")
	obj.AbrirConexion
		...
		Set rsAmbiente=Obj.Consultar("ConsultarHorarios","FO",8,codigo_cac,0,0)
...
<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" <%=alto%>>
  ...
  <tr>
    ...
    <%call llenarlista("cbocodigo_cac","actualizarlista('vsthorarioambienteAsignado.asp?codigo_cac=' + this.value + '&codigo_amb=' + cbocodigo_amb.value)",rsCiclo,"codigo_cac","descripcion_cac",codigo_cac,"","","")%>
    </td>
  </tr>
  <tr>
    <td width="105" class="etiqueta">Ambiente</td>
    <td width="83%">
    <%call llenarlista("cbocodigo_amb","AbrirFicha('tblhorarioambienteAsignado.asp',0)",rsAmbiente,"codigo_amb","ambiente",codigo_amb,"Seleccione el Ambiente","","")%>
    </td>
  </tr>
</table>
<br>
	...
	<tr id="trDetalle" >
  		<td width="100%" height="100%">
			<table cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="100%">
				<tr height="5%">
					<td class="pestanaresaltada" id="tab" align="center" width="18%" onclick="AbrirFicha('tblhorarioambienteAsignado.asp',0)">
                    Vista Gráfica</td>
					<td width="1%" height="10%" class="bordeinf">&nbsp;</td>
					<td class="pestanabloqueada" id="tab" align="center" width="18%" onclick="AbrirFicha('tblcursosambienteAsignado.asp',1)">
                    Vista detalle</td>
