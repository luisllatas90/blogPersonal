...
Set Obj= Server.CreateObject("PryUSAT.clsAccesoDatos")
	obj.AbrirConexion
		Set rsHorario=obj.Consultar("ConsultarHorariosAmbiente","FO",7,codigo_cac,codigo_amb,0,0)
	obj.CerrarConexion
Set Obj=nothing
...
if Not(rsHorario.BOF and rsHorario.EOF) then
  if ((cint(codigo_cac) <= cint(session("codigo_cac"))) or (session("codigo_tfu")="1" or session("codigo_tfu")="15" or session("codigo_tfu")="41"  or session("codigo_tfu")="18" or session("codigo_tfu")="25" or session("codigo_tfu")="72" or session("codigo_tfu")="9" or session("codigo_tfu")="16" or session("codigo_tfu")="116"))   then
	dim dia,hora
