...
codigo_ctf=request.QueryString("ctf")
...
Set Obj= Server.CreateObject("PryUSAT.clsAccesoDatos")
	obj.AbrirConexion
		...
		'Set rsAmbiente=Obj.Consultar("ConsultarHorarios","FO",20,codigo_cac,0,0)
		'Set rsAmbiente=Obj.Consultar("ACAD_ListaAmbientexCiclo","FO",codigo_cac,codigo_ctf)
		
		Set rsAmbiente=Obj.Consultar("ACAD_ListaAmbientexCicloEscuelas","FO",codigo_cac,request.QueryString("id"),codigo_ctf)
...
<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" <%=alto%>>
  <tr>
    ...
    <p class="usattitulo">Consultar Horarios Por Ambiente Asignado</td>
  </tr>
  <tr>
    <td width="27%" height="5%" class="etiqueta">Ciclo Académico</td>
    <td width="73%" height="5%">
    <%call llenarlista("cbocodigo_cac","actualizarlista('vsthorarioambienteAsignadoNoConfirmadoEscuelas.asp?codigo_cac=' + this.value + '&codigo_amb=' + cbocodigo_amb.value + '&ctf=9&id=" + request.QueryString("id") + "')",rsCiclo,"codigo_cac","descripcion_cac",codigo_cac,"","","")    
    %>
    </td>
  </tr>
  <tr>
    ...
    <%
    call llenarlista("cbocodigo_amb","AbrirFicha('tblhorarioambienteAsignadoNoConfirmado.asp',0)",rsAmbiente,"codigo_amb","ambiente",codigo_amb,"Seleccione el Ambiente","","")    
    %>
    </td>
  </tr>
</table>
	...
	<tr id="trDetalle" >
  		<td width="100%" height="100%">
			<table cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="100%">
				<tr height="5%">
					<td class="pestanaresaltada" id="tab" align="center" width="18%" onclick="AbrirFicha('tblhorarioambienteAsignadoNoConfirmado.asp',0)">
                    Vista Gráfica</td>
					<td width="1%" height="10%" class="bordeinf">&nbsp;</td>
					<td class="pestanabloqueada" id="tab" align="center" width="18%" onclick="AbrirFicha('tblcursosambienteAsignadoNoConfirmado.asp',1)">
                    Vista detalle</td>
