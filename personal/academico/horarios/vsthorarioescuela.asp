...
<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" <%=alto%>>
  ...
  <tr>
    ...
    <td width="73%" colspan="3" height="5%"><%call ciclosAcademicos("actualizarlista('vsthorarioescuela.asp?codigo_cac='+this.value)",codigo_cac,"","")%></td>
  </tr>
  <tr>
    <td width="27%" height="5%">Escuela Profesional:</td>
    <td width="73%" colspan="3" height="5%"><%call escuelaprofesional("actualizarlista('vsthorarioescuela.asp?codigo_cpf='+this.value + '&codigo_cac=' + cbocodigo_cac.value)",codigo_cpf,"Seleccionar Escuela Profesional")%></td>
  </tr>
  <%if codigo_cpf<>"-2" then
  ...
  <tr>
    ...
    Mostrar asignaturas en una sola tabla Horario y la leyenda de descripción</td>
  </tr>
  -->
  <tr>
    <td width="27%" height="5%">&nbsp;</td>
    <td width="73%" colspan="3" height="5%">
    <input type="button" value="  Ver horarios" name="cmdGenerar" class="horario2" onClick="GenerarVistaHorario('HE')">
