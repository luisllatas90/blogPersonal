...
Partial Class personales
    ...
    Protected Sub CmdGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmdGuardar.Click
        ...
        valor = objPersonal.GrabaDatosPersonales(Me.LblPaterno.Text, _
                                                 ...
                                                 CType(Me.txtfecinusat.Text.Trim, Date))
    ...
    Protected Sub ddlEntidadFinancieraCuenta_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlEntidadFinancieraCuenta.SelectedIndexChanged
        Try
            'Response.Write(ddlEntidadFinancieraCuenta.SelectedValue)
        Catch ex As Exception
            Response.Write(ex.Message)
        End Try
    End Sub

    Protected Sub ddlRegimenSalud_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlRegimenSalud.SelectedIndexChanged
        Try
            'Response.Write(ddlRegimenSalud.SelectedValue)
        Catch ex As Exception
            Response.Write(ex.Message)
        End Try
    End Sub
    ...
    Protected Sub ddlTipoZona1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlTipoZona1.SelectedIndexChanged
        Try
            'Response.Write(ddlTipoZona1.SelectedValue)
        Catch ex As Exception
            Response.Write(ex.Message)
        End Try
    End Sub
