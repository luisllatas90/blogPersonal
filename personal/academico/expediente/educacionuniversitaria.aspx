                                    ...
                                    <tr>
                                        ...
                                        <td class="titulo_items" align="left">
                                            ...
                                            <asp:RangeValidator ID="RangeValidator4" runat="server" ControlToValidate="DDLInstitucion"
                                                ErrorMessage="Seleccione tipo de institución" MaximumValue="8000" MinimumValue="1"
                                                SetFocusOnError="True" ValidationGroup="titulo">*</asp:RangeValidator>
                                            <asp:Label ID="Label30" runat="server" Text="Modalidad"></asp:Label>
                                            <asp:DropDownList ID="DDLModalidad" runat="server" AutoPostBack="True" 
                                                CssClass="datos_combo" Width="199px">
                                            </asp:DropDownList>
                                            <asp:RangeValidator ID="RangeValidator7" runat="server" ControlToValidate="DDLModalidad"
                                                ErrorMessage="Seleccione la Modalidad" MaximumValue="8000" MinimumValue="1"
                                                SetFocusOnError="True" ValidationGroup="titulo">*</asp:RangeValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table id="Table1" class="borde_tab">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="middle" align="left">
                                            ...
                                            <asp:Label ID="Label31" runat="server" Text="Modalidad"></asp:Label>
                                            &nbsp;<asp:DropDownList ID="DDLModalidadGr" runat="server" AutoPostBack="True" 
                                                CssClass="datos_combo" Height="16px" Width="179px">
                                            </asp:DropDownList>
                                            <asp:RangeValidator 
                                                                ID="RangeValidator10" 
                                                                runat="server" 
                                                                ControlToValidate="DDLModalidadGr"
                                                                ValidationGroup="grado"
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" style="height: 32px">
                                            <asp:Button ID="CmdGrabarGrado" 
                                                        runat="server" 
                                                        CssClass="tab_normal" 
                                                        Text="Guardar" 
                                                        Width="85px" 
                                                        Height="24px" 
                                                        ValidationGroup="grado" /></td>
                                    </tr>
                                </table>
                            </asp:Panel>
                        </td>
