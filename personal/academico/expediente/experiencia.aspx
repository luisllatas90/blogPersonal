...
<head runat="server">
    ...
    <script type="text/javascript" src="private/expediente.js?x=1"></script>
...
<center>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <table cellpadding="0" cellspacing="0" class="style1">
            <tr>
                    <td align="left" valign="top" width="75%">
                           <table cellpadding="0" cellspacing="0" class="tabla_personal" style="width: 100%;height: 100%">
                                <tr>
                                    <td align="left" class="titulo_tabla" style="height: 29px">
                                        &nbsp;Registro de Experiencia Laboral y Asistencia a Eventos
                                    </td>
                                    <td align="right" class="titulo_tabla" style="height: 29px">
                                        <asp:Label 
                                                    ID="Label3" runat="server" Font-Bold="True" Font-Names="Verdana" 
                                                    Font-Size="10pt" ForeColor="White" Text="Paso 05 de 07">
                                        </asp:Label>
                                        &nbsp;&nbsp;&nbsp; 
                                    </td>
            </tr>
            
            <!-- Inicio Experiencia Académica -->
            <tr>
                ...
                <td align="center" style="padding-top: 5px; height: 147px" valign="top" 
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 98%">
                        <tr>
                            <td align="left">
                                <asp:LinkButton 
                                    ID="LinkVistaExperienciaUnv" 
                                    runat="server" 
                                    BorderColor="Silver" 
                                    BorderStyle="Solid"
                                    BorderWidth="1px" 
                                    CausesValidation="False" 
                                    CssClass="tab_seleccionado" 
                                    Height="27px"
                                    Width="126px">Datos Exp. Académica</asp:LinkButton>
                                    
                                 <asp:LinkButton ID="LinkAgregaExperienciaUnv"
                                 runat="server" 
                                 BorderColor="Silver" 
                                 BorderStyle="Solid" 
                                 BorderWidth="1px" 
                                 ...
                                 CssClass="tab_normal" 
                                 Height="27px" 
                                 Style="text-align: center" Width="130px">Agregar Experiencia Académica</asp:LinkButton></td>
                        </tr>
                        <tr>
                                    ...
                                    <table id="Table2" class="borde_tab">
                                        <tr>
                                            <td class="titulo_items" colspan="2" style="border-bottom: gold 1px solid; height: 22px">
                                                <asp:Label ID="LblExperienciaUnv" runat="server" Font-Bold="True" Font-Names="Verdana"
                                                    ForeColor="Navy"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td class="titulo_items" align="left">
                                                &nbsp;Institución/Empresa</td>
                                            <td class="titulo_items" align="left">
                                                <asp:TextBox ID="TxtEmpresaUnv" runat="server" BorderColor="Black" BorderStyle="Solid"
                                                    BorderWidth="1px" CssClass="datos_combo" Width="415px"></asp:TextBox><asp:RequiredFieldValidator
                                                        ID="RequiredFieldValidator5" runat="server" ControlToValidate="TxtEmpresaUnv" ErrorMessage="Ingrese institucion o empresa que laboró"
                                                        SetFocusOnError="True" ValidationGroup="experienciaUnv">*</asp:RequiredFieldValidator></td>
                                        </tr>
                                        <tr>
                                            <td class="titulo_items" align="left">
                                                &nbsp;Ciudad</td>
                                            <td class="titulo_items" style="width: 415px" align="left">
                                                <asp:TextBox ID="TxtCiudadUnv" runat="server" BorderColor="Black" BorderStyle="Solid"
                                                    BorderWidth="1px" CssClass="datos_combo" Width="166px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator
                                                        ID="RequiredFieldValidator6" runat="server" ControlToValidate="TxtCiudadUnv" ErrorMessage="Ingrese ciudad que laboró"
                                                        SetFocusOnError="True" ValidationGroup="experienciaUnv">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="titulo_items" align="left">
                                            ...
                                            <td class="titulo_items">
                                                <asp:DropDownList ID="DDLContratoUnv" runat="server" CssClass="datos_combo" 
                                                    Width="174px">
                                                </asp:DropDownList>
                                                <asp:CompareValidator 
                                                     ID="CompareValidator5" 
                                                     runat="server" 
                                                     ControlToValidate="DDLContratoUnv"
                                                    ErrorMessage="Seleccione tipo de contrato" Operator="NotEqual" SetFocusOnError="True"
                                                    ValueToCompare="0" Width="7px" ValidationGroup="experienciaUnv">*</asp:CompareValidator>
                                                Cargo &nbsp;<asp:DropDownList ID="DDLCargoUnv" runat="server" CssClass="datos_combo"
                                                    Width="184px">
                                                </asp:DropDownList>
                                                <asp:CompareValidator 
                                                    ID="CompareValidator6" 
                                                    runat="server" 
                                                    ControlToValidate="DDLCargoUnv"
                                                    ErrorMessage="Seleccione cargo" 
                                                    Operator="NotEqual" 
                                                    SetFocusOnError="True" 
                                                    ValueToCompare="0" 
                                                    ValidationGroup="experienciaUnv">*</asp:CompareValidator></td>
                                        </tr>
                                        <tr style="color: #808000">
                                            <td class="titulo_items" align="left">
                                                &nbsp;Función Desempeño</td>
                                            <td class="titulo_items" align="left" style="font-size: 10pt; color: olive; font-family: Verdana">
                                                <asp:TextBox ID="TxtFuncionUnv" runat="server" BorderColor="Black" BorderStyle="Solid"
                                        ...
                                        <tr style="color: #808000">
                                            ...
                                            <td class="titulo_items">
                                                Inicio
                                                <asp:DropDownList ID="DDLMesIniUnv" runat="server" CssClass="datos_combo" 
                                                    Width="68px">
                                                ...
                                                <asp:DropDownList ID="DDLAnioIniUnv" runat="server" CssClass="datos_combo"
                                                    Width="65px">
                                                </asp:DropDownList>
                                                Fin
                                                <asp:DropDownList ID="DDLMesFinUnv" runat="server" CssClass="datos_combo" 
                                                    Width="68px">
                                                ...
                                                <asp:DropDownList ID="DDLAnioFinUnv" runat="server" CssClass="datos_combo"
                                                    Width="68px">
                                                </asp:DropDownList>
                                                <asp:CustomValidator 
                                                    ID="CustomValidator10" 
                                                    runat="server" ClientValidationFunction="validaexperienciaUnv"
                                                    ErrorMessage="Ambas fecha de fin deben estar en curso o seleccione una fecha correcta" 
                                                    ValidationGroup="experienciaUnv">*</asp:CustomValidator></td>
                                        </tr>
                                        <tr>
                                            <td class="titulo_items" align="left">
                                                &nbsp;Motivo de Cese</td>
                                            <td class="titulo_items" style="width: 415px" align="left">
                                                <asp:DropDownList ID="DDLCeseUnv" runat="server" CssClass="datos_combo" Enabled="False"
                                                    Width="170px">
                                                ...
                                                <asp:CustomValidator 
                                                    ...
                                                    runat="server" 
                                                    ClientValidationFunction="valida2experienciaUnv"
                                                    ErrorMessage="Seleccione motivo de cese" 
                                                    ValidationGroup="experienciaUnv">*</asp:CustomValidator></td>
                                        </tr>
                                        <tr>
                                            <td class="titulo_items" align="left">
                                            ...
                                            <td id="Td1" class="titulo_items" style="font-size: 10pt; color: olive; font-family: Verdana">
                                                <asp:TextBox ID="TxtDescripcionUnv" runat="server" BorderColor="Black" BorderStyle="Solid"
                                                    BorderWidth="1px" CssClass="datos_combo" Height="53px" MaxLength="400" TextMode="MultiLine"
                                                    Width="418px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator7"
                                                        runat="server" ControlToValidate="TxtDescripcionUnv" ErrorMessage="Ingrese breve descripcion de labor desempeñada"
                                                        SetFocusOnError="True" ValidationGroup="experienciaUnv">*</asp:RequiredFieldValidator></td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td align="right">
                                                <asp:Button ID="CmdGuardarUnv" runat="server" CssClass="tab_normal" 
                                                    Height="24px" Text="Guardar"
                                                    ValidationGroup="experienciaUnv" Width="85px" /></td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                                <!-- Listado de registros -->
                                <asp:Panel ID="Panel6" runat="server" Width="100%">
                                            <asp:GridView ID="GridViewUnv" runat="server" AllowSorting="True" 
                                                AutoGenerateColumns="False" DataSourceID="ObjExperienciaAcac"
                                                Width="100%" DataKeyNames="codigo_exp" AllowPaging="True" PageSize="6" 
                                    ...
                                    <table id="tabla" class="borde_tab">
                                        ...
                                        <tr style="color: #808000">
                                            ...
                                            <td class="titulo_items">
                                                ...
                                                <asp:DropDownList ID="DDLAnioIni" runat="server" CssClass="datos_combo"
                                                    Width="65px">
                                                </asp:DropDownList>
                                                Fin
                                                ...
                                                <asp:DropDownList ID="DDLAnioFin" runat="server" CssClass="datos_combo"
                                                    Width="68px">
                                                </asp:DropDownList>
                                                <asp:CustomValidator 
                                                        ID="CustomValidator1" 
                                                        runat="server" 
                                                        ClientValidationFunction="validaexperiencia"
                                                        ErrorMessage="Ambas fecha de fin deben estar en curso o seleccione una fecha correcta" 
                                                        ValidationGroup="experiencia">*</asp:CustomValidator></td>
                                        </tr>
                                        <tr>
                                            <td class="titulo_items">
                                                &nbsp;Motivo de Cese</td>
                                            <td class="titulo_items" style="width: 415px">
                                                ...
                                                <asp:CustomValidator 
                                                    ID="CustomValidator2" 
                                                    runat="server" 
                                                    ClientValidationFunction="valida2experiencia"
                                                    ErrorMessage="Seleccione motivo de cese" 
                                                    ValidationGroup="experiencia">*</asp:CustomValidator></td>
                                        </tr>
                                        <tr>
                            ...
                            <td align="center" class="borde_tab" style="height: 230px" valign="top">
                                ...
                                <asp:Panel ID="Panel4" runat="server" Visible="False" Width="100%">
                                    <table id="Table1" class="borde_tab">
                                        ...
                                        <tr>
                                            <td class="titulo_items" colspan="2" align="left">
                                                Buscar Eventos por: &nbsp;
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" valign="middle">
                                                ...
                                                <asp:RadioButton ID="RbAcademico" runat="server" AutoPostBack="True" 
                                                    Checked="True" GroupName="tipoeven" Text="Academico" />
                                                <asp:RadioButton  ID="RbSocial" runat="server" AutoPostBack="True" 
                                                    GroupName="tipoeven" Text="Social" Width="60px" />
                                            ...
                                            <td class="titulo_items" colspan="2" align="left">
                                                ...
                                                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="DDLTIpo"
                                                   ...
                                                   <!--Procedencia: -->
                                                       ...
                                                       <asp:DropDownList ID="DDLProcedenciaEve" runat="server" Width="111px" 
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:CheckBoxList ID="ChkParticipa" runat="server" BorderStyle="None" BorderWidth="1px"
                                                    CssClass="titulo_items" RepeatColumns="5" Width="100%">
                                                </asp:CheckBoxList>
                                                </td>
                                        </tr>
                                        <tr>
                                ...
                                <table align="left">
                                    ...
                                    <tr>
                                        ...
                                        <a href="experiencia.aspx?menu= <%=Request.querystring("menu")%>&id=<%=Request.querystring("id")%>&ctf=<%=Request.querystring("ctf")%>">                                         
                                            <img border=0 alt="Experiencia laboral y asistencia a eventos" 
                                                src="images/hojavida/exepriencia_r.gif" />
                                        </a>    
                                            </td>
                                    </tr>
                                    <tr>
            ...
            <SelectParameters>
                ...
                <asp:Parameter DefaultValue="&quot;&quot;" Name="param2" Type="String" />
                                            ...
                                            <asp:ObjectDataSource 
                                                        ID="ObjExperiencia" 
                                                        runat="server" 
                                                        DeleteMethod="QuitarExperiencia"
                                                        SelectMethod="ObtieneDatosExperiencia" 
                                                        TypeName="Personal">
                                                <DeleteParameters>
                                            ...
                                            <!--Source Experiencia Académica -->
                                                 <asp:ObjectDataSource 
                                                        ID="ObjExperienciaAcac" 
                                                        runat="server" 
                                                        DeleteMethod="QuitarExperiencia"
                                                        SelectMethod="ObtieneDatosExperiencia" 
                                                        TypeName="Personal">
                                                    ...
                                                    <SelectParameters>
                                                        <asp:SessionParameter 
                                                            ...
                                                            SessionField="id" 
                                                            Type="Object" />
                                                        <asp:Parameter Name="tipo" DefaultValue="PA" />
                                                    </SelectParameters>
                                                </asp:ObjectDataSource>
                                            <!--Source para Experiencia Académica -->
                                            
        <asp:HiddenField ID="HddExperiencia" runat="server" />
        <asp:HiddenField ID="HddExperienciaUnv" runat="server" />
        ...
        <asp:ValidationSummary ID="ValidationSummary4" runat="server" DisplayMode="List"
            ShowMessageBox="True" ShowSummary="False" ValidationGroup="experienciaUnv" />
        ...
        <Triggers>
                ...
                <asp:PostBackTrigger ControlID="CmdGuardarUnv"/>
