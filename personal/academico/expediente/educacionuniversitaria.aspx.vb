...
Partial Class educacionuniversitaria
    ...
    Protected Sub CargarInicioTitulos()
        ...
        '**------------------------------------------
        'Agregado xDguevara 03.10.2013
        objCOmbo.llenaModalidad(DDLModalidad)
        '**------------------------------------------
    ...
    Protected Sub CargarInicioGrados()
        ...
        '** Modalidad **  dguevara 04.10.2013 
        objCOmbo.llenaModalidad(Me.DDLModalidadGr)
        '--------------------------------------------
    ...
    Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridView1.RowEditing
        ...
        If Me.GridView1.DataKeys.Item(e.NewEditIndex).Value IsNot Nothing Then
            ...
            With datos.Rows(0)
                ...
                '**Modalidad ***  -->  add dguevara 04.10.2013  <--
                If .Item("codigo_mod") = 0 Then
                    Me.DDLModalidad.SelectedValue = 0
                Else
                    Me.DDLModalidad.SelectedValue = .Item("codigo_mod")
                End If
                '-----------------------------------------------------------------
    ...
    Public Sub GuardarTitulos()
        Dim objpersonal As New Personal
        Dim codTpf, anoing, anoegr, anotitu, codins, codsit, codmod As Integer
        ...
        Try
            ...
            codmod = CInt(Me.DDLModalidad.SelectedValue)    'add dguevara 04.10.2013.

            'Response.Write(codmod)
            ...
            If Me.HddTitulo.Value = "-1" Then
                valor = objpersonal.GrabarTitulos(codTpf, strtitulo, anoing, anoegr, anotitu, strinstitucion, codsit, codins, codmod)
            Else
                valor = objpersonal.ModificaTitulos(codTpf, strtitulo, anoing, anoegr, anotitu, strinstitucion, codsit, codins, Me.HddTitulo.Value, codmod)
            End If
    ...
    Protected Sub GridView2_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridView2.RowEditing
        ...
        If Me.GridView2.DataKeys.Item(e.NewEditIndex).Value IsNot Nothing Then
            ...
            With Datos.Rows(0)
                ...
                '** Modalidad ** dguevara 04.10.2013 --------------------------------
                If .Item("codigo_mod") = 0 Then
                    Me.DDLModalidadGr.SelectedValue = 0
                Else
                    Me.DDLModalidadGr.SelectedValue = .Item("codigo_mod")
                End If
                '--------------------------------------------------------------------

                'El codigo_pai esta relaciondo con la tabla instituacion a la que esta amarrada el pais de procedencia.
                'codigo_pai=156 ->> Perú.
                If Datos.Rows(0).Item("codigo_pai").ToString = "156" Then
                    Me.DDLProcedencia.SelectedValue = 1
    ...
    Public Sub GuardarGrado()
        ...
        Dim objpersonal As New Personal
        Dim codGpr, anoing, anoegr, anotitu, codins, codsit, codmod As Integer
        ...
        Try
            ...
            codmod = CInt(Me.DDLModalidadGr.SelectedValue)  'add dguevara 04.10.2013
            ...
            If Me.HddGrado.Value = "-1" Then
                valor = objpersonal.GrabarGrados(codGpr, strgrado, anoing, anoegr, anotitu, StrMencion, strinstitucion, codsit, codins, codmod)
            Else
                valor = objpersonal.ModificaGrados(codGpr, strgrado, anoing, anoegr, anotitu, StrMencion, strinstitucion, codsit, codins, Me.HddGrado.Value, codmod)
            End If
