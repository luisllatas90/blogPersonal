...
Partial Class Consultas_hojavida
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        If Me.DatPublicaciones.Items.Count = 0 Then
            Me.lblPublicaciones.Visible = False
        Else
            Me.lblPublicaciones.Text = Me.lblPublicaciones.Text & "<br><br>"
        End If
    ...
    Public Function HTML() As String
        ...
        Me.DatGrados.EnableViewState = False
        page1.EnableViewState = False

        page1.Controls.Add(form1)
        form1.Controls.Add(Me.Table1)
    ...
    Protected Sub pdp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles pdp.Click
        ...
        'Cambio 02.11.2012
        'xDguevara
        Response.Redirect("../../../../personal/pdp/" & pdp)
