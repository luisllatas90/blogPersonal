<%@ Page Language="VB" AutoEventWireup="false" CodeFile="personal.aspx.vb" Inherits="Consultas_hojavida" %>
...
<body>
    ...
    <asp:ObjectDataSource ID="Grados" runat="server" SelectMethod="ObtieneDatosGrados"
                                                TypeName="Personal">
                                                <SelectParameters>
                                                    <asp:QueryStringParameter Name="idpersonal" QueryStringField="id" Type="String" />
        ...
        <asp:ObjectDataSource ID="ObjEventos" runat="server" SelectMethod="ObtieneDatosEventos"
            TypeName="Personal">
            <SelectParameters>
                <asp:QueryStringParameter Name="idpersonal" QueryStringField="id" Type="Object" />
    ...
    <asp:ObjectDataSource ID="ObjInvestigaciones" runat="server" SelectMethod="ObtieneInvestigaciones" TypeName="Personal">
            <SelectParameters>
                <asp:QueryStringParameter Name="codigo_per" QueryStringField="id" Type="Int32" />
            </SelectParameters>
    </asp:ObjectDataSource>
        <asp:ObjectDataSource ID="ObjPublicaciones" runat="server" 
            SelectMethod="ConsultarPublicaciones" TypeName="Personal">
             <SelectParameters>
                <asp:QueryStringParameter Name="codigo_per" QueryStringField="id" Type="Int32" />
                  <asp:Parameter DefaultValue="0" Name="codigo_pub" Type="Int32"/>
            </SelectParameters>
        </asp:ObjectDataSource>
        <asp:Table ID="Table1" runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" CellPadding="0" CellSpacing="0" Height="98px" HorizontalAlign="Center" Width="144px">
            ...
            <tbody>
                ...
                <tr>
                    <td align="center" colspan="3">
                        <asp:Label ID="LblNombres" runat="server" style="text-transform: uppercase; color: navy; font-family: verdana" Font-Bold="True" Font-Names="Arial" Font-Size="Medium" ForeColor="Black"></asp:Label></td>
                </tr>
                <tr>
                    <td />
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <asp:Label ID="LblSeminarios" runat="server" Font-Bold="True" Font-Size="X-Small"
                            Font-Underline="True" ForeColor="Black" Text="ASISTENCIA A SEMINARIOS - TALLERES - CONGRESOS"></asp:Label><asp:DataList ID="DatSeminarios" runat="server" DataSourceID="ObjEventos" Width="100%">
                            <ItemTemplate>
                                <table cellpadding="1" cellspacing="0" style="width: 100%">
                                    <tr>
                        ...
                        <asp:Label ID="lblPublicaciones" runat="server" Font-Bold="True" Font-Size="X-Small"
                            Font-Underline="True" ForeColor="Black" Text="PUBLICACIONES"></asp:Label>
                        <asp:DataList ID="DatPublicaciones" runat="server" DataKeyField="codigo_pub" DataSourceID="ObjPublicaciones"
                            Width="100%">
                            <ItemTemplate>
                                <table cellpadding="1" cellspacing="0" style="font-size: 8pt; color: maroon; font-family: verdana"
                                    width="100%">
                                    <tr>
                                        ...
                                        <td style="font-size: 8pt; color: navy; font-family: verdana; font-weight: bold;">
                                            <asp:Label ID="descripcion_tdisLabel" runat="server" Text='<%# Eval("nombre") %>'></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="color: maroon">
                                            &nbsp;Editorial</td>
                                        <td style="font-size: 8pt; color: navy; font-family: verdana">
                                            <asp:Label ID="otorgado_disLabel" runat="server" Text='<%# Eval("editorial") %>'></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td style="color: maroon;">
                                            &nbsp;Procedencia</td>
                                        <td style="font-size: 8pt; color: navy; font-family: verdana;">
                                            <asp:Label ID="ciudad_disLabel" runat="server" Text='<%# Eval("procedencia") %>'></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td style="color: maroon">
                                            &nbsp;Autoria</td>
                                        <td style="font-size: 8pt; color: navy; font-family: verdana">
                                            <asp:Label ID="fechaentrega_disLabel" runat="server" Text='<%# Eval("autoria") %>'></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td style="color: maroon">
                                            &nbsp;Tipo</td>
                                        <td style="font-size: 8pt; color: navy; font-family: verdana">
                                            <asp:Label ID="motivo_disLabel" runat="server" Text='<%# Eval("tipo") %>'></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td style="color: maroon">
                                            &nbsp;Información</td>
                                        <td style="font-size: 8pt; color: navy; font-family: verdana">
                                            <asp:Label ID="Label2" runat="server" Text='<%# Eval("info") %>'></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="font-size: 8pt; color: navy; font-family: verdana">
                                            &nbsp;
