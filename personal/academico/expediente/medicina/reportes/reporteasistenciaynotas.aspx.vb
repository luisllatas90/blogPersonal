...
Partial Class medicina_reportes_reporteasistenciaynotas
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            fila = e.Row.DataItem
            e.Row.ToolTip = "TEMAS: " & fila.Row("temas_act").ToString
            ...
            If consideraasistencia = 1 Then
                ...
                If fila.Row("tipoasistencia_act") Is System.DBNull.Value Or fila.Row("tipoasistencia_act").ToString.ToUpper.Trim = "F" Then
