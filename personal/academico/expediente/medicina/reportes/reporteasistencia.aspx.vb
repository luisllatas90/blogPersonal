...
Partial Class medicina_reportes_reporteasistencia
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Actividades = obj.TraerDataTable("MED_COnsultarActividades", 1, Request.QueryString("codigo_syl"), "S")
        ...
        If Alumnos.Rows.Count > 0 Then
            ...
            For i As Int16 = 0 To Alumnos.Rows.Count - 1
                ...
                If Codigo_alu <> CInt(Alumnos.Rows(i).Item("codigo_Alu").ToString) Then
                    ...
                    Asistencia = obj.TraerDataTable("MED_ConsultarAsistenciaAlumno", "AS", Request.QueryString("codigo_syl"), Alumnos.Rows(i).Item("codigo_dma"))
                    For j As Integer = Actividades.Rows.Count - 1 To 0 Step -1
                        ...
                        For k As Integer = 0 To Asistencia.Rows.Count - 1
                            If Actividades.Rows(j).Item("codigo_act").ToString = Asistencia.Rows(k).Item("codigo_act").ToString Then
                                CelAsist.Text = IIf(Asistencia.Rows(k).Item("tipoasistencia_act").ToString = " ", "F", Asistencia.Rows(k).Item("tipoasistencia_act").ToString)
                                If CelAsist.Text = "F" Then
                                    CelAsist.ForeColor = Drawing.Color.Red
                                Else
