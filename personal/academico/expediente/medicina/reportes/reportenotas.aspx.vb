...
Partial Class medicina_reportes_reportenotas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Actividades = obj.TraerDataTable("MED_COnsultarActividades", 2, Request.QueryString("codigo_syl"), "S")
        ...
        If Alumnos.Rows.Count > 0 Then
            ...
            For j As Integer = Actividades.Rows.Count - 1 To 0 Step -1
                If Actividades.Rows(j).Item("Considerarnota_act").ToString = "S" Then
            ...
            For i As Int16 = 0 To Alumnos.Rows.Count - 1
                ...
                If Codigo_alu <> CInt(Alumnos.Rows(i).Item("codigo_Alu").ToString) Then
                    ...
                    Asistencia = obj.TraerDataTable("MED_ConsultarAsistenciaAlumno", "NO", Request.QueryString("codigo_syl"), Alumnos.Rows(i).Item("codigo_dma"))
                    For j As Integer = Actividades.Rows.Count - 1 To 0 Step -1
                        If Actividades.Rows(j).Item("Considerarnota_act").ToString = "S" Then
                            ...
                            For k As Integer = 0 To Asistencia.Rows.Count - 1
                                If Actividades.Rows(j).Item("codigo_act").ToString = Asistencia.Rows(k).Item("codigo_act").ToString Then
                                    If Asistencia.Rows(k).Item("NOta") IsNot System.DBNull.Value Then
                                        CelAsist.Text = FormatNumber(Asistencia.Rows(k).Item("NOta").ToString, 2, TriState.True, TriState.False)
    ...
    Public Function HTML() As String
        ...
        writer2.Write("<font face='verdana' size='2' color='#121212'>Reporte de Notas - USAT<br>Actualizado al :" & Date.Now() & "</font>")
        page1.Dispose()
        page1 = Nothing
