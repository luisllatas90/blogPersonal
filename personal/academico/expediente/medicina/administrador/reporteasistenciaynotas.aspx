<%@ Page Language="VB" AutoEventWireup="false" CodeFile="reporteasistenciaynotas.aspx.vb" Inherits="medicina_administrar_reporteasistenciaynotas" %>
...
&nbsp;&nbsp;&nbsp;&nbsp; Fecha Fin:
    ...
    <asp:HiddenField runat="server" id="codigo_syl" />
