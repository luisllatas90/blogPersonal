...
Partial Class medicina_administrador_BusquedaAlumno
    ...
    Protected Sub CmdBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmdBuscar.Click
        ...
        obj.AbrirConexion()
        If Me.DdlBusqueda.SelectedValue = 1 Then
            Me.GridAlumnos.DataSource = obj.TraerDataTable("med_consultaralumno", "CU5", Me.TxtBusqueda.Text)
        Else
            Me.GridAlumnos.DataSource = obj.TraerDataTable("med_consultaralumno", "AL5", Me.TxtBusqueda.Text)
        End If
        obj.CerrarConexion()
