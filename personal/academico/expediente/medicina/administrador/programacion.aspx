<%@ Page Language="VB" AutoEventWireup="false" CodeFile="programacion.aspx.vb" Inherits="medicina_administrador_programacion" %>
...
<body style="margin:0,0,0,0">
    ...
    <div>
        <table width="100%">
            <tr>
                <td colspan="3" style="border-top: black 1px solid; font-weight: bold; font-size: 11pt;
                    ...
                    Programación de Actividades</td>
            </tr>
            <tr>
                <td>
                    &nbsp;
            ...
            <tr>
                <td align="center" colspan="3" style="height: 47px">
                    <asp:Label ID="LblMensaje" runat="server" Font-Names="Verdana" Font-Size="11pt" ForeColor="Red"></asp:Label>&nbsp;<br />
                    <br />
                    Actividades
                    <br />
                    <br />
                    <asp:Table ID="TblActividades" runat="server" Width="90%" CellPadding="4" CellSpacing="0" BorderWidth="0px">
                    </asp:Table>
                </td>
            </tr>
        </table>
        ...
        <asp:HiddenField ID="HddCodSyl" runat="server" />
    </form>
</body>
</html>
