<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BusquedaAlumno4.aspx.vb" Inherits="medicina_administrador_BusquedaAlumno" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="font-weight: bold;
                    ...
                    ">
                Mostrar Asistencias y Notas Parciales por Estudiante</td>
        </tr>
        <tr>
            <td>
                &nbsp;</td>
        ...
        <tr >
            <td>
                Busqueda por:                 <asp:DropDownList ID="DdlBusqueda" runat="server" AutoPostBack="True">
                    ...
                    <asp:ListItem Value="2" Selected="True">Apellidos y Nombres</asp:ListItem>
                </asp:DropDownList>
...
&nbsp;
    ...
    Width="100%" style="text-align: center">
                        ...
                        <EmptyDataTemplate>
                            <label style="color:Red">No se encontro ninguna coincidencia</label>
                        </EmptyDataTemplate>
