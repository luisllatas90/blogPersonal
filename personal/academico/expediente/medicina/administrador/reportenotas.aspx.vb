...
'@funcion = Reporte de notas

Partial Class medicina_administrador_reportenotas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Actividades = obj.TraerDataTable("MED_COnsultarActividades", 2, Codigo_syl, "S")
        obj.CerrarConexion()
        ...
        If Alumnos.Rows.Count > 0 Then
            ...
            For i As Int16 = 0 To Alumnos.Rows.Count - 1
                ...
                If Codigo_alu <> CInt(Alumnos.Rows(i).Item("codigo_Alu").ToString) Then
                    ...
                    obj.AbrirConexion()
                    Asistencia = obj.TraerDataTable("MED_ConsultarAsistenciaAlumno", "NO", codigo_syl, Alumnos.Rows(i).Item("codigo_dma"))
                    obj.CerrarConexion()
