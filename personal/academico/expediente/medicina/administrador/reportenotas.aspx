<%@ Page Language="VB" AutoEventWireup="false" CodeFile="reportenotas.aspx.vb" Inherits="medicina_administrador_reportenotas" %>
        ...
        <tr >
            <td colspan="2">
                <asp:Button ID="CmdRegresar" runat="server" CssClass="salir" 
                    Text="      Regresar" 
                    onclientclick="javascript:location.href='administrar.aspx'; return false;" Width="78px" />
