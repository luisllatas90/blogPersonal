<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EvaluacionesRegistradas.aspx.vb" Inherits="medicina_administrador_EvaluacionesRegistradas" %>
        ...
        <table width="100%">
            ...
            <tr>
                <td align="center" colspan="3">
                    <asp:Label ID="LblMensaje" runat="server" Font-Names="Verdana" Font-Size="11pt" ForeColor="Red"></asp:Label>&nbsp;</td>
            </tr>
            <tr>
                <td align="center" colspan="3" style="height: 32px; font-weight: bold; text-decoration: underline;" valign="bottom">
                    Evaluaciones Pendientes&nbsp; de Ingreso de Notas</td>
            </tr>
            <tr>
                <td align="center" colspan="3">
                    <br />
