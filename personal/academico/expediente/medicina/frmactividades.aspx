<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmactividades.aspx.vb" Inherits="medicina_frmactividades" %>
            ...
            <tr>
                <td colspan="3" rowspan="3">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TxtNombre" runat="server" BorderStyle="Solid" BorderWidth="1px"
                                    Font-Names="Verdana" Font-Size="8pt" TextMode="MultiLine" Width="241px" Height="38px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TxtNombre"
                                    ErrorMessage="Nombre actividad requerida" SetFocusOnError="True">*</asp:RequiredFieldValidator></td>
                        </tr>
                        <tr>
                            <td style="font-weight: bold; width: 164px">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="TxtHoraIni" runat="server" BorderStyle="Solid" BorderWidth="1px"
                                    Font-Names="Verdana" Font-Size="8pt" MaxLength="2" Width="25px"></asp:TextBox><strong><asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="TxtHoraIni"
                                            ErrorMessage="Hora debe estar entre 1 y 12" MaximumValue="12" MinimumValue="1"
                                            SetFocusOnError="True" Type="Integer">*</asp:RangeValidator></strong><b>:<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TxtHoraIni"
                                            ErrorMessage="Hora de Inicio Requerida" SetFocusOnError="True">*</asp:RequiredFieldValidator></b><asp:TextBox ID="TxtMinutoIni" runat="server" BorderStyle="Solid" BorderWidth="1px"
                                    Font-Names="Verdana" Font-Size="8pt" MaxLength="2" Width="25px"></asp:TextBox><asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="TxtMinutoIni"
                                    Display="Dynamic" ErrorMessage="Minuto debe estar entre 0 - 59" Operator="LessThanEqual"
                                    SetFocusOnError="True" Type="Integer" ValueToCompare="59">*</asp:CompareValidator><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TxtMinutoIni"
                                    ErrorMessage="Minutos de Inicio requeridos" SetFocusOnError="True">*</asp:RequiredFieldValidator><asp:DropDownList ID="DDlHorario" runat="server" Width="38px">
                                    <asp:ListItem Value="-1">---</asp:ListItem>
                                    <asp:ListItem Value="1">a.m.</asp:ListItem>
                                    <asp:ListItem Value="2">p.m.</asp:ListItem>
                                </asp:DropDownList>
                                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="DDlHorario"
                                    ErrorMessage="Seleccione Horario" Operator="NotEqual" Type="Integer" ValueToCompare="-1">*</asp:CompareValidator></td>
                        </tr>
                        <tr>
                            <td style="font-weight: bold; width: 164px">
                                Estado</td>
                        ...
                        <tr>
                            <td style="font-weight: bold; width: 164px; height: 30px">
                            </td>
