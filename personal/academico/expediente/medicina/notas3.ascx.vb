...
Partial Class medicina_notas3
    ...
    Public WriteOnly Property ToolNotas3() As String
        Set(ByVal value As String)
            Me.TxtNota3.ToolTip = value
        End Set
    End Property
    ...
    Public Property Notas3() As String
        Get
            Return Me.TxtNota3.Text
        End Get
        Set(ByVal value As String)
            Me.TxtNota3.Text = value
        End Set
    End Property
