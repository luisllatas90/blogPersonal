<%@ Control Language="VB" AutoEventWireup="false" CodeFile="notas.ascx.vb" Inherits="medicina_notas" %>
    ...
    <tr id="fila" runat="server">
        ...
        <td align="center" style="width: 100px">
            <asp:TextBox ID="TxtNota" runat="server" BorderColor="Black" BorderStyle="Solid"
                ...
                Style="text-align: center" Width="43px">0</asp:TextBox>
            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="TxtNota"
                Display="Dynamic" ErrorMessage="Nota debe ser menor o igual a 20" Operator="LessThanEqual"
                SetFocusOnError="True" Type="Double" ValueToCompare="20">*</asp:CompareValidator>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtNota"
                Display="Dynamic" ErrorMessage="Valor de nota requerido" SetFocusOnError="True">*</asp:RequiredFieldValidator></td>
