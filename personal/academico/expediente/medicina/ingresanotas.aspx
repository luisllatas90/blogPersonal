        ...
        <tr>
            <td colspan="2" >
                <table style="width:100%;">
                    <tr>
                        <td>
                            <asp:Label ID="lblinicio" runat="server" Text="Inicio Clase:" Font-Bold="True" 
                                ForeColor="#0000CC" Visible="False"></asp:Label>                           
                        </td>                    
                        <td><asp:Label ID="lblInicioClase" runat="server" Font-Bold="True" 
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblfin" runat="server" Text="Fin Clase:" Font-Bold="True" 
                                ForeColor="Red" Visible="False"></asp:Label>                            
                        </td>                    
                        <td><asp:Label ID="lblFinClase" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                        </td>
                        <td>
                        </td>
                    </tr>
