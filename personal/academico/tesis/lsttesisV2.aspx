<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lsttesisV2.aspx.vb" Inherits="lsttesis" %>
...
<body>
    ...
    <p class="usatTitulo">
        Lista de Trabajos de investigación para Titulación</p>
    <table cellpadding="2" cellspacing="0">
        <tr>
            <td>
                Buscar: &nbsp;<asp:DropDownList ID="dpEscuela" runat="server" Font-Size="8" AutoPostBack="True">
                </asp:DropDownList>
                ...
                <asp:TextBox ID="txtbusqueda" runat="server" MaxLength="255" Width="200px" Font-Size="8"></asp:TextBox>
             ...
             <input id="cmdNuevo" class="agregar2" type="button" value="     Nuevo" onclick="return cmdNuevo_onclick()" /> </a>--%>
            </td>
        </tr>
 <%--       <tr>
            <td align="right">
                <asp:Button ID="cmdReporte" runat="server" Text="Reporte Exportar" UseSubmitBehavior="False"
                    CssClass="boton" />
            </td>
        </tr>--%>
    </table>
    <br />
    <asp:GridView ID="grwListaTesis" runat="server" AutoGenerateColumns="False" DataKeyNames="codigo_Tes"
        CellPadding="3" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" Font-Size="Smaller">
        <Columns>
            <asp:BoundField HeaderText="Nro" />
            <asp:BoundField DataField="titulo_tes" HeaderText="Título" SortExpression="titulo_tes">
  ...
  <asp:CommandField ButtonType="Image" 
            ...
            <asp:BoundField HeaderText="Actualización de Autores" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="codigo_cac" HeaderText="codigo_cac" Visible="False" />
