...
Partial Class lsttesis
    ...
    Protected Sub grwListaTesis_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grwListaTesis.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Cells(7).Text = "<a href='frmModificarAutores.aspx?titulo=" + fila.Row("titulo_tes") + "&cac=" & fila.Row("codigo_cac") & "&cpf=" & fila.Row("codigo_cpf") & "&codigo_tes=" & fila.Row("codigo_tes") & "&id=" & Request.QueryString("id") & "&ctf=" & Request.QueryString("ctf") & "&KeepThis=true&TB_iframe=true&height=450&width=750&modal=true' title='Modificar Autores de tesis' class='thickbox'><img src='../../../images/editar.gif' border=0 /><a/>"
