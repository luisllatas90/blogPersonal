...
Partial Class personal_academico_tesis_frmcambiaretapatesis
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            Dim tbCicloAcademico As Data.DataTable
            ...
            If Request.QueryString("ctf") = 1 Then
                ClsFunciones.LlenarListas(Me.dpEscuela, obj.TraerDataTable("ConsultarCarreraProfesional", "MA", 0), "codigo_cpf", "nombre_cpf", "-Seleccione la Escuela Profesional-")
            Else
                ClsFunciones.LlenarListas(Me.dpEscuela, obj.TraerDataTable("consultaracceso", "ESC", "", Request.QueryString("id")), "codigo_cpf", "nombre_cpf", "-Seleccione la Escuela Profesional-")
            End If
            ...
            Me.ddlCiclo.Attributes.Add("OnChange", "OcultarTabla()")
            ...
            For I = 0 To Me.GridView1.Rows.Count - 1
                ...
                If Fila.RowType = DataControlRowType.DataRow Then
                    If CType(Fila.FindControl("chkElegir"), CheckBox).Checked = True Then
                        ...
                        ' Guardar los datos
                        '==================================
                        obj.Ejecutar("TES_AgregarEtapaInvestigacionTesis", CDate(Me.txtFechaAprobacion.Text).ToShortDateString, Me.GridView1.DataKeys.Item(Fila.RowIndex).Values(0), 1, Me.hdFase.Value, Request.QueryString("id"), Me.TxtComentario.Text.Trim, Me.chkBloquear.Checked)
                    End If
                End If
            Next
            obj.TerminarTransaccion()
            obj = Nothing
            Page.RegisterStartupScript("CambioEstado", "<script>alert('Se han guardado los Cambios de Estado correctamente');location.href='frmcambiaretapatesis.aspx?ctf=" & Request.QueryString("ctf") & "&id=" & Request.QueryString("id") & "'</script>")
    ...
    '                    ' Guardar los datos
    '                    '==================================
    '                    obj.Ejecutar("TES_BloquearAvanceTesis", Me.GridView1.DataKeys.Item(Fila.RowIndex).Values("codigo_tes"), Me.dpAcciones.SelectedValue, Request.QueryString("id"))
    '                End If
    '            End If
    '        Next
    '        'obj.TerminarTransaccion()
    '        obj = Nothing
    '        Page.RegisterStartupScript("Habilitar", "<script>alert('Se han guardado los cambios correctamente');location.href='frmcambiaretapatesis.aspx?ctf=" & Request.QueryString("ctf") & "&id=" & Request.QueryString("id") & "'</script>")
    ...
    Private Sub ConsultarTesis()
        Dim obj As New ClsSqlServer(ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString)
        Me.GridView1.DataSource = obj.TraerDataTable("TES_ConsultarListaTesisReporte", Me.dpEscuela.SelectedValue, _
                                                     Me.txtTermino.Text.Trim, _
                                                     Me.dpCurso.SelectedValue, Me.dpCurso.SelectedItem.Text, Me.ddlCiclo.SelectedValue)
