...
Partial Class academico_Vacantes_FrmMantenimientoVacantes
    ...
    Private Sub CargarCarreraProfesional()
        ...
        obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
        obj.AbrirConexion()
        objfun.CargarListas(cboCpf, obj.TraerDataTable("ConsultarCarreraProfesional", "TO", 2), "codigo_cpf", "nombre_cpf", "--Seleccione--")
        obj.CerrarConexion()
        obj = Nothing
    End Sub
    ...
    Private Sub CargarCarreraProfesional2()
        ...
        obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
        obj.AbrirConexion()
        objfun.CargarListas(cboCpf2, obj.TraerDataTable("ConsultarCarreraProfesional", "TO", 2), "codigo_cpf", "nombre_cpf", "--Seleccione--")
        obj.CerrarConexion()
        obj = Nothing
    End Sub
