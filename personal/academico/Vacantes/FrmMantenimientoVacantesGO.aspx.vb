...
Partial Class academico_Vacantes_FrmMantenimientoVacantesGO
    ...
    Private Sub CargarCarreraProfesional()
        ...
        obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
        obj.AbrirConexion()
        objfun.CargarListas(cboCpf, obj.TraerDataTable("ConsultarCarreraProfesional", "GO", 10), "codigo_cpf", "nombre_cpf", "--Seleccione--")
        obj.CerrarConexion()
        obj = Nothing
    End Sub
    Private Sub CargarModalidad()
        ...
        obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
        obj.AbrirConexion()
        objfun.CargarListas(cboMin, obj.TraerDataTable("ConsultarModalidadIngreso", "TO", ""), "codigo_min", "nombre_Min", "--Seleccione--")
        obj.CerrarConexion()
        obj = Nothing
    End Sub
    '---Busqueda
    ...
    Private Sub CargarCarreraProfesional2()
        ...
        obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
        obj.AbrirConexion()
        objfun.CargarListas(cboCpf2, obj.TraerDataTable("ConsultarCarreraProfesional", "GO", 10), "codigo_cpf", "nombre_cpf", "--Seleccione--")
        obj.CerrarConexion()
        obj = Nothing
    End Sub
    Private Sub CargarModalidad2()
        ...
        obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
        obj.AbrirConexion()
        objfun.CargarListas(cbomin2, obj.TraerDataTable("ConsultarModalidadIngreso", "TO", ""), "codigo_min", "nombre_Min", "--Seleccione--")
        obj.CerrarConexion()
        obj = Nothing
    End Sub
    '-------
