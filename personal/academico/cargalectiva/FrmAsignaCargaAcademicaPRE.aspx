<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmAsignaCargaAcademicaPRE.aspx.vb" Inherits="academico_cargalectiva_FrmAsignaCargaAcademicaPRE" %>
...
<table cellpadding="3" cellspacing="0" style="width: 100%; border:1px solid #96ACE7" 
        ...
        <tr style="background-color: #6694e3; color:White">
            <td style="height: 30px; "><asp:Label ID="lblnombre_dac" runat="server" Font-Bold="True" 
                    Font-Names="Verdana" Font-Size="8pt" Text="Ud. no está registrado como Director de Dpto. Académico. Consultar con la Of. de Personal."></asp:Label>
            ...
            <td style="height: 30px; ">
                                                ...
                                                <asp:DropDownList ID="dpEstado" runat="server">
                                                    <asp:ListItem Value="0">Cursos SIN Profesor asignado</asp:ListItem>
                                                    <asp:ListItem Value="1">Cursos CON Profesor asignado</asp:ListItem>
                                                </asp:DropDownList>
