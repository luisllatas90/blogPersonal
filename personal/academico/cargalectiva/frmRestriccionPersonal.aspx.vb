...
Partial Class academico_cargalectiva_frmRestriccionPersonal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            Dim mod_ As Int16 = Request.QueryString("mod")
    ...
    Private Sub fnCboDedicacion()
        Try
            'Response.Write(1)
            Dim obj As New ClsConectarDatos
            obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
            obj.AbrirConexion()
            ClsFunciones.LlenarListas(Me.ddlDedicacion, obj.TraerDataTable("H_DedidacionConsultar", CInt(Me.ddlDepartamento.SelectedValue)), "codigo_ded", "descripcion_ded")
            obj.CerrarConexion()
    ...
    Protected Sub btnConsultar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnConsultar.Click
        ...
        Try
            ...
            tb = obj.TraerDataTable("ACAD_RestriccionPersonal_Consultar", "1", 0, Me.ddlDedicacion.SelectedValue, Me.ddlCiclo.SelectedValue, 0, Me.ddlDepartamento.SelectedValue, Me.TextBox1.Text)
