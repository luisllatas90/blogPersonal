<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRestriccionDocente.aspx.vb" Inherits="academico_horarios_administrar_frmRestriccionAmbiente" %>
...
<body>
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="Button1" CssClass="btn" runat="server" Text="Buscar" />
            </td>
        </tr>
        <tr>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" 
                    DataKeyNames="codigo_rper,codigo_per">
        <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
        <Columns>   
            <asp:BoundField DataField="codigo_per" HeaderText="codigo_per" Visible="False" />
            <asp:BoundField DataField="Descripcion_Ded" HeaderText="Dedicación" ReadOnly="True" />
            <asp:BoundField DataField="departamento" HeaderText="Dep Académico" ReadOnly="True" />
            <asp:BoundField DataField="Personal" HeaderText="Docente" ReadOnly="True" />
            <asp:BoundField DataField="codigo_rper" HeaderText="codigo_rper" Visible="False" />
            <asp:TemplateField HeaderText="LU" SortExpression="D1">
                <ItemTemplate>
                    <asp:DropDownList ID="ddlD1" runat="server" SelectedValue='<%# Bind("D1")%>' >
                        ...
                        <asp:ListItem Text="No puede" Value="-1"></asp:ListItem>
                    </asp:DropDownList>
                </ItemTemplate>
            </asp:TemplateField>
              ...
              <asp:TemplateField HeaderText="MA" SortExpression="D2">
                <ItemTemplate>
                    <asp:DropDownList ID="ddlD2" runat="server" SelectedValue='<%# Bind("D2")%>'>
                        ...
                        <asp:ListItem Text="No puede" Value="-2"></asp:ListItem>
                    </asp:DropDownList>
                </ItemTemplate>
            </asp:TemplateField>
              ...
              <asp:TemplateField HeaderText="MI" SortExpression="D3" >
                <ItemTemplate>
                    <asp:DropDownList ID="ddlD3" runat="server" SelectedValue='<%# Bind("D3")%>'>
                        ...
                        <asp:ListItem Text="No puede" Value="-3"></asp:ListItem>
                    </asp:DropDownList>
                </ItemTemplate>
            </asp:TemplateField>
              ...
              <asp:TemplateField HeaderText="JU" SortExpression="D4">
                <ItemTemplate>
                    <asp:DropDownList ID="ddlD4" runat="server" SelectedValue='<%# Bind("D4")%>'>
                        ...
                        <asp:ListItem Text="No puede" Value="-4"></asp:ListItem>
                    </asp:DropDownList>
                </ItemTemplate>
            </asp:TemplateField>
              ...
              <asp:TemplateField HeaderText="VI" SortExpression="D5">
                <ItemTemplate>
                    <asp:DropDownList ID="ddlD5" runat="server" SelectedValue='<%# Bind("D5")%>'>
                        ...
                        <asp:ListItem Text="No puede" Value="-5"></asp:ListItem>
                    </asp:DropDownList>
                </ItemTemplate>
            </asp:TemplateField>
              ...
              <asp:TemplateField HeaderText="SA" SortExpression="D6">
                <ItemTemplate>
                    <asp:DropDownList ID="ddlD6" runat="server" SelectedValue='<%# Bind("D6")%>'>
                        ...
                        <asp:ListItem Text="No puede" Value="-6"></asp:ListItem>
                    </asp:DropDownList>
                </ItemTemplate>
            </asp:TemplateField>
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="hRestriccionPersonal_Consultar_v2" SelectCommandType="StoredProcedure" 
                        UpdateCommand="hRestriccionPersonal_Registrar" UpdateCommandType="StoredProcedure" 
                        
                        >
                        
                        <SelectParameters>
                        <asp:QueryStringParameter  Name="tipo"    Type="String" ConvertEmptyStringToNull="true" DefaultValue=" " />
                        <asp:ControlParameter ControlID="ddlDedicacion" Name="codigo_ded" PropertyName="SelectedValue" Type="Int32" />
                        ...
                        <asp:ControlParameter  ControlID="ddlDepartamento" Name="codigo_dac" PropertyName="SelectedValue" Type="Int32" />
                        <asp:ControlParameter  ControlID="TextBox1" Name="nombre" PropertyName="Text" Type="String" ConvertEmptyStringToNull="true" DefaultValue=" " />                        
                          ...
                          <asp:ControlParameter ControlID="GridView1" Name="codigo_rper" 
                                PropertyName="SelectedDataKey.Values[codigo_rper]" Type="Int32" />   
                          <asp:ControlParameter ControlID="GridView1" Name="codigo_per" 
                                PropertyName="SelectedDataKey.Values[codigo_per]" Type="Int32" />   
                          <asp:ControlParameter ControlID="ddlCiclo" Name="codigo_cac" PropertyName="SelectedValue" Type="Int32" />                        
