...
<tr>
	<td height="3%" colspan="5" class="usattitulo" width="748">Programación de asignaturas por Planes de Estudio</td>
</tr>
<tr>
	<td height="3%" style="width: 10%">Ciclo Académico:</td>
	<td height="3%" style="width: 10%" align="left">
	<%call llenarlista("cbocodigo_cac","",rsCiclo,"codigo_cac","descripcion_cac",codigo_cac,"","","")%>			
	</td>
	<td height="3%" style="width: 15%" align="right">Plan de Estudio:</td>
	<td height="3%" style="width: 60%">
