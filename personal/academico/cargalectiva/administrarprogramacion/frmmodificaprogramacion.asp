...
<tr>
	<td height="3%" colspan="5" class="usattitulo">Modificar programación de asignaturas</td>
</tr>
<tr>
  ...
  <tr valign="top">
		...
		<tr bgcolor="#F0F0F0">
      	...
      	<table width="100%">
			<tr class="azul">
    			...
    			%>			
				<input style="width:100px" name="cmdAgregar" type="button" value="   Añadir Grupo" class="agregar2" disabled="true" onclick="AbrirGrupo('A')" />
	...
	<%if activo<>true and codigo_cac<>"-2" and codigo_cpf<>"-2" then%>
		...
		No se han programado asignaturas en el Plan de Estudio seleccionado, para ello debe ir al menú [Nuevo Programación] y elegir las asignaturas a programar, según el plan de estudio</h5>
	<%end if%>
</body>
</html>