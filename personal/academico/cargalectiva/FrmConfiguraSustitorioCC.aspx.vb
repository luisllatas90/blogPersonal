...
Partial Class academico_cargalectiva_FrmConfiguraSustitorioCC
    ...
    Private Function fnVerificarFuncion() As Integer ' #EPENA 261/11/2019
        ...
        Try
            ...
            cls.AbrirConexion()
            dt = cls.TraerDataTable("MAT_consultarTipoFuncion", Session("id_per"), 43)
            cls.CerrarConexion()
    ...
    End Function
    Private Function fnEsDirectorCC() As Boolean ' #EPENA 261/11/2019
        Try
    ...
    Protected Sub gvDatos_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles gvDatos.RowEditing
        ...
        Catch ex As Exception
            Me.lblMensaje.Text = "Error: " & ex.Message & "<>" & ex.StackTrace
        End Try
    End Sub
    ...
    Private Sub Buscar()
        ...
        Try
            ...
            dt = obj1.TraerDataTable("ACAD_ListaCursosProgramadosCC", Me.cboEstado.SelectedValue + Tipo, 0, Me.cboCiclo.SelectedValue, "")
            obj1.CerrarConexion()
    ...
    Private Function BuscarRegistro(ByVal codigo_cup As Integer) As DataRow
        ...
        Try
            ...
            obj1.AbrirConexion()
            'dt = obj1.TraerDataTable("ACAD_ListaCursosProgramados", Me.cboEstado.SelectedValue + Tipo, codigo_cup, Me.cboCiclo.SelectedValue, "", 0, Me.ddlCiclo_cur.SelectedValue)
            dt = obj1.TraerDataTable("ACAD_ListaCursosProgramadosCC", Me.cboEstado.SelectedValue + Tipo, codigo_cup, Me.cboCiclo.SelectedValue, "")
            obj1.CerrarConexion()
    ...
    Private Function ListaDocente() As Data.DataTable
        ...
        Try
            ...
            obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
            obj.AbrirConexion()
            dt = obj.TraerDataTable("ACAD_ListaDocentesCC", codigo_fun, codigo_per, codigo_cac)
            obj.CerrarConexion()
            obj = Nothing
