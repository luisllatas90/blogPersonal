...
if codigo_dac<>"-2" and codigo_dac<>"" then
 ...
 %>
	<table width="100%" border="1" bordercolor="#C0C0C0" style="border-collapse: collapse" cellpadding="3" cellspacing="0">
	  ...
	  <tr bgcolor="#FFFFCC"> 
  	    <td colspan="6" align="LEFT">HORAS COMPL.:<%=totalComp%>&nbsp;&nbsp;HORAS PRG.ESPEC.:<%=totalEsp%>&nbsp;&nbsp;<b>HORAS PREGRADO:<%=totalHoras%>&nbsp;</b></td>
    	<td align="right"><b>HORAS TOTALES</b></td>
    	<td align="center"><b><%=totalHoras + totalComp + totalEsp%>&nbsp;</b></td>
	  </tr>
