<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRestriccionPersonal.aspx.vb" Inherits="academico_cargalectiva_frmRestriccionPersonal" %>
                                    ...
                                    <div class="page_header">
                                       ...
                                       <div class="col-md-12 col-sm-12 col-lg-12">
                                            <div class="col-md-6" style="float:left;width:50%;">                                            
                                             <div class="form-group">
                                                <label class="col-md-4 control-label ">
                                                    Dedicación del Docente</label>
                                                <div class="col-md-8">
                                                     <asp:DropDownList ID="ddlDedicacion" runat="server"  CssClass="form-control"></asp:DropDownList>
                                                </div>
                                            </div>
                                            </div>
                                            <div class="col-md-6" style="float:left;width:50%;">
