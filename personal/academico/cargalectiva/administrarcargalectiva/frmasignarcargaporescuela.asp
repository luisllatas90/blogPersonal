...
<p class="usatTitulo">Asignación de Carga Académica y horarios</p>
<table style="border-collapse: collapse" width="100%" <%=alto%>>
	<tr>
		...
		<img src="../../../../images/menus/buscar_small12.gif" alt="Abrir formulario de búsqueda" onClick="AbrirBusqueda('<%=modulo%>')" class="imagen">
		</td>
	</tr>
	<%if HayReg=true then%>
	<tr height="35%" valign="top">
		<td width="100%" class="contornotabla" colspan="5">
			...
			<tr class="etabla">
				...
				<td width="27%" height="1%">Descripción</td>
