...
%>
<body>
<p class="usatTitulo">Registro de Docentes adscritos según Departamento Académico </p>
...
<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" <%=alto%>>
  <tr>
    <td width="26%" height="5%">Departamento Académico</td>
    <td width="74%" height="5%"><%call llenarlista("cboDpto","actualizarlista('frmadscribiradpto.asp?modo=R&codigo_dac='+this.value)",rsDpto,"codigo_dac","nombre_dac",codigo_dac,"Seleccionar el Dpto Académico","","")%></td>
  </tr>
  <%if modo="R" and codigo_dac>=0 then%> 
  <tr>
