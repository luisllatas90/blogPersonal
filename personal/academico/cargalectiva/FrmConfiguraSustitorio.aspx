<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmConfiguraSustitorio.aspx.vb" Inherits="academico_cargalectiva_FrmConfiguraSustitorio" %>
   ...
   <asp:HiddenField ID="hdFn" runat="server" />
    ...
    <asp:Button ID="btnCopiarHorario" runat="server" Text="Copiar Horario" 
        ...
        <asp:GridView ID="gvProgramado" runat="server" Width="100%" 
            ...
            DataKeyNames="codigo_cup,nombre_Cur,grupoHor_Cup,ambiente,nombre_cpf,codigo_lho,vacantes_cup,codigo_Per" CellPadding="4" 
            ForeColor="#333333">
