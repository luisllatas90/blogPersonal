<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmConfiguraSustitorioPP.aspx.vb" Inherits="academico_cargalectiva_FrmConfiguraSustitorioPP" %>
...
<body>
    ...
    <asp:Button ID="btnCopiarHorario" runat="server" Text="Copiar Horario" 
        ...
        <asp:GridView ID="gvProgramado" runat="server" Width="100%" 
            ...
            DataKeyNames="codigo_cup,nombre_Cur,grupoHor_Cup,ambiente" CellPadding="4" 
            ForeColor="#333333">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Fecha" HeaderText="FECHA INICIO-FIN" />
                <asp:BoundField DataField="docente" HeaderText="DOCENTE" />
                <asp:CommandField ShowDeleteButton="True" />
                <asp:BoundField DataField="ambiente" HeaderText="AMBIENTE" />
                <asp:TemplateField HeaderText="Acción">
                    <ItemTemplate>
                        <asp:Button ID="Button1" CssClass="btn" runat="server" Text="Horario Ambiente"
        ...
        <asp:GridView ID="gvDatos" runat="server" Width="100%" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="codigo_cup" HeaderText="CODIGO" Visible="False" />
                <asp:BoundField DataField="nombre_Cur" HeaderText="CURSO" />
                <asp:BoundField DataField="grupoHor_Cup" HeaderText="GRUPO"></asp:BoundField>
                ...
                <asp:BoundField DataField="Fecha" HeaderText="FECHA INICIO-FIN" />
                <asp:TemplateField HeaderText="ASIST. REQ. (%)" Visible="False">
                    <EditItemTemplate>                        
