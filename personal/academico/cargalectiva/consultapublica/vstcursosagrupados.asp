...
Set obj=Server.CreateObject("PryUSAT.clsAccesoDatos")
	...
	if codigo_cac<>"-2" and codigo_cpf<>"-2" then
		Set rsCursoPlan= Obj.Consultar("ConsultarCursoProgramadoAgrupado","FO",1,codigo_cac,codigo_cpf,"")
...
<script language="Javascript">
	...
	{
		var pagina="../academico/cargalectiva/consultapublica/vstcursosagrupados.asp?codigo_cac="+cbocodigo_cac.value + "&codigo_cpf="+cbocodigo_cpf.value
...
<tr>
	...
	<td height="3%" style="width: 10%" align="right">
	    <img alt="Buscar cursos programados" src="../../../../images/menus/buscar_small.gif" class="imagen" onclick="ConsultarGrupos()">
	</td>
</tr>
<%if activo=true then%>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#808080" width="100%" height="100%">
      <tr>
		...
		%>
			...
			%>
			<tr valign="top">
				<td align="center" width="5%"><%=ConvRomano(rsHijos("ciclo_Cur"))%>&nbsp;</td>
				<td width="10%"><%=rsHijos("identificador_cur")%></td>
				<td width="35%"><%=rsHijos("nombre_cur")%> (<i>Secundario</i>)</td>
				<td width="5%" align="center"><%=rsHijos("creditos_cur")%></td>
				<td width="30%"><i><%=rsHijos("nombre_cpf")%></i></td>
				<td width="10%">&nbsp;</td>
			</tr>
				<%
				rsHijos.movenext
