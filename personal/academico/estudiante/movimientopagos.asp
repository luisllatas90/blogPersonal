...
<script>
	function consultarMov()
	{
		if(txtanioini.value.length>5 && txtaniofin.value.length>5){
			alert("Por favor especifique correctamente los años de inicio y fin")
			return(false)
		}
...
<body bgcolor="#EEEEEE">
	<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1" bgcolor="#FFFFFF" class="contornotabla">
      <tr>
        <td width="1148" colspan="7" class="usatceldatitulo">Consultar movimientos por mes y año</td>
      </tr>
      <tr>
...
<table>
<tr>
	<td><font color="#0000FF"><b>Número de convenios realizados:</b></font></td>
	<td><b>
	<%
    ...
    clic aquí para ver los convenios</span>
			    </font>
			<%end if
