...
<head runat="server">
    <title>Cuadro de méritos - USAT</title>
...
<body>
    ...
    <div class="usatTitulo">
        CUADRO DE MÉRITOS
        <asp:LinkButton ID="lnkMedioSup" runat="server">Medio Superior</asp:LinkButton>
        &nbsp;|
    ...
    <div>
        ...
        <asp:GridView ID="gvCuadro" runat="server" AutoGenerateColumns="False" GridLines="Horizontal"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="creditosAprobados" HeaderText="Créd. Aprobados" ItemStyle-HorizontalAlign="Center" />
            </Columns>
            <HeaderStyle BackColor="#0066CC" ForeColor="White" />
        </asp:GridView>
        <asp:GridView ID="gvCuadroNuevo" runat="server" AutoGenerateColumns="False" GridLines="Horizontal" DataKeyNames="puesto"
            Width="100%">
            <Columns>
                ...
                <asp:BoundField DataField="CreditosMatriculados" HeaderText="CRÉD. MATRICULADOS"
                    ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField DataField="CreditosAprobados" HeaderText="CRÉD. APROBADOS" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField DataField="DIFE. CREDITOS" HeaderText="DIFE. CRÉDITOS" ItemStyle-HorizontalAlign="Center" />
