...
<form name="frmFicha" METHOD="POST" ACTION="procesardatosalumnope.asp?IncluirDatos=<%=incluirDatos%>&codigo_alu=<%=codigo_alu%>">
  ...
  <tr>
    ...
    <td class="usatsubtitulousuario" width="50%" colspan="3">: <%=session("nombre_cpf")%>&nbsp;</td>
	  ...
	  <tr>
		...
		Por favor debe especificar el número de su documento de Identidad. Si no actualiza este dato no podrá hacer uso de los Servicios de biblioteca
		<br>Si no tuviera DNI, realizar los trámites respectivos en RENIEC para la obtención del mismo.
		</td>
          </tr>
          </table>
    </td>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
	    ...
	    <option value="NINGUNO" <%=SeleccionarItem("cbo",estadocivil_Dal,"NINGUNO")%>>--Seleccione--</option>
          ...
          <tr>
	    	...
	    	<td class="azul">
                ...
                <input <%=confirmacion%> type="checkbox" value="1" name="confirmacion"/>Confirmación
            </td>
            <td class="azul">
          ...
          <tr>
	    	<td width="15%" valign="top">Tipo de Institución Educativa</td>
          ...
          <tr id="otrocolegio" style="display:<%=iif(nombrecolegio_dal="","none","")%>">
            ...
            del nombre de la Institución Educativa:
   ...
   <!--<h3 class="rojo" align="center">ACEPTO, que la Información ingresada es fidedigna y correcta para uso exclusivo de la Universidad en los procesos académicos y administrativos.</h3>-->
   <p align="center">
