...
<html>
<head>
<title>Consulta de fotos por Carrera Profesional</title>
...
<tr>
	<td height="3%" colspan="6" class="usattitulo">Consulta de Fotos por Carrera Profesional</td>
</tr>
<tr>
	<td height="3%" style="width: 10%" align="right">Carrera Profesional:</td>
...
<%if activo<>true and codigo_cpf<>"-2" then%>
	<h5 class="usatsugerencia">&nbsp;&nbsp;&nbsp;&nbsp; No se han encontrado estudiantes registrados en la Carrera Profesional seleccionada</h5>
<%end if%>
</body>
</html>