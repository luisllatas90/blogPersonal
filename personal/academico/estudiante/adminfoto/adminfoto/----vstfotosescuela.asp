		...
		<%	i=0
			...
			Do while not rsAlumno.eof
				...
				if rsAlumno("foto_alu")=1 then
					...
					foto="http://www.intranet.edu.pe/imgestudiantes/" & foto
				else
	    	...
	    	<img src="<%=foto%>" alt="Código:<%=rsAlumno("codigouniver_alu") & chr(13) & "Estudiante:" & rsAlumno("alumno")%>" width="50" height="50">
		    <br>
			<span class="piepagina"><%=rsAlumno("alumno")%></span>
    		</td>
			<%
				rsAlumno.movenext
			Loop
