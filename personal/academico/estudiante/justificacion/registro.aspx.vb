            ...
            For j As Integer = 0 To tbDocentes.Rows.Count - 1
                ...
                If bodycorreo <> "" Then
                    Try
                        ...
                        objCorreo.EnviarMail("campusvirtual@usat.edu.pe", "Sistema Trámites Virtuales - Campus Virtual", "yperez@usat.edu.pe", "COPIA - Notificación: Justificación de Inasistencia", bodycorreo, True, "", "")
                    Catch ex As Exception
