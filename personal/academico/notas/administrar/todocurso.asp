...
<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  ...
  <tr>
    <td width="15%">Semestre Académico</td>
    <td width="75%">
  ...
  <tr>
	...
	<%if HayReg=true  then%>
  	...
  	<input onClick="AbrirAutorizacionNota('Q')" name="cmdQuitar" type="button" value="Quitar autorización de llenado de notas" class="eliminar2" style="width:220px">
...
<%
  	if HayReg="" then%>
		...
		se han registro asignaturas a su cargo, en el semestre académico seleccionado.</h5>
  	<%else
%>
<br>
<table border="1" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="gray" width="100%">
	  <tr class="etabla">
	    ...
	    <th width="5%">Ciclo</th>
	    <th width="20%">Carrera Profesional</th>
