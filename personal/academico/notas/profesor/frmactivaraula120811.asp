...
<input type="button" class="enviaryrecibir1"  value="        Habilitar y actualizar"  disabled=true onClick="alert('Las aulas serán activadas esta semana.')" name="cmdGuardar" style="width: 170px">
<br>
...
<p class="usattitulousuario" style="cursor:hand" onclick="OcultarPreguntas()">
    Las aulas virtuales serán activadas esta semana.<br /><br />
Preguntas frecuentes</p>
<div id="divpreguntas">
&nbsp;<p class="usatEtiqOblig">1. ¿Qué debo hacer para agrupar asignaturas en 
	el aula virtual?
	</p>
<p>Solicitar por email a evaluación y 
registros, el agrupamiento de asignaturas indicando las asignaturas que se 
agruparán y el motivo.</p>
<p class="usatEtiqOblig">2. ¿Cómo copio documentos de asignaturas 
...
<img src="../../../../images/menus/attachfiles_small.gif" width="25" height="25"> 
	para indicar de qué asignatura se copiarán los documentos..</p>
<p class="usatEtiqOblig">3. ¿Qué debo hacer si no tengo asignada mi carga académica para el ciclo actual?
	</p>
<p>Solicitar por email a <strong>Evaluación y 
Registros</strong>, el registro de la carga académica en el Sistema.</p>
</div>
<%end if%>
</body>
</html>
