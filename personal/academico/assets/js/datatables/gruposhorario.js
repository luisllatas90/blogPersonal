$(document).ready(function() {
    ...
    var oTable = $('#tablagruposhorario').DataTable({
        "bPaginate": false,
        "bFilter": false,
        "bLengthChange": false,
        "bInfo": false,
        ...
        $('#tablagruposhorario thead tr').each(function() {
            this.insertBefore(nCloneTh, this.childNodes[0]);
        });

        $('#tablagruposhorario tbody tr').each(function() {
            this.insertBefore(nCloneTd.cloneNode(true), this.childNodes[0]);
        });

        $('#tablagruposhorario tbody td.details-control').on('click', function() {
        ...
        var cmt = parseInt($("#txtcm").val());
        if (cmt == 0) {
            if (_SWUPREQGH) $('#tablagruposhorario  thead  tr th:eq(0)').html('<a href ="#" class="btn btn-primary" onclick="fnUpReqCur();" style="font-size:10px">Actualizar <i class="ion-ios-refresh-empty"></i></a> ');
        }
    });
       ...
       $.ajax({
            ...
            $('.piluku-preloader').removeClass('hidden');
                ...
                if (data[0].resultado == "OK") {
                    ...
                    $('#tablagruposhorario  thead  tr th:eq(0)').html('');
                    _SWUPREQGH = false;
                    f_Menu('gruposhorario.aspx');
                } else {
