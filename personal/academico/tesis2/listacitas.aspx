<%@ Page Language="VB" AutoEventWireup="false" CodeFile="listacitas.aspx.vb" Inherits="SysTesisInv_listacitas" %>
        ...
        <tr class="Selected">
            ...
            <td align="center">
                <asp:Button ID="cmdAnular" runat="server" 
                    ...
                    Text="Suspender" CausesValidation="False" UseSubmitBehavior="False" />
                        </td>
        </tr>
        <tr>
            <td>
        ...
        <tr >
            ...
            <p>
                <asp:Button ID="cmdAtender" runat="server" 
                    ...
                    Text="Asesorar actividad" CausesValidation="False" 
