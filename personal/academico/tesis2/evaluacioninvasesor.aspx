<%@ Page Language="VB" AutoEventWireup="false" CodeFile="evaluacioninvasesor.aspx.vb" Inherits="evaluacioninvasesor" %>
...
<body>
    ...
    <p class="usatTitulo">Evaluación de investigaciones<p/>
...
<legend><b>Registrar resultado de la investigación</b></legend>
                <asp:Button ID="cmdNotaProyecto" runat="server" 
                    onclientclick="AbrirPopUp('frmresultadoinvestigacion.aspx?tipo=P','350','550');return(false)" 
                    Text="1. Proyecto de Inv." CausesValidation="False" 
                    UseSubmitBehavior="False" />
                    &nbsp;<asp:Button ID="cmdNotaEjecucion" runat="server" 
                    onclientclick="AbrirPopUp('frmresultadoinvestigacion.aspx?tipo=E','350','550');return(false)" 
                    Text="2. Ejecución de Inv." CausesValidation="False" 
                    UseSubmitBehavior="False" />
                    &nbsp;<asp:Button ID="cmdNotaInforme" runat="server" 
                    onclientclick="AbrirPopUp('frmresultadoinvestigacion.aspx?tipo=I','350','550');return(false)" 
