...
<%  
	...
	If Not(rsAlumno.BOF AND rsAlumno.EOF) then
			...
			session("cicloRefMat")=rsAlumno("CicloAlumno")
			...
			'Campos nuevos usados para Verano
			session("max_nivelacion")=rsAlumno("max_nivelacion")		
			session("max_adelantar")=rsAlumno("max_adelantar")
			session("numCursosDesap")=rsAlumno("numCursosDesap")
