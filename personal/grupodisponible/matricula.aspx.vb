...
Partial Class matricula
                ...
                If cic_ext Then
                    ...
                    If Cronograma() Then
                        ...
                        If SituacionAlumno() Then
                            ...
                            '    strTbody.Append("<i class='ion-locked'></i>&nbsp;BloqueosESP")
                            '    strTbody.Append("</h3>")
                            '    strTbody.Append("</div>")
                            ...
                            'End If  ' FIN  If AlumnoPersonalizado()
    ...
    Public Function VerificarDeudaVerano() As Boolean
        Try
            ...
            If dt IsNot Nothing AndAlso dtd.Rows.Count > 0 Then
                Return False
            Else
                Return True
            End If
    ...
    Private Sub fnDivInscripcionCursoVerano()
        ...
        str.Append("<center>")
        str.Append("<img src='assets/images/CONFIRMACION_INSCRIPCION_VERANO.png?Q=5' style='width:50%;height:50%;' />")
        str.Append("</center>")
    ...
    Private Sub ListarVerano()
        ...
        If Not dt Is Nothing AndAlso dt.Rows.Count > 0 Then
            For i = 0 To dt.Rows.Count - 1
                'If i < (dt.Rows.Count - 1) And CInt(dt.Rows(i).Item("ciclo_cur")) <= Session("cicloCurMax") Then
                If i < (dt.Rows.Count - 1) Then
                    '  If swIdioma = False And dt.Rows(i).Item("tipocomplementario_cur").ToString <> "I" Then
            ...
            ' If CInt(dt.Rows(dt.Rows.Count - 1).Item("ciclo_cur")) <= Session("cicloCurMax") Then
            If swIdioma And dt.Rows(dt.Rows.Count - 1).Item("tipocomplementario_cur").ToString = "I" Then
