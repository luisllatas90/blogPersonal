...
<head>
    ...
    <% 
    if session("descripcion_apl") = "CRM USAT" OR session("descripcion_apl") = "GRADOS Y TITULOS" OR  session("descripcion_apl") = "PERSONAL" _ 
			...
			or session("codigo_apl")=19 or session("codigo_apl")=35 or session("codigo_apl")=76 then    
...
<frameset rows="3%,*" frameborder="0" border="0" framespacing="0">
  <frame src="cabecera2020.asp" name="fraArriba" scrolling="No" id="fraArriba">
