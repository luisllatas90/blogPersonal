<%@ Page Language="VB" AutoEventWireup="false" CodeFile="0_frmListaEgresados.aspx.vb" Inherits="Egresado_frmListaEgresados" %>
...
<body>
    ...
    <table width="100%">
     ...
     <tr>
         ...
         <td class="style14">
            <asp:DropDownList ID="ddlFacultad" runat="server" Height="17px" Width="220px">
            </asp:DropDownList>
         </td>
      </tr>
      <tr>
     ...
     <br />   <br />   
            ...
            AutoGenerateColumns="False" DataKeyNames="codigo_pso,foto_Ega,cv_Ega,NOMBRES, CORREO" 
    ...
    <table cellspacing="0" width="85%"  style="width: 85%; border-color: #0099FF; border-bottom-width: 1px; 
        ...
        <tr>
            ...
            <td >
               <label id="label1" runat="server">j</label>
            </td>
        </tr>
        <tr>
