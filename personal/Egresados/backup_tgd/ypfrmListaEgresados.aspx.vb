            ...
            For i As Integer = 0 To Me.gvwEgresados.Rows.Count - 1
                ...
                If (valor = True) Then
                    If Me.gvwEgresados.DataKeys(i).Values("CORREO").ToString = "SI" Then
                        Mensaje = "Estimado(a) " & Me.gvwEgresados.DataKeys(i).Values(3) & " : <br/>"
                        Mensaje &= Me.txtMensaje.Text.Trim
                        Dim para As String
                        para = Me.gvwEgresados.DataKeys(i).Values("EMAIL").ToString
                        para = "yperez@usat.edu.pe"
                        Me.lblMensajeFormulario.Text = cls.EnviarMailAd("alumni@usat.edu.pe", "Alumni USAT", para, Me.txtAsunto.Text.Trim, Mensaje, True, "", "alumni@usat.edu.pe", strRuta, Me.FileUpload1.FileName)
                    Else
