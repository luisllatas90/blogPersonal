Partial Class Egresado_frmListaEgresados
    ...
    Private Sub CargaCiclo()
        ...
        Try
            obj.AbrirConexion()
            dt = obj.TraerDataTable("SOL_ReporteListarCiclos")
            obj.CerrarConexion()
    ...
    Sub CargarListas()
        ...
        '#Escuela
        dt = New Data.DataTable
        dt = obj.TraerDataTable("ALUMNI_ListarCarreraProfesional", Integer.Parse(Session("id_per")))
    ...
    Private Function CargarGrid() As Data.DataTable
        Dim obj As New ClsConectarDatos
    ...
    Protected Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        Try
            If (ValidaMensaje() = True) Then
                ...
                For i As Integer = 0 To Me.gvwEgresados.Rows.Count - 1
                    ...
                    If (valor = True) Then
                        ...
                        If Me.gvwEgresados.DataKeys(i).Values("CORREO").ToString = "SI" Then
                            ...
                            If EnviarMensaje(para, Me.txtAsunto.Text.Trim, Mensaje, copia, strRuta, Me.FileUpload1.FileName) Then
                                obj.AbrirConexion()
                ...
                obj = Nothing
            End If
            EnviarMensajeNotificacion(StrCuentas, txtMensaje.Value, txtAsunto.Text, Me.FileUpload1.FileName, nro, correosEnviados, correosNoEnviados, sincorreo)
            Me.txtAsunto.Text = ""
            Me.txtMensaje.Value = ""
            OcultaAlEnviar(False)
        Catch ex As Exception
    ...
    Function EnviarMensaje(ByVal para As String, ByVal asunto As String, ByVal mensaje As String, ByVal copia As String, ByVal rutaarchivo As String, ByVal nombrearchivo As String) As Boolean
        Try
            Dim cls As New ClsEnvioMailAlumni
            If cls.EnviarMailAd("alumni@usat.edu.pe", "alumniUSAT", para, asunto, mensaje, True, copia, "alumni@usat.edu.pe", rutaarchivo, nombrearchivo) Then
                cls = Nothing
                Return True
            Else
                cls = Nothing
    ...
    Sub EnviarMensajeNotificacion(ByVal cuentas As String, ByVal mensaje As String, ByVal asunto As String, ByVal adjunto As String, ByVal dt As Integer, ByVal de As Integer, ByVal dne As Integer, ByVal dsc As Integer)
        ...
        xmensaje &= "</font>"
        Dim cls As New ClsEnvioMailAlumni
        cls.EnviarMailAd("alumni@usat.edu.pe", "alumniUSAT", "ghernandez@usat.edu.pe", "Módulo de Alumni USAT - Notificación de Envío de Correo", xmensaje, True, "")
        xmensaje = ""
        cls = Nothing
    End Sub
