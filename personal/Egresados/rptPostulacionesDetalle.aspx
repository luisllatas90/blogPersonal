<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptPostulacionesDetalle.aspx.vb" Inherits="Egresados_rptPostulaciones" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <tr style="background-color: #E8EEF7; font-weight: bold; height: 30px">
            <td colspan="7"><h3>Detalle de Postulaciones</h3></td>            
        </tr>
        <tr>
