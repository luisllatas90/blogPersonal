                                ...
                                <table align="left">
                                    ...
                                    <tr align="left">
                                        ...
                                        <a href="educacionuniversitaria.aspx?menu= <%=Request.querystring("menu")%>&id=<%=Request.querystring("id")%>&ctf=<%=Request.querystring("ctf")%>">                                         
                                            <img border=0 alt="3. Formación Académica" src="images/hojavida/formacionacademica_r.gif" />
                                        </a>
                                        </td>
                                    </tr>
                                    <tr>
