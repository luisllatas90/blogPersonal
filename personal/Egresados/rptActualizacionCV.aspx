<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptActualizacionCV.aspx.vb" Inherits="rptActualizacionCV" ValidateRequest="false" %>
...
<body>
    ...
    <table width="100%">
        <tr>
            ...
            <asp:Label ID="lblTitulo" runat="server" Text="Reporte de Actualización de CV" 
     ...
     <table class="">
     <tr>
         <td class=""> Carrera profesional: </td>
         <td class="style2">
            <asp:DropDownList ID="ddlEscuela" runat="server" Height="20px" Width="380px">
            </asp:DropDownList>
         </td>
         <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     ...
     <tr>
      ...
      <tr>
        <td class=""> Apellidos o Nombres:</td>
        <td class="style2">
                    <asp:TextBox ID="txtApellidoNombre" runat="server" Width="46%"></asp:TextBox>
        </td>
         <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> 
      
         
        <td class="style1"><label runat="server" id="lbldesde" visible="False">Desde:</label></td>
      
         
        <td class="style1"><input type="text" runat="server" id="txtDesde" visible="False" /></td>
      
         
        <td class="style1"><label runat="server" id="lblhasta" visible="False">Hasta</label></td>
      
         
        <td class="style1"><input type="text"  runat="server" id="txtHasta" visible="False" /></td>
