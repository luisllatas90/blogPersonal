...
<body>
    ...
    <br />
    <br />
             <asp:GridView ID="gvwEgresados0" runat="server" Width="100%" 
            AutoGenerateColumns="False" DataKeyNames="codigo_pso,foto_Ega,cv_Ega,NOMBRES,CORREO,APELLIDOS,EMAIL,SEXO,EMAIL_PER,codigo_alu"
            PageSize="15" CellPadding="2" ForeColor="#333333" Font-Size="Smaller" 
        Visible="False">
        <Columns>
    ...
    <table cellspacing="0" width="85%"  style="width: 85%; border-color: #0099FF; border-bottom-width: 1px; 
        ...
        <tr>
            <td colspan="2" align="center" style="height:22px; border-color: #0099FF; border-bottom-width: 1px; border-bottom-style:solid" bgcolor="#E6E6FA">
                <asp:Label ID="lblTit" runat="server" Text="Actualizar Datos Referenciales" 
                    Font-Bold="True" Font-Size="Small"></asp:Label>
            </td>
        </tr>
        <tr style="height:22px">
        ...
        <tr>
            <td class="style10">
                <asp:Label ID="lblCentroLaboral" runat="server" Text="Centro Laboral:"></asp:Label>
            </td>            
            <td>
                <asp:TextBox ID="txtCentroLaboral" runat="server" Width="80%" MaxLength="50"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style10">
            ...
            <td>
                <asp:TextBox ID="txtCargo" runat="server" Width="50%" MaxLength="50"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td colspan="2" align="right">
