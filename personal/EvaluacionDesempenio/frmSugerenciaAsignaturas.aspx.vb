...
Partial Class EvaluacionDesempenio_frmSugerenciaAsignaturas
...
#Region "Métodos"
    ...
    Private Sub mt_CargarDatos()
        Try
            ...
            fila = dt.NewRow()
            fila("codigo_asg") = "C0251"
            fila("nombre_asg") = "REALIDAD NACIONAL"
            fila("ciclo_asg") = "I"
            fila("docente_asg") = "JOSE BARDALES NEIRA"
            fila("grupo_asg") = "A"
            fila("comentario_asg") = "No cumple las espectativas..."
            fila("estado_asg") = "SUGERIDO"
