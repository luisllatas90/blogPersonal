<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSugerenciaAsignaturas.aspx.vb" Inherits="EvaluacionDesempenio_frmSugerenciaAsignaturas" %>
<!DOCTYPE html>
<html lang="es">
...
<head>
    ...
    <title>Sugerencia de evaluación de Asignaturas</title>
    ...
    <form id="frmSugerenciaAsignaturas" runat="server">
        ...
        <div class="container-fluid">
            <div class="card div-title">                        
                <div class="row title">SUGERENCIA DE EVALUACIÓN DE ASIGNATURAS</div>
            </div>
