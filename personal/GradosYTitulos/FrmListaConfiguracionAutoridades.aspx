<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmListaConfiguracionAutoridades.aspx.vb"
    Inherits="GradosYTitulos_FrmListaConfiguracionAutoridades" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html lang="en">
<head>
    <title id='Description'>Configuración de Autoridades</title>
    ...
    <script src="js/ConfiguraAutoridad.js?x=1" type="text/javascript"></script>
                            ...
                            <div id="PanelBusqueda">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="page_header">
                                        <div class="pull-left">
                                            <i class="icon ti-settings page_header_icon"></i><span class="main-text">Configuración
                                                de Autoridades</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                <label class="col-md-2 control-label ">
                                                    Cargo</label>
                                                <div class="col-md-10">
                                                    <select name="cboCargo" class="form-control" id="cboCargo">
                            ...
                            <div class="modal-content">
                                <div class="modal-header" style="background-color: #E33439; color: White; font-weight: bold;">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel3">
                                        Configurar Cargo de Autoridad</h4>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">
                                                Cargo:</label>
                                            <div class="col-sm-9">
                                                <select class="form-control" id="cboCargoR" name="cboCargoR">
                                                    <option value="" selected="">-- Seleccione -- </option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <%--                                    <div class="row">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">
                                                Prefijo:</label>
                                            <div class="col-sm-4">
                                                <input type="text" id="txtPrefijo" name="txtPrefijo" />
                                            </div>
                                        </div>
                                    </div>--%>
                                    <div class="row">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">
                                                Prefijo:</label>
                                            <div class="col-sm-9">
                                                <select class="form-control" id="cboPrefijo" name="cboPrefijo">
                                                    <option value="" selected="">-- Seleccione -- </option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">
                                                Personal:</label>
                                            <div class="col-sm-9">
                                                <select class="form-control" id="cboPersonalR" name="cboPersonalR">
                                                    <option value="" selected="">-- Seleccione -- </option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">
                                                Facultad:</label>
                                            <div class="col-sm-6">
                                                <select class="form-control" id="cboFacultad" name="cboFacultad">
                                                    <option value="" selected="">-- Seleccione -- </option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">
                                                Orden:</label>
                                            <div class="col-sm-6">
                                                <select name="cboOrden" class="form-control" id="cboOrden">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">
                                                Encargado:</label>
                                            <div class="col-sm-4">
                                                <input type="checkbox" id="chkEncargado" name="chkEncargado" style="display: block;"
                                                    checked="checked" />
                                            </div>
                                        </div>
                                    </div>
