<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmListaExpedientesSesionConsejo.aspx.vb"
    Inherits="GradosYTitulos_FrmListaExpedientesSesionConsejo" %>
...
<head>
    ...
    <script src="js/Sesion.js?x=2" type="text/javascript"></script>
    ...
    <div class="wrapper">
        <div class="content">
            ...
            <div class="main-content">
                                    ...
                                    <div class="page_header">
                                        ...
                                        <div class="buttons-list">
                                            <div class="pull-right-btn">
                                                <button class="btn btn-primary" id="btnRegistrar" value="Registrar">Registrar</button>
                ...
                <div class="row" id="RegistraSesion" style="display: none">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <label class="col-md-12 control-label" style="font-weight: bold; color: black">
                                            II. Asignar Egresados a las Sesiones Existentes :</label>
                                    </div>
                                    <div class="row">
                                        <label class="col-md-3 control-label">
                                            Elegir Sesión</label>
