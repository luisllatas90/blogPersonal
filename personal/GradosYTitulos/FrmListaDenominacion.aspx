<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmListaDenominacion.aspx.vb"
    Inherits="GradosYTitulos_FrmListaDenominacion" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html lang="en">
<head>
    <title id='Description'>Denominación</title>
    ...
    <script src="js/Denominacion.js?x=1123" type="text/javascript"></script>
                            ...
                            <div id="PanelBusqueda">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="page_header">
                                        <div class="pull-left">
                                            <i class="icon ti-bookmark-alt page_header_icon"></i><span class="main-text">Denominación
                                                de Diplomas</span>
                                        </div>
