...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <%if codigo_prp <>"" then
	...
	<%informe_prp=propuesta("esinforme_prp")%>
      ...
      <tr>
        <td height="5%" colspan="3" align="center" valign="top"><TABLE align="center" cellpadding="0" cellspacing="0">
          <%
          ...
          <TR>
            <TD align="center" class="Estilo26"><%response.write(interesado(0))%>            </TD>
          </TR>
          <%
						interesado.movenext()
					loop
      ...
      <tr>
        <td height="3%" colspan="3" align="center" valign="top">&nbsp;<%''Response.Write(propuesta("estado_prp"))%></td>
      </tr>
      
      <tr>
        <td width="82%" height="3%" align="left" valign="top"><span style="cursor:hand" class="Estilo27">&nbsp;&nbsp;Propuesta registrada el:
...
por el proponente. </span></td>
      ...
      <tr>
        <td colspan="3" align="center" valign="top"><table width="100%" height="100%" border="0" cellpadding="3" cellspacing="3">
          <tr>
            <td valign="top"><table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td width="100%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="20%" valign="top" class="Estilo37"><strong>Tipo de Propuesta </strong></td>
                            <td width="2%" valign="top" class="Estilo37"><strong>: </strong></td>
                            <td width="26%" valign="top" class="Estilo37"><%Response.write(propuesta("Descripcion_Tpr"))%></td>
                            <td width="18%" valign="top" class="Estilo37"><strong>Instancia actual </strong></td>
                            <td width="1%" valign="top" class="Estilo37"><strong>: </strong></td>
				...
				%>
                            ...
                            <td valign="top" class="Estilo37"><strong>Versiones</strong></td>
                            <td valign="top" class="Estilo37"><strong>:</strong></td>
...
%></td>
              ...
              <tr>
				...
				<iframe   src="datosVersionInforme_Presentacion.asp?codigo_prp=<%=codigo_prp%>&version=<%=RsVersiones("version_Dip")%>&instancia=<%=instancia%>" frameborder="0" class="contornotabla" width="100%" id="fraversion" name="fraversion" marginheight="0" height="470"></iframe></td>
				<%else
				RsVersiones.MoveFirst
				%>
				<iframe   src="datosVersion_presentacion.asp?codigo_prp=<%=codigo_prp%>&version=<%=RsVersiones("version_Dap")%>&instancia=<%=instancia%>" frameborder="0" class="contornotabla" width="100%" id="fraversion" name="fraversion" marginheight="0" height="470"></iframe></td>
				<%end if%>
	...
	<!--			-->
      ...
      <tr>
        <td height="3%" colspan="3"><table width="100%" height="0" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td align="right" valign="middle" class="bordesup"><span class="Estilo37"><strong><a href="presentacion_calificacion.asp?codigo_prp=<%=codigo_prp%>&codigo_rec=<%=codigo_rec%>"><p class="Estilo37"><strong>Calificaciones</A></strong></span></p>                </td>
            <td align="left" valign="middle" class="bordesup"><a href="presentacion_calificacion.asp?codigo_prp=<%=codigo_prp%>&codigo_rec=<%=codigo_rec%>"><img src="../../../../../images/menus/softwareD.gif" width="40" height="40" border="0"></a>&nbsp;&nbsp;</td>
