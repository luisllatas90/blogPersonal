...
%>
			<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
              <tr height="25">
                ...
                <td width="20%" bgcolor="#F0F0F0" class="bordeinf">&nbsp;</td>
                <td width="14%" bgcolor="#F0F0F0" class="bordeinf">&nbsp;</td>
              </tr>
              <tr>
  ...
  <tr>
    <td height="48%" valign="top"><table cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="100%">
      <tr>
        ...
        <td width="30%" height="5%" align="right" class="bordeinf"><input <%if codigo_rec="" then%> disabled="disabled"<%end if%> onClick="verPresentacion()" name="cmdPresentacion" type="button" class="presentacion" id="cmdPresentacion" value="     Presentaci&oacute;n"></td>
