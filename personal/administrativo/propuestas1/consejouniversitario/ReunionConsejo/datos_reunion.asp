...
<TR>
	<TD align="center">
	<strong>
		<span style=" color:#990000">	Por favor, espere mientras se procesa la información... </span>	</strong>	</TD>
</tR>
<TR>
	<TD align="center">
		<img src="../../../../../images/cargando.gif" >	</TD>
</tR>
<TR>
	<TD>	</TD>
</tR>
    ...
    <td height="22" colspan="2" align="center" valign="top" class="bordeizqinf">
				    ...
				    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="2">
                      ...
                      <tr>
                        ...
                        <td width="92%" align="left"><a href="../../../../../filespropuestas/actas/<%=propuesta("acta_rec")%>" target="_blank">
  ...
  <tr>
	...
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="contornotabla">
      <tr>
        ...
        <td width="114" align="center" bgcolor="#E1F1FB" class="bordeinf">&nbsp;</td>
        <td colspan="4" align="center" bgcolor="#E1F1FB" class="bordeinf Estilo2"><strong>Ver</strong></td>
        </tr>
      <%do while not RsAgenda.eof
	  	i=i+1
	  %>
	  <tr>
        <td width="19" valign="top" class="bordeinf"><span class="Estilo2"><%=i%>.-&nbsp;</span></td>
		<%
		...
		%>
        <td width="530" valign="top" class="bordeinf"><span class="Estilo2"><%=RsAgenda(1)%>. <%=RsAgenda("estado")%></span></td>
        <td align="center" class="bordeinf"><span class="Estilo3">(<%=estadoActual%>)</span></td>
        <td width="40" align="right" bgcolor="#FFFFFF" class="bordeinf"><span class="bordesup"><img src="../../../../../images/menus/todos.gif" alt="Editar Discusiones" border="0" style="cursor:hand" onClick="RegistraDiscusion('<%=RsAgenda(0)%>','<%=codigo_rec%>')"></span></td>
        <td width="75" align="left" valign="middle" class="bordeinf"><span class="Estilo1" style="text-align:center; cursor:hand" onClick="RegistraDiscusion('<%=RsAgenda(0)%>','<%=codigo_rec%>')">Discusiones</span></td>
	    <td width="75" align="right" class="bordeinf"><span class="bordesup">
	    ...
	    <td width="75" align="left" class="bordeinf"><span class="Estilo1" style="text-align:center; cursor:hand" onClick="RegistraAcuerdo('<%=RsAgenda(0)%>','<%=codigo_rec%>')">Acuerdos</span></td>
	  </tr>
	  <tr>
	    <td colspan="7"></td>
	    </tr>
