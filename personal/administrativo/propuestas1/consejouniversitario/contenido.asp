    ...
    <td height="29%" valign="top"><input name="hidden" type="HIDDEN" id="txtelegido">
	    <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
		  <tr>
			...
			if inf="SI" then			
				set propuesta=objCC.Consultar("ConsultarPropuestas","FO","IF",instancia,estado,codigo_per,nombre_prp,informe)		
...
''								set RsFechas=objVence.Consultar("ConsultarFechasPropuesta","FO","FE",propuesta(0),codigo_per,instancia)
								set RsFechas=objVence.Consultar("ConsultarFechasPropuesta","FO","IN",propuesta(0),codigo_per,instancia)								
