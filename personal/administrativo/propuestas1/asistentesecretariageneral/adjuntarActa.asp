...
function SeleccionarFila1()
{
	...
	//}
		...
		function eliminar(codigo_rec,archivo,codigo_cop){
			...
			//alert(codigo_cop)
			location.href="guardaracta.asp?accion=eliminar&codigo_rec=" + codigo_rec + "&archivo=" + archivo			
			}
			else
			{
...
%>
		...
		<form id="frmSubir" action="guardaracta.asp?codigo_rec=<%=codigo_rec%>" method="post" enctype="multipart/form-data">
		<input name="doCreate" type="hidden" id="doCreate" value="true">
		  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="6%" height="25" class="bordeinf"><img src="../../../../images/menus/nuevo_1.gif" width="35" height="35" border="0"></td>
              <td width="94%" class="bordeinf Estilo4">&nbsp;&nbsp;Adjuntar Acta </td>
            </tr>
            <tr>
              <td colspan="2" valign="top"><table width="100%" height="100%" border="0" cellpadding="5" cellspacing="0" bordercolor="#111111" style="border-collapse: collapse">
                ...
                <tr>
                  ...
                  <td height="20" colspan="2"><span class="Estilo7">Acta  adjunta (01 archivo) </span></td>
                </tr>
                <tr>
...
//			  		do while not rsArchivosPrp.eof
			  if rsInformePrp("acta_rec") <> "" then%>
                            <TR height="25" onMouseOver="Resaltar(1,this,'S')" onMouseOut="Resaltar(0,this,'S')" class="Sel" typ="Sel" onClick="ponervalortext('<%=rsInformePrp("acta_rec")%>')" >
                              <td  width="5%" align="left" valign="middle">&nbsp;</td>
                              <td width="15%" align="center">
							  <a href="../../../../filespropuestas/actas/<%=rsInformePrp("acta_rec")%>" target="_blank"> 
							  <img src="../../../../images/ext/<%=right(rsInformePrp("acta_rec"),3)%>.gif" width="16" height="16"  border="0"> 
							  </a>
							   </td>
                              <td width="80%" align="left"><%response.write(rsInformePrp("acta_rec"))%></td>
                            </TR>
              <%end if
                        ...
                        <td width="10%" align="right" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="0">
                              <tr>
                                <td align="right">
								<input type="button" name="cmdEnviar" onClick="ValidarSilabos()" value=" Agregar" class="attach_prp" style="width: 85" <%if rsInformePrp("acta_rec")<>"" then%> disabled="disabled" <%end if%>>
								</td>
                              </tr>
                              <tr>
