	...
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="contornotabla">
	  ...
	  <tr>
        ...
        <td width="23" align="center"><span class="bordesup Estilo2"><img src="../../../../images/menus/Persona_s.gif" <% if RsAgenda("estado_prp")<>"A" then %>style="visibility:hidden" <%end if%> alt="Editar Responsable" width="16" height="16" border="0" style="cursor:hand" onClick="RegistraResponsable('<%=RsAgenda(0)%>','<%=RsAgenda("codigo_per")%>')">			</span>		</td>
       				<% end if%>
	    <td width="21" align="center"><span class="bordesup">
		<img src="../../../../images/menus/todos.gif" alt="Editar Discusiones" border="0" style="cursor:hand" <%if RsAgenda("estado_prp")="P" then %> style="visibility:hidden" <%end if%> onClick="RegistraDiscusion('<%=RsAgenda(0)%>','<%=codigo_rec%>')"></span> </td>
	    <td width="30" align="center"><span class="bordesup"><img src="../../../../images/menus/editar.gif" <%if RsAgenda("estado_prp")="P" then %> style="visibility:hidden" <%end if%> alt="Editar Acuerdos" border="0" style="cursor:hand" onClick="RegistraAcuerdo('<%=RsAgenda(0)%>','<%=codigo_rec%>')"> </span> </td>
