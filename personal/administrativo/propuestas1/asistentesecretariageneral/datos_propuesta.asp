...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
      ...
      <tr>
        <td valign="top"><span class="Estilo2"><strong>Área</strong></span></td>
      ...
      <tr>
        ...
        <td width="5%" valign="top"><span class="Estilo1">Tipo:</span></td>
        <td width="35%" valign="top"><span class="Estilo2">
      ...
      <tr>
        <td colspan="5" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td valign="top" class="Estilo2"><strong><span style="background-color:#FFFF99">
                <%
