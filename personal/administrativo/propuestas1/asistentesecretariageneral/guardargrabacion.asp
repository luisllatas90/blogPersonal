...
if Request.QueryString("accion")="eliminar" then
		archivo1=server.MapPath("../../../../filespropuestas/grabaciones/" & Request.QueryString("archivo"))
	...
	//	ObjPropuesta.ejecutar "EliminarArchivoPropuesta",false,Request.QueryString("archivo")
		...
		objPropuesta.Ejecutar "ActualizarReunionConsejo",false,"gr",codigo_rec,0,0,0,0
		response.write(archivo1)			
		objPropuesta.CerrarConexionTrans		
		response.redirect "adjuntargrabacion.asp?codigo_rec=" & codigo_rec
else
	...
	''*************************************************************************************
	//directorio=
	directorio=CrearCarpeta(server.MapPath("../../../../filespropuestas/grabaciones/"))
	...
	Set Cargar = New clsSubir
		...
		archivogenerado="grab_rec_" + codigo_rec
...
//		ffin=Cargar.Fields("fechafin").Value
		...
		''*************************************************************************************
				...
				Set objCC=Server.CreateObject("PryUSAT.clsAccesoDatos")
		           ObjCC.AbrirConexion				
  					Call objCC.ejecutar("ActualizarReunionConsejo",false,"RE",codigo_rec,descripcion_prp,0,0,0)
