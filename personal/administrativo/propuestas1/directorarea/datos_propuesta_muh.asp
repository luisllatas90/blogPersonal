  ...
  <tr>
    <td align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
      ...
      <tr>
        ...
        <td width="78%" valign="top"><div align="justify" class="Estilo1">
      ...
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="Estilo2"><TABLE cellpadding="0" cellspacing="0">
                  <%
      ...
      <tr>
        <td colspan="3" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td valign="top" class="Estilo2"><strong>Informe</strong></td>
              <td valign="top" class="Estilo2"><strong>: </strong></td>
              <td valign="top" class="Estilo2"><%
				select case propuesta("esinforme_prp")
		  		case "SI"
					response.write("Sin Informe")
		  		case else 
					response.write("Con Informe")
				end select					
				%></td>
            </tr>
            <tr>
		...
		Do While not RsVersiones.EOF
			i=i+1
			if i=1 then%>
				<span onClick="enviarVersion('<%=codigo_prp%>','<%Response.Write(RsVersiones("version_Dap"))%>')"  style="cursor:hand"> <%Response.Write(RsVersiones("version_Dap"))%> 
				</span>
			    <%else
				Response.Write(" - ") %>
				<span onClick="enviarVersion('<%=codigo_prp%>','<%Response.Write(RsVersiones("version_Dap"))%>')"  style="cursor:hand"> <%Response.Write(RsVersiones("version_Dap"))%> 
...
%>              </td>
			  ...
			  <input name="txtVersion" type="button" class="nuevaversion" id="txtVersion" value=" Nueva Versi&oacute;n" border="" onClick="AbrirPopUps('registraversion.asp?codigo_prp=<%=codigo_prp%>','550','750')" <%if instancia_PRP="P"  or estado="A" then%>disabled="disabled" <%end if%> style="visibility:hidden">
			  </td>
            </tr>
        </table></td>
      </tr>
  ...
  <tr>
    ...
    <td  align="center" valign="top"><iframe height="180" src="datosVersion.asp?codigo_prp=<%=codigo_prp%>&version=<%=RsVersiones("version_Dap")%>&instancia=<%=instancia%>" frameborder="0" class="contornotabla" width="98%" id="fraversion" name="fraversion" marginheight="0"> </iframe></td>
  </tr>
</table>
</body>
<%end if%>
