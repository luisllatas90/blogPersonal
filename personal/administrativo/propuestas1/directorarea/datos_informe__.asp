...
%>              </td>
			  ...
			  <input name="txtVersion" type="button" class="nuevaversion" id="txtVersion" style="visibility:hidden" value=" Nueva Versi&oacute;n" border="" onClick="AbrirPopUps('registraInforme.asp?codigo_prp=<%=codigo_prp%>','550','750')">			  </td>
            </tr>
        </table></td>
      </tr>
    </table></td>
