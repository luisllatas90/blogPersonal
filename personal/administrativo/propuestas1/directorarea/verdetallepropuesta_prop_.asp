...
<center>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="center" valign="top"><span class="usatTituloAplicacion">Consulta de Propuesta</span><span class="usatTituloPagina"> (Proponente) </span></td>
    </tr>
  </table>
  <p>
    <%  
...
<%
			  ...
			  <tr>
				...
				<a href="../../../../filespropuestas/<%=prop%>/<%=rsArchivosPrp("nombre_apr")%>" target="_blank">			
				<img src="../../../../images/ext/<%=right(rsArchivosPrp(2),3)%>.gif" width="16" height="16" border="0">				</td>
				</a>
                <td width="92%" align="left"><%response.write(rsArchivosPrp(3))%></td>
              </tr>
              <%
