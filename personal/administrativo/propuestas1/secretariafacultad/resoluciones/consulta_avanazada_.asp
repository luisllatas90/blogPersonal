...
%>
			<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
              <tr height="25">
                ...
                <td width="88%" align="right" valign="top" bgcolor="#F0F0F0" class="bordeinf">				<table width="100%"  border="0">
                  <tr>
		 ...
		 %>
                ...
                <td width="11%" align="center" bgcolor="#F0F0F0" class="bordeinf"><input name="Submit" type="submit" class="buscar1" value="     Buscar"></td>
              </tr>
              <tr>
