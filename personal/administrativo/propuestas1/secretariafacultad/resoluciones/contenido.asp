...
<%			nombre_prp=Request.Form("txtNombrePrp")
			...
			if nombre_prp = "NO" then
				set convenio=objCC.Consultar("RS_ConsultarResoluciones","FO","TO",0,0)
			else
				set convenio=objCC.Consultar("RS_ConsultarResoluciones","FO","TO",0,nombre_prp)
			end if		
...
(<%=convenio.RecordCount%>)                  </span>
              ...
              <tr>
				...
				<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" >
                    <tr>
                      <td width="35%"  height="3%" align="center" bgcolor="#F0F0F0" class="bordeinf"><strong>Resoluci&oacute;n</strong></td>
                      <td width="15%"  height="3%" align="center" bgcolor="#F0F0F0" class="bordeizqinf"><strong>Fecha Emisi&oacute;n </strong></td>
                      <td width="15%" align="center" bgcolor="#F0F0F0" class="bordeizqinf"><strong>Tipo</strong></td>
                      <td width="20%"  height="3%" align="center" bgcolor="#F0F0F0" class="bordeizqinf"><strong>Observaci&oacute;n</strong><strong></strong></td>
                      <td width="15%"  height="3%" align="center" bgcolor="#F0F0F0" class="bordeizqinf"><strong>Fecha Registro </strong>&nbsp;</td>
                    </tr>
                    <tr>
                      <td colspan="5"><div id="listadiv" style="height:100%" class="NoImprimir">
                          <table table class="sortable" id="unique_id" width="100%" border="0" cellpadding="0" cellspacing="0" name="rsTable" id=rsTable  cols=5 >
                            <tr>
                              ...
                              <td width="15%" align="right" class="bordeinf">&nbsp;Ordenar</td>
                              <td width="15%" align="right" class="bordeinf">&nbsp;Ordenar</td>
                              <td width="20%" align="right" class="bordeinf">&nbsp;Ordenar</td>
                              <td width="15%" align="right" class="bordeinf">&nbsp;Ordenar</td>
                            ...
                            <tr id="fila<%=convenio(0)%>" height="17"  onMouseOver="Resaltar(1,this,'S')" onMouseOut="Resaltar(0,this,'S')" class="Sel" Typ="Sel" onClick="ResaltarfilaDetalle('',this,'datos_resolucion.asp?codigo_cni=<%=convenio(0)%>');activamodifica('<%=veredicto%>','<%=estado%>')">
                              <td valign="top" width="30%"><%=convenio(1)%><br><br></td>
                              <td  valign="top"  width="11%" align="left">
							  	<%=convenio(2)%>
							  </td>
                              <td valign="top"  width="10%" align="center"><%=convenio(3)%></td>
                              <td valign="top"  width="42%" align="center"><%=convenio(4)%></td>
                              <td valign="top"  width="7%" align="center"><%=convenio(5)%></td>
  ...
  <tr>
    <td height="48%" valign="top"><table width="100%" height="100%" cellpadding="0" cellspacing="0" bordercolor="#111111" class="contornotabla" style="border-collapse: collapse">
      <tr>
        <td width="81%" height="5%" align="center" bgcolor="#E1F1FB" class="bordeinf" id="tab" onClick="AbrirPropuesta('datos_resolucion.asp')"><span class="Estilo3">&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Datos de la Resoluci&oacute;n </span></td>
        <td width="19%" align="center" bgcolor="#E1F1FB" class="bordeinf" id="tab" onClick="AbrirPropuesta('datos_resolucion.asp')"><input name="Submit3" type="submit" class="imprimir_prp" value="         Imprimir" onClick="imprimir()"></td>
      </tr>
      <tr>
