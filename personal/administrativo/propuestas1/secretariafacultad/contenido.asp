...
<%
	...
	persona= Request.QueryString("id")
%>
		...
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
				...
				<td width="40%"><input name="Submit2224" type="button" class="enviaryrecibir1" value="      Enviar y Recibir" onClick="actualizarlista('contenido.asp?estado=<%=estado%>&instancia=<%=instancia%>&menu=<%=menu%>&nombre=<%=nombre_prp%>')" style="visibility:hidden">
				  <input name="Submit3" type="button" class="cambiouser" onClick="AbrirMenu()" value="      Cambiar Funci&oacute;n"></td>
					<td align="right"><input  onClick="Aprobar()" name="cmdconforme2" type="submit"  class="subirinforme" id="cmdconforme2" value="         Calificar"></td>
					<td width="10%">&nbsp;</td>
					<td width="10%">&nbsp;</td>
				    <td>&nbsp;</td>
			  </tr>
...
<%	
			...
			if  nombre_prp="" then
	     	...
	     	ObjCC.AbrirConexion				
				set propuesta=objCC.Consultar("PRP_ConsultarPropuestasConsejoFacultad","FO",tipo,persona,estado)		
                      ...
                      <td colspan="6"><div id="listadiv" style="height:100%" class="NoImprimir">
                          <table table class="sortable" id="unique_id" width="100%" border="0" cellpadding="0" cellspacing="0" name="rsTable" id=rsTable  cols=5 >
                            ...
                            <%do while not propuesta.eof
								...
								set RsFechas=objVence.Consultar("ConsultarFechasPropuesta","FO","FA",propuesta(0),codigo_per,instancia)
