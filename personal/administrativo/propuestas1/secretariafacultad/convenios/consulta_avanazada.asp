  ...
  <tr>
    <td width="100%" height="4%">
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
					<td width="10%"><input name="Submit2" type="hidden" class="nuevo1"  value="       Nuevo"  onClick="popUp('registra_convenio.asp?modifica=0','600','600','yes')"></td>
					<td width="10%"><input name="cmdmodificar" type="hidden" class="modificar_1" <%if estado="A" then%> style="visibility:hidden" <%end if%> id="cmdmodificar" value="       Modificar" disabled="disabled" onClick="popUp('registra_convenio.asp?modifica=1&codigo_cni=' + txtelegido.value.substring(4,txtelegido.value.length) ,'600','600','yes')">
					</td>
					<td width="10%">&nbsp;</td>
					<td width="10%">&nbsp;</td>
					<td width="10%">&nbsp;</td>
                              ...
                              <td  width="18%" align="center"  valign="top" class="bordeinf">
										...
										''	IF institucion("CODIGO_INS")<> "68" THEN
											...
											<%
												...
												''	Response.Write(institucion("nombre_pai"))
											%>
											<!-- </td>
											</tr>
											</table>-->
