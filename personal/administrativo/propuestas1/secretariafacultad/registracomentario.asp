        ...
        <td align="center" valign="top">
            <table width="95%" border="0" align="center" cellpadding="2" cellspacing="2">
              ...
              <tr>
                ...
                <td colspan="2" align="right" valign="bottom"><input name="ChkComentario" type="checkbox" id="ChkComentario" value="0"  onClick="CambiarCheck()" style="visibility:hidden" ></td>
                </tr>
