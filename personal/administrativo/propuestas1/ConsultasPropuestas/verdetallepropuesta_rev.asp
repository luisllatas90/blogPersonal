...
<center>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="50%" align="center" valign="top"><span class="usatTituloAplicacion">Consulta de Propuestas</span></td>
      <td width="50%"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="contornotabla">
          <tr>
            <td width="49%" align="right" valign="middle" class="usatCeldaTitulo"><img src="../../../../images/bien.gif" width="15" height="15"></td>
            <td width="60%" align="left" valign="middle" class="usatCeldaTitulo">&nbsp;Calificar</td>
          </tr>
		  <%
		    Set objVeredicto=Server.CreateObject("PryUSAT.clsAccesoDatos")
	     	objVeredicto.AbrirConexiontrans
			  
		  if REQUEST.querystring("veredicto")= "c" then ''SI EL VEREDICTO FUE CONFORME
		  ''	response.write("CONFORME")
    		objVeredicto.ejecutar "ActualizaVerdictoRevisor",false,"CP",session("codigo_Usu"),prop,REQUEST.querystring("instancia"),"C"			
		  end if
		  if REQUEST.querystring("veredicto")="n" then ''SI EL VEREDICTO FUE NO CONFORME
		  ''	response.write("NO CONFORME")	
			objVeredicto.ejecutar "ActualizaVerdictoRevisor",false,"CP",session("codigo_Usu"),prop,REQUEST.querystring("instancia"),"N"
				  	
		  end if
		  ''CONSULTAR LOS VERDICTOS DE LOS TODOS LOS REVISORES
			SET rsVeredictos = objVeredicto.consultar ("VerificarVerdicto","FO","SE",0,prop," ")
					cambio=1
					...
					if cambio = 1 then
						...
						objVeredicto.ejecutar "ActualizarPropuesta", false, "VE", prop, "S"
						else
						response.write(cambio)
					end if
	    	objVeredicto.CerrarConexiontrans
		  ...
		  <%''verifica el veredicto consultándodolo según el usuario que se ha logueado, el codigo_prp y la instancia en alq ue se encuentra
		    ...
		    Set objVeredicto1=Server.CreateObject("PryUSAT.clsAccesoDatos")
	     	objVeredicto1.AbrirConexiontrans		
			SET VeredictoActual=objVeredicto1.consultar ("VerificarVerdicto","FO","VE",session("codigo_Usu"),prop,REQUEST.querystring("instancia"))
			veredicto1=VeredictoActual(0)
			''response.write(veredicto1)
			objVeredicto1.CerrarConexiontrans
			set objVeredicto1=nothing 		  
		  %>
          <tr>
            <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" valign="middle"><a href="verdetallepropuesta_rev.asp?propuesta=<%=request.querystring("propuesta")%>&instancia=<%=request.querystring("instancia")%>&veredicto=c"><img src="../../../../images/img4.gif" width="32" height="32" border="0"></a>				  </td>
                  <td align="center" valign="middle"><a href="registraobservacion1.asp?propuesta=<%=request.querystring("propuesta")%>&instancia=<%=request.querystring("instancia")%>&veredicto=o&coment_propuesta=<%=coment1%>"><img src="../../../../images/img5.gif" width="32" height="32" border="0"></a></td>
                  <td align="center" valign="middle"><a href="verdetallepropuesta_rev.asp?propuesta=<%=request.querystring("propuesta")%>&instancia=<%=request.querystring("instancia")%>&veredicto=n"><img src="../../../../images/rechazar.gif" width="32" height="32" border="0"></a></td>
                </tr>
                <tr>
                  <td align="center" valign="middle">
				  
				   <%if REQUEST.querystring("veredicto")= "C" or veredicto1="C" then %>
				  <b><font color="#FF0000"> Conforme </font></b>
				  <%else%>
				   Conforme
				  <%end if%>
				  </td>
                  <td align="center" valign="middle">
		  	      ...
		  	      <%if REQUEST.querystring("veredicto")= "O" or veredicto1="O" then %>
				  <b><font color="#FF0000"> Observado</font></b>
				  <%else%>
				   Observar
				  <%end if%>
				  </td>
                  <td align="center" valign="middle">
		  	      ...
		  	      <%if REQUEST.querystring("veredicto")= "N" or veredicto1="N" then %>
				  <b><font color="#FF0000"> No Conforme</font></b>
				  <%else%>
				   No Conforme
				  <%end if%>				  
				  </td>
...
<%
  ...
  <p><span class="usattitulousuario">  Observaciones</span><br>
    <br>
...
<%
    ...
    <tr>
      <td colspan="4" align="center" class="bordesup"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
          <td width="5%" align="right"><img src="../../../../images/rpta.GIF">&nbsp;</td>
          <td width="95%">&nbsp;<a href="registraobservacion1.asp?comentario=<%=RsComentarios("codigo_cop")%>&codigo_prop=<%=prop%>" class="usatError">Responder a esta observaci&oacute;n </a></td>
        </tr>
      </table></td>
    </tr>
  </table>
