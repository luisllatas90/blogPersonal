...
''			  response.write()
  ...
  <tr>
    <td height="22" align="right" valign="middle" class="bordeizq etiqueta"><img src="../../../../images/menus/user_card_1.gif" width="29" height="22"></td>
    <td height="22" align="left" valign="middle"><span class="etiqueta">&nbsp;Informe</span></td>
  </tr>
  <tr>
    <td height="22" colspan="2" align="center" valign="top" class="bordeizqinf">
	
	<%if propuesta("descripcioninforme_prp") <>"" then%>
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          <td width="8%" align="left"><a href="../../../../filespropuestas/<%=codigo_prp%>/<%=propuesta("nombreinforme_prp")%>" target="_blank"> <img src="../../../../images/ext/<%=right(propuesta("nombreinforme_prp"),3)%>.gif" width="16" height="16" border="0"> </a> </td>
          <td width="92%" align="left"><%Response.write(propuesta("descripcioninforme_prp"))%></td>
        </tr>
      </table>
	<%
	else
		Response.write("No presenta informe")
	end if
