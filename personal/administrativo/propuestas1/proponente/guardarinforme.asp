...
if Request.QueryString("accion")="eliminar" then
	...
	//ObjPropuesta.ejecutar "EliminarArchivoPropuesta",false,Request.QueryString("archivo")
		Call ObjPropuesta.ejecutar("RegistraInformePropuesta",false,codigo_prp,null,null)		
		objPropuesta.CerrarConexionTrans		
		response.redirect "adjuntarinforme.asp?codigo_prp=" & codigo_prp
else
	...
	Set Cargar = New clsSubir
		...
		archivogenerado="inf" + codigo_prp + nusuario + fechahora		
...
//		ffin=Cargar.Fields("fechafin").Value
		...
		''*************************************************************************************
				...
				Set objCC=Server.CreateObject("PryUSAT.clsAccesoDatos")
		           ObjCC.AbrirConexion				
  					Call objCC.ejecutar("RegistraInformePropuesta",false,codigo_prp,ArchivoNuevo,descripcion_prp)
