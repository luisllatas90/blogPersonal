  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
		  ...
		  <table <%IF RsArchivo.RecordCount=0 THEN%>  background="../../../../images/fr.gif" <%end if%> height="50" width="100%" border="0" cellpadding="0" cellspacing="0" class="contornotabla">
            <tr height="100%">
              <td height="100%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
             <%IF RsArchivo.RecordCount=0 THEN%>
			  		<span style="color:#FFCC00">
			  		<B>No ha registrado archivos, registre una nueva versión con los archivos adjuntos.</B>
			  		</span>
