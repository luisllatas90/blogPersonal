...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
      ...
      <tr>
        <td width="19%" valign="top"><span class="Estilo1">Denominaci&oacute;n</span></td>
        <td width="1%" valign="top"><span class="Estilo1">: </span></td>
        <td colspan="2" valign="top"><div align="justify" class="Estilo1">
      ...
      <tr>
        ...
        <td width="18%" rowspan="2" align="center" valign="middle"><table width="2%" border="0" cellpadding="0" cellspacing="0" class="contornotabla">
          <tr>
      ...
      <tr>
        <td colspan="4" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="19%" valign="top" class="Estilo2"><strong>Facultad</strong></td>
              <td width="1%" valign="top" class="Estilo2"><strong>:</strong></td>
              <td width="28%" valign="top" class="Estilo2"><%
		...
		set objVERSION=nothing
  		if RsVersiones.recordcount =0 then
			...
			Do While not RsVersiones.EOF
				i=i+1%>
			<span onClick="enviarVersion('<%=codigo_prp%>','<%Response.Write(RsVersiones("version_Dip"))%>')"  style="cursor:hand"> 
		...
		%>		
		     <input type="hidden"  name="txtVersiones" <%if RsVersiones.recordcount =0 then%> value="NO" <%else%>value="SI"<%end if%> ></td>
              <td align="right" valign="top" class="Estilo2">
			  <input  name="txtVersion" type="button" class="nuevaversion" id="txtVersion" value="  Nueva Versi&oacute;n" onClick="AbrirPopUps('registraInforme.asp?codigo_prp=<%=codigo_prp%>','550','750')" tooltip="Registre una Nueva Versi&oacute;n del Informe">	 
	 </td>
            </tr>
        </table></td>
      </tr>
  ...
  <tr>
	...
	<td  align="center" valign="top"> <p class="Estilo2">&nbsp;</p>
      <table width="70%" border="0" cellpadding="0" cellspacing="3" class="contornotabla">
        ...
        <tr>
          <td><p align="justify" class="Estilo2 Estilo6">Le ha sido asignada la ejecuci&oacute;n de esta propuesta, s&iacute;rvase a registrar los datos del <span class="Estilo5">Informe</span>, hacer clic en &quot;<span class="Estilo5">Nueva Versi&oacute;n</span>&quot;, llenar los datos y <span class="Estilo5">Guardar.</span></p>          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
