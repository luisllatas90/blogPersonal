...
dim RsComentarios
 //consulta mi recordset
    ...
    <tr>
	 ...
	 <font size="4" color="#000066" face="Arial, Helvetica, sans-serif"> 
	 <strong>De: <%response.write(RsComentarios("nombre"))%></strong></font>
	  </td>
      <td width="25%" align="center" valign="middle">	 
  		<font size="4" color="#000066" face="Arial, Helvetica, sans-serif"> <strong>Enviado el: </strong>
    ...
    <tr>
	  ...
	  <font size="4" color="#990000" face="Arial, Helvetica, sans-serif">
      ...
      <td colspan="2" align="left" >
	  <div align="justify"> <font  size="4" color="#000000" face="Arial, Helvetica, sans-serif">
	  <strong>
