    ...
    <td width="100%" height="6%">
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
				...
				<%end if%>
					<td width="25%" align="right"><input  onClick="Aprobar()" name="cmdconforme2" type="submit"  class="subirinforme" id="cmdconforme2" value="         Calificar"></td>
...
''				set propuesta=objCC.Consultar("ConsultarPropuestas","FO","PD",instancia,estado,codigo_per,nombre_prp,informe)
				set propuesta=objCC.Consultar("ConsultarPropuestasRevision","FO","SS",instancia,estado,codigo_per,nombre_prp,informe,estado_prop)				
			end if
                    ...
                    <tr>
                      <td colspan="6"><div id="listadiv" style="height:100%" class="NoImprimir">
                          <table table class="sortable" id="unique_id" width="100%" border="0" cellpadding="0" cellspacing="0" name="rsTable" id=rsTable  cols=5 >
							...
							<%
							codigo_per=41 
							''por ser el secretario general e instanacia secretariageneral
							%>
