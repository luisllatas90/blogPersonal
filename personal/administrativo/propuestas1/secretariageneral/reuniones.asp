  ...
  <tr>
    <td width="100%" height="6%">
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
					<td width="10%"><input name="Submit2" type="button" class="nuevo1"  value="       Nuevo"  onClick="AbrirPopUp('registrareunion.asp?modifica=0','600','650')"></td>
					<td width="10%"><input name="cmdmodificar" type="button" class="modificar_1" <%if estado="A" then%> style="visibility:hidden" <%end if%> id="cmdmodificar" value="       Modificar" disabled="disabled" onClick="AbrirPopUp('registrareunion.asp?modifica=1&codigo_rec=' + txtelegido.value.substring(4,txtelegido.value.length),'600','650')"></td>
					...
					<td width="10%">&nbsp;</td>
					<td width="10%"><input name="Submit3" type="button" class="cambiouser" onClick="AbrirMenu()" value="      Cambiar Funci&oacute;n"></td>
					<td width="10%">&nbsp;</td>
...
<%			nombre_prp=Request.Form("txtNombrePrp")
			...
			if nombre_prp ="" then
				...
				if nombre_prp = "NO" then
					set reunion=objCC.Consultar("ConsultarReunionConsejo","FO","CO",0,Request.QueryString("id"),0)			
				else
					set reunion=objCC.Consultar("ConsultarReunionConsejo","FO","CN",0,Request.QueryString("id"),nombre_prp)			
				end if
  ...
  <tr>
    <td height="48%" valign="top"><table cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="100%">
      <tr>
        ...
        <input <%if codigo_rec="" then%> disabled="disabled"<%end if%> onClick="verActa()" name="cmdGeneraActa" type="button" class="enviarpropuesta" id="cmdGeneraActa" value="      Genera Acta" style="visibility:hidden">
		</td>
