...
<center>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="center" valign="top"><span class="usatTituloAplicacion">Consulta de Propuestas</span></td>
    </tr>
  </table>
  <p>
    <%  
...
<%
  ...
  <table width="80%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td rowspan="2" align="center"><span class="usattitulousuario">Observaciones</span></td>
