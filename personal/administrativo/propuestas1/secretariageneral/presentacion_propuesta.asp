      ...
      <tr>
        <td height="3%" colspan="3"><table width="100%" height="0" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			<td class="bordesup"><img  src="../../../../images/menus/conforme1.gif" width="35" height="35" border="0" style="cursor:hand" onClick="Aprobar('<%=codigo_prp%>','<%=codigo_rec%>','<%=codigo_per%>')"  style="display:none" ></td>
            <td class="bordesup"><span  class="Estilo56" style="cursor:hand" onClick="Aprobar('<%=codigo_prp%>','<%=codigo_rec%>','<%=codigo_per%>','<%=informe_prp%>')" style="display:none"><span class="Estilo37"  style="display:none" ><strong>Aprobar</strong></span></span></td>
            <td class="bordesup">&nbsp;&nbsp;<img  src="../../../../images/menus/noconforme_1.gif" width="35"  height="35" border="0" style="cursor:hand" onClick="Denegar('<%=codigo_prp%>','<%=codigo_rec%>')"  style="display:none" ></td>
            <td class="bordesup">
			<span  class="Estilo56" style="cursor:hand" onClick="Denegar('<%=codigo_prp%>','<%=codigo_rec%>')"  style="display:none" ><span class="Estilo37"  style="display:none" ><strong>Denegar</strong></span></span></td>
          </tr>
				<%
				end if
