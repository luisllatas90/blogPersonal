...
<html>
<head>
<title>Registro Responsable de la Ejecuci&oacute;n de la Propuesta</title>
...
eval ("frminstitucion." + objeto + ".readOnly=false")
	...
	function EnviarResponsable(codigo_prp,codigo_per,codigo_cco,informe){
		...
		frmResponsable.action="RegistraResponsable.asp?accion=guardar&codigo_prp="+codigo_prp+"&codigo_per="+codigo_per+"&codigo_cco="+codigo_cco+"&informe="+informe //  (instancia B) proponente que guarda como borrador |  (instancia P) proponente que envìa como director
alert(informe)
...
<%
''CARGAR DATOS DEL COMBO PERSONAL
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td bgcolor="#F0F0F0" class="bordeinf"><table  width="95%" height="100%" border="0" align="center" cellpadding="0" cellspacing="5">
        <tr>
          <td valign="top"><input name="Submit" type="button" onClick="EnviarResponsable('<%=codigo_prp%>','<%=codigo_per%>','<%=centrocosto%>','<%=informe_prp%>')" class="guardar_prp" value="    Asignar Responsable"></td>
	<%	    Set objProp=Server.CreateObject("PryUSAT.clsAccesoDatos")
	     	objProp.AbrirConexiontrans
      ...
      <td valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="100%"><table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td colspan="3" align="center" valign="top"><span class="Estilo5">Registro de Responsable de Ejecuci&oacute;n de la Propuesta:</span></td>
              </tr>
            <tr>
            ...
            <tr>
              ...
              <td width="71%"><span class="Estilo6 Estilo8">
                <%call llenarlista("cboPersonal","actualizarlista('RegistraResponsable.asp?SELECCION=SI&codigo_per=' + this.value + '&codigo_prp="& codigo_prp &"')",rsPER,"codigo_per","personal",codigo_per,"Seleccione un trabajador","","")
			  	rsPER.close
		    	set rsPer= nothing
		 ...
		 %>
            ...
            <tr>
              <td colspan="3"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF" class="contornotabla">
                <tr>
                  <td width="1%">&nbsp;</td>
                  <td width="22%">&nbsp;</td>
                  <td colspan="2">&nbsp;</td>
