...
<script>
	function CambiarCheck(){
		if (document.all.ChkComentario.checked==true){
			...
			alert ('El comentario sólo será visto por los miembros de Consejo Universitario')
		}
		else{
			frmpropuesta.txtasunto_cop.value="Observación"
			alert ('La observación será dada a conocer al proponente')			
		}			
	...
	{	
		...
		if (frmpropuesta.ChkComentario.checked==true){		
			var ObsCom="C"
		}
		else{
			var ObsCom="O"
...
//				location.href="procesar.asp?codigo_ipr=" + codigo_ipr + "&nivelrestriccion_cop=P&codigorespuesta_cop=" + coment1 + "&estado_cop=I&asunto_cop=" + asunto_cop + "&comentario_cop=" + comentario_cop + "&remLen=" + remLen + "&accion=guardarcomentario&codigo_prp=" + codigo_prp	+ "&attach=1"									
				location.href="procesar.asp?codigo_ipr=" + codigo_ipr + "&nivelrestriccion_cop=" + estado_prp + "&codigorespuesta_cop=" + coment1 + "&estado_cop=I&asunto_cop=" + asunto_cop + "&comentario_cop=" + comentario_cop + "&remLen=" + remLen + "&accion=guardarcomentario&codigo_prp=" + codigo_prp	+ "&attach=1&ObsCom=" + ObsCom								
				}
				else{
...
//				location.href="procesar.asp?codigo_ipr=" + codigo_ipr + "&nivelrestriccion_cop=P&codigorespuesta_cop=" + coment1 + "&estado_cop=A&asunto_cop=" + asunto_cop + "&comentario_cop=" + comentario_cop + "&remLen=" + remLen + "&accion=guardarcomentario&codigo_prp=" + codigo_prp + "&envio_cop=1"							
				location.href="procesar.asp?codigo_ipr=" + codigo_ipr + "&nivelrestriccion_cop=" + estado_prp + "&codigorespuesta_cop=" + coment1 + "&estado_cop=A&asunto_cop=" + asunto_cop + "&comentario_cop=" + comentario_cop + "&remLen=" + remLen + "&accion=guardarcomentario&codigo_prp=" + codigo_prp + "&envio_cop=1&ObsCom=" + ObsCom
...
//				location.href="procesar.asp?codigo_ipr=" + codigo_ipr + "&nivelrestriccion_cop=P&codigorespuesta_cop=" + coment1 + "&estado_cop=A&asunto_cop=" + asunto_cop + "&comentario_cop=" + comentario_cop + "&remLen=" + remLen + "&accion=actualizacomentario&codigo_prp=" + codigo_prp + "&codigo_cop=" + codigo_cop + "&envio_cop=1"	
				location.href="procesar.asp?codigo_ipr=" + codigo_ipr + "&nivelrestriccion_cop=" + estado_prp + "&codigorespuesta_cop=" + coment1 + "&estado_cop=A&asunto_cop=" + asunto_cop + "&comentario_cop=" + comentario_cop + "&remLen=" + remLen + "&accion=actualizacomentario&codigo_prp=" + codigo_prp + "&codigo_cop=" + codigo_cop + "&envio_cop=1&ObsCom=" + ObsCom
				//alert("cerrar ventana")
				}
			}			
			}
        ...
        <td align="center" valign="top">
            <table width="95%" border="0" align="center" cellpadding="2" cellspacing="2">
              ...
              <tr>
                ...
                <td colspan="2" align="right" valign="bottom"><input name="ChkComentario" type="checkbox" id="ChkComentario" value="0" <%if ObsCom<>"O" then %>checked <%end if%> onclick="CambiarCheck()" >
                  <span class="Estilo4">Comentario (S&oacute;lo Consejo Universitario)</span> <span class="Estilo5">-</span> <span class="rojo">Si desmarca el check el comentario ser&aacute; dado a conocer al proponente. </span></td>
                </tr>
