...
<script type="text/javascript" language="JavaScript" src="../../../../../private/sorttable.js"></script>
-->
...
//	alert(menu)
	...
	eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=NO,scrollbars=1,location=0,statusbar=0,status=0,menubar=0,resizable=0,width=1000,height=550,left = "+ izq +",top = "+ arriba +"');");
	}
</script>
</head>
    ...
    <td width="100%" height="4%">
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
					...
					<td width="10%"><input name="cmdmodificar" type="button" class="modificar_1" id="cmdmodificar" value="       Modificar" disabled="disabled" onClick="popUp('frmRegistrarConvenio.aspx?id=<%=codigo_per%>&modifica=1&codigo_cni=' + txtelegido.value.substring(4,txtelegido.value.length) ,'600','600','yes')">
					</td>
					<td width="10%">&nbsp;</td>
					<td width="10%">&nbsp;</td>
					<td width="10%">&nbsp;</td>
...
%>
			<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
              <tr height="25">
                ...
                <td width="50%" bgcolor="#F0F0F0" class="bordeinf">                  
                    <span class="Estilo1"><%Response.Write(Request.QueryString("menu"))%>
                            (<%=convenio.RecordCount%>)                  
                    </span>
                </td>
                <td width="15%" bgcolor="#F0F0F0" class="bordeinf">Nombre/C&oacute;digo:</td>
              ...
              <tr>
				...
				<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" >
                    <tr>
                      <td width="35%"  height="3%" align="center" bgcolor="#F0F0F0" class="bordeinf"><strong>Descripci&oacute;n</strong></td>
