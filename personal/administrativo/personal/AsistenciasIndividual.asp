                ...
                <tr>
                  <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="contornotabla">
                    <tr>
                      ...
                      Entrada </span></td>
                      <td width="9%" align="center" bgcolor="#E1F1FB" class="bordeizqinf"><p class="Estilo12">Marcaci&oacute;n<br>
                        Salida</p>                      </td>
					...
					<%i=i+1%>
                      ...
                      <td align="center" bgcolor="#FFFFFF" class="bordeizqinf Estilo8"><%=asistencia("finmarca")%></td>
