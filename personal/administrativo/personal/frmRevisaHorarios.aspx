<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRevisaHorarios.aspx.vb" Inherits="frmRevisaHorarios" %>
                                            ...
                                            <table style="width:100%;">
                                                ...
                                                <tr>
                                                    <td>
                                                        Escuela</td>
                                                    <td colspan="3">
                                                        <asp:DropDownList ID="ddlEscuela" runat="server">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:GridView ID="gvEditHorario" runat="server" CellPadding="4" 
                                                ...
                                                Caption="Distribución de carga Horaria" CaptionAlign="Top">
                                                <RowStyle BackColor="#EFF3FB" />
                                                <Columns>
