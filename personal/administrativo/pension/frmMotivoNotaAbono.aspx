...
<body>
    ...
    <form id="frmMotivoNotaAbono" runat="server">
        ...
        <div class="container-fluid">
            <div class="card div-title">                        
                <div class="row title">MOTIVOS DE NOTA DE ABONO</div>
            </div>
                ...
                <div class="tab-pane show active" id="listado" role="tabpanel" aria-labelledby="listado-tab">
                        ...
                        <asp:UpdatePanel ID="udpFiltros" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                            <ContentTemplate>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <label for="cmbGrupoFiltro" class="col-sm-2 col-form-label form-control-sm">Clasificación:</label>
                                            <div class="col-sm-3">
                                                <asp:DropDownList ID="cmbGrupoFiltro" runat="server" AutoPostBack="true" CssClass="form-control form-control-sm combo_filtro" data-live-search="true" AutoComplete="off"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <hr/>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <asp:LinkButton ID="btnNuevo" runat="server" CssClass="btn btn-accion btn-azul"                                                    
                                                    OnClientClick="return alertConfirm(this, event, '¿Desea registrar un nuevo motivo de nota de abono?', 'warning');">
                    ...
                    <div class="table-responsive">
                        <asp:UpdatePanel ID="udpLista" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                            <ContentTemplate>
                                <asp:GridView ID="grwLista" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="codigo_mno"
                                    CssClass="display table table-sm" GridLines="None">
                                    <Columns>
                                        <asp:BoundField DataField="descripcion_mno" HeaderText="DESCRIPCIÓN" ItemStyle-Width="30%" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="nombre_gmn" HeaderText="CLASIFICACIÓN" ItemStyle-Width="20%" ItemStyle-Wrap="false" />
                                        <asp:CheckBoxField DataField="conveniobeca" HeaderText="CONV. BECA" ItemStyle-Width="10%" />
                                        <asp:CheckBoxField DataField="solicitudAnulacion" HeaderText="SOL. ANULACIÓN" ItemStyle-Width="10%" />
                                        <asp:TemplateField HeaderText="OPE." ItemStyle-Width="10%" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnEditar" runat="server" 
                                                    ...
                                                    ToolTip="Editar motivo de nota de abono"
                ...
                <div class="tab-pane" id="registro" role="tabpanel" aria-labelledby="registro-tab">
                    <div class="panel-cabecera">
                        <asp:UpdatePanel ID="udpRegistro" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                            <ContentTemplate>
                                <div class="card">
                                    <div class="card-header">Datos del Motivo de Abono</div>
                                    <div class="card-body">
                                        <div class="row">
                                            <label for="txtDescripcion" class="col-sm-2 col-form-label form-control-sm">Nombre:</label>
                                            <div class="col-sm-4">
                                                <asp:TextBox ID="txtDescripcion" runat="server" MaxLength="150" CssClass="form-control form-control-sm uppercase" AutoComplete="off"/>
                                            </div>                                            
                                        </div>
                                        <div class="row">
                                            <label for="cmbGrupo" class="col-sm-2 col-form-label form-control-sm">Clasificación:</label>
                                            <div class="col-sm-3">
                                                <asp:DropDownList ID="cmbGrupo" runat="server" AutoPostBack="true" CssClass="form-control form-control-sm combo_filtro" data-live-search="true" AutoComplete="off"></asp:DropDownList>
                                            </div> 
                                        </div>
                                        <div class="row">
                                            <label for="chkConvenioBeca" class="col-sm-2 col-form-label form-control-sm">Convenio Beca:</label>                                   
                                            <div class="col-sm-1">                                                
                                                <asp:CheckBox ID="chkConvenioBeca" AutoPostBack="True" runat="server"/>
                                            </div>                                              
                                        </div>
                                        <div class="row">
                                            <label for="chkSolicitudAnulacion" class="col-sm-2 col-form-label form-control-sm">Solicitud Anulación:</label>                                   
                                            <div class="col-sm-1">                                                
                                                <asp:CheckBox ID="chkSolicitudAnulacion" AutoPostBack="True" runat="server"/>
                                            </div>                                              
                                        </div>
                                    </div>
                                    <div class="card-footer" style="text-align: center;">
                                        <asp:LinkButton ID="btnGuardar" runat="server" CssClass="btn btn-accion btn-verde"
                                            OnClientClick="return alertConfirm(this, event, '¿Desea registrar el motivo de nota de abono?', 'warning');">
