<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmGrupoAsignacionAlumno.aspx.vb" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <asp:LinkButton ID="btnGenerarDoc" runat="server" Text='<i class="fa fa-file-pdf"></i> Generar Doc'
                                    CssClass="btn btn-info btn-sm" OnClick="btnGenerarDoc_Click"></asp:LinkButton>
                                <asp:LinkButton ID="btnExportar" runat="server" Text='<i class="fa fa-file-excel"></i> Exportar'
                                    CssClass="btn btn-warning btn-sm" OnClick="btnExportar_Click"></asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <asp:TemplateField HeaderText="Acciones" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <%--<asp:LinkButton ID="btnAgregar" runat="server" CommandName="Agregar" 
                                                ...
                                                CssClass="btn btn-success btn-sm" ToolTip = "Agregar"
                                                Enabled='<%# IIF(Eval("codigo_gva")=-1,"True","False") %>'>
