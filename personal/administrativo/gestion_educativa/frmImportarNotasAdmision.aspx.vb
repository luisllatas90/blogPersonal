...
Partial Class administrativo_pec_test_frmImportarNotasAdmision
...
#Region "Eventos"
    ...
    Protected Sub cmbTipoEstudio_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbTipoEstudio.SelectedIndexChanged
        ...
        Dim lo_DtTipoEstudio As New Data.DataTable
        If ls_CodigoTest <> "-1" Then
            lo_DtTipoEstudio = mo_RepoAdmision.ListarCentroCosto(ms_CodigoTfu, ms_CodigoPer, ls_CodigoTest)
        End If
        ClsFunciones.LlenarListas(cmbCentroCosto, lo_DtTipoEstudio, "codigo_Cco", "Nombre", "-- Seleccione --")
    ...
    Private Sub Enviar()
        Try
            ...
            If lo_Validacion.Item("rpta") = 1 Then
                ...
                Dim ln_IdTabla As Integer = mo_RepoAdmision.ObtenerVariableGlobal("codigoTablaArchivo")
