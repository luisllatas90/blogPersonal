...
<table align="center" border="1" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="90%">
  ...
  <tr>
    ...
    <td width="5%"><input type="text" name="txtPrecio" onChange="recalcular()" value="<%=dblPrecioUnit_Art%>" size="5" disabled></td> 
  </tr>
</table>
<br>
            ...
            If x = totalAnos Then
                ...
                For y = mi To mesFin
                    ...
                    %>    
						...
						%> 
							<td align="center"><input type="text" name="txtCantidad" value="<%=cant%>" id="txtCantidad<%=y%>"  onKeyUp="calcularvalores(txtCantidad,txtCantGlobal);calcularsubtotal(txtCantidad<%=y%>,txtSubTotal<%=y%>,txtPrecio);calcularvalores(txtSubTotal,txtSubTotalGlobal)" size="5" disabled></td>
							<%end if %>
							<td align="center"><input type="text" name="txtSubTotal" value="<%=subt%>" size="10" id="txtSubTotal<%=y%>" onChange="calcularvalores(txtSubTotal,txtSubTotalGlobal)" disabled></td>
                ...
                For y = mi To 12 'hasta Diciembre
                    ...
                    %>    
						<tr>	                   
							...
							<td align="center"><%=ano%>&nbsp;</td>
						<%	if cbool(blnFuncion_Art)=true then %>
								<td align="center"><input type="text" name="txtCantidad" value ="<%=cant%>" id="txtCantidad<%=y%>" size="5" onKeyUp="calcularvalores(txtCantidad,txtCantGlobal);calcularsubtotal(txtCantidad<%=y%>,txtSubTotal<%=y%>,txtPrecio);calcularvalores(txtSubTotal,txtSubTotalGlobal)" disabled></td>
							<% end if %>
								<td align="center"><input type="text" name="txtSubTotal" value="<%=subt%>" size="10" id="txtSubTotal<%=y%>" onKeyUp="calcularvalores(txtSubTotal,txtSubTotalGlobal)" disabled></td>
						</tr>	                   
                <%
...
if rsDetalleEjecucion.state<>0 then rsDetalleEjecucion.close
...
<tr>
	  <td align="right">
	    <Input Type="Button" value="Cerrar" class="salir" onClick="window.close()" id=Button1 name=Button1>
      </td>
	
	<td class="etabla">TOTAL</td>
	<%	if cbool(blnFuncion_Art)=true then %>
	<td align="center"><input type="textbox" name="txtCantGlobal" id="txtCantGlobal" value="<%=cant%>" size="5" disabled></td>
	<%end if%>
	<td align="center"><input type="textbox" name="txtSubTotalGlobal" id="txtSubTotalGlobal" value="<%=tot%>"  size="10" disabled></td>
