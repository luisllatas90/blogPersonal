...
<html>
<head>
	<title>Presupuestos Por Area</title>	
	...
	<script language="Javascript">	
		...
		function enviar(){
			...
			if (cboparametro!=undefined){
				...
				document.frmParametro.action = "consultarPresupuestoArea.asp" 
...
<table align="center" width="100%">
  <tr>
      <th align="center" class="table">CONSULTAR PRESUPUESTO POR ÁREA</th>
  </tr>
  <tr>
	<td><hr></td>
  </tr>
...
<form onSubmit="return validaSubmite()" name="frmParametro" method="get" action="ConsultarPresupuestoArea.asp">

<table width="958" height="48">
 <tr>
   <td width="714" height="16"> 
   ...
   <td width="234" height="16"> &nbsp;</td>
   </tr> 
	<tr>
		<td>
        <input type="submit" value="Consultar" name="cmdConsultar" class="boton" style="float: right"></td>
	</tr>
   <tr>
   	<td width="714" height="16">
    <p align="left">Leyenda de Estados: &nbsp;<img border="0" src="../images/R.gif" align="baseline">
   	<b>Desaprobado</b> <img border="0" src="../images/A.gif" align="baseline">
	<b>Aprobado</b> </td>
...
<%IF trim(strAno)<>"" then %>
	...
	<table align="center" border="1" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
		  ...
		  <tr class="etabla"> 
		    ...
		    <td width="10%">Ingresos (<%=strMoneda%>)</td>
		    <td width="15%">Egresos (<%=strMoneda%>)</td>
		    <td width="10%">Diferencia (<%=strMoneda%>)</td>
			<td width="3%">Est</td>
				 ...
				 %>
			 	 ...
			 	 <tr > 
				   <%if cdbl(totalEgreso)=0 and cdbl(totalIngreso)=0 then %>
 			        <td align="center" width="3%" class="Nivel0">&nbsp;</td>
					 <td width="60%" class="Nivel0"><%=strCentro%>&nbsp;</td>
					 <td width="10%" align="right" class="Nivel0"><%=totalIngreso%>&nbsp;</td>
					 <td width="15%" align="right"><%=totalEgreso%>&nbsp;</td>
					 <td width="10%" align="right" class="Nivel0"><%=diferencia%>&nbsp;</td>
					 <%if strEstado_Cco="P" then%>
					 <td align="3%" align="center"  onclick="MostrarTabla(document.all.tblTipo<%=lngCodigo_Cco%>,imgTI<%=lngCodigo_Cco%>)" style="cursor:hand"><img border="0" src="../images/R.gif" align="baseline"></td>
			
					 <%else%>
					 <td align="3%" align="center"  onclick="MostrarTabla(document.all.tblTipo<%=lngCodigo_Cco%>,imgTI<%=lngCodigo_Cco%>)" style="cursor:hand"><img border="0" src="../images/A.gif" align="baseline"> </td>
					 
				     <%end if%>
				   			   
				   <%else%>
				     <td align="center" class="Nivel0"  width="3%" onClick="MostrarTabla(document.all.tblTipo<%=lngCodigo_Cco%>,imgTI<%=lngCodigo_Cco%>)" style="cursor:hand"><img id="imgTI<%=lngCodigo_Cco%>" src="../images/mas.gif" height="9"></td>
					 <td width="60%"  class="Nivel0" onclick="MostrarTabla(document.all.tblTipo<%=lngCodigo_Cco%>,imgTI<%=lngCodigo_Cco%>)" style="cursor:hand"><%=strCentro%>&nbsp;</td>
					 <td width="10%"  class="Nivel0" align="right" onClick="MostrarTabla(document.all.tblTipo<%=lngCodigo_Cco%>,imgTI<%=lngCodigo_Cco%>)" style="cursor:hand"><%=totalIngreso%>&nbsp;</td>
					 <td width="15%"  class="Nivel0" align="right" onClick="MostrarTabla(document.all.tblTipo<%=lngCodigo_Cco%>,imgTI<%=lngCodigo_Cco%>)" style="cursor:hand" ><%=totalEgreso%>&nbsp;</td>
					 <td width="10%"  align="right" class="Nivel0" onClick="MostrarTabla(document.all.tblTipo<%=lngCodigo_Cco%>,imgTI<%=lngCodigo_Cco%>)" style="cursor:hand"><%=diferencia%>&nbsp;</td>
					 <%if strEstado_Cco="P" then%>
					 <td align="center" class="Nivel0" align="3%" onclick="MostrarTabla(document.all.tblTipo<%=lngCodigo_Cco%>,imgTI<%=lngCodigo_Cco%>)" style="cursor:hand"><img border="0" src="../images/R.gif" align="baseline"> </td>
							
					 <%else%>
					 <td align="center" class="Nivel0" align="3%" onclick="MostrarTabla(document.all.tblTipo<%=lngCodigo_Cco%>,imgTI<%=lngCodigo_Cco%>)" style="cursor:hand"><img border="0" src="../images/A.gif" align="baseline"> </td>
																											...
																											<tr class="etabla">
																												...
																												<%do while not rsArticulo.eof
																													...
																													<tr align="center" onMouseOver="Resaltar(1,this)" onMouseOut="Resaltar(0,this)" style="cursor:hand">
																													   ...
																													   <td align="right" onClick="AbrirPopUp('consultardetallepresupuestoArea.asp?tpto=<%=strTipo_Pto%>&Cent=<%=strCentro%>&ca=<%=lngCodigo_Art%>&cp=<%=lngCodigo_Pto%>&da=<%=rsArticulo("descripcion_art")%>&pa=<%=rsArticulo("precioUnitario_Dpr")%>&ua=<%=rsArticulo("descripcion_Uni")%>&ct=<%=strCuenta%>&ta=<%=rsArticulo("funcion_art")%>&tc=<%=strTipoConsulta%>','520','600','no','no','no',100,250)"><%=formatNumber(rsArticulo("total_Dpr"))%></td>
