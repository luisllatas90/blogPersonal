Partial Class rptenotaspec
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            'Almacenar en sesiones para realizar retornos desde otras ASPX

            Dim obj As New ClsConectarDatos
            obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
            obj.AbrirConexion()
            ClsFunciones.LlenarListas(Me.dpPrograma, obj.TraerDataTable("PEC_ConsultarProgramaEC", 8, codigo_usu, 0, 0), "codigo_pec", "descripcion_pes", "--Seleccione--")
            obj.CerrarConexion()
            obj = Nothing
        End If
    End Sub
