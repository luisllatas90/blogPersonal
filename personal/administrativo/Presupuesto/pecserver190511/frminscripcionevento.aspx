...
<body>
	...
	<table cellspacing="0" cellpadding="0" style="border-collapse: collapse;bordercolor: #111111;width:100%">
		<tr>
			<td class="pestanabloqueada" id="tab" align="center" style="height:25px;width:20%" onclick="ResaltarPestana2('0','','');">
			...
			<td class="pestanaresaltada" id="tab" align="center" style="height:25px;width:20%" onclick="ResaltarPestana2('1','','');">
            ...
            <td style="height:25px;width:59%" class="bordeinf">&nbsp;</td>
		</tr>
		<tr>
    	<td style="height:600px;width:100%" valign="top" colspan="7" class="pestanarevez">
