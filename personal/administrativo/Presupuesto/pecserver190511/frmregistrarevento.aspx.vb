Partial Class frmregistrarevento
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            ...
            obj.AbrirConexion()
            objfun.CargarListas(cboCecos, obj.TraerDataTable("PRESU_ConsultarCentroCostosXPermisos", Request.QueryString("ctf"), Request.QueryString("id"), ""), "codigo_Cco", "Nombre", ">> Seleccione<<")
    ...
    Protected Sub cmdGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdGuardar.Click
        ...
        '    Page.RegisterStartupScript("ERROR", "<script>alert('Ocurrió un error. Comunicarse con desarrollosistemas@usat.edu.pe')</script>")
        'End Try
    End Sub
    Public Sub EnviarMensaje(ByVal emailResp As String, ByVal emailApy As String)
        ...
        ConCopiaA = "jdanjanovic@usat.edu.pe"
