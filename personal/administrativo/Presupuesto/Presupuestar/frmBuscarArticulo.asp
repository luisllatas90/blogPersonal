...
<form action="frmbuscararticulo.asp" method="post" name="frmbuscararticulo" id="frmbuscararticulo">
...
<!--<table align="center" border="1" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="90%">-->
	...
	%>
	    		<tr onMouseOver="Resaltar(1,this)" onMouseOut="Resaltar(0,this)" style="cursor:hand" class="table" onclick="location.href='frmregistrardetallepresupuesto.asp?ca=<%=lngCodigo_Art%>&cp=<%=lngCodigo_Pto%>&pa=<%=dblPrecioUnit_Art%>&ua=<%=strUnidad_Art%>&ct=<%=strCuenta_Art%>&ta=<%=blnTipo_Art%>&tpto=<%=strTipo_Pto%>'">
