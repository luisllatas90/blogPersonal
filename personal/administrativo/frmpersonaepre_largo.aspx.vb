Partial Class administrativo_frmpersonaepre_largo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            If tbl.Rows.Count > 0 Then
                ...
                ClsFunciones.LlenarListas(Me.dpCicloIng_alu, obj.TraerDataTable("ADM_ConsultarPreSemetreInscripcion_v3"), "codigo_cac", "descripcion_cac")
                ...
                'Cargar Modalidad de ingreso - Hcano
                ...
                'Cargar Estado civil padre
                '' ClsFunciones.LlenarListas(Me.dpOperadorPadre, obj.TraerDataTable("EstadoCivilConsultar", 0), "codigo_eciv", "nombre_eciv", "--Seleccione--")
                ...
                Next
                Me.dpPromocion.SelectedIndex = -1
            ...
            If Request.QueryString("accion") = "M" Then
                ...
                'mostrarCategorias()
                dpCodigo_col_SelectedIndexChanged(dpCodigo_col, New EventArgs())
    ...
    Private Sub BuscarPersona(ByVal tipo As String, ByVal valor As String, Optional ByVal mostrardni As Boolean = False)
        ...
        Try
                ...
                If tblalumno.Rows.Count > 0 Then
                    ...
                    If TipoConsultaAlumno = 1 Then
                        If (tblalumno.Rows(0).Item("codigo_test") = 1 Or tblalumno.Rows(0).Item("codigo_test") = 2) Then
                            ...
                            Me.dpCodigo_cpf.SelectedIndex = -1
                        End If
                    End If
                    ...
                    If hdurlaccion.Value = "M" Then                        
                        ...
                        ClsFunciones.LlenarListas(Me.dpModalidad, obj.TraerDataTable("EVE_ConsultarInformacionParaEvento", 77, 1, tblalumno.Rows(0).Item("codigo_cac").ToString, Me.dpCodigo_cpf.SelectedValue), "codigo_min", "nombre_min", "--Seleccione--")
                        cont_mod = Me.dpModalidad.Items.Count
                    End If
                    ...
                    If (hdurlaccion.Value = "M") Then
                        'YPEREZ: EL FRM ESTA EN MUERE Y PARA SALVAR EL REQUERIMIENTO "URGENTE"...
                        If (tblalumno.Rows(0).Item("codigo_test") = 1 Or tblalumno.Rows(0).Item("codigo_test") = 2) Then
                            If tblalumno.Rows(0).Item("tempcodigo_cpf").ToString > 0 Then
                                Me.dpCodigo_cpf.SelectedValue = tblalumno.Rows(0).Item("tempcodigo_cpf").ToString
                                ClsFunciones.LlenarListas(Me.dpModalidad, obj.TraerDataTable("EVE_ConsultarInformacionParaEvento", 77, 1, Me.dpCicloIng_alu.SelectedValue, Me.dpCodigo_cpf.SelectedValue), "codigo_min", "nombre_min", "--Seleccione--")
                                Me.dpModalidad.SelectedValue = tblalumno.Rows(0).Item("codigo_min").ToString
                            End If
                    ...
                    If tblalumno.Rows(0).Item("DepartamentoNac").ToString <> "" Then
                        If tblalumno.Rows(0).Item("DepartamentoNac").ToString = "" Then
                            Me.dpdepartamentonac.SelectedIndex = -1
                        ...
                        If tblalumno.Rows(0).Item("ProvinciaNac").ToString = "" Then
                            Me.dpprovincianac.SelectedIndex = -1
                        ...
                        If tblalumno.Rows(0).Item("codigoDisNacimiento_Dal").ToString = "" Then
                            Me.dpdistritonac.SelectedIndex = -1
                    ...
                    'Datos del apoderado
                    txtNombresApoderado.Text = iif(tblalumno.Rows(0).Item("PersonaApod_Dal").ToString = "", tblalumno.Rows(0).Item("PersonaFam_Dal").ToString, tblalumno.Rows(0).Item("PersonaApod_Dal").ToString)
                    txtdireccionApoderado.Text = iif(tblalumno.Rows(0).Item("direccionApod_Dal").ToString = "", tblalumno.Rows(0).Item("direccionFam_Dal").ToString, tblalumno.Rows(0).Item("direccionApod_Dal").ToString)
                    txturbanizacionApoderado.Text = iif(tblalumno.Rows(0).Item("urbanizacionApod_Dal").ToString = "", tblalumno.Rows(0).Item("urbanizacionFam_Dal").ToString, tblalumno.Rows(0).Item("urbanizacionApod_Dal").ToString)


                    'ClsFunciones.LlenarListas(Me.dpprovinciaApoderado, obj.TraerDataTable("ConsultarLugares", 3, tbl.Rows(0).Item("codigo_dep"), 0), "codigo_pro", "nombre_pro", "--Seleccione--")
                    'ClsFunciones.LlenarListas(Me.dpdistritoApoderado, obj.TraerDataTable("ConsultarLugares", 4, tbl.Rows(0).Item("codigo_pro"), 0), "codigo_dis", "nombre_dis", "--Seleccione--")

                    ''Si hay distrito del apoderado
                    If tblalumno.Rows(0).Item("DepartamentoApod").ToString <> "" Then

                        If tblalumno.Rows(0).Item("DepartamentoApod").ToString = "" Then
                            Me.dpdepartamentoApoderado.SelectedIndex = -1
                        ...
                        If tblalumno.Rows(0).Item("ProvinciaApod").ToString = "" Then
                            Me.dpprovinciaApoderado.SelectedIndex = -1
                        ...
                        If tblalumno.Rows(0).Item("distritoApod_Dal").ToString = "" Then
                            Me.dpdistritoApoderado.SelectedIndex = -1
                    ...
                    Else
                        ...
                        Me.dpdepartamentoApoderado.SelectedValue = Me.dpdepartamentoPadre.SelectedValue                      
                    End If

                    ''YPEREZ                    
                    'If tblalumno.Rows(0).Item("DepartamentoApod").ToString = "" Then
                    '    Me.dpdepartamentoApoderado.SelectedValue = dpdepartamentoPadre.SelectedValue
                    'ElseIf tblalumno.Rows(0).Item("ProvinciaApod").ToString = "" Then
                    ...
                    '    Me.dpdistritoApoderado.SelectedValue = dpprovinciaPadre.SelectedValue
                    'End If


                'Me.dpdistritoApoderado.SelectedValue = tblalumno.Rows(0).Item("ProvinciaFam").ToString
            ...
            If ExistePersona = True Then
                ...
                Me.dpEstadoCivil.SelectedIndex = -1
                ...
                If tbl.Rows(0).Item("codigo_dep").ToString <> "" Then
                    If tbl.Rows(0).Item("codigo_dep") = 26 Or tbl.Rows(0).Item("codigo_dep").ToString = "" Then
                        Me.dpdepartamento.SelectedIndex = -1
                    Else
                    ...
                    If tbl.Rows(0).Item("codigo_pro") = 1 Or tbl.Rows(0).Item("codigo_pro").ToString = "" Then
                        Me.dpprovincia.SelectedIndex = -1
                ...
                Else
                    dpPaisNacimiento.SelectedIndex = -1
                End If
                '==================================================================================
    ...
    Private Sub LimpiarCajas()
        ...
        Me.dpprovinciacolegio.SelectedIndex = -1
        Me.dpdistritocolegio.SelectedIndex = -1
        Me.dpCodigo_col.SelectedIndex = -1
        Me.dpPromocion.SelectedIndex = -1
        ...
        chkDisVisual.Checked = False
        dpPaisNacimiento.SelectedIndex = -1
        dpdepartamentonac.SelectedIndex = -1
        dpprovincianac.SelectedIndex = -1
        dpdistritonac.SelectedIndex = -1
        ...
        dpdepartamentoPadre.SelectedIndex = -1
        dpprovinciaPadre.SelectedIndex = -1
        dpdistritoPadre.SelectedIndex = -1
        ...
        dpdepartamentoApoderado.SelectedIndex = -1
        dpprovinciaApoderado.SelectedIndex = -1
        dpdistritoApoderado.SelectedIndex = -1
        ...
        If hdcodigo_cpf.Value <> 9 Then
            Me.dpModalidad.SelectedIndex = -1
        End If
    End Sub
  ...
  Protected Sub imgActualizarColegioCategoria_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgActualizarColegioCategoria.Click
        mostrarCategorias()
    End Sub
    ...
    Protected Sub dpPaisNacimiento_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dpPaisNacimiento.SelectedIndexChanged
        ...
        If dpPaisNacimiento.SelectedValue = 156 Then
            ...
            Me.dpdepartamento.Enabled = True
            If hdcodigo_pso.Value = 0 Then
                ClsFunciones.LlenarListas(Me.dpdepartamento, obj.TraerDataTable("ConsultarLugares", 2, 156, 0), "codigo_dep", "nombre_dep", "--Seleccione--")
                Me.dpprovincia.SelectedIndex = -1
                Me.dpdistrito.SelectedIndex = -1
            End If
    ...
    private Sub mostrarCategorias()
        ...
        If Me.dpCodigo_col.SelectedValue > 0 And Me.dpCodigo_cpf.SelectedValue > 0 Then
            ...
            If tb.Rows.Count > 0 Then
                ...
                me.txtcc.value=Cdec(tb.Rows(0).Item("preciocredito"))/5
            Else
