<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmdetallerendicion.aspx.vb"
    Inherits="frmdetallerendicion" %>
...
<head runat="server">
    ...
    <script language="javascript">
        ...
        function OcultarBotones() {
            document.getElementById("cmdagregar").style.display = "none";
...
<body bgcolor="white" style="background-color: whitesmoke" scroll="auto">
    ...
    %>
    <table cellpadding="3" cellspacing="0" bordercolor="gray" bgcolor="white" style="width: 98%;
        border-collapse: collapse">
        <tr>
            <td style="font-size: 12px; color: #ffffff; font-family: 'Courier New'; height: 3px;
                background-color: darkolivegreen; font-variant: normal; border-right: darkolivegreen 1px solid;
                border-top: darkolivegreen 1px solid; border-left: darkolivegreen 1px solid;
                width: 73px; border-bottom: darkolivegreen 1px solid; text-align: center;">
                Detalle
            </td>
        </tr>
    </table>
    <table cellpadding="3" cellspacing="0" bordercolor="gray" bgcolor="white" style="width: 98%;
        border-collapse: collapse">
        <tr>
            <td colspan="5" style="font-size: 12px; color: #ffffff; font-family: 'Courier New';
                height: 3px; background-color: darkolivegreen; font-variant: normal; border-right: darkolivegreen 1px solid;
                border-top: darkolivegreen 1px solid; border-left: darkolivegreen 1px solid;
                width: 183px; border-bottom: darkolivegreen 1px solid; text-align: center;">
                Número de Rendición:
                <%=dtsdetalleegreso.Tables("consulta").Rows(0).Item("numeracionanual_rend").ToString%>
            </td>
        </tr>
        <tr>
            <td style="font-size: 12px; width: 73px; font-family: 'Courier New'; height: 3px;
                background-color: darkolivegreen; font-variant: normal; color: #ffffff; border-right: darkolivegreen 1px solid;
                border-top: darkolivegreen 1px solid; border-left: darkolivegreen 1px solid;
                border-bottom: darkolivegreen 1px solid;">
                <span style="font-size: 9pt; font-family: Courier New">Documento:</span>
            </td>
            <td style="font-size: 12px; font-family: 'Courier New'; height: 3px; background-color: darkolivegreen;
                font-variant: normal; border-right: darkolivegreen 1px solid; border-top: darkolivegreen 1px solid;
                border-left: darkolivegreen 1px solid; width: 73px; color: #ffffff; border-bottom: darkolivegreen 1px solid;"
                colspan="3">
                <%=dtsdetalleegreso.Tables("consulta").Rows(0).Item("descripcion_tdo")%>
            </td>
            <td style="font-size: 12px; width: 73px; font-family: 'Courier New'; height: 3px;
                background-color: darkolivegreen; font-variant: normal; color: #ffffff; border-left: darkolivegreen 1px solid;
                border-right: darkolivegreen 1px solid; border-top: darkolivegreen 1px solid;
                border-bottom: darkolivegreen 1px solid;">
                Nº:
            </td>
            <td style="font-size: 12px; width: 73px; font-family: 'Courier New'; height: 3px;
                background-color: darkolivegreen; font-variant: normal; border-left: darkolivegreen 1px solid;
                color: #ffffff; border-right: darkolivegreen 1px solid; border-top: darkolivegreen 1px solid;
                border-bottom: darkolivegreen 1px solid;">
                <%=dtsdetalleegreso.Tables("consulta").Rows(0).Item("seriedoc_egr") & "-" & dtsdetalleegreso.Tables("consulta").Rows(0).Item("numerodoc_egr")%>
            </td>
            <td style="font-size: 12px; width: 73px; font-family: 'Courier New'; height: 3px;
                background-color: darkolivegreen; font-variant: normal; color: #ffffff; border-left: darkolivegreen 1px solid;
                border-right: darkolivegreen 1px solid; border-top: darkolivegreen 1px solid;
        ...
        <tr>
            ...
            <td style="font-size: 12px; width: 73px; font-family: 'Courier New'; height: 3px;
                ...
                color: #ffffff; border-right: darkolivegreen 1px solid; border-top: darkolivegreen 1px solid;
                border-bottom: darkolivegreen 1px solid;">
                <%=dtsdetalleegreso.Tables("consulta").Rows(0).Item("Descripcion_tip")%>
            </td>
            <td style="font-size: 12px; width: 73px; font-family: 'Courier New'; height: 3px;
                background-color: darkolivegreen; font-variant: normal; color: #ffffff; border-left: darkolivegreen 1px solid;
                border-right: darkolivegreen 1px solid; border-top: darkolivegreen 1px solid;
        ...
        <tr>
            ...
            <td colspan="7" style="border-right: darkolivegreen 1px solid; border-top: darkolivegreen 1px solid;
        ...
        <tr>
            <td colspan="10" style="font-size: 12px; font-family: 'Courier New'; background-color: white;
                font-variant: normal; height: 30px;" valign="middle">
                <asp:Button ID="cmdcancelar" runat="server" BackColor="LemonChiffon" Font-Bold="False"
                    ...
                    background-repeat: no-repeat; background-position: left center;" Text=" Cerrar"
                    Width="96px" BorderStyle="Groove" />
                ...
                <input id="cmdReactivar" style="width: 112px; background-repeat: no-repeat; background-color: lemonchiffon;"
                    type="button" value="Reactivar" language="javascript" onclick="ReactivarRendicion()"
                    onclick="return cmdReactivar_onclick()" onclick="return cmdReactivar_onclick()"
    ...
    <br />
    <table border="1" cellpadding="3" cellspacing="0" style="width: 98%; border-collapse: collapse"
        bordercolor="gray" bgcolor="white">
        <tr>
        ...
        <tr onmouseenter="resaltar(this,1)" onmouseleave="resaltar(this,0)" style="font-size: 8pt">
            <td style="height: 10px">
                <img src="iconos/mas.gif" onclick="Mostrar(this,'S<%=dtsdetallerendicion.tables("consulta").rows(i-1).item("codigo_dren")%>')" />
            </td>
            <td style="height: 10px">
                <%=dtsdetallerendicion.Tables("consulta").Rows(i - 1).Item("descripcion_tdo")%>
            </td>
            <td style="height: 10px">
                <%=dtsdetallerendicion.Tables("consulta").Rows(i - 1).Item("serienumero_dren")%>
            </td>
            <td style="height: 10px">
                <%=Format(dtsdetallerendicion.Tables("consulta").Rows(i - 1).Item("fecha_dren"), "dd/MM/yyyy")%>
            </td>
            <td style="height: 10px; width: 471px;">
                <%=dtsdetallerendicion.Tables("consulta").Rows(i - 1).Item("institucion_dren")%>
            </td>
            <td style="height: 10px">
                <%=Format(dtsdetallerendicion.Tables("consulta").Rows(i - 1).Item("importe_dren"), "###,##0.00")%>
            </td>
            <td style="height: 10px">
            </td>
            <%--<td>
                <a href="frmprocesar.aspx?operacion=quitardetallerendicion&codigo_dren=<%=dtsdetallerendicion.Tables("consulta").Rows(i - 1).Item("codigo_dren")%>">
                    Eliminar</a> &nbsp;
            </td>--%>
            <td>
                <%
        ...
        <tr onmouseenter="resaltar(this,1)" onmouseleave="resaltar(this,0)" style="font-size: 8pt">
            ...
            <td colspan="4" style="height: 9px; font-size: 8pt; color: blue; font-style: italic;">
                <span>Obs :<%=dtsdetallerendicion.Tables("consulta").Rows(i - 1).Item("descripcion_dren")%></span>
            </td>
        </tr>
        <tr style="display: none; font-size: 8pt;" id="S<%=dtsdetallerendicion.tables("consulta").rows(i-1).item("codigo_dren")%>">
            ...
            <td colspan="6" style="height: 1px; background-color: whitesmoke;">
                <table height="100%" cellspacing="0" style="width: 30%; border-collapse: collapse"
                    bordercolor="gray" bgcolor="white">
                    <tr>
                        ...
                        <td bgcolor="darkolivegreen" style="width: 363px; color: #ffffff; height: 15px">
                            Descripción
                            <img src="iconos/anadir.gif" alt="Añadir Archivo" id="IMG1" language="javascript"
                                onclick="window.open('frmsubirarchivo.aspx?codigo_dren=<%=dtsdetallerendicion.Tables("consulta").Rows(i - 1).Item("codigo_dren")%>','frmsubirarchivo','toolbar=no, width=600, height=200');" />
                        </td>
                    </tr>
                    <%
                        ' Mostrar la información de los archivos adjuntos
                    ...
                    <tr height="8px">
                        <td style="width: 8px; height: 1px;">
                            <a target='_blank' href='frmdescargar.aspx?ruta=A<%=dtsdocumentosadjuntos.Tables("consulta").Rows(j - 1).Item("codigo_ddr") & dtsdocumentosadjuntos.Tables("consulta").Rows(j - 1).Item("tipo_ddr")%>'>
                                <img border="0" src="iconos/<%=dtsdocumentosadjuntos.Tables("consulta").Rows(j - 1).item("icono_ddr")%>" /></a>
                        </td>
                        <%
                            If dtsdocumentosadjuntos.Tables("consulta").Rows(j - 1).Item("descripcion_ddr") = "" Then
                        %>
                        <td style="width: 363px; height: 1px; background-color: #ffffff;">
                            Ninguno
                        </td>
                        <%
                        Else
                        %>
                        <td style="width: 363px; height: 1px; background-color: #ffffff;">
                            <%=dtsdocumentosadjuntos.Tables("consulta").Rows(j - 1).Item("descripcion_ddr")%>
                        </td>
                        <%
                        End If
                        %>
    ...
    <table>
        ...
        <tr>
            <td style="font-family: 'Courier New'; text-align: center">
                <% =dtsdetalleegreso.Tables("consulta").Rows(0).Item("nombres")%>
            </td>
        </tr>
    </table>
