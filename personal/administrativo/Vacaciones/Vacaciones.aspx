<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Vacaciones.aspx.vb" Inherits="administrativo_Vacaciones_Vacaciones" %>
...
//              }
              function Persona() {
                  $.ajax({
                      type: "POST",
                      // contentType: "application/json; charset=utf-8",
                      url: "../../DataJson/Vacaciones/Vacaciones_ajax.aspx",
              ...
              function ListarVacaciones() {
                ...
                $.ajax({
                    ...
                    data: { "Funcion": "ListarVacaciones", "PersonaId": $("#Persona").val() },
                    dataType: "json",
                    cache: false,
                    success: function(data) {
                        var row = 1;                        
