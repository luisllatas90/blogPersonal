    ...
    Protected Sub CmdGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmdGuardar.Click
        ...
        If Request.QueryString("accion") = "A" Then
            Try
                ...
                ObjGuarda.Ejecutar("CAJ_AgregarColegio", txtNombre.Text.ToUpper, cboDist.SelectedValue, cboTipo.SelectedValue)
        ...
        Else
            Try
                ObjGuarda.AbrirConexion()
                ObjGuarda.Ejecutar("CAJ_ModificarColegio", Request.QueryString("pk"), txtNombre.Text, cboDist.SelectedValue, cboTipo.SelectedValue)
                ObjGuarda.CerrarConexion()
