<%@ Page Language="VB" AutoEventWireup="false" CodeFile="contenido_POA_v1.aspx.vb"
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function HabilitarBoton(tipo, fila, rpta) {
                                ...
                                <tr>
                                    <td class="style7">
                                        ...
                                        <asp:Button ID="cmdModificar1" runat="server" CssClass="ayuda_prp" Height="47px"
                                            Text="          Boton" Width="79px" Visible="False" />
                    ...
                    <tr>
                        <td>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CNXBDUSAT %>"
                                SelectCommand="PRP_ConsultarPropuesta_v1" SelectCommandType="StoredProcedure">
                                <SelectParameters>
