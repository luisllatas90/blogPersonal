...
Partial Class nuevapropuesta
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim rsAreas As New Data.DataTable
            rsAreas = ObjCnx.TraerDataTable("PRP_ConsultarCentroCostosPersonal", idUsu)

            ClsFunciones.LlenarListas(ddlCentroCosto, rsAreas, "codigo_cco", "descripcion_cco")


            'consultar facultad
            rsFacultad = ObjCnx.TraerDataTable("ConsultarFacultad", "AR", Me.ddlCentroCosto.SelectedValue)
            'Response.Write("cod: " & Me.ddlCentroCosto.SelectedValue)
            'rsFacultad = ObjCnx.TraerDataTable("ConsultarFacultad", "AR", idUsu)
    ...
    Private Sub RegistrarPropuesta()
        ...
        If Me.lblIdPropuesta.Text.Trim = "" Then
            codigo_prp = ObjCnx.TraerValor("PRP_RegistraPropuesta", "PR", Me.txtPropuesta.Text, "P", "P", VarPrioridad, Me.ddlTipoPropuesta.SelectedValue, Me.lblFacultadID.Text, System.DBNull.Value, "SI", ddlCentroCosto.SelectedValue, Me.txtIngreso.Text, Me.txtEgreso.Text, Me.lblUtilidad.Text, Me.txtResumen.Text, Me.txtImportancia.Text, 1, Me.ddlMoneda.SelectedValue, lblTipoCambio.Text, Me.lblIngresoMN.Text, Me.lblEgresoMN.Text, Me.lblUtilidadMN.Text, Me.lblIdUsuario.Text, Me.ddlCentroCosto.SelectedValue)
