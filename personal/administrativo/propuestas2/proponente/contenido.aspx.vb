...
Partial Class proponente_contenido
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Pruebas de para verificar el codigo_per
        'Response.Write(Me.lblUsuario.Text)

        MostrarInstancias()
        Dim ObjCnx As New ClsSqlServer(ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString)
        Dim x As Boolean

        'Response.Write(ObjCnx.TraerValor("PRP_VerificarSecretariasConsejos", Request.QueryString("id"), 0))
    ...
    Protected Sub cmdConforme_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdConforme.Click
        Dim ObjCnx As New ClsSqlServer(ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString)
        'Response.Write(Request.QueryString("id") & "--" & Me.txtelegido.Value & "--" & Me.ddlInstanciaRevision.SelectedValue & "--" & Me.ddlInstanciaRevision.SelectedValue & "--" & "C")
