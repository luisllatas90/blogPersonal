<%@ Page Language="VB" AutoEventWireup="false" CodeFile="seguimiento_POA.aspx.vb" Inherits="proponente_contenido" %>
            ...
            <tr>
                <td class="contornotabla" valign="top" width="100%" colspan="6">
                    <table  width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CNXBDUSAT %>" SelectCommand="PRP_ConsultarPropuesta_ant" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
