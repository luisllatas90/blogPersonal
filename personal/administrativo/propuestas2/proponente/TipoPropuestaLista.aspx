<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TipoPropuestaLista.aspx.vb"
                        ...
                        <td bgcolor="#F0F0F0" class="bordeinf" width="20%">
                            <table style="width: 100%;">
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlTipoPropuesta" runat="server" Height="20px" Width="400px">
                                        </asp:DropDownList>
                                    </td>
                                    <td class="style1">
                                        Estado
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlCentroCostos" runat="server" Height="20px" Width="400px">
                                        </asp:DropDownList>
                                    </td>
                                    <td class="style1">
                                    </td>
                                ...
                                <tr>
                                    <td colspan="6">
                                        ...
                                        <asp:Button ID="cmdGuardar" runat="server" Text="        Guardar" CssClass="guardar_prp"
                                            Height="35px" Width="120px" ValidationGroup="Guardar" />
                                    </td>
                                </tr>
                            </table>
                        </td>
