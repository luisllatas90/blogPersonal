<%@ Page Language="VB" AutoEventWireup="false" CodeFile="nuevapropuesta_POA_v2.aspx.vb"
    Inherits="nuevapropuesta_POA_v2" Debug="true" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    
    <script src="../../../scripts/js/jquery-1.12.3.min.js" type="text/javascript"></script>    
    <script src="../../tramite/private/jquery.loadmask.js" type="text/javascript"></script>
                        ...
                        <tr>
                            <td class="bordeinf" valign="top">
                                <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:Button ID="cmdEnviar_" runat="server" Text="Enviar" CssClass="enviarpropuesta"
                        ...
                        <tr>
                            <td>
                                <table style="color: #0000FF;" class="style12">
                                    <tr>
                                        <td colspan="7" style="font-weight: bold" class="style13">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" width="10%">
                                            ...
                                            <asp:Label ID="lbl_Propuesta" runat="server" Font-Bold="True" Text="[                                ]"
                                    ...
                                    <tr id="TDFacultadDerivar" runat="server">
                                        <td style="font-weight: bold">
                                            Facultad que Organiza la Actividad:
                                        </td>
                                        <td colspan="5">
                                            <span lang="es-pe">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="6">
                                            <asp:TextBox ID="txtResumen" runat="server" Height="60px" MaxLength="2000" Rows="4"
                                                Width="450px" TextMode="MultiLine" Enabled="False"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="6">
                                            <asp:TextBox ID="txtImportancia" runat="server" Height="60px" MaxLength="2000" Rows="4"
                                                Width="450px" TextMode="MultiLine" Enabled="False"></asp:TextBox>
                        ...
                        <tr>
                            <td colspan="3" style="font-weight: bold; font-size: 8pt; color: black; font-family: verdana">
                                ...
                                <asp:TextBox ID="TxtNombre" runat="server" Width="200px"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator
                                    ...
                                    SetFocusOnError="True" ValidationGroup="agregar">*</asp:RequiredFieldValidator><asp:Button ID="CmdAgregar" OnClientClick="OcultarTabla()" runat="server" Text="Agregar"
