<%@ Page Language="VB" AutoEventWireup="false" CodeFile="seguimiento.aspx.vb" Inherits="proponente_contenido" %>
   ...
   <table style="width: 100%; height: 100%" align="left">
                            ...
                            <td>
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                    ...
                                    <SelectParameters>
                                        ...
                                        <asp:ControlParameter ControlID="txtfacultad" DefaultValue="" Name="codigo_per" 
    ...
    GridLines="Horizontal" PageSize="7" 
            ...
            <tr>
                ...
                <td width="1%"  class="style5"></td>
		        <td width="20%" class="style5">&nbsp;</td>
                <td width="38%"  class="style5" style="color: #FF0000">Atención: La opción DERIVAR 
                    enviará la propuesta a Rectorado</td>
            </tr>
            <tr>
                        ...
                        <tr>
                            ...
                            <td align="center" width="25%" style="width: 17%">
                                <asp:Button ID="cmdDerivar" runat="server" CssClass="enviarpropuesta" Height="47px" 
                                    Text="          Derivar" Width="90px" Enabled="False" Visible="False" />
                                </td>
                        </tr>
                    </table>
                </td>
