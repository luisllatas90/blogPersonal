<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EliminarPropuestaPOA.aspx.vb"
    Inherits="administrativo_propuestas2_proponente_EliminarPropuestaPOA" %>
        ...
        <tr>
            <td class="contornotabla" valign="top" width="100%" colspan="6">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <asp:Button ID="btnConsultar" runat="server" Text="            Consultar" CssClass="enviarpropuesta"
