...
Partial Class secretarias_reuniones
    ...
    Protected Sub cmdPresentacion_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdPresentacion.Click
        Response.Redirect("presentacion_intro.aspx?id_rec=" & Me.txtelegido.Value)
    End Sub

    Protected Sub cmdNuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdNuevo.Click
        Response.Redirect("registrarreunion.aspx?instancia_rec=" & Me.ddlInstanciaRevision.SelectedValue & "&codigo_per=" & Request.QueryString("id"))
    End Sub
    ...
    Protected Sub cmdModificar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdModificar.Click
        Response.Redirect("registrarreunion.aspx?instancia_rec=" & Me.ddlInstanciaRevision.SelectedValue & "&id_rec=" & Me.txtelegido.Value & "&codigo_per=" & Request.QueryString("id"))
    End Sub
End Class
