...
Partial Class nuevapropuesta
    ...
    Private Sub RegistrarPropuesta()
        ...
        If Me.lblIdPropuesta.Text.Trim = "" Then
            codigo_prp = ObjCnx.TraerValor("PRP_RegistraPropuesta", "PR", Me.txtPropuesta.Text, "P", "P", VarPrioridad, Me.ddlTipoPropuesta.SelectedValue, Me.lblFacultadID.Text, System.DBNull.Value, "SI", ddlArea.SelectedValue, Me.txtIngreso.Text, Me.txtEgreso.Text, Me.lblUtilidad.Text, Me.txtResumen.Text, Me.txtImportancia.Text, 1, Me.ddlMoneda.SelectedValue, lblTipoCambio.Text, Me.lblIngresoMN.Text, Me.lblEgresoMN.Text, Me.lblUtilidadMN.Text, Me.lblIdUsuario.Text, Me.ddlCentroCosto.SelectedValue)
