<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptMarcacionBecaDocente.aspx.vb" Inherits="aulavirtual_adminaula_rptEstadisticaUso" %>
...
<body>
    ...
    <h3>Beca Docente - Consulta de Marcaciones</h3>
     <table runat="server" cellpadding="0" cellspacing="0" id="tabla">    
    <tr>       
        <td class="celda1 sinborderBottom">Selecionar Fecha</td>
