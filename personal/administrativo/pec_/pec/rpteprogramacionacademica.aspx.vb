...
Partial Class rpteprogramacionacademica
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            Try
                ...
                If (Request.QueryString("id") = 5315) Then  'ID Sunedu
                    cls.CargarListas(Me.dpCiclo, obj.TraerDataTable("ConsultarCicloAcademico_SUNE", "TO", "0"), "codigo_cac", "descripcion_cac", "--Seleccione--")
                Else
    ...
    Protected Sub cmdBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdBuscar.Click
        Try
            ...
            obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
            obj.AbrirConexion()
            dt = obj.TraerDataTable("ACAD_ConsultarDatosProgramaEspecial", Me.dpEscuela.SelectedValue, Me.dpCiclo.SelectedValue)
            'Response.Write(dt.Rows.Count)
            Me.grwCursosProgramados.DataSource = dt
