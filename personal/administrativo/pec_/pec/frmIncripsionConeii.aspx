            ...
            return results[1];
              ...
              function LoadCecos() {
                  ...
                  $.ajax({
                      ...
                      data: { "Funcion": "cecos", id: $.get("id"), mod: $.get("mod"), ctf: $.get("ctf") },
                      dataType: "json",
                      cache: false,
              ...
              function LoadRubro(Codigo) {
                  /// alert($("#NroRendicion").val());
                  $.ajax({
                      type: "POST",
                      //contentType: "application/json; charset=utf-8",
                      url: "../../DataJson/EventosAcademicos/EventosAcademicos.aspx",
                      data: { "Funcion": "rubro", id: Codigo },
                      dataType: "json",
                      cache: false,
                      success: function(data) {
                  ...
                  if (validar() == true) {
                      ...
                      jQuery.each(data.Alumnos, function(i, val) {
                          ...
                          $.ajax({
                              ...
                              data: { "Funcion": "Post",
                                  TipoDoc: val.TipoDoc,
                                  NumDoc: val.NumDoc.trim(),
                                  ApellPaterno: val.ApellPaterno,
                                  ApellMaterno: val.ApellMaterno,
                                  Nombres: val.Nombres,
                                  FecNac: val.FecNac,
                                  Importe: val.Importe,
                                  FecVence: val.fecVence,
                                  Email: val.Email,
                                  Codigo_Ceco: $("#cboCecos").val(),
                                  Codigo_Sco: $("#cboRubro").val()
              ...
              function validar() 
              {
                  ...
                  else  
                  {
                      if ($("#cboCecos").val() == String.empty) 
                      {
                          fnMensaje('warning', "Seleccione el Rubro");
                          res = false;
                      }
                    }
              return res;
                            ...
                            <div id="PanelBusqueda">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="page_header">
                                        <div class="pull-left">
                                            <i class="icon ti-volume page_header_icon"></i><span class="main-text">Cargar Inscritos CONEII </span>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12 col-md-8">
                                                        <select name="cboCecos" class="form-control" id="cboCecos">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-12 col-md-4 control-label">
                                                        Rubro </label>
                                                    <div class="col-sm-12 col-md-8">
                                                        <select name="cboRubro" class="form-control" id="cboRubro">
                                                            <option value="" selected="">-- Seleccione -- </option>
                                                        </select>
                                                    </div>
                                                </div>
           ...
           <div class="panel panel-piluku" id="PanelLista">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                Listado de Almunos Inscritos <span class="panel-options"><a class="panel-refresh" href="#">
