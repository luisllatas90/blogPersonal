        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                If Request.QueryString("ctf") = 1 Or Request.QueryString("ctf") = 19 Or _
                    ...
                    Request.QueryString("ctf") = 47 Or Request.QueryString("ctf") = 169 Then
                ...
                If (tblActivo.Rows.Count > 0) Then
                    ...
                    For i As Integer = 0 To Me.DDLPersona.Items.Count - 1
                        'HCano 25-05-18 Inicio
                        'If (Me.DDLPersona.Items(i).Value = "E-" & tblActivo.Rows(0).Item("codigo_alu").ToString) Then
                        If (Me.DDLPersona.Items(i).Value = "E-" & ultimo_codigo.ToString) Then
                            'HCano 25-05-18 Fin
                            Me.DDLPersona.SelectedIndex = i
                        End If
                    Next
                Else
