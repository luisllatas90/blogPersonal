Partial Class frminscripcionevento
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'Se  había ocultado en todos los tipos de estudio        
        ...
        If IsPostBack = False Then
            ...
            objfun.CargarListas(cboCecos, obj.TraerDataTable("EVE_ConsultarCentroCostosXPermisosXVisibilidad", Request.QueryString("ctf"), Request.QueryString("id"), "", Request.QueryString("mod"), 1), "codigo_Cco", "Nombre", ">> Seleccione<<")
            obj.CerrarConexion()
            obj = Nothing
            objfun = Nothing
            ...
            Select Case Request.QueryString("mod")
                ...
                Case 5 'PostGrado
                    Me.lblTitulo.Text = "Inscripción a Escuela de Posgrado" '<< Modificado por fatima.vasquez 
    ...
    Protected Sub cmdBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdBuscar.Click
        ...
        obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
        obj.AbrirConexion()
        gvCecos.DataSource = obj.TraerDataTable("EVE_ConsultarCentroCostosXPermisosXVisibilidad", Request.QueryString("ctf"), Request.QueryString("id"), txtBuscaCecos.Text.Trim, Request.QueryString("mod"), 1)
        gvCecos.DataBind()
        obj = Nothing
    ...
    Protected Sub txtBuscaCecos_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtBuscaCecos.TextChanged
