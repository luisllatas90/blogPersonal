<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frminscripcionevento.aspx.vb" Inherits="frminscripcionevento" Theme="Acero" %>
<html>
<head runat="server">
    <title>Eventos</title>
            ...
            ValidationGroup="BusquedaTexto">*</asp:RequiredFieldValidator>
                ...
                <td width="85%">
                                        ...
                                        &nbsp;<asp:LinkButton ID="lnkBusquedaAvanzada" runat="server" 
                                            Font-Underline="True" ForeColor="Blue" ValidationGroup="Avanzada">Busqueda Avanzada</asp:LinkButton><asp:ValidationSummary ID="ValidationSummary1" runat="server" 
		...
		<tr>
			<td class="pestanabloqueada" id="tab" align="center" style="height:25px;width:12%" onclick="ResaltarPestana2('0','','');">
                <asp:LinkButton ID="lnkDatosEvento" runat="server" Font-Bold="True" 
                    Font-Underline="True" ForeColor="Blue">Datos del evento</asp:LinkButton>
            </td>
            ...
            <% If (request.querystring("mod") = 6 OR request.querystring("mod") = 0) Then%> <!--fatima.vasquez 15-08-2018 --->
            <td class="bordeinf" style="height:25px;width:1%;">&nbsp;</td>
			<td class="pestanaresaltada" id="tab" align="center" style="height:25px;width:12%;" onclick="ResaltarPestana2('1','','');">
            ...
            <td class="bordeinf" style="height:25px;width:1%;">&nbsp;</td>
			    <td class="pestanaresaltada" id="Td1" align="center" style="height:25px;width:12%;" onclick="ResaltarPestana2('1','','');">
