<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCertificacionAlumno.aspx.vb" Inherits="frmCertificacionAlumno" %>
...
&nbsp;<asp:Button ID="cmdBuscar" runat="server" Text="Ver" />
    ...
    EnableModelValidation="True" CellPadding="2">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="email_alu" HeaderText="% Asistencia">
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="email2_alu" HeaderText="Pagos Completos">
