...
&nbsp;(Determina que la inscripción permita el registro de personas con deuda como participantes)</td>
        ...
        <tr>
            <td></td>
            <td>
                <asp:CheckBox ID="chkInscripcionViaWeb" runat="server" Text="Incripción via Web" 
                    ForeColor="#990000" />
                 &nbsp; (Envía email a los coordinadores con el fórmato con la inscripción web)
            </td>
        </tr>
        <tr style="background-color:Red; font-size: 12px; font-family:Verdana; color: #FFFFFF;">
    <td width="15%">
                    Es programa académico</td>
                <td width="85%">
                                        <asp:CheckBox ID="chkgestionanotas_dev" runat="server" Text="Al marcar este check, el coordinador debe registrar el plan de estudios, programación, carga académica y emisión de notas o control de asistencia" />
            </td>
        </tr>
        <tr id="trGeneraNotas">
    <td width="15%">
...
&nbsp; SubTipo:
    ...
    <td width="15%">
                ...
                <td width="85%">
                    ...
                    <asp:HiddenField ID="hd_email_coordinador" runat="server" />
                    <asp:HiddenField ID="hd_email_apoyo" runat="server" />
            </td>
        </tr>
        </table>
    <p align="center">
        <asp:Button ID="cmdGuardar" runat="server" Text="Guardar" 
            ...
            <asp:Button ID="cmdEnviarInscripcion" Visible="false"
        runat="server" 
        Text="Enviar Inscripción Web" SkinID="BotonSinTextoAdjuntar" />
