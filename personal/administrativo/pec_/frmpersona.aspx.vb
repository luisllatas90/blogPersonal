        ...
        If IsPostBack = False Then
            ...
            If (Request.QueryString("token") <> Nothing) Then
                ...
                If (dtPreIns.Rows.Count > 0) Then
                    ...
                    cco = dtPreIns.Rows(0).Item("codigo_cco")
                    Me.hdcodigo_cco.Value = cco
        ...
        If (Me.hdCodCaptcha.Value.Trim = Me.txtCaptcha.Text.Trim) Then
            If ValidarNroIdentidad() = True Then
                If (ValidaForm() = True) Then
                    ...
                    '===============================================================================================================
                    'Grabar en la lista de PreInscritos
                    '===============================================================================================================
                    Try
                        obj.Ejecutar("LOG_InsertaPreInscrito", Me.hdcodigo_pso.Value, Me.hdcodigo_cco.Value, _
                                     IIf(Me.hdAccionForm.Value.Trim = "N", "S", "C"), _
                                     Me.txtObservacion.Text, Date.Today, _
                                     0, 0, 0, _
                                     IIf(Me.hdAccionForm.Value.Trim = "N", "M", "N"))

                        Dim dtToken As DataTable
                        dtToken = obj.TraerDataTable("LOG_RetornaPreInscripcion", Me.hdcodigo_pso.Value, Me.hdcodigo_cco.Value)
                        ...
                        If (dtToken.Rows.Count > 0) Then
                            ...
                            "<a href='http://server-test/campusvirtual/personal/administrativo/pec2/frmpersona.aspx?mod=0&token=" & dtToken.Rows(0).Item("token_pins").ToString.Trim & "'>" & _
