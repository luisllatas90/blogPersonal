<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lstpreinscritoseventocargo.aspx.vb" Inherits="lstpreinscritoseventocargo" Theme="Acero" %>
...
<body>
    ...
    <p class="usatTitulo">Lista de participantes pre - inscritos</p>
