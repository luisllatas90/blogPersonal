...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Ingresantes por modalidad' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../../reportServer/?/PRIVADOS/ACADEMICO/ADM_ConsolidadoIngresantes' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 8 ,
		@variable_men AS NVARCHAR(100) = 'menu78' ,
