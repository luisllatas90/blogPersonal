...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Diagnóstico de respuestas por postulante' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../../reportServer/?/PRIVADOS/ACADEMICO/ADM_DiagnosticoRespuestas' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 7 ,
		@variable_men AS NVARCHAR(100) = 'menu77' ,
