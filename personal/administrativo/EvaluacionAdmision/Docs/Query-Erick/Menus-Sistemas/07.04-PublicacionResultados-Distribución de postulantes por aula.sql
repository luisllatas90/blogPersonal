...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Distribución de postulantes por aula' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../../reportServer/?/PRIVADOS/ACADEMICO/ADM_DistribucionPostulantesPorAula' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 4 ,
		@variable_men AS NVARCHAR(100) = 'menu74' ,
