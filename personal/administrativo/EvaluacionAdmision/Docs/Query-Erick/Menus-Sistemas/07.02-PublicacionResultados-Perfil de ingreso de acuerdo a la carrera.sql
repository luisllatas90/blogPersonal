...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Perfil de ingreso de acuerdo a la carrera' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../../reportServer/?/PRIVADOS/ACADEMICO/ADM_PerfilIngreso_Carrera' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 2 ,
		@variable_men AS NVARCHAR(100) = 'menu72' ,
