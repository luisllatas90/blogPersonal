...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Estructura por tipo de examen' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../../reportServer/?/PRIVADOS/ACADEMICO/ADM_TipoEvaluacion_Estrutura' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 1 ,
		@variable_men AS NVARCHAR(100) = 'menu71' ,
