...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Recalcular Resultados' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../personal/administrativo/EvaluacionAdmision/ProcesamientoResultados/frmRecalculoResultados.aspx?mod=1' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 3 ,
		@variable_men AS NVARCHAR(100) = 'menu53' ,
