...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Consolidado de nivelación' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../../reportServer/?/PRIVADOS/ACADEMICO/ADM_ConsolidadoNivelacion' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 10 ,
		@variable_men AS NVARCHAR(100) = 'menu791' ,
