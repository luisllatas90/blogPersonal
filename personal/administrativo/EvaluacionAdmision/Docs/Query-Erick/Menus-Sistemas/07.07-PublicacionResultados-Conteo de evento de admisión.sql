...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Conteo de evento de admisión' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../../reportServer/?/PRIVADOS/ACADEMICO/ADM_ConteoEventoAdmision' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 6 ,
		@variable_men AS NVARCHAR(100) = 'menu76' ,
