...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Cuadro de nota máximo y mínimo' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../../reportServer/?/PRIVADOS/ACADEMICO/ADM_CuadroMaximoMinimoEventoAdmision' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 5 ,
		@variable_men AS NVARCHAR(100) = 'menu75' ,
