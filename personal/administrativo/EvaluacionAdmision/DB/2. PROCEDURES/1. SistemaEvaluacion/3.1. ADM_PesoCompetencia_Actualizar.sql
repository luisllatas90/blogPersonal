...
-- Description:	
-- =============================================
CREATE PROCEDURE ADM_PesoCompetencia_Actualizar
	@codigo_pcom INT,
	...
	BEGIN TRY 
		...
		BEGIN
			...
			BEGIN
				...
				ELSE
				BEGIN
					EXEC ADM_PesoCompetencia_Insertar @codigo_cac, @codigo_cpf_aux, @codigo_com, @peso_pcom, 0, @codigo_per
				END
...
GRANT EXECUTE ON ADM_PesoCompetencia_Actualizar TO iusrvirtualsistema
GRANT EXECUTE ON ADM_PesoCompetencia_Actualizar TO usuariogeneral
GO