...
-- Description:	
-- =============================================
CREATE PROCEDURE ADM_TipoEvaluacion_Eliminar
	@codigo_tev INT,
	@codigo_per INT
AS
BEGIN
...
GRANT EXECUTE ON ADM_TipoEvaluacion_Eliminar TO iusrvirtualsistema
GRANT EXECUTE ON ADM_TipoEvaluacion_Eliminar TO usuariogeneral
GO