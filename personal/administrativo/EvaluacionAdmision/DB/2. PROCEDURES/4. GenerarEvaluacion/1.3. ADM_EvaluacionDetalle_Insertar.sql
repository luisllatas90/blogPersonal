...
-- ==============================================================================================
CREATE PROCEDURE ADM_EvaluacionDetalle_Insertar 
	@codigo_evl int,
	@codigo_prv int,
	@orden_evl int,
	@codigo_per int
...
GRANT EXECUTE ON ADM_EvaluacionDetalle_Insertar TO iusrvirtualsistema
GRANT EXECUTE ON ADM_EvaluacionDetalle_Insertar TO usuariogeneral
GO