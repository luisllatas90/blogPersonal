...
-- ==============================================================================================
ALTER PROCEDURE ADM_EvaluacionDetalle_Listar
	@tipoOpe varchar(2),
	@codigo_evd int,
	@codigo_evl int,
	@codigo_prv int,
...
BEGIN
	...
	BEGIN
		...
		ind.descripcion_ind, ind.codigo_scom, scom.nombre_scom, scom.codigo_com, com.nombre_com, com.descripcion_com, p.id nro_item,
