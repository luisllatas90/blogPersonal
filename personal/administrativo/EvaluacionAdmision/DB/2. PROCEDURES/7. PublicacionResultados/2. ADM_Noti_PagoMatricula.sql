...
-- Description:	
-- =============================================
CREATE PROCEDURE ADM_Noti_PagoMatricula
	@tipo VARCHAR(4),
	@codigo_cco INT,
	@codigo_apl INT,
	@codigo_evl INT,
...
BEGIN
	...
	BEGIN TRY
		...
		DECLARE ingresantes CURSOR FOR
			...
			--INNER JOIN vstCajaIngresoMatricula_v2 cim ON alu.codigo_Alu = cim.codigo_Alu
...
GRANT EXECUTE ON ADM_Noti_PagoMatricula TO iusrvirtualsistema
GRANT EXECUTE ON ADM_Noti_PagoMatricula TO usuariogeneral
GO
