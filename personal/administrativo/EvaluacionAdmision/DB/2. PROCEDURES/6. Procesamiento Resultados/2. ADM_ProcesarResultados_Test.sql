...
-- ==================================================================
CREATE PROCEDURE ADM_ProcesarResultados_Test
	@codigo_evl INT,
	@ruta AS VARCHAR(500),
	@idArchivo AS BIGINT,
	@codigo_per INT,
...
GRANT EXECUTE ON ADM_ProcesarResultados_Test TO iusrvirtualsistema
GRANT EXECUTE ON ADM_ProcesarResultados_Test TO usuariogeneral
GO