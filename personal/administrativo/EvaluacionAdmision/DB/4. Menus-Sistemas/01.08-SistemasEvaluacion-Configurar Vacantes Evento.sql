...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Configuración de Vacantes por Evento de Admisión' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../personal/administrativo/EvaluacionAdmision/SistemaEvaluacion/frmVacantesEvento.aspx?mod=1' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 9 ,
		@variable_men AS NVARCHAR(100) = 'menu19' ,
