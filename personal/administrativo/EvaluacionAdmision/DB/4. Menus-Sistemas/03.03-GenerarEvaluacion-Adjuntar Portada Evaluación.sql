...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Adjuntar Portada para Evaluación' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../personal/administrativo/EvaluacionAdmision/GenerarEvaluacion/frmEvaluacionAdjuntarPortada.aspx?mod=1' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 3 ,
		@variable_men AS NVARCHAR(100) = 'menu33' ,
