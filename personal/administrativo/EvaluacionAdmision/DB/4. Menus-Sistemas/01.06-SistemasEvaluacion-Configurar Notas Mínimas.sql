...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Configuración de Notas Mínimas de Ingreso' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../personal/administrativo/EvaluacionAdmision/SistemaEvaluacion/frmConfiguracionNotasMinimas.aspx?mod=1' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 7 ,
		@variable_men AS NVARCHAR(100) = 'menu17' ,
