...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Matriz de competencias e indicadores' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../../reportServer/?/PRIVADOS/ACADEMICO/ADM_MatrizComponente' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 3 ,
		@variable_men AS NVARCHAR(100) = 'menu73' ,
