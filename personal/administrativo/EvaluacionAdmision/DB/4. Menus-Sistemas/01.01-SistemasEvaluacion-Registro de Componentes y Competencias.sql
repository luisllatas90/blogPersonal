...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Registro de Componentes y Competencias' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../personal/administrativo/EvaluacionAdmision/SistemaEvaluacion/frmComponentesCompetencias.aspx?mod=1' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 2 ,
		@variable_men AS NVARCHAR(100) = 'menu12' ,
