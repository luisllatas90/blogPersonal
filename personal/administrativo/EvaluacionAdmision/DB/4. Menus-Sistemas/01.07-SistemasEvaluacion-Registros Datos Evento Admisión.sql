...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Registro de Datos de Evento de Admisión' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../personal/administrativo/EvaluacionAdmision/SistemaEvaluacion/frmDatosEventoAdmision.aspx?mod=1' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 8 ,
		@variable_men AS NVARCHAR(100) = 'menu18' ,
