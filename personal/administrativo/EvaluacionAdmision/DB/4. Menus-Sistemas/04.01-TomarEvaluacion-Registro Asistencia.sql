...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Registro de Asistencia' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../personal/administrativo/EvaluacionAdmision/TomarEvaluacion/frmRegistroAsistencia.aspx?mod=1' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 1 ,
		@variable_men AS NVARCHAR(100) = 'menu41' ,
