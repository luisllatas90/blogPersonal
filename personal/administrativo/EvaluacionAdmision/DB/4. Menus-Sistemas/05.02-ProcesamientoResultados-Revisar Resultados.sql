...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Revisión de Respuestas por Evaluación' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../personal/administrativo/EvaluacionAdmision/ProcesamientoResultados/frmRevisionResultados.aspx?mod=1' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 2 ,
		@variable_men AS NVARCHAR(100) = 'menu52' ,
