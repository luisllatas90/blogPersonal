...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Configuración de Pesos por Competencia y Escuela' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../personal/administrativo/EvaluacionAdmision/SistemaEvaluacion/frmConfiguracionPesosCompetencia.aspx?mod=1' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 4 ,
		@variable_men AS NVARCHAR(100) = 'menu14' ,
