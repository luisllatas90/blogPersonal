...
DECLARE @codigo_Men AS INT = 0 , 
		@descripcion_Men AS NVARCHAR(510) = 'Resultados de Admisión' , --NOMBRE DEL MENU
		@enlace_Men AS NVARCHAR(510) = '../librerianet/Admision/frm_ResultadosAdmision.aspx' , --RUTA DEL FORMULARIO
		...
		@orden_men AS INT = 2 ,
		@variable_men AS NVARCHAR(100) = 'menu62' ,
