...
var $mdlNotasPorDefecto = undefined;
var $mdlNotaMinimaCompetencias = undefined;
...
$(document).ready(function () {
    ...
    $mdlNotasPorDefecto = $('#mdlNotasPorDefecto');
    $mdlNotasPorDefecto.modal({
        backdrop: 'static',
        show: false,
    });

    $mdlNotaMinimaCompetencias = $('#mdlNotaMinimaCompetencias');
    $mdlNotaMinimaCompetencias.modal({
        backdrop: 'static',
        show: false,
    });
    ...
    for (var tipo of tipos) {
        switch (tipo) {
            ...
            case 'ACC_ADIC':
                ...
                switch (tipoModal) {
                    case 'NPD':
                        $modal = $mdlNotasPorDefecto;
                        break;
                    case 'NMPC':
                        $modal = $mdlNotaMinimaCompetencias;
                        break;
                }
