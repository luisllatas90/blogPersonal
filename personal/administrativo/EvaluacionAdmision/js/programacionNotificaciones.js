...
$(document).ready(function () {
    ...
    $('body').on('change', '#rbtTipoEmail', function (e) {  
        __doPostBack('rbtTipoEmail', '');
    });

    $('body').on('change', '#rbtTipoSms', function (e) {  
        __doPostBack('rbtTipoSms', '');
    });
...
function initFilterPlugins() {
    ...
    initDatepicker('txtFiltroDesde', {
        language: 'es',
        format: 'dd/mm/yyyy'
    });

    initDatepicker('txtFiltroHasta', {
        language: 'es',
        format: 'dd/mm/yyyy'
    });
}
...
function initFormPlugins() {
    ...
    initSelectPicker('cmbPeriodicidad', {});
    initSelectPicker('cmbPlantilla', {});

    initDatetimePicker('mrkFechaHoraInicio', {
        format: 'DD/MM/YYYY HH:mm',
    });

    initDatetimePicker('mrkFechaHoraFin', {
        format: 'DD/MM/YYYY HH:mm',
    });
}
