<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDatosEventoAdmision.aspx.vb" Inherits="frmDatosEventoAdmision" %>
...
<head runat="server">
    ...
    <title>.:: Registro de Datos de Evento de Admisión ::.</title>
    <!-- Estilos externos -->
    ...
    <link rel="stylesheet" href=<%=ClsGlobales.PATH_CSS %>/datosEventoAdmision.css>
</head>
...
<body>
    <form id="form" runat="server">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-48">
                    <h1 class="main-title">Registro de Datos de Evento de Admisión<img src=<%=ClsGlobales.PATH_IMG %>/loading.gif id="loadingGif"></h1>
                    <hr>
                </div>
            </div>
            <nav>
                        ...
                        <div class="card-body">
                            <div class="row form-group">
                                <div class="col-sm-14 d-flex">
                                    ...
                                    <div class="fill">
                                        <asp:DropDownList ID="cmbFiltroCicloAcademico" runat="server" CssClass="form-control form-control-sm selectpicker" data-live-search="true">
                                            <asp:ListItem Text="-- TODOS --" Value="1" />
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-sm-34 text-right">
                                    ...
                                    <asp:UpdatePanel ID="udpGrvList" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                                        <ContentTemplate>
                                            <div id="divGrvList" runat="server">
                                                <hr class="separador">
                                                <asp:GridView ID="grvList" runat="server" DataKeyNames="codigo_cco" AutoGenerateColumns="false" CssClass="table table-sm" GridLines="None">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="SEMESTRE ACADÉMICO" ItemStyle-Width="25%" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <div class="d-flex controles justify-content-center">
                                                                    <asp:HiddenField ID="hddDea" runat="server" Value='<%# Eval("codigo_dea") %>' />
                                                                    <asp:HiddenField ID="hddCco" runat="server" Value='<%# Eval("codigo_cco") %>' />
                                                                    <asp:HiddenField ID="hddCac" runat="server" Value='<%# Eval("codigo_cac") %>' />
                                                                    <span id="spnCicloAcademico" runat="server"><%# Eval("descripcion_cac") %></span>
                                                                    <asp:DropDownList ID="cmbCicloAcademico" runat="server" CssClass="form-control form-control-sm selectpicker" Visible="false"
                                                                        data-live-search="true">
                                                                    </asp:DropDownList>
                                                                    <asp:LinkButton type="button" id="btnEditar" runat="server" CommandName="Editar" class="btn btn-sm btn-primary ml-3">
                                                                        <i class="fa fa-edit"></i>
                                                                        <span class="text">Editar</span>
                                                                    </asp:LinkButton>
                                                                    <asp:LinkButton type="button" id="btnGuardar" runat="server" CommandName="Guardar" Visible="False" class="btn btn-sm btn-success ml-3">
                                                                        <i class="fa fa-save"></i>
                                                                        <span class="text">Guardar</span>
                                                                    </asp:LinkButton>
                                                                    <asp:LinkButton type="button" id="btnCancelar" runat="server" CommandName="Cancelar" Visible="False" class="btn btn-sm btn-danger ml-1">
                                                                        <i class="fa fa-ban"></i>
                                                        ...
                                                        <asp:TemplateField HeaderText="FECHA DE EVENTO" ItemStyle-Width="25%" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <div class="d-flex controles justify-content-center">
                                                                    <span id="spnFechaEvento" runat="server"><%# Eval("fechaEvento_dea") %></span>
                                                                    <asp:TextBox ID="txtFechaEvento" runat="server" CssClass="form-control form-control-sm" Visible="False" placeholder="Fecha" />
                                                                    </asp:DropDownList>
                                                                    <asp:LinkButton type="button" id="btnEditarFecha" runat="server" CommandName="EditarFecha" class="btn btn-sm btn-primary ml-3">
                                                                        <i class="fa fa-edit"></i>
                                                                        <span class="text">Editar</span>
                                                                    </asp:LinkButton>
                                                                    <asp:LinkButton type="button" id="btnGuardarFecha" runat="server" CommandName="GuardarFecha" Visible="False" class="btn btn-sm btn-success ml-3">
                                                                        <i class="fa fa-save"></i>
                                                                        <span class="text">Guardar</span>
                                                                    </asp:LinkButton>
                                                                    <asp:LinkButton type="button" id="btnCancelarFecha" runat="server" CommandName="CancelarFecha" Visible="False" class="btn btn-sm btn-danger ml-1">
                                                                        <i class="fa fa-ban"></i>
                                                                        <span class="text">Cancelar</span>
                                                                    </asp:LinkButton>
                                                                </div>
    ...
    <script src="<%=ClsGlobales.PATH_JS %>/datosEventoAdmision.js"></script>
