...
Partial Class administrativo_frmExportaFichaPostulacion
    ...
    Private Sub Generarpdf()
        ...
        Dim documento As New Document(PageSize.A4, 75, 85, 67, 50)
        ...
        If tbl.Rows.Count > 0 Then
            ...
            Dim fechanacalu As String = tbl.Rows(0).Item("fechaNacimiento_Alu").ToString
            ...
            'Dim tipoestudioperfil As String = tbl.Rows(0).Item("nombre_tep").ToString
            ...
            'Dim cell1 As New PdfPCell(New Phrase("DATOS DEL POSTULANTE", FontFactory.GetFont("Arial", 10, Font.BOLD)))
            'cell1.Colspan = 6
            'table.AddCell(cell)
            'Dim celda33 As New PdfPCell(New Phrase("Perfil Estudiante", FontFactory.GetFont("Arial", 9)))
            'table.AddCell(celda33)
            'Dim cell0 As New PdfPCell(New Phrase(tipoestudioperfil, FontFactory.GetFont("Arial", 9)))
            'cell0.Colspan = 5
            'table.AddCell(cell0)
            ...
            parrafo35.Add("Los estudiantes que no concretaron su proceso de matrícula deben solicitar la devolución de sus documentos en un plazo máximo de 30 días, de lo controlario USAT no se hace responsable por la entrega de los mismos.") 'Texto que se insertara
