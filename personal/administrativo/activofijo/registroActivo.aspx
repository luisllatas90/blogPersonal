<%@ Page Language="VB" AutoEventWireup="false" CodeFile="registroActivo.aspx.vb" Inherits="administrativo_activofijo_registroActivo" %>
...
<script type="text/javascript">
    ...
    fnResetDataTableTramite('tbArtCom', 0, 'desc');
        ...
        $("#btnActualuzarSerie").click(fnActualuzarSerie);
        llenarFormulario($('#param1').val(),"P");
        llenarFormulario($('#param1').val(), "DP");

    });

    function fnActualuzarSerie() {
        $('#hdAccion').val("ACT");
        $('#hdIEgreso').val(0);
        //alert($('#param1').val());
        //alert($('#hdIEgreso').val());
...
//        alert($('#txtNroPedido').val());
    ...
    function llenarFormulario(codigo, param) {
        $.ajax({
            ...
            contentType: "application/json; charset=utf-8",
            url: "../../DataJson/activofijo/processactivofijo.aspx",
            data: { "param0": "lstRegistroActivo", "param1": codigo, "tipo": param },
            dataType: "json",
            async: false,
            success: function(data) {
                var t = '';
    ...
    function fnRegistrarSerie(fila, c_det, activo) {
        //alert("fila: " + fila);
        //alert("c_det: " + c_det)
        //alert("activo: " + activo);
        ...
        $.ajax({
            ...
            contentType: "application/json; charset=utf-8",
            url: "../../DataJson/activofijo/processactivofijo.aspx",
            data: { "param0": "LstDetalleRegistroAF", "param1": $('#txtNroPedido').val(), "param2": aDataDP[c_det].c_art },
            dataType: "json",
            success: function(data) {
                aDataDR = data;
            },
        ...
        if (activo == 0) {
            ...
            //alert("Nro Ped: " + $('#txtNroPedido').val());
            //alert("C_art: " + aDataDP[c_det].c_art);
...
//            });
        ...
        mostrarArticuloComponente(aDataDP[c_det].c_art, fila,c_det);
        
        $('div#mdRegistroSerieAF').modal('show');
        return true;
    }

    function mostrarArticuloComponente(c_art, pos1, pos) {
        ...
        //alert($('#txtCSerie\\[' + cont + '\\]').val());
        //alert($('#txtNroComp\\[' + cont + '\\]').val());
...
//                                alert("Valor: "+$('#txtValorC\\[' + i + '\\]').val());
                    ...
                    //alert("ID: " + $('#hdDetalleIdCCO').val());
                    //alert("Valor: " + $('#hdDetalleValorCCO').val());
                    //alert("Articulo: " + $('#hdArt1').val());
                    //alert("Componente: " + $('#hdArt').val());
                    //alert("Unidades: " + $('#hdUnid').val());
                    //alert("NumeroEs: " + $('#hdNumeroEs').val());
    ...
    function fnComponentes(fila, c_det) {        
        $('#hdIEgreso').val("0");
	        ...
	        <div class="row">
	            <div class="col-md-12" id="divConfirmar">
                    ...
                    <div class="form-group">
				        ...
				        <div class="col-md-7">
					        <input name="txtSerie" type="text" id="txtSerie" value="" class="form-control" />
				        </div>
                        <div class="col-md-1">					        
