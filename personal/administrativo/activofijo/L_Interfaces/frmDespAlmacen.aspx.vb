...
Partial Class administrativo_DespachoAlmacen_frmDespAlmacen
        ...
        Try
            Select Case ls_panel
                ...
                Case "GuiaRemision"
                    ...
                    Me.udpGuiaRemisionArticulos.Update()
                    ScriptManager.RegisterStartupScript(Me, Me.Page.GetType, "udpGuiaRemision", "", True)
    ...
    Private Sub mt_FlujoTabs(ByVal ls_tab As String)
        Try
            Select Case ls_tab
                ...
                Case "Despacho->GuiaRemision"
                    Me.udpScripts.Update()
                    ScriptManager.RegisterStartupScript(Me, Me.Page.GetType, "flujoTabs", "flujoTabs('despacho->guiaRemision-tab');", True)
                Case "GuiaRemision->Listado"
                    Me.udpScripts.Update()
                    ScriptManager.RegisterStartupScript(Me, Me.Page.GetType, "flujoTabs", "flujoTabs('guiaRemision->listado-tab');", True)
            End Select
        Catch ex As Exception
            Call mt_ShowMessage(ex.Message.Replace("'", " "), MessageType.error)
        End Try
    ...
    Private Sub mt_CargarDatosGuiaRemision()
        Dim obj As New ClsConectarDatos
        Dim dt As New Data.DataTable
        Dim i As Integer
        'obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
        Try
            ...
            dt.Rows.Add(1, 3, "15/02/2021", "Roberto Gonzales", "JFD", 623)
            'obj.CerrarConexion()
            Me.grwGuiaRemisionArticulos.DataSource = dt
            Me.grwGuiaRemisionArticulos.DataBind()
            Call md_Funciones.AgregarHearders(grwGuiaRemisionArticulos)
            Call mt_UpdatePanel("GuiaRemision")
    ...
    Protected Sub lnkBtnSalirGuiaRemision_Sup_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkBtnSalirGuiaRemision_Sup.Click
        Try
            Call btnListar_Click(Nothing, Nothing)
            Call mt_FlujoTabs("GuiaRemision->Listado")
    ...
    Protected Sub lnkBtnSalirGuiaRemision_Inf_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkBtnSalirGuiaRemision_Inf.Click
        Try
            Call btnListar_Click(Nothing, Nothing)
            Call mt_FlujoTabs("GuiaRemision->Listado")
    ...
    Protected Sub lnkBtnAtenderPedido_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkBtnAtenderPedido.Click
        Try
            Call mt_CargarDatosGuiaRemision()
            Call mt_FlujoTabs("Despacho->GuiaRemision")
