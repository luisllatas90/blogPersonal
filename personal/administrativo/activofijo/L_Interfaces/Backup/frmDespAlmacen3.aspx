<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDespAlmacen.aspx.vb" Inherits="administrativo_activofijo_L_Interfaces_frmDespAlmacen" %>
...
<!DOCTYPE html>
    ...
    <body>
        <form id="frmDespachoAlmacen" runat="server">
             <asp:ScriptManager ID="scripPrueba" runat="server"></asp:ScriptManager>
                        ...
                        <asp:GridView ID="grwListaa" runat="server" Width="100%" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                             ...
                                             <asp:TemplateField ItemStyle-HorizontalAlign="Center"
                                                HeaderText="Selec.">
                                                <ItemTemplate>
                                              <asp:CheckBox ID="chkSelecPedido2" runat ="server" AutoPostBack="false" CssClass ="filaSelec" onchange="seleccionarFila(this);"/>  
                      ...
                      <!--Contenedor de GridView (Pestaña 02)-->
                        <div class="table-responsive">
                           ...
                           <asp:UpdatePanel ID="udpDetalle" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">                                                                    
                                <ContentTemplate>
                                           <asp:CheckBox ID="chkselecpedido2" runat ="server" AutoPostBack="false"/>                                  
                                       ...
                                       GridLines="None">
                                        <Columns>
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center"
                                                HeaderText="Selec.">
                                                <ItemTemplate>
                                                          <asp:CheckBox ID="chkselecpedido"  runat ="server" AutoPostBack="false" CssClass ="chkFila"
                                                              />                                  
          ...
          <script type="text/javascript">
            ...
            $(document).ready(function() {
                //No funciona cuando se le hace click en el botón Listar (sólo funciona cuando carga directamente el GridView), se dispara automátocamente (asigna evento: onchange)
                         $("#<%=grwListaa.ClientID%> [id*='chkSelecPedido2']").change(function() {
                        
                  });
                  
              });

              //Si funciona cuando se le hace clic en el botón Listar (Se dispara desde el evento: onchange="seleccionarFila(this);)
              function seleccionarFila(control)
              {
                  alert("Luis seleccion");

                 var aux = document.getElementsByTagName(control);

                var chk = $(control).prop('checked');
                var hola = $('tbody tr td span.filaSelec input:checkbox');
                if (chk == true) {
                    $('tbody tr td span.filaSelec input:checkbox').prop("checked", false);
                    $('tbody tr td span.filaSelec input:checkbox').prop("checked", true);                             
