<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDespAlmacen.aspx.vb"
    ...
    <head runat="server">
        ...
        <script type="text/javascript">
            ...
            {
                $("#grwDetalle tbody tr span.chkFila input")
                var aux = $("#<%=grwDetalle.ClientID%> tbody tr span.chkFila input");
                alert("dds")
            }
            
              $(document).ready(function() {

                         //$('td:eq(2) :text', '#<%=grwDetalle.ClientID%> tr').change(function() {
                  var aux4 = $("#<%=grwDetalle.ClientID%> tbody tr span.chkFila input");

                       $("#<%=grwDetalle.ClientID%> tbody tr span.chkFila [id*='chkselecpedido']").click(function() {
                           alert('LUIS LUISooodsdsds1');
                       var chk = $(this).prop('checked');
                       var aux = $('tbody tr td span.chkFila input:checkbox');
                       if (chk == true) {
