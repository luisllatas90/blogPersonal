<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSolicitarActivoFijo.aspx.vb" Inherits="administrativo_activofijo_l_Interfaces_frmSolicitarActivoFijo" %>
     ...
     <head runat="server">
        ...
        <script type="text/javascript">
            ...
            function flujoTabs(tabActivo) {
                ...
                } else if (tabActivo == 'Detalle->Listado') {
                    //HABILITAR
                    estadoTabDetalle('D');
        ...
        <form id="frmInformacionContable" runat="server">
            ...
            <div class="container-fluid">
                ...
                <div class="card div-title">
                    <div class="row title">SOLICITAR ACTIVO FIJO</div>
                </div>
                <!--/Cabecera de Panel-->
                <!--Tabs-->
                ...
                <div class="tab-content" id="contentTabs">
                                ...
                                <ContentTemplate>
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                   <asp:DropDownList ID="cmbTipoFiltro" runat="server"
                                                        ...
                                                        <asp:ListItem Value="POR VALIDAR">POR VALIDAR
                                                        </asp:ListItem>        
                                                        <asp:ListItem Value="VALIDADO">VALIDADO
                                                        </asp:ListItem>                                    
                                                    </asp:DropDownList>
                                                </div>    
                                                <div class ="col-sm-4">
                                                     <asp:LinkButton ID="btnListarSolicitud" runat="server"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                  <asp:LinkButton ID="btnNuevaSolic" runat="server"
                            ...
                            <asp:UpdatePanel ID="udpLista" runat="server" UpdateMode="Conditional"
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="grwLista" runat="server" Width="100%" AutoGenerateColumns="false"
                                        ShowHeader="true" CssClass="display table table-sm"
                                        GridLines="None">
                                        <Columns>
                                            <asp:BoundField DataField="cod_solReq" HeaderText="CÓD. SOLIC." />
                                            <asp:BoundField DataField="solic" HeaderText="SOLICITANTE" />
                                            <asp:BoundField DataField="are_solc" HeaderText="ÁREA SOLICITANTE" />
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnVerDetalle" runat="server"
                                                        ...
                                                        CommandName="VerDetalle" CssClass="btn btn-primary btn-sm"
                                                        ToolTip="Ver Detalle">
                                                        <span><i class="fa fa-search"></i></span>
                                                    </asp:LinkButton>
                                                    <asp:LinkButton ID="btnElimSolic" runat="server"
                                                        CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"
                                                        CommandName="ElimSol" CssClass="btn btn-primary btn-sm"
                                                        ToolTip="Eliminar solicitud">
                                                        <span><i class="fa fa-trash"></i></span>
                                                    </asp:LinkButton>
                                                     <asp:LinkButton ID="btnConfValid" runat="server"
                                                        CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"
                                                        CommandName="ConfVal" CssClass="btn btn-primary btn-sm"
                                                        ToolTip="Confirmar Validación">
                    ...
                    <!--Tab de Nueva Solicitud (Pestaña 02)-->
                    <div class="tab-pane" id="registro" role="tabpanel" aria-labelledby="registro-tab">                      
                                        ...
                                        <div class="card-body">
                                            <div class="row">                                               
                                                <label for="txtArticulo"
                                                    class="col-sm-1 col-form-label form-control-sm">Artículo:</label>
                                                <div class="col-sm-3">
                        ...
                        <div class="table-responsive">
                            <asp:UpdatePanel ID="udpRegistrar" runat="server" UpdateMode="Conditional"
                                ChildrenAsTriggers="false">
                                <ContentTemplate>
                                    <asp:GridView ID="gvRegistrar" runat="server" Width="100%" AutoGenerateColumns="false"
                                        ShowHeader="true" DataKeyNames="cod_nuevoReg"  CssClass="display table table-sm"
                                        GridLines="None">
                                        <Columns>
                                            <asp:BoundField DataField="descrip" HeaderText="DESCRIPCIÓN" />
                                            <asp:BoundField DataField="cantid" HeaderText="CANTIDAD" />
                                         
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center"
                                                HeaderText="OPE.">
                                                <ItemTemplate>                                                   
                                                    <asp:LinkButton ID="btnElimArticulo" runat="server"
                                                        CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"
                                                        CommandName="ElimArt" CssClass="btn btn-primary btn-sm"
                    ...
                    <!--/Tab de Registro (Pestaña 02) -->   

                    <!--Tab Detalle (Pestaña 03)  -->  
                    <div class="tab-pane" id="detalle" role="tabpanel" aria-labelledby="detalle-tab">                      
                        ...
                        <div class="table-responsive">
                            <asp:UpdatePanel ID="udpDetalleSolic" runat="server" UpdateMode="Conditional"
                                ChildrenAsTriggers="false">
                                <ContentTemplate>
