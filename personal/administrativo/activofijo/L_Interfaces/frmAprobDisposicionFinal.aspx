<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAprobDisposicionFinal.aspx.vb" Inherits="administrativo_activofijo_L_Interfaces_frmAprobDisposicionFinal" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <head runat="server">
        <title>Aprobación de Disposición Final</title>
        ...
        <form id="frmInformacionContable" runat="server">
            ...
            <div class="container-fluid">
                ...
                <div class="card div-title">
                    <div class="row title">APROBACIÓN DE DISPOSICIÓN FINAL</div>
                </div>
                <!--/Cabecera de Panel-->
                <!--Tabs-->
                ...
                <div class="tab-content" id="contentTabs">
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnVerExpBien" runat="server"
                                                        ...
                                                        CommandName="VerExpBien" CssClass="btn btn-secondary"
                                                        ToolTip="Ver Expediente del Bien">
                                                        <span><i class="fa fa-search"></i></span>
                                                    </asp:LinkButton>

                                                    <asp:LinkButton ID="btnExportarExpedBien" runat="server"
                                                        CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"
                                                        CommandName="ExporExpBien" CssClass="btn btn-secondary"
                                                        ToolTip="Exportar Expediente del Bien">
                                                        <span><i class="fa fa-file-export"></i></span>
                                                    </asp:LinkButton>
                                                    <asp:LinkButton ID="btnAdjuntarExpedBien" runat="server"
                                                        CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"
                                                        CommandName="AdjExpedBien" CssClass="btn btn-primary"
                                                        ToolTip="Adjuntar Expediente del bien">
                                                        <span><i class="fa fa-paperclip"></i></span>
                                                    </asp:LinkButton>
                                                    <asp:LinkButton ID="btnConfAprob" runat="server"
                                                        CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>"
                                                        CommandName="ConfirmarAprob" CssClass="btn btn-primary"
                                                        ToolTip="Confirmar Aprobación de Disposición Final">
                    ...
                    <div class="tab-pane" id="adjuntar" role="tabpanel" aria-labelledby="adjuntar-tab">                      
                        <!--Panel de Filtro de Búsqueda-->
                        <div class="panel-cabecera">
                            <asp:UpdatePanel ID="udpFiltroAdjEvidenc" runat="server" UpdateMode="Conditional"
                                ChildrenAsTriggers="false">
                                <ContentTemplate>
                                    <div class="card">
                                        <div class="card-header">Adjuntar Expediente del Bien</div>
                                        <div class="card-body">
                                            <div class="row">                                               
