                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Recomendaciones">
                                        <ItemTemplate>
                                            <asp:RadioButtonList ID="rbRecomendacion" runat="server">
                                                <asp:ListItem class="radio-inline" Value="L" Text="Licitación"></asp:ListItem>
                                                <asp:ListItem class="radio-inline" Value="D" Text="Donación"></asp:ListItem>
                                                <asp:ListItem class="radio-inline" Value="E" Text="Eliminación"></asp:ListItem>
                                            </asp:RadioButtonList>
