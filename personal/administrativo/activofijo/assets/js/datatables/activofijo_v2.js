$(document).ready(function() {
    ...
    $('#tbActivoFijo tbody td.details-control').on('click', function() {
        ...
        if (oTable.fnIsOpen(nTr)) {
            ...
            var nuevo = idEgreso;
            var nuevo1 = aDataDP[c_det].c_art;
            ...
            $.ajax({
                ...
                data: { "param0": "LstDetalleRegistroAF", "param1": nrop, "param2": aDataDP[c_det].c_art, "hdIEgreso": idEgreso },
                ...
                success: function(data) {
                    ...
                    for (j = 0; j < cant_det; j++) {
                        ...
                        if (j < i) {
                            ...
                            sOut += '<td width="5%"><a href="#" class="btn btn-orange btn-xs" onclick="fnRegistrarSerie(' + j + ',' + c_det + ',' + 1 + ',' + nuevo + ',' + nuevo1 + ',\'' + aDataDR[j].d_ser + '\')" ><i class="ion-android-create"></i></a></td>';
                            ...
                            sOut += '<td width="5%" class=' + contador + '>' + '<input name="txtEgreso[' + contador + ']" type="text" id="txtEgreso[' + contador + ']" value="" width="100%" onblur="focusEgresado(' + contador + ',' + nuevo + ',' + nuevo1 + ',' + 'this' + ',\'' + nTr + '\')"/>' + '</td>';
                            //sOut += '<td width="5%"> - </td>';
                            sOut += '<td width="5%"> - </td>';
                            sOut += '<td width="5%"><a href="#" class="btn btn-orange btn-xs" onclick="fnRegistrarSerie(' + j + ',' + c_det + ',' + 0 + ',' + nuevo + ',' + nuevo1 + ',\'' + '0' + '\')" ><i class="ion-android-create"></i></a></td>';
                        }
                        if (j == 0) {
                            if (swDF == 1) {
