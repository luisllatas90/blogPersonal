...
Public Class ClsEnviaMail
    Public Sub ConsultarEnvioMail(ByVal codigo_sol As Int32)
        ...
        If Dat_Evaluador.Rows.Count > 0 Then
            ...
            Select Case Dat_Evaluador.Rows(0).Item("NIVEL_EVA")
                Case 1
                    Mensaje = Mensaje & "    <td>Sr(a)(ta). Director(a) de Escuela <b>" & Dat_Evaluador.Rows(0).Item("PERSONA") & "</b></br></br></br>"
                Case 2
                    Mensaje = Mensaje & "    <td>Sr. Director Académico <b>" & Dat_Evaluador.Rows(0).Item("PERSONA") & "</b></br></br></br>"
                Case 3
                    Mensaje = Mensaje & "    <td>Sr. Gerente General <b>" & Dat_Evaluador.Rows(0).Item("PERSONA") & "</b></br></br></br>"
            End Select
            Mensaje = Mensaje & "    La solicitud número <b>" & Dat_Evaluador.Rows(0).Item("numero_sol") & "</b> del estudiante <b>" & Dat_Evaluador.Rows(0).Item("alumno") & "</b>"
            Mensaje = Mensaje & "    con código universitario <b>" & Dat_Evaluador.Rows(0).Item("codigouniver_alu") & "</b>"
            Mensaje = Mensaje & "    ha sido registrada el día <b>" & Dat_Evaluador.Rows(0).Item("fecha_sol") & "</b>.</br> </br> Por favor sirvase atenderla. </br></br> "
    ...
    Private Sub EnviarMailCaja(ByVal codigo_sol As Int32)
        ...
        If Dat_Accion.Rows.Count > 0 Then
            If CInt(Dat_Accion.Rows(0).Item("aprobado")) = 1 Then
                ...
                'Correo = "hreyes@usat.edu.pe"
                'ConCopia = Dat_Accion.Rows(0).Item("correo")
    ...
    Public Sub EnviaMailEvaluacionRegistro(ByVal codigo_sol As Int32)
        ...
        If CInt(Dat_Accion.Rows(0).Item("aprobadas")) = CInt(Dat_Accion.Rows(0).Item("evaluacion")) Then
            ...
            AsuntoCorreo = "1 Solicitud Pendiente"
            Correo = "mvilchez@usat.edu.pe"
            ConCopiaA = "eurpeque@usat.edu.pe; msanchez@usat.edu.pe; hreyes@usat.edu.pe"
            'Correo = "hreyes@usat.edu.pe"
            'ConCopiaA = ""
            ObjMailNet.EnviarMail("campusvirtual@usat.edu.pe", "Sistema de Solicitudes", Correo, AsuntoCorreo, Mensaje, True, ConCopiaA)
