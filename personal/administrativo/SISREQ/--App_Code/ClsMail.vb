...
Public Class ClsMail
    ...
    Public Function EnviarMail(ByVal De As String, ByVal nombreenvia As String, ByVal Para As String, ByVal Asunto As String, ByVal Mensaje As String, ByVal HTML As Boolean, optional concopia as string="") As Boolean
