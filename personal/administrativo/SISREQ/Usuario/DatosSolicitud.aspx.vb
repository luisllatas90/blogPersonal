    ...
    Protected Sub cmdGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdGuardar.Click
        ...
        Try
            ...
            If Me.txtobservacion.Text = "" Then
                ObjCnx.Ejecutar("paReq_InsertarSolicitud", Me.txtDescripcion.Text, Me.CboPrioridad.SelectedValue, Me.CboEstado.SelectedValue, Me.txtfecha.Text, Me.CboTipo.SelectedValue, Me.CboAplicacion.SelectedValue, Me.CboPersona.SelectedValue, Me.CboArea.SelectedValue, Me.txtobservacion.Text, 0, CInt(Request.QueryString("id")))
            Else
                ObjCnx.Ejecutar("paReq_InsertarSolicitud", Me.txtDescripcion.Text, Me.CboPrioridad.SelectedValue, Me.CboEstado.SelectedValue, Me.txtfecha.Text, Me.CboTipo.SelectedValue, Me.CboAplicacion.SelectedValue, Me.CboPersona.SelectedValue, Me.CboArea.SelectedValue, Me.txtobservacion.Text, 1, CInt(Request.QueryString("id")))
            End If
