                                                ...
                                                <tr>
                                                    <th>
                                                        <asp:GridView ID="GvEstadoCue" runat="server" AutoGenerateColumns="False" 
                                                            DataKeyNames="codigo_Deu" Width="100%" ShowFooter="True">
                                                            <Columns>
                                                                <asp:BoundField DataField="fechaVencimiento_Sco" 
                                                                    DataFormatString="{0:dd-MM-yyyy}" HeaderText="Fecha de Venc." 
                                                                    SortExpression="fechaVencimiento_Sco">
                                    ...
                                    <tr>
                                        <td style="Width:50%" valign="top">
                                            <asp:Panel ID="Panel2" runat="server" BorderWidth="1px" Height="100px" 
                                                ...
                                                BorderStyle="Solid">
                                                <asp:CheckBoxList ID="CblSeleccionar" runat="server">
                                                </asp:CheckBoxList>
                                            </asp:Panel>
                                        </td>
                                        <td style="Width:50%" valign="top">
