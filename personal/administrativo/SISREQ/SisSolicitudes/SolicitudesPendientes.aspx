<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SolicitudesPendientes.aspx.vb" Inherits="SisSolicitudes_SolicitudesPendientes" %>
...
<body>
    ...
    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="FondoPagina" height="18">
                <b>LISTA DE SOLICITUDES POR CÓDIGO, NOMBRE O NÚMERO DE SOLICITUD</b></td>
        </tr>
        <tr>
            <td class="FondoPagina">
                Buscar estudiante por: <asp:DropDownList ID="CboSeleccionar" runat="server" 
                    AutoPostBack="True">
                    <asp:ListItem Value="1">Código Universitario</asp:ListItem>
                    <asp:ListItem Value="2">Apellidos y Nombres</asp:ListItem>
                    <asp:ListItem Value="6">Numero de solicitud</asp:ListItem>
                </asp:DropDownList>
&nbsp;
                <asp:TextBox ID="TxtBuscar" runat="server" Width="30%"></asp:TextBox>
&nbsp;
                <asp:Button ID="CmdBuscar" runat="server" Text="    Buscar" CssClass="Buscar" 
                    Height="24px" Width="80px" />
            </td>
        </tr>
        <tr class="FondoPagina">
            <td>
                &nbsp;</td>
        </tr>
        <tr>
                    ...
                    GridLines="Horizontal">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Fecha_Sol" DataFormatString="{0:dd/MM/yyyy}" 
                                HeaderText="Fecha de Sol." ReadOnly="True" SortExpression="Fecha_Sol" />
            ...
            <td align="center" colspan="2">
                ...
                <asp:DetailsView ID="DvEstudiante" runat="server" AutoGenerateRows="False" 
                    ...
                    <Fields>
                        ...
                        <asp:BoundField DataField="beneficio_Alu" HeaderText="Beneficio de Beca">
                        </asp:BoundField>
                    </Fields>
                </asp:DetailsView>
                        </td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
        ...
        <tr>
            <td valign="top" style="font-weight: 700;">
                <asp:Button ID="CmdEnviar" runat="server" Text="Enviar" visible="False" />
            </td>
        </tr>
        <tr>
            <td>
