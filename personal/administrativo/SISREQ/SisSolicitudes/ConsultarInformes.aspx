<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ConsultarInformes.aspx.vb" Inherits="SisSolicitudes_ConsultarInformes" %>
                            ...
                            <tr>
                                <td align="right">
                                    <div id="DivAnulada" align="center" 
                                        style="position: absolute; width: 100%; height: 522px; top: 65px; left: 3px;">
                                        <br />
                                        <br />
                                        <br />
                                        <br />
                                    ...
                                    <asp:Label ID="LblNroSolicitud" runat="server" Text="Label"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <table width="100%" id="tblDE">
                                        <tr>
                                            <td colspan="2">
                                                <b>
                                                <asp:Label ID="lblNivel1" runat="server">Director de Escuela: </asp:Label>
                                    ...
                                    <asp:Label ID="LblFechaDE" runat="server"></asp:Label>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:TextBox ID="TxtObservacionDE" runat="server" ReadOnly="True" Rows="15"
                                ...
                                <td>
                                    <table width="100%"  id="tblDA">
                                        <tr>
                                            <td colspan="2">
                                                <b>
                                                <asp:Label ID="lblNivel2" runat="server">Director Académico: </asp:Label>
                                    ...
                                    <asp:Label ID="LblFechaDA" runat="server"></asp:Label>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:TextBox ID="TxtObservacionDA" runat="server" ReadOnly="True" Rows="2" 
                                                    TextMode="MultiLine" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:Label ID="LblFechaAG" runat="server"></asp:Label>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:TextBox ID="TxtObservacionAG" runat="server" ReadOnly="True" Rows="5" 
                                                    TextMode="MultiLine" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
