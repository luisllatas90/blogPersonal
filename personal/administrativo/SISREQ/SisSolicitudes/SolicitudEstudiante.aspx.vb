...
Partial Class SisSolicitudes_Solicitud
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Me.TxtNumSolicitud.Text = ObtenerCorrelativoSolicitud()
        ...
        Select Case Me.RblAsunto.SelectedValue
            ...
            Case 6, 7, 13, 17 'Agregado de asignatura - Cambio de grupo horario 
                ...
                If RblAsunto.SelectedValue = 13 Then
                    ClsFunciones.LlenarListas(Me.CblSeleccionar, Obj.TraerDataTable("ConsultarPlanEstudio", "SO", Session("codigo_alu"), "CC"), "codigo_cur", "Descripcion", "codigo_Pes")
                Else
            ...
            Case 10 'Examen Extraordinario - clluen 21/08/11
                ...
                If RblAsunto.SelectedValue = 10 Then
                    ClsFunciones.LlenarListas(Me.CblSeleccionar, Obj.TraerDataTable("SOL_ConsultarCursosExamExtraordinario", "PE", Session("codigo_alu")), "codigo_cur", "Abreviatura")
                Else
                    ClsFunciones.LlenarListas(Me.CblSeleccionar, Obj.TraerDataTable("ConsultarPlanEstudio", "SO", Session("codigo_alu"), "NC"), "codigo_cur", "Descripcion")
                End If
                Me.HddTotalSel.Value = Me.CblSeleccionar.Items.Count
    ...
    Protected Sub CmdGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmdGuardar.Click
        ...
        Dim codigoCur As String = ""
        Dim errorm As String = ""
        Dim totalCursos As String = 0
        Dim c As Integer = 0
        Dim estado As Boolean = False
        Dim numeroSol As String = ""
        ...
        If Me.TxtNumSolicitud.Text <> "" Then
            ...
            If Me.RblAsunto.SelectedValue = 8 And Obj.TraerDataTable("SOL_ConsultarSolicitud_ExamExtraordinario", Session("codigo_alu"), 8).Rows.Count > 0 Then
            ...
            Else
                ...
                codigo_sol = Obj.Ejecutar("SOL_AgregarSolicitudCliente", "E", CInt(Session("codigo_alu")), Me.TxtFecha.Text, _
                                        numeroSol, Me.TxtObservaciones.Text, 1, "P", 1, Me.TxtResponsable.Text, _
                ...
                For i = 0 To Me.RblAsunto.Items.Count - 1
                    If Me.RblAsunto.Items(i).Selected = True Then
                        'Modificado el26/06/2014 X fcastillo para poder registrar los cursos solicitados por examen estraordinario
                        If Me.RblAsunto.SelectedValue = 10 Then
                            totalCursos = Me.CblSeleccionar.Items.Count
                            For c = 0 To totalCursos - 1
                                codigoCur = CrearCodigosCursos(c)
                                DescripcionAsunto = CrearDescripcionAsunto(c)
                                If DescripcionAsunto <> "" Then
                                    Obj.Ejecutar("SOL_AgregarCursosExamenExtraordinario", codigo_sol, Me.RblAsunto.Items(i).Value, DescripcionAsunto, CInt(codigoCur))
                                End If
                            Next
                        Else
    ...
    End Function
    Private Function CrearDescripcionAsunto(ByVal c As Integer) As String
        Dim Descripcion_asu As String = ""
        If Me.RblAsunto.SelectedValue = 10 Then
            If Me.CblSeleccionar.Items(c).Selected = True Then
                Descripcion_asu = Me.CblSeleccionar.Items(c).Text
            End If
        End If
        Return Descripcion_asu
    End Function
    Private Function CrearCodigosCursos(ByVal c As Integer) As String
        Dim Descripcion_asu As String = ""
        If Me.RblAsunto.SelectedValue = 10 Then
            If Me.CblSeleccionar.Items(c).Selected = True Then
                Descripcion_asu = Me.CblSeleccionar.Items(c).Value.ToString
            End If
        End If
        Return Descripcion_asu
    End Function
    ...
    Private Function ObtenerCorrelativoSolicitud() As String
        '**********************************************'
        '***      Creado 20/06/2014 - Fcastillo     ***'
        '*** Recupera número de la última solicitud ***' 
        '**********************************************'
        ...
        datos = Obj.TraerDataTable("SOL_ObtenerCorrelativoSolicitudes")
        numeroCorrelativo = datos.Rows(0).Item(0).ToString
