...
<head id="Head1">
	...
	<script type="text/javascript" language="javascript">		
	    ...
	    function fnEnCaso() {
	        if (document.getElementById('checkEnCaso').checked) {
	            document.getElementById('txtNombresApoderado').removeAttribute("disabled");
	            document.getElementById('txtdireccionApoderado').removeAttribute("disabled");
	            document.getElementById('txturbanizacionApoderado').removeAttribute("disabled");
	            document.getElementById('txttelefonoApoderado').removeAttribute("disabled");
	            document.getElementById('txttelefonooficinaApoderado').removeAttribute("disabled");
	            document.getElementById('txtcelularApoderado').removeAttribute("disabled");
	            document.getElementById('dpOperadorApoderado').removeAttribute("disabled");
	            document.getElementById('txtemailApoderado').removeAttribute("disabled");
	            document.getElementById('txtObservaciones').removeAttribute("disabled");
	                        
	        } else {
	        document.getElementById('txtNombresApoderado').setAttribute("disabled", "disabled");
	        document.getElementById('txtdireccionApoderado').setAttribute("disabled", "disabled");
	        document.getElementById('txturbanizacionApoderado').setAttribute("disabled", "disabled");
	        document.getElementById('txttelefonoApoderado').setAttribute("disabled", "disabled");
	        document.getElementById('txttelefonooficinaApoderado').setAttribute("disabled", "disabled");
	        document.getElementById('txtcelularApoderado').setAttribute("disabled", "disabled");
	        document.getElementById('dpOperadorApoderado').setAttribute("disabled", "disabled");
	        document.getElementById('txtemailApoderado').setAttribute("disabled", "disabled");
	        document.getElementById('txtObservaciones').setAttribute("disabled", "disabled");
		...
		<form id="demoForm" method="post" action="" class="bbq" runat="server" accept-charset="utf-8">			
			...
			<div id="fieldWrapper">			
				<span class="step" id="first">					
					...
					<label for="surname">Fecha Nac. (dd/mm/aaaa) </label>	                    
				...
				<span id="finland" class="step">					
					...
					<asp:UpdatePanel ID="UpdatePanelmodalidad" runat="server" >
					<ContentTemplate>
					
					<label for="firstname">Ciclo de Ingreso</label>
						&nbsp;&nbsp;<asp:DropDownList ID="dpCicloIng_alu" AutoPostBack="True" runat="server" >
						</asp:DropDownList><br />
						<label for="surname">Escuela Profesional</label>
						&nbsp;&nbsp;<asp:DropDownList ID="dpCodigo_cpf" runat="server" AutoPostBack="true" SkinID="ComboObligatorio" >
						</asp:DropDownList><br/> 
						...
						&nbsp;&nbsp;<asp:DropDownList ID="dpModalidad" AutoPostBack="True" runat="server" ></asp:DropDownList><br />                            
						<%--Comentado para el wizard mvillavicencio
						<asp:CompareValidator 
						...
						<Triggers>
							<asp:AsyncPostBackTrigger ControlID="dpCicloIng_alu" 
							 EventName="SelectedIndexChanged" />
						</Triggers>	
						</asp:UpdatePanel>
				...
				<span id="x" class="step">
					...
					&nbsp;<asp:TextBox ID="txtdireccioncolegio" runat="server" Width="60%" disabled = "True"
						 class="input_field_12em  AutoPostBack="True" Visible="false">
						 </asp:TextBox><br />                    					
                    <label>Departamento</label>    												
                    ...
                    <asp:ImageButton ID="imgActualizarColegio" runat="server" 
                                ...
                                Visible="False" />
                                <asp:ImageButton ID="imgActualizarColegioCategoria" runat="server" 
                                ImageUrl="../../images/menus/nota.gif" 
                                ToolTip="Actualizar categorias de colegios" ValidationGroup="Colegio" 
                                Visible="true" />(Click para actualizar el c&aacute;lculo por categor&iacute;as)
					...
					<asp:TextBox ID="txtColegio" runat="server" Width="139px"
                        ...
                        <asp:HiddenField ID="txtcc" runat="server" Value="0" />
					</ContentTemplate>
					...
					<br />
					<asp:UpdatePanel 
                    ID="UpdatePanel62" runat="server">
                    <ContentTemplate>
                        <b><span id="Span1" class="step">
                        <label>Categoria Por Colegio y Escuela Profesional</label><br />
                         <asp:Label ID="lblCategoria" runat="server" 
                                ForeColor="red" Text="Colegio sin categoria" Visible="False"></asp:Label><br />
                        <asp:GridView ID="lstCat" runat="server" Width="100%"
                    AutoGenerateColumns="False" >
                            <Columns>
                                ...
                                <asp:BoundField DataField="preciocredito" HeaderText="Costo Credito" >
                                    <HeaderStyle BackColor="#0099FF" Font-Bold="True" ForeColor="White" />
                                    <ItemStyle BackColor="White" />
                                </asp:BoundField>
					...
					<asp:UpdatePanel ID="UpdatePanel100" runat="server">
						<ContentTemplate>				   --%>
						   <asp:TextBox ID="txtNombresPadre" runat="server" MaxLength="80" 
							...
							<label for="surname" style="width:55px">Zona</label> 					 
				...
				<span id="confirmation" class="step submit_step">
					<span class="font_normal_07em_black">Último paso - Datos del Responsable de Pago</span><br />									
					<!--<label>Marcar</label><input type="checkbox" id="checkEnCaso" name="checkEnCaso" onclick="fnEnCaso();"/>Registrar en caso el responsable de pago sea distinto al Padre<br /><br />-->
                   <label for="surname">Nombres</label>	
					<%--*buscar
            ...
            $("#demoForm").formwizard({
                ...
                formOptions: {
                    ...
                    beforeSubmit: function(data) {
                        ...
                        $("#data").html("data sent 2 the server: " + $.param(data));
                    },
                    dataType: 'html',
                    resetForm: true,
            ...
            $("#demoForm .step").each(function() { // for each step in the wizard, add an option to the remoteAjax object...
                remoteAjax[$(this).attr("id")] = {
                    ...
                    success: function(data) {
                        //alert("PASO ADELANTE " + $('#hdPaso').val() )
                        if (data > 0) { //data is either true or false (returned from store_in_database.html) simulating successful / failing store								                            						
                            ...
                            if (paso == 1) //En el 1er paso se graba a la persona
                            {
                                ...
                                $("#hdcodigo_pso").val(data);
                                $("#lnkComprobarNombres").css("display", "none");
                            }
                            ...
                            if (data == 0) {
                                if ($('#<%= dpmodalidad.ClientID %>').val() == -1) {
                                    alert("Seleccione Modalidad Para Poder Continuar.");
                                    $('#lblmensaje').val('Seleccione Modalidad Para Poder Continuar.');
                                }
                                else {
