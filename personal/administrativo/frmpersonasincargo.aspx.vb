Partial Class frmpersonasincargo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            ...
            cli.Value = Request.QueryString("cli") 'andy.diaz 19/06/2019
            ...
            If tbl.Rows.Count > 0 Then
                ...
                ' Response.Write("GESTION: " & tbl.Rows(0).Item("gestionanotas_dev"))
                If tbl.Rows(0).Item("gestionanotas_dev") Then
                    'Response.Write("PES: " & tbl.Rows(0).Item("codigo_pes"))
    ...
    Private Sub BuscarPersona(ByVal tipo As String, ByVal valor As String, Optional ByVal mostrardni As Boolean = False)
        ...
        Try
            ...
            If tbl.Rows.Count > 0 Then
                ...
                If Not String.IsNullOrEmpty(cli.Value) Then
        ...
        Try
            ...
            If ValidarNroIdentidad() = True Then
                ...
                If Request.QueryString("accion") = "A" Then
                    ...
                    Response.Redirect("pec/lstinscritoseventocargo.aspx?ctf=" & Request.QueryString("ctf") & "&mod=" & Request.QueryString("mod") & "&id=" & Request.QueryString("id") & "&cco=" & cco & "&tcl=" & tcl & "&cli=" & cli & "&pso=" & codigo_psoNuevo(0))
                End If
