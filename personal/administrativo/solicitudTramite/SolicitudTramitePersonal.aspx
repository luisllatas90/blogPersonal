<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SolicitudTramitePersonal.aspx.vb"
    Inherits="_SolicitudTramitePersonal" %>
            ...
            <div class="page_header">
                <div class="pull-left">
                    <i class="icon ti-bookmark-alt page_header_icon"></i><span class="main-text">
                        <asp:Label ID="nombre_titulo" runat="server" Text="Vista de la"></asp:Label>
                        Solicitud de
                    ...
                    <div id="divFormulario" runat="server">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label ">
                                    Colaborador :</label>
                                <asp:Label ID="lblColaborador" runat="server" Font-Bold="True" class="col-md-10 control-label"></asp:Label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <asp:TextBox ID="txtMotivo" runat="server" AutoPostBack="True" CssClass="form-control"
                                        MaxLength="1000" Enabled="false" Rows="3" TextMode="MultiLine"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <asp:TextBox ID="txtObservacion" runat="server" AutoPostBack="True" MaxLength="1000"
                                        CssClass="form-control" Enabled="false" Rows="2" TextMode="MultiLine"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row">
