<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AprobacionSolicitudTramitePersonal.aspx.vb"
    Inherits="_AprobacionSolicitudTramitePersonal" %>
            ...
            <div class="page_header">
                <div class="pull-left">
                    <i class="icon ti-bookmark-alt page_header_icon"></i><span class="main-text">
                        <asp:Label ID="nombre_titulo" runat="server"></asp:Label>
                        Solicitud de
                        <asp:Label ID="lblTipo_Solic" runat="server"></asp:Label>
                        N°
                        <asp:Label ID="lblNumero_Tramite" runat="server"></asp:Label></span>
                    <p class="text">
                        Solicitud de
            ...
            <div class="panel panel-piluku" id="PanelLista">
                ...
                <div class="panel-body">
                    <div id="divFormulario" runat="server">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <asp:TextBox ID="txtInstitucion" runat="server" AutoPostBack="true" CssClass="form-control"
                                        MaxLength="600" Enabled ="false"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="divTipoPermiso" runat="server">
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label id="lblTipoPerm" runat="server" class="control-label" style="margin-left">
                                        Tipo de Permiso :</label>
                                </div>
                                <div class="col-md-9">
                                    <asp:DropDownList ID="ddlTipoPermiso" runat="server" AutoPostBack="True" CssClass="form-control">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                ...
                                <%--<div class="col-md-1">
                                    <asp:Image ID="Image1" src="../img/calender.png" runat="server" />&nbsp;
                                </div>--%>
                                <asp:Label class="col-md-2 control-label" ID="lblHoraInicio" runat="server" Text="Salida Real :">
                                </asp:Label>
                                <div class="col-md-2">
                                    <asp:DropDownList ID="ddlHoraInicio" runat="server" AutoPostBack="true" CssClass="form-control">
                                    </asp:DropDownList>
                                    <asp:TextBox ID="txtHInicio" runat="server" AutoPostBack="True" CssClass="form-control"></asp:TextBox>
                                </div>
                                <asp:Label class="col-md-2 control-label" ID="lblHoraInicioSol" runat="server" Text="Hora Inicio Solicitada:">
                                </asp:Label>
                                <div class="col-md-2">
                                    <asp:DropDownList ID="ddlHoraInicioSol" runat="server" AutoPostBack="true" CssClass="form-control"
                                        Enabled="false">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <%--<div class="col-md-1">
                                    <asp:Image ID="Image2" src="../img/calender.png" runat="server" />&nbsp;
                                </div>--%>
                                <asp:Label class="col-md-2 control-label" ID="lblHoraFin" runat="server" Text="Retorno Real :">
                                </asp:Label>
                                <div class="col-md-2">
                                    <asp:DropDownList ID="ddlHoraFin" runat="server" AutoPostBack="true" CssClass="form-control">
                                    </asp:DropDownList>
                                    <asp:TextBox ID="txtHFin" runat="server" AutoPostBack="True" CssClass="form-control"></asp:TextBox>
                                </div>
                                <asp:Label class="col-md-2 control-label" ID="lblHoraFinSol" runat="server" Text="Hora Final Solicitada:">
                                </asp:Label>
                                <div class="col-md-2">
                                    <asp:DropDownList ID="ddlHoraFinSol" runat="server" AutoPostBack="true" CssClass="form-control"
                                        Enabled="false">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <asp:Label ID="lblHoras" runat="server" class="col-md-4 control-label" Text="Tiempo Real Usado:"
                                        Style="color: #CC0000">
                                    </asp:Label>
                                    <asp:Label ID="lblTotalHoras" runat="server" class="col-md-3 control-label" Style="color: #1313CC;
                                        text-align: left" Font-Bold="True" Text="--">
                                    </asp:Label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="divMotivo" runat="server">
                            <div class="form-group">
                                <label id="lblMotivo" class="col-md-2 control-label" runat="server">
                                    Motivo Colaborador :</label>
                                <div class="col-md-10">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-2 control-label">
                                    Goce de Haber :</label>
                                <div class="col-md-1">
                                    <asp:Label ID="lblConGoce" runat="server" class="control-label"></asp:Label>
                                </div>
                                <div class="col-md-1">
                                    <asp:CheckBox ID="chkConGoce" runat="server" AutoPostBack="True"></asp:CheckBox>
                                </div>
                            </div>
                        </div>
                        <div class="row ">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <asp:GridView ID="gvCarga" runat="server" AutoGenerateColumns="False" DataKeyNames="codigo_ast,ID,token"
                                    ...
                                    <PagerStyle BackColor="#284775" ForeColor="White" Font-Size="small" HorizontalAlign="Center" />
                            ...
                            <div class="form-group">
                                <center>
                                    <asp:Button ID="btnGuardar" runat="server" Text="Guardar" CssClass="btn btn-success"
                                        ToolTip="*Guarda la observación de Vacaciones." />
                    ...
                    <div id="divConfirmaAprobar" runat="server">
                        <label style="font-weight: bold">
                            ¿ESTÁ SEGURO QUE DESEA APROBAR LA SOLICITUD DE TRÁMITE Y REGISTRAR EL PERMISO?
                        </label>
