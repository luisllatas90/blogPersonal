<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SolicitudesTramitePersonalDirector.aspx.vb"
    Inherits="_SolicitudesTramitePersonalDirector" %>
    ...
    <div class="wrapper">
        <div class="content">
            ...
            <div class="page_header">
                <div class="pull-left">
                    <i class="icon ion-ios-list-outline  page_header_icon"></i><span class="main-text">
                    Lista de Solicitudes de Licencias, Permisos por Horas y Vacaciones - Responsable de Área</span>
                    <p class="text">
                        Consulta de
            ...
            <div class="panel panel-piluku" id="PanelLista">
                ...
                <div class="panel-body">
                    <div id="divListado" runat="server">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <asp:GridView ID="gvCarga" runat="server" AutoGenerateColumns="False" DataKeyNames="codigo_ST, Estado, codigo_EST,Tipo_Solicitud"
