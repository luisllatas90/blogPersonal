<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Copia de frmpersonaepre.aspx.vb" Inherits="frmpersonaepre" Theme="Acero" %>
    ...
    <table style="width: 100%">
                    ...
                    <tr>
                        <td style="width:20%">
                            Ciclo de Ingreso</td>
                        <td>
                            <asp:DropDownList ID="dpCicloIng_alu" runat="server" SkinID="ComboObligatorio">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="dpCodigo_cpf" runat="server" SkinID="ComboObligatorio">
                            </asp:DropDownList>
                    ...
                    <tr>
                        <td style="width:20%">
                            Categoría</td>
                        <td>
                            <asp:DropDownList ID="dpCategorias" runat="server" SkinID="ComboObligatorio">
                            </asp:DropDownList>
                            <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                ControlToValidate="dpCategorias" ErrorMessage="Seleccione la Categoría" 
                                Operator="NotEqual" ValueToCompare="-1">*</asp:CompareValidator>
                        </td>
                    </tr>
