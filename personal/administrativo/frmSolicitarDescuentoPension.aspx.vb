Partial Class SolicitarDescuentoPension
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
                ...
                obj.AbrirConexion()
                'dt = obj.TraerDataTable("ConsultarCicloAcademico", "CV", 1)
                dt = obj.TraerDataTable("ACAD_RetornaCicloVigenteTipoEstudio", Request.QueryString("mod"))
                obj.CerrarConexion()

                _codigoCac.Text = dt.Rows(0).Item("codigo_Cac").ToString
                'Response.Write(_codigoCac.Text)
    ...
    Private Sub CargarRegistros()
        Try
            ...
            obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
            obj.AbrirConexion()
            tb = obj.TraerDataTable("PEN_descuentoPensionListar", 0, Request.QueryString("mod"), CInt(_codigoCac.Text))
            If tb.Rows.Count > 0 Then
    ...
    Private Sub BuscarAlumno()
        Try
            ...
            'Else
            dt = obj.TraerDataTable("[PEN_BuscarAlumnosSolDsctov2]", ddlTipo.SelectedValue, txtBuscarAlumno.Text.Trim, CInt(Request.QueryString("mod")), CInt(_codigoCac.Text))
            'End If
    ...
    Protected Sub btnEnviar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEnviar.Click
        Try
            ...
            If HiddenField.Value <> "" Then
                ...
                DatosAlumno()
            Else
                lblMensajeCalculo.Text = "*Seleccione el estudiante para calcular descuento"
            End If
        Catch ex As Exception
            Response.Write(ex.Message)
        End Try
    ...
    Private Sub DatosPension()
        ...
        If Request.QueryString("mod") = 2 Then
            tb = obj.TraerDataTable("PEN_CalculaAdelantoPensionV2", Me.HiddenField.Value, CInt(_codigoCac.Text))
        Else
            tb = obj.TraerDataTable("PEN_CalculaAdelantoPensionV3", Me.HiddenField.Value, CInt(_codigoCac.Text))
        End If
        obj.CerrarConexion()
            ...
            For i = 0 To n
                ...
                With gvPensiones.Rows(i)
                    If CDbl(.Cells(5).Text) > 0 Then
                        ...
                        resul = obj.Ejecutar("PEN_GenerarDeudaPensionDescuento", Me.HiddenField.Value, .Cells(0).Text, .Cells(1).Text, CDbl(.Cells(5).Text), .Cells(3).Text, CInt(Request.QueryString("id")), CInt(_codigoCac.Text))
    ...
    Protected Sub btnSi_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSi.Click
        Try
            ...
            tb = obj.TraerDataTable("PEN_descuentoPension_V2", Me.HiddenField.Value, _codigoCac.Text)
            obj.CerrarConexion()
