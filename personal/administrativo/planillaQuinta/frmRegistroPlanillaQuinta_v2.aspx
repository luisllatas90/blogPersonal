<%@ Page EnableEventValidation="false" Language="VB" AutoEventWireup="false" CodeFile="frmRegistroPlanillaQuinta_v2.aspx.vb" Inherits="planillaQuinta_frmRegistroPlanillaQuinta_v2" %>
                                ...
                                <tr>
                                    <td colspan="2" style="margin-left: 80px">
                                        <table class="contornotabla" style="width:100%;">
                                            ...
                                            <tr>
                                                <td align="justify" colspan="3" bgcolor="#FFFFEA" 
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <asp:GridView ID="gvDetalleQuinta" runat="server" AutoGenerateColumns="False" 
                                                        ...
                                                        DataSourceID="SqlDataSource1" ShowFooter="True" Width="100%">
                                                        <Columns>
