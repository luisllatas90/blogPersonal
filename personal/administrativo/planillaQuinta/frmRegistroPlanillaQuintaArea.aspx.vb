...
Partial Class planillaQuinta_frmRegistroPlanillaQuintaArea
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            datos = objPlla.ConsultarFuncionQuinta(Request.QueryString("id"))
            ...
            datos = objPlla.ConsultarPersonalDelArea(Request.QueryString("id"))
            objfun.CargarListas(cboPersonal, datos, "codigo_Per", "Personal", ">> Seleccione <<")
            ...
            If Request.QueryString("ctf") = 1 Or Request.QueryString("ctf") = 85 Or Request.QueryString("ctf") = 181 Then ' Administrador o responsable de registro (coordinador administrativo)
    ...
    Protected Sub cmdGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdGuardar.Click
        ...
        Try
            ...
            rpta = objPlla.AgregarAnexoDetallePlanillaEjecutado(Me.hddCodigo_Adplla.Value, 1, Me.cboPlanilla.SelectedValue, cboPeriodoPresu.SelectedValue, cboPersonal.SelectedValue, cboCecos.SelectedValue, Me.txtImporte.Text, 19, 28, Me.cboFuncion.SelectedValue, Me.txtObservacion.Text, Request.QueryString("id"), "B", codigo_Dplla)
            If rpta = -1 Then
    ...
    Protected Sub gvDetalleQuinta_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvDetalleQuinta.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Else
                If Request.QueryString("id") = gvDetalleQuinta.DataKeys.Item(e.Row.RowIndex).Values(6) Then
                    If fila.Item("Estado").ToString.Trim = "Borrador" Then
                        e.Row.Cells(13).Visible = True
                        e.Row.Cells(14).Visible = True
                    End If
    ...
    Protected Sub cmdEnviar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdEnviar.Click
        ...
        If Me.gvDetalleQuinta.Rows.Count > 0 And cboCecos.SelectedValue > 0 And cboPlanilla.SelectedValue > 0 Then
            Rpta = ObjPlla.EnviarDetallePlanillaQuintaARevisor(Me.cboPlanilla.SelectedValue, Me.cboCecos.SelectedValue, Request.QueryString("ctf"))
    ...
    'Protected Sub lnkOcultar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkOcultar.Click
    '    pnlHistorico.Width = 50
    '    'ClientScript.RegisterStartupScript(Me.GetType, "Ocultar", "tdHistorico.style.width='10%';", True)
    'End Sub

    'Protected Sub lnkMostrar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMostrar.Click
    '    pnlHistorico.Width = 10
    '    'ClientScript.RegisterStartupScript(Me.GetType, "Mostrar", "tdHistorico.style.visibility='hidden';", True)
    '    'Page.RegisterStartupScript("Habilitar3", "<script>tdHistorico.style.width='10%;</script>")
    'End Sub
End Class
