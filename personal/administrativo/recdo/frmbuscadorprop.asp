...
<table style="width: 100%;<%=alto%>">
	<tr>
		...
		<td style="height: 10%; width: 80%;">
        <input type="text" class="Cajas2" value="<%=criterio%>" name="txtcriterio" onkeyup="if(event.keyCode==13){BuscarDatos(this.value)}" maxlength="50" size="20"></td>
