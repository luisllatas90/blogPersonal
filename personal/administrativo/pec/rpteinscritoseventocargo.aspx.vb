...
Partial Class rpteinscritoseventocargo
    ...
    Protected Sub grwListaPersonas_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grwListaPersonas.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim columnas As Integer = grwListaPersonas.Columns.Count

            Select Case Request.QueryString("mod")
                Case "5"
                    grwListaPersonas.Columns(columnas - 1).Visible = True
                    grwListaPersonas.Columns(columnas - 2).Visible = True
                    grwListaPersonas.Columns(columnas - 3).Visible = True
            End Select
        End If
    End Sub
    ...
    Protected Sub cmdExportar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdExportar.Click
        If Me.grwListaPersonas.Rows.Count > 0 Then
