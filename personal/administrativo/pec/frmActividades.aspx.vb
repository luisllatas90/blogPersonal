...
Partial Class administrativo_pec2_frmActividades
    ...
    Protected Sub cmdAceptar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdAceptar.Click
        ...
        Try
            ...
            obj.Ejecutar("EVE_AgregaActividades", Me.txtTitulo.Text, Me.txtContenido.Text, _
                         Me.txtRuta.Text, Me.cboActividad.SelectedValue, Me.txtMaxInscripciones.Text) 'fatima.vasquez 15-08-2018: Se agregó MaxInscripciones
            obj.CerrarConexion()
            LimpiarControles()
    ...
    Private Sub LimpiarControles()
        ...
        Me.txtRuta.Text = ""
        Me.txtTitulo.Text = ""
        Me.txtMaxInscripciones.Text = "" 'fatima.vasquez 15-08-2018
    End Sub
