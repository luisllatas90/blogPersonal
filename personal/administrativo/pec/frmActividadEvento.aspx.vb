Partial Class administrativo_pec2_frmActividadEvento
    ...
    Protected Sub cmdRptAsistencia_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdRptAsistencia.Click
        Response.Redirect(rutareporte + "PRIVADOS/EVENTOS/LOG_RptAsistenciaEvento&mod=" & Request.QueryString("mod") & "&ctf=" & Request.QueryString("ctf") & "&id=" & Request.QueryString("id") & "&codigo_cco=" & Me.Hdcodigo_cco.Value)
    ...
    Protected Sub gvActividadEvento_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvActividadEvento.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Cells(7).Text = "<a target='_blank' href='//intranet.usat.edu.pe/rptusat/?/PRIVADOS/EVENTOS/EVE_RptInscritoActividadEvento&codigo_aev=" & fila.Row("codigo_aev") & "'>Ver</a>"
        End If
    End Sub
