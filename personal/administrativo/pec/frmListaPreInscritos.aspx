...
<body>
    <form id="form1" runat="server">
        ...
        <Columns>            
            ...
            <asp:BoundField DataField="codigo_pins" HeaderText="codigo_pins" 
                Visible="False" />
            ...
            <asp:CommandField HeaderText="Eliminar" ShowDeleteButton="True" 
                ButtonType="Image" DeleteImageUrl="../../../images/eliminar.gif">
                <ItemStyle HorizontalAlign="Center" Width="10%" />
            </asp:CommandField>
            <asp:BoundField DataField="codigo_pso" HeaderText="codigo_pso" 
                Visible="False" />
            <asp:CommandField ShowSelectButton="True" HeaderText="Ver" ButtonType="Image" 
                SelectImageUrl="../../../images/readebook.gif" >
                <ItemStyle HorizontalAlign="Center" Width="10%" />
            </asp:CommandField>
        </Columns>
