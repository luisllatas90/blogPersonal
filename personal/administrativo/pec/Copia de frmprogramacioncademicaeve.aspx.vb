...
Partial Class frmprogramacioncademicaeve
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            '  Cargarhorario()
        End If
        If Not (Request.QueryString("mod") = 3 Or Request.QueryString("mod") = 5) Then
            Me.cmdGuardarAmbiente.Visible = False
        End If
    ...
    Sub Cargarhorario()
        ...
        Me.gridHorario.DataSource = obj.TraerDataTable("HorarioPE_ConsultarSolxCup", Me.hdcodigo_cup.Value)
        Me.gridHorario.DataBind()
        Me.cmdGuardarAmbiente.Enabled = gridHorario.Rows.Count
        Me.cmdSolicitarAmbiente.Enabled = gridHorario.Rows.Count
        obj.CerrarConexion()
        'Me.cmdVer0.Enabled = gridHorario.Rows.Count
    End Sub
    ...
    Protected Sub gridHorario_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gridHorario.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If gridHorario.DataKeys(e.Row.RowIndex).Values("codigo_lho").ToString <> 0 Then
                ...
                obj.CerrarConexion()
                '  Response.Write(gridHorario.DataKeys(e.Row.RowIndex).Values("codigo_lho") & "," & dpCodigo_pes.SelectedValue & "," & dpCodigo_cac.SelectedValue & "," & tipo)

                If tb.Rows.Count Then
                    For i As Integer = 0 To tb.Rows.Count - 1
                        ddlAmb.Items.Add(New ListItem(tb.Rows(i).Item("ambiente"), tb.Rows(i).Item("codigo_amb")))
                        ' If tb.Rows(i).Item("tipo") = "S" Then
                        'ddlAmb.SelectedValue = gridHorario.DataKeys(e.Row.RowIndex).Values("codigo_amb")
                        ' End If
                        ' If tb.Rows(i).Item("tipo") = "A" Then
                        ' End If
                    Next

                    If gridHorario.DataKeys(e.Row.RowIndex).Values("codigo_amb") = 0 And gridHorario.DataKeys(e.Row.RowIndex).Values("codigo_daa") = 0 Then
                        ddlAmb.Items.Add(New ListItem("--Seleccionar--", -1))
                        ddlAmb.SelectedValue = -1
                    Else
                        ddlAmb.SelectedValue = gridHorario.DataKeys(e.Row.RowIndex).Values("codigo_daa")
                    End If
                Else
                ...
                '    Next
                'Else
                '    ddlAmb.Items.Add(New ListItem("No se ha registrado ambiente", -1))
                'End If
    ...
    Protected Sub cmdGuardarAmbiente_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdGuardarAmbiente.Click
        ...
        If Me.gridHorario.Rows.Count Then
            If Request.QueryString("mod") = 3 Or Request.QueryString("mod") = 5 Then
                Dim Fila As GridViewRow
                ...
                For i As Integer = 0 To Me.gridHorario.Rows.Count - 1
                    ...
                    If CType(Fila.FindControl("ddlAmbiente"), DropDownList).SelectedValue <> "-1" Then
            ...
            Else
                Session("h_codigo_cup") = Me.hdcodigo_cup.Value
                Session("h_nombre_cur") = Me.lblnombre_cur.Text
            End If
        End If
    End Sub

    Protected Sub cmdVer0_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdVer0.Click
        Dim obj As New ClsConectarDatos
        obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
        obj.AbrirConexion()
        Me.gridHorario.DataSource = obj.TraerDataTable("HorarioPE_Consultar", Me.hdcodigo_cup.Value)
        ...
        Me.gridHorario.DataBind()
        obj = Nothing
        Me.lblMsjHorarioAmbiente.Text = Me.hdcodigo_cup.Value.ToString
    End Sub
    ...
    Protected Sub cmdSolicitarAmbiente_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdSolicitarAmbiente.Click
        Session("h_codigo_cup") = Me.hdcodigo_cup.Value
        Session("h_nombre_cur") = Me.lblnombre_cur.Text
        Session("h_mod") = Request.QueryString("mod")
        Session("h_id") = Request.QueryString("id")
        Session("h_ctf") = Request.QueryString("id")
        'Response.Redirect("http://server-test/campusvirtual/personal/administrativo/pec/frmSolicitarAmbiente.aspx")
        Me.RegisterStartupScript("llamar", "<script>solicitar();</script>")
    End Sub
    ...
    Protected Sub gridHorario_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gridHorario.RowCommand
        ...
        If (e.CommandName = "LimpiarAmbiente") Then
            ...
            obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
            obj.AbrirConexion()
            obj.Ejecutar("HorarioPE_LimpiarAmbiente", gridHorario.DataKeys(index).Values("codigo_lho"))
            Me.gridHorario.DataSource = obj.TraerDataTable("HorarioPE_Consultar", Me.hdcodigo_cup.Value)
            Me.gridHorario.DataBind()
            obj.CerrarConexion()
            obj = Nothing
