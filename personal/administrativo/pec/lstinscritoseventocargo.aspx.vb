...
Partial Class lstinscritoseventocargo
    ...
    Protected Sub grwListaPersonas_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grwListaPersonas.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Else
                ...
                e.Row.Cells(17).Text = "<a target='_blank' href='https://intranet.usat.edu.pe/rptusat/?/PRIVADOS/PENSIONES/PEN_ConvenioPago_v2&ctf=0&usuario=" & Me.HdID.Value & "&tcl=" & e.Row.Cells(18).Text & "&codigo=" & codigo_cli & "'>Ver</a>"
            End If
    ...
    Protected Sub cmdReporte_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdReporte.Click
        ...
        Response.Write("<script>window.open('rpteinscritoseventocargo.aspx?cco=" & Request.QueryString("cco") & "&estado=" & Me.ddlEstado.SelectedValue & "&mod=" & Request.QueryString("mod") & "', 'Reporte', 'menubar=yes,location=yes,resizable=yes,scrollbars=yes,status=yes,width=800,height=600')</script>")
