...
Partial Class frmListaAlumnosProfesionalizacion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            'Response.Write("<br />")
            'Response.Write("s_accion_set " + s_accion_set)
            ...
            If Not IsPostBack Then
                ...
                Select Case s_accion_set 's_accion 'Request.QueryString("Accion")
                    Case "L"
                        ...
                        lblTitulo.Text = "GENERAR PRE-MATRICULA A ESTUDIANTES - INVITACIÓN"
        ...
        Try
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                If s_accion = "L" Then  'sessiones s_accion
                    ...
                    If fila("cumpleRequisito") = 0 Then
                        e.Row.Cells(0).Text = ""
                        e.Row.Cells(16).Text = "No"
                    Else
                        e.Row.Cells(16).Text = "Si"
                    End If                   
                ...
                '============AGREGADO POR EDGARD: no mostrar check si tiene deudas === usuarios caprichosos xD

                If fila("cntDeudas") > 0 Then
                    e.Row.Cells(0).Text = ""
    ...
    Private Sub ListaAlumnos(ByVal Accion As String)
        Try
            ...
            If Accion <> "C" Then
                ...
                'Response.Write(lblGrupoHorario.Text.Trim.ToString & ", '', '', 0, 0, " & Accion & "," & s_codigo_cup & "," & s_cboCecos & "," & s_codigo_cac & "," & s_per)
