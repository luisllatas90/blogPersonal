...
&nbsp;<asp:Label ID="lblFechaIni" runat="server" ForeColor="#CC0000"></asp:Label>&nbsp;<asp:Label ID="lblIntervalo" runat="server" Font-Bold="False" ForeColor="#000099" 
            ...
            <td valign="top">
                ...
                &nbsp;</td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblNiv" runat="server" Text="Tipo de Curso" 
                                                    style="font-weight: 700"></asp:Label>
                                            </td>
                                            <td colspan="3">
                                            &nbsp;<asp:DropDownList ID="ddlModalidadCurso" runat="server" >
                                                    
                                                </asp:DropDownList>
                                                <asp:CheckBox ID="chkFaltanteDesap"  Enabled=false
                                                    ToolTip="Habilitar el Check para indicar que el curso es Desaprobado Faltante" 
                                                    runat="server" Visible="false"  AutoPostBack="True" Checked="False" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <b>Curso                        <b>Curso</b></td>
                                            <td colspan="3">
               ...
               <td>Asignación de Profesores Adscritos al Grupo Horario</td>               
               </tr>
...
&nbsp;<table ID="fraGruposProgramados" runat="server" cellpadding="3" 
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:ImageButton 
                                                                                    ...
                                                                                    Visible='<%# iif( Eval("nivelacion_cup") = "1" or Eval("nivelacion_cup")=1 , "True", "False") %>'
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:ImageButton 
                                                                                    ...
                                                                                    runat="server" 
                                                                                    ToolTip="Invitar al Curso" 
                                                                                    Visible='<%# iif( (Eval("faltanteDesap_cup") = "1" or Eval("tutorial_cup") = "1" or Eval("pendiente_cup") = "1")  , "True", "False") %>'
                                                                                    ImageUrl='<%# iif( (Eval("faltanteDesap_cup") = "1" or Eval("pendiente_cup") = "1"  )  , "../../../images/invitar.png" ,"../../../images/tutorial.png" )%>' 
                                                ...
                                                <asp:HiddenField ID="HdCronogramaApto" runat="server" />
                                            </td>
                                        </tr>
                                    </table>
