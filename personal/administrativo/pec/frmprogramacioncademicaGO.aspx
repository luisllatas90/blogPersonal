<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmprogramacioncademicaGO.aspx.vb" Inherits="frmprogramacioncademicaeve" %>
...
<body>
    <form id="form1" runat="server">
     <busyboxdotnet:BusyBox ID="BusyBox1" runat="server" ShowBusyBox="OnLeavingPage" Image="Clock" Text="Procesando su consulta" Title="Por favor espere" />
...
&nbsp;<asp:Label ID="lblFechaIni" runat="server" ForeColor="#CC0000"></asp:Label>&nbsp;<asp:Label ID="lblIntervalo" runat="server" Font-Bold="False" ForeColor="#000099" 
                    Text="al"></asp:Label>&nbsp;<asp:Label ID="LblFechaFin" runat="server" ForeColor="#CC0000"></asp:Label></td>
        </tr>
        </table>
            ...
            <td valign="top">
                                        ...
                                        <tr>
                                            <td class="style1">
                                                <asp:Label ID="lblgrupohor_cup" runat="server" EnableViewState="False" 
                                                    Text="Grupo" style="font-weight: 700"></asp:Label>
                                            </td>
                                            <td class="style1" colspan="3">
                                                <asp:TextBox ID="txtGrupoHor_cup" runat="server" CssClass="cajas"  Width="90%"
                                                    MaxLength="150" Visible="False">A</asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                &nbsp;<asp:RequiredFieldValidator ID="RqFechaFin" runat="server" 
                                                    ...
                                                    ErrorMessage="Debe especificar la fecha de término">*</asp:RequiredFieldValidator><asp:CompareValidator ID="CRqFechaFin" runat="server" 
                                                    ControlToCompare="txtFin" ControlToValidate="txtInicio" 
                                                    ErrorMessage="Fecha de Termino menor o igual a fecha de inicio." 
                                                    Operator="LessThan" Type="Date">*</asp:CompareValidator><asp:TextBox ID="txtRetiro" runat="server" BackColor="#CCCCCC" Font-Size="8pt" 
               ...
               <td>Sugerir Profesores al Grupo Horario</td>               
               </tr>
        ...
        <asp:CheckBox ID="CheckBox1" runat="server" Text="Incluir Finalizados" 
            AutoPostBack="True" />
                                                &nbsp;&nbsp;
                                                <asp:Label ID="lblLimite" runat="server" style="color: #FF6600" Text="Label" 
                                                    Visible="False"></asp:Label>
                                                &nbsp;&nbsp;<span class="style5" style="display:none;">(*)Excepto Solicitud de Auditorios </span>
                                                <br />
                                            </td>
                                        </tr>
                                        <tr>
        ...
        <table style="width: 95%;" border="0" cellpadding="0">
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:Label ID="lbldia" runat="server" Text="Día de Sesión: -" Visible="False"></asp:Label>
                </td>
            </tr>
            <tr>
            <td>Hora Inicio</td>
            <td>
                ...
                <td>
                    Nro. Ambientes</td>
                <td>
                    <asp:DropDownList ID="ddlNro" runat="server" Enabled="False">
            ...
            <asp:CheckBox ID="chkVarias" runat="server" Text="Crear varias sesiones" 
             ...
             <tr><td>Descripción del Evento</td><td colspan="3">
                <asp:TextBox ID="txtDescripcion" runat="server" MaxLength="500" TextMode="MultiLine" 
                    Width="415px" Height="77px"></asp:TextBox>
                 <br />
            ...
            <asp:Button ID="btnRegistrarPers" runat="server" Text="Registrar" CssClass="btn" />
                ...
                <asp:Button ID="btnCancelar" runat="server" CssClass="btn" Text="Cancelar" />
                 ...
                 <tr>
                     <td>
                         <asp:Label ID="lblCruce" runat="server" Text="Detalle del Cruce" 
                             Visible="False"></asp:Label>
                     </td>
                     <td colspan="3">
                     <div style="padding-top:10px"></div>
                         <asp:GridView ID="gvCruces" runat="server" CellPadding="3" ForeColor="#333333" 
                             GridLines="Both" Font-Size="X-Small" Visible="False">
...
&nbsp;<table ID="fraGruposProgramados" runat="server" cellpadding="3" 
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <asp:HiddenField ID="hdcodigo_cup_lho" runat="server" Value="0" />
                                            </td>
                                        </tr>
                                    </table>
