...
Partial Class aulavirtual_adminaula_rptEstadisticaUso
    ...
    Protected Sub btnConsultar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnConsultar.Click
        If Not Me.ddlCiclo.SelectedValue = -1 Then
            ...
            obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
            obj.AbrirConexion()
            dt = obj.TraerDataTable("PRE_ConsultarEstadoPostulacion", Me.ddlCiclo.SelectedItem.Text)
            obj.CerrarConexion()
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExportar.Click
        If Me.GridView1.Rows.Count Then
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=ConsultarEstadoPostulacion-" & Me.ddlCiclo.SelectedItem.Text & ".xls")
