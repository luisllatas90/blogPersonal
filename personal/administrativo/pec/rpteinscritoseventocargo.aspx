    ...
    <br />
       <asp:GridView ID="grwListaPersonas" runat="server"
        ...
        <Columns>
            ...
            <%-- Se pidió que se separa en apellidos y nombres / andy.diaz 15-05-2019 --%>
            <asp:BoundField HeaderText="Ape. Paterno" DataField="apellidoPaterno_Pso" />
            <asp:BoundField HeaderText="Ape. Materno" DataField="apellidoMaterno_Pso" />
            <asp:BoundField HeaderText="Nombres" DataField="nombres_Pso" />
            <%--<asp:BoundField HeaderText="Participante" DataField="participante" / andy.diaz 15-05-2019 />--%> 
            ...
            <asp:BoundField DataField="observacion_pins" HeaderText="Observacion Inscripción" />
            <asp:BoundField DataField="primeraObservacion_Deu" HeaderText="Observación Deuda" />
            <asp:BoundField DataField="centroTrabajo_Dal" HeaderText="Centro de Trabajo" Visible="false" />
            <asp:BoundField DataField="cargoActual_Dal" HeaderText="Cargo Trabajo" Visible="false" />
            <asp:BoundField DataField="edad" HeaderText="Edad" Visible="false" />
        </Columns>
