...
Partial Class administrativo_pec_lstinscripcion
    ...
    Private Sub ValidarSegunModulo(ByRef Resultado As String)
        ...
        Select Case Request.QueryString("mod")
            Case "1" 'Epre
                Resultado = "../frmpersonaepre_largo.aspx?mod=" & Request.QueryString("mod") & "&cco=" & Me.Request.QueryString("cco") & "&ctf=" & Request.QueryString("ctf") & "&id=" & Request.QueryString("id")
