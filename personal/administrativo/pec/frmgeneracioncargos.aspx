...
<head runat="server">
    <title>Generación de Cargos</title>
	  ...
	  function sumarcuotas() {
	   ...
	   $("#TabFormaPago_TabSInConvenio_TxtTotalPagarMuestra").val(parseFloat(precio) + parseFloat(recargo) - parseFloat(descuento));
	    ...
	    function totalfinanciar() {
	        ...
	        $("#TabFormaPago_TabConConvenio_txtCuotaUnica").val(totalpagar - inicial);	        
	    }

	    function fnImprimir2() {
	        // $("form#frmImprimir").submit();
	        document.getElementById('frmImprimir2').submit();
	    }
...
<body>
<form id='frmImprimir2' method="GET" action="../frmExportaFichaPostulacionGO.aspx" target="_blank">
       ...
       <%-- <input type='button' id="btnImprimir2" value='Submit form' onClick='fnImprimir2()' />--%>
    </form>​
      ...
      <tr>
        ...
        <td>
          ...
          <asp:Button ID="CmdBuscarAlumno" runat="server" Text=" . . . " 
            ...
            <%--andy.diaz 22/06/2020: Oculto el enlace "Imprimir Ficha de Datos--%>
            <asp:HyperLink ID="btnImprimir" runat="server" Visible="false"><font color="#E33439"><b><u>Imprimir Ficha de Datos</u></b></font></asp:HyperLink>
            ...
            <tr>
              <td>
                ...
                <asp:TextBox ID="TxtRecargo"  runat="server"  Width="70px" 
                  SkinID="CajaTextoObligatorio" Visible="False"></asp:TextBox>
                  &nbsp;
                  <asp:Label ID="lblDescuento" runat="server" Text="Descuento"></asp:Label>
                <asp:TextBox ID="TxtDescuento"  runat="server"  
                  Width="70px" SkinID="CajaTextoObligatorio" Visible="False"></asp:TextBox>
              &nbsp;<B>Total a Pagar</B>
      ...
      <tr>
        <td colspan="2">
          <ajaxToolkit:TabContainer  ID="TabFormaPago" runat="server" ActiveTabIndex="0" 
            ...
            <ajaxToolkit:TabPanel  runat="server"  HeaderText="SIN Convenio" ID="TabSInConvenio" visible="false"><HeaderTemplate>
                SIN Convenio 
...
<td valign="top">
    <table style="width:100%;">
      <tr>
        <td>
        <asp:CheckBox ID="chkUnaCuota" runat="server" Text="Una sola cuota" AutoPostBack="true"></asp:CheckBox>
        </td>
      </tr>
      <tr>
        <td dir="ltr" width="100">
        <asp:Label ID="lblCuotainicial" runat="server" Text="Cuota Inicial"></asp:Label>
          </td>
        <td>
          ...
          <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
            ...
            <asp:TextBox ID="txtCuotaUnica" runat="server" SkinID="CajaTextoObligatorio" 
            Width="75px" Visible=false></asp:TextBox>
            
             
          <asp:Label ID="lblFechaVctoInicial" runat="server" Text="&#160;Fecha Vcto Cuota Inicial&#160;"></asp:Label>
          <asp:TextBox ID="TxtFecVctoInicial" runat="server" 
      ...
      <tr runat="server" id="trsaldofinanciar">
        <td>
      ...
      <tr runat="server" id="trnrocuotas">
        <td>
          <asp:Label ID="lblNroCuotas" runat="server" Text="Nº de Cuotas"></asp:Label></td>
        <td>
      ...
      <tr runat="server" id="trmontocuota">
        <td>
          <asp:Label ID="lblMontoCuota" runat="server" Text="Monto de Cuota"></asp:Label></td>
        <td>
      ...
      <tr runat="server" id="trPeriodo">
        <td>
          <asp:Label ID="lblTipoPeriodo" runat="server" Text="Tipo de Período"></asp:Label></td>
        <td>
      ...
      <tr runat="server" id="trCalcularCuotas">
        <td>
          &#160;</td>
        <td>
    ...
    <td valign="top">
      ...
      <tr>
      <td colspan="2">Deudas Generadas en el Item seleccionado: <asp:Panel ID="Panel3" runat="server" Height="140px" ScrollBars="Vertical" 
          ...
          <asp:GridView ID="DgvDeudas" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
              ...
              <asp:BoundField DataField="codigo_Deu" HeaderText="Codigo Deu" Visible=false/>
            </Columns>
