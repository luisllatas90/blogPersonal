Partial Class personal_administrativo_pec2_frmEntregaMateriales
    ...
    Private Sub llenar_checkboxlist()
        Try
            If (Me.DropDownList4.SelectedIndex <> -1) Then
                ...
                obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
                obj.AbrirConexion()                
                tabla = obj.TraerDataTable("EVE_ConsultarMaterialesEvento", Me.DropDownList4.SelectedValue, Me.Calendar1.SelectedDate)
    ...
    Private Sub RegistrarSeleccionados()
        ...
        obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
        obj.AbrirConexion()
        TablaMaterialesEvento = obj.TraerDataTable("EVE_ConsultarMaterialesEvento", Me.DropDownList4.SelectedValue, Me.Calendar1.SelectedDate)
        Dim i As Integer
