    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If Request.QueryString("accion") = "M" Then
                ...
                'Response.Write(DatosEscuela.Rows(0).Item("vigencia_cpf"))
                If DatosEscuela.Rows(0).Item("vigencia_cpf") = True Then
    ...
    Protected Sub CmdGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmdGuardar.Click
        ...
        If Request.QueryString("accion") = "A" Then
            ...
            Catch ex As Exception
                Me.LblMensaje.Text = "Ocurrió un error al regitrar los datos: " & ex.Message
