...
&nbsp;<asp:Label ID="LblFechaFin" runat="server" ForeColor="#CC0000"></asp:Label>
            ...
            <td valign="top">
              ...
              <td valign="top">
               <table cellpadding="3" cellspacing="0" style="border: 1px solid #C2CFF1; width:100%"  id="fraDetalleAmbiente" runat="server" visible="false">
               ...
               <tr><td>
                ...
                <asp:Button ID="cmdVer0" runat="server" Text="Consultar" 
                    CssClass="buscar2" />
                
                                            &nbsp;&nbsp;
                                                <asp:Button ID="cmdRegistrarHorario" runat="server" Text="Registrar Horario" 
                                                    CssClass="horario2" Width="120px" />
                                            &nbsp;&nbsp;&nbsp; <asp:Button ID="cmdGuardarAmbiente" 
                       runat="server" Text="Asignar Ambiente" 
                                                    CssClass="guardar2" Width="120px" 
                       Visible="False" />
               &nbsp;<asp:Button ID="cmdSolicitarAmbiente" runat="server" Text=" Solicitar Ambiente" 
                                                    CssClass="modificar2" Width="120px" 
                       Visible="False" />
                   </td></tr>
               <tr>
               <td class="style3" valign="top"><br />
                   <asp:GridView ID="gridHorario" runat="server" AutoGenerateColumns="False"
                                                CaptionAlign="Top" DataKeyNames="codigo_lho,codigo_amb,codigo_Daa" 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Ambiente">
                                                         ...
                                                         <asp:CommandField ButtonType="Image" DeleteImageUrl="~/administrativo/pec/image/eH.png" 
                                                            ShowDeleteButton="True" HeaderText="Borrar Horario" DeleteText="Borrar Horario" >
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:CommandField>
                                                        
                                                        <asp:TemplateField HeaderText="Borrar Ambiente" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>                                                                                                                           
                                                                <asp:ImageButton ID="btnQuitarAmbiente" runat="server" CommandName="LimpiarAmbiente"  ImageUrl="~/administrativo/pec/image/eA.png" ToolTip="Borrar Ambiente"
                                                                CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>"                                                                
                                                                />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Solicitar Ambiente" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>                                                                                                                           
                                                                <asp:ImageButton ID="btnSolicitarAmbiente" runat="server" CommandName="SolicitarAmbiente"  ImageUrl="~/administrativo/pec/image/Asol.png" ToolTip="Solicitar Ambiente"
                                                                CommandArgument="<%# CType(Container,GridViewRow).RowIndex %>"                                                                
                                                                />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
