...
Set obj= Server.CreateObject("PryUSAT.clsAccesoDatos")
	obj.AbrirConexion
			...
			Set rsClientes=obj.Consultar("consultarPagosProgramasEspeciales","FO",codigo_sco,edicion,codigo_pes)		
...
<script type="text/javascript" language="javascript">
	function BuscarDeudas()
	{
		...
		pagina="../administrativo/controlpagos/vstdeudascobrarSistemas.asp?codigo_sco=" + txtcodigo_sco.value  + "&edicion=" + cboEdicion.value  + "&codigo_pes=" + txtcodigo_pes.value  
	...
	<tr>
		...
		<td colspan="5">
		    <select name="cboEdicion" id="cboEdicion" >
		           ...
		           <option value="1" <%=sel1%>> 1 Edicion</option>
		           <option value="2" <%=sel2%>> 2 Edicion</option>
		           <option value="3" <%=sel3%>> 3 Edicion</option>		           
		    </select>
		</td>
	</tr>
	<tr>
