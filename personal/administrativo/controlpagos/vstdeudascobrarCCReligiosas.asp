...
Set obj= Server.CreateObject("PryUSAT.clsAccesoDatos")
	obj.AbrirConexion
			...
			Set rsClientes=obj.Consultar("consultarPagosProgramasEspecialesReligiosas","FO",codigo_sco,edicion,codigo_pes)		
...
<script type="text/javascript" language="javascript">
	function BuscarDeudas()
	{
		...
		pagina="../administrativo/controlpagos/vstdeudascobrarCCReligiosas.asp?codigo_sco=" + txtcodigo_sco.value  + "&edicion=" + cboEdicion.value  + "&codigo_pes=" + txtcodigo_pes.value  
...
<table cellpadding="3" style="width: 100%" class="contornotabla">
	<tr>
		...
		<td class="etiqueta" width="15%">Programa</td>
		<td colspan="5">
		    <select name="cboEdicion" id="cboEdicion" >
		           <option value="0"><-- Seleccione --></option>
		           <option value="1" <%=sel1%>> Licenciatura en Filosofía y Teología - Moyobamba</option>
		           <option value="2" <%=sel2%>> Programa de formación Filosófica y Teológica - Ica</option>
		           <option value="3" <%=sel3%>> Psicopedagogía religiosa</option>		           
		           <option value="4" <%=sel4%>> Diplomado en ética aplicada a las profesiones</option>
		           <option value="5" <%=sel5%>> Segunda Especialidad en Didáctica de las CC.Religiosas</option>
		           <option value="6" <%=sel6%>> Complementación pedagógica para sacerdotes - Chota</option>
		           <option value="7" <%=sel7%>> Licenciatura en educación - Filosofía y Teología - Sacerdotes - Chiclayo</option>
		    </select>
		</td>
	</tr>
	<tr>
