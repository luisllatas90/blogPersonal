...
#Region "Métodos y Funciones del Formulario"
    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        ...
        If Not IsPostBack Then
            CargarEstadoInvestigacion()
            CargarInstanciasInvestigacion()
    ...
    Private Sub CargarInstanciasInvestigacion()
        Try
            Dim dts As New Data.DataTable
            Dim obj As New clsInvestigacion

            dts = obj.ListaInstanciasFiltro()
            ddlInstanciasInvestigacion.DataSource = dts
            ddlInstanciasInvestigacion.DataTextField = "nombre"
            ddlInstanciasInvestigacion.DataValueField = "id"
            ddlInstanciasInvestigacion.DataBind()
    ...
    Private Sub CargarVistaPanel()
        Try
            Dim dts As New Data.DataTable
            Dim obj As New clsInvestigacion
            Select Case Request.QueryString("ctf")
                Case 13 'Profesor
                    Me.pnlAlertaProfesor.Visible = True
                    dts = obj.VistaResumenPerfil(Request.QueryString("id"))
                    gvPanel.DataSource = dts
                    gvPanel.DataBind()
                Case Else
                    pnlAlertaCoordinadorRevisor.Visible = True
                    dts = obj.VistaResumenPerfilCoorRev(Request.QueryString("id"), Me.Request.QueryString("ctf"))
                    gvPanelCoorRev.DataSource = dts
                    gvPanelCoorRev.DataBind()
            End Select
    ...
    Private Sub InformacionPerfil()
        Try
            Select Case Request.QueryString("ctf")
                Case 1
                    Me.imgPerfil.ImageUrl = "../images/inv_administrador2.png"
                Case 13
                    Me.imgPerfil.ImageUrl = "../images/inv_profesor2.png"
                Case 64
                    Me.imgPerfil.ImageUrl = "../images/inv_director2.png"
                Case 131
                    Me.imgPerfil.ImageUrl = "../images/inv_revisor2.png"
                Case 132
                    Me.imgPerfil.ImageUrl = "../images/inv_coordinador2.png"
    ...
    Private Sub EstadoControlesSegunPerfil(ByVal ctf As Integer)
        Try
            ...
            Select Case ctf
                Case 1      'Administradores systema.
                    ...
                    lblEstadoRevisor.Text = "# Investigaciones: "
                    ddlInstanciasInvestigacion.Visible = False

                Case 64      'Administradores del módulo.
                    btnEnviar.Enabled = True
                    btnEnviar.Visible = True

                    '==>>> Solicitado x edelzo el 07.08.2013 no mostrar los botones de evaluación 
                    btnObservar.Visible = False 'True
                    btnRechazar.Visible = False 'True
                    btnConforme.Visible = False 'True
                    btnNuevo.Visible = False

                    lblEstadoRevisor.Visible = True
                    lblEstadoRevisor.Text = "# Investigaciones: "
                    btnEnviar.ToolTip = "Enviar Investigaciones a la siguiente instancia."
                ...
                Case 13     'Profesores - Autores
                    ...
                    lblEstadoRevisor.Visible = True
                    lblEstadoRevisor.Text = "# Investigaciones por Instancia: "
                    ddlInstanciasInvestigacion.Visible = True
    ...
    Protected Sub gvInvestigacion_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvInvestigacion.SelectedIndexChanged
        Try
            ...
            If Request.QueryString("ctf") = 13 Then
                ...
                '= Cuando la investigacion se encuentra el la instancia (4-> VICERRECTORADO DE INVESTIGACIÓN)
                If dt.Rows(0).Item("investigacion_instancia_id") >= 4 And dt.Rows(0).Item("estado") <> "Finalizado" Then
...
#Region "Métodos y Funciones de Usuario"
    ...
    Private Sub CargarInvestigaciones()
        ...
        Select Case Request.QueryString("ctf")
            Case 13
                'Para el perfil profesor:
                If ddlInstanciasInvestigacion.SelectedValue = 0 Then
                    gvInvestigacion.DataSource = objInv.ConsultaInvestigaciones(0, Request.QueryString("ctf").ToString, Request.QueryString("id").ToString, Me.txtBuscarInv.Text.Trim)
                    gvInvestigacion.DataBind()
                    Me.lblCantidad.Text = objInv.ConsultaInvestigaciones(0, Request.QueryString("ctf").ToString, Request.QueryString("id").ToString, Me.txtBuscarInv.Text.Trim).Rows.Count
                Else
                    Me.lblCantidad.Text = objInv.ConsultaInvestigacionesPorEstadoRevision(0, Request.QueryString("ctf").ToString, Request.QueryString("id").ToString, Me.ddlInstanciasInvestigacion.SelectedValue, Me.txtBuscarInv.Text.Trim).Rows.Count
                    gvInvestigacion.DataSource = objInv.ConsultaInvestigacionesPorEstadoRevision(0, Request.QueryString("ctf").ToString, Request.QueryString("id").ToString, Me.ddlInstanciasInvestigacion.SelectedValue, Me.txtBuscarInv.Text.Trim)
                    gvInvestigacion.DataBind()
                End If
            Case Else
                ...
                Else
                    ...
                    Me.lblCantidad.Text = objInv.ConsultaInvestigacionesPorEstadoRevision(0, Request.QueryString("ctf").ToString, Request.QueryString("id").ToString, Me.ddlEstadoRevisor.SelectedValue, Me.txtBuscarInv.Text.Trim).Rows.Count
                    gvInvestigacion.DataSource = objInv.ConsultaInvestigacionesPorEstadoRevision(0, Request.QueryString("ctf").ToString, Request.QueryString("id").ToString, Me.ddlEstadoRevisor.SelectedValue, Me.txtBuscarInv.Text.Trim)
                    gvInvestigacion.DataBind()
                End If
        End Select
    End Sub
...
#End Region
    ...
    Protected Sub hlEliminar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            Dim row As GridViewRow
            Dim hlEliminar As LinkButton
            Dim obj As New clsInvestigacion
            Dim dts As New Data.DataTable

            hlEliminar = sender
            row = hlEliminar.NamingContainer
            EjecucionEliminar(row.Cells.Item(0).Text, Me.Request.QueryString("id"))
        Catch ex As Exception
            Response.Write(ex.Message)
        End Try
    End Sub
    ...
    Protected Sub hlEnviar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            CargarInvestigaciones()
            CargarVistaPanel()  'add 07.08.2013
        Catch ex As Exception
            Response.Write(ex.Message)
        End Try
    End Sub

    'Agregado el 08.07.2013 xDguevara
    Private Sub EjecucionEliminar(ByVal id_investigacion As Integer, ByVal codigo_per As Integer)
        Try
            Dim exec As Integer = 0
            Dim obj As New clsInvestigacion

            obj.AbrirTransaccionCnx()
            exec = obj.EjecutaEliminacionInvestigacion(id_investigacion, codigo_per, 0)
            obj.CerrarTransaccionCnx()
            obj = Nothing

            If exec > 0 Then
                ClientScript.RegisterStartupScript(Me.GetType, "FaltanDatos", "alert('El registro de la Investigación ha sido eliminada correctamente.');", True)
                CargarInvestigaciones()
            Else
                ClientScript.RegisterStartupScript(Me.GetType, "FaltanDatos", "alert('No se pudo eliminar, favor de volver a intentar caso contrario comuniquese con Desarrollo de Sistemas - USAT.');", True)
            End If
        Catch ex As Exception
            Response.Write(ex.Message)
        End Try
    ...
    Private Sub EjecucionEnvios(ByVal id_investigacion As Integer, ByVal codigo_per As Integer)
        Try
            ...
            If exec > 0 Then
                'EnviarMensaje(id_investigacion, Request.QueryString("ctf"), "")        'xDsc
                CargarInvestigaciones()
                ClientScript.RegisterStartupScript(Me.GetType, "FaltanDatos", "alert('El envio se ha realizado de forma satisfactoria.X');", True)
            Else
    ...
    Protected Sub btnEnviar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEnviar.Click
        Try
            '==============================================================
            '     -->>  Cambio de Instancia segun el perfil  <<---
            '==============================================================

            ' 132 Perfil Coordinador de comité (Investigacion - Etica.)
            ...
            If Request.QueryString("ctf") = 64 Then
                ...
                If dtsResolucion.Rows.Count > 0 Then
                    If dtsResolucion.Rows(0).Item("rpt") = 0 Then
                        ClientScript.RegisterStartupScript(Me.GetType, "FaltanDatos", "alert('Necesita asignar el Nº de Resolución  para poder enviar el proyecto a la siguiente instancia');", True)
                        director = 0
                        Exit Sub
                    Else
                        director = 1    ''add 07.08.2013 xDguevara 
                    End If
                End If
            Else
                director = 1
            ...
            'Agregado para validar que exitan miembros en la instanacias superiores para que puedan revisar la investigacion
            dtsResolucion = obj.VerificarResolucionInvestigacion(hfCodInvestigacion.Value)
            If dtsResolucion.Rows(0).Item("miembros") = 0 Then
                ClientScript.RegisterStartupScript(Me.GetType, "FaltanDatos", "alert('No se puede enviar la investigación a la siguiente instanacia, debido a que no se han registros miembros revisores.');", True)
                director = 0
                Exit Sub
            Else
                director = 1
            ...
            If (Request.QueryString("ctf") = 132 Or Request.QueryString("ctf") = 131 Or (Request.QueryString("ctf") = 64) And director = 1) Then
                'xDguevara 07.08.2013
                'Verificando proceso:
                'Cuando entra en el validaCheckActivo ->> Envia al correo a los miembros de la siguiente instanacia. 
                ...
                Else
                    ClientScript.RegisterStartupScript(Me.GetType, "FaltanDatos", "alert('XX: Favor de marcar con un check el proyecto de investigación que desea enviar.');", True)
                End If
            Else
            ...
            '--------------------------------------------------------------
            CargarInvestigaciones()     'add 07.08.2013 xDguevara
            CargarVistaPanel()          'add 07.08.2013 xDguevara
            pnlDetalle.Visible = False
            '--------------------------------------------------------------
        Catch ex As Exception
            Response.Write(ex.Message)
    ...
    Private Function validaCheckActivo() As Boolean
        ...
        For i As Integer = 0 To Me.gvInvestigacion.Rows.Count - 1
            ...
            If (valor = True) Then
                ...
                obj = Nothing
                If exec = 1 Then
                    'EnviarMensaje(gvInvestigacion.Rows(i).Cells(0).Text, Request.QueryString("ctf"), "E")  'xDsc
                    sw = 1
                Else
                    sw = 0
                    Exit For
    ...
    Private Function validaCheckCalifica() As Boolean
        Try
            ...
            If Contador = 1 Then
                sw = 1
                'Hago otro recorrido para identificar la posicion del registro, siempre y cuando solo hay un registro.
                For i As Integer = 0 To Me.gvInvestigacion.Rows.Count - 1
                    Fila = gvInvestigacion.Rows(i)
                    Dim valor As Boolean = CType(Fila.FindControl("chkElegir"), CheckBox).Checked
                    If (valor = True) Then
                        Me.lblIdInvestigacion.Text = gvInvestigacion.Rows(i).Cells(0).Text
                    End If
                Next
            End If
    ...
    Protected Sub btnGuardarRevisor_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardarRevisor.Click
        Try
            ...
            '======================================================================
            'Dguevara: ** taba fallandao esta nota, 
            'Agregado el 28.10.2013

            If Me.lblIdInvestigacion.Text.Trim <> "" Then
                If FileArchivo.HasFile Then
                    Dim filePath As String
                    Dim archivo As String = "\" & Now.Day.ToString & Now.Month.ToString & Now.Year.ToString & Now.Hour.ToString & Now.Minute.ToString & Now.Second.ToString & System.IO.Path.GetExtension(FileArchivo.FileName).ToString
                    ...
                    'AKII
                    filePath = Server.MapPath("../../filesInvestigacion")
                    filePath = filePath & "\" & Me.lblIdInvestigacion.Text.Trim           'gvInvestigacion.Rows(i).Cells(0).Text
                    Dim carpeta As New System.IO.DirectoryInfo(filePath)
                    If carpeta.Exists = False Then
                        carpeta.Create()
                    End If
                    ...
                    'Actualiza el estado.
                    obj.AbrirTransaccionCnx()
                    exec = obj.CalificaInvestigacion(Me.lblIdInvestigacion.Text.Trim, Me.Request.QueryString("ctf"), Me.Request.QueryString("id"), hfTipoRevisor.Value, txtRevisor.Text.Trim, archivoBD, 0)
                    obj.CerrarTransaccionCnx()
                    obj = Nothing
                Else
                    'Actualiza el estado.
                    obj.AbrirTransaccionCnx()
                    exec = obj.CalificaInvestigacion(Me.lblIdInvestigacion.Text.Trim, Me.Request.QueryString("ctf"), Me.Request.QueryString("id"), hfTipoRevisor.Value, txtRevisor.Text.Trim, "", 0)
                    obj.CerrarTransaccionCnx()
                    obj = Nothing
                End If
                '------------------------------------------------------------------------------------------------------------------------'
                ''''****'Envia email al autor de la investigacion y al  - coordinador de la Instancia en la que se encuentra la Investigacion    '
                If exec = 1 Then
                    EnviarMensaje(Me.lblIdInvestigacion.Text.Trim, Request.QueryString("ctf"), hfTipoRevisor.Value)
                End If
                sw = 1
            Else
                'Aqui debe entrar cuando el id de la investigacion no ha pasado al popup para la hacer la observacion o el rechazo.
                sw = 0
            End If

            '** Mostramos el alertar al usuario.
            If sw = 1 Then
                ClientScript.RegisterStartupScript(Me.GetType, "FaltanDatos", "alert('Proceso terminado correctamente.');", True)
            Else
                ClientScript.RegisterStartupScript(Me.GetType, "FaltanDatos", "alert('No se pudo terminar el proceso, favor volver a intentar.!');", True)
        ...
        Try
            ...
            For i As Integer = 0 To Me.gvInvestigacion.Rows.Count - 1
                ...
                If (valor = True) Then
                    ...
                    obj.CerrarTransaccionCnx()
                    obj = Nothing
                    'EnviarMensaje(gvInvestigacion.Rows(i).Cells(0).Text, Request.QueryString("ctf"), "C")  'xDsc
                End If
            Next
    ...
    Protected Sub btnGuardarResolucion_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardarResolucion.Click
        Try
            ...
            If exec = 1 Then
                'EnviarMensaje(hfCodInvestigacion.Value, Request.QueryString("ctf"), "RS")       'xdsc
                ClientScript.RegisterStartupScript(Me.GetType, "FaltanDatos", "alert('Se cargo la Resolución al proyecto de investigación');", True)
            Else
                ClientScript.RegisterStartupScript(Me.GetType, "FaltanDatos", "alert('No se pudo cargar el Informe al proyecto de investigación, intentelo nuevamente.');", True)
            End If
            txtNumeroRes.Text = ""
    ...
    Protected Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnBuscar.Click
        Try
            'ClientScript.RegisterStartupScript(Me.GetType, "FaltanDatos", "alert('Buscando....');", True)
            CargarInvestigaciones()
        Catch ex As Exception
            Response.Write(ex.Message)
        End Try
    ...
    Protected Sub ddlInstanciasInvestigacion_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlInstanciasInvestigacion.SelectedIndexChanged
        Try
            CargarInvestigaciones()
            pnlDetalle.Visible = False
        Catch ex As Exception
