<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSubirInforme.aspx.vb" Inherits="investigacion_frmAgregarEditarComite" %>
            ...
            <table style="border:#c2cff1 1px solid;" cellpadding=0px;>
                <tr>
                    <td colspan="2" style=" background:#d1ddef;color:#2f4f4f" class="style4">
                        <b>Subir Informe de Investigación</b></td>
