<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmGestionInvestigacionX.aspx.vb" Inherits="frmGestionInvestigacionX" EnableEventValidation ="true" %>
        ...
        <ContentTemplate>
            ...
            <tr>
                <td>
                     <table style="width:100%;">
                        <tr>
                            <td style ="background-color:#32CD32; font-weight: bold;" height="30px">
                                <asp:Label ID="lblTit" runat="server" Text="Investigaciones"></asp:Label>
                                
                                </td>
                        </tr>
                        <tr>
                                <td align="right" style ="background-color:#f0f0f0; font-weight: bold;" 
                                    height="30px">
                                        <asp:Button 
                                            ID="btnConforme" 
                                            runat="server" 
            ...
            <tr>
                <td>
                    <asp:Panel ID="pnlDetalle" runat="server">
                        <asp:GridView ID="gvInvestigacion" runat="server" AllowPaging="True" 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:LinkButton ID="hlEnviar" runat="server" Font-Underline="True" 
                                                        ...
                                                        Visible='<%# iif(Eval("etapa") = "Borrador", "True", "False") %>'>Enviar
                                                </asp:LinkButton>
                                                </td>
                                                <td>
                                ...
                                <table style="border: 1px solid #99BAE2; width:100%; border-collapse: collapse;" width="100%" height="100%" cellpadding=0 cellspacing=0>
                                    ...
                                    <tr>
                                        <td style="width:5%">
                                            &nbsp;</td>
                                        <td style="width:15%; font-weight: bold;">
                                            <asp:Label ID="Label10" runat="server" Text="Estado Envío"></asp:Label>
                                        </td>
                                        <td style="width:30%">
                                                ...
                                                <table style="width: 90%;" align="center">
                                                    ...
                                                    <tr>
                                                        <td style="width:10%">
                                                            Documento:</td>
                                                        <td style="width:90%">                                                            
                                                            <asp:FileUpload ID="afuObservacion" runat="server" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                    ...
                    <asp:Panel ID="pnlPopContenedorAvance" runat="server" Style="display: none" CssClass="modalPopup">
                        ...
                        <table style="width: 100%;background-color:White;height:160px">
                            ...
                            <tr>
                                ...
                                <td style="width: 70%">                               
                                    ...
                                    <asp:FileUpload ID="afuAvance" runat="server" />
                                </td>
                                <td style="width: 10%">
                    ...
                    <asp:Panel ID="pnlContedorResolucion" runat="server" Style="display: none; Width:350px"  CssClass="modalPopup">
                        ...
                        <table style="width: 100%;background-color:White;height:160px">
                            ...
                            <tr>
                                ...
                                <td style="width: 10%" valign="top">
                                    <asp:RequiredFieldValidator 
                                    ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtRevisor" 
