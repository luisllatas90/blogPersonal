...
Partial Class investigacion_frmAgregarEditarComite
    ...
    Protected Sub btbGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btbGuardar.Click
        ...
        If Me.txtNroResolucion.Text.Trim <> "" Then
            If Me.FileUpload1.HasFile Then
                ...
                obj.RegistrarResolucion(xid, Me.txtNroResolucion.Text.Trim, filePath & archivo)
            ...
            Else
                ClientScript.RegisterStartupScript(Me.GetType, "Alerta", "alert('Seleccione el archivo referente a la resolución del la investigación');", True)
            End If
        Else
            ClientScript.RegisterStartupScript(Me.GetType, "Alerta", "alert('Debe escribir el Número de Resolución de la Investigación');", True)
        End If
