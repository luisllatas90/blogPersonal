...
Partial Class DirectorInvestigacion_administrarAreasLineasTematicas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("del") = "A" Then
            ...
            obj.EliminarArea(xID, CInt(Request.QueryString("id")))
            obj.CerrarTransaccionCnx()
        Else
            obj.AbrirTransaccionCnx()
            obj.EliminarLinea(xID, CInt(Request.QueryString("id")))
            obj.CerrarTransaccionCnx()
        End If
        ...
        If Not Page.IsPostBack Then
            ...
            divContent = "<ul id='red' class='treeview' style='cursor:hand;color:#2f4f4f;'>"
            ...
            If dtComite.Rows.Count Then
                ...
                For i As Int16 = 0 To dtComite.Rows.Count - 1
                    href = "frmAgregarEditarAreaLinea.aspx?id=" & Request.QueryString("id") & "&act=A&typ=A&xid=" & dtComite.Rows(i).Item(0) & "&xna="
                    varC = "C" & i
                    divContent &= "<li>"
                    ...
                    divContent &= "   </div>"
                    divContent &= "   <div id='" & varC & "' style='padding-left:10px;float:left;color:#999999;'>"
                    divContent &= "     <a id='enlace' class='ifancybox' style='padding-left:10px;'  href='" & href & "'>Agregar Área</a>"
                    divContent &= "   </div>"
                    ...
                    If dtArea.Rows.Count Then
                        divContent &= "<ul style='cursor:hand; color:#203360;'>"
                        For j As Int16 = 0 To dtArea.Rows.Count - 1
                            ...
                            divContent &= "  <div>"
                            divContent &= "   <div style='float:left;'>"
                            divContent &= "Área: " & dtArea.Rows(j).Item(1)
                            divContent &= "   </div>"
                            divContent &= "   <div id='" & varA & "' style='float:left;display:block;padding-left:10px;color:#999999;'>"

                            href = "frmAgregarEditarAreaLinea.aspx?id=" & Request.QueryString("id") & "&act=A&typ=L&xid=" & dtArea.Rows(j).Item(0) & "&xna="
                            divContent &= "     <a id='enlace' class='ifancybox'  style='padding-left:10px;' href='" & href & "'>Agregar Línea</a>  "

                            href = "frmAgregarEditarAreaLinea.aspx?id=" & Request.QueryString("id") & "&act=E&typ=A&xid=" & dtArea.Rows(j).Item(0) & "&xna=" & dtArea.Rows(j).Item(1)
                            divContent &= "     <a id='enlace' class='ifancybox'  style='padding-left:10px;' href='" & href & "'>Modificar</a>  "

                            href = "?id=" & Request.QueryString("id") & "&xid=" & dtArea.Rows(j).Item(0) & "&del=A"
                            divContent &= "     <a style='padding-left:10px;' href='" & href & "'>Eliminar</a>  "
                            divContent &= "   </div>"
                            ...
                            If dtLinea.Rows.Count Then
                                divContent &= "<ul style='color:#3b5998'>"
                                For k As Int16 = 0 To dtLinea.Rows.Count - 1
                                    varL = "L" & k
                                    divContent &= "<li>    "

                                    divContent &= "  <div>"
                                    divContent &= "   <div style='float:left; padding-left:10px;'>"
                                    divContent &= "Línea: " & dtLinea.Rows(k).Item(1)
                                    divContent &= "   </div>"
                                    divContent &= "   <div id='" & varL & "' style='float:left;display:block;padding-left:10px;color:#999999;' >"

                                    href = "frmAgregarEditarAreaLinea.aspx?id=" & Request.QueryString("id") & "&act=E&typ=L&xid=" & dtLinea.Rows(k).Item(0) & "&xna=" & dtLinea.Rows(k).Item(1)
                                    divContent &= "     <a id='enlace' class='ifancybox' style='padding-left:10px;' href='" & href & "'>Modificar</a>  "

                                    href = "?id=" & Request.QueryString("id") & "&xid=" & dtLinea.Rows(k).Item(0) & "&del=L"
                                    divContent &= "     <a style='padding-left:10px;' href='" & href & "'>Eliminar</a>  "
                                    divContent &= "   </div>"
