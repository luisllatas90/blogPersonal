...
<%  response.write(clsfunciones.cargacalendario) %>
    <div>
        ...
        <ContentTemplate>
            ...
            <tr>
                <td>
                     <table style=" background-color:#D1DDEF"; width="100%" >
                        <tr>
                            <td style ="background-color:#D1DDEF; font-weight: bold;" height="30px">
                                <asp:Image ID="Image5" runat="server" ImageUrl="~/Images/inv_titulo.png" 
                                    style="height: 50px" />
                            </td>
                            <td rowspan="4" align="center" style ="background-color:#D1DDEF">
                                <asp:Image ID="imgPerfil" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td align="left"style ="background-color:#D1DDEF;  font-weight: bold;" height="20px">
                                <asp:Label ID="lblEstadoRevisor" runat="server" Text="Estado Revisión: " 
                                    Visible="False">
                                </asp:Label>
                                <asp:Label ID="lblCantidad" runat="server" ForeColor="#990000"></asp:Label>
                                <asp:DropDownList ID="ddlEstadoRevisor" runat="server" Visible="False" 
                                    AutoPostBack="True">
                                </asp:DropDownList>
                                <asp:DropDownList ID="ddlInstanciasInvestigacion" runat="server" AutoPostBack="True">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                             <asp:Panel ID="pnlAlertaProfesor" runat="server" Visible="false">
                                <td bgcolor="#D1DDEF" height="15px">
                                
                                      <table style="width:100%;">
                                        <tr>
                                             <td>
                                              <asp:GridView ID="gvPanel" Width="100%" runat="server" AutoGenerateColumns="False" 
                                                     BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
                                                     CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                                                     <Columns>
                                                         <asp:BoundField DataField="1" 
                                                             HeaderImageUrl="~/Images/inv_inst_autor.png" 
                                                             >
                                                             <HeaderStyle HorizontalAlign="Center" />
                                                             <ItemStyle Font-Bold="True" HorizontalAlign="Center" />
                                                         </asp:BoundField>
                                                         <asp:ImageField HeaderImageUrl="~/Images/inv_paso.png">
                                                         </asp:ImageField>
                                                          <asp:BoundField DataField="2" 
                                                             
                                                             HeaderImageUrl="~/Images/inv_inst_cinvestigacion.png" >
                                                             <ItemStyle Font-Bold="True" HorizontalAlign="Center" />
                                                         </asp:BoundField>
                                                         <asp:ImageField HeaderImageUrl="~/Images/inv_paso.png">
                                                         </asp:ImageField>
                                                          <asp:BoundField DataField="3" 
                                                             ...
                                                             HeaderImageUrl="~/Images/inv_inst_cetica.png" >
                                                             <ItemStyle Font-Bold="True" HorizontalAlign="Center" />
                                                         </asp:BoundField>
                                                         <asp:ImageField HeaderImageUrl="~/Images/inv_paso.png">
                                                         </asp:ImageField>
                                                         <asp:BoundField DataField="4" 
                                                             ...
                                                             HeaderImageUrl="~/Images/inv_ins_vinvestigacion.png" >
                                                             <ItemStyle Font-Bold="True" HorizontalAlign="Center" />
                                                         </asp:BoundField>
                                                         <asp:ImageField HeaderImageUrl="~/Images/inv_paso.png">
                                                         </asp:ImageField>
                                                         <asp:BoundField DataField="5" 
                                                             ...
                                                             HeaderImageUrl="~/Images/inv_ins_concejoinv.png" >
                                                             <ItemStyle Font-Bold="True" HorizontalAlign="Center" />
                                                         </asp:BoundField>
                                                         <asp:ImageField HeaderImageUrl="~/Images/inv_paso.png">
                                                         </asp:ImageField>
                                                          <asp:BoundField DataField="6" 
                                                            HeaderText="COMITE DE REDACCION"
                                                             HeaderImageUrl="~/Images/inv_ins_credaccion.png" >
                                                             <ItemStyle Font-Bold="True" HorizontalAlign="Center" />
                                                         </asp:BoundField>
                                                         <asp:BoundField DataField="TOTAL" 
                                                             HeaderImageUrl="~/Images/inv_total_inv.png" >
                                                             <ItemStyle Font-Bold="True" HorizontalAlign="Center" />
                                                         </asp:BoundField>
                                                     </Columns>
                        ...
                        <tr>
                            <asp:Panel ID="pnlAlertaCoordinadorRevisor" runat="server" Visible="false"  >
                                         <td bgcolor="#D1DDEF" height="15px">
                                             
                                                 <table style="width:100%;">
                                                    <tr>
                                                        <td>
                                                            <asp:GridView ID="gvPanelCoorRev" Width="100%" runat="server" AutoGenerateColumns="False" 
                                                                 BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
                                                                 CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                                                                 <Columns>
                                                                     <asp:BoundField DataField="1" 
                                                                         HeaderImageUrl="~/Images/est_pendientes.png" 
                                                                         HeaderText="PENDIENTES">
                                                                         <HeaderStyle HorizontalAlign="Center" />
                                                                         <ItemStyle Font-Bold="True" HorizontalAlign="Center" />
                                                                     </asp:BoundField>
                                                                      <asp:BoundField DataField="2" 
                                                                         HeaderText="OBSERVADOS"
                                                                         HeaderImageUrl="~/Images/est_observados.png" >
                                                                         <ItemStyle Font-Bold="True" HorizontalAlign="Center" />
                                                                     </asp:BoundField>
                                                                     <asp:BoundField DataField="4" 
                                                                         HeaderText="RECHAZADO"
                                                                         HeaderImageUrl="~/Images/est_rechazados.png" >
                                                                         <ItemStyle Font-Bold="True" HorizontalAlign="Center" />
                                                                     </asp:BoundField>
                                                                     <asp:BoundField DataField="3" 
                                                                        HeaderText="CONFIRMADOS"
                                                                         HeaderImageUrl="~/Images/est_conforme.png" >
                                                                         <ItemStyle Font-Bold="True" HorizontalAlign="Center" />
                                                                     </asp:BoundField>
                                                                     <asp:BoundField DataField="TOTAL" 
                                                                         HeaderImageUrl="~/Images/inv_sum.png" >
                                                                         <ItemStyle Font-Bold="True" HorizontalAlign="Center" />
                                                                     </asp:BoundField>
                                                                 </Columns>
                                                                   <SelectedRowStyle BackColor="#D1DDF1" ForeColor="#333333" />
                        ...
                        <!--#e8eef7 #f0f0f0 -->
                        <tr>
                                <td colspan="2"  align="left" style ="background-color:#D1DDEF; font-weight: bold;" 
                                    height="30px">
                                        <asp:Button 
                                            ID="btnConforme" 
                                            runat="server" 
                                            ...
                                            Text="          Conforme" 
                                            Font-Underline="False" BackColor="#D1DDEF" />
                                    <asp:Button ID="btnObservar" runat="server" CssClass="observar_inv" 
                                        Font-Underline="False" BackColor="#D1DDEF" Height="47px" Text="        Observar" Width="95px" />
                                    <asp:Button ID="btnRechazar" runat="server" CssClass="rechazar_inv" 
                                        Font-Underline="False" BackColor="#D1DDEF" Height="47px" Text="        Rechazar" Width="95px" />
                                    <asp:Button ID="btnEnviar" runat="server" CssClass="enviarpropuesta" 
                                        Height="47px" BackColor="#D1DDEF" Text="          Enviar" Width="95px" />
                                    <asp:Button ID="btnNuevo" BackColor="#D1DDEF" runat="server" Width="95px" Height="47px" Text="       Nuevo" 
            ...
            <tr>
                <td>
                    <table style=" background-color:#D1DDEF"; width="100%" >
                        <tr>
                            <td style="width:20%">
                                <asp:Image ID="Image6" ImageUrl="~/Images/inv_titulo_buscar.png" runat="server" />
                            </td>
                            <td style="width:70%">
                                <asp:TextBox ID="txtBuscarInv" Width="100%" runat="server"></asp:TextBox>
                            </td>
                            <td style="width:10%" align="right">
                                <asp:ImageButton ID="btnBuscar" ImageUrl="~/Images/inv_buscar.png" runat="server" />
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td>
                    <asp:GridView ID="gvInvestigacion" runat="server" CellPadding="4" 
                        ...
                        AutoGenerateColumns="False" DataKeyNames="instancia,estado">
                                    ...
                                    <ItemTemplate>
                                        <table style="width:100%;">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:LinkButton ID="hlEliminar" ForeColor="Red" 
                                                        runat="server" Font-Underline="True" 
                                                        OnClick="hlEliminar_Click" 
                                                        Visible='<%# iif(Eval("etapa") = "Borrador", "True", "False") %>' 
                                                        Font-Bold="True">Eliminar
                                                </asp:LinkButton>
                                                </td>
                                                <td>
                                                    <asp:LinkButton ID="hlVersion" runat="server" Font-Underline="True" 
                                                        OnClick="hlVersion_Click" 
                                                        Visible='<%# iif(Eval("estado")="Finalizado","False",iif(Eval("estado_version") = "3", "True", "False"))  %>'>Versión
                                                </asp:LinkButton>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:Image      ID="Image7" 
                                                                    ToolTip="Investigación Finalizada" 
                                                                    Visible='<%# iif(Eval("estado") = "Finalizado", "True", "False") %>' 
                                                                    ImageUrl="../images/accept.png" runat="server" />
                                                </td>
                                                <td>
                            ...
                            <tr>
                                <td style="width: 98%">
                                    <div style="background-color: #e8eef7; color: #3366CC; font-weight: bold;" >
                                        ...
                                        <asp:Label ID="lblID" runat="server" Text="Investigación: "></asp:Label>
                                        <asp:Label ID="lblIdInvestigacion" runat="server" ForeColor="Blue" Text=""></asp:Label>
                                    </div>
                                </td>
                                <td style="width: 2%">
                        ...
                        <table style="width: 100%;background-color:White;height:320px">
                            <tr>
                                <td valign="top" align="center">
                                    ...
                                    <br/>
                                    <asp:GridView ID="gvEliminados" runat="server" AllowPaging="True" 
                                    AutoGenerateColumns="False" BorderColor="#99BAE2" BorderStyle="Solid" 
                                    BorderWidth="1px" CellPadding="4" ForeColor="#333333" GridLines="Horizontal" 
                                    PageSize="5" Width="98%">
                                    <Columns>
                                        <asp:BoundField DataField="hito_id" HeaderText="Hito" Visible="False" ></asp:BoundField>
                                        <asp:BoundField DataField="hito" HeaderText="Hito" Visible="False" ></asp:BoundField>
                                        <asp:BoundField DataField="hitoactivo" HeaderText="hitoactivo" Visible="False" ></asp:BoundField>
                                        <asp:BoundField DataField="avanceactivo" HeaderText="avanceactivo" Visible="False" ></asp:BoundField>
                                        <asp:TemplateField HeaderText="Hito">
                                            <ItemTemplate>
                                                <asp:Panel ID="pnlHito" runat="server">
                                                <table style="width: 100%;">
                                                ...
                                                <table style="width:100%"> 
                                                    <tr>
                                                        <td style="width:50%" align="center">
                                                            <asp:Label ID="lblCantObs" runat="server" Text='<%# Eval("observaciones") %>'></asp:Label>
                                                        </td>
                                                        <td style="width:50%" align="center" >
                                                            <asp:ImageButton ID="ibtnVerObs" runat="server" ImageUrl="~/Images/previo.gif" 
                                                                onclick="ibtnVerObs_Click" ToolTip="Ver Observación" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate><ItemStyle Width="16%" />
                                        </asp:TemplateField>
        ...
        <ajaxtoolkit:calendarextender ID="cbeAvance"  runat="server" PopupButtonID="ibtnCalendarAvance" TargetControlID="txtFechaAvance" Format="dd/MM/yyyy" ></ajaxtoolkit:calendarextender>
            ...
            <Triggers>
                ...
                <asp:PostBackTrigger ControlID="ddlInstanciasInvestigacion" />
