...
Partial Class CRISUSAT_FrmUnidadOrganizacional
    ...
    Private Function ConsultarUnidadOrganizacional() As Data.DataTable
        ...
        Try
            ...
            list.Add("EntidadSimple", "orgunit")
            list.Add("Columnas", "name parentorgunit")
            list.Add("Entidad", "orgunits")

            Dim envelope As String = obj.SoapEnvelopeListar(list)
            Dim result As String = obj.PeticionRequestSoap(ruta, envelope, SOAPAaction, "")


            dt.Columns.Add("ID") 'Columna2
            dt.Columns.Add("cod_ou") 'Columna2
            dt.Columns.Add("Unidad") 'Columna2
            ...
            If nodos.Count > 0 Then ' Verificamos si hay filas para mostrar
                ...
                For i = 0 To nodos.Count - 1 ' recorremos las filas
                    ...
                    arreglo(1) = nodos(i).Attributes("publicID").Value.ToString()
                    For j As Integer = 0 To nodos(i).ChildNodes.Count - 1 'llenamos arreglo (5 Columnas maximo por ahora [sino agregar columnas en #001])
                        arreglo(j + 2) = nodos(i).ChildNodes(j).InnerText.ToString
                    Next j
    ...
    Protected Sub ddTipoUnidad_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddTipoUnidad.SelectedIndexChanged
        Try
            'Page.RegisterClientScriptBlock("modal", "<script type='text/javascript'>MostrarModalJS()</script>")
