...
Partial Class CRISUSAT_FrmPersonas
    ...
    Private Sub ConsultarUnidadOrganizacional()
        Try
            ...
            dt.Columns.Add("ID SISTEMA INTERNO") 'Columna2
            dt.Columns.Add("Unidad Organizacional") 'Columna2
            dt.Columns.Add("Unidad Organizacional Padre") 'Columna2
            ...
            If nodos.Count > 0 Then ' Verificamos si hay filas para mostrar
                ...
                For i = 0 To nodos.Count - 1 ' recorremos las filas
                    ...
                    Dim arreglo(nodos(i).ChildNodes.Count) As String ' declaro arreglo variable para cada fila
                ...
                Me.gvUnidadOrganizacional.DataSource = dt

                Me.gvUnidadOrganizacional.DataBind()
                'Me.gvUnidadOrganizacional.Sort(1, SortDirection.Ascending)
            Else
                Me.gvUnidadOrganizacional.DataSource = Nothing
                Me.gvUnidadOrganizacional.DataBind()
            End If
        Catch ex As Exception
    ...
    '    If dt.Rows(0).Item("regina") = "1" Then
    ...
    '        Me.DivMensaje.InnerHtml = "Debe Seleccionar e Ingresar URL Dina"
    '        Return False
    '    End If
    '    If Me.chkDina.Checked = True Then
    '        If Me.txtUrlDina.Text = "" Then
    '            Me.DivMensaje.InnerHtml = "Debe Ingresar URL Dina"
