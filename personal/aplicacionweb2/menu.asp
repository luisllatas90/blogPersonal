...
<table width="100%" height="100%" border="0" cellpadding="4" cellspacing="0" id="tblMnuPrincipal">
  ...
  <tr>
    ...
    response.write "<table width=""100%""><tr>" & vbcrlf & vbtab
    Do while Not rsMenu.EOF
		fila=fila+1
	
		if fila=4 or fila=7 then
  ...
  <tr>
    <td colspan="2" height="60%" width="100%" valign="top" align="center">
