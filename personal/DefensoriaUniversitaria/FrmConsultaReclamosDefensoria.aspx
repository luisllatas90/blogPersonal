...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/Defensoria.js?x=5"></script>

    <script type="text/javascript" src="js/JsDefensoria.js?x=16"></script>
    ...
    <div class="wrapper">
        <div class="content">
            ...
            <div class="main-content">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <div id="tConsultaDefensoria_wrapper" class="dataTables_wrapper" role="grid">
                                    <table id="tConsultaDefensoria" name="tConsultaDefensoria" class="display dataTable"
                                        width="100%">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <td width="20%" style="font-weight: bold; width: 30px; text-align: center" class="sorting"
                                                    tabindex="0" rowspan="1" colspan="1" aria-label="Nombre: activate to sort column ascending">
                                                    Detalle
                                                </td>
                                                <td width="10%" style="font-weight: bold; width: 10px; text-align: center" class="sorting"
                ...
                <!-- row -->
                <div class="row">
                    <div class="modal fade" id="mdVerRespuesta" role="dialog" aria-labelledby="myModalLabel"
                        style="z-index: 0;" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                        <div class="modal-dialog" id="modalVerResp">
                            <div class="modal-content">
                                <div class="modal-header" style="background-color: #E33439; color: White; font-weight: bold;">
                                    ...
                                    <h4 class="modal-title" id="H2">
                                        Vista de Respuestas</h4>
                                </div>
                                <div class="modal-body">
                                    <form id="frmVerRespuestas" name="frmVerRespuestas" enctype="multipart/form-data"
                                    class="form-horizontal" method="post" onsubmit="return false;" action="#">
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="table-responsive">
                                                    <div id="tResDefensoria_wrapper" class="dataTables_wrapper" role="grid">
                                                        <table id="tResDefensoria" name="tResDefensoria" class="display dataTable" width="100%">
                                                            <thead>
                                                                <tr role="row">
                                                                    <td width="5%" style="font-weight: bold; width: 5px; text-align: center" class="sorting_asc"
                                                                        tabindex="0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="N°: activate to sort column descending">
                                                                    ...
                                                                    <td width="85%" style="font-weight: bold; width: 85px; text-align: center" class="sorting"
                                                                        tabindex="0" rowspan="1" colspan="1" aria-label="Nombre: activate to sort column ascending">
                                                                        Respuesta
                                                                    </td>
                                                                    <td width="15%" style="font-weight: bold; width: 15px; text-align: center" class="sorting"
                                                                        tabindex="0" rowspan="1" colspan="1" aria-label="Nombre: activate to sort column ascending">
                                                                        Fecha
                                                                    </td>
                                                                </tr>
                                ...
                                <div class="modal-footer">
                                    <center>
                                        <button type="button" class="btn btn-danger" id="btnCancelarVer" data-dismiss="modal">
                                            Cancelar</button>
                                    </center>
                                </div>
                            </div>
