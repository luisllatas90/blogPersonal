...
Partial Class frmmatriculafc
    ...
    Private Sub Listar()
        ...
        dt = obj.TraerDataTable("[BE_ConsultarCursoFormacionComplementaria]", Me.hdcod_univ.value, 486, "", "D")
    ...
    Private Sub Listar1()
        ...
        obj.AbrirConexion()
        Dim dt As New Data.DataTable
        dt = obj.TraerDataTable("[BE_ConsultarCursoFormacionComplementaria]", Me.hdcod_univ.value, 486, "", "M")
    ...
    Private Sub ver()
        ...
        Tbl = obj.TraerDataTable("consultaracceso", "E", trim(Me.txtcodigo.Text.Trim), 0)
        Me.lblMensaje.Visible = False

        If Tbl.Rows.Count > 0 Then
            Me.lblcodigo.text = trim(txtcodigo.text)
