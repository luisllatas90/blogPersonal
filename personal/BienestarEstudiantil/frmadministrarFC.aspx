<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmadministrarFC.aspx.vb"
    Inherits="frmadministrarFC" %>
...
<head runat="server">
    ...
    <title>Administración Formacion Complementaria</title>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="background-color: #E33439; color: White; font-weight: bold;
                font-size: 16px;">
                Administrar Acreditación en Formación Complementaria
            </div>
            <div class="panel-body">
                ...
                <br/>
                <asp:UpdatePanel runat="server" ID="updMatriculas" UpdateMode="Conditional" ChildrenAsTriggers="false">
                    <contenttemplate>
                        <div runat="server" id="divMatricula">
                            <div class="form-group"> 
                            
                                <div class="tab-pane" style="background-color: #E33439; color: white; font-weight: bold;
                                font-size: 13px; text-align :left;">
                                Historial de Matrículas
                                </div>                                                                                        
                                <asp:HiddenField runat="server" ID="hdciclo" Value="0" Visible="true" />                                                                        
                                <asp:GridView runat="server" AutoGenerateColumns="False" ID="gvmatriculas" CellPadding="3" BorderColor="#CCCCCC" BorderStyle="Solid" 
                                    BorderWidth="1px" Width="100%" ShowFooter="false" DataKeyNames="codigo_cac,codigo_mat" CssClass="table table-condensed">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="codigo_cac" HeaderText="Codigo_cac" 
                                            InsertVisible="False" ReadOnly="True" SortExpression="Codigo_cac" 
                                            Visible="false" />
                                        <asp:BoundField DataField="codigo_mat" HeaderText="CÓD. MAT." HeaderStyle-Width="10%" />
                                        <asp:BoundField DataField="descripcion_Cac" HeaderText="SEMESTRE" HeaderStyle-Width="10%" />                                        
                                        <asp:BoundField DataField="estado" HeaderText="ESTADO" HeaderStyle-Width="15%" />
                                        <asp:BoundField DataField="observacion_Mat" HeaderText="OBSERVACIÓN" HeaderStyle-Width="65%" />
                                        <asp:CommandField SelectText=" " ShowSelectButton="True">
                                            <ItemStyle Width="1px" />
                                        </asp:CommandField>                                                                                                                                                       
                                    </Columns>
                                    
                                    <HeaderStyle BackColor="#E33439" ForeColor="#3366CC" BorderColor="#99BAE2" 
                                    BorderStyle="Solid" BorderWidth="1px" />
                                    <RowStyle Font-Size="13px" />
                                    <SelectedRowStyle BackColor="#FFFFD2" />
                                    <EmptyDataTemplate>
                                        <b>No se encontraron matrículas</b>
                                    </EmptyDataTemplate>
                                </asp:GridView>
                            </div>
                        </div>
                ...
                <asp:UpdatePanel runat="server" ID="updLista" UpdateMode="Conditional" ChildrenAsTriggers="false">
                    <contenttemplate>
                        <div runat="server" id="Lista" style="background-color: #FFFFFF; color: black;">
                            <div class="form-group"> 
                            ...
                            <%--<div class="form-group">--%>
                                <asp:GridView runat="server" ID="gvLista" CssClass="table table-condensed" DataKeyNames="codigo_cup,codigo_cur"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="creditos_cur" HeaderText="CRE" HeaderStyle-Width="5%" />
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                    <contenttemplate>
                        <div class="form-group" id="DivMantenimiento" runat="server" visible="false">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <asp:HiddenField runat="server" ID="HiddenField3" Value="0" Visible="false" />                                    
                                    <asp:Label ID="lblGrupo1" runat="server" CssClass="col-sm-2 col-md-1 control-label"
                                        For="cboGrupo1">Grupo</asp:Label>
                                    <div class="col-sm-6 col-md-6">
                                     <asp:DropDownList ID="cboGrupo1" runat="server" AutoPostBack="True">
                ...
                <asp:UpdatePanel runat="server" ID="updLista1" UpdateMode="Conditional" ChildrenAsTriggers="false">
                    <contenttemplate>
                        <div runat="server" id="Lista1" style="background-color: #FFFFFF; color: black;">
                            <div class="tab-pane" style="background-color: #FFFFFF; color: black; font-weight: bold;
                                font-size: 14px; text-align :center;">
                                Talleres Inscritos
                            </div>
                            ...
                            <asp:LinkButton runat="server" ID="lblCambiaGrupo" CssClass="btn btn-sm btn-success btn-radius"
                                Text='<span class="fa fa-less-circle"></span>&nbsp;Cambio Grupo' OnClientClick="fnLoading(true);"></asp:LinkButton>
                            <div class="form-group">
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel2" UpdateMode="Conditional">
                    <contenttemplate>
                        <div class="form-group" id="DivMantenimiento1" runat="server" visible="false">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <asp:HiddenField runat="server" ID="HiddenField4" Value="0" Visible="false" />                                    
                                    <asp:Label ID="lblGrupo" runat="server" CssClass="col-sm-2 col-md-1 control-label"
                                        For="cboGrupo">Grupo</asp:Label>
                                    <div class="col-sm-6 col-md-6">
