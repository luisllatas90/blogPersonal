<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmatencioninformeFC.aspx.vb"
    Inherits="frmatencioninformeFC" %>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="background-color: #E33439; color: White; font-weight: bold;
                font-size: 14px;">
                <b>REVISIÓN DE INFORME DE RESPONSABLES</b>
            </div>
                    ...
                    <contenttemplate>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">                           
                                ...
                                <asp:Label ID="Label6" runat="server" CssClass="col-sm-2 col-md-2 control-label">Conformidad:</asp:Label>
                                <div class="col-sm-4 col-md-4">
                                    <div class="col-sm-5 col-md-5">
                                        ...
                                        <asp:ListItem Value="R">OBSERVADO</asp:ListItem>                                                                                                           
                                    </asp:DropDownList>
                                    </div>                                    
                                </div>
                                ...
                                <asp:Label ID="lblObserva" runat="server" CssClass="col-sm-2 col-md-2 control-label">Observaciones:</asp:Label>                                
                                    
                                <hr /> 
                               <div class="form-group">                                                          
                                <asp:GridView runat="server" ID="gvObservaciones" DataKeyNames="codigo"
                                    AutoGenerateColumns="false">
                                    <Columns>                                                                            
                                        <asp:BoundField  HeaderText="N°" HeaderStyle-Width="10%" />                                        
                                        <asp:BoundField  HeaderText="Observación" HeaderStyle-Width="20%" />                                        
                                        <asp:BoundField  HeaderText="Fecha" HeaderStyle-Width="10%" />                                                                                                                       
                            ...
                            <div class="col-sm-5 col-md-5">
                                <div class="col-sm-12 col-md-12">
                                    <asp:DropDownList runat="server" ID="ddlEstado" CssClass="form-control" AutoPostBack="true">
                                        ...
                                        <asp:ListItem Value="2">APROBADOS</asp:ListItem>
                        ...
                        <div class="form-group">                       
                            <asp:GridView runat="server" ID="gvListaEscalas" CssClass="table table-condensed" DataKeyNames="codigo_ecs, eliminado_ecs"
                                    ...
                                    <Columns>                                                                            
                                        ...
                                        <asp:BoundField  HeaderText="RESPONSABLE" HeaderStyle-Width="20%" />
                                        <asp:BoundField  HeaderText="TALLER" HeaderStyle-Width="20%" />                                        
