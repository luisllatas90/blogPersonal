<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmatenciontramitesFC.aspx.vb"
    Inherits="frmatenciontramitesFC" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Atención de Trámites</title>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="background-color: #E33439; color: White; font-weight: bold;
                font-size: 14px;">
                <b>ATENCIÓN DE TRÁMITE DE RECONOCIMIENTO</b>
            </div>
                    ...
                    <contenttemplate>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">                           
                                ...
                                <asp:Label ID="Label2" runat="server" CssClass="col-sm-2 col-md-2 control-label">Código Univ: </asp:Label>
                                <div class="col-sm-4 col-md-4">
                                    <div class="col-sm-5 col-md-5">
                                    <asp:TextBox runat="server" ID="txtCodigoUni" ReadOnly="false" CssClass="form-control"  Style="text-transform: uppercase" Text="191TD452369">
                                       </asp:TextBox>
                                    </div>
                                    <hr />                                      
                                </div>                                 
                                ...
                                <asp:Label ID="Label4" runat="server" CssClass="col-sm-2 col-md-2 control-label">Fecha Ingreso: </asp:Label>
                                <div class="col-sm-4 col-md-4">
                                    <div class="col-sm-4 col-md-4">
                                    <asp:TextBox runat="server" ID="txtFecha" ReadOnly="false" CssClass="form-control"  Style="text-transform: uppercase" Text="13/02/2019">
                                       </asp:TextBox>
                                    </div>
                                    <hr />                                    
                                </div>                                 
                                <asp:Label ID="lbladjunto" runat="server" CssClass="col-sm-2 col-md-2 control-label">Adjunto: </asp:Label>
                                <div class="col-sm-4 col-md-4">                               
                                    <div class="col-sm-2 col-md-2">
                                            <asp:LinkButton ID="btnAdjunto" runat="server" Text='<span class="fa fa-download"></span> Descargar'
                                 ...
                                 <div class="col-sm-12 col-md-12">
                                  <div class="panel-heading" style="background-color: #E33439; color: White; font-weight: bold;
                                    font-size: 14px;"> 
                                    REVISIÓN DEL COORDINADOR DE ACTIVIDADES: 
                                    </div>
                                     <hr /> 
                                 </div>                                                                                                 
                                <asp:Label ID="Label6" runat="server" CssClass="col-sm-2 col-md-2 control-label">Conformidad Coo.Act: </asp:Label>
                                <div class="col-sm-4 col-md-4">
                                    <div class="col-sm-4 col-md-4">
                                    <asp:TextBox runat="server" ID="txtConforme" ReadOnly="false" CssClass="form-control"  Style="text-transform: uppercase" Text="Conforme">
                                       </asp:TextBox>
                                    </div>                                    
                                </div>
                                <asp:Label ID="lblInforme" runat="server" CssClass="col-sm-2 col-md-2 control-label">Informe: </asp:Label>
                                <div class="col-sm-4 col-md-4">
                                    <div class="col-sm-2 col-md-2">
                                            <asp:LinkButton ID="btnArchivo" runat="server" Text='<span class="fa fa-download"></span> Descargar'
                                                CssClass="btn btn-info btn-sm btn-radius" ToolTip="Descargar" OnClientClick="return false;">
                                            </asp:LinkButton>
                                    </div>
                                    <hr/> 
                                 ...
                                 <div class="col-sm-12 col-md-12">
                                  <div class="panel-heading" style="background-color: #E33439; color: White; font-weight: bold;
                                    font-size: 14px;"> 
                                    REVISIÓN DEL DIRECTOR DE BIENESTAR: 
                                    </div>
                                     <hr /> 
                                 </div> 
                                 <asp:Label ID="lblRespuesta" runat="server" CssClass="col-sm-2 col-md-2 control-label">Reconocimiento: </asp:Label>
                                 <div class="col-sm-4 col-md-4">
                                    <div class="col-sm-5 col-md-5">
                                ...
                                <asp:Label ID="Label7" runat="server" CssClass="col-sm-2 col-md-2 control-label">Observación: </asp:Label>
                                <div class="col-sm-4 col-md-4">
                                    <div class="col-sm-12 col-md-12">
                                    <asp:TextBox runat="server" ID="txtObservacion" ReadOnly="false" TextMode="MultiLine" Rows ="3" CssClass="form-control" Style="text-transform: uppercase" Text="">
                                       </asp:TextBox>
                                    </div>
                                    <hr />                                    
                                </div>                                                                                     
                    ...
                    <contenttemplate>
                        ...
                        <div class="form-group">                       
                            <asp:GridView runat="server" ID="gvListaEscalas" CssClass="table table-condensed" DataKeyNames="codigo_ecs, eliminado_ecs"
                                    ...
                                    <Columns>                                                                            
                                        <asp:BoundField  HeaderText="N° TRÁM" HeaderStyle-Width="10%" />                                        
                                        <asp:BoundField  HeaderText="CARRERA PROFESIONAL" HeaderStyle-Width="20%" />                                        
                                        <asp:BoundField  HeaderText="CÓD.UNIV." HeaderStyle-Width="10%" />                                        
                                        <asp:BoundField  HeaderText="ESTUDIANTE" HeaderStyle-Width="25%" />
                                        <asp:BoundField  HeaderText="TALLER" HeaderStyle-Width="25%" />
                                        <asp:BoundField  HeaderText="SEMESTRE" HeaderStyle-Width="10%" />
                                        <asp:BoundField  HeaderText="FECHA INGRESO" HeaderStyle-Width="10%" />                                        
