...
Partial Class frmasignarcargaacademicafc
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            ...
            objFun.CargarListas(Me.dpCodigo_cpf, obj.TraerDataTable("EVE_ConsultarCarreraProfesionalFC", Modulo, codigo_tfu, codigo_usu, 85), "codigo_cpf", "nombre_cpf", "--Seleccione la Carrera Profesional--")
            'CECI cambiar Código_Apl en EVE_ConsultarCarreraProfesionalFC
    ...
    Protected Sub grwGruposProgramados_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles grwGruposProgramados.SelectedIndexChanged, cmdPopUp.Click
        ...
        If Session("PermitirCarga") = "SI" Then
            ...
            ClsFunciones.LlenarListas(Me.blstProfesoresSugeridos, obj.TraerDataTable("CAR_ConsultarProcesoCargaAcademica", 12, Me.hdcodigo_dac.Value, Me.hdCodigo_Cup.Value, Me.dpCodigo_cac.SelectedValue, 0), "codigo_per", "profesor")
    ...
    Protected Sub cmdGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdGuardar.Click
        ...
        If (dt.Rows.Count > 0) Then
            ...
            dt = obj.TraerDataTable("ACAD_RetornaDocentesPermitidos", Me.hdCodigo_Cup.Value)
            Me.lblCarga.Text = (dt.Rows(0).Item("docentes") + 1) & " de " & dt.Rows(0).Item("nrodocente_cup")
    ...
    Private Sub ValidarPermisoAcciones()
        If Me.dpCodigo_cpf.SelectedValue <> -1 And Me.grwGruposProgramados.Rows.Count > 0 Then
            ...
            If codigo_tfu <> 1 Then
                ...
                obj.CadenaConexion = ConfigurationManager.ConnectionStrings("CNXBDUSAT").ConnectionString
                obj.AbrirConexion()
                'Procedimiento anterior: ValidarPermisoAccionesEnProcesoMatriculaCarga
                'Se cambió para agregar el parametro Tipo Estudio (Mod) - CSenmache 26.06.2017                
                tblPermisos = obj.TraerDataTable("ValidarPermisoAccionesEnProcesoMatriculaCarga_v2", "0", Me.dpCodigo_cac.SelectedValue, codigo_usu, "cargaacademica", Request.QueryString("mod"))
