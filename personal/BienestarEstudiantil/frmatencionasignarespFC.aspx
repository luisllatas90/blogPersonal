<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmatencionasignarespFC.aspx.vb"
    Inherits="frmatencionasignarespFC" %>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="background-color: #E33439; color: White; font-weight: bold;
                font-size: 14px;">
                <b>ASIGNACIÓN DE RESPONSABLES A TALLERES</b>
            </div>
                    ...
                    <contenttemplate>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">                           
                                ...
                                <asp:Label ID="lbladjunto" runat="server" CssClass="col-sm-2 col-md-2 control-label">Responsable: </asp:Label>
                                <div class="col-sm-4 col-md-4">                               
                                    <div class="col-sm-12 col-md-12">
                                          <asp:DropDownList runat="server" ID="cboResponsable" CssClass="form-control" AutoPostBack="true">
                                ...
                                <asp:Label ID="lblInforme" runat="server" CssClass="col-sm-2 col-md-2 control-label">Adjunto: </asp:Label>
                                <div class="col-sm-4 col-md-4">
                        ...
                        <div class="form-group">                       
                            <asp:GridView runat="server" ID="gvListaEscalas" CssClass="table table-condensed" DataKeyNames="codigo_ecs, eliminado_ecs"
                                    ...
                                    <Columns>                                                                            
                                        ...
                                        <asp:BoundField  HeaderText="FECHA ASIGNA" HeaderStyle-Width="10%" />                                        
