...
Partial Class academico_silabos_FrmAdminSilabosFC
    ...
    Private Sub ValidaCronograma()
        ...
        Try
            ...
            If dt.Rows.Count = 0 Then
                ...
                Me.lblMensaje.Text = "No puede registrar sílabos por encontrarse fuera de fecha. Coordinar con Dirección académica"
            ...
            Else
                ...
                Me.lblMensaje.Text = "Fechas definidas para subir sílabos: " & f1.ToString("dd/MM/yyyy") & "-" & f2.ToString("dd/MM/yyyy")
