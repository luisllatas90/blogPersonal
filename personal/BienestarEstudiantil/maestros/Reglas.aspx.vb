...
Partial Class BienestarEstudiantil_maestros_Reglas
...
#Region "Procedimiento"
    ...
    Private Sub CargaDatos()
        ...
        Renglon("ID") = "1"
        Renglon("CODIGO") = "RFC001"
        Renglon("NOMBRE") = "CUMPLE CRONOGRAMA INSCRIPCION"
        Renglon("DESCRIPCION") = "Verifica en cronograma en la actividad Ins Form Compl"
        miDataTable.Rows.Add(Renglon)

        Renglon = miDataTable.NewRow()
        Renglon("ID") = "2"
        Renglon("CODIGO") = "RFC002"
        Renglon("NOMBRE") = "CUMPLE CRONOGRAMA AGREGADOS Y RETIROS"
        Renglon("DESCRIPCION") = "Verifica en cronograma en la actividad Ins Form Compl"
        miDataTable.Rows.Add(Renglon)

        Renglon = miDataTable.NewRow()
        Renglon("ID") = "3"
        Renglon("CODIGO") = "RFC003"
        Renglon("NOMBRE") = "CUMPLE CRONOGRAMA CAMBIO DE GRUPO"
        Renglon("DESCRIPCION") = "Verifica en cronograma en la actividad Ins Form Compl"
        miDataTable.Rows.Add(Renglon)
