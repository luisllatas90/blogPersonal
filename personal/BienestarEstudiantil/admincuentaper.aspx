<%@ Page Language="VB" AutoEventWireup="false" CodeFile="admincuentaper.aspx.vb" Inherits="librerianet_academico_adminestadocuenta" %>
        ...
        <asp:Panel ID="pnlDatos" runat="server">
            <table ID="tblDatos" border="0" bordercolor="#111111" cellpadding="3" 
                ...
                <tr>
                    ...
                    <td class="usatsubtitulousuario" width="50%">
                        <asp:Label ID="lblcodigo" runat="server"></asp:Label>
                    </td>
                    <td width="15%">Costo Pensi&oacute;n</td>
                    <td class="usatsubtitulousuario" width="10%" align="right">
                        <asp:Label ID="lblCostoPension" runat="server" Font-Bold="True"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td width="15%"> 
                    ...
                    <td width="15%"">Costo Comp.</td>
                    <td width="10%" align="right" class="usatsubtitulousuario" ><asp:Label ID="lblCostoComp" runat="server" 
                ...
                <tr>
                    ...
                    <td width="10%" align="right" class="usatsubtitulousuario" ><asp:Label ID="lblCostoTotal" runat="server" 
                            Font-Bold="True"></asp:Label></td>
                </tr>
                <tr>
                    <td width="15%">
                    ...
                    <td width="10%"  align="right" class="usatsubtitulousuario" >
                        <asp:Label ID="lblNCuotas" runat="server" Font-Bold="True"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td width="15%">
                    ...
                    <td class="usatsubtitulousuario" width="50%">
                     ...
                     <td width="15%">Cuota Mensual:</td>
                    <td align="right" width="10%" class="usatsubtitulousuario"><asp:Label ID="lblCuotaMensual" runat="server" 
                            Font-Bold="True"></asp:Label></td>
                </tr>
                <tr>
                    ...
                    <td class="style2" width="50%">
                     ...
                     <td width="15%" class="style1">Cuota Mensual Complementario:</td>
                    <td align="right" width="10%" class="style2"><asp:Label ID="lblCuotaMensualComplementario" runat="server" 
                            Font-Bold="True"></asp:Label></td>
                </tr>
                <tr>
                    <td colspan="4" style="width: 85%" width="15%">
                        <asp:Label 
...
<asp:Button ID="cmdExportar" runat="server" CssClass="imprimir2" 
    ...
    <asp:Panel ID="pnlDeudas" runat="server">
        ...
        <asp:GridView ID="gvPagoVsDeuda" runat="server" AutoGenerateColumns="False">
                <Columns>
                    ...
                    <asp:BoundField DataField="observacion_deu" HeaderText="Observacion Cargo" />
                    <asp:BoundField DataField="observacion_Cin" HeaderText="Observación Pago" />
                </Columns>  
    ...
    <asp:Panel ID="pnlAviso" runat="server">
        <p class="etiqueta">
            ...
            <li><b><font color="#FF0000">Deberá acudir a cancelar en cualquier agencia del BCP o 
                BBVA a nivel nacional, indicando su número de DNI.</font></b> </li>
