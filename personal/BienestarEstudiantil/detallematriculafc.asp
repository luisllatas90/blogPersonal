...
<title>Talleres Matriculados</title>
<link rel="stylesheet" type="text/css" href="../../private/estilo.css"/>
<script type="text/javascript" language="JavaScript" src="../../private/funciones.js"></script>
<script type="text/javascript" language="javascript">
	function actualizarmatricula(obj)
	{
		location.href="detallematriculafc.asp?codigo_mat=" + obj.value + "&<%=replace(request.querystring,"codigo_mat=","")%>"
	}
</script>
</head>
<body>
...
<table border="1" cellpadding="2" cellspacing="0" style="border-collapse: collapse" bordercolor="#E9E9E9" width="100%" id="tbllista">
  <tr class="usatencabezadotabla" style="cursor:hand">
    ...
    <td width="250">Descripción del Taller</td>
    <td width="27">Crd</td>
    <!--<td width="27">Ciclo</td>-->
    <td width="46">Veces</td>
    <td width="38">Acredita</td>
  ...
  %>
  <tr class="usatTablaInfo">
    <td width="100%" colspan="<%=colspan+3%>" align="right"><b>Talleres Matriculados: <%=totalmat%> 
        | Talleres Retirados: <%=totalret%> | Créditos Matriculados:<%=totalcrd%> | 
        Talleres Inhabilitados:<%=NumInh%> | Créditos Inhabilitados:<%=CredInh%> &nbsp;&nbsp; | Promedio 
