            ...
            <tr>
                <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="MAT_ConsultarCronogramaV3" SelectCommandType="StoredProcedure">
                        <SelectParameters>
    ...
    <tbody>
        <tr>
            <td colspan="2" style="text-align:center">
                <h3>Configuración de Cronograma de Matrícula Complementaria</h3></td>
        ...
        <tr>
            <td style="width:100%;text-align:center;" colspan="2">
              ...
              Rango de CICLO: CICLO INI - CICLO FIN<br />
              Rango de Fechas Para Matricularse según CICLO: F. INICIO - F. FINAL
              </h6>              
              </td>    
        </tr>
        <tr>
    ...
    <asp:GridView ID="lstGrupo" runat="server" AutoGenerateColumns="False" 
            ...
            Font-Size="X-Small"  class="display">
                    ...
                    <asp:TemplateField>
                        ...
                        <asp:BoundField DataField="pps_ini" HeaderText="CICLO INI" >
                            <HeaderStyle Font-Bold="True" Font-Size="Small" />
                            <ItemStyle Width="23%" HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="pps_fin" HeaderText="CICLO FIN" >
                            <HeaderStyle Font-Bold="True" Font-Size="Small" />
                            <ItemStyle Width="23%" HorizontalAlign="Right" />
                        </asp:BoundField>
...
<HeaderStyle BackColor="#e33439" ForeColor="#FFFFFF" Height="22px" />
    ...
    <td style="width:30%">
     <div id="Registro" runat="server" visible="false">
                 ...
                 <tr>
                 <td style="width:50%">Ciclo Inicial</td>
                 <td>
