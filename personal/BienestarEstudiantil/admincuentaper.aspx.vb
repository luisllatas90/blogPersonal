...
Partial Class librerianet_academico_adminestadocuenta
    ...
    Private Sub CalculaPagos()
        ...
        Try
           dt = obj.TraerDataTable("ACAD_CalculaCargoPensionAlumno", Request.QueryString("id"))
            If (dt.Rows.Count > 0) Then
                ...
                Me.lblCuotaMensualComplementario.Text = FormatNumber(Double.Parse(Me.lblCostoComp.Text) / Double.Parse(Me.lblNCuotas.Text), 2)
            End If
        Catch ex As Exception
    ...
    Protected Sub grwPagos_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grwPagos.RowDataBound
        ...
        ElseIf e.Row.RowType = DataControlRowType.Footer Then
            ...
            Me.lblVencidas.Text = "TOTAL DE DEUDAS VENCIDAS QUE GENERAN MORA: S/." & Mora.ToString            
    ...
    Protected Sub grwPagos_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles grwPagos.SelectedIndexChanged
