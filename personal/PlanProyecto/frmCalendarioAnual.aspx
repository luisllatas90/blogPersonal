<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCalendarioAnual.aspx.vb" Inherits="PlanProyecto_frmCalendarioAnual" %>
        ...
        <table width="100%" >        
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="btnAgregar" runat="server" Text="Agregar Actividad" CssClass="agregar2" Height="22px" Width="120px" />                    
                    <asp:Button ID="btnListar" runat="server" Text="Listar Grupos" CssClass="buscar2" Width="100px" Height="22px" />                   
                    <asp:Button ID="btnDuplicar" runat="server" Text="Duplicar Actividades" Width="140px" Height="22px" CssClass="modificar2" />
                    <asp:Button ID="btnFinalizar" runat="server" Text="Finaliza Proyecto" CssClass="modificar2" Width="120px" Height="22px" />
