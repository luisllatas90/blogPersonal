...
Partial Class PlanProyecto_frmExportarCalendario
            ...
            Else    'SI NO ES PROCESO                
                If (dt.Rows(i).Item("proceso").ToString = "S") Then 'SI ES PROCESO
                    If (dt.Rows(i).Item("feriado_apr") = False) Then
                        strAct = strAct & "<td colspan='2' style='width:175px; background:#CEE3F6; font-size:11px; border-bottom-width:1px; border-bottom-color:#FFFFFF; border-bottom-style:solid; border-right-style:solid; border-right-color:#D8DADB; border-right-width:1px;'><b>" & dt.Rows(i).Item(1) & "</b></td>"
                    Else
                        strAct = strAct & "<td colspan='2' style='width:175px; background:#F7FE2E; font-size:11px; border-bottom-width:1px; border-bottom-color:#FFFFFF; border-bottom-style:solid; border-right-style:solid; border-right-color:#F7FE2E; border-right-width:1px;'><b>" & dt.Rows(i).Item(1) & "</b></td>"
                    End If
                Else
                    If (dt.Rows(i).Item("feriado_apr") = False) Then
                        ...
                        Else    'Tiene semanas
                            ...
                            Else
                                If (j = 53) Then
                                    ...
                                    strAct = strAct & "</a>" & "</td>"
                                Else
                                    strAct = strAct & "<td title='Actividad' align='center'  style='background: " & colorFeriado & "; color:" & dt.Rows(i).Item("color").ToString & "; cursor:hand; border-bottom-width:1px; border-bottom-color:#0B0B61; border-bottom-style:solid; border-right-style:solid; border-right-color:#D8DADB; border-right-width:1px;'>&nbsp;&nbsp;</td>"
                                End If
