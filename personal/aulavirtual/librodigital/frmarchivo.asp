...
<title>Copiar archivos al servidor...</title>
<link rel="stylesheet" type="text/css" href="../../../private/estiloaulavirtual.css">
<base target="_self">
</head>

<body>
<form name="frmImagen" enctype="multipart/form-data" method="post" action="guardararchivo.asp?idcursovirtual=<%=idcursovirtual%>&idtabla=<%=idtabla%>">
<input type="hidden" name="doCreate" value="true">
<fieldset style="padding: 2">
  <legend>
  <p class="e1">Copiar imágen al contenido temático</p>
  </legend>
