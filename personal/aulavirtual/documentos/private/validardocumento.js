...
function AgregarDoc(modo)
{
	...
	if (iddir==""){
		...
		if (modo=="A"){
			...
			AbrirPopUp("generacadena.asp?Accion=agregardocumento&pagina=frmdocumento.aspx&tipodoc=A&idcarpeta=" + iddir,"350","620")	}

		if (modo=="L")
			{AbrirPopUp("frmdocumento.asp?Accion=agregardocumento&tipodoc=L&idcarpeta=" + iddir,"350","620")}
			
        if (modo=="P")
			{location.href="generacadena.asp?Accion=agregardocumento&pagina=frmpaginaweb.aspx&tipodoc=P&idcarpeta=" + iddir}
	}
}
...
{
    if (tipodoc!="P"){
        AbrirPopUp("generacadena.asp?Accion=modificardocumento&pagina=frmdocumento.aspx&idcarpeta=" + iddir + "&tipodoc=" + tipodoc + "&IdDocumento=" + iddoc + "&numfila=" + nfila,"300","620")
    }
    else{
        parent.parent.location.href="generacadena.asp?Accion=modificardocumento&pagina=frmpaginaweb.aspx&tipodoc=P&idcarpeta=" + iddir + "&IdDocumento=" + iddoc
    }       
}
