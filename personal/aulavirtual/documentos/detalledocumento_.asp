...
<body topmargin="0" leftmargin="0">
  ...
  <tr>
    ...
    <img style="cursor:hand" onClick="EliminarDoc('<%=idDocumento%>','<%=archivo%>')" border="0" src="../../../images/eliminar.gif" ALT="Haga clic aquí para Eliminar el documento"/><br>
  ...
  <tr style="cursor:hand">
    ...
    <td width="95%" valign="top" colspan="2" align="right"><%=.BuscarRuta("documento",iddocumento,tipodoc,versiondoc,archivo,link,idestadorecurso)%></td>
  </tr>
  <%end if%>
</table>
</body>
