...
cadena="idusuario=" & idusuario & "&ficursovirtual=" & ficursovirtual & "&ffcursovirtual=" & ffcursovirtual & "&idvisita=" & idvisita & "&accion=" & accion & "&numfila=" & numfila & "&idcursovirtual=" & idcursovirtual 
...
if pagina="frmpaginaweb.aspx" then
	cadena="accion=" & accion & "&refcodigo_ccv=0&iddocumento=" & iddocumento & "&idcursovirtual=" & idcursovirtual & "&refiddocumento=" & idcarpeta & "&idusuario=" & idusuario & "&codigo_tfu" & session("codigo_tfu")
	'response.redirect("../../../libreriaNET/aulavirtual/" & pagina & "?" & cadena)
		response.redirect("../../aulavirtualProfesores/" & pagina & "?" & cadena)
end if
