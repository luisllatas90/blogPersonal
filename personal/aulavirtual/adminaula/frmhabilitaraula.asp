...
<table border="0" cellpadding="2" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="<%=alto%>">
    <tr>
      ...
      Habilitar Acceso al Aula Virtual para Docentes</td>
    </tr>
    <tr>
        <td width="18%" height="3%" valign="top">Semestre Académico</td>
        <td width="10%" height="3%" valign="top"><%call llenarlista("cboCiclo","actualizarlista('frmhabilitaraula.asp?codigo_cac=' + this.value)",rsCac,"codigo_cac","descripcion_cac",codigo_cac,"","","")%></td>
        <td width="20%" height="3%" valign="top" align="right">Departamento Acad.</td>
        <td width="40%" height="3%" valign="top"><%call llenarlista("cboDpto","actualizarlista('frmhabilitaraula.asp?modo=R&codigo_cac=' + cboCiclo.value + '&codigo_dac=' + this.value)",rsDpto,"codigo_dac","nombre_dac",codigo_dac,"Seleccionar el Dpto Académico",Todos,"")%></td>
        </tr>
    <%if estado="R" then%>
    <tr>
        <td width="18%" height="3%" valign="top">Profesor</td>
        <td width="70%" height="3%" valign="top" colspan="3">
        <%call llenarlista("cboprofesor","fradetalle.location.href='lstcargadocente.asp?codigo_per=' + this.value + '&codigo_cac=' + cboCiclo.value",rsProfesor,"codigo_per","docente",codigo_per,"Seleccionar el Profesor","","")%>
		</td>
        </tr>
		<tr>
	...
	<%elseif modo="R" then%>
		<tr><td width="100%" height="5%" colspan="4" class="usatsugerencia">&nbsp;&nbsp;&nbsp; No se han registrado Docentes para el Departamento Seleccionado</td></tr>
	<%end if%>
</table>
</body>
</html>