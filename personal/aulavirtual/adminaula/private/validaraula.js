...
function consultarAulaVirtualPorTipoEstudio2(mod, ctf, id) {
    location.href = "frmaccesoaulamoodle.asp?resultado=S&codigo_cac=" + cbocodigo_cac.value + "&codigo_cpf=" + cbocodigo_cpf.value + "&mod=" + mod + "&ctf=" + ctf + "&id=" + id
}
