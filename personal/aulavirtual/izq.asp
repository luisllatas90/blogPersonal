...
%>
  <tr>
    <td width="100%" onMouseOver="Resaltar(1,this,'S','#DEE0C5')" onMouseOut="Resaltar(0,this,'S','#DEE0C5')" onClick="ModificarCurso()"><img src="../../images/disenar.gif">&nbsp;Administrar</td>
  </tr>
<%end if%>
  <%If IsEmpty(ArrDatos)=false then
  for i=lbound(Arrdatos,2) to Ubound(Arrdatos,2)%>
  <tr onMouseOver="Resaltar(1,this,'S','#DEE0C5')" onMouseOut="Resaltar(0,this,'S','#DEE0C5')" onClick="marcarColorfila('<%=i+item%>','','<%=arrdatos(1,i)%>')">
  ...
  <!--
  <tr onMouseOver="Resaltar(1,this,'S','#DEE0C5')" onMouseOut="Resaltar(0,this,'S','#DEE0C5')" onClick="location.href='cerrarvisitacurso.asp'">
