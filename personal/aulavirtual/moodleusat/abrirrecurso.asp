...
select case codigo_tre
	...
	case "R": cadena="frmpaginaweb.aspx?" & strcurso & "&codigo_tfu=1&refiddocumento=0&iddocumento=" & request.querystring("iddocumento")
...
response.redirect("../../aulavirtualProfesores/" & cadena)
