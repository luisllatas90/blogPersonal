...
<body>
<p class="e4">Foros sin responder</p>
<%
Set Obj= Server.CreateObject("AulaVirtual.clsAccesoDatos")
obj.AbrirConexion
	Set rsContenido=obj.Consultar("DI_ConsultarTodoForo","FO",session("idcursovirtual"),session("codigo_tfu"),session("codigo_usu"),0)
obj.CerrarConexion
Set Obj=nothing
...
<table border="1" cellpadding="3" cellspacing="0" style="border-collapse: collapse" width="100%" bordercolor="#808080">
  <tr class="etabla">
    ...
    <td width="50%">Tema en discusión</td>
    <td width="5%">Respuestas</td>
    <td width="20%">Último Mensaje</td>
  </tr>
  <%
...
<%else
response.write "<h5 class=""sugerencia"">&nbsp;&nbsp;&nbsp;&nbsp;No se han encontrado foros por responder</h5>"
end if
