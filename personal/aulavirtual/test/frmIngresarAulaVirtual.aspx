    ...
    <form id="frmIngresarAulaVirtual" runat="server">
        ...
        <div class="container-fluid">
            <div class="card div-title">                        
                <div class="row title">REGISTRO DE ASISTENCIA DOCENTE</div>
            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <asp:UpdatePanel ID="udpHorario" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                                                <ContentTemplate>
                                                    <asp:GridView ID="grwHorario" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="codigo_hdo, codigo_cup, codigo_lho, codigo_per, descripcion_horario, tipo"
