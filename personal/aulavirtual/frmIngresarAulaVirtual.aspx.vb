    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If (Session("id_per") Is Nothing OrElse Session("perlogin") Is Nothing) Then
                Dim msj As String = "La sesión ha expirado. Debe iniciar sesión nuevamente para poder realizar la marcación."
                Response.Redirect("https://intranet.usat.edu.pe/campusvirtual/personal/frmSinAcceso.aspx?msj=" & msj)
            End If
    ...
    Protected Sub grwHorario_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grwHorario.RowCommand
        Try
            ...
            With le_AsistenciaDocente
                ...
                .codigo_hop = CInt(Me.grwHorario.DataKeys(index).Values("codigo_hop").ToString)
...
#Region "Metodos"
    ...
    Private Sub mt_CargarHorario()
        Try
            ...
            If dt.Rows.Count > 0 Then Call mt_UpdatePanel("Horario") Else udpHorario.Update()

            Dim fecha_actual As DateTime = DateTime.Now
            Me.lblUltimaActualizacion.InnerText = "ÚLTIMA ACTUALIZACIÓN: " & fecha_actual.ToString("dddd").ToUpper & " " & fecha_actual.ToString("dd") & "/" & fecha_actual.ToString("MM") & "/" & fecha_actual.ToString("yyyy") & " " & fecha_actual.ToString("HH:mm")
            Call mt_UpdatePanel("Actualizacion")
        Catch ex As Exception
            Call mt_ShowMessage(ex.Message.Replace("'", " "), MessageType.error)
        End Try
    End Sub
    ...
    Private Sub mt_CargarHistorial()
        Try
            ...
            If dt.Rows.Count > 0 Then Call mt_UpdatePanel("Historial") Else udpHistorial.Update()
    ...
    Private Function mt_RegistrarInicioFinClase(ByVal le_AsistenciaDocente As e_AsistenciaDocente, ByVal tipo As String) As Boolean
        Try
            ...
            With me_AsistenciaDocente
                ...
                .codigo_hop = le_AsistenciaDocente.codigo_hop
    ...
    Private Function fu_ValidarRegistrarInicioFinClase(ByVal le_AsistenciaDocente As e_AsistenciaDocente, ByVal tipo As String) As Boolean
        Try
            ...
            If String.IsNullOrEmpty(le_AsistenciaDocente.codigo_hop) OrElse CInt(le_AsistenciaDocente.codigo_hop) = 0 Then
