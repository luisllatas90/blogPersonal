<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCategoria.aspx.vb" Inherits="sistema_Maestros_frmCategoria" %>
    ...
    <form id="frmCategoria" runat="server">
        ...
        <div class="container-fluid">
            <div class="card div-title">                        
                <div class="row title">REGISTRO DE CATEGORÍAS</div>
            </div>
                ...
                <div class="tab-pane show active" id="listado" role="tabpanel" aria-labelledby="listado-tab">
                        ...
                        <asp:UpdatePanel ID="udpFiltros" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                            <ContentTemplate>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <label for="cmbGrupoFiltro" class="col-sm-2 col-form-label form-control-sm">Grupo:</label>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <asp:LinkButton ID="btnNuevo" runat="server" CssClass="btn btn-accion btn-azul"                                                    
                                                    OnClientClick="return alertConfirm(this, event, '¿Desea registrar una nueva categoría?', 'warning');">
                    ...
                    <div class="table-responsive">
                        <asp:UpdatePanel ID="udpLista" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                            <ContentTemplate>
                                <asp:GridView ID="grwLista" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="codigo_cat"
                                    CssClass="display table table-sm" GridLines="None">
                                    <Columns>
                                        <asp:BoundField DataField="grupo_cat" HeaderText="GRUPO" ItemStyle-Width="20%" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="nombre_cat" HeaderText="NOMBRE" ItemStyle-Width="20%" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="abreviatura_cat" HeaderText="ABREVIATURA" ItemStyle-Width="10%" ItemStyle-Wrap="false" />
                        ...
                        <asp:UpdatePanel ID="udpRegistro" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                            <ContentTemplate>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <label for="cmbGrupo" class="col-sm-2 col-form-label form-control-sm">Grupo:</label>
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-3">
                                                <asp:TextBox ID="txtGrupo" runat="server" MaxLength="50" CssClass="form-control form-control-sm uppercase" Placeholder="NUEVO GRUPO" AutoComplete="off"/>
                                            </div> 
                                        </div>
                                        <div class="row">
                                            <label for="txtNombre" class="col-sm-2 col-form-label form-control-sm">Nombre:</label>
                                            <div class="col-sm-4">
                                                <asp:TextBox ID="txtNombre" runat="server" MaxLength="250" CssClass="form-control form-control-sm uppercase" AutoComplete="off"/>
                                            </div>                                              
                                        </div> 
                                        <div class="row">
                                            <label for="txtAbreviatura" class="col-sm-2 col-form-label form-control-sm">Abreviatura:</label>
                                            <div class="col-sm-2">
                                                <asp:TextBox ID="txtAbreviatura" runat="server" MaxLength="100" CssClass="form-control form-control-sm uppercase" AutoComplete="off"/>
                                            </div> 
                                        </div>                                                                                
                                    </div>
                                    <div class="card-footer" style="text-align: center;">
                                        <asp:LinkButton ID="btnGuardar" runat="server" CssClass="btn btn-accion btn-verde"
                                            OnClientClick="return alertConfirm(this, event, '¿Desea registrar la categoría?', 'warning');">
