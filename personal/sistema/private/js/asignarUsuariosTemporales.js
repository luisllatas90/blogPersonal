...
$(document).ready(function () {
    ...
    // Eventos
    $('body').on('change', '#chkHabilitarHasta', function (e) {  
        __doPostBack('chkHabilitarHasta', '');
    });
    ...
    initFakeListener('btnFakeDesactivar', 'btnDesactivar');
    initFakeListener('btnFakeActivar', 'btnActivar');
...
function initFilterPlugins() {
    initSelectPicker('cmbFiltroRegistradoPor', {
        liveSearch: true,
        size: 8
    });
}
...
function initFormPlugins() {
    initSelectPicker('cmbUsuarioReal', {
        liveSearch: true,
        size: 8
    });

    initSelectPicker('cmbUsuarioTemporal', {
        liveSearch: true,
        size: 8
    });
...
function initFormDatetimepickers() {  
    initDatetimePicker('mrkFechaHasta', {
        format: 'DD/MM/YYYY'
    });

    initDatetimePicker('mrkHoraHasta', {
        format: 'HH:mm'
    });
}
