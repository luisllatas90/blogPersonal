                ...
                If (dt_Persona.Rows.Count > 0) Then
                    ...
                    If ((blnExisteDeuda = False) And (Me.HdPermiteAsistencia.Value = True)) Then
                        ...
                        If (dt_Actividad.Rows.Count > 0) Then
                            ...
                            Else
                                Me.lblMensaje.Text = "Usted ya esta participando de la actividad " + dt_Horario.Rows(0).Item("evento") '+ codigo_cco + "/strActividades:" + strActividades + "/codigo_pso:" + codigo_pso + "/cboActividad:" + Me.cboActividad.SelectedValue + "/fecha:" + Me.calFecha.SelectedDate & " " & hour(Now) & " : " & minute(Now) & " : " & second(Now)
                                Me.lblMensaje.Font.Size = 20
                                Me.lblMensaje.ForeColor = Drawing.Color.Red
                            End If
