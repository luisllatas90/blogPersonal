            ...
            Select Case e.CommandName
                Case "ver"
                    ...
                    Else
                        ...
                        arreglo.Add("sesionUsuario", Session("perlogin").ToString)
                        '-----------------                
                        arreglo.Add("codigo_datos", codigoDatos) '' en este caso solo [codigodatos] solo es previa del doumento
                        arreglo.Add("codigo_sol", codigo_sol)
                ...
                Case "generar"
                    Try
                        ...
                        Else   '''''' para todos los documnetos
