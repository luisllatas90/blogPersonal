<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmConstanciasNotMat.aspx.vb" Inherits="GestionDocumentaria_frmConstanciasNotMat" %>
            ...
            <div class="container-fluid">
                <div class="panel-cabecera">
                     <div class="card" style="height:1080px" >
                        <div class="card-header">GENERA CONSTANCIA DE NOTAS Y MATRICULA</div>
                        <div class="card-body">
                            <%--<asp:UpdatePanel ID="udpFiltros" runat="server" UpdateMode="Conditional" >
                                <ContentTemplate>--%>                                
                                    <div class="row">
	                                    ...
	                                    <label class="col-sm-2 col-form-label form-control-sm" for="lblCiclo">Ciclo Académico:</label>
	                                    <div class="col-sm-3">
                                   ...
                                   <div class="row">   
                                    ...
                                    <div class="row">
                                        <div class="col-sm-1">
	                                        <asp:LinkButton ID="lbVerPdf" runat="server" CssClass="btn btn-info" ToolTip="Visualizar" >
                                                <span><i class="fa fa-eye"></i></span> &nbsp; Visualizar
						                    </asp:LinkButton>
	                                    </div>	                                     <div class="col-sm-1">	                                        
	                                        <asp:LinkButton ID="lbGeneraDocumento" runat="server" CssClass="btn btn-success" ToolTip="Generar PDF" Visible = "true">
